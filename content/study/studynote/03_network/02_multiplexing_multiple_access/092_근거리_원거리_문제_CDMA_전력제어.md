...
|:---|:---|:---|:---|
| **FDMA (1G)** | 주파수 분리 | 낮음 (서로 다른 주파수라 안 들림) | 배터리 절약 목적 정도로만 사용 |
| **TDMA (2G)** | 시간 분리 | 중간 (발언 시간이 달라 겹치지 않음) | 중간 수준 통제 |
| **CDMA (3G)** | **코드 분리** | **절대적 (한 방에서 모두가 섞임)** | **시스템의 생존을 결정하는 코어 엔진** |
...
| **OFDMA** | 4G/5G의 접속 방식. 주파수 분할 직교성을 써서 근거리-원거리 문제가 크게 완화되었으나 기지국 간 간섭 억제를 위해 전력 제어 유산을 승계했다. |
