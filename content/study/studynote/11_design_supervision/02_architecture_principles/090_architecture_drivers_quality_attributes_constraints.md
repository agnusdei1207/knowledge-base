...
| :--- | :--- | :--- | :--- |
| **성능 (Performance)**<br>빠른 응답 시간 | **보안 (Security)**<br>강력한 데이터 암호화 | 암호화/복호화 연산으로 인한 CPU 부하 및 지연 시간 발생 | 데이터 중요도에 따라 부분 암호화 적용, 전용 H/W 가속기 도입 |
| **가용성 (Availability)**<br>무중단 서비스 | **제약 (Constraints)**<br>인프라 예산 삭감 | 이중화/삼중화 서버 구성 시 비용 기하급수적 증가 | 클라우드 오토스케일링 및 Active-Standby의 저비용 혼합 구성 |
