...
2. **이해관계자 참여 여부**: 아키텍트들끼리만 모여서 탁상공론을 하는 것이 아니라, 비즈니스 요구사항을 가진 경영진과 운영/보안 담당자가 모두 회의에 참석했는가?
3. **리스크 문서화**: 도출된 Risk와 Trade-off Point가 아키텍처 기술서(SAD)에 명확히 기록되어 향후 설계 변경의 근거로 남았는가?
