...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: O2O는 **온라인 플랫폼에서 고객을 유치하여 오프라인 매장·서비스로 연결**하는 비즈니스 모델이며, 배달앱(배달의민족)·차량호출(카카오T)·숙박(에어비앤비)이 대표이다.
...
O2O는 **플랫폼 비즈니스의 핵심 모델**이며, OMO(온·오프 융합)으로 진화하고 있다.
