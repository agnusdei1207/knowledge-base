...
> 3. **판단 포인트**: 금융(계좌 개설)·통신(유심 개통)·HR(신입사원 입사)이 핵심 적용 분야이며, 비대면 실명 [[396_validation|확인]](eKYC)이 규제 핵심이다.
...
디지털 온보딩은 **고객 경험의 첫인상**이며, eKYC+[[988_digital_signature|전자 서명]]으로 비대면 완전 자동화가 표준이 되고 있다.
...
|:---|:---|
| **디지털 온보딩** | 비대면 등록 자동화 |
| **eKYC** | 전자 본인 [[396_validation|확인]] |
| **OCR** | 신분증 문서 인식 |
| **[[988_digital_signature|전자 서명]]** | 법적 유효 서명 |
| **[[060_rpa_hyperautomation|RPA]]** | 후처리 자동화 |
