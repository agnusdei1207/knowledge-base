...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 아웃바운드 마케팅은 기업이 고객에게 **먼저 메시지를 보내는(Push)** 전통 방식(TV 광고·콜드콜·배너)이고, 인바운드 마케팅은 **고객이 자발적으로 찾아오게(Pull)** 만드는 콘텐츠 중심 전략(블로그·SEO·웨비나)이다.
...
| **CPL** | 높음 | **낮음 (시간 경과 시)** |
| **신뢰도** | 낮음 (광고 피로) | **높음 (콘텐츠 가치)** |
| **측정** | 어려움 | **GA4·CRM 추적 용이** |
...
3. 요즘은 맛집(인바운드)이 되면서 **가끔 쿠폰(아웃바운드)**도 보내는 혼합 전략이 대세랍니다!