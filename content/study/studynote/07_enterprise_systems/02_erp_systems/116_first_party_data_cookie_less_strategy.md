...
2. **Zero Party 수집**: 설문·위시리스트·선호도 조사.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **CDP** | 1st Party Data 통합·활성화 인프라 |
| **CMP** | 쿠키 동의 관리 플랫폼 (GDPR 준수) |
| **DMP** | 3rd Party 쿠키 기반 (폐지 중) |
| **Zero Party Data** | 고객 자발적 제공 데이터 |
...
2. 이제는 그게 금지돼서, **우리 가게에 온 손님의 정보(1st Party)**만 쓸 수 있어요.
