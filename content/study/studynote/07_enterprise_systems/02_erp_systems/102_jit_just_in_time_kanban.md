...
JIT 시스템의 뼈대는 **풀(Pull) 생산 시스템**과 이를 통신하게 해주는 **칸반 (Kanban, 간판) 시스템**이다. 주문이 발생한 하류 공정이 상류 공정에게 필요한 부품을 요구하는 역방향 정보 흐름을 가진다.
...
| **칸반 (Kanban) 보드** | 도요타의 생산 지시표가 SW 개발의 시각적 작업 관리 도구로 진화한 형태 |
| **WIP (Work In Progress) 제한** | 공정 내 미완성품(진행 중인 작업)의 개수를 제한하여 병목을 막는 규칙 |
