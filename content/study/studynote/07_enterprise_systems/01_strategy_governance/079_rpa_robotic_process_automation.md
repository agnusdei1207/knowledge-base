...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: RPA(Robotic Process Automation)는 기계 팔(Robot)이 아니라 컴퓨터에 깔리는 **소프트웨어 봇(Bot)**으로, 사람이 PC 화면을 보고 마우스 클릭과 키보드 타이핑을 하는 **반복적인 규칙 기반(Rule-based) 업무를 100% 똑같이 흉내 내는 자동화 아키텍처**다.
...
| **개발 기간/비용** | 수개월 ~ 수년 (거대 SI 프로젝트) | **수일 ~ 수주 (초고속 ROI 달성)** |
