...
| **Autoregressive** | 이전 토큰으로 다음 예측 |
| **KV Cache** | 추론 시 Key·Value 재사용 |
| **BERT** | 마스킹 없음 (양방향) |
| **GPT** | Masked Self-Attention 사용 |
...
3. GPT가 **앞 단어만 보고 다음 단어를 예측**할 수 있는 건 이 마스킹 덕분이에요!
