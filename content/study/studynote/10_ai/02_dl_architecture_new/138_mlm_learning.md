...
> 3. **판단 포인트**: MLM은 **이해(NLU)에 최적**이지만 생성에는 부적합하며, Generative 작업에는 CLM(GPT)·Prefix LM(T5)이 적합하다.
...
- **📢 섹션 요약 비유**: MLM은 **빈칸 채우기 시험**이다. 양쪽 힌트를 보고 빈칸에 들어갈 단어를 맞춘다.

---

## Ⅱ~Ⅴ. 결론

MLM은 **양방향 언어 이해의 핵심 학습 방식**이며, BERT·RoBERTa·DeBERTa의 사전 학습 기반이다.
