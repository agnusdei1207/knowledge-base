...
결론적으로 반환 시간, 대기 시간, 응답 시간은 서로 다른 개념이 아니라 **하나의 작업 생애를 세 방향에서 읽는 좌표계**다. 좋은 스케줄링은 이 세 값을 모두 최소화하는 마법이 아니라, 서비스 목적에 맞는 지표를 우선 보호하면서 다른 지표의 희생을 통제 가능한 범위에 두는 설계라고 기억하는 것이 정확하다.
