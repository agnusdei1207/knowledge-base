...
| 개념 | 연결 포인트 |
|:---|:---|
| 인터럽트 구동 입출력 | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| 우선순위 역전 (Priority Inversion) 방지 | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| 고아 좀비 프로세스 init 처리 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
