...
> 2. **가치**: Choreography 대비 **[[191_transaction_concept_states|트랜잭션]] 흐름이 한 곳(오케스트레이터)에 집중**되어 복잡한 비즈니스 로직의 이해·디버깅·모니터링이 쉽다.
...
- **📢 섹션 요약 비유**: Orchestration은 **교향곡 지휘자**이다. 지휘자가 각 악기에 [[130_signal|신호]]를 보내 연주를 조율한다.

---

## Ⅱ~Ⅴ. 결론

[[073_container_orchestration_tools|Orchestration]] Saga는 **복잡한 [[619_msa_traffic_hardware|MSA]] 비즈니스 흐름의 표준**이며, Temporal의 Durable Execution이 핵심 기술이다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[[073_container_orchestration_tools|Orchestration]]** | 중앙 제어 [[305_saga|Saga]] |
| **Temporal** | Durable Execution 프레임워크 |
| **Choreography** | 대안 (이벤트 기반) |
| **Durable Execution** | 장애에도 상태 보존 |
| **Step Functions** | AWS [[206_serverless_cold_start|서버리스]] [[073_container_orchestration_tools|오케스트레이션]] |
