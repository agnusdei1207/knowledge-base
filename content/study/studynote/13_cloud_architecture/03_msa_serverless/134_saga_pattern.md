...
Saga는 **MSA 분산 트랜잭션의 사실상 표준**이며, Temporal/Cadence가 Orchestration Saga의 대표 프레임워크이다.
...
2. 한 선수가 넘어지면(실패) **그 구간만 다시 달려요(보상 트랜잭션)**.
3. 전원이 동시에 출발하는 것(2PC)보다 **빠르고 안전**하답니다!
