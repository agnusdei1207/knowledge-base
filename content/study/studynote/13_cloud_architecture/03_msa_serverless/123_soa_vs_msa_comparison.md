...
### 👶 어린이를 위한 3줄 비유 설명
1. SOA는 **교환원(ESB)**이 모든 전화를 연결해주는 거예요. 교환원이 바쁘면 전화가 안 돼요.
2. MSA는 교환원 없이 **직접 전화**하는 거예요. 더 빠르지만 전화번호부(Service Discovery)가 필요해요.
3. 요즘은 **직접 전화(MSA)가 대세**지만, 옛날 전화기(레거시)는 교환원(SOA)이 필요할 때도 있어요!
