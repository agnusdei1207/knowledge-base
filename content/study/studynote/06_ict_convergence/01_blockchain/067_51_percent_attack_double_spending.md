...
> 1. **본질**: 51% 공격은 과반의 해시 파워나 지분을 장악해 [[004_blockchain|블록체인]] 합의를 흔드는 공격이다.
> 2. **가치**: 더블 스펜딩, reorg, 검열 가능성을 통해 [[989_blockchain_security|블록체인 보안]] 가정의 한계를 드러낸다.
...
[[004_blockchain|블록체인]]은 다수결에 기대는 시스템이다. 따라서 과반이 한쪽으로 쏠리면 결과를 조작할 수 있다.
...
| PoW | 해시 파워 과반 |
| PoS | 지분/검증자 과반 |
| [[647_bft_verification|BFT]] | quorum 파괴 또는 구성 공격 |

| 결과 | 설명 |
| :-- | :-- |
| Reorg | 기록 뒤집힘 |
| [[065_consensus_finality_probabilistic_deterministic|Finality]] 약화 | 확정 신뢰 저하 |

51% 공격은 [[989_blockchain_security|블록체인 보안]]의 기본 가정을 시험하는 사례다.
...
4. 확정성과 [[396_validation|확인]] 횟수를 이해하는가?
5. 분산도와 보안 가정을 평가하는가?
...
51% 공격을 이해하면 [[004_blockchain|블록체인]] 설계에서 분산성과 완결성의 중요성을 분명히 볼 수 있다.
