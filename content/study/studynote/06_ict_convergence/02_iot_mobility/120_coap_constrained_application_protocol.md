...
| **DTLS** | CoAP의 보안 계층 (UDP용 TLS) |
| **MQTT** | CoAP의 보완 프로토콜 (Pub/Sub) |
| **LwM2M** | CoAP 기반 IoT 디바이스 관리 프로토콜 |
| **HTTP-CoAP 프록시** | 웹↔IoT 연동 게이트웨이 |
...
3. MQTT는 **라디오 방송**이에요. 방송국(Broker)이 뉴스(센서 데이터)를 구독자에게 내보내요!