...
| **메시** | ✅ Self-healing | ✅ | ✅ (4홉) |
| **Matter 호환** | **핵심 전송 계층** | Bridge | Bridge |
...
| **6LoWPAN** | IPv6를 802.15.4에 적응시키는 압축 기술 |
| **Matter** | Thread를 전송 계층으로 사용하는 앱 표준 |
| **Border Router** | Thread ↔ IP 네트워크 연결 장치 |
| **Zigbee** | 같은 PHY를 쓰는 경쟁 프로토콜 |
...
2. Thread는 **세계 공용어(IPv6)**를 쓰니까 통역 없이 바로 인터넷에 연결돼요!
