...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 군집주행(Platooning)은 **선두 차량을 따라 후속 차량들이 V2V 통신으로 자동 추종**하며, 차간 거리를 수m로 유지하여 공기 저항을 줄이고 연비를 10~15% 향상시키는 기술이다.
...
- **📢 섹션 요약 비유**: 군집주행은 **기러기 V자 비행**이다. 선두가 공기 저항을 받고, 뒤따르는 기러기(트럭)는 에너지를 절약한다.
...
2. 뒤따르는 트럭은 **바람 저항이 적어** 기름을 덜 써요(15%↓).
