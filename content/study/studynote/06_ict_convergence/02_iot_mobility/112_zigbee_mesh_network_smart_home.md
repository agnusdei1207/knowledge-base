...
| **전력** | 매우 낮음 | 낮음 | 높음 |
| **토폴로지** | **Star/Tree/Mesh** | Star (Mesh 제한적) | Star |
...
| **메시 네트워크** | Zigbee의 핵심 토폴로지, Self-healing |
| **BLE (Bluetooth Low Energy)** | 1:1 통신 경쟁 기술 |
| **Thread** | IPv6 기반 메시, Matter의 하위 프로토콜 |
| **Matter** | Zigbee·Thread·Wi-Fi 통합 차세대 스마트 홈 표준 |
