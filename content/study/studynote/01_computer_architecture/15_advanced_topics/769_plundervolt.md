...
> 1. **본질**: 플런더버그 (Plundervolt)는 Intel 프로세서의 DVFS (Dynamic Voltage and Frequency Scaling) 제어 경로를 악용해, 보안 연산 순간에 코어 전압을 낮추고 그 결과 생긴 계산 오류를 공격에 이용하는 **소프트웨어 유도형 전압 결함 주입**이다.
