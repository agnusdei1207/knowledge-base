...
EMA는 DPA, EMFI (Electromagnetic Fault Injection)와 나란히 놓고 봐야 역할이 분명해진다. DPA와 EMA는 모두 누설을 **관측**하지만, EMFI는 전자기 펄스를 쏴서 회로를 **교란**한다. 즉 EMA는 읽는 공격이고, EMFI는 틀리게 만들고 그 결과를 이용하는 공격이다.
