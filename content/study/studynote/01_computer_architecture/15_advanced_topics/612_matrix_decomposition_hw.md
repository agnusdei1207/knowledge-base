...
결론적으로 행렬 분해 하드웨어는 "행렬곱을 많이 하는 칩"이 아니라, **삼각화와 의존성 있는 선형대수 과정을 데이터 흐름으로 바꿔 버리는 구조적 사고**다. 이 점을 기억하면 LU, QR, 촐레스키와 시스톨릭 어레이, CORDIC, 혼합 정밀도가 왜 한 문맥에서 함께 논의되는지 자연스럽게 이어진다.
