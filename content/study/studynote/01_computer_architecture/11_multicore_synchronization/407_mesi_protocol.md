...
- 이 데이터는 여러 코어가 동시에 **읽기만** 하는가, 아니면 **쓰기 경쟁**이 있는가?
...
따라서 MESI는 "캐시의 4상태 표"로 외우기보다, **독점이면 조용히 쓰고, 공유되면 조정 비용이 생기며, 수정본은 반드시 주인이 있다**는 관점으로 기억하는 것이 좋다. 이 시각을 가지면 False Sharing, MOESI, Memory Barrier, Directory Protocol 같은 다음 개념도 훨씬 자연스럽게 연결된다.
