...
결국 캐시 교체 알고리즘은 "무엇을 버려야 무엇을 살릴 수 있는가"를 정하는 메모리 관리의 핵심 철학이다. 기억을 무한히 늘릴 수 없는 이상, 좋은 시스템은 더 많이 저장하는 시스템이 아니라 **더 가치 있게 잊는 시스템**이라는 관점으로 이해하는 것이 중요하다.
