...
하지만 한계도 분명하다. 통신 지연이 크고 자원 품질이 균일하지 않으며, 운영 정책과 보안 체계가 복잡하다. 그래서 그리드는 모든 문제를 빠르게 만드는 만능 해법이 아니라, **독립적 작업을 넓은 자원망에 뿌려 처리량을 얻는 전략**으로 기억해야 한다. 즉, 그리드의 경쟁력은 "최저 지연시간"이 아니라 "최대 자원 동원 범위"에 있다.
