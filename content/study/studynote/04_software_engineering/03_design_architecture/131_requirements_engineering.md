...
> 2. **가치**: 프로젝트 실패의 60%+가 요구사항 문제(누락·모호·변경)에서 발생하며, 개발 후반 요구 변경 비용은 초기 대비 **50~200배**이므로 체계적 공학이 필수이다.
...
요구사항 공학은 **프로젝트 성공의 가장 중요한 첫 단추**이며, Agile에서도 User Story·BDD로 지속적으로 수행된다.
