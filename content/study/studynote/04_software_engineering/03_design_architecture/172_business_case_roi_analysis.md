...
기술사 답안에서는 "ROI가 높다"는 선언보다, **대안 비교·TCO·현금흐름 시점·민감도·리스크 보정**까지 설명해야 완성도가 높다. 좋은 답안은 숫자를 많이 적는 답안이 아니라, 숫자가 왜 그 결론을 지지하는지 설명하는 답안이다.
...
결론적으로 비즈니스 케이스와 ROI 분석의 핵심은 "기술의 우수성"이 아니라 **투자 자원의 사용 근거**를 만드는 데 있다. 좋은 소프트웨어 공학은 기능을 만드는 일에서 멈추지 않고, 왜 이 기능에 지금 이만큼 투자해야 하는지까지 설명할 수 있을 때 완성된다.
