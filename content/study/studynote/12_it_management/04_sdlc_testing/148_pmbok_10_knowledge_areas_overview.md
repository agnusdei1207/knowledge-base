...
| :--- | :--- | :--- | :--- |
| **관점 및 철학** | **지식 영역(What) 기반의 백과사전**. 방대한 도구와 기법의 집대성 | **프로세스 및 테마(How) 기반**. 명확한 단계별 책임과 통제 위주 | **가치(Value)와 적응성 중심**. 변화를 환영하며 스프린트 단위 반복 |
...
### 실무 판단 시나리오
1. **범위 확산(Scope Creep)의 악몽과 CCB(변경 통제 위원회) 융합 쉴드**: 현업 부서장이 술자리에서 개발자에게 "김 대리, 결제 버튼 색깔 바꾸면서 카카오페이 기능 하나만 몰래 쓱 추가해 줘~"라고 요구했다. 개발자가 무심코 승낙하고 코드를 고쳤다. 
