...
- **📢 섹션 요약 비유**: Adam은 **내비게이션**이다. 방향(Momentum)과 속도(RMSProp)를 자동으로 조절하여 목적지(최솟값)에 빠르게 도착한다.
...
Adam/AdamW는 **딥러닝 학습의 사실상 표준 옵티마이저**이며, Transformer·LLM 학습에 필수이다.
...
3. 거의 모든 AI 학습에서 **Adam이 기본 설정**으로 쓰인답니다!
