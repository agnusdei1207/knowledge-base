...
Transformer는 **현대 AI의 기반 아키텍처**이며, BERT·GPT·T5·LLM·ViT 모두 Transformer 변형이다.
...
2. Transformer는 **모든 사람이 동시에 대화**해서 훨씬 빨라요(병렬).
3. ChatGPT, BERT, 번역기 등 **거의 모든 AI**가 Transformer를 사용해요!
