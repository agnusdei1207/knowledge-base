...
- **📢 섹션 요약 비유**: BERT는 **독해 시험의 달인**이다. 지문(양방향 문맥)을 완벽히 이해하고, 질문(Fine-tuning)에 따라 답을 내놓는다.
...
2. [CLS] 토큰은 **전체 요약 점수**예요. 이걸로 분류·비교를 해요.
3. 적은 연습(Fine-tuning)만으로도 **다양한 시험**을 잘 볼 수 있어요!
