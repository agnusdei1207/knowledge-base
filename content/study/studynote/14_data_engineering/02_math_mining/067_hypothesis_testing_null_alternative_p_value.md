...
> 2. **가치**: [[337_p_value_significance|p-value]], 유의수준, 검정력을 함께 봐야 판단이 의미 있다.
...
[[001_dikw_pyramid|데이터]]가 우연인지 실제 효과인지 구분하려면 검정이 필요하다. 가설 검정은 이런 불확실성을 정량화한다.
...
| H0 | 차이 없음 |
| H1 | 차이 있음 |
| [[337_p_value_significance|p-value]] | H0 하에서의 희귀도 |
| α | 기각 기준 |
...
| H0 | 기본 가정 |
| H1 | 대안 가정 |
| [[337_p_value_significance|p-value]] | 관측치의 희귀도 |
...
가설 검정을 이해하면 실험과 분석에서 결론을 더 신뢰할 수 있다. 그래서 [[001_dikw_pyramid|데이터]] 기반 의사결정의 기본이 된다.
