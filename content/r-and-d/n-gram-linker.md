...
지식베이스의 문서 수가 늘어남에 따라(9,430개 문서, 19,846개 전공 키워드), 특정 문서 본문에서 키워드를 찾아 `[[001_voltage|전압]]` 형태로 자동 치환하는 링킹 작업에서 치명적인 속도 저하가 발생했습니다.
...
*   기존에 이미 설정된 위키링크(`[[link]]`) 및 이미지 마크다운(`![caption](url)`)
