...
- [projects](/work/planning/projects/)
...
- 기반 기술: [tech-stack](/work/develop/tech-stack/)
- 실험과 검증: [research-and-development](/research-and-development/)
- 운영 기준: [operations](/work/develop/operations/)
- 데이터 흐름: [knowledge-pipeline](/work/develop/knowledge-pipeline/)
- Claude Code + MCP: [claude-code-mcp](/work/develop/claude-code-mcp/)
- 클라이언트 규격: [mcp-client-setup](/work/develop/mcp-client-setup/)
- Codex SDK 운영안: [codex-sdk-operations](/work/develop/codex-sdk-operations/)

## 🗄️ 스토리지 운영 가이드

- [lvm-storage-pool](/work/develop/lvm-storage-pool/) — 우분투 LVM으로 외장 하드 여러 개를 하나의 스토리지 풀로 묶고 무중단 확장하기
