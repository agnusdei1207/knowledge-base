...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">dcl-grant-revoke -&gt; current scope -&gt; tcl-commit-rollba…</div></div>
</div>
</div>
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">DML (INSERT, UP… -&gt; DCL (GRANT, REV… -&gt; TCL (COMMIT, RO…</div></div>
</div>
</div>
