...
│ L3 Cache ──────│── 수천 사이클 접근 │
│ │ │ │
│ Main Memory ───│──수 나노초 접근 (DRAM) │
│ │ │ │
│ SSD/HDD ───────▼──수 마이크로초 ~ 밀리초 접근 (디스크) │
│ │
├─────────────────────────────────────────────────────────────────────────┤
│ │
│ 실제 DBMS 동작: │
...
│ 데이터베이스는 "데이터를 저장하고 관리하는 종합관리시스템"이다. │
│ │
│ 따라서: │
...
│ │ │ 모든 트랜잭션 보장 │ 지연 허용 시성능 │ │
│ ├────────────────┼─────────────────────┼─────────────────────┤ │
│ │ 쿼리 언어 │ 표준화된 SQL │ 다양하지만 비표준화 │ │
