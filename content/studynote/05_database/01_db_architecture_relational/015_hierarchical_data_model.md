...
이러한 배경에서 IBM은 북미항공우주국(Rockwell)과 협력하여 최초의 상용 DBMS인 IMS(Information [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/372_management/) System)를 개발했다. 이때 도입된 구조가 바로 계층형 [데이터 모델](/knowledge-base/studynote/05_database/01_db_architecture_relational/014_data_model_components/)(Hierarchical [Data Model](/knowledge-base/studynote/05_database/01_db_architecture_relational/014_data_model_components/))이다. 조직도나 가계도처럼 현실 세계의 많은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 '조직-부서-팀원'과 같이 하향식 [종속성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/008_dependencies/)을 가지는 것에 착안하여, 모든 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 1:N(일대다) 부모-자식 트리 형태로 모델링한 것이다.
