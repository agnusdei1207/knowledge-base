...
← **이전**: [[011_system_catalog|11. 시스템 카탈로그 (System Catalog) / 데이터 사전 (Data Dictionary) - 메타데이터(Metadata)]]
**다음**: [[013_data_directory|13. 데이터 디렉터리 (Data Directory) - 시스템만 접근 가능한 카탈로그 부분]] →
