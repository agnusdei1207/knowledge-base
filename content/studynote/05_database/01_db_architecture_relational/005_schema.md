...
- **Flyway / Liquibase** | 스키마 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/)과 변경 이력을 코드화하여 [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/)/CD 배포 과정에서 자동 적용해주는 마이그레이션 도구
