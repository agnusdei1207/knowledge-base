...
기술사 관점에서는 "실행 계획을 볼 줄 안다"보다 한 단계 더 들어가야 한다. 즉, 트리를 읽고 병목을 찾는 것에서 끝나지 않고 <strong>왜 옵티마이저가 그렇게 판단했는지</strong>, 그리고 <strong>통계·인덱스·힌트 중 무엇으로 개입할지</strong>까지 말할 수 있어야 설계 답안으로 완성된다.
