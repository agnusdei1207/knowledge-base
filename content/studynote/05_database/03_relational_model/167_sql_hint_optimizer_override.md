...
← **이전**: [[166_execution_plan_optimizer_navigation_tree|166. 실행 계획 (Execution Plan) - 옵티마이저가 생성한 네비게이션 트리]]
**다음**: [[168_clustering_factor_index_physical_alignment|168. 데이터 딕셔너리 통계 정보 (Statistics) - 테이블 건수, 블록 수, 인덱스 높이, 클러스터링 팩터 등]] →
