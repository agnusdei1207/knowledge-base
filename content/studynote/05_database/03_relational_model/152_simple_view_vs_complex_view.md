...
1. 진짜 보물(돈, 비밀번호)이 가득 찬 창고를 알바생에게 활짝 열어주면 몽땅 다 훔쳐 갈까 봐 너무 무섭잖아요? 그래서 창고 벽에 구멍을 뚫고 **'작은 투명 유리창(뷰)'**을 하나 달아줬어요.
2. 창고에 보물 상자가 딱 1개만 있어서 구경하기도 쉽고 구멍으로 물건을 넣을 수도 있는 걸 **'단순 뷰'**라고 해요. (수정 가능!)
3. 그런데 창고 안에 보물 상자가 100개나 엉켜있고, 유리창이 무지개색으로 두껍게 덮여서 안을 구경할 수는 있지만 절대 손을 뻗어 물건을 넣거나 고칠 수는 없는 꽉 막힌 창문도 있어요. 그걸 **'복합 뷰'**라고 한답니다! (수정 절대 불가!)
