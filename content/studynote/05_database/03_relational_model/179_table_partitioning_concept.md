...
> 1. **본질**: 파티셔닝 (Partitioning)은 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)적으로 하나의 테이블을 유지하면서, 물리적으로는 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키 ([Partition](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) [Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/)) 기준으로 여러 저장 구간으로 나누어 읽기 범위와 관리 범위를 줄이는 기법이다.
> 2. **가치**: 잘 설계된 파티셔닝은 [파티션 프루닝](/knowledge-base/studynote/05_database/03_relational_model/184_partition_pruning/) ([Partition Pruning](/knowledge-base/studynote/05_database/03_relational_model/184_partition_pruning/)), [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 단위 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)·보관·삭제, [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 처리에 유리해져서 대용량 테이블의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 운영성을 함께 높인다.
> 3. **판단 포인트**: 핵심은 "[파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)을 쓰느냐"보다 "어떤 키를 어떤 단위로 자르느냐"다. 조회 조건이 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키와 어긋나거나 특정 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)에 부하가 몰리면 효과는 급격히 줄어든다.

---

## Ⅰ. 개요 및 필요성

파티셔닝은 대용량 테이블을 여러 개의 물리 구간으로 나누어 관리하는 저장 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이다. 애플리케이션과 SQL (Structured Query Language) 관점에서는 여전히 하나의 테이블처럼 보이지만, RDBMS (Relational [Database](/knowledge-base/studynote/05_database/04_transactions_concurrency/501_database/) [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/) System) 내부에서는 월별·분기별·지역별 같은 기준으로 분리된 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)에 저장된다. 즉 "테이블을 쪼갠다"기보다 <strong>한 테이블의 물리 배치를 계층화한다</strong>는 표현이 더 정확하다.
...
| :--- | :--- | :--- | :--- | :--- |
| 범위 파티셔닝 ([Range Partitioning](/knowledge-base/studynote/05_database/03_relational_model/180_range_partitioning/)) | 날짜, 금액 구간 | 시계열 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)와 보관 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)에 강함 | 특정 최신 구간에 부하 집중 가능 | 주문일자 월별 분할 |
| 목록 파티셔닝 ([List Partitioning](/knowledge-base/studynote/05_database/03_relational_model/182_list_partitioning/)) | 지역, 상태 코드 | 업무 규칙과 관리 단위가 명확함 | 코드 추가 시 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 관리 필요 | 국내/해외, 채널별 분할 |
...
- **📢 섹션 요약 비유**: 손님 명단을 정리할 때 입장 순서대로 한 권에 적는 대신, 월별 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)철로 나누면 새 손님은 맞는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)에 꽂고, 5월 손님을 찾을 때는 5월 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)만 뒤지면 된다.

---

## Ⅲ. 비교 및 연결

파티셔닝은 종종 인덱싱 (Indexing) 이나 [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/) ([Sharding](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/243_sharding_horizontal_scaling_database/)) 과 혼동된다. 하지만 셋은 해결하려는 문제가 다르다. [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/)는 "어디에 있는가"를 빠르게 찾는 구조이고, 파티셔닝은 "얼마나 넓은 공간을 읽고 관리할 것인가"를 줄이는 구조이며, [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/)은 "한 서버가 감당할 수 없는 규모를 여러 서버로 나눌 것인가"를 다루는 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 구조다.

| 구분 | [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 테이블 | 주요 목적 | 분할 단위 | 핵심 효과 |
| :--- | :--- | :--- | :--- | :--- |
| 인덱싱 (Indexing) | 하나 | 검색 경로 단축 | [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) | [선택도](/knowledge-base/studynote/05_database/03_relational_model/170_selectivity_cardinality_distribution_tuning/) 높은 조건 탐색 가속 |
| 파티셔닝 (Partitioning) | 하나 | 읽기 범위·관리 범위 축소 | [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) | 프루닝, 보관, [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/), [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)성 |
| [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/) ([Sharding](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/243_sharding_horizontal_scaling_database/)) | 여러 샤드로 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) | 서버 간 확장 | [데이터베이스 인스턴스](/knowledge-base/studynote/05_database/01_db_architecture_relational/058_database_instance_architecture/) | 용량·[처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/) 수평 확장 |
...
실무에서 가장 먼저 해야 할 질문은 "주요 조회와 주요 운영 작업이 무엇을 기준으로 움직이는가"다. 주문·[로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)·과금 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)처럼 대부분의 조회가 날짜 범위로 들어오고, 보관 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)도 월 단위로 끊긴다면 범위 파티셔닝이 자연스럽다. 반대로 특정 고객군에 부하가 몰려 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)이 중요하다면 해시 또는 복합 파티셔닝이 더 적합할 수 있다.

예를 들어 최근 24개월 주문 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)만 자주 조회하고, 25개월 이전 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 아카이브 대상인 시스템이라면 `order_date` 기준 월별 파티셔닝이 운영상 유리하다. 이 경우 월말 정산 이후 오래된 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 `DROP PARTITION` 또는 `EXCHANGE PARTITION` 으로 빠르게 분리·이관할 수 있다. 반대로 조회가 대부분 `customer_id` 기준인데 날짜 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)만 두면, 프루닝 이득은 약하고 최신 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)에 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)만 몰리는 핫스폿이 생길 수 있다.

### 기술사 판단 [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/)

1. [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키가 실제 `WHERE`, `JOIN`, 보관 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)과 일치하는가?
2. 일별·월별·분기별 중 어느 단위가 관리성과 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 수 사이 균형이 맞는가?
3. [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키 조건을 함수로 감싸지 않아 프루닝이 가능하도록 SQL 을 작성했는가?
4. 로컬 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/)와 글로벌 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) 중 [유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)과 전역 탐색 요구사항에 맞는 구조를 골랐는가?
5. 최신 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)에만 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)가 집중되는 핫 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 현상을 감당할 수 있는가?
6. [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 추가, 병합, 분할, 교체 작업의 운영 절차와 장애 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 시나리오가 준비되어 있는가?

### 자주 나오는 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 조회에 거의 쓰이지 않는 컬럼을 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키로 잡아 프루닝 효과를 못 보는 경우
- 지나치게 잘게 나누어 수천 개 이상의 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) [메타데이터 관리](/knowledge-base/studynote/16_bigdata/10_governance/203_metadata_management/) 비용이 커지는 경우
...
파티셔닝이 잘 설계되면 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/)는 필요한 구간만 읽고, 필요한 구간만 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)하고, 필요 없는 구간은 빠르게 제거할 수 있다. 그 결과 Input/Output 감소, [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 처리 효율 향상, 유지보수 시간 단축, 아카이빙 단순화 같은 효과가 함께 따라온다. 특히 대용량 이력 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에서는 "한 번의 대수술" 대신 "작은 관리 단위들의 일상 운영"으로 문제를 바꿔 준다는 점이 크다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 키 ([Partition](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) [Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/)) | 행이 어느 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)에 저장될지 결정하는 기준 컬럼 |
| [파티션 프루닝](/knowledge-base/studynote/05_database/03_relational_model/184_partition_pruning/) ([Partition Pruning](/knowledge-base/studynote/05_database/03_relational_model/184_partition_pruning/)) | 조회 시 불필요한 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)을 제외해 읽기 범위를 줄이는 핵심 최적화 |
| 로컬 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) (Local [Index](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/)) | [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)과 함께 관리되어 유지보수에 유리한 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) 구조 |
| 글로벌 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) ([Global Index](/knowledge-base/studynote/05_database/03_relational_model/185_global_vs_local_index/)) | 여러 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)을 가로지르는 탐색과 전역 제약에 유리한 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) 구조 |
| 복합 파티셔닝 ([Composite Partitioning](/knowledge-base/studynote/05_database/03_relational_model/183_composite_partitioning/)) | 보관성과 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)성을 동시에 얻기 위한 다단계 분할 방식 |
| [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 와이즈 조인 ([Partition](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)-Wise [Join](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/)) | 대응되는 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)끼리 조인해 중간 결과를 줄이는 방식 |
| 정보 수명주기 관리 (ILM, Information [Lifecycle Management](/knowledge-base/studynote/09_security/18_iot_ot_physical/927_medical_device_lifecycle/)) | [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)을 이용해 핫·[콜드 데이터](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/676_cold_data_archiving/) 배치를 운영하는 상위 개념 |
| [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/) ([Sharding](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/243_sharding_horizontal_scaling_database/)) | 인스턴스 간 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)이라는 점에서 파티셔닝과 구분되는 수평 확장 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
