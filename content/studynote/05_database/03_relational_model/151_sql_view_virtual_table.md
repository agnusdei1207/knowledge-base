...
## Ⅰ. 개요 및 왜 '뷰(View)' [인가](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/509_authorization_models_rbac_abac/)? ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) & Necessity)

뷰(View)는 쇳덩이 물리 테이블(Base Table)을 향해 뚫어놓은 투명한 가상의 창문(Window)이다. 사용자가 이 창문을 통해 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 엿보도록 필터링을 씌워주는 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 인터페이스 객체다.
...
2. <strong><a href="/knowledge-base/studynote/12_it_management/02_itsm_itil/867_dml/">DML</a> 튕겨내기 방패 (WITH CHECK OPTION 락킹 🛡️)</strong>:
...
- <strong>조회 전용 통계 뷰에 <a href="/knowledge-base/studynote/12_it_management/02_itsm_itil/867_dml/">DML</a> 무방비 방치 (<code>WITH READ ONLY</code> 누락 파국 💀)</strong>:
...
<- **이전**: [150. SQL 집합 연산자 - UNION, UNION ALL, INTERSECT, MINUS/EXCEPT](/knowledge-base/studynote/05_database/03_relational_model/150_sql_set_operators_union_intersect_minus/)
**다음**: [152. 단순 뷰 (Simple View) vs 복합 뷰 (Complex View) - DML 관통성과 논리적 환상의 두 얼굴](/knowledge-base/studynote/05_database/03_relational_model/152_simple_view_vs_complex_view/) ->
