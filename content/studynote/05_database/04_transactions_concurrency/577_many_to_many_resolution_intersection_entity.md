...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">many-to-many-reso… -&gt; current scope -&gt; supertype-subtype…</div></div>
</div>
</div>
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">팩트리스 팩트 테이블 (Fa… -&gt; 다대다 관계 해소 교차 릴레… -&gt; 수퍼타입/서브타입 데이터 물…</div></div>
</div>
</div>
