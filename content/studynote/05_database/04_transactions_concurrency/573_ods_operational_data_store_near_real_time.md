...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">ods-operational-d… -&gt; current scope -&gt; conformed-dimensi…</div></div>
</div>
</div>
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">데이터 옵스 자동화 테스트 … -&gt; ODS 준실시간 스냅샷 레코… -&gt; 데이터 마트 콘포밍 차원 (…</div></div>
</div>
</div>
