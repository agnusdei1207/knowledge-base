...
← **이전**: [[077_user_defined_integrity_check_trigger|77. 사용자 정의 무결성 (User-defined Integrity) - 업무 규칙에 따른 제약 (CHECK 제약조건 등)]]
**다음**: [[079_null_integrity_not_null|079. NULL 무결성과 NOT NULL 제약조건]] →
