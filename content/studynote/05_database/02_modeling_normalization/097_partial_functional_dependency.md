...
> 1. **본질**: 부분 함수적 종속 (Partial Functional Dependency)은 테이블의 [기본 키](/knowledge-base/studynote/05_database/02_modeling_normalization/070_primary_key_alternate_key/)(PK)가 복합키일 때, 일반 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/)이 복합키 전체가 아닌 일부 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/)에만 종속되어 값이 결정되는 기형적 현상이다.
> 2. **가치**: 이 [종속성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/008_dependencies/)을 방치하면 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 중복으로 인한 저장 공간 낭비와 [갱신 이상](/knowledge-base/studynote/05_database/02_modeling_normalization/093_update_anomaly/) ([Update Anomaly](/knowledge-base/studynote/05_database/02_modeling_normalization/093_update_anomaly/)) 등 치명적인 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 모순이 발생한다.
> 3. **판단 포인트**: 이를 해결하기 위해 부분 종속된 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/)을 별도의 테이블로 분리하는 과정이 [제2정규형](/knowledge-base/studynote/05_database/02_modeling_normalization/104_second_normal_form_2nf_full_fd/) ([2NF](/knowledge-base/studynote/05_database/02_modeling_normalization/104_second_normal_form_2nf_full_fd/))이며, [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 최적화와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) 사이의 설계 트레이드오프를 결정하는 핵심 기준이 된다.
...
| **종속 구조** | 복합키의 **일부** $\rightarrow$ 일반 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) | 일반 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) $\rightarrow$ 다른 일반 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) |
| **해결 방법** | [제2정규형](/knowledge-base/studynote/05_database/02_modeling_normalization/104_second_normal_form_2nf_full_fd/) ([2NF](/knowledge-base/studynote/05_database/02_modeling_normalization/104_second_normal_form_2nf_full_fd/)) 적용 | [제3정규형](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/) ([3NF](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/)) 적용 |
| **영향도** | 레코드 추가 시 복합키 제약 조건 위배([삽입 이상](/knowledge-base/studynote/05_database/02_modeling_normalization/091_functional_dependency_fd/)) 유발 | [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) 간 논리적 계층 파괴 |

[데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 모델링 관점에서, 부분 종속을 제거하는 것은 테이블의 '주제'를 명확히 하는 과정이다. 학생 정보와 수강 정보가 한 테이블에 섞여 있던 것을, 학생 테이블과 수강 테이블로 분리하여 각 테이블이 하나의 명확한 엔티티를 나타내도록 만든다.
...
실무에서 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 테이블을 설계할 때 복합키를 사용한다면 무조건 부분 종속 발생 여부를 의심해야 한다.

### [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/) ([2NF](/knowledge-base/studynote/05_database/02_modeling_normalization/104_second_normal_form_2nf_full_fd/) 위배 판별법)
...
부분 함수적 종속을 도려내는 제2정규화 과정을 거치면, [릴레이션](/knowledge-base/studynote/05_database/02_modeling_normalization/061_relation_schema_instance/)은 [갱신 이상](/knowledge-base/studynote/05_database/02_modeling_normalization/093_update_anomaly/) ([Update Anomaly](/knowledge-base/studynote/05_database/02_modeling_normalization/093_update_anomaly/)), [삽입 이상](/knowledge-base/studynote/05_database/02_modeling_normalization/091_functional_dependency_fd/) (Insert [Anomaly](/knowledge-base/studynote/05_database/04_transactions_concurrency/530_anomaly/)), [삭제 이상](/knowledge-base/studynote/05_database/02_modeling_normalization/092_deletion_anomaly/) (Delete [Anomaly](/knowledge-base/studynote/05_database/04_transactions_concurrency/530_anomaly/))의 굴레에서 벗어난다. 테이블은 각자의 고유한 관심사에 집중하게 되며, 저장 공간의 낭비도 획기적으로 줄어든다.

그러나 [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/)로 인해 테이블이 분할되면 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 조회할 때 필연적으로 조인([Join](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/)) 비용이 발생한다. 따라서 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 전문가는 테이블을 무턱대고 쪼개는 것이 아니라, 시스템의 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 위주인지 읽기 위주인지에 따라 부분 종속을 전략적으로 다룰 수 있어야 한다. 결론적으로 부분 함수적 종속은 "이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 진짜 누구의 통제를 받아야 하는가"를 묻는 뼈대 있는 질문이다.
...
← **이전**: [96. 완전 함수적 종속 (Full Functional Dependency)](/knowledge-base/studynote/05_database/02_modeling_normalization/096_full_functional_dependency/)
**다음**: [98. 이행적 함수적 종속 (Transitive Functional Dependency) - X->Y, Y->Z 일 때 X->Z 종속](/knowledge-base/studynote/05_database/02_modeling_normalization/098_transitive_functional_dependency/) →
