...
| 표기법 | 카디널리티 | [식별](/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/)/비식별 | 도구 |
|:---|:---|:---|:---|
| **IE** | 까마귀발 | 실선/점선 | <strong>ERwin, <a href="/studynote/12_it_management/03_ea_isp/104_da_as_is_analysis/">DA</a>#</strong> |
| **Barker** | 원·바 | 라인 스타일 | <strong><a href="/studynote/05_database/03_relational_model/188_pl_sql_t_sql_procedural/">Oracle</a> Designer</strong> |
| **IDEF1X** | ●·◇ | 원형 마크 | **ERwin** |
...
| **Barker** | [Oracle](/studynote/05_database/03_relational_model/188_pl_sql_t_sql_procedural/) 표기법 |
| **IDEF1X** | 국방 표준 |
| **카디널리티** | 1:1, 1:N, M:N |
| **ERwin** | 대표 모델링 도구 |
...
<- **이전**: [129. ORM & 임피던스 불일치 (Object-Relational Mismatch)](/studynote/05_database/02_modeling_normalization/129_orm_impedance_mismatch/)
**다음**: [131. SQL 표준 (ANSI/ISO SQL) - 관계형 데이터베이스 질의 언어 표준](/studynote/05_database/03_relational_model/131_sql_ansi_iso_standard/) ->
