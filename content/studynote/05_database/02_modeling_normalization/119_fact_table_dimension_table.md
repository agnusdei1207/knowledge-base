...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [팩트 테이블](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/210_fact_dimension_table_snowflake_schema/)은 **비즈니스 이벤트의 측정값(매출액·수량·클릭 수)**을 저장하는 대용량 테이블이고, 디멘전 테이블은 **분석 축(날짜·상품·고객·지역)**의 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/)을 저장하는 마스터 테이블이다.
> 2. **가치**: "2024년 1월 서울 매장의 전자제품 매출"을 분석할 때, 팩트(매출)에 디멘전(날짜·지역·카테고리)을 **JOIN하면 자유로운 다차원 분석([OLAP](/knowledge-base/studynote/12_it_management/05_security_compliance/316_olap/) Cube)**이 가능하다.
...
| 유형 | 설명 | 예 |
|:---|:---|:---|
| **[Transaction](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)** | 이벤트 발생 시마다 1행 | 주문·클릭 |
| **Periodic [Snapshot](/knowledge-base/studynote/02_operating_system/10_security/637_zfs_snapshot_cow_architecture/)** | 정해진 주기로 [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) | 월말 재고·잔액 |
| **Accumulating [Snapshot](/knowledge-base/studynote/02_operating_system/10_security/637_zfs_snapshot_cow_architecture/)** | 프로세스 전체 추적 | 주문→배송→반품 |
...
- **Natural [Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/)** (상품코드 "P001"): 비즈니스 의미 있음, 변경 가능.
- **[Surrogate Key](/knowledge-base/studynote/12_it_management/05_security_compliance/314_surrogate_key/)** (자동증가 정수): [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 내부 전용, **[SCD](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/277_scd_slowly_changing_dimension_modeling/) Type 2에 필수**.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)** | 팩트 중심 + 1단 디멘전 [JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/) |
| **[SCD](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/277_scd_slowly_changing_dimension_modeling/)** | 디멘전 변경 이력 관리 |
| **[Surrogate Key](/knowledge-base/studynote/12_it_management/05_security_compliance/314_surrogate_key/)** | [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 디멘전의 내부 PK |
| **[OLAP](/knowledge-base/studynote/12_it_management/05_security_compliance/316_olap/) Cube** | 팩트+디멘전으로 구성하는 다차원 분석 |
