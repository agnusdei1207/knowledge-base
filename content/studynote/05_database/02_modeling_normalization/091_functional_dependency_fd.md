...
← **이전**: [[090_anomaly_insertion_deletion_update|90. 이상 현상 (Anomaly) - 정규화를 거치지 않아 발생하는 데이터 중복에 따른 부작용]]
**다음**: [[092_deletion_anomaly|92. 삭제 이상 (Deletion Anomaly) - 연쇄 삭제로 인해 필요한 데이터까지 소실되는 현상]] →
