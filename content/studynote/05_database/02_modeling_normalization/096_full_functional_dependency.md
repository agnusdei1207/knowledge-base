...
← **이전**: [[095_determinant_dependent|95. 결정자 (Determinant) X / 종속자 (Dependent) Y]]
**다음**: [[097_partial_functional_dependency|97. 부분 함수적 종속 (Partial Functional Dependency) - 복합키의 일부 속성에만 종속]] →
