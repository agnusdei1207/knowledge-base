...
← **이전**: [[091_functional_dependency_fd|91. 삽입 이상 (Insertion Anomaly) - 불필요한 데이터까지 함께 삽입해야 하는 현상]]
**다음**: [[093_update_anomaly|93. 갱신 이상 (Update Anomaly) - 중복 데이터 중 일부만 갱신되어 데이터 불일치 발생]] →
