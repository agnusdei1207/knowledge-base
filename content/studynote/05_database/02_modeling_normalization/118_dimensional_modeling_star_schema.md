...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 차원 모델링은 [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/))에서 **분석 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 극대화**하기 위해, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 **[팩트 테이블](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/210_fact_dimension_table_snowflake_schema/)(측정값)과 디멘전 테이블(분석 축)**로 구성하는 설계 기법이다.
> 2. **가치**: [3NF](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/) [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/)는 OLTP에 최적이지만, 분석 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)([GROUP BY](/knowledge-base/studynote/05_database/04_transactions_concurrency/522_group_by/)·SUM·AVG)에는 JOIN이 과다하여 느리다. 차원 모델링은 **비정규화된 디멘전**으로 JOIN을 최소화하여 **[쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) 속도를 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)~100배 향상**시킨다.
> 3. **판단 포인트**: **[스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)(팩트 중심 1단계 [JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/))**와 **[스노우플레이크 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/335_snowflake_schema/)(디멘전 [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/), 다단계 [JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/))**를 구분하고, 현대 컬럼 스토어([BigQuery](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/263_storage_compute_separation_bigquery/)·[Snowflake](/knowledge-base/studynote/05_database/04_transactions_concurrency/541_cassandra/))에서는 [스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)가 사실상 표준이다.
...
| **[JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/)** | **1단계** | 다단계 |
| **[쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) 속도** | **빠름** | 느림 |
| **중복** | 있음 | 최소 |
| **현대 [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)** | **표준** | 드물게 사용 |
...
|:---|:---|:---|
| **목적** | [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/) [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) | **분석 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)** |
| **[JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/)** | 많음 | **최소** |
| **중복** | 없음 | 허용 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[팩트 테이블](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/210_fact_dimension_table_snowflake_schema/)** | 측정값(매출·수량) 저장 |
| **디멘전 테이블** | 분석 축(날짜·상품·고객) |
| **[스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)** | 팩트 중심 1단계 [JOIN](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/) |
| **[SCD](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/277_scd_slowly_changing_dimension_modeling/)** | 디멘전 변경 이력 관리 |
| **[Kimball](/knowledge-base/studynote/12_it_management/05_security_compliance/312_kimball/) 방법론** | 차원 모델링의 이론적 기반 |
...
3. [스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)는 일지와 사전을 **별(Star) 모양으로 연결**해서 빠르게 분석할 수 있게 한 거예요!
