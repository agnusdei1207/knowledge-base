...
| C | 분석 항목 |
|:---|:---|
| **[Customer](/knowledge-base/studynote/12_it_management/01_governance_strategy/026_three_c_analysis/)** | 고객 세그먼트, 니즈, 구매 기준, 불만, 트렌드 |
...
| 비교 | 3C | SWOT | 5 Forces |
|:---|:---|:---|:---|
| 초점 | [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 포지셔닝 | 내외부 요인 | 산업 매력도 |
| 관점 수 | 3개 | 4개 | 5개 |
| 결과물 | 차별화 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | 4가지 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | 투자 결정 |
| 깊이 | 고객 심층 분석 | 균형 분석 | [구조적 분석](/knowledge-base/studynote/04_software_engineering/03_design_architecture/143_structured_analysis_dfd_dd_minispec/) |

- **📢 섹션 요약 비유**: 3C·SWOT·5Forces는 사업 조사 세 방식이다. 3C(고객·경쟁·나 삼각 비교), SWOT(내외부 4분면 분석), 5Forces(산업 구조 분석)는 서로 보완하는 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)다.

---

## Ⅳ. 실무 적용 및 기술사 판단

### IT [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)에서 3C 적용
...
| 기대효과 | 내용 |
|:---|:---|
| **명확한 포지셔닝** | 3개 교차점에서 차별화 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 도출 |
| **고객 중심** | 경쟁 분석보다 고객 니즈 우선 |
| **[전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)** | 자사 역량과 시장 기회 정렬 |

디지털 시대에는 4C(+Community 또는 +Channel)로 확장되기도 한다. [플랫폼 비즈니스](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/072_platform_business_two_sided_market/)에서 커뮤니티(Community)가 핵심 경쟁 우위가 되고(Airbnb·Uber의 [네트워크 효과](/knowledge-base/studynote/12_it_management/05_security_compliance/253_network_effect_metcalfe/)), 디지털 채널(Channel) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 전통 3C만큼 중요해졌다.
...
| **[STP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/570_stp_vs_mtp/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)** | 3C 후 시장 세분화·타깃팅·포지셔닝 |
| **PMF** | 고객 니즈와 제품 일치 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) |
| **4C** | 커뮤니티·채널 추가 확장 |
