...
- **📢 섹션 요약 비유**: MBO는 마라톤 코치와 선수가 함께 "이번 대회에서 3시간 30분 안에 완주"라는 목표를 세우고, 중간에 체크포인트를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하면서 달리는 것이다. 목표가 명확하면 선수는 자기 페이스로 자율적으로 훈련할 수 있다.
...
| **도전성** | 현실적 달성 목표 | 도전적 목표 (70% = 성공) | [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 목표 달성 |
...
2. 목표가 명확하면 학생은 스스로 공부 계획을 세우고, 중간에 얼마나 달성했는지 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)할 수 있어요.
