...
1. **Planner (기획자/경영진)**: 범위/문맥 파악 ([Scope](/knowledge-base/studynote/09_security/05_web_app_security/512_oauth_scope/)). 비즈니스 목표와 투자 대비 효과([ROI](/knowledge-base/studynote/12_it_management/01_governance_strategy/807_roi_return_on_investment/)).
...
* <strong><a href="/knowledge-base/studynote/12_it_management/03_ea_isp/110_enterprise_architecture_ea/">EA</a> (<a href="/knowledge-base/studynote/12_it_management/01_governance_strategy/806_ea_enterprise_architecture/">Enterprise Architecture</a>)</strong> | 기업의 비즈니스와 IT 자산을 구조화하는 전체 학문 영역으로 잭맨이 그 창시적 토대를 제공
