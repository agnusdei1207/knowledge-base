...
기술사 답안 작성 시 <strong>캐스케이딩 (Cascading)</strong>을 반드시 언급해야 한다. 전사 전략 체계도를 부서·팀·개인 수준의 하위 체계도로 세분화하여, 최하위 개인의 목표가 최상위 재무 목표와 논리적으로 연결되도록 계층화하는 것이 전략 실행력을 담보하는 핵심 운영 기법이다.
