...
> 3. 성장 엔진 선택(바이럴 vs 스티키 vs 유료)이 [[459_quic_fec_forward_error_correction|초기]] 단계에서 가장 중요한 [[268_strategy_pattern|전략]] 결정이며, 잘못된 성장 엔진으로 지표를 최적화하면 후기에 완전히 다른 조직 역량이 필요하게 된다.
...
> 📢 **섹션 요약 비유**: PMF는 마라톤 선수가 "페이스가 잡혔다"는 느낌 — 수치(심박수, 페이스)로 [[396_validation|확인]]하기 전에도 느낌이 달라짐.

---

## [[288_version_ihl_tos_total_length|IV]]. 성장 엔진 3가지
...
> 📢 **섹션 요약 비유**: BML은 요리 레시피 실험 — 알림(재료) 추가 후 손님 재방문율(측정) [[396_validation|확인]], 재료 비율 조정(학습)을 반복해 최고의 레시피 완성.
