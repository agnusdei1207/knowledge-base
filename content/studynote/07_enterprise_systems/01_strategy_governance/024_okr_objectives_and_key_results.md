...
- **📢 섹션 요약 비유**: OKR은 마라톤 페이스 목표(달성률 70%면 훌륭), KPI는 혈압·맥박 [모니터](/knowledge-base/studynote/02_operating_system/04_synchronization/229_monitor/)링([현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/) 측정), MBO는 연말 성과급 계약(반드시 달성해야 하는 약속)이다.

---

## Ⅲ. 비교 및 연결

OKR의 "O는 정성적, KR은 정량적" 원칙은 [BSC](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)(Balanced Scorecard)의 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 맵과 결합하면 강력하다. BSC가 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)의 4대 관점(재무·고객·내부 프로세스·학습)을 제공하고, OKR이 각 관점의 분기 도전 목표를 운영한다.

- **📢 섹션 요약 비유**: BSC는 지도([전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)의 전체 그림)이고 OKR은 GPS 내비게이션(다음 분기의 구체적 경로)이다. 지도 없이 내비게이션만 쓰면 방향을 잃고, 내비게이션 없이 지도만 보면 현재 위치를 모른다.
...
1. OKR은 반 전체가 "이번 학기에 영어 말하기 대회 우승하자(O)"라는 꿈을 세우고, "매주 영어 일기 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)(KR1), 원어민 선생님과 주 2회 대화(KR2)"처럼 구체적 약속을 정하는 것이에요!
...
← **이전**: [23. 전략 체계도 (Strategy Map)](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/023_strategy_map/)
**다음**: [25. MBO (Management by Objectives) — 목표 관리](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/025_mbo_management_by_objectives/) →
