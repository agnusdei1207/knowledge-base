...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 마이클 포터(Michael Porter)의 [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/)([Value Chain](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/)) 분석에서 본원적 활동(Primary Activities)은 제품·[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)의 물리적 생산, 판매, 배송, 사후 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)에 직접 관여하는 5가지 활동(내부 물류·운영·외부 물류·마케팅·[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/))으로 구성된다.
> 2. **가치**: 각 본원적 활동에서 비용 우위 또는 차별화를 달성하는 것이 경쟁 우위의 원천이다. 5가지 활동 중 어느 단계에서 경쟁자보다 더 잘하거나 더 싸게 할 수 있는가가 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 분석의 핵심이다.
> 3. **판단 포인트**: [디지털 전환](/knowledge-base/studynote/12_it_management/01_governance_strategy/055_digital_transformation/)(DT) 맥락에서 [가치 사슬 분석](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/)은 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/)·클라우드·[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 각 본원적 활동을 어떻게 강화하는가를 분석하는 틀로 활용된다. IT 투자 우선순위를 결정할 때 "어느 활동의 디지털화가 가장 큰 가치를 창출하는가"를 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/)한다.
...
| 활동 | 정의 | IT 디지털화 예시 |
|:---|:---|:---|
| **내부 물류** | 원재료·부품 수입, 보관, 분배 | [WMS](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/097_wms_warehouse_management_system/)(창고관리시스템), [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 재고 |
...
| 비교 | 비용 우위 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | 차별화 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
|:---|:---|:---|
| **내부 물류** | JIT로 재고 최소화 | 신속 조달로 리드타임 단축 |
| **운영** | 자동화로 생산 비용 절감 | [커스터마이즈](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/091_kustomize_kubernetes_declarative_overlay_manifest/) 생산 |
| **마케팅** | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 기반 타기팅 광고 | 브랜드 프리미엄 구축 |

- **📢 섹션 요약 비유**: 비용 우위는 더 싸게 만드는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)(삼성 [반도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/009_semiconductor/) 대량 생산), 차별화는 더 특별하게 만드는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)(애플 디자인)이다. [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) 각 단계에서 어느 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)을 선택하느냐가 기업 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)을 결정한다.

---

## Ⅳ. 실무 적용 및 기술사 판단

### DT [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 수립에서 [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) 활용
1. 각 본원적 활동의 현행 수준 평가([As-Is](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/)).
2. 디지털 기술이 어떤 활동을 강화할 수 있는가 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/).
3. 경쟁사 대비 취약한 활동에 우선 투자.
4. 디지털 [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) 목표 상태(To-Be) 설계.

예시: 제조기업 DT 우선순위
- 운영([MES](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/119_mes_manufacturing_execution_system/) + [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 품질 검사) > 내부물류([WMS](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/097_wms_warehouse_management_system/) [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/)) > [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)(예측 정비)

- **📢 섹션 요약 비유**: [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) DT 우선순위 결정은 집 수리 순서 정하기다. 지붕(운영)이 새면 먼저 고치고, 다음 창문(물류), 마지막 인테리어(마케팅) 순으로 가장 중요한 것부터 고친다.
