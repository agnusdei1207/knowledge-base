...
### 분석 [CRM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/107_crm_customer_relationship_management/) 핵심 기법

| 기법 | 목적 | 대표 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | 비즈니스 질문 |
|:---|:---|:---|:---|
...
| 비교 | 운영 [CRM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/107_crm_customer_relationship_management/) | 분석 [CRM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/107_crm_customer_relationship_management/) |
|:---|:---|:---|
| **역할** | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 수집·실행 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석·예측 |
| **사용자** | 영업·마케터·상담원 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석가·경영진 |
| **도구** | Salesforce, HubSpot | [Tableau](/knowledge-base/studynote/16_bigdata/08_visualization/164_tableau/), [Power BI](/knowledge-base/studynote/16_bigdata/08_visualization/165_power_bi/), Python |
| **출력** | 거래 기록, 캠페인 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) | 세그먼트, 이탈 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/), 추천 |
...
분석 CRM은 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)형 AI와 결합하여 "자연어로 질문하면 고객 인사이트를 즉시 답변하는" Conversational Analytics 시대로 진입하고 있다.
