...
- **회피 또는 별도 설계**: [입력 검증](/knowledge-base/studynote/09_security/uncategorized/601_input_validation/) 오류, 로컬 [함수 호출](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/294_function_calling_tool_use/), 실패를 숨기면 안 되는 금융 승인 결과 왜곡 시나리오
