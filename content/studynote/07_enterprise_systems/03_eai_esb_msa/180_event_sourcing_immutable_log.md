...
> 1. **본질**: [이벤트 소싱](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/249_event_sourcing_append_only_state_reconstruction/) ([Event Sourcing](/knowledge-base/studynote/12_it_management/05_security_compliance/307_event_sourcing/))은 [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/) 한 줄을 계속 덮어쓰는 대신, 상태를 바꾼 사건들을 시간 순서대로 불변 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) (Append-Only Log) 에 쌓고 그 합으로 현재를 계산하는 저장 모델이다.
> 2. **가치**: 왜 이런 상태가 되었는지, 어제와 오늘 사이에 무엇이 달라졌는지, 특정 시점 상태를 다시 만들 수 있는지를 정확히 추적할 수 있어 [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/)·[복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)·재현에 강하다.
> 3. **판단 포인트**: 이벤트를 진실 원천으로 삼는 대신 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 관리, [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/), 프로젝션 재생, 최종 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)까지 감당해야 한다. 따라서 이력의 의미가 큰 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)에 선택적으로 적용해야 한다.
...
| 요소 | 역할 | 설계 포인트 |
| :--- | :--- | :--- |
| 명령 처리기 ([Command](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/271_command_pattern/) Handler) | 입력 명령 수신 및 권한·형식 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) | 중복 명령 처리와 에러 모델 분리 |
| [애그리게이트](/knowledge-base/studynote/04_software_engineering/04_testing_quality/222_aggregate_ddd_transaction_consistency/) ([Aggregate](/knowledge-base/studynote/04_software_engineering/04_testing_quality/222_aggregate_ddd_transaction_consistency/)) | 과거 이벤트를 접어 현재 규칙 판단 | 불변식 보장, 명령 허용 여부 판단 |
| 이벤트 저장소 (Event Store) | 이벤트 스트림의 원본 보관 | append-only, 순서, [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 충돌 처리 |
| [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) ([Snapshot](/knowledge-base/studynote/02_operating_system/10_security/637_zfs_snapshot_cow_architecture/)) | 긴 스트림의 중간 상태 저장 | 재생 비용 절감, 저장 주기 설계 |
...
- **📢 섹션 요약 비유**: 레고 작품 사진 한 장만 남겨 두는 것이 아니라, 조립 설명서의 모든 단계를 보관하는 셈이다. 중간 완성 사진은 [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/)이고, 진짜 원본은 블록을 어떤 순서로 끼웠는지에 대한 기록이다.
...
| :--- | :--- | :--- | :--- | :--- |
| CRUD [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/) 저장 | 현재 테이블 | 단순함, 학습 비용 낮음 | 과거 맥락과 재생 능력 약함 | 일반 관리 시스템 |
| CRUD + [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) | 현재 테이블 + 보조 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) | 추적성 일부 확보 | [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)와 [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/)가 분리됨 | 기본 [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 요구 |
| [이벤트 소싱](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/249_event_sourcing_append_only_state_reconstruction/) | 이벤트 스트림 | 완전한 이력, 재생, 시점 복원 | 모델링·운영 복잡도 큼 | 금융, 주문 수명주기, 규제 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) |
| [트랜잭셔널 아웃박스](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/314_transactional_outbox_pattern/) ([Transactional Outbox](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/314_transactional_outbox_pattern/)) | [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/) + 발행용 기록 | 외부 이벤트 전달 안정화 | 저장 원천 자체는 바뀌지 않음 | [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 이벤트 발행 |
...
[이벤트 소싱](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/249_event_sourcing_append_only_state_reconstruction/)은 [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 요구가 크고, 상태 변화의 순서 자체가 업무 의미를 갖고, 나중에 새로운 읽기 모델을 다시 만들 가능성이 높은 시스템에서 빛난다. 예를 들어 결제 승인·취소·환불 흐름, 포인트 적립·차감, 주문 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)·결제·출고·반품 같은 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)은 사건의 흐름이 곧 비즈니스 설명이다. 반대로 단순 게시판 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)값처럼 "현재 값만 맞으면 되는" 영역에 적용하면 복잡도만 늘어날 수 있다.
...
1. 상태 변화 순서와 근거가 비즈니스적으로 중요한 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)인가?
2. 이벤트 이름이 기술 용어가 아니라 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 사실로 정의되어 있는가?
3. 스트림 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 충돌, 중복 명령, 프로젝션 재처리를 감당할 운영 절차가 있는가?
4. [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) 주기와 전체 재생 시간이 현실적인가?
5. 이벤트 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 변경 시 업캐스팅 (Upcasting) 또는 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 공존 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 준비되어 있는가?
6. [개인정보](/knowledge-base/studynote/09_security/16_data_privacy/781_personal_information/) 삭제 요구가 있을 때 불변 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)를 어떻게 처리할지 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)이 있는가?
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 이벤트 ([Domain](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) Event) | 비즈니스에서 실제로 일어난 사실을 과거형으로 표현한 기본 단위 |
| 이벤트 저장소 (Event Store) | 이벤트 스트림의 원본을 append-only로 보관하는 저장소 |
| [애그리게이트](/knowledge-base/studynote/04_software_engineering/04_testing_quality/222_aggregate_ddd_transaction_consistency/) 스트림 ([Aggregate](/knowledge-base/studynote/04_software_engineering/04_testing_quality/222_aggregate_ddd_transaction_consistency/) [Stream](/knowledge-base/studynote/03_network/09_application_layer_web_email/467_http2_stream_multiplexing_tcp_hol/)) | 한 업무 개체에 대한 이벤트 순서를 유지하는 단위 |
| [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) ([Snapshot](/knowledge-base/studynote/02_operating_system/10_security/637_zfs_snapshot_cow_architecture/)) | 긴 이벤트 스트림의 재생 비용을 줄이는 중간 상태 |
| 프로젝션 (Projection) | 이벤트를 현재 조회 형태로 변환하는 과정 |
| [CQRS](/knowledge-base/studynote/12_it_management/05_security_compliance/306_cqrs/) ([Command Query Responsibility Segregation](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/250_cqrs_command_query_responsibility_segregation_pattern/)) | 이벤트 기반 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 모델과 읽기 모델 분리를 자주 결합하는 패턴 |
| [낙관적 동시성 제어](/knowledge-base/studynote/05_database/04_transactions_concurrency/223_optimistic_concurrency_control_validation/) ([Optimistic Concurrency Control](/knowledge-base/studynote/05_database/04_transactions_concurrency/223_optimistic_concurrency_control_validation/)) | 스트림 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 충돌을 감지해 이벤트 순서를 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)하는 방법 |
| 업캐스팅 (Upcasting) | 오래된 이벤트를 새 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 의미로 해석하게 돕는 진화 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
...
1. [이벤트 소싱](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/249_event_sourcing_append_only_state_reconstruction/)은 지금 점수가 몇 점인지 한 줄만 적는 대신, 점수가 올라가고 내려간 모든 일을 차례대로 적는 거예요.
