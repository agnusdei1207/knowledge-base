...
> 3. **융합**: "전 세계 기업 API를 1곳에 모아 구글처럼 검색하게 하자"는 너무 거대한 야망(Public UDDI)은 XML 무거운 껍데기 랙과 해킹 보안 문제로 타 죽어 멸망(Deprecated)했지만!! 그 '중앙 장부에서 동적으로 IP를 찾아 꽂는다'는 사상 뼈대 영혼 자체는, <strong>모던 <a href="/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/532_microservices_decomposition_patterns/">마이크로서비스</a>(<a href="/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/619_msa_traffic_hardware/">MSA</a>) 클라우드 K8s 심장부의 '유레카(Netflix Eureka)와 CoreDNS'라는 초경량 <a href="/knowledge-base/studynote/12_it_management/05_security_compliance/946_service_discovery/">Service Discovery</a>(<a href="/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/306_service_discovery_pattern/">서비스 디스커버리</a> 봇) 생태계로 100% 완벽히 부활 환생(Reincarnation)</strong>하여 진정한 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)망 대통일을 완수했다.

---

## Ⅰ. 개요 및 왜 UDDI [인가](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/509_authorization_models_rbac_abac/)? ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) & Necessity)

UDDI는 "누가 어떤 비즈니스 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/))를 가졌고(Description), 그걸 어디(IP URL)로 쏘면 통신 호출할 수 있는지"를 명시한 XML 기반 거대 계약 스펙 문서([WSDL](/knowledge-base/studynote/07_enterprise_systems/03_eai_esb_msa/152_wsdl_web_services_description_language/))들을 트리 구조 카테고리(White/Yellow/Green Pages)로 예쁘게 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)해 보관하는 중앙 도서관 서버 플랫폼이다.
...
**대재앙 발동 💥**: 그 포인트 삭감 찐 로직([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/))은 이미 1년 전 재무팀 김 대리가 완벽한 무결점(Bug-free) 코드로 짜서 쇳덩이 서버에 런칭 띄워놨던 거다! 근데 그게 사내망 구석탱이에 짱박혀 있어 아무도 그 존재(Existence)를 몰랐기에 ➔ 100개 타 부서 놈들이 전부 각자 지들 뇌피셜로 포인트 빼기 똥 코드를 100번 처음부터 새로 복사 창조(Copy & Paste 떡칠) 해버렸다. 나중에 '세금 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)% 룰' 1줄 바뀌자마자 100군데 소스 일일이 다 뜯어고치다 서버 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) 뻗고 그룹사 셧다운 마비 터짐 💀.
**아키텍트 대장 극대노 십자 철퇴 (UDDI 중앙 집권 융합) 🪓!!**: "야 이 병신 [사일로](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/)([Silo](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/)) 우물 안 개구리 타자기들아!!! **하늘이 두 쪽 나도 니들이 쳐 만든 모든 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/) 기능([Service](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)) 1개 짤 때마다 무.조.건. 사내 한가운데 이 거대한 [UDDI 중앙 전화번호부 도서관 게시판] 대문 앞에다가 '나 이거 만들었음 메뉴판 주소 여깄음 ㅋ' 하고 전사 공개 퍼블리시(Publish 등록 쾅!) 록온 때려 쳐박아 놔라 쾅!!!
그리고 내일 신규 앱 짜는 놈들은 키보드 손 떼 락!! 코딩 1바이트 치기 전에!! 무조건 이 UDDI 도서관 켜서 [포인트 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)] 검색(Find 🔍)부터 눈알 빠지게 쳐 스캔 돌려!!!
...
- **[🌟 아키텍트의 메스: UDDI 런타임 0.001초 컷 핑퐁 스위칭 (Late Binding) 🚀]**:
  - "야 이 좆소 타자기 새끼들아!! 언제까지 타겟 서버 쇳덩이 IP 주소를 네 뱃속에 문신으로 새겨 락킹([Lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/)) 칠래!! **하늘이 두 쪽 나도 오늘부로 100% 소스 코드 안의 남의 집 IP 주소를 단 1바이트도 남기지 말고 싹 다 백지화(Blank) 지우개 삭제 척살시켜라 쾅!!!**"
  - 모던 [SOA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/618_soa_hardware/) 융합 소스 코드 💻: `String ip = UDDI.getIp("결제 봇"); send(ip, xml);`
  - **기적의 생존 회피 기동 발동 ✨**: 쇳덩이 서버가 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/).0.0.5 에서 ➔ [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/).0.0.6 으로 1초 만에 불타 죽고 새 놈이 팟! 부활했다!!
  이때 새 서버(.6)가 뜨는 찰나에 지 스스로 중앙 UDDI 도서관 게시판 찔러서 "야 내 주소 `.6` 으로 갱신(Update) 덮어써 쾅!" 0.001초 만에 최신화 등록 퍼블리시(Publish) 락킹 완료 컷!
  ➔ 그리고 쇼핑몰(Requester 유저 폰) 놈이 **결제 버튼을 누르는 딱 그 0.001초 유저 실행 찰나(Runtime)의 순간!!** 내 코드가 빛의 속도로 UDDI 중앙 뇌를 찔러 "방금 살아 숨 쉬는 최신 결제 주소 내놔 툭 ㅋ!" ➔ `.6` 새 주소를 허공에서 스윽 따와서 ➔ 바로 0.1초 컷으로 새 서버로 스티어링(Steering 방향 꺾기) 우회 [라우팅](/knowledge-base/studynote/03_network/07_network_layer_routing/339_routing_overview_best_path_selection/) 다이빙 1:1 타격을 다이렉트 직빵 꽂아버린다 쓩🚀!!!
...
### 2. UDDI 내부 해부 엑스레이: White/Yellow/Green Pages 3단 십자 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) 트리 맵
...
| 비교 잣대 | 🏛️ UDDI (Universal 거대 엑셀 도서관 / 낡은 관료제 💀) | ☁️ [Service Discovery](/knowledge-base/studynote/12_it_management/05_security_compliance/946_service_discovery/) (Eureka/K8s [DNS](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/511_dns_hierarchical_distributed_architecture/) 모던 봇 🚀) | 아키텍트의 파멸과 진화 타점 |
|:---|:---|:---|:---|
...
UDDI(Universal Description, Discovery and Integration)는 1,000개의 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [사일로](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/) 시스템이 얽힌 엔터프라이즈의 거미줄 폭사를 막아내기 위해 인류 아키텍트가 빼어 든 단 하나의 유일한 진리 방벽 헌법이었다.
...
[SOA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/618_soa_hardware/) 아키텍트는 이 끈적한 강결합 사슬을 도끼로 무자비하게 쳐내어 찢어발겼다. 제공자([Provider](/knowledge-base/studynote/07_enterprise_systems/03_eai_esb_msa/150_soa_triangle_architecture/))는 내가 오늘 밤 어디로 이사했는지(IP 변경) 오직 중앙 도서관([Registry](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) UDDI) 1곳 게시판에만 조용히 텍스트 덮어쓰기 등록(Publish 갱신)하고 빠진다. 요청자(Requester)의 소스 코드는 타겟의 찐 주소(쇳덩이)가 아니라 오직 "결제 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)가 필요하다"는 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)적 추상 갈망(Name) 텍스트 1줄만을 품고 컴파일(Compile)되어 백지화 상태로 기다린다.
