...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">EAI vs ESB topology</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">EAI (hub-and-spoke)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">App A ----\</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">Integration Hub</div><div class="kb-diagram-connector">→</div><div class="kb-diagram-note">target apps</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">App C ----/ transform / route / control</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">ESB (service bus)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Service A --+</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">Bus / mediation / standards</div><div class="kb-diagram-connector">←</div><div class="kb-diagram-note">-+</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Service C --+ SOAP / REST / JMS / XML ----+</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">Point-to-Point integration</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">EAI (hub-centric integration)</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">ESB (SOA service bus)</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">API Gateway + Event Broker + iPaaS</div>
</div>
</div>
