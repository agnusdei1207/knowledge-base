...
- **📢 섹션 요약 비유**: [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)는 모든 직원이 직접 외부 전화, 보안 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/), 통화 녹취를 처리하던 회사를, 각자 옆에 전문 비서를 붙여 통화 절차를 맡기는 방식으로 바꾸는 것과 같다. 직원은 본업에 집중하고, 비서는 통화 규칙을 통일한다.
...
- **📢 섹션 요약 비유**: [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)는 각 지점에 배치된 경비원들이 스스로 규칙을 정하는 조직이 아니라, 본사 관제실이 경비 규칙과 출입증을 일괄 배포하는 체계와 같다. 현장에서 움직이는 것은 경비원이지만, 규칙을 바꾸는 힘은 중앙 관제에 있다.

---

## Ⅲ. 비교 및 연결

[서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)는 [Application Programming Interface](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) ([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)) Gateway와 자주 혼동되지만 담당하는 위치가 다르다. [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 게이트웨이는 외부 클라이언트가 내부 시스템으로 들어오는 북-사우스 트래픽의 진입점을 주로 다루고, [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)는 내부 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)끼리 오가는 이스트-웨스트 트래픽을 다룬다. 따라서 둘은 경쟁 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)라기보다 서로 다른 경계에 놓인 보완 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)다.

또한 도입 시에는 "[서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)를 쓸까 말까"뿐 아니라 "Istio와 Linkerd 중 무엇을 고를까"도 함께 판단해야 한다.

| 항목 | [Istio](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/) | Linkerd |
| :--- | :--- | :--- |
...
| [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 게이트웨이 ([API Gateway](/knowledge-base/studynote/04_software_engineering/11_testing_validation/542_api_gateway/)) | 외부 진입 트래픽을 다루며 [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)와 다른 경계를 담당하는 보완 기술 |
...
1. [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)는 친구들이 서로 직접 뛰어다니며 쪽지를 주는 대신, 모두 옆에 전달 도우미를 붙여서 쪽지를 주고받는 방법이에요.
