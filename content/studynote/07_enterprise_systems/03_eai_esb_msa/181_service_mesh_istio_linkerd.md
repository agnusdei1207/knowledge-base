...
← **이전**: [[180_event_sourcing_immutable_log|180. 이벤트 소싱 (Event Sourcing) - 상태 변경 이벤트를 불변 로그 (Append-Only Log) 로 저장]]
**다음**: [[182_sidecar_pattern_proxy_container|182. 사이드카 패턴 (Sidecar Pattern) - MSA 프록시 컨테이너]] →
