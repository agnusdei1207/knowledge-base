...
기업 정보화 투자 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)폴리오 관리, 즉 IT PPM은 조직 내 IT 과제들을 하나의 투자 묶음으로 보고 우선순위와 자원 배분을 조정하는 관리 체계다. 프로젝트가 개별적으로 잘 수행되는지보다, 그 프로젝트들의 조합이 회사 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)과 얼마나 맞는지를 묻는다는 점에서 프로젝트 관리와 다르다.
...
| :-- | :-- | :-- | :-- | :-- |
| 운영 (Run) | 현재 사업 안정성 유지 | [ERP](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/081_erp_enterprise_resource_planning/), 보안 패치, 규제 대응 | 가동률, 장애 감소, [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 통과 | 부족하면 현재 수익이 흔들림 |
| 확장 (Grow) | 기존 사업 성과 확대 | 채널 고도화, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석, 고객 기능 개선 | 매출 증대, 전환율, 생산성 | 너무 적으면 경쟁력 둔화 |
| 혁신 (Transform) | 미래 사업 모델 탐색 | [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 신사업, 신규 플랫폼, 개념 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) (PoC, Proof of [Concept](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/)) | 학습 속도, 시장 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/), 옵션 가치 | 과도하면 실패 비용 증가 |

예산 버킷은 고정 비율 공식이 아니라 기업 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)과 시장 상황에 따라 달라진다. 다만 중요한 것은 세 버킷이 명시적으로 분리되어야 한다는 점이다. 그래야 운영 이슈가 혁신 예산을 잡아먹는 현상이나, 반대로 화려한 실험이 필수 운영투자를 잠식하는 현상을 막을 수 있다.
...
| 자원 관점 | 개별 팀 일정 중심 | 전사 예산과 인력 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)폴리오 | 가치 흐름 단위의 지속 투자 |
...
1. 이 과제는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 목표와 직접 연결되는가, 아니면 단순 희망사항인가?
2. 재무 지표 외에 규제 대응·보안 필수성·브랜드 영향 같은 비재무 가치가 있는가?
3. 핵심 병목 자원을 실제로 투입할 수 있는가?
4. 최소 기능 제품 ([MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/), [Minimum Viable Product](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/)) 수준으로 먼저 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 가능한가?
...
IT PPM이 정착하면 중복 투자가 줄고, 우선순위 결정 근거가 투명해지며, 핵심 인력이 가장 가치 큰 과제에 먼저 배치된다. 결과적으로 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 과제의 시장 출시 속도, 예산 사용 효율, 경영진과 IT 간 정렬 수준이 좋아진다. 운영·확장·혁신 예산을 분리해 보는 것만으로도 조직은 "왜 이 과제에 돈을 쓰는가"를 더 명확히 설명하게 된다.
