...
[가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) ([Virtual Memory](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/))는 CPU (Central Processing Unit)가 생성한 가상 주소를 물리 메모리의 실제 주소로 변환해 사용하는 메모리 관리 방식이다. 핵심은 프로그램이 “연속적이고 넓은 개인 메모리”를 쓰는 것처럼 보이게 만들면서, 실제 하드웨어는 여러 프로세스의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 잘게 나누어 공유한다는 점이다. 즉, [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)는 단순한 저장 공간 확장이 아니라 <strong>주소 <a href="/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/">추상화</a> + <a href="/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/">보호</a> + 적재 <a href="/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/">지연</a></strong>을 묶은 시스템 설계다.
...
따라서 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)를 이해할 때는 “디스크를 램처럼 쓰는 기술”이라는 축약 설명만으로는 부족하다. 더 정확한 관점은 <strong>프로그램의 <a href="/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/">논리</a> 세계와 하드웨어의 물리 세계를 분리하여, 둘 사이를 <a href="/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/">운영체제</a> (<a href="/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/">Operating System</a>)와 메모리 관리 장치가 중재하는 구조</strong>라고 보는 것이다.
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">가상 주소가 실제 데이터가 되기까지의 경로</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">CPU가 가상 주소 생성</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">VPN | Offset</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">TLB 조회 TLB Hit ▶ 물리 주소 생성</div></div>
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">── Present = 1</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">── Present = 0 ─▶ Page Fault ─▶ OS 처리 ─▶ 디스크에서 Page-In</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">── PTE 갱신 후 명령 재시도</div></div>
</div>
</div>
...
실무에서 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)는 “있으면 좋은 기능”이 아니라 시스템 성격에 따라 설계 전략이 갈리는 핵심 정책이다. 범용 서버와 데스크톱은 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)를 적극 활용해 높은 [멀티태스킹](/knowledge-base/studynote/02_operating_system/11_exam_summary/675_multitasking_terminology_preemptive/)과 격리를 얻지만, 실시간 제어 시스템은 예측 불가능한 [페이지 부재](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/)를 위험 요소로 본다. 즉, 중요한 질문은 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)를 쓸지 말지가 아니라 <strong>어디까지 <a href="/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/">동적 적재</a>를 허용할지</strong>다.
...
1. <strong><a href="/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/138_response_time/">응답 시간</a> 예측 가능성이 최우선이면</strong> 핵심 코드와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 고정([lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/))하거나 [페이지 부재](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/)를 사실상 금지해야 한다.
...
3. <strong><a href="/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/">페이지 크기</a> 선택에서는</strong> 작은 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 내부 [단편화](/knowledge-base/studynote/03_network/06_network_layer_ip/291_fragmentation_and_reassembly_process/)를 줄이지만 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)과 [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 부담을 키우고, 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 효율을 높이지만 낭비와 입출력 증폭을 만들 수 있다.
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">오버레이 (Overlay) · 고정 분할 메모리</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">가상 주소 / 물리 주소 분리</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">페이징 (Paging) · 페이지 테이블 (Page Table)</div>
<div class="kb-diagram-connector">▼</div>
...
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">워킹 셋 (Working Set) · 스래싱 (Thrashing) 제어</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">메모리 맵 파일 · Huge Page · 가상화 이중 페이징</div>
</div>
</div>
