...
[페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리 과정 ([Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/) Handling)은 프로세스가 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)한 가상 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 현재 물리 메모리에 존재하지 않을 때, 메모리 관리 장치 ([Memory Management Unit](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/284_mmu/), [MMU](/knowledge-base/studynote/02_operating_system/06_memory_management/328_mmu/))가 예외를 발생시키고 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)가 해당 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 적재한 뒤 중단된 명령을 다시 실행하게 만드는 절차다. 이름만 보면 오류처럼 들리지만, [요구 페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/) ([Demand Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/)) 환경에서는 오히려 정상 동작의 일부다. 즉 "필요해질 때까지 안 올린다"는 전략이 실제로 성립하려면, 필요해진 순간을 감지하고 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)하는 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리 과정이 반드시 있어야 한다.
...
[페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)가 발생하면 하드웨어와 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)는 역할을 나눠 움직인다. CPU는 명령을 실행하다가 가상 주소를 내고, MMU는 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 엔트리 ([Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) Entry, PTE)와 변환 색인 버퍼 ([Translation Lookaside Buffer](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/291_tlb/), [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/))를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)한다. 이때 유효 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/)가 꺼져 있거나 접근 권한이 맞지 않으면 프로세서는 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 예외를 발생시키고 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 모드로 전환한다. 이후 실제 적재, 희생 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 선정, [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 갱신은 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)의 책임이다.

| 구성 요소 | 역할 | 병목 또는 판단 포인트 |
| :-- | :-- | :-- |
| CPU | 실패한 메모리 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 명령 실행 주체 | 중단된 명령을 정확히 재시작할 수 있어야 함 |
| [MMU](/knowledge-base/studynote/02_operating_system/06_memory_management/328_mmu/) | [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 존재 여부와 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/) [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) 판정 | 예외 원인 구분 [정확성](/knowledge-base/studynote/16_bigdata/01_intro/002_bigdata_5v/) |
| [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) | 최근 주소 변환 캐시 | 적재 후 무효화 또는 재적재 필요 |
| [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 핸들러 | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)의 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 루틴 | 자유 프레임 확보, 예외 종류 판별 |
| 저장장치 | 누락된 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)의 원본 보관 | 밀리초 단위 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)이 전체 비용 지배 |
...
- **📢 섹션 요약 비유**: [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리의 핵심 원리는 주방 주문 사고 처리와 같다. 재료가 없으면 먼저 "손님이 잘못 주문한 것인지, 창고에서 꺼내 오면 되는 것인지"를 구분하고, 꺼내 와야 한다면 빈 조리대 확보부터 주문 재개까지 순서대로 맞춰야 주방이 엉키지 않는다.

---

## Ⅲ. 비교 및 연결

[페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)는 모두 같은 무게를 갖지 않는다. [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) 관점에서는 크게 경미한 폴트 ([Minor Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/429_minor_vs_major_page_fault/))와 주요 폴트 (Major [Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/))로 나눠 생각하는 것이 실무적이다. 경미한 폴트는 실제 저장장치 입출력이 없이 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)만 보정하거나 이미 메모리에 있는 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 다시 연결하는 경우이고, 주요 폴트는 저장장치에서 실제로 읽어 와야 하는 경우다. 체감 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 차이는 여기서 극단적으로 벌어진다.

| 항목 | 경미한 폴트 (Minor Fault) | 주요 폴트 (Major Fault) |
| :-- | :-- | :-- |
| 저장장치 입출력 | 없음 | 있음 |
| 대표 상황 | 공유 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 재연결, [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 매핑 보정 | 스왑 영역 또는 파일에서 실제 읽기 |
| [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간 | 마이크로초 수준 가능 | 수십 마이크로초 ~ 밀리초 |
| [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 영향 | 제한적 | 요청 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/), 문맥 전환 증가 |

[페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리는 [요구 페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/), [페이지 교체](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/), [스래싱](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/)과 직접 연결된다. [요구 페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/)은 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)를 "적재 [트리거](/knowledge-base/studynote/05_database/04_transactions_concurrency/507_acid_properties/)"로 사용하고, [페이지 교체](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/)는 자유 프레임이 없을 때 누굴 내보낼지 결정한다. 만약 현재 작업 집합 ([Working Set](/knowledge-base/studynote/02_operating_system/04_synchronization/265_working_set/))이 물리 메모리보다 커져 희생과 재적재가 반복되면, [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리는 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 메커니즘이 아니라 병목 메커니즘으로 변질된다. 그 상태가 바로 [스래싱](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/)이다.

또한 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)는 캐시 미스와도 닮았지만 층위가 다르다. 캐시 미스는 보통 같은 메모리 계층 안에서 더 느린 계층을 조회하는 문제지만, [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)는 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) 개입과 저장장치 입출력을 동반할 수 있어 비용 규모가 훨씬 크다. 그래서 "미스가 좀 늘었다" 수준으로 다루면 안 되고, 시스템 응답성 전체를 흔드는 사건으로 봐야 한다.
...
실무에서 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리는 "발생했는가"보다 "어떤 종류가 얼마나 자주 발생하는가"를 봐야 한다. 예를 들어 애플리케이션 서버가 배포 직후 첫 요청에서 느린 것은 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 주요 폴트가 몰렸기 때문일 수 있다. 이때는 단순 CPU 튜닝보다 워밍업 요청, 자주 쓰는 파일의 선행 적재, 메모리 여유 확보가 더 직접적인 해결책이 된다. 반대로 상시 운영 중에도 major fault가 높게 유지된다면, 이는 이미 작업 집합이 메모리에 안정적으로 안착하지 못하고 있다는 신호다.

### 기술사 판단 [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/)

1. [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)가 정상적인 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 적재인지, 메모리 압박 때문에 반복되는 병목인지 구분했는가?
2. 자유 프레임 부족이 지속된다면 [페이지 교체](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)보다 먼저 물리 메모리 용량과 프로세스 밀도를 점검했는가?
3. [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 민감 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)라면 메모리 고정 (Memory [Locking](/knowledge-base/studynote/05_database/04_transactions_concurrency/213_locking_mechanism_concurrency_control/))이나 프리페치로 주요 폴트를 회피해야 하지 않는가?
4. 더티 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (Dirty [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)) 비율이 높아 [page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)-out 비용까지 커지고 있지는 않은가?
...
- **📢 섹션 요약 비유**: [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리는 무대 뒤 스태프와 같다. 배우는 무대 위에서 자연스럽게 연기하지만, 소품이 비는 순간 뒤에서 재빨리 채워 넣어 주지 못하면 공연 전체가 멈춰 버린다.
...
| 개념 | 연결 포인트 |
| :-- | :-- |
| [요구 페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/) ([Demand Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/)) | [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)를 필요한 순간의 적재 신호로 활용하는 상위 전략이다. |
| [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) ([Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)) | 현재 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)의 존재 여부와 프레임 위치를 기록해 폴트 발생 여부를 결정한다. |
| 변환 색인 버퍼 ([Translation Lookaside Buffer](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/291_tlb/), [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/)) | 적재 후 주소 변환 캐시 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)을 맞춰야 재시작이 정확해진다. |
| [페이지 교체](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/) ([Page Replacement](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/)) | 자유 프레임이 없을 때 폴트 처리를 끝내기 위해 반드시 연계된다. |
| 작업 집합 ([Working Set](/knowledge-base/studynote/02_operating_system/04_synchronization/265_working_set/)) | [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)가 정상 수준인지, [스래싱](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/) 전조인지 판단하는 기준이다. |
| [스래싱](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/) ([Thrashing](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/)) | [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 처리가 과도해져 시스템이 계산보다 적재에 시간을 더 쓰는 상태다. |
...
1. 컴퓨터가 책을 읽다가 지금 책상 위에 없는 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 찾으면, "잠깐만!" 하고 엄마에게 그 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 가져와 달라고 부탁하는 게 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)예요.
2. 엄마가 책장을 다녀오는 동안 컴퓨터는 가만히 울지 않고 다른 숙제를 먼저 해요.
3. 필요한 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 오면 아까 멈춘 줄부터 다시 읽어서, 처음부터 다 있었던 것처럼 자연스럽게 이어 간답니다.
