...
실무에서 페이징은 단순히 "메모리를 잘게 쪼갠다"가 아니라 페이지 크기, 변환 비용, 교체 비용, 보호 정책을 함께 설계하는 문제다. 특히 기술사 관점에서는 페이징의 장점만 말하는 답안보다, <strong>어떤 워크로드에서 어떤 크기와 정책이 유리한지</strong>를 판단하는 문장이 중요하다.
