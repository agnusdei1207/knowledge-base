...
> 1. **본질**: [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/) ([External Fragmentation](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/))는 메모리 총량이 부족해서가 아니라, **연속된 빈 공간의 형태가 무너져서** 할당이 실패하는 현상이다.
> 2. **가치**: 이 문제는 가변 크기 [연속 할당](/knowledge-base/studynote/02_operating_system/09_file_system/523_contiguous_allocation/)이 가진 구조적 약점을 드러내며, [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) ([Operating System](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)) 가 메모리를 "얼마나 갖고 있나"보다 "어떻게 배치하나"를 함께 관리해야 함을 보여준다.
> 3. **판단 포인트**: [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) ([Compaction](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)), 병합 (Coalescing), [버디 시스템](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/) ([Buddy System](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/)), [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) ([Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/))은 모두 [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)를 다루는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이지만, 지연시간·구현 복잡도·연속 물리 메모리 요구사항에 따라 선택이 달라진다.
...
- **📢 섹션 요약 비유**: 책장에 큰 책과 작은 책을 섞어 꽂았다 뺐다 반복하면 빈칸은 많아도 큰 전집 한 질이 들어갈 자리는 사라진다. [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)는 "빈칸 부족"이 아니라 "이어진 빈칸 부족"의 문제다.
...
| :--- | :--- | :--- |
| [최초 적합](/knowledge-base/studynote/02_operating_system/06_memory_management/344_first_fit/) ([First Fit](/knowledge-base/studynote/02_operating_system/06_memory_management/344_first_fit/)) | 앞에서부터 처음 맞는 빈 공간에 배치 | 빠르지만 앞부분에 작은 구멍이 누적되기 쉽다 |
| [최적 적합](/knowledge-base/studynote/02_operating_system/06_memory_management/345_best_fit/) ([Best Fit](/knowledge-base/studynote/02_operating_system/06_memory_management/345_best_fit/)) | 남는 공간이 가장 적은 구역 선택 | 미세한 조각을 많이 남겨 장기적으로 불리할 수 있다 |
| [최악 적합](/knowledge-base/studynote/02_operating_system/06_memory_management/346_worst_fit/) ([Worst Fit](/knowledge-base/studynote/02_operating_system/06_memory_management/346_worst_fit/)) | 가장 큰 빈 공간에 배치 | 큰 구역을 유지하려 하지만 검색 비용이 커진다 |
| 병합 (Coalescing) | 인접한 빈 공간을 즉시 합침 | [단편화](/knowledge-base/studynote/03_network/06_network_layer_ip/291_fragmentation_and_reassembly_process/) 완화에 효과적이지만 비인접 조각은 못 합친다 |
| [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) ([Compaction](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)) | 사용 중 블록을 한쪽으로 이동시켜 빈 공간 집중 | 가장 직접적이지만 복사 비용과 중단 시간이 크다 |
...
| :--- | :--- | :--- |
| 발생 조건 | 가변 크기 [연속 할당](/knowledge-base/studynote/02_operating_system/09_file_system/523_contiguous_allocation/) | 고정 크기 블록·[페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 할당 |
| 낭비 위치 | 블록과 블록 사이 | 할당된 블록 내부 |
| 직접 영향 | 큰 요청이 실패할 수 있음 | 평균 메모리 이용률 저하 |
| 대표 대응 | 병합, [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/), [버디 시스템](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/), [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) | 블록 크기 조정, [슬랩](/knowledge-base/studynote/02_operating_system/11_exam_summary/760_slab_allocator_object_caching/) 캐시, [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/) 최적화 |
...
- [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 비용을 무시한 채 가변 분할이 오래 버틸 것이라 가정하는 것
- [거대 페이지](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)나 장치 버퍼 요구사항을 일반 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 할당과 동일하게 보는 것

- **📢 섹션 요약 비유**: 창고 운영자는 남은 면적만 보면 안 되고, 지게차가 실제로 들어갈 수 있는 통로 폭도 봐야 한다. [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/) 판단은 "몇 평 남았나"보다 "한 번에 실을 길이 남았나"를 보는 일이다.

---

## Ⅴ. 기대효과 및 결론

[외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)를 잘 관리하면 메모리 사용률뿐 아니라 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 지속성, 대형 요청 성공률, 지연시간 안정성이 함께 좋아진다. 특히 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)는 [연속 할당](/knowledge-base/studynote/02_operating_system/09_file_system/523_contiguous_allocation/)의 한계를 이해해야만 왜 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/), [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/), [버디 시스템](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/) 같은 계층형 설계가 필요한지 설명할 수 있다. 즉 [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)는 메모리의 "양"보다 "형태"가 더 중요할 때가 있음을 보여주는 대표 사례다.

반대로 모든 환경에서 [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)를 없애는 것이 최우선은 아니다. [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/)은 [내부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/)와 주소 변환 비용을 감수하고, [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)은 중단 시간을 감수하며, [버디 시스템](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/)은 2의 거듭제곱 반올림으로 낭비를 만든다. 따라서 정답은 하나가 아니라, 시스템이 요구하는 연속성·[성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)·예측 가능성 사이의 균형점이다.

결국 기억해야 할 핵심은 단순하다. [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)는 "빈 메모리가 없는 상태"가 아니라 "쓸 수 있는 모양의 메모리가 없는 상태"이며, 현대 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)는 이를 피하기 위해 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)적 연속성과 물리적 배치를 분리하는 방향으로 진화해 왔다.

- **📢 섹션 요약 비유**: 좋은 정리법은 물건 개수를 줄이는 것이 아니라, 필요한 물건이 한 번에 들어갈 자리를 남겨 두는 것이다. [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/) 관리도 결국 공간을 "남기는 법"이 아니라 "이어지게 남기는 법"이다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [세그멘테이션](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/) ([Segmentation](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/)) | [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 단위를 살리지만 가변 크기라 [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)에 취약하다 |
| [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) ([Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/)) | 동일 크기 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)/프레임으로 물리 연속성 의존을 줄인다 |
| [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) ([Compaction](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)) | 흩어진 빈 공간을 한곳으로 모으는 직접적 대응책이다 |
| [버디 시스템](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/) ([Buddy System](/knowledge-base/studynote/02_operating_system/06_memory_management/348_buddy_system/)) | 분할과 병합을 체계화해 연속 블록 확보를 돕는다 |
| [거대 페이지](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/) ([Huge Page](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/517_huge_page/)) | 현대 시스템에서도 연속 물리 메모리 확보 이슈를 다시 드러낸다 |
...
2. 이게 바로 [외부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/342_external_fragmentation/)예요. 자리가 없는 게 아니라, 이어진 자리가 없는 거예요.
