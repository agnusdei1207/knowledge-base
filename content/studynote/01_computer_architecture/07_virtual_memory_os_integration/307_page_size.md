...
| :--- | :--- | :--- | :--- |
| 4GB 공간을 나눌 때 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 수 | 1,048,576개 | 2,048개 | 4개 |
| 평균 [내부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/) | 약 2KB | 약 1MB | 약 512MB |
| [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 64엔트리 기준 커버 범위 | 256KB | 128MB | 64GB |
| 관리 특성 | 세밀한 할당 | [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 지향 절충 | 특수 목적 최적화 |

현대 x86-64 계열에서는 [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)에 따라 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 워크 깊이도 달라진다. 4KB [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 보통 최하위 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)까지 내려가야 하지만, 2MB [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 중간 단계에서 끝낼 수 있고 1GB [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 그보다 더 위 단계에서 바로 매핑된다. 따라서 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 미스가 났을 때도 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 워크 비용을 줄이는 추가 이점을 갖는다.
...
[페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)를 제대로 이해하려면 "메모리 효율"과 "주소 변환 효율"의 경계 비교를 동시에 봐야 한다. 작은 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 희소한 주소 공간, 잦은 할당/해제, 다양한 크기의 객체가 섞인 환경에서 강하다. 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 넓은 영역을 오래 유지하고 반복적으로 접근하는 환경에서 강하다.

| 비교 축 | 작은 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (예: 4KB) | 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (예: 2MB, 1GB) |
| :--- | :--- | :--- |
| 메모리 낭비 | 적음 | 큼 |
| [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 크기 | 큼 | 작음 |
| [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 미스 가능성 | 높음 | 낮음 |
| [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 단위 | 작아서 세밀함 | 커서 한 번에 많이 적재 |
...
실무에서는 "어떤 [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)가 더 좋은가?"보다 "어떤 메모리 구간에 어떤 [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)를 써야 하는가?"가 더 정확한 질문이다. 예를 들어 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) [버퍼 캐시](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/), 인메모리 분석 엔진, 하이퍼바이저의 게스트 메모리처럼 큰 배열을 오래 유지하는 경우에는 Huge Page가 높은 확률로 이득을 준다. 반대로 짧게 생성되고 자주 사라지는 작은 객체 중심 애플리케이션은 4KB [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 낭비를 줄이고 회수도 쉽다.
...
- "서버니까 무조건 [Huge Page](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/517_huge_page/)"처럼 워크로드 분석 없이 일괄 적용하는 것
...
적절한 [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/) 전략을 쓰면 같은 물리 메모리에서도 체감 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 크게 달라진다. 작은 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 메모리 이용률을 높이고 세밀한 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)·회수·공유를 가능하게 한다. 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)는 [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) miss와 [page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) walk 비용을 줄여 대용량 워크로드의 CPU 낭비를 줄인다.

다만 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 항상 우월한 것은 아니다. [내부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/)가 커지고, 세밀한 [페이지 교체](/knowledge-base/studynote/02_operating_system/04_synchronization/260_page_replacement/)나 복사-쓰기 최적화가 어렵고, 연속 물리 메모리 확보 실패가 문제가 될 수 있다. 따라서 "[성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 향상"이라는 결과만 보지 말고 그 뒤에 숨은 메모리 유연성 손실까지 함께 판단해야 한다.

결론적으로 [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)는 메모리 시스템의 확대경 배율과 같다. 4KB는 세밀한 관찰과 정교한 관리에, 2MB·1GB는 넓은 장면을 빠르게 훑는 데 유리하다. 현대 시스템이 기본 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)와 Huge Page를 함께 쓰는 이유도 바로 이 두 시야를 상황별로 바꿔 써야 하기 때문이다.

- **📢 섹션 요약 비유**: 현미경과 망원경은 누가 더 좋은 도구가 아니라, 보는 대상이 다를 뿐이다. [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)도 마찬가지로 문제의 크기에 맞는 렌즈를 고를 때 가장 큰 효과가 난다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) ([Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)) | [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 수가 늘수록 엔트리 수와 메모리 오버헤드가 커진다. |
| [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) ([Translation Lookaside Buffer](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/291_tlb/)) | [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)가 클수록 동일 엔트리 수로 더 넓은 주소 범위를 커버한다. |
| [내부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/) ([Internal Fragmentation](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/)) | [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)가 커질수록 평균 낭비 공간이 증가한다. |
| THP (Transparent [Huge Pages](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)) | [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)가 큰 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 자동 승격·분할하며 절충점을 찾는 기법이다. |
| [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) ([Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/)) | [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)는 한 번의 폴트로 읽어오는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 양과 I/O 성격을 바꾼다. |
| [메모리 맵 파일](/knowledge-base/studynote/02_operating_system/02_process_thread/131_mmap_ipc/) ([Memory-Mapped File](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/308_memory_mapped_file/)) | 큰 연속 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 매핑에서는 Huge Page가 주소 변환 오버헤드를 줄일 수 있다. |
...
1. [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/)는 장난감을 담는 상자의 크기를 정하는 규칙이에요.
