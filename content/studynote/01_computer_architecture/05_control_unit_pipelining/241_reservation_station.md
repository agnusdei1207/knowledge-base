...
기술사 관점에서는 "RS는 OoO 성능 향상 장치"라고만 쓰면 부족하다. <strong>지연 숨김 효과, 웨이크업·선택 복잡도, CDB 병목, ROB와의 역할 분담</strong>까지 함께 써야 답안의 깊이가 생긴다. 채택 판단은 결국 워크로드의 지연 특성과 허용 가능한 전력·면적 예산의 균형 문제다.
