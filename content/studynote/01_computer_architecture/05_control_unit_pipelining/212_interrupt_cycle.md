...
- **📢 섹션 요약 비유**: [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클은 식당 사장이 주방을 비우고 매초 문밖을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 대신, 벨이 울릴 때만 나가 손님을 맞는 방식과 같다. 벨이 없으면 반응은 느리고 일이 낭비되며, 벨이 있으면 본업과 응답을 둘 다 챙길 수 있다.
...
| :--- | :--- | :--- |
| [PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/) | 다음 실행 주소 유지 | 복귀 지점을 정확히 남겨야 원래 흐름을 재개 가능 |
| PSW/[상태 레지스터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/167_status_register/) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 허용, 조건 코드 보관 | 단순 주소뿐 아니라 실행 상태까지 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)해야 함 |
| [SP](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/166_sp/) | [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 최상단 관리 | 문맥 저장 위치를 정해 nested interrupt를 감당 |
| IVT | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 번호와 [ISR](/knowledge-base/studynote/02_operating_system/01_overview_architecture/020_isr/) 주소 연결 | 어떤 사건인지에 따라 즉시 적절한 핸들러 진입 |
| [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 마스크 | 허용/차단 제어 | 긴급도와 임계구역 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)를 하드웨어 수준에서 보장 |
...
- **📢 섹션 요약 비유**: [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클은 책을 읽다가 급한 전화를 받는 상황과 같다. [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 번호를 접어 두고, 중요한 메모를 남기고, 전화를 받고 돌아와야 같은 문장부터 다시 읽을 수 있다. 접어 두는 과정이 없으면 복귀는 빨라 보여도 정확하지 않다.

---

## Ⅲ. 비교 및 연결

[인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클의 경계는 [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/)과 비교할 때 가장 또렷하고, 예외(Exception)와 비교할 때 가장 자주 헷갈린다. [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/)은 CPU가 사건을 찾으러 가는 방식이고, [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)는 사건이 CPU를 부르는 방식이다. 또한 외부 장치가 건 요청은 [하드웨어 인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/017_hardware_interrupt/), [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 실행 중 내부에서 검출된 오류는 예외로 분류되지만, 둘 다 결국 제어 흐름을 바꾸고 상태를 저장한다는 점에서 공통 메커니즘을 공유한다.

| 비교 항목 | [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) ([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/)) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) ([Interrupt](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)) | 예외 (Exception) |
| :--- | :--- | :--- | :--- |
| 발생 주체 | CPU의 능동 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) | 외부 장치/타이머의 비동기 요청 | CPU 내부 실행 결과 |
| 발생 시점 | 소프트웨어가 검사할 때만 | 사건 발생 시 즉시 펜딩 | [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 수행 중 동기적으로 검출 |
| 장점 | 단순하고 예측 쉬움 | CPU 낭비 감소, 응답성 우수 | 오류 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)와 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/) 가능 |
| 주의점 | 불필요한 [바쁜 대기](/knowledge-base/studynote/02_operating_system/04_synchronization/227_busy_waiting/) | 문맥 저장·우선순위 관리 필요 | 정밀한 예외 순서 보장 필요 |

[운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)와 연결하면 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클은 곧 스케줄링의 시작점이 된다. 타이머 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)가 주기적으로 들어오면 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)은 현재 프로세스의 문맥을 저장하고 다른 프로세스로 전환할 수 있다. 컴퓨터구조 관점의 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클이 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) 관점의 [문맥 교환](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/211_context_switch/) ([Context Switch](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/211_context_switch/))과 직접 이어지는 이유가 여기에 있다.
...
- **📢 섹션 요약 비유**: [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/)은 택배가 왔는지 창문을 계속 내다보는 것이고, [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)는 초인종이 울리면 나가는 것이다. 예외는 집 안에서 갑자기 [가스](/knowledge-base/studynote/06_ict_convergence/01_blockchain/024_gas/) 경보가 울리는 경우인데, 밖에서 온 신호든 안에서 난 문제든 결국 하던 일을 멈추고 먼저 처리해야 한다는 점은 같다.
...
1. [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 수용 지점이 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 경계 또는 정밀 상태 보장 지점으로 제한되어 있는가?
2. ISR에서 잠금 경쟁, 메모리 할당, 블로킹 호출 같은 장기 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 요소를 피하고 있는가?
3. 우선순위가 높은 장치가 낮은 장치의 [ISR](/knowledge-base/studynote/02_operating_system/01_overview_architecture/020_isr/) 때문에 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)되지 않도록 중첩 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 또는 마스킹 정책이 설계되어 있는가?
4. [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 폭주 시 [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) 전환, 코얼레싱(coalescing), [MSI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/561_msi/)-X [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 같은 완화 전략이 준비되어 있는가?

### 피해야 할 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- [ISR](/knowledge-base/studynote/02_operating_system/01_overview_architecture/020_isr/) 안에서 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) I/O, sleep, 긴 반복문을 수행하는 설계
- 모든 사건을 최고 우선순위 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)로 처리해 우선순위 체계를 붕괴시키는 설계
- 멀티코어 환경에서 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)를 한 코어에 몰아넣어 캐시 편향과 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)을 키우는 운영

결국 기술사 답안에서는 "[인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)가 왜 좋은가"만 쓰면 부족하다. 언제 [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/)보다 유리한지, 언제 오히려 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 오버헤드가 병목이 되는지, 그리고 정밀한 예외와 문맥 보존을 어떻게 보장하는지가 함께 나와야 좋은 판단이 된다.

- **📢 섹션 요약 비유**: [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 처리는 응급실 접수와 같다. 환자를 빨리 받는 것도 중요하지만, 접수창구에서 오래 붙잡아 두면 뒤 환자들이 모두 밀린다. 응급 처치만 하고 검사·입원은 뒤 절차로 넘겨야 병원이 전체적으로 잘 돈다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [명령어 사이클](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/207_instruction_cycle/) ([Instruction Cycle](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/207_instruction_cycle/)) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클은 정상 명령 실행 루프 사이에 끼어드는 예외적 제어 단계다. |
| [인터럽트 벡터](/knowledge-base/studynote/02_operating_system/01_overview_architecture/019_interrupt_vector/) ([Interrupt Vector](/knowledge-base/studynote/02_operating_system/01_overview_architecture/019_interrupt_vector/)) | 어떤 ISR로 점프할지 결정하는 인덱스이자 주소 매핑 수단이다. |
| [문맥 교환](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/211_context_switch/) ([Context Switch](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/211_context_switch/)) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)가 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 스케줄러를 깨우면 프로세스 전환으로 확장된다. |
| 정밀한 예외 (Precise Exception) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)/예외 수용 시점에 앞선 명령 완료와 뒤 명령 미반영 상태를 보장한다. |
| 파이프라인 플러시 ([Pipeline](/knowledge-base/studynote/12_it_management/02_itsm_itil/082_pipeline/) Flush) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 수용 후 잘못 [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/) 중인 뒤 단계 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)를 제거하는 비용과 연결된다. |
| [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) ([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/)) | [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클의 필요성과 장점을 가장 잘 드러내는 대비 개념이다. |
...
1. 컴퓨터가 숙제를 하고 있을 때 초인종이 울리면, 어디까지 했는지 책갈피를 꽂고 문을 열러 가는 과정이 [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 사이클이에요.
2. 문 앞 일을 끝내면 책갈피를 보고 다시 원래 숙제로 정확히 돌아와요.
3. 그래서 컴퓨터는 매번 문밖을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하지 않아도 되고, 중요한 일이 생겼을 때만 빠르게 반응할 수 있어요.
