...
간접 사이클의 핵심 구성 요소는 [프로그램 카운터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/) (Program [Counter](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/), [PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/)), [명령어 레지스터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/165_ir/) ([Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), [IR](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/165_ir/)), 메모리 주소 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Memory Address [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), MAR), 메모리 버퍼 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Memory Buffer [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), [MBR](/knowledge-base/studynote/02_operating_system/09_file_system/515_mbr_vs_gpt/)) 또는 메모리 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Memory [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), [MDR](/knowledge-base/studynote/09_security/04_endpoint_security/327_mdr/))다. 인출과 해독이 끝나면 [제어 유닛](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/)은 IR의 간접 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/)와 주소 필드를 보고, 해당 주소를 그대로 실행하지 말고 한 번 더 메모리를 읽으라고 지시한다.

| 구성 요소 | 역할 | 간접 사이클에서의 의미 |
| :--- | :--- | :--- |
| [IR](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/165_ir/) | 현재 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 보관 | 주소 필드와 간접 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) |
| MAR | 메모리에 제시할 주소 보관 | 먼저 "주소가 저장된 위치"를 넣음 |
| [MBR](/knowledge-base/studynote/02_operating_system/09_file_system/515_mbr_vs_gpt/)/[MDR](/knowledge-base/studynote/09_security/04_endpoint_security/327_mdr/) | 메모리에서 읽어 온 값 보관 | 읽어 온 값이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 아니라 EA가 됨 |
| [제어 유닛](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/) ([Control Unit](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/)) | 순서 제어 | 추가 메모리 읽기 여부 결정 |
...
간접 사이클의 특징은 [직접 주소 지정](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/176_direct_addressing/) ([Direct Addressing](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/176_direct_addressing/))과 비교할 때 가장 선명해진다. 직접 주소는 빠르고 단순하지만 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 주소 필드가 곧바로 실제 위치를 지정해야 한다. 간접 주소는 메모리 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)가 늘어나는 대신, 주소값을 메모리에 따로 보관해 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 대상을 유연하게 바꿀 수 있다.

| 비교 항목 | [직접 주소 지정](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/176_direct_addressing/) | [간접 주소 지정](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/177_indirect_addressing/) |
| :--- | :--- | :--- |
| 실제 메모리 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 수 | 보통 1회 | 보통 2회 이상 |
| 주소 필드 활용 | 큰 주소 공간에 불리 | 작은 필드로도 넓은 공간 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 가능 |
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 구조 유연성 | 낮음 | 높음 |
| 파이프라인 친화성 | 상대적으로 높음 | 포인터 의존성 때문에 낮아짐 |

이 차이는 파이프라이닝과도 직접 연결된다. 파이프라인에서는 다음 단계가 미리 진행돼야 처리량이 높아지는데, 간접 주소는 실제 접근 위치가 추가 메모리 read가 끝나야 확정된다. 따라서 주소 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)이 늦어지고, 뒤따르는 로드/실행 단계는 [데이터 해저드](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/223_data_hazard/) ([Data Hazard](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/223_data_hazard/))와 구조적 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)에 더 민감해진다.

현대 [RISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/195_risc/) (Reduced [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Set Computer) 계열이 고전적 의미의 "전용 간접 사이클"을 약화시키는 이유도 여기에 있다. 복잡한 주소 추적을 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 하나의 내부 상태 기계로 숨기기보다, `load pointer` 후 `load data`처럼 단순 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 둘로 쪼개어 파이프라인 제어와 컴파일러 스케줄링을 쉽게 만드는 편이 유리하기 때문이다. 반면 [CISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/196_cisc/) (Complex [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Set Computer) 계열은 다양한 주소 지정 모드를 지원해 같은 동작을 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 수준에서 더 풍부하게 제공해 왔다.

소프트웨어 관점에서는 간접 사이클이 곧 포인터 역참조와 맞닿아 있다. `*p`는 "p가 담고 있는 주소로 다시 가서 읽어라"는 뜻이므로, 하드웨어 입장에서는 주소를 한 번 따라가는 행동이다. 운영체제의 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 탐색, [인터럽트 벡터](/knowledge-base/studynote/02_operating_system/01_overview_architecture/019_interrupt_vector/) [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/), 객체지향 언어의 가상 함수 테이블 접근도 본질적으로는 이 간접성의 확장된 사례다.

- **📢 섹션 요약 비유**: 직접 주소는 집 주소를 종이에 바로 써서 택배를 보내는 방식이고, 간접 주소는 먼저 "배송 대행지"에 보내고 거기서 최종 주소를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해 다시 보내는 방식이다. 유연성은 커지지만 경유지가 늘어 시간이 더 든다.
...
1. 간접 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)가 한 번인지, 다중 단계인지 파악했는가?
2. 포인터가 가리키는 위치가 캐시 친화적으로 배치되어 있는가?
3. 파이프라인에서 주소 확정 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 때문에 로드-유즈 스톨이 커지지 않는가?
...
- 포인터 체인을 깊게 설계해 메모리 접근 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)을 연쇄적으로 키우는 경우
- 배열로 평탄화할 수 있는 구조를 불필요하게 링크 구조로 만들어 캐시 효율을 떨어뜨리는 경우
- 복잡한 [간접 주소 지정](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/177_indirect_addressing/)을 "[명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 수 감소"만 보고 채택해, 실제 파이프라인 비용과 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 복잡도를 과소평가하는 경우

결론적으로 간접 사이클은 기능적으로 유용하지만, [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 설계에서는 늘 "유연성 대 지역성"의 trade-off로 봐야 한다. 주소 한 번 더 읽는 비용은 작은 것처럼 보여도, 주기적으로 반복되면 전체 처리량을 크게 깎을 수 있다.

- **📢 섹션 요약 비유**: 간접 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)를 많이 쓰는 프로그램은 골목마다 안내 표지판을 보고 다시 방향을 정하는 배달원과 같다. 길은 유연하게 바꿀 수 있지만, 표지판이 많아질수록 배송 시간은 늘어난다.

---

## Ⅴ. 기대효과 및 결론

간접 사이클이 제공하는 가장 큰 효과는 주소 공간 활용의 유연성과 자료구조 표현력 향상이다. [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)가 모든 실제 주소를 직접 품지 않아도 되므로, 제한된 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 형식으로도 큰 메모리 체계를 다룰 수 있다. 또한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 재배치, [동적 연결](/knowledge-base/studynote/02_operating_system/06_memory_management/332_dynamic_linking/), 포인터 기반 구조를 지원해 소프트웨어 설계 자유도를 높인다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [주소 지정 방식](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/173_addressing_modes/) (Addressing Mode) | 간접 사이클은 [간접 주소 지정](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/177_indirect_addressing/)이 선택되었을 때만 나타나는 보조 단계다. |
| [명령어 사이클](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/207_instruction_cycle/) ([Instruction Cycle](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/207_instruction_cycle/)) | 인출-해독-실행 흐름 중, 해독과 실행 사이에서 실제 주소를 확정한다. |
| 유효 주소 (Effective Address, [EA](/knowledge-base/studynote/12_it_management/03_ea_isp/110_enterprise_architecture_ea/)) | 간접 사이클의 직접 산출물이며, 이후 실행 단계의 실제 접근 기준이 된다. |
| 포인터 (Pointer) | 메모리에 저장된 주소를 다시 따라간다는 점에서 소프트웨어 수준의 대응 개념이다. |
| [데이터 해저드](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/223_data_hazard/) ([Data Hazard](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/223_data_hazard/)) | 실제 주소 확정이 늦어질수록 뒤따르는 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)가 대기하게 된다. |
| 캐시 미스 (Cache Miss) | 간접 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)가 예측 불가능한 메모리 위치를 따라갈수록 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 손실이 커진다. |
