...
실무 관점에서 순수 COMA를 직접 도입할 일은 거의 없다. 기술사 답안이나 아키텍처 판단에서는 "왜 상용 서버가 COMA 대신 ccNUMA를 택했는가"를 설명할 수 있어야 한다. 핵심 답은 <strong>데이터 이동 이점보다 위치 추적과 일관성 유지 비용이 더 컸기 때문</strong>이다.
