...
> 1. **본질**: SIMD (Single [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Multiple [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))는 하나의 명령을 여러 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 조각에 동시에 적용해, 제어 오버헤드보다 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/)을 우선 극대화하는 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 구조다.
> 2. **가치**: 픽셀 보정, 행렬 연산, [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) 처리처럼 같은 계산을 대량 반복하는 작업에서는 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 인출·해독 비용을 줄이고 전력 대비 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/)을 크게 높인다.
...
SIMD를 구현하려면 하나의 [제어 유닛](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/) ([Control Unit](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/))이 벡터 명령을 해독하고, 그 명령을 여러 연산 레인 (Lane)에 동시에 전달할 수 있어야 한다. 각 레인은 긴 벡터 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Vector [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/))에서 자기 구간의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 꺼내 같은 연산을 수행한다. 예를 들어 256비트 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)에 32비트 정수 8개가 들어 있으면, 한 번의 벡터 덧셈 명령이 8개 덧셈으로 분해되어 동시에 실행된다.

| 구성 요소 | 역할 | 설계 포인트 | 흔한 병목 |
| :--- | :--- | :--- | :--- |
| [제어 유닛](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/) ([Control Unit](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/206_control_unit/)) | SIMD 명령 1회를 해독해 모든 레인에 전파 | 명령 브로드캐스트 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 최소화 | 분기 발생 시 전체 효율 저하 |
| 벡터 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Vector [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/)) | 여러 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 한 묶음으로 저장 | 128/256/512비트 폭, 정렬된 접근 | [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 폭보다 작은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 활용률 저하 |
| 레인 (Lane) | 각 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 조각을 독립적으로 연산 | 정수·[부동소수점](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/087_floating_point/) 연산기 균형 | 일부 레인 유휴 발생 |
| 로드/스토어 유닛 (Load/Store Unit) | 메모리와 벡터 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 사이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 이동 | 연속 메모리 접근, 정렬, 프리패치 | 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 부족 |
| 마스크 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Mask [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/)) | 조건에 따라 특정 레인만 활성화 | 조건부 실행과 예외 처리 보조 | 마스크가 많아질수록 유효 연산 밀도 감소 |
...
SIMD의 경계를 이해하려면 [SISD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/369_sisd/), 다중 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 다중 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) ([MIMD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/372_mimd/), Multiple [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Multiple [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)), 그리고 그래픽처리장치에서 자주 언급되는 [SIMT](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/423_simt/) (Single [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Multiple Threads)와 비교해야 한다. SISD는 명령 하나가 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 하나를 순차 처리하므로 제어가 유연하지만, 같은 작업을 반복할 때 프론트엔드 부담이 크다. 반대로 SIMD는 제어 유연성을 일부 희생하고 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)성을 극대화한다.

| 비교 축 | [SISD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/369_sisd/) | SIMD | [MIMD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/372_mimd/) |
| :--- | :--- | :--- | :--- |
| 제어 흐름 | 명령 1개, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 1개 | 명령 1개, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 여러 개 | 명령 여러 개, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 여러 개 |
| 강한 작업 | 복잡한 분기, 순차 로직 | 벡터·행렬·픽셀·[신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) 처리 | 서버, 멀티스레드, 다양한 작업 혼재 |
...
1. 동일한 연산을 수십~수천 개 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 원소에 반복하는가?
2. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 연속 메모리에 정렬되어 있어 한 번에 넓게 읽기 쉬운가?
3. 조건문을 마스킹으로 바꿔도 의미가 유지되는가?
4. 병목이 연산 부족인가, 아니면 이미 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 한계인가?
5. 컴파일러 자동 벡터화만으로 충분한가, 아니면 인트린식 (Intrinsic) 수준 제어가 필요한가?

### 채택이 유리한 경우

- 이미지 밝기·색상 보정처럼 각 원소에 같은 산술 연산을 반복할 때
- 대규모 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 합산, 내적, 행렬 곱셈처럼 루프 구조가 규칙적일 때
- CPU 내부 AVX나 ARM NEON으로 추가 하드웨어 없이 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/)을 높일 수 있을 때
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| 플린의 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)법 (Flynn's Taxonomy) | SIMD를 [SISD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/369_sisd/)·[MISD](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/371_misd/)·MIMD와 구분하는 이론적 틀 |
| [벡터 프로세서](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/373_vector_processor/) ([Vector Processor](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/373_vector_processor/)) | SIMD 철학을 길게 확장한 대표 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 장치 |
| AVX (Advanced Vector Extensions) | 범용 CPU 내부에서 SIMD를 구현하는 대표 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 확장 |
| 마스크 연산 (Masking) | 조건부 실행 시 일부 레인만 활성화하는 기법 |
| [SoA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/618_soa_hardware/) (Structure of Arrays) | SIMD 친화적 메모리 배치를 만드는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 구조 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
