...
| 기수 | 사용 기호 | 특징 | 실무 예 |
| :--- | :--- | :--- | :--- |
| 2 | 0, 1 | 하드웨어 친화 | [[073_bit|비트]], 논리회로 |
| 8 | 0~7 | 3비트 묶음이 쉬움 | 레거시 표기 |
| [[489_raid_10_hybrid|10]] | 0~9 | 인간이 가장 익숙 | 일상 수치 |
...
16진수는 4비트씩 묶어 읽기 좋기 때문에 메모리 주소, 색상 코드, 디버깅 덤프에서 자주 쓰인다. 8진수는 3비트 묶음과 잘 맞아 [[459_quic_fec_forward_error_correction|초기]] 시스템에서 많이 사용됐다.
...
## Ⅲ. 비교 및 연결
10진수는 읽기 쉽지만 기계적 변환 비용이 크고, 2진수는 계산이 단순하지만 사람이 길게 읽기 어렵다. 8진수와 16진수는 그 중간에서 [[073_bit|비트]] 묶음을 압축해 보여주는 타협안이다.

기수는 부호 표현과도 연결된다. 같은 [[073_bit|비트]]열이라도 [[081_unsigned_integer|부호 없는 정수]], 2의 보수, 고정소수점에서 해석이 달라지므로, 자리값과 표현 규칙을 함께 봐야 한다. 즉 숫자를 보는 눈은 기수와 표현 체계를 함께 읽어야 완성된다.
...
- 채택: [[073_bit|비트]] 패턴을 빠르게 확인해야 할 때
...
## Ⅴ. 기대효과 및 결론
기수 개념을 이해하면 [[078_numeral_systems|진법 변환]], 메모리 주소 읽기, [[073_bit|비트]] 연산, 디버깅이 훨씬 빨라진다. 결국 기수는 숫자의 껍데기가 아니라, 값이 자리마다 어떻게 나뉘는지를 설명하는 핵심 언어다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| 위치 값 기수법(Positional Notation) | 자릿값과 밑의 [[083_relationship_in_er_model|관계]] |
| 2진수(Binary) | 컴퓨터 내부 표현 |
| 8진수(Octal) | 3비트 묶음 표기 |
| 16진수(Hexadecimal) | 4비트 묶음 표기 |
| 2의 보수 | [[082_signed_integer|부호 있는 정수]] 표현 |
...
← **이전**: [[076_double_word|76. 더블 워드 (Double Word)]]
**다음**: [[078_numeral_systems|78. 진법 변환 (2진수, 8진수, 10진수, 16진수)]] →
