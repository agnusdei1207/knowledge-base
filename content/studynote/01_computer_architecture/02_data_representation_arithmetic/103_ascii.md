...
ASCII는 하드웨어 자원이 극도로 제한적이었던 시기에 7비트라는 좁은 공간 안에 문자, 제어 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/), 계산 편의성(대소문자 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) 스위칭, 숫자 분리)을 기적적으로 압축해 낸 인류 최초의 '기계어 국제 법전'이다.
