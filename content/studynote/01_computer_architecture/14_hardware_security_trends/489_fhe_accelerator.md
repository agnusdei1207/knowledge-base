...
> 1. **본질**: [동형 암호](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/) 가속기 ([FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) Accelerator)는 [완전 동형 암호](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) ([FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/), Fully [Homomorphic Encryption](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/))의 거대한 [다항식](/knowledge-base/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 연산과 [부트스트래핑](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/)을 전용 하드웨어로 줄여, 복호화 없는 계산을 실용 구간으로 끌어오는 장치다.
...
[동형 암호](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/) 가속기 ([FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) Accelerator)는 [완전 동형 암호](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) ([FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/), Fully [Homomorphic Encryption](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/)) 연산에서 가장 무거운 [다항식](/knowledge-base/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 곱셈, 키 스위칭, [부트스트래핑](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/)을 전용 회로로 처리하는 하드웨어다. 일반 암호화는 저장할 때와 보낼 때만 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)하고, 계산할 때는 결국 평문으로 풀어야 했다. 반면 FHE는 암호문 상태 그대로 덧셈·곱셈을 수행하므로, 클라우드 운영자조차 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 의미를 모른 채 결과만 계산할 수 있다.

문제는 계산 비용이다. FHE는 격자 기반 [다항식](/knowledge-base/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 연산과 노이즈 관리를 동반하므로, 같은 연산이라도 평문 대비 여러 자릿수 큰 오버헤드가 생긴다. 특히 클라우드 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) 추론, 금융 통계, 의료 분석처럼 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 민감도는 높지만 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/)도 요구되는 환경에서는 중앙처리장치 (CPU, Central Processing Unit)만으로 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 수준 목표를 맞추기 어렵다. 그래서 FHE의 실용화는 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 개선과 함께, 그 수학 구조에 맞춘 가속 하드웨어의 등장을 필요로 했다.
...
| 구성 요소 | 역할 | 설계 포인트 |
| :-- | :-- | :-- |
| 호스트 런타임 | 연산 [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/) 스케줄링, 파라미터·키 관리 | [PCI Express](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/) ([PCIe](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/)) 왕복을 줄이고 배치 단위를 키워야 한다. |
| NTT/INTT 어레이 | [다항식](/knowledge-base/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 곱셈을 점별 곱셈 형태로 변환 | [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)러 곱셈 병렬도와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 재사용이 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 좌우한다. |
| 키 스위칭·리스케일 유닛 | 기저 변환, 스케일 정리, 노이즈 제어 | 중간 버퍼 재활용과 [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/) 손실 관리가 중요하다. |
| [부트스트래핑](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/) 엔진 | 누적된 노이즈를 초기화에 가깝게 복원 | 가장 긴 지연구간이므로 전용 파이프라인이 필요하다. |
| 온칩 [SRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/250_sram/) + [HBM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/) | 중간 암호문 타일과 키 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 저장 | 연산 자체보다 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)이 병목이 되기 쉽다. |
...
- **📢 섹션 요약 비유**: [FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) 가속기는 밀가루 공장과 비슷하다. 밀을 빻는 기계만 빠르다고 끝이 아니라, 저장창고·운반 벨트·정제 공정이 끊기지 않아야 전체 생산량이 올라간다.
...
| :-- | :-- | :-- | :-- |
| 서버가 보는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | 끝까지 암호문 | 실행 중 평문 가능 | 분할된 비밀 조각 |
| 신뢰 가정 | 비밀키 보유자만 신뢰 | CPU/[펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/)/부채널 완화 일부 신뢰 | 다수 참여자 중 임계 수 이상 정직 가정 |
...
[FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) 가속기는 개인정보가 매우 민감하지만 계산은 외부 인프라에 맡겨야 하는 구간에서 빛난다. 대표적으로 암호화된 의료 영상 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/), 금융기관 간 위험도 공동 분석, 고객 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 노출되면 안 되는 클라우드 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) 추론이 있다. 다만 현재도 지연시간과 메모리 요구량이 크기 때문에, 초저지연 제어 루프나 대화형 범용 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 전체를 통째로 FHE에 넣는 것은 현실성이 낮다.
...
2. <strong>스킴 선택 <a href="/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/">확인</a></strong>: 근사 실수 계산은 CKKS (Cheon-Kim-Kim-Song), 정확한 정수 계산은 BFV/BGV (Brakerski-Fan-Vercauteren / Brakerski-Gentry-Vaikuntanathan), [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) 단위 빠른 논리는 TFHE (Fast Fully [Homomorphic Encryption](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/) over the [Torus](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/390_torus/))가 적합한가?
...
- 평문용 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) 모델을 그대로 옮겨 암호문 팽창과 [부트스트래핑](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/) 비용을 무시하는 설계
...
| 개념 | 연결 포인트 |
| :-- | :-- |
| [완전 동형 암호](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) ([FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/), Fully [Homomorphic Encryption](/knowledge-base/studynote/09_security/20_extra_exam_prep/1098_homomorphic_encryption/)) | 암호문 상태에서 덧셈과 곱셈을 수행하게 하는 수학적 기반이다. |
| 수론적 변환 (NTT, Number Theoretic Transform) | [FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) [다항식](/knowledge-base/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 곱셈의 핵심 병목으로, 가속기 병렬화의 중심이 된다. |
| [부트스트래핑](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/) ([Bootstrapping](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/)) | 누적 노이즈를 다시 낮춰 깊은 회로 계산을 계속 가능하게 만든다. |
| 키 스위칭 ([Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/) Switching) | 암호문 표현과 키 기준을 바꾸어 후속 연산을 이어 가게 한다. |
| CKKS / BFV / TFHE | 근사 실수, 정확 정수, [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) 연산 등 워크로드별 [FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) 스킴 선택지를 제공한다. |
| [기밀 컴퓨팅](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/795_confidential_computing/) ([Confidential Computing](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/795_confidential_computing/)) | [FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) 가속기는 처리 중 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)를 강화하는 가장 강한 축 중 하나다. |
...
1. [FHE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/617_fhe_modular_multiplier/) 가속기는 비밀이 든 상자를 열지 않고도 안에서 계산해 주는 특별한 로봇이에요.
