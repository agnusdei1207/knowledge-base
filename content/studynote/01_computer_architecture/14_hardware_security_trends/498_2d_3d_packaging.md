...
> 1. **본질**: 2.5D 패키징은 여러 다이를 실리콘 인터포저나 [브리지](/knowledge-base/studynote/04_software_engineering/04_testing_quality/260_bridge_pattern_abstraction_implementation/) 위에 나란히 배치해 고밀도로 연결하는 방식이고, 3D 패키징은 다이를 수직으로 적층해 [TSV](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/496_tsv/) (Through-Silicon Via)나 하이브리드 본딩 (Hybrid Bonding)으로 직접 잇는 방식이다.
> 2. **가치**: 미세 공정만으로는 더 이상 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)·전력·면적 요구를 감당하기 어려워지면서, 패키징이 "포장 공정"이 아니라 시스템 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 결정하는 핵심 아키텍처가 되었다.
> 3. **판단 포인트**: 2.5D는 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)과 열 설계의 균형이 좋아 실용성이 높고, 3D는 가장 짧은 연결과 높은 집적도를 제공하지만 열, 수율, 테스트 난도가 훨씬 크다.

---

## Ⅰ. 개요 및 필요성

2.5D 및 3D 패키징은 여러 [반도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/009_semiconductor/) 다이를 한 패키지 안에서 매우 가깝고 촘촘하게 연결해, 보드 수준 배선보다 훨씬 높은 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)과 낮은 전력/bit를 얻는 집적 기술이다. 과거 패키징의 주된 역할이 칩 보호와 외부 연결이었다면, 오늘날 패키징은 연산 칩, 메모리, 입출력 (I/O, Input/Output)을 어떤 거리와 구조로 붙일지 결정하는 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 설계가 되었다. 특히 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/), [Artificial Intelligence](/knowledge-base/studynote/10_ai/01_ai_basics/001_artificial_intelligence/)) 가속기, [HPC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/548_automotive_hpc/) ([High Performance Computing](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/226_hpc_supercomputing_infrastructure/)), 초고해상도 센서 같은 분야는 배선 길이와 I/O 밀도가 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 상한을 정하기 때문에 패키징 혁신이 필수가 되었다.
...
| :-- | :-- | :-- | :-- |
| 실리콘 인터포저 | 다이 사이 초미세 수평 배선 | 보조적 | 넓은 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/), 면적, 비용 |
| EMIB [브리지](/knowledge-base/studynote/04_software_engineering/04_testing_quality/260_bridge_pattern_abstraction_implementation/) | 필요한 구간만 고밀도 연결 | 보조적 | 인터포저 면적 절감 |
| [TSV](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/496_tsv/) | [HBM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/) [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 내부 연결 | 적층 다이 수직 연결 | 열, 응력, 수율 |
...
| :-- | :-- | :-- | :-- |
| 다이 배치 | 보드 또는 기판 위 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) | 같은 평면에 고밀도 배치 | 위아래 수직 적층 |
| [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | 고속 I/O와 긴 배선 | 초미세 수평 배선 | 최단 수직 연결 |
| 열 관리 | 상대적으로 쉬움 | 보통 | 가장 어려움 |
| 대표 적용 | 범용 [SoC](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/131_soc/), 일반 CPU | [GPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/418_gpu/) + [HBM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/), [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 가속기 | 3D V-Cache, 이미지 센서, 모바일 적층 |
| 주요 부담 | 핀 수·[신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) | 인터포저 비용 | 수율·열·검사 복잡도 |

또한 2.5D와 3D는 [칩렛](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/) 아키텍처와 직접 연결된다. [칩렛](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/)이 "무엇을 나눌 것인가"를 정하는 개념이라면, 2.5D와 3D는 "그 나눈 것을 어떻게 붙일 것인가"를 정하는 수단이다. CoWoS (Chip-on-Wafer-on-Substrate), Foveros, SoIC (System on Integrated Chips), EMIB 같은 상용 기술들이 바로 이 접점에서 경쟁한다.

이 때문에 패키징은 더 이상 후공정 부서만의 문제가 아니다. 아키텍처, 회로, 열, 테스트, [공급망](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/520_supply_chain_attack_and_ci_cd_security/) 부서가 동시에 들어와야 하는 시스템 설계 주제가 되었다. 특히 HBM을 쓰는 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 칩에서는 패키지 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 사실상 제품 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)과 동일하다.

- **📢 섹션 요약 비유**: [칩렛](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/)이 방 구조를 나누는 설계도라면, 2.5D와 3D는 그 방들을 복도로 잇느냐, 복층으로 쌓느냐를 정하는 건축 방식이다.
...
- [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 요구는 크지 않은데 "최신이니까" 3D 적층부터 검토하는 접근
...
2.5D와 3D 패키징이 확산되면 고대역폭 메모리 결합, 이기종 로직 통합, 제품 소형화, 전력/[bit](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/086_fenwick_tree/) 절감이라는 네 가지 효과를 동시에 기대할 수 있다. 특히 AI와 [HPC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/548_automotive_hpc/) 시대에는 연산 칩만 빠른 것으로는 부족하고, 그 칩에 데이터를 어떻게 공급하느냐가 실제 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 좌우한다. 이런 점에서 첨단 패키징은 미세 공정의 보조 수단이 아니라, 미세 공정 한계를 넘는 우회 경로다.
...
| EMIB (Embedded Multi-die Interconnect [Bridge](/knowledge-base/studynote/04_software_engineering/04_testing_quality/260_bridge_pattern_abstraction_implementation/)) | 인터포저를 부분 적용해 비용과 면적을 줄이는 2.5D 계열 기술이다. |
| [TSV](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/496_tsv/) (Through-Silicon Via) | 3D 적층과 [HBM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/) [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)의 수직 연결 핵심 요소다. |
| 하이브리드 본딩 (Hybrid Bonding) | 차세대 3D 적층에서 미세 피치 직접 접합을 가능하게 한다. |
| [HBM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/) ([High Bandwidth Memory](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/495_hbm/)) | 2.5D 패키징이 가장 널리 활용되는 대표 적용 사례다. |
| [칩렛](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/) ([Chiplet](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/)) 아키텍처 | 패키징이 묶어야 할 다이 구조와 분할 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)을 제공한다. |
