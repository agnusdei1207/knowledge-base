...
> 1. **본질**: 멀티코어 칩 온도 불균형 (Thermal Gradient)은 패키지 평균 온도가 아니라 코어·캐시·인터커넥트 주변의 국소 온도 차이가 실제 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 한계와 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)을 좌우하는 현상이다.
> 2. **가치**: 특정 영역에 전력 밀도가 몰리면 핫스팟 (Hot Spot), 누설 [전류](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/002_current/) 증가, 타이밍 마진 축소, 조기 스로틀링이 이어져 같은 전력 예산에서도 지속 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 크게 달라진다.
> 3. **판단 포인트**: 열 문제는 냉각기만의 문제가 아니라 floorplan, 작업 배치, 동적 [전압](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/001_voltage/)·주파수 조정 (Dynamic [Voltage](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/001_voltage/) and Frequency Scaling, [DVFS](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/469_dvfs/)), 마이그레이션, [power](/knowledge-base/studynote/14_data_engineering/02_math_mining/069_type_1_2_error_statistical_power/) gating을 함께 설계해야 해결되며, [다크 실리콘](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/155_dark_silicon/) ([Dark Silicon](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/155_dark_silicon/))은 그 제약이 구조적으로 드러난 결과다.
...
실무에서는 열이 몰릴 때 세 가지 선택지가 있다. 첫째, 짧은 burst라면 DVFS로 해당 코어만 즉시 눌러 과열을 막는다. 둘째, 장시간 부하라면 작업을 차가운 코어로 옮겨 열을 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)한다. 셋째, 반복적으로 같은 위치가 뜨거워진다면 그때는 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) 문제가 아니라 floorplan, 패키지, 전원 배선까지 포함한 설계 문제로 봐야 한다.

특히 서버와 고성능 컴퓨팅 ([High Performance Computing](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/226_hpc_supercomputing_infrastructure/), [HPC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/548_automotive_hpc/))은 평균 온도보다 sustained hotspot이 중요하고, 모바일은 피부 접촉 온도까지 함께 고려해야 한다. 3D 적층과 [chiplet](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/) 환경에서는 수직 방향 열 [저항](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/003_resistance/)이 커져 상단 다이나 중앙 다이가 더 불리해질 수 있으므로, 열-aware 배치가 사실상 필수다.
...
2. [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/)가 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)만이 아니라 열 이력과 인접 코어 온도까지 고려하는가?
3. [DVFS](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/469_dvfs/) 개입 온도와 migration 임계치가 따로 설계되어 있는가?
4. 장기 부하 기준 sustained [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 측정했는가, 아니면 짧은 burst만 본 것인가?
5. 반복적으로 같은 블록이 과열된다면 floorplan 또는 [chiplet](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/497_chiplet/) 배치를 재검토했는가?

### 피해야 할 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 평균 패키지 온도만 보고 국소 핫스팟을 무시하는 설계
- 모든 코어에 부하를 균등 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)하면 항상 안전하다고 가정하는 운영
- 열 이력 없이 현재 온도만 보고 migration을 반복해 ping-pong을 만드는 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)
...
| [동적 써멀 관리](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/532_dynamic_thermal_management/) ([Dynamic Thermal Management](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/532_dynamic_thermal_management/), [DTM](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/532_dynamic_thermal_management/)) | 온도 불균형을 감지하고 제어 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)으로 연결하는 상위 제어 체계다. |
| 동적 [전압](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/001_voltage/)·주파수 조정 (Dynamic [Voltage](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/001_voltage/) and Frequency Scaling, [DVFS](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/469_dvfs/)) | 가장 빠르게 개입할 수 있는 열 완화 수단이다. |
| [다크 실리콘](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/155_dark_silicon/) ([Dark Silicon](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/155_dark_silicon/)) | 열과 전력 제약 때문에 일부 영역을 비활성으로 남겨두는 구조적 결과다. |
| 전자 이동 (Electromigration) | 높은 온도 구배와 [전류](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/002_current/) 밀도가 장기 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)을 해치는 대표 현상이다. |
| Thermal-Aware Scheduling | 작업 배치 자체로 열 집중을 줄이는 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)·런타임 전략이다. |
