...
3. **회로 위장 병행**: camouflaged cell, [dummy](/knowledge-base/studynote/04_software_engineering/11_testing_validation/851_dummy_test_double/) via, 불투명 배선은 분석 비용을 올리지만, 단독 방어가 아니라 [제로화](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/784_zeroization_circuit/)·키 파생과 함께 써야 한다.
