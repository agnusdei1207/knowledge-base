...
기술사 답안에서는 "분기 예측이 위험하다"에서 멈추지 말고, 어떤 경계에서 오염이 전파되는지와 그 경계를 끊는 수단이 무엇인지까지 써야 한다. 핵심은 분기 예측기 성능 자체를 비난하는 것이 아니라, 공유 예측 상태를 <strong>성능 캐시이자 동시에 보안 자원</strong>으로 다루는 관점을 갖는 것이다.
