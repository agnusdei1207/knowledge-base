...
[스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 클러스터 망은 여러 서버를 하나의 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 풀로 묶어, 필요할 때 노드를 더 추가하는 방식으로 성능과 용량을 키우는 네트워크 구조다. 거대한 서버 한 대를 키우는 [스케일 업](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/)과 달리, [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/)은 "작은 서버 여러 대"를 전제로 한다. 이 때문에 네트워크는 단순 연결 수단이 아니라, [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 시스템 전체의 실질적 [시스템 버스](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/127_system_bus/) 역할을 맡는다.
...
현대 [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/)의 표준은 스파인-리프 패브릭이다. 각 랙의 서버는 탑 오브 랙 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) (ToR, Top-of-Rack) 역할을 하는 리프 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)에 연결되고, 모든 리프는 상단의 스파인 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)들과 균등하게 연결된다. 이 구조의 장점은 어느 랙에서 어느 랙으로 가더라도 경로 길이가 거의 같고, ECMP로 여러 상향 링크를 동시에 활용할 수 있다는 점이다.

| 구성 요소 | 역할 | 설계 포인트 |
| :-- | :-- | :-- |
| 노드 (Node) | 애플리케이션·스토리지·연산 실행 | 장애는 허용하되 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 [복제](/knowledge-base/studynote/14_data_engineering/01_infrastructure/016_replication_factor/)로 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/) |
| 리프 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) (Leaf) | 서버가 직접 붙는 접속 계층 | 랙 단위 장애 도메인과 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 밀도 관리 |
| 스파인 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) (Spine) | 리프 간 교차 연결 백본 | 비차단 대역폭과 균형 경로 확보 |
| [ECMP](/knowledge-base/studynote/03_network/16_data_center_cloud/804_ecmp_equal_cost_multi_path_routing_load_balancing/) / [RDMA](/knowledge-base/studynote/02_operating_system/10_security/639_rdma_kernel_bypass/) | 다중 경로 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)·저지연 전송 | 꼬리 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/), 혼잡 제어, 패킷 손실 최소화 |
...
[스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 클러스터 망은 [스케일 업](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/) [시스템 버스](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/127_system_bus/)와 비슷해 보이지만, 내부 철학이 완전히 다르다. [스케일 업](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/)은 하드웨어가 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)와 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)을 보장하는 반면, [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/)은 네트워크 위에서 소프트웨어가 [복제](/knowledge-base/studynote/14_data_engineering/01_infrastructure/016_replication_factor/)·합의·재시도를 수행한다. 따라서 확장성은 높지만, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)과 장애 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 로직이 애플리케이션 계층으로 올라온다.

| 항목 | [스케일 업](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/) [시스템 버스](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/127_system_bus/) | [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 클러스터 망 |
| :-- | :-- | :-- |
| 기본 단위 | 큰 서버 한 대 | 작은 서버 여러 대 |
| 공유 모델 | [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) | [메시지 전달](/knowledge-base/studynote/02_operating_system/02_process_thread/119_message_passing/)·[복제](/knowledge-base/studynote/14_data_engineering/01_infrastructure/016_replication_factor/) |
| 확장 방식 | [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)·메모리 증설 | 노드·랙 증설 |
| 장애 처리 | 하드웨어 [이중화](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/456_dual_redundancy/) 중심 | 소프트웨어 재분배·[복제](/knowledge-base/studynote/14_data_engineering/01_infrastructure/016_replication_factor/) 중심 |
| 개발 난이도 | 상대적으로 단순 | [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 고려 필요 |

네트워크 토폴로지 관점에서도 차이가 있다. 전통 3계층 네트워크는 남북 방향 트래픽에는 강하지만, 클러스터의 동서 방향 통신에는 중앙 병목을 만들기 쉽다. 반면 스파인-리프는 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 스토리지, [쿠버네티스](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/196_kubernetes_k8s_container_orchestration/) ([Kubernetes](/knowledge-base/studynote/12_it_management/05_security_compliance/205_kubernetes_container_orchestration/)), 대규모 캐시, 매개변수 서버 기반 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) 학습처럼 노드 간 대화가 빈번한 구조와 잘 맞는다.

- **📢 섹션 요약 비유**: [스케일 업](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/)이 한 체육관 안에서 모두 같은 공을 돌려 쓰는 경기라면, [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/)은 여러 경기장이 무전기와 규칙으로 협업하는 리그 경기와 같다. 사람을 늘리는 방식이 아니라 운영 규칙이 달라진다.
...
1. [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)가 [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/), [복제](/knowledge-base/studynote/14_data_engineering/01_infrastructure/016_replication_factor/), 재시도로 장애를 흡수할 수 있는가?
...
| 스파인-리프 (Spine-Leaf) | 현대 [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/)가 Clos를 실용적으로 구현한 토폴로지 |
| 동급 비용 다중 경로 ([ECMP](/knowledge-base/studynote/03_network/16_data_center_cloud/804_ecmp_equal_cost_multi_path_routing_load_balancing/), [Equal-Cost Multi-Path](/knowledge-base/studynote/03_network/16_data_center_cloud/804_ecmp_equal_cost_multi_path_routing_load_balancing/)) | 여러 상향 링크를 동시에 활용해 병목을 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) |
| 원격 [직접 메모리 접근](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/450_dma_direct_memory_access/) ([RDMA](/knowledge-base/studynote/02_operating_system/10_security/639_rdma_kernel_bypass/), Remote [Direct Memory Access](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/318_dma/)) | 고성능 클러스터에서 CPU 개입을 줄이는 저지연 통신 방식 |
| [쿠버네티스](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/196_kubernetes_k8s_container_orchestration/) ([Kubernetes](/knowledge-base/studynote/12_it_management/05_security_compliance/205_kubernetes_container_orchestration/)) | [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 노드 풀을 활용하는 대표적인 [오케스트레이션](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/073_container_orchestration_tools/) 계층 |
...
1. [스케일 아웃](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 클러스터 망은 작은 컴퓨터 친구들을 많이 모아 한 팀으로 뛰게 만드는 운동장 규칙이에요.
...
← **이전**: [621. 스케일 업 (Scale-Up) 시스템 버스](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/621_scale_up_system_bus/)
**다음**: [623. 데이터센터 PUE (Power Usage Effectiveness)](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/623_datacenter_pue/) →
