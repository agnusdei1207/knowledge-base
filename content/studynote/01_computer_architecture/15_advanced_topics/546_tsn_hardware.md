...
기술사 답안에서는 "TSN = 실시간 이더넷" 정도로만 쓰면 부족하다. <strong>동기화, TAS, preemption, Frame Replication and Elimination for Reliability (FRER), guard band, end-to-end schedule</strong>을 함께 설명해야 비로소 설계 판단이 된다.
