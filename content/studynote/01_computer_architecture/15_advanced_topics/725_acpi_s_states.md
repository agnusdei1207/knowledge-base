...
기술사 답안에서도 포인트는 동일하다. S-State는 정의 암기보다 <strong>보존 데이터, 전력 절감 폭, wake latency, 플랫폼 지원성</strong>을 연결해 설명해야 한다. 그래야 Modern Standby, hibernation, shutdown 차이를 실무 시나리오로 풀어낼 수 있다.
