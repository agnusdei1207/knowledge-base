...
1. **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 이동 병목**: 연산보다 메모리·인터커넥트 비용이 더 큰가?
...
결론적으로 More than Moore는 "미세화의 대체품"이 아니라 **시스템 가치를 만드는 주된 전장**이다. 이 개념을 이해할 때는 선폭 경쟁보다 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 경로, 기능 결합, 패키지 아키텍처를 먼저 떠올리는 것이 정확하다.
