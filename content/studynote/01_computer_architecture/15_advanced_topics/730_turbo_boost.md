...
특히 벤치마크를 읽을 때는 워크로드 특성을 반드시 함께 봐야 한다. 단일 스레드 점수는 최대 터보 빈의 영향을 크게 받고, 장시간 렌더링이나 컴파일은 PL1과 냉각 성능의 영향을 더 크게 받는다. 따라서 설계자나 기술사는 "최대 부스트 클럭"만 비교하지 말고, <strong>지속 부하와 순간 부하를 구분한 성능 해석</strong>을 제시해야 한다.
