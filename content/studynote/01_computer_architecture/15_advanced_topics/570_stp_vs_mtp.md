...
> 1. **본질**: 단일 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) (Single-[Thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) [Performance](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/), STP)은 한 개의 중요한 실행 흐름을 얼마나 빨리 끝내는가를, [다중 스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/095_multithreading_benefits/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) (Multi-[Thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) [Performance](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/), MTP)은 여러 실행 흐름을 합쳐 단위 시간에 얼마나 많이 처리하는가를 본다.
> 2. **가치**: 사용자 체감 응답성은 대개 STP에, 서버·배치·렌더링의 총 처리량은 MTP에 더 민감하므로 같은 칩이라도 무엇을 최적화했는지에 따라 가치가 달라진다.
> 3. **판단 포인트**: 좋은 아키텍처 선택은 "코어 수가 많은가"가 아니라 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 구간의 비중, 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/), tail [latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/), 전력 예산을 보고 STP와 MTP의 목표 함수를 먼저 정하는 데서 시작한다.
...
| :--- | :--- | :--- |
| 자원 투자 | 큰 OoO 윈도우, 넓은 issue 폭, 큰 branch predictor | 코어 수 확대, 단순 파이프라인, 높은 [thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) density |
| 핵심 지표 | 낮은 [latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/), 높은 per-[thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) | 높은 [throughput](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/), 높은 total work |
| 대표 병목 | branch miss, 긴 dependency chain | memory [bandwidth](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/), cache sharing, [lock contention](/knowledge-base/studynote/02_operating_system/04_synchronization/275_lock_contention_monitoring/) |
| 전력 사용 | 코어당 피크 전력 큼 | 코어당 전력은 낮지만 총 활성 코어 수 많음 |
| 잘 맞는 환경 | 사용자 인터페이스 (User Interface, UI), 게임, [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) ([Database](/knowledge-base/studynote/05_database/04_transactions_concurrency/501_database/), DB)의 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 구간, 실시간 제어 | 웹 서버, 렌더링, [배치 처리](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/228_batch_processing_hadoop_spark/), 대규모 추론 |
...
암달의 법칙 (Amdahl's Law)은 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 구간이 남아 있는 한 STP가 전체 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 상한을 결정한다고 말한다. 반면 구스타프슨의 법칙 (Gustafson's Law)은 문제 크기가 커질수록 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 부분이 커져 MTP의 가치가 커진다고 본다. 동시에 [다중 스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/095_multithreading_benefits/) 동시 실행 (Simultaneous [Multithreading](/knowledge-base/studynote/02_operating_system/02_process_thread/095_multithreading_benefits/), [SMT](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/400_smt/))은 큰 코어 안의 놀고 있는 실행 자원을 활용해 MTP를 보강하지만, 근본적으로 낮은 STP 코어를 높은 STP 코어로 바꿔 주지는 못한다.

| 워크로드 | [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 비중 | 중요한 지표 | 이유 |
| :--- | :--- | :--- | :--- |
| 게임 메인 루프 | 높음 | STP | 한두 개 critical thread가 frame time을 결정한다. |
| 웹 서버 / 원격 프로시저 호출 ([Remote Procedure Call](/knowledge-base/studynote/02_operating_system/02_process_thread/126_rpc/), [RPC](/knowledge-base/studynote/02_operating_system/02_process_thread/126_rpc/)) 처리 | 낮음~중간 | MTP | 독립 요청이 많아 동시 처리량이 우선이다. |
| 온라인 [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/) 처리 (Online [Transaction](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/) Processing, [OLTP](/knowledge-base/studynote/05_database/06_dw_olap_trends/327_hint_handoff/)) [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) | 중간 | 균형 | [lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/), log flush, tail [latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/) 때문에 STP와 MTP가 함께 중요하다. |
...
1. [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 목표가 평균 처리량인가, 아니면 최악 응답 시간인가?
2. 전체 코드에서 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 구간과 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/) 비용은 얼마나 큰가?
3. 코어 수를 늘렸을 때 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)과 LLC가 이를 감당하는가?
...
- 단일 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 벤치마크만 보고 서버 처리량을 예측하는 것
- 메모리 병목과 [lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/) contention을 무시한 채 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)화만 늘리는 것
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) ([Instructions Per Cycle](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/135_ipc/)) | STP를 구성하는 대표적인 per-[thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 실행 효율 지표다. |
| [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 수준 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)성 (Instruction-Level Parallelism, ILP) | STP 중심 코어가 한 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 안에서 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 끌어내는 방식이다. |
...
| 암달의 법칙 (Amdahl's Law) | [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 구간이 남아 있으면 STP가 전체 상한을 좌우함을 보여 준다. |
| [다중 스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/095_multithreading_benefits/) 동시 실행 (Simultaneous [Multithreading](/knowledge-base/studynote/02_operating_system/02_process_thread/095_multithreading_benefits/), [SMT](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/400_smt/)) | STP 지향 코어의 유휴 자원을 활용해 MTP를 보강하는 절충안이다. |
