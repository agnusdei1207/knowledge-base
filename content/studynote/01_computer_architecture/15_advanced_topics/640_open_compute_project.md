...
> 1. **본질**: 오픈 컴퓨트 프로젝트 (Open Compute [Project](/knowledge-base/studynote/05_database/01_db_architecture_relational/042_relational_algebra_project/), [OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/))는 하이퍼스케일 [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/) 하드웨어 설계를 공개하고 표준화하는 커뮤니티로, 서버를 제품이 아니라 공유 가능한 설계 자산으로 다루게 만든다.
> 2. **가치**: OCP는 전력, 냉각, [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)성, 기구 규격을 공통 분모로 맞춰 [벤더 종속](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/051_vendor_lock_in_cloud_computing/)을 낮추고, 대규모 운영자가 같은 문제를 반복해서 재설계하는 낭비를 줄인다.
> 3. **판단 포인트**: OCP는 단순히 값싼 화이트박스를 사는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 아니라, 개방형 규격을 스스로 운영할 역량이 있을 때 가장 큰 효과를 내는 생태계 선택이다.

---

## Ⅰ. 개요 및 필요성

OCP는 2011년 페이스북이 자사 [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/)용 효율 설계를 공개하면서 시작된 하드웨어 커뮤니티다. 핵심 아이디어는 소프트웨어 오픈소스처럼, 서버와 랙의 설계 규격도 공유하면 전 세계 운영자가 같은 시행착오를 반복하지 않아도 된다는 것이다. 따라서 OCP는 제품 한 개의 이름이 아니라, 공개 설계와 상호 [호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/)을 중심으로 돌아가는 생태계다.
...
[OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/) 설계의 핵심은 하이퍼스케일 운영에 유리한 공통 인터페이스를 만드는 것이다. 대표적으로 21인치 기반 Open Rack 기구 규격, 최근 세대에서 강화된 48V 전력 배전, 공구 없이 교체하기 쉬운 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 구조, 개방형 관리 [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 체계가 있다. 중요한 점은 특정 벤더의 완제품을 고르는 것이 아니라, 랙과 서버 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)이 같은 규칙을 따르도록 맞추는 데 있다.
...
| 구분 | 전통 엔터프라이즈 서버 | [OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/) 기반 장비 |
| :--- | :--- | :--- |
...
2. [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 배포, 장애 분석, 부품 스페어 체계가 자동화되어 있는가?
3. 다중 제조사 조달을 감당할 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)·[인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/) 프로세스가 있는가?
4. 단일 벤더 지원이 없어도 운영 조직이 책임을 나눠 가질 수 있는가?

### [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 장비 가격만 보고 OCP를 도입하고, 운영 자동화와 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 체계를 준비하지 않는 경우
- 소규모 서버실에 대규모 [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/)용 기구 규격을 무리하게 맞추는 경우
- 개방형 하드웨어를 쓰면서도 [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/)와 관리 소프트웨어는 폐쇄적으로 남겨 두는 경우

- **📢 섹션 요약 비유**: [OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/) 도입은 대형 식자재 유통망을 들이는 일과 같다. 손님이 많은 식당에는 큰 이익이 되지만, 작은 가게가 준비 없이 들이면 냉장고와 창고부터 다시 짜야 해서 오히려 부담이 커진다.
...
| OpenBMC | 개방형 서버 관리 [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 생태계로 [OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/) 운영 자동화와 결합된다 |
| [SONiC](/knowledge-base/studynote/03_network/17_sdn_nfv/883_sonic_software_for_open_networking_in_the_cloud/) | 화이트박스 네트워킹과 연결되는 대표적 개방형 네트워크 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) |
| Whitebox Hardware | 특정 벤더 완제품 대신 공통 규격 기반 조달이 가능한 하드웨어 모델 |
| [랙 스케일 아키텍처](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/639_rack_scale_architecture/) ([Rack Scale Architecture](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/639_rack_scale_architecture/), [RSA](/knowledge-base/studynote/09_security/03_network_security/110_rsa/)) | [OCP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/746_ocp/) 물리 표준 위에서 조합형 인프라를 구현하는 상위 설계 방향 |
...
<- **이전**: [639. 랙 스케일 아키텍처 (Rack Scale Architecture)](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/639_rack_scale_architecture/)
**다음**: [641. 데이터 레이크 (Data Lake) 스토리지 아키텍처](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/641_data_lake_storage/) ->
