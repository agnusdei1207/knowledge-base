...
> 1. **본질**: 스토리지 티어링 (Storage Tiering)은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 온도, [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 민감도, 보존 성격에 따라 서로 다른 저장 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/) 계층에 배치하고 다시 이동시키는 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 기반 저장 전략이다.
> 2. **가치**: 자주 읽히는 소수 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 빠른 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)에 남기고, 드물게 접근되는 대다수 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 저렴한 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)로 내려보내므로 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 비용을 함께 맞출 수 있다.
> 3. **판단 포인트**: 성공 여부는 단순히 [Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/) ([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/))와 Hard Disk Drive ([HDD](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/465_hdd_structure/))를 섞는 데 있지 않고, 어떤 지표로 뜨거움을 판단할지, 어떤 단위로 이동할지, 얼마나 자주 움직일지를 정교하게 설계하는 데 달려 있다.

---

## Ⅰ. 개요 및 필요성

스토리지 티어링은 "모든 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 가장 빠른 디스크에 둘 수 없다"는 현실에서 출발한다. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)센터의 대부분 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 시간이 갈수록 접근 빈도가 떨어지지만, 일부 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/)나 최신 [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)처럼 아주 작은 영역은 계속 빠른 응답을 요구한다. 이런 불균형을 무시하고 전부 같은 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)에 두면, 빠른 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)만 쓸 때는 비용이 폭증하고 느린 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)만 쓸 때는 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)이 커진다.
...
| :--- | :--- | :--- | :--- |
| Tier 0 | [NVMe](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/) [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/), Storage Class Memory | 수십~수백 마이크로초 | [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/) [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/), 핫 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) |
| Tier 1 | 엔터프라이즈 [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/) | 0.1~1밀리초 | 활성 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/), 자주 읽는 가상머신 이미지 |
...
| :--- | :--- | :--- | :--- | :--- |
| [캐싱](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/456_caching/) ([Caching](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/456_caching/)) | 원본의 사본 | 밀리초~초 | 순간적인 읽기/[쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 부하 흡수 | 오래된 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 제공 |
| **스토리지 티어링** | 원본 자체가 더 적합한 계층으로 이동 | 분~시간~일 | 장기적인 비용/[성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 균형 | 과도한 이동, [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 흔들림 |
| 아카이빙 (Archiving) | 장기 보존용 별도 저장소 | 일~월~년 | 규제 준수, 보존 비용 절감 | [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/), 검색 곤란 |

이 관계를 보면 스토리지 티어링은 ILM (Information [Lifecycle Management](/knowledge-base/studynote/09_security/18_iot_ot_physical/927_medical_device_lifecycle/))의 실무 구현 중 하나라고 볼 수 있다. 정보 생애주기 전체를 설계하는 큰 틀 안에서, 티어링은 "지금 이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 어느 계층에 있어야 하는가"를 지속적으로 조정하는 장치다. 그래서 캐시 [적중률](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/264_hit_ratio/), [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/), 아카이브 기준과도 자연스럽게 연결된다.

- **📢 섹션 요약 비유**: [캐싱](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/456_caching/)이 인기 상품을 계산대 옆에 임시로 쌓아 두는 일이라면, 티어링은 매장 전체 진열 위치를 다시 재배치하는 일이고, 아카이빙은 창고 밖 보관창고로 보내는 일이다. 겉보기에 다 "옮기는 일" 같아도 목적이 전혀 다르다.
...
- **채택이 유리한 경우**
  - [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 접근 패턴이 명확히 편중되어 있고, 상위 티어에 올릴 hot set이 전체 대비 작을 때
  - 계층 간 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)/비용 차이가 충분히 커서 이동의 경제성이 뚜렷할 때
  - 블록, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/), 오브젝트 중 어떤 단위가 업무 특성과 맞는지 분명할 때
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 온도 ([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [Temperature](/knowledge-base/studynote/10_ai/05_data_science_ml/386_llm_temperature/)) | 티어링 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)이 승급·강등을 결정할 때 가장 먼저 보는 기준이다. |
| [캐싱](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/456_caching/) ([Caching](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/456_caching/)) | 티어링과 달리 원본이 아닌 사본을 빠른 계층에 두어 순간 부하를 흡수한다. |
| ILM (Information [Lifecycle Management](/knowledge-base/studynote/09_security/18_iot_ot_physical/927_medical_device_lifecycle/)) | 티어링을 포함해 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)·활용·보존 전 과정을 관리하는 상위 개념이다. |
| [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/) ([Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) / [HDD](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/465_hdd_structure/) (Hard Disk Drive) | 티어 간 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)·비용 차이를 대표하는 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/) 조합이다. |
