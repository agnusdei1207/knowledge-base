...
> 1. **본질**: 소프트웨어 회춘(Software Rejuvenation)은 장시간 실행으로 누적되는 [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/), 자원 고갈, [단편화](/knowledge-base/studynote/03_network/06_network_layer_ip/291_fragmentation_and_reassembly_process/), 상태 오염 같은 소프트웨어 [노화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/)를 장애 전에 계획적으로 제거하는 예방적 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이다.
> 2. **가치**: 예기치 않은 다운타임을 기다려 한 번에 크게 멈추는 대신, 짧고 통제된 재시작·재배포·리부트로 가용성을 더 높일 수 있다.
> 3. **판단 포인트**: 프로세스 재시작, [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/) 교체, [VM](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/598_vm_migration_nic/) ([Virtual Machine](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/598_vm_migration_nic/)) 재생성, OS ([Operating System](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)) 재부팅, HW (Hardware) 리부트는 지우는 상태 범위와 비용이 다르므로, [노화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/)가 어느 계층에 쌓이는지 보고 가장 얕은 수단부터 선택해야 한다.
...
| :--- | :--- | :--- | :--- |
| 프로세스 재시작 | 사용자 공간 힙, 핸들, [세션](/knowledge-base/studynote/02_operating_system/02_process_thread/160_session_controlling_terminal/) 캐시 | 가장 작음 | [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/), 워커 누적 |
| [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/)/[VM](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/598_vm_migration_nic/) 교체 | 프로세스 + 런타임 이미지 + 인스턴스 상태 | 작음~중간 | [Immutable](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/298_immutable/) 배포, 불안정 런타임 |
...
- **📢 섹션 요약 비유**: 아픈 선수를 교체 선수와 바꿔가며 경기를 계속하는 것이 회춘이고, 경기장이 정전돼 모두 멈춘 뒤 겨우 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)하는 것은 비상 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)다. 둘 다 다시 뛰게 만들지만 준비된 교체가 훨씬 덜 아프다.
...
5. **근본 원인 수정과 병행하는가**: 회춘은 운영 완충재이지, [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/)나 드라이버 버그를 영구히 덮는 면허가 아니다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| Software [Aging](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/) | [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/), 자원 고갈, [단편화](/knowledge-base/studynote/03_network/06_network_layer_ip/291_fragmentation_and_reassembly_process/) 등 회춘이 대응하는 근본 현상 |
| Rolling Restart | 여러 인스턴스를 순차 재시작해 무중단에 가깝게 회춘하는 운영 방식 |
| HA (High [Availability](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/)) | 회춘 중 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 연속성을 유지하게 해 주는 중복 구조 |
| [Kubernetes](/knowledge-base/studynote/12_it_management/05_security_compliance/205_kubernetes_container_orchestration/) / [Immutable Infrastructure](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/204_immutable_infrastructure_configuration_drift_prevention/) | [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/)·노드 재생성 기반 회춘 자동화와 직접 연결 |
| OS Reboot / Cold Reboot | 사용자 공간을 넘어 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)·장치 상태까지 지우는 깊은 회춘 수단 |
| Watchdog / Health Check | 회춘 [트리거](/knowledge-base/studynote/05_database/04_transactions_concurrency/507_acid_properties/)와 안전한 재투입 판단의 기준 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) |
