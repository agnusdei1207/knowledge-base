...
> 1. **본질**: 배스터브 곡선 (Bathtub Curve)은 부품의 고장률이 시간 내내 일정하지 않고, [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 불량기·안정기·마모기로 바뀐다는 사실을 보여 주는 수명 주기 모델이다.
> 2. **가치**: 같은 장비라도 시기별로 필요한 전략이 달라서, [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/)는 [번인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/758_burn_in_test/), 중기는 [이중화](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/456_dual_redundancy/)와 신속 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/), 말기는 예방 교체라는 서로 다른 운영 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)을 세우게 만든다.
> 3. **판단 포인트**: MTBF나 지수분포 기반 상수 고장률 가정은 주로 안정 구간에서만 잘 맞으며, [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 불량과 마모 구간은 별도 수명 모델과 현장 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 보정해야 한다.
...
| :--- | :--- | :--- | :--- | :--- |
| [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 고장기 | 감소 (DFR, Decreasing Failure Rate) | 제조 불량, 납땜 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/), 조립 편차 | [번인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/758_burn_in_test/) ([Burn-in](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/758_burn_in_test/)), [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 선별 | `β < 1` |
| 우발 고장기 | 거의 일정 ([CFR](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/025_change_failure_rate_cfr/), Constant Failure Rate) | 외부 충격, 전원 품질, 우발 사고 | [이중화](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/456_dual_redundancy/), 빠른 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/), 모니터링 | `β ≈ 1` |
| 마모 고장기 | 증가 (IFR, Increasing Failure Rate) | 베어링 마모, 절연 열화, [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 소모 | 예방 교체, 예지 정비 | `β > 1` |
...
1. [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 불량 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 운영 고장 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)와 분리해 기록하고 있는가?
2. 장비 종류별로 서로 다른 배스터브 곡선을 가정하고 있는가, 아니면 모두 같은 MTBF로 뭉뚱그리는가?
3. [번인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/758_burn_in_test/) 시간과 스트레스 조건이 실제 배치 환경과 연결되는가?
4. 우발 고장기에는 [이중화](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/456_dual_redundancy/)와 [MTTR](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/451_mttr/) (Mean Time To Repair) 단축이 준비되어 있는가?
5. 마모 고장기 진입 전 교체 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)이 S.M.A.R.T., 온도, 오류 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 같은 텔레메트리와 연결되는가?

### 피해야 할 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- **신규 장비 즉시 투입**: [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 고장기 장비를 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 없이 본서비스에 넣는 경우다.
- **평균값 맹신**: 우발 고장기의 MTBF를 장비 전체 생애에 그대로 적용하는 경우다.
- **노후 장비 방치**: 마모 징후가 보여도 "아직 돈다"는 이유로 교체를 미루는 경우다.

결국 배스터브 곡선의 실무 메시지는 단순하다. 고장률이 일정하지 않다면, 유지보수도 일정하면 안 된다. 시기별로 다른 실패 메커니즘을 인정하고 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)을 바꾸는 조직만이 비용과 [가용성](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/) 사이에서 균형을 잡을 수 있다.

- **📢 섹션 요약 비유**: 배스터브 곡선은 자동차 관리와 같다. 새 차는 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 점검이 중요하고, 잘 길든 뒤에는 보험과 소모품 관리가 중요하며, 오래되면 큰 고장 전에 계획 교체를 고민해야 한다.
...
| [Burn-in](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/758_burn_in_test/) | [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 고장기의 약한 개체를 선별해 현장 투입 전 제거하는 방법이다. |
| [MTBF](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/450_mtbf/) | 주로 우발 고장기의 평균 특성을 설명하는 지표로 쓰인다. |
| Weibull Distribution | 감소형, 일정형, 증가형 고장률을 형상계수 `β`로 표현하는 대표 수명 모델이다. |
| [ALT](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/762_accelerated_life_testing/) ([Accelerated Life Testing](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/762_accelerated_life_testing/)) | 마모 고장기 특성을 빠르게 관찰하기 위한 가속 수명 시험이다. |
| Predictive Maintenance | 마모 고장기 진입을 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 예측해 고장 전에 교체하는 전략이다. |
