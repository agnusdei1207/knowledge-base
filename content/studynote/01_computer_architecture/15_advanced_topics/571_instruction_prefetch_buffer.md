...
> 1. **본질**: [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 프리패치 버퍼 ([Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Prefetch Buffer)는 fetch 단계가 미리 가져온 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) [바이트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/074_byte/) 또는 번들을 잠시 저장해, [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 공급 속도와 decode 소비 속도를 분리하는 front-end 완충층이다.
> 2. **가치**: [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 캐시 refill, flash wait [state](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/), 분기 재지정 때문에 생기는 짧은 공급 흔들림을 버퍼가 흡수해 파이프라인 굶주림과 front-end stall을 줄인다.
> 3. **판단 포인트**: 버퍼가 큰 것만으로는 충분하지 않으며, fetch 폭·branch predict 정확도·[명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 정렬·flush 비용까지 함께 맞아야 실제 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) ([Instructions Per Cycle](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/135_ipc/)) 향상으로 이어진다.
...
| Prefetch Buffer [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/) | [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)에 건네기 전 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)를 임시 저장한다. | 깊이와 전력, flush 비용의 균형이 중요하다. |
| Align / Predecode Logic | [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 경계를 맞추고 길이 정보를 정리한다. | 가변 길이 ISA에서 특히 중요하다. |
| Redirect / Flush Control | 잘못된 경로의 항목을 폐기하고 새 경로로 전환한다. | branch miss 시 [회복](/knowledge-base/studynote/05_database/04_transactions_concurrency/233_recovery_database_restoration_overview/) 시간을 줄여야 한다. |
...
| 구성 요소 | 주된 역할 | 강점 | 한계 |
| :--- | :--- | :--- | :--- |
| I-cache | [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 블록 저장 | 지역성 활용, 반복 실행에 강함 | miss가 나면 refill 대기 필요 |
| [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Prefetcher | 앞으로 읽을 블록 예측 | miss를 미리 줄인다 | 예측이 틀리면 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 낭비 |
| [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Prefetch Buffer | 이미 읽은 블록의 단기 완충 | 짧은 공급 흔들림 흡수 | 긴 miss나 branch miss는 못 가린다 |
| [Micro-Operation](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/213_micro_operation/) Cache | decode 결과 재사용 | decode 비용 절감, 반복 코드 가속 | 용량과 coherence 관리가 복잡 |

이 관점에서 보면 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 프리패치 버퍼는 572번 루프 프리패처처럼 "무엇을 미리 가져올지"를 적극 학습하는 장치보다 더 앞단의 기본 장치다. 전자는 예측, 후자는 완충에 가깝다.
...
1. fetch 소스가 정적 램 (Static Random Access Memory, [SRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/250_sram/))[인가](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/509_authorization_models_rbac_abac/), flash인가, 상위 cache miss가 잦은 구조인가?
2. decode 폭과 버퍼 깊이가 균형을 이루는가?
3. 분기 밀도가 높아 flush가 자주 발생하지 않는가?
4. [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 정렬과 predecode가 경계 crossing 비용을 줄여 주는가?
5. 버퍼 확장이 실제 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 향상보다 전력 증가를 더 크게 만들지 않는가?
...
- self-modifying code나 [code](/knowledge-base/studynote/02_operating_system/02_process_thread/082_process_memory_structure/) patching 환경에서 [instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) coherence를 소홀히 하는 것
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 캐시 ([Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Cache, I-cache) | 버퍼 앞단의 주된 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 공급원이며, miss가 나면 버퍼가 시간을 번다. |
| 분기 대상 버퍼 (Branch Target Buffer, [BTB](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/234_btb/)) | 다음 fetch 주소를 바꿔 버퍼에 채울 내용을 결정한다. |
| Branch Predictor | 올바른 경로를 예측해 flush 빈도를 줄인다. |
| Predecode | 가변 길이 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)의 경계와 속성을 미리 정리해 decode 부담을 낮춘다. |
| [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) ([Instructions Per Cycle](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/135_ipc/)) | 버퍼 설계 개선 효과가 최종적으로 드러나는 대표 지표다. |
| [Micro-Operation](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/213_micro_operation/) Cache | 버퍼 이후 단계에서 decode 결과까지 재사용하는 고급 front-end 최적화다. |
...
3. 이 미리 쌓아 둔 책장 더미가 바로 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 프리패치 버퍼예요.
