...
좋은 UPS 설계는 정전 순간만이 아니라 평상시 유지보수에서도 차이를 만든다. 모듈형 구조와 정적 바이패스가 있으면 장비를 멈추지 않고도 일부 부품을 교체할 수 있고, 장애를 부분 고장으로 국한할 수 있다. 기술사 관점에서는 용량보다 <strong>어떤 품질의 전기를 얼마나 오래, 어떤 중복도로 공급할 것인가</strong>를 먼저 묻는 것이 맞다.
