...
> 1. **본질**: 원자적 읽기-수정-쓰기 (Atomic Read-Modify-Write, RMW)는 메모리 값을 읽고 바꾸고 다시 쓰는 과정을 끊을 수 없는 하나의 하드웨어 사건으로 만들어, 경쟁 상태에서 값 손실을 막는 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)의 최소 단위다.
> 2. **가치**: 락, [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/), 티켓 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/), [락-프리](/knowledge-base/studynote/02_operating_system/04_synchronization/256_lock_free_data_structures/) 자료구조의 토대가 되며, [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)부터 고성능 서버까지 거의 모든 [동시성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/014_concurrency/) 제어의 바닥을 받쳐 준다.
> 3. **판단 포인트**: 원자적 명령 자체는 빠르지만 경합이 심해지면 캐시 라인 소유권 이동이 병목이 되므로, 연산 종류·메모리 순서·[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 배치를 함께 설계해야 진짜 성능이 난다.
...
| 연산 | 의미 | 대표 활용 | 주의점 |
| :-- | :-- | :-- | :-- |
| Test-and-Set | 값을 읽으면서 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) | 단순 [스핀락](/knowledge-base/studynote/02_operating_system/04_synchronization/222_spinlock/) | 과도한 경합 시 바운싱이 심하다. |
| Exchange | 기존 값과 새 값을 교환 | 락 변수 획득·상태 전환 | 조건 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 없이 덮어쓰므로 용도가 제한된다. |
| [Compare-and-Swap](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/415_compare_and_swap/) ([CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/)) | 기대값과 같을 때만 교체 | [락-프리](/knowledge-base/studynote/02_operating_system/04_synchronization/256_lock_free_data_structures/) [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/), [상태 전이](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/632_state_transition_diagram_testing/) | ABA 문제와 재시도 루프를 고려해야 한다. |
| Fetch-and-Add (FAA) | 이전 값을 반환하며 덧셈 | [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/), 티켓 락 | 전역 핫스폿이 되기 쉽다. |
| Fetch-and-Or/And | [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/) 갱신 | 상태 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/)맵, [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 마스크 | false sharing에 민감하다. |
...
원자적 RMW 내부에서도 어떤 연산을 고르느냐에 따라 비용과 표현력이 달라진다. CAS는 "조건이 맞을 때만 바꾼다"는 점에서 가장 유연하지만 실패 재시도가 필요하고, FAA는 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/)에 매우 적합하지만 복합 불변식을 표현하기 어렵다. LL/SC는 중간에 누가 건드렸는지를 감지해 CAS보다 ABA에 덜 취약할 수 있으나, 실패가 더 자주 일어나고 하드웨어 제약도 다르다.

| 비교 축 | [CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/) | FAA | LL/SC | 소프트웨어 락 |
| :-- | :-- | :-- | :-- | :-- |
| 강점 | 조건부 [상태 전이](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/632_state_transition_diagram_testing/) | 단순 누적 갱신 | intervening write 감지 | 복합 로직 표현 용이 |
| 약점 | ABA, 재시도 루프 | 핫스폿 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/)화 | 실패 재시도, 구현 제약 | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 개입·직렬화 |
...
1. 이 연산이 정말 한 메모리 위치의 [원자성](/knowledge-base/studynote/05_database/04_transactions_concurrency/193_atomicity_all_or_nothing/)만으로 충분한가?
2. 전역 핫스폿 대신 [샤딩](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/280_sharding/), 배치, per-core 누적이 가능한가?
...
- 복잡한 다중 필드 불변식을 [CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/) 루프 하나로 억지 구현하는 설계
- 모든 원자 연산에 가장 강한 메모리 순서를 무조건 쓰는 습관
- 단순 통계 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/)를 전역 FAA 하나로 모아 수십 코어가 두드리게 하는 설계
...
원자적 RMW를 적재적소에 쓰면 [동시성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/014_concurrency/) 제어의 비용을 크게 줄이고, [락-프리](/knowledge-base/studynote/02_operating_system/04_synchronization/256_lock_free_data_structures/) 자료구조와 고성능 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 경로를 구현할 수 있다. 짧은 [상태 전이](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/632_state_transition_diagram_testing/), [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/) 갱신, [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 수명 관리처럼 한 [워드](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/075_word/) 수준의 문제에서는 가장 강력하고 직접적인 도구다. 그래서 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/), 런타임, [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/), 네트워크 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 어디를 가도 원자적 RMW는 빠지지 않는다.
...
| 개념 | 연결 포인트 |
| :-- | :-- |
| [캐시 일관성](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/) ([Cache Coherence](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/)) | 원자적 RMW는 보통 캐시 라인의 독점 소유권 확보로 구현된다. |
| [CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/) ([Compare-and-Swap](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/415_compare_and_swap/)) | 조건부 [상태 전이](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/632_state_transition_diagram_testing/)를 담당하는 대표 원자적 RMW다. |
| LL/SC (Load-Link / Store-Conditional) | 일부 아키텍처가 [CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/) 대신 쓰는 [원자성](/knowledge-base/studynote/05_database/04_transactions_concurrency/193_atomicity_all_or_nothing/) 구현 모델이다. |
| [메모리 배리어](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/416_memory_barrier/) ([Memory Barrier](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/416_memory_barrier/)) | 원자 연산 전후의 가시성과 순서를 조절한다. |
| ABA 문제 | [CAS](/knowledge-base/studynote/02_operating_system/11_exam_summary/768_cas_compare_and_swap_lock_free/) 기반 [락-프리](/knowledge-base/studynote/02_operating_system/04_synchronization/256_lock_free_data_structures/) 구조에서 자주 함께 등장하는 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 오류다. |
| [False Sharing](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/409_false_sharing/) | 다른 변수 때문에 같은 캐시 라인이 흔들려 원자 연산 성능이 떨어지는 현상이다. |
