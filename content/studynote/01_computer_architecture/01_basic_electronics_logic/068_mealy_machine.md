...
> 2. **가치**: 입력 변화에 빠르게 반응할 수 있어 제어 논리와 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 설계에 유리하다.
...
| 구성 요소 | 역할 |
| :-- | :-- |
| [State](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) | 현재 내부 상황 |
| Input | 즉시 반응 요소 |
| Output | 상태+입력 기반 결과 |
...
5. FSM 구현 시 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)/안정성을 고려했는가?
