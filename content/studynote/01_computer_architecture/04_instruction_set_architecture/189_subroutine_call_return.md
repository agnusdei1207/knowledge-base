...
> 2. **가치**: 이 왕복 구조 덕분에 같은 코드를 여러 곳에서 재사용할 수 있고, 함수·프로시저·[재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/) 호출 같은 고수준 소프트웨어 구조가 기계어 수준에서도 안정적으로 성립한다.
> 3. **판단 포인트**: [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 안정성은 "복귀 주소를 어디에 저장하는가", "호출 규약이 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)와 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 프레임을 어떻게 다루는가", "깊은 호출과 공격으로부터 복귀 경로를 어떻게 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/)하는가"에서 갈린다.
...
또한 함수 호출은 단지 "편리한 프로그래밍 습관"이 아니라 현대 소프트웨어 계층의 바닥 규칙이다. 고급 언어의 함수, 운영체제의 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) 호출, [재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/) [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/), [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) 처리 이후 복귀까지 모두 "현재 문맥을 보존하고 다시 이어서 실행한다"는 공통 원리 위에 서 있다. 이 규칙이 없으면 프로그램은 분기 이후 다시 어디서 이어야 하는지 알 수 없어 큰 시스템을 구조적으로 만들기 어렵다.
...
| 구성 요소 | 역할 | 설계 포인트 |
| :-- | :-- | :-- |
| [프로그램 카운터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/) (Program [Counter](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/), [PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/)) | 다음에 실행할 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 주소 유지 | Call 전후 값 보존이 핵심 |
| [스택 포인터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/166_sp/) ([Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) Pointer, [SP](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/166_sp/)) | 복귀 주소와 지역 변수 저장 위치 관리 | 깊은 호출에서 공간 부족 주의 |
| 프레임 포인터 (Frame Pointer, [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/)) | 현재 함수의 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 프레임 기준점 제공 | 디버깅·로컬 변수 접근 안정화 |
| 링크 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Link [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), LR) | 일부 구조에서 복귀 주소를 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)에 임시 보관 | 얕은 호출은 빠르지만 중첩 호출 시 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/) 필요 |
| 호출 규약 (Calling Convention) | 인자·반환값·보존 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 규칙 정의 | 컴파일러/[라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) [호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/) 좌우 |
...
Call/Return을 제대로 이해하려면 단순 점프와의 차이, 그리고 복귀 주소 저장 방식의 차이를 함께 봐야 한다. 이 차이는 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 집합 구조 ([Instruction Set Architecture](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/), [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/))의 성향과 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 특성을 그대로 드러낸다.
...
| 항목 | [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 기반 복귀 주소 저장 | 링크 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 기반 저장 |
| :-- | :-- | :-- |
| 대표 성향 | x86 계열의 전통적 Call/Ret | ARM 계열의 BL/RET 계열 |
| 장점 | 깊은 중첩 호출에 자연스럽게 대응 | 메모리 접근 감소로 얕은 호출이 빠름 |
| 약점 | 메모리 접근 부담, [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 트래픽 증가 | 중첩 호출 시 LR [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/) 누락 위험 |
| 적합 상황 | [재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/)·중첩 호출이 많은 구조 | 짧은 함수, leaf function 최적화 |

링크 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Link [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), LR) 방식은 "복귀 주소를 일단 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)에 담아 두고 가자"는 접근이다. 메모리에 바로 쓰지 않으므로 빠르지만, 함수 안에서 또 다른 함수를 부르면 기존 LR 값이 덮어써질 수 있어 필요 시 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)에 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)해야 한다. 반대로 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 기반 방식은 호출 때마다 메모리를 건드려 상대적으로 무겁지만, 중첩 구조를 다루는 규칙이 단순하고 일관적이다.

이 개념은 파이프라인의 [제어 해저드](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/224_control_hazard/) ([Control Hazard](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/224_control_hazard/))와도 연결된다. Call은 앞으로 갈 위치를 바꾸고, Return은 저장된 주소를 읽어 와야 하므로 분기 예측기와 복귀 주소 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) (Return Address [Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/), [RAS](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/449_ras/)) 같은 [하드웨어 보조](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/527_hardware_assisted_virtualization/) 장치가 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)에 큰 영향을 준다. 결국 Call/Return은 소프트웨어 구조의 기반이면서 동시에 [마이크로아키텍처](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/204_microarchitecture/) 최적화의 대상이다.
...
기술사 답안 관점에서 핵심은 "Call/Return은 편의 기능이 아니라 제어 흐름 [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/)의 중심"이라고 정리하는 것이다. 함수 호출을 많이 쓴다고 바로 나쁜 것이 아니라, **호출 빈도·깊이·보안 요구·디버깅 요구를 같이 보고 최적화 여부를 판단해야 한다.**
...
| 개념 | 연결 포인트 |
| :-- | :-- |
| [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 프레임 ([Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) Frame) | 복귀 주소, 지역 변수, 저장 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)를 한 함수 단위로 묶는 실행 문맥 |
| 호출 규약 (Calling Convention) | 인자 전달 방식, 반환값 위치, [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 보존 책임을 정의하는 계약 |
| 링크 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) (Link [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/), LR) | 일부 ISA에서 복귀 주소를 메모리 대신 먼저 저장하는 전용 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) |
| [제어 해저드](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/224_control_hazard/) ([Control Hazard](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/224_control_hazard/)) | Call/Return이 파이프라인의 다음 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 흐름을 불확실하게 만드는 지점 |
| 복귀 주소 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) (Return Address [Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/), [RAS](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/449_ras/)) | Return 목적지를 빠르게 예측해 파이프라인 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 높이는 하드웨어 구조 |
| [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) [오버플로우](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/095_overflow/) ([Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) [Overflow](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/095_overflow/)) | 과도한 호출 깊이 또는 큰 프레임으로 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) 공간이 고갈되는 상태 |
| 반환 지향 프로그래밍 ([Return-Oriented Programming](/knowledge-base/studynote/02_operating_system/10_security/596_return_oriented_programming/), [ROP](/knowledge-base/studynote/02_operating_system/10_security/596_return_oriented_programming/)) | 손상된 복귀 주소를 악용해 공격용 코드 흐름을 조합하는 기법 |
