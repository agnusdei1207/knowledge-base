...
> 1. **본질**: 3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) (Three-Address [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/))는 두 입력과 한 출력의 위치를 각각 분리해 적는 형식이라, 연산 후에도 원본 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/)가 보존되는 비파괴적 실행 모델을 만든다.
> 2. **가치**: 이 분리는 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 재사용, 컴파일러 최적화, 파이프라인 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)화에 유리하며, 현대 [RISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/195_risc/) (Reduced [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Set Computer) 계열 [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/) ([Instruction Set Architecture](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/))의 기본 문법이 되었다.
> 3. **판단 포인트**: 장점은 명확하지만 주소 필드가 많아 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 폭과 코드 크기가 커지므로, [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)·디코딩 단순성·코드 밀도 사이의 균형을 함께 봐야 한다.
...
- **📢 섹션 요약 비유**: 3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)는 재료 두 개를 꺼내 새 그릇에 요리 결과만 담는 방식과 같다. 밀가루 통과 달걀은 그대로 남고, 반죽만 새 볼에 담기니 다음 요리를 이어가기 쉽다.
...
| 구성 요소 | 역할 | 설계 포인트 |
| :-- | :-- | :-- |
| [Opcode](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/159_opcode/) | 수행 연산 지정 | 산술, [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/), 이동, 비교 등 명령 종류 구분 |
| Rd (Destination [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/)) | 결과 저장 위치 | 기존 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/)와 분리되어 비파괴성 확보 |
| Rs1 (Source [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/) 1) | 첫 번째 입력 | 주로 왼쪽 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) |
| Rs2 (Source [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/) 2) | 두 번째 입력 | [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 또는 즉시값 변형과 결합 |

현대 [RISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/195_risc/) 계열에서 3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)가 잘 맞는 이유는 고정 길이 포맷과 결합하기 쉽기 때문이다. 예를 들어 32비트 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)에서 [범용 레지스터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/162_gpr/) [GPR](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/162_gpr/) (General Purpose [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/))가 32개라면, [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 하나를 지정하는 데 5비트가 필요하다. 세 주소를 넣으면 15비트를 쓰고도 연산 코드와 일부 제어 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/)를 남길 수 있어, [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)가 매 사이클 같은 위치에서 `Rd`, `Rs1`, `Rs2`를 빠르게 분리해 낼 수 있다.
...
다만 주소를 세 개 담으려면 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) 예산이 빠듯하다. [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 수를 너무 늘리면 주소 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/)가 커지고, 즉시값 크기를 늘리면 주소 필드가 줄어든다. 그래서 많은 3-주소 ISA는 "[레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)는 32개 안팎, [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 길이는 32비트, 큰 상수는 별도 로드"라는 절충을 선택한다.
...
2-주소 형식은 코드 밀도 면에서는 매력적이지만, `A = A + B`처럼 목적지가 입력을 겸하면서 거짓 의존성(False Dependency)을 많이 만든다. 1-주소 형식은 더 단순하지만 [누산기](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/) 병목이 심하다. 3-주소 형식은 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 하나가 약간 커져도, 전체 프로그램 수준에서는 불필요한 `MOV`, `LOAD`, `STORE` 수를 줄여 실행 흐름을 더 매끈하게 만든다.

이 지점에서 RISC와 [CISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/196_cisc/) (Complex [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Set Computer)의 철학 차이도 연결된다. RISC는 고정 길이·[레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 중심·단순 디코딩을 선호하므로 3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)와 잘 맞는다. 반대로 x86 같은 CISC는 겉으로는 2-주소 또는 메모리 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) 형식을 많이 쓰지만, 내부 마이크로-연산으로 쪼갤 때는 사실상 3-주소 형태로 재구성해 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 실행에 활용한다. 즉 3-주소는 외부 [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/) 문법일 뿐 아니라, 현대 [마이크로아키텍처](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/204_microarchitecture/) 내부에서 선호되는 실행 단위이기도 하다.

컴파일러 관점에서도 연결성이 크다. [IR](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/165_ir/) (Intermediate Representation)이나 SSA (Static Single Assignment) 형태가 3-주소와 닮아 있는 이유는, 각 연산 결과를 새 이름에 바인딩할수록 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 흐름 분석과 최적화가 쉬워지기 때문이다. 결국 3-주소는 "하드웨어가 좋아하는 형식"이면서 동시에 "컴파일러가 생각하기 쉬운 형식"이다.
...
3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)의 가장 큰 효과는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 흐름을 명확하게 만든다는 점이다. 원본을 보존하므로 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 간 의존 관계가 드러나고, [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 재사용과 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 실행 기회가 커진다. 그 결과 컴파일러는 더 공격적인 최적화를 수행할 수 있고, 프로세서는 더 예측 가능한 파이프라인을 구성할 수 있다.
...
| 개념 | 연결 포인트 |
| :-- | :-- |
| [2-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/193_2_address_instruction/) (Two-Address [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)) | 목적지와 소스가 겹쳐 원본 파괴가 발생하는 비교 대상 |
| Load/Store [Architecture](/knowledge-base/studynote/12_it_management/05_security_compliance/319_architecture/) | 메모리는 읽고 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)만 하고, 연산은 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)에서 수행하는 3-주소 RISC의 기본 운영 방식 |
| [Register Renaming](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/239_register_renaming/) | 외부 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)의 의존성을 내부 물리 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)로 풀어 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/)성을 높이는 기법 |
| SSA (Static Single Assignment) | 결과를 새 이름에 저장하는 3-주소적 사고를 컴파일러 수준에서 체계화한 표현 |
| Compressed [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/) | 3-주소의 코드 크기 약점을 보완하기 위해 도입되는 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 명령 집합 |
...
1. 3-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)는 친구 둘이 재료를 주고, 다른 빈 그릇에 완성품을 담는 약속이에요.
