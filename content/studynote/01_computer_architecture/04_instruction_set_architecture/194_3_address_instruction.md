...
기술사 답안에서는 "3-주소가 항상 우월하다"고 쓰면 부족하다. 정확한 판단은 <strong>성능 중심이면 3-주소가 유리하지만, 코드 밀도와 즉시값 표현력까지 고려하면 압축 명령어 또는 혼합 포맷이 필요하다</strong>는 식으로 정리해야 한다. 실제 ARM Thumb, RISC-V C 확장은 이 한계를 메우기 위해 등장한 사례다.
