...
> 1. **본질**: 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) (Two-Address [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/))는 두 개의 주소 필드를 가지되, 그중 하나가 입력과 결과 저장 위치를 겸하는 **파괴적 갱신** 구조다.
> 2. **가치**: 이 구조는 [1-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/192_1_address_instruction/)의 [누산기](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/) 병목을 줄이면서도 [3-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/194_3_address_instruction/)보다 코드 밀도 ([Code](/knowledge-base/studynote/02_operating_system/02_process_thread/082_process_memory_structure/) Density)를 높여, 메모리가 비싸던 시대에 매우 현실적인 절충안이 되었다.
> 3. **판단 포인트**: 겉으로는 간결하지만 원본 보존이 어렵기 때문에, 현대 시스템에서는 [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/) ([Instruction Set Architecture](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/)) 수준에서는 유지되더라도 내부 실행은 3-주소형 마이크로-연산으로 바꿔 처리하는 경우가 많다.
...
- **📢 섹션 요약 비유**: 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)는 칠판 한쪽에 적힌 답을 지우고 그 자리에 새 답을 적는 방식과 같다. 분필과 칠판 공간은 아끼지만, 이전 답을 다시 보려면 미리 공책에 베껴 두어야 한다.
...
| 필드 | 의미 | 동작 역할 | 설계상 영향 |
| :--- | :--- | :--- | :--- |
| [연산 코드](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/159_opcode/) ([Opcode](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/159_opcode/)) | 수행할 연산 종류 | ADD, SUB, AND 등 지정 | 해독 복잡도 결정 |
| [Operand](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) 1 | 첫 번째 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) | 입력 + 결과 저장 위치 | 원본 파괴 가능 |
| [Operand](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) 2 | 두 번째 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) | 입력 전용 | 값 보존 가능 |
...
2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)를 제대로 이해하려면 1-주소, 3-주소와의 경계를 같이 봐야 한다. 1-주소는 [누산기](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/) 중심이라 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)는 짧지만 병렬성이 약하고, 3-주소는 원본을 보존해 최적화가 쉽지만 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 폭이 커진다. 2-주소는 그 중간 지점에서 코드 크기와 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 활용의 균형을 잡는다.

| 구분 | [1-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/192_1_address_instruction/) | 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) | [3-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/194_3_address_instruction/) |
| :--- | :--- | :--- | :--- |
| 기본 형태 | `ADD X` | `ADD R1, R2` | `ADD R3, R1, R2` |
| 숨은 저장 위치 | [누산기](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/) | 첫 번째 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/) | 별도 목적지 |
...
1. 결과가 첫 번째 [피연산자](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/160_operand/)를 덮어쓰므로, 원본 값의 생존 구간 (Live Range)을 정확히 추적해야 한다.
2. 메모리-[레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 혼합 연산이 가능하더라도, 실제 병목은 디코딩과 메모리 지연일 수 있으므로 단순 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 수만 보고 판단하면 안 된다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [누산기](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/) ([Accumulator](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/161_accumulator/)) | [1-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/192_1_address_instruction/)의 중심 저장소로, 2-주소가 극복하려 한 병목의 출발점 |
| [범용 레지스터](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/162_gpr/) ([GPR](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/162_gpr/), General Purpose [Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/)) | 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)가 여러 연산 대상을 다루게 해 준 핵심 자원 |
| [3-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/194_3_address_instruction/) (Three-Address [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)) | 비파괴적 연산 구조를 통해 2-주소의 한계를 드러내는 비교 대상 |
| [레지스터 리네이밍](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/239_register_renaming/) ([Register Renaming](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/239_register_renaming/)) | 2-주소의 거짓 의존성을 하드웨어 내부에서 완화하는 기법 |
| [CISC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/196_cisc/) (Complex [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Set Computer) | 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)가 많이 쓰인 대표 계열로, 코드 밀도와 [호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/)을 중시 |
...
1. 2-주소 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)는 공책 두 칸 중 한 칸에 계산도 하고 답도 다시 적는 방법이에요.
...
← **이전**: [192. 1-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/192_1_address_instruction/)
**다음**: [194. 3-주소 명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/194_3_address_instruction/) →
