...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">공유 버스에서 점대점 스위치 구조로 바뀌는 이유</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">PCI</div><div class="kb-diagram-cell">PCIe</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">(Shared Parallel Bus)</div><div class="kb-diagram-cell">(Point-to-Point Serial Interconnect)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">CPU ─ ─ Device A</div><div class="kb-diagram-cell">CPU / Root Complex ─ Switch ─ Device A</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">─ Device B</div><div class="kb-diagram-cell">Device B</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">─ Device C</div><div class="kb-diagram-cell">Device C</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">한 버스를 번갈아 사용</div><div class="kb-diagram-cell">장치별 독립 링크 사용</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">충돌·대기 증가</div><div class="kb-diagram-cell">동시 처리·확장성 향상</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">PCIe 링크의 논리 구조와 데이터 흐름</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Application / Driver</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Transaction Layer : 메모리 읽기/쓰기 요청, Completion, DMA</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Data Link Layer : 순서 보장, ACK/NAK, CRC, 재전송</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Physical Layer : 직렬화, 레인 동기화, 속도 협상, 전기 신호 처리</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">x1 / x4 / x8 / x16 ──&gt; 차동 신호 레인 집합 ──&gt; 장치 간 패킷 전달</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">PCI (공유 병렬 버스)</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">PCIe Gen1~Gen3</div>
<div class="kb-diagram-note">(점대점 직렬 링크 · 레인 확장)</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">PCIe Gen4~Gen6</div>
<div class="kb-diagram-note">(대역폭 증대 · 신호 무결성 고도화 · PAM4)</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">NVMe SSD · GPU 가속 · 100G/200G NIC</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">CXL · 가속기 패브릭 · 메모리 확장</div>
</div>
</div>
