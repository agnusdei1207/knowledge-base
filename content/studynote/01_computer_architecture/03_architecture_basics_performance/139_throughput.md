...
결국 기술사 답안이나 실무 설계에서는 "처리량을 높여야 하는 업무인지, 응답 시간을 지켜야 하는 업무인지"를 먼저 구분해야 한다. 그리고 처리량 목표를 택했다면, 단순 성능 자랑이 아니라 <strong>병목 제거 + 병렬성 확보 + 포화 관리</strong>라는 세 가지를 함께 제시해야 한다.
