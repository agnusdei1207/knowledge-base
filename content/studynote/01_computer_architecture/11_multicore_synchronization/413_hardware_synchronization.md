...
기술사 답안 관점에서는 "하드웨어 동기화 = 고성능"이라고 단정하지 말고, <strong>짧은 구간·낮은 충돌·정확한 메모리 순서 설계</strong>일 때 강점을 발휘한다고 쓰는 것이 정확하다. 또한 운영체제 수준 락, 캐시 일관성, 메모리 배리어와 함께 설명해야 입체적인 답안이 된다.
