...
| 갱신 메시지 | 주소 + 새 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 전달 | 무효화보다 패킷이 무거움 |
| 수신 캐시 | 해당 라인을 최신값으로 수정 | 다음 읽기 히트 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 상승 |
| 메모리 계층 | 필요 시 최신 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 반영 | [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)별로 시점 차이 존재 |
...
| :--- | :--- | :--- |
| [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 시 동작 | 새 값을 다른 캐시에 전달 | 다른 복사본을 무효화 |
| 다음 읽기 비용 | 낮을 수 있음 | 다시 읽을 때 miss 가능 |
| 반복 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 비용 | 매 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)마다 전파 비용 발생 | 첫 무효화 후 조용한 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 가능 |
| 적합한 패턴 | 읽기 비율 높고 재공유가 빠름 | [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 집중, 공유자 많음 |
| 현대 채택 | 제한적, 특수 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 위주 | 범용 CPU의 주류 |
...
실무 판단의 핵심은 "공유 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 정말 곧바로 재사용되는가, 아니면 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)만 많이 일어나는가"다. 현대 범용 프로세서가 write-update를 널리 채택하지 않는 이유는 명확하다. 코어 수가 늘수록 공유자 추적과 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 전파 비용이 커지고, 고빈도 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 구간에서는 캐시 미스를 줄인 이득보다 인터커넥트 혼잡이 더 큰 손해로 바뀌기 때문이다.
...
- [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/) 증가처럼 짧은 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)가 매우 자주 반복되는 경우
...
갱신 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)의 가장 큰 장점은 공유 읽기의 체감 지연시간을 줄인다는 점이다. 다른 코어가 이미 최신값을 받아 둔 상태라면, 다음 읽기에서 캐시 미스를 거치지 않고 곧바로 작업을 이어 갈 수 있다. 이는 소규모 공유, 제어 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/), 빠른 hand-off 패턴에서 의미 있는 효과를 낼 수 있다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [캐시 일관성](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/) ([Cache Coherence](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/)) | 여러 캐시 복사본의 값이 충돌하지 않게 유지하는 상위 문제 |
| [무효화 정책](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/405_write_invalidate/) ([Write-Invalidate](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/405_write_invalidate/)) | Write-Update와 대비되는 주류 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) |
| [스누핑 프로토콜](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/403_snooping_protocol/) ([Snooping Protocol](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/403_snooping_protocol/)) | 공유 버스에서 update 메시지를 감시·반영하는 구현 방식 |
| Dragon [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) (Dragon [Protocol](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)) | write-update 계열의 대표 사례 |
| [거짓 공유](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/409_false_sharing/) ([False Sharing](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/409_false_sharing/)) | update/invalidate 모두에서 불필요한 통신을 키우는 병목 |
