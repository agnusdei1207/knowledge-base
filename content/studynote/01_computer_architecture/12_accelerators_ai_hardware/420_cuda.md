...
결국 기술사 관점의 판단은 명확하다. CUDA는 범용 가속 만능키가 아니라, <strong>문제를 데이터 병렬 구조로 재정의할 수 있을 때 폭발적인 효과를 내는 특화 도구</strong>다. 따라서 Nsight 계열 프로파일러로 병목을 확인하고, 메모리 이동·커널 배치·라이브러리 활용 순서로 최적화해야 한다.
