...
스트리밍 멀티프로세서 (Streaming [Multiprocessor](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/375_multiprocessor/), SM)는 NVIDIA GPU에서 [스레드 블록](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/) ([Thread Block](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/))을 받아 실제 연산을 수행하는 하드웨어 실행 클러스터다. CPU (Central Processing Unit) 코어가 단일 작업의 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간을 줄이는 데 많은 제어 로직을 쓰는 반면, SM은 같은 종류의 연산을 대량으로 흘려보내는 데 면적을 집중한다. 즉, SM은 "똑똑한 소수"보다 "규격화된 다수"를 택한 구조다.
...
| :--- | :--- | :--- |
| 워프 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) (Warp Scheduler) | 실행 가능한 워프를 선택해 명령 발행 | 메모리 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 은닉, 발행 효율 결정 |
| [CUDA](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/420_cuda/) 코어 | 정수·[부동소수점](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/087_floating_point/) 기본 연산 수행 | 범용 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 연산 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/) 결정 |
| [텐서 코어](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/427_tensor_core/) | 행렬 곱셈 누산 (Matrix [Multiply-Accumulate](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/428_mac_operation/)) 가속 | [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 학습·추론 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/) 급증 |
| [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) | [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)별 상태와 중간값 저장 | 점유율 (Occupancy), 문맥 교체 비용에 영향 |
| [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) / L1 캐시 | 블록 내부 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 재사용, 저지연 협업 | 메모리 병목 감소, 타일링 최적화 핵심 |
| 로드/스토어 유닛 | 전역 메모리 접근 처리 | 코얼레싱 여부에 따라 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 차이 발생 |
...
즉 SM [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)은 단순히 "코어 몇 개냐"보다 "준비된 워프를 얼마나 많이 유지하느냐"에 달려 있다. 그래서 [GPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/418_gpu/) 최적화는 종종 계산식 자체보다 자원 배치 문제에 가깝다. 블록 크기, [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)당 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 수, [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) 타일 크기가 모두 SM 내부 수용 능력과 직접 연결된다.
...
SM의 성격을 선명하게 보려면 CPU 코어와 비교하는 것이 가장 빠르다. CPU 코어는 낮은 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간, 높은 [단일 스레드 성능](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/570_stp_vs_mtp/), 복잡한 제어 흐름 처리에 강하다. 반면 SM은 많은 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)가 대체로 같은 명령 흐름을 따를 때 강하며, 복잡한 분기보다 대량의 반복 연산에서 진가를 발휘한다. 같은 "코어"라는 말을 써도 설계 목표가 다르다.

| 항목 | CPU 코어 | SM |
| :--- | :--- | :--- |
| 우선 목표 | [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간 최소화 | [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/) 최대화 |
| 제어 구조 | [분기 예측](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/231_branch_prediction/), Out-of-Order 실행 중심 | 단순 제어 + 대량 워프 관리 |
| [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 처리 | 적은 수의 강한 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) | 많은 수의 가벼운 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) |
| [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 대응 | 캐시 계층·투기 실행 | 워프 교체·점유율 확보 |
| 취약점 | 코어 수 확장 비용 큼 | 분기 발산·비정형 접근에 약함 |

또한 SM은 [SIMT](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/423_simt/) (Single [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Multiple Threads) 실행 모델의 실제 무대다. 워프 내부 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)는 같은 명령 흐름을 공유하므로, `if-else` 분기가 갈라지면 워프 분기 발산 (Warp Divergence)이 생겨 유휴 연산기가 늘어난다. 이는 422번의 [스레드 블록](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/)/워프, 423번의 SIMT와 직접 이어지고, 427번의 [텐서 코어](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/427_tensor_core/)와는 "SM 안에 특화 연산기를 추가해 특정 연산의 밀도를 더 끌어올린다"는 방향으로 연결된다.

나아가 SM은 범용 GPU와 전용 가속기 사이의 경계도 보여준다. [NPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/) ([Neural Processing Unit](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/))나 [TPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/425_tpu/) ([Tensor Processing Unit](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/425_tpu/))는 특정 연산 패턴에 맞춰 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 흐름을 더 강하게 고정함으로써 효율을 높인다. 반대로 SM은 여전히 범용성을 유지해 그래픽스, 과학 계산, 딥러닝, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석을 폭넓게 처리한다. 즉 SM은 CPU보다 훨씬 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 친화적이면서도, 완전한 전용기보다는 덜 경직된 중간 지점에 있다.
...
실무에서 SM을 이해한다는 것은 "GPU를 샀다"가 아니라 "SM 자원을 얼마나 효율적으로 채웠는가"를 묻는 일이다. 예를 들어 블록 크기를 32의 배수로 맞추지 않으면 워프가 부분적으로만 차서 연산기가 빈자리를 안고 실행된다. 반대로 블록을 무작정 크게 잡으면 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)와 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)를 과점해 동시에 상주할 수 있는 블록 수가 줄어든다. 결국 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 튜닝은 최대 점유율과 충분한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 재사용 사이의 균형 문제다.
...
- 동일 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)을 많은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 반복 적용하는 [배치 처리](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/228_batch_processing_hadoop_spark/)
- 타일링과 재사용을 통해 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) 이득을 얻을 수 있는 문제

### 회피가 필요한 경우

- 포인터 추적, 트리 순회, [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/) 탐색처럼 분기와 불규칙 접근이 심한 문제
- [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 크기가 작아 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 실행 및 전송 오버헤드가 더 큰 문제
- 실시간 제어처럼 최악 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간 보장이 더 중요한 문제

기술사 답안 관점에서는 "SM 개수 증가 = 무조건 빠름"이라고 쓰면 부족하다. SM 수가 늘어도 메모리 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/), 인터커넥트, L2 캐시, [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 구조가 받쳐주지 않으면 확장 효율은 떨어진다. 따라서 SM은 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)의 원인이자 동시에 병목을 드러내는 측정 단위로 봐야 한다.
...
SM 아키텍처의 가장 큰 효과는 GPU를 대규모 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 처리에 맞는 모듈형 구조로 만들었다는 점이다. 동일한 실행 단위를 반복 배치함으로써 칩 설계는 확장성을 확보하고, 소프트웨어는 블록과 워프 추상화로 이를 활용할 수 있게 되었다. 그 결과 그래픽스뿐 아니라 고성능 컴퓨팅 ([High Performance Computing](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/226_hpc_supercomputing_infrastructure/), [HPC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/548_automotive_hpc/))과 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) 학습까지 하나의 생태계 위에서 돌아가게 되었다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [스레드 블록](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/) ([Thread Block](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/)) | 하나의 SM에 배치되는 소프트웨어 작업 단위 |
| 워프 (Warp) | SM이 실제로 스케줄링하는 최소 실행 묶음 |
| [SIMT](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/423_simt/) (Single [Instruction](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) Multiple Threads) | SM이 대량 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)를 실행하는 기본 제어 모델 |
| [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) ([Shared Memory](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)) | SM 내부에서 블록 구성원이 협업하는 저지연 저장소 |
| 점유율 (Occupancy) | SM 자원 사용량이 활성 워프 수로 이어지는 지표 |
| [텐서 코어](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/427_tensor_core/) ([Tensor Core](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/427_tensor_core/)) | 최신 SM 내부에 통합된 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 특화 연산기 |
...
← **이전**: [420. CUDA (Compute Unified Device Architecture)](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/420_cuda/)
**다음**: [422. 스레드 블록 (Thread Block)과 워프 (Warp)](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/422_thread_block_and_warp/) →
