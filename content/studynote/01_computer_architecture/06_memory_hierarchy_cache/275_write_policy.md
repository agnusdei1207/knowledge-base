...
# 275. 캐시 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) (Write [Policy](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/))

## 핵심 인사이트 (3줄 요약)

> 1. **본질**: 캐시 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) (Write [Policy](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/))은 CPU (Central Processing Unit)가 값을 바꿨을 때 그 변경을 캐시에만 잠시 둘지, 하위 메모리까지 즉시 보낼지를 정하는 규칙이다.
> 2. **가치**: 이 선택은 읽기 경로보다 더 직접적으로 메모리 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 트래픽, [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간, [전력 소모](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/466_power_consumption/), [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 비용을 바꾼다.
> 3. **판단 포인트**: 현대 시스템은 보통 [Write-Back](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/277_write_back/) + Write-Allocate를 택하지만, 장치 제어·[로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 기록·[DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) ([Direct Memory Access](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/318_dma/)) 연동처럼 즉시 반영이 중요한 구간은 다른 선택이 더 안전하다.
...
| :--- | :--- | :--- | :--- |
| Write [Hit](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/263_cache_hit_miss/) 처리 | [Write-Through](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/276_write_through/) | 캐시와 하위 메모리를 함께 갱신 | No-Write-Allocate와 자주 결합 |
| Write [Hit](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/263_cache_hit_miss/) 처리 | [Write-Back](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/277_write_back/) | 캐시만 갱신하고 [더티 비트](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/278_dirty_bit/) 표시 | Write-Allocate와 자주 결합 |
...
| :--- | :--- | :--- |
| 하위 메모리 갱신 시점 | 매 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)마다 즉시 | 교체·플러시 시점 |
| 메모리 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 트래픽 | 큼 | 작음 |
| 하드웨어 복잡도 | 비교적 단순 | [더티 비트](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/278_dirty_bit/)·상태 관리 필요 |
| 장애/관찰 관점 | 최신값 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)이 쉬움 | 캐시 플러시 여부 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 필요 |
| 잘 맞는 워크로드 | [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/), MMIO (Memory-Mapped I/O), 일회성 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) | 루프 변수, 누적값, 일반 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) |

여기에 Allocate [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)을 붙이면 특성이 더 선명해진다. [Write-Through](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/276_write_through/) + No-Write-Allocate는 "어차피 다시 안 쓸 가능성이 큰 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 캐시를 더럽히지 말자"는 철학이고, [Write-Back](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/277_write_back/) + Write-Allocate는 "한 번 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 시작한 블록은 곧 다시 쓸 가능성이 크다"는 철학이다. 결국 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)은 지역성 가정에 대한 아키텍처의 답변이다.

또한 이 개념은 멀티코어와 입출력으로 자연스럽게 확장된다. 한 코어가 Write-Back으로 수정한 값을 다른 코어가 읽으려면 [캐시 일관성](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/) [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)이 최신 소유자를 찾아줘야 한다. 장치가 DMA로 메모리를 직접 읽고 쓰는 경우에는 CPU 캐시의 최신본과 장치가 보는 메모리 값이 어긋날 수 있으므로, 캐시 무효화나 플러시가 반드시 따라붙는다.
...
1. 같은 블록에 대한 반복 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)가 많은가, 아니면 한 번 쓰고 끝나는가?
2. 다른 코어·장치가 즉시 최신값을 봐야 하는가?
3. 정전·장애 시 최신본 유실을 소프트웨어 계층에서 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)할 수 있는가?
4. [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 버퍼 포화, 플러시 비용, [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 트래픽을 감당할 수 있는가?

### [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- MMIO 영역을 일반 DRAM처럼 생각하고 Write-Back으로 다루는 설계
- [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) 버퍼를 [캐시 일관성](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/) 처리 없이 재사용하는 드라이버 코드
- 스트리밍 대량 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 일반 캐시에 채워 넣어 캐시 오염을 유발하는 구현

- **📢 섹션 요약 비유**: 장치 제어 주소는 결재 버튼과 같아서 누르는 즉시 서버에 반영돼야 한다. 반면 일반 작업 문서는 로컬 초안에서 여러 번 다듬어도 되므로, 같은 "[쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)"라도 문맥에 따라 규칙을 달리 써야 한다.

---

## Ⅴ. 기대효과 및 결론

적절한 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)을 선택하면 메모리 계층은 단순 저장소가 아니라 트래픽 조절기가 된다. Write-Back은 동일 블록에 대한 반복 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)를 캐시 내부에 흡수하여 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 사용량과 평균 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간을 크게 줄인다. Write-Through는 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)에서는 불리하지만, 관찰 가능성과 단순성 덕분에 장치 제어·특수 메모리 영역에서 여전히 중요한 역할을 맡는다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [Write-Through](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/276_write_through/) | 캐시와 하위 메모리를 즉시 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)하는 대표 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) |
| [Write-Back](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/277_write_back/) | [더티 비트](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/278_dirty_bit/)를 기반으로 교체 시점에 반영하는 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 중심 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) |
| Write-Allocate | [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 미스 시 블록을 캐시에 적재해 이후 지역성을 활용하는 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) |
| [Dirty Bit](/knowledge-base/studynote/02_operating_system/07_virtual_memory/396_dirty_bit/) | 캐시 라인이 하위 메모리와 달라졌는지 추적하는 상태 [비트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/073_bit/) |
| [Cache Coherence](/knowledge-base/studynote/01_computer_architecture/11_multicore_synchronization/402_cache_coherence/) | 멀티코어에서 각 캐시의 최신본을 일치시키는 메커니즘 |
| [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) ([Direct Memory Access](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/318_dma/)) | CPU 캐시 밖에서 메모리를 직접 갱신해 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)과 충돌할 수 있는 장치 접근 방식 |
