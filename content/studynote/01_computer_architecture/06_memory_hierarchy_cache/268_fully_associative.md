...
기술사 답안에서는 "완전 연관 = 최고 성능"이라고 단정하면 부족하다. 정확한 표현은 <strong>"적중률 관점에서는 가장 유리하지만, hit time·면적·전력 관점에서는 가장 비싼 구조"</strong> 다. 결국 실무 채택 여부는 이상적 배치보다 전체 메모리 계층의 비용 균형으로 결정된다.
