...
기술사 답안 관점에서는 "직접 사상 = 무조건 구식"이라고 쓰면 부족하다. 핵심은 <strong>조회 지연 최소화와 충돌 증가 사이의 교환관계</strong>를 설명하고, 어떤 환경에서는 여전히 합리적 선택임을 보여주는 것이다. 즉, 직접 사상은 시대에 뒤처진 구조가 아니라 비용 제약이 강한 곳에서 여전히 유효한 극단값이다.
