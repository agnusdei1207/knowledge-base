...
기술사 답안에서는 집합 연관 사상을 “좋은 절충안”이라고만 쓰면 부족하다. 더 정확한 표현은 <strong>충돌 미스를 줄이기 위해 제한된 범위의 병렬 비교를 허용한 구조</strong>이며, 최적 웨이는 계층, 워크로드, 전력 예산에 따라 달라진다는 것이다. 결국 설계 판단의 핵심은 연관도 자체가 아니라, 연관도가 만들어 내는 전체 비용 균형이다.
