...
| :--- | :--- | :--- | :--- | :--- |
| [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) ([Register](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/175_register_addressing/)) | [플립플롭](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/051_flip_flop/) ([Flip-Flop](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/051_flip_flop/)) | 1 cycle 수준 | [워드](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/075_word/) ([Word](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/075_word/)) | [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)/컴파일러 |
| 캐시 (Cache) | [SRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/250_sram/) | 수 cycle ~ 수십 cycle | 캐시 라인 (Cache Line) | 하드웨어 |
...
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 성격 | 지금 곧 쓸 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | 곧 쓰지 않을 가능성이 큰 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) |
| 관리 방식 | 하드웨어 자동화 비중 큼 | [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)·[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)시스템 관여 큼 |
| 실패 비용 | 수 cycle 손실 | 수백 ns ~ ms급 대기 |
| 대표 문제 | 충돌 미스, 용량 미스 | [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/), I/O 병목 |
...
또 다른 사례는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)베이스와 서버 아키텍처다. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)베이스는 메모리 버퍼 풀로 디스크 접근을 줄이고, 애플리케이션은 [Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/) 같은 인메모리 캐시로 원본 저장소 부하를 줄인다. 이는 모두 가장 느린 계층으로 가는 빈도를 줄이려는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이다. 반대로 로그를 한 줄 쓸 때마다 동기식 디스크 flush를 수행하거나, 대용량 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 무작위로 스캔하는 패턴은 계층 구조의 이점을 스스로 파괴하는 안티패턴이다.

### 실무 판단 [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/)

1. 자주 쓰는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 크기가 상위 계층 용량 안에 들어오는가?
...
3. 캐시 미스가 늘어날 때 CPU 병목인지, [DRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/251_dram/) 병목인지, 스토리지 병목인지 구분했는가?
4. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 구조를 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 중심으로 바꾸거나 배치 순서를 조정해 워킹셋을 줄일 수 있는가?
5. 느린 계층 접근을 완전히 없앨 수 없다면, 비동기화·배치화·프리페치로 완충할 수 있는가?

결론적으로 메모리 계층을 잘 쓰는 설계는 “빠른 장치를 더 사는 것”보다 “느린 장치에 덜 가게 만드는 것”에 가깝다. 그래서 실제 튜닝은 하드웨어 증설만이 아니라 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 배치, 캐시 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/), [페이지 크기](/knowledge-base/studynote/02_operating_system/06_memory_management/352_page_size/), [배치 처리](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/228_batch_processing_hadoop_spark/) 방식까지 함께 봐야 한다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [참조의 지역성](/knowledge-base/studynote/02_operating_system/04_synchronization/253_locality_of_reference/) ([Locality of Reference](/knowledge-base/studynote/02_operating_system/04_synchronization/253_locality_of_reference/)) | 메모리 계층이 성립하는 전제이며, 상위 계층에 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 미리 두는 근거가 된다. |
| [캐시 메모리](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/259_cache_memory/) ([Cache Memory](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/259_cache_memory/)) | CPU와 [DRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/251_dram/) 사이에서 평균 접근 시간을 낮추는 대표적 상위 계층 구현이다. |
| [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) ([Virtual Memory](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)) | DRAM과 스토리지 사이에서 더 큰 주소 공간을 제공하는 계층 확장 메커니즘이다. |
| [AMAT](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/265_amat/) (Average Memory Access Time) | 계층 구조의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 히트 시간·미스율·미스 패널티 관점에서 정량화하는 지표다. |
| 워킹셋 ([Working Set](/knowledge-base/studynote/02_operating_system/04_synchronization/265_working_set/)) | 어떤 시점에 빠른 계층에 남겨야 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 유지되는 활성 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 집합이다. |
| [스래싱](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/) ([Thrashing](/knowledge-base/studynote/02_operating_system/04_synchronization/257_thrashing/)) | 워킹셋이 상위 계층 용량을 초과해 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 교체만 반복되는 병목 상태다. |
...
3. [메모리 계층 구조](/knowledge-base/studynote/02_operating_system/04_synchronization/252_memory_hierarchy/)는 이렇게 “가까운 곳엔 조금만, 먼 곳엔 많이” 두어서 빠름과 넉넉함을 같이 얻는 방법이에요.
