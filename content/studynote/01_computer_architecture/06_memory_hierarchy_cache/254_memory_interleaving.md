...
기술사 관점에서는 "어디서 쓰면 좋은가"와 함께 "어디서 멈춰야 하는가"를 말해야 한다. 개인용 PC나 단일 소켓 서버에서는 인터리빙이 대역폭 효율을 높이는 기본 해법이지만, 대규모 NUMA 환경에서는 로컬성 보장이 더 중요할 수 있다. 따라서 답안은 <strong>채널/뱅크 병렬성의 이득</strong>과 <strong>토폴로지 확장에 따른 비용</strong>을 함께 설명해야 완성도가 높다.
