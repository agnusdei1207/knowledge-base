...
기술사 답안에서는 "폴링은 나쁘다"라고 단정하면 부족하다. 정확한 평가는 <strong>단순성·결정성·저지연</strong>을 얻는 대신 <strong>CPU 효율·전력 효율·확장성</strong>을 희생하는 방식이라고 쓰는 것이다. 즉 장치 특성, 이벤트 빈도, 인터럽트 비용, 전용 자원 유무를 함께 보고 채택해야 한다.
