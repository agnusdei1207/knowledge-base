...
> 1. **본질**: 분리형 I/O (Isolated I/O)는 메모리 주소 공간과 입출력 장치 주소 공간을 분리해, 장치를 메모리가 아닌 별도 [포트 번호](/knowledge-base/studynote/03_network/08_transport_layer/402_port_number_16bit_application_process_identification/)로 다루는 구조다.
> 2. **가치**: 이 방식은 주소 공간이 작던 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 시스템에서 메인 메모리 (Main Memory)를 잠식하지 않고 장치를 제어하게 해 주었고, 명령의 의미도 더 명확히 나눴다.
...
| 구성 요소 | 역할 | 핵심 포인트 |
| :--- | :--- | :--- |
| [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 주소 ([Port](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) Address) | 장치 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/) | 메모리 주소와 별도 체계 |
| `IN` / `OUT` 명령 | I/O 전용 접근 | 명령 수준에서 의미 분리 |
| 주소 [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) (Address [Decoder](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)) | [포트 번호](/knowledge-base/studynote/03_network/08_transport_layer/402_port_number_16bit_application_process_identification/) 해석 | 특정 장치 선택 |
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 교환 | 실제 [바이트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/074_byte/)/[워드](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/075_word/) 전달 |
| 상태·제어 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) | 장치 상태 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 및 제어 | 준비 여부, 오류, 모드 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) |
...
| :--- | :--- | :--- |
| 주소 체계 | [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 공간 별도 분리 | 메모리 주소 공간과 통합 |
| 접근 명령 | `IN`, `OUT` 등 전용 명령 | `LOAD`, `STORE`, `MOV` 계열 |
| 메모리 공간 사용 | 메모리 공간 보존 | 장치가 메모리 공간 일부 차지 |
| 프로그래밍 방식 | 포인터 접근 불편, 전용 루틴 필요 | 포인터/구조체 기반 접근 용이 |
| 현대 고속 장치 적합성 | 낮음 | 높음 |
| 대표 맥락 | 레거시 x86, 단순 제어 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) | ARM, [RISC-V](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/200_riscv/), [PCIe](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/) 장치 |
...
1. 장치가 단순 제어 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 수준인가, 아니면 대규모 [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/)·큐 구조를 갖는가?
2. 대상 플랫폼이 x86 레거시 호환을 요구하는가?
3. [가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/) 환경에서 `IN`/`OUT` [트랩](/knowledge-base/studynote/02_operating_system/11_exam_summary/677_trap_based_system_call_implementation/) 비용을 감당할 수 있는가?
4. 향후 [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/), [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/), [메모리 보호](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/803_memory_protection/)와의 통합을 고려했는가?

### 피해야 할 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 고속 장치를 분리형 I/O만으로 계속 제어하려는 설계
- 드라이버 확장성을 무시하고 "예전 방식이니 그대로 유지"하는 접근
- [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 접근이 단순하다는 이유로 현대 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)의 [메모리 보호](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/803_memory_protection/)·[가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/) 비용을 과소평가하는 판단
...
분리형 I/O의 가장 큰 효과는 메모리 공간을 아끼고, 메모리 접근과 장치 접근의 의미를 구조적으로 분리했다는 데 있다. 이 덕분에 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 컴퓨터는 좁은 주소 공간에서도 여러 장치를 제어할 수 있었고, 특정 장치 제어를 명령 수준에서 분명히 정의할 수 있었다. 특히 x86 계열의 긴 역사 속에서 이 방식은 막대한 하위 [호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/)을 떠받치는 한 축이 되었다.
...
| 프로그램드 I/O (Programmed I/O) | CPU가 직접 장치 상태를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하며 읽고 쓰는 제어 방식 |
| [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) ([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/)) | 분리형 I/O [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)를 반복 읽으며 장치 준비 상태를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 대표 방식 |
| [인터럽트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) ([Interrupt](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/)) | [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 기반 제어의 비효율을 줄이기 위해 CPU에게 비동기 알림 제공 |
| [직접 메모리 접근](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/450_dma_direct_memory_access/) ([Direct Memory Access](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/318_dma/), [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/)) | 대용량 전송에서 CPU의 직접 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 접근 부담을 줄이는 기술 |
| x86 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 집합 구조 ([Instruction Set Architecture](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/), [ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/)) | `IN`, `OUT` 명령을 통해 분리형 I/O를 대표적으로 지원하는 구조 |
