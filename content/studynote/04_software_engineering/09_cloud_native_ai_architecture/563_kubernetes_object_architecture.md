...
<- **이전**: [563. 쿠버네티스 (Kubernetes) 오브젝트 아키텍처 (Pod, Service, Deployment, Ingress)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/955_kubernetes_object_architecture/)
**다음**: [564. 헬름 (Helm) 차트를 이용한 SW 패키지 관리](/knowledge-base/studynote/04_software_engineering/11_testing_validation/956_helm_chart_package_management/) ->
