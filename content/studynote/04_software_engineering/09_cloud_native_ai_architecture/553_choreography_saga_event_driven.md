...
<- **이전**: [553. 코레오그래피 사가 (Choreography Saga) - 이벤트 구독 기반의 자율적 흐름](/knowledge-base/studynote/04_software_engineering/11_testing_validation/945_choreography_saga/)
**다음**: [554. CQRS (명령과 조회 책임 분리) - 쓰기 DB와 읽기 DB 분리, 동기화 문제 해결 (Eventual Consistency)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/946_cqrs_command_query_responsibility_segmentation/) ->
