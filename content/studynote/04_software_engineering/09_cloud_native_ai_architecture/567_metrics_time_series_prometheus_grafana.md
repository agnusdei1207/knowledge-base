...
<- **이전**: [567. 메트릭 (Metrics) - 시계열 데이터 수집 (Prometheus, Grafana)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/959_metrics_time_series_collection/)
**다음**: [568. 로그 (Logs) - 분산 로그 수집 (ELK Stack - Elasticsearch, Logstash, Kibana / Fluentd)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/960_logs_distributed_collection/) ->
