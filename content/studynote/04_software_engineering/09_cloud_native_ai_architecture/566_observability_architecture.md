...
<- **이전**: [566. 옵저버빌리티 (Observability / 가시성) 아키텍처](/knowledge-base/studynote/04_software_engineering/11_testing_validation/958_observability_architecture/)
**다음**: [567. 메트릭 (Metrics) - 시계열 데이터 수집 (Prometheus, Grafana)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/959_metrics_time_series_collection/) ->
