...
← **이전**: [569. 분산 추적 (Distributed Tracing) - 트랜잭션 경로 추적 (OpenTelemetry, Jaeger, Zipkin)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/569_distributed_tracing/)
**다음**: [570. Trace ID와 Span ID의 전파 (Context Propagation)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/570_trace_id_and_span_id_propagation/) →
