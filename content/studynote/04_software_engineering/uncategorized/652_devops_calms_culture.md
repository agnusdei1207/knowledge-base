...
> 1. **본질**: 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
- **📢 섹션 요약 비유**: 요리사(개발팀)가 주방에서 맛있는 음식을 대충 접시에 담아 홀로 던져버리면, 서빙 직원(운영팀)이 쏟아진 음식을 수습하며 손님에게 욕을 먹는 식당 구조([사일로](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/))를 없애고, 요리사가 직접 서빙과 손님 반응까지 살피게 만드는 과정입니다.
...
2. <strong>Automation (자동화 - <a href="/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/">CI</a>/CD 인프라 코드화)</strong>:
...
- **📢 섹션 요약 비유**: 수제 자동차 공장에서 장인들이 망치로 철판을 두드리다 싸우던([사일로](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/)) 옛날 방식에서, 컨베이어 벨트(자동화)를 깔고 로봇 팔이 용접을 대신하며 불량품이 나오면 로봇의 세팅을 고치는(비난 없는 문화) 현대식 스마트 팩토리로의 전환입니다.

---

| 항목 | 설명 | 비고 |
| :--- | :--- | :--- |
| 핵심 특성 | 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화의 핵심 특성과 동작 방식 | 필수 이해 요소 |
...
| 변경 [리드 타임](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/085_lead_time_cycle_time/) (커밋~배포) | 1~6 개월 | 1시간 이내 |
| [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 시간 ([MTTR](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/451_mttr/)) | 수 시간 ~ 수 일 (전면 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)) | 1시간 이내 (빠른 [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/) 및 자동 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)) |
| 변경 실패율 | 15% ~ 30% | 0% ~ 15% |
...
3. **NoOps 오해**: 클라우드와 자동화가 모든 것을 해주므로 운영(Ops) 전문가가 아예 필요 없다고 믿는 현상. 오히려 보안, 아키텍처 안정성, 비용 최적화를 다루는 고도화된 [SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) ([Site Reliability 엔진ering](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/)) 전문가의 수요가 폭증한다.

- **📢 섹션 요약 비유**: 좋은 악기(자동화 툴)를 샀다고 해서 당장 훌륭한 교향악단(DevOps 조직)이 되는 것은 아닙니다. 단원들이 서로의 소리를 듣고 맞추려는 배려와 문화([CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/))가 없다면 그저 시끄러운 소음이 될 뿐인 것과 같은 이치입니다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software 엔진ering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
| 품질 보증 (QA, Quality Assurance) | 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화 적용 결과는 QA 활동을 통해 검증되고 측정된다 |
| [형상 관리](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/) ([SCM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/167_scm_software_configuration_management/), [Software Configuration Management](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/)) | 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화에서 생성된 산출물은 SCM을 통해 체계적으로 관리된다 |
...
1. 데브옵스 (DevOps) [CALMS](/knowledge-base/studynote/15_devops_sre/05_devsecops/281_calms/) 문화은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
...
<- **이전**: [651. 카나리 배포 / 블루-그린 배포 무중단](/knowledge-base/studynote/04_software_engineering/uncategorized/651_canary_blue_green_deployment/)
**다음**: [653. 데브섹옵스 (DevSecOps) 시프트 레프트](/knowledge-base/studynote/04_software_engineering/uncategorized/653_devsecops_shift_left/) ->
