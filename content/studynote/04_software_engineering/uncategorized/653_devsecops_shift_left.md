...
> 1. **본질**: 데브섹옵스 (DevSecOps) [시프트 레프트](/knowledge-base/studynote/15_devops_sre/05_devsecops/242_shift_left_sdlc/)은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
| 항목 | 설명 | 비고 |
| :--- | :--- | :--- |
| 핵심 특성 | 데브섹옵스 (DevSecOps) [시프트 레프트](/knowledge-base/studynote/15_devops_sre/05_devsecops/242_shift_left_sdlc/)의 핵심 특성과 동작 방식 | 필수 이해 요소 |
...
1. 데브섹옵스 (DevSecOps) [시프트 레프트](/knowledge-base/studynote/15_devops_sre/05_devsecops/242_shift_left_sdlc/)은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
