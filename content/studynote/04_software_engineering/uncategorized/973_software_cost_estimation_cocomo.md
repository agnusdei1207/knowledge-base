...
> 1. **본질**: 소프트웨어 비용 산정 COCOMO은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
- **개념**: [COCOMO](/knowledge-base/studynote/12_it_management/04_sdlc_testing/145_cocomo_model/) ([Constructive Cost Model](/knowledge-base/studynote/12_it_management/04_sdlc_testing/145_cocomo_model/))는 1981년 배리 보엠(Barry Boehm)이 제안한 소프트웨어 비용 산정 모델로, 예상되는 소스 코드의 라인 수(LOC, Lines of [Code](/knowledge-base/studynote/02_operating_system/02_process_thread/082_process_memory_structure/))를 핵심 입력 변수로 사용하여 개발에 필요한 총 노력(Man-Months)과 개발 기간(Months)을 계산하는 수학적 경험 모형이다.

- **필요성**: 소프트웨어 개발은 눈에 보이지 않는 논리적 산출물을 만드는 과정이므로, 건축이나 제조와 달리 물리적 자재 명세서([BOM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/124_bom_bill_of_materials/))가 존재하지 않는다. 이로 인해 프로젝트 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 단계에서 "얼마나 걸리고, 비용이 얼마나 들 것인가?"라는 이해관계자의 질문에 답하기 매우 어렵다. 과거에는 전문가의 직관에 의존하는 [델파이 기법](/knowledge-base/studynote/04_software_engineering/01_overview_principles/051_delphi_method/) 등이 쓰였으나, 프로젝트 규모가 커짐에 따라 개인의 경험에만 의존하면 치명적인 예산 초과(Cost Overrun)를 겪게 되었다. COCOMO는 과거 수많은 프로젝트 데이터의 통계적 회귀 분석을 통해 산출된 수학적 공식을 제공함으로써, 비용 산정을 과학의 영역으로 끌어올렸다.
...
| 비교 항목 | 소프트웨어 비용 산정 [COCOMO](/knowledge-base/studynote/12_it_management/04_sdlc_testing/145_cocomo_model/) | 유사 대안 |
| :--- | :--- | :--- |
...
다른 [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) 개념과의 연결을 보면, 소프트웨어 비용 산정 COCOMO은(는) 요구공학·설계·테스트·형상관리 전반에 걸쳐 영향을 미친다. 특히 품질 보증(QA, Quality Assurance)과 [형상 관리](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/)([SCM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/167_scm_software_configuration_management/), [Software Configuration Management](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/))와 긴밀하게 연계된다.
...
소프트웨어 비용 산정 COCOMO을(를) 올바르게 적용하면 [소프트웨어 품질](/knowledge-base/studynote/04_software_engineering/06_software_architecture/339_software_quality_definition/)·[유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)·팀 생산성이 동시에 향상된다. 그러나 도입에는 학습 비용과 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 투자가 필요하며, 조직 전체의 공감과 훈련이 선행되어야 한다.
...
- **📢 섹션 요약 비유**: 소프트웨어 비용 산정 COCOMO의 기대효과는 마라톤 훈련과 같다. 처음에는 느리고 고통스럽지만, 올바른 훈련 원칙을 지킨 선수만이 결승선에서 최고의 기록을 낼 수 있다. [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 원칙도 단기 편의보다 장기 완성도를 위한 투자다.
