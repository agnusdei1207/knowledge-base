...
> 1. **본질**: 번다운/번업 차트는 [[067_sprint_timebox|스프린트]]나 프로젝트의 [[216_progress_in_synchronization|진행]]을 [[003_bigdata_7v|시각화]]하는 [[033_agile_management|애자일 관리]] 도구다.
...
프로젝트의 흐름을 숫자만으로 보면 감이 안 온다. 차트는 이를 [[003_bigdata_7v|시각화]]한다.
...
| Burndown | 남은 작업 감소 |
| Burnup | 완료 작업 증가 |
| [[512_oauth_scope|Scope]] Line | 범위 변화 |
...
| 관점 | 남은 일감 | 완료량 |
| 범위 변화 | 간접 | 직접 |
| 사용 | [[067_sprint_timebox|스프린트]] 추적 | 범위 관리 |
...
기술사 관점에서는 번다운/번업 차트를 "[[004_agile_relation|애자일]] [[216_progress_in_synchronization|진행]] [[003_bigdata_7v|시각화]] 도구"로 설명해야 한다.
...
차트는 [[216_progress_in_synchronization|진행]] 상황을 빠르게 공유하고 위험을 조기에 발견하게 한다.

결론적으로 번다운/번업 차트는 [[004_agile_relation|애자일]] 진척 [[003_bigdata_7v|시각화]] 도구다.
