...
> 1. **본질**: CD ([Continuous Deployment](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/165_continuous_deployment/) / Delivery)는 [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/)([지속적 통합](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/076_ci_continuous_integration/))를 통과해 검증이 완료된 소프트웨어 빌드 결과물을 실제 운영 서버(Production)까지 안전하고 빠르게 릴리즈하는 자동화 파이프라인이다.
...
비록 [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/) 환경 구축보다 테스트 커버리지에 대한 강박적인 요구 수준이 높아 도입 난이도는 높지만, 한 번 구축된 CD 파이프라인은 [데브옵스](/knowledge-base/studynote/04_software_engineering/uncategorized/652_devops_calms_culture/)의 최종 목표인 '무중단 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 혁신'을 물리적으로 보장한다. CD는 단순한 배포 자동화 스크립트가 아니라, 비즈니스의 민첩성을 담보하는 가장 강력한 IT 심장으로 기억되어야 한다.
