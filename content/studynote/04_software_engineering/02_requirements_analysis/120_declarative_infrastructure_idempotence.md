...
← **이전**: [[119_gitops_single_source_of_truth|119. GitOps (Single Source of Truth) - Git을 단일 진실 원천으로 한 선언적 운영]]
**다음**: [[121_cicd_pipeline_automation|121. CI/CD 파이프라인 자동화 - 빌드·테스트·배포의 지속적 통합/전달 체계]] →
