...
> 2. **가치**: 팀이 외부 지시에만 의존하지 않고 스스로 일과를 나눠 가지면 [[067_sprint_timebox|스프린트]] 속도와 품질이 안정된다.
...
팀이 자기 조직화되지 않으면 병목이 생기고, [[067_sprint_timebox|스프린트]] 목표도 외부 지시로 흔들린다.
...
| Increment 책임 | 잠재적으로 출시 가능한 결과물 [[087_process_state_transition|생성]] |
...
| [[064_scrum_master_sm|Scrum Master]] | 프로세스 지원 | 팀 관리자 |
...
3. [[067_sprint_timebox|스프린트]] 목표를 함께 책임지는가?
...
← **이전**: [[064_scrum_master_sm|64. 스크럼 마스터 (Scrum Master) - 가이드, 장애 제거]]
**다음**: [[066_product_backlog_grooming|66. 제품 백로그 (Product Backlog) - 요구사항 우선순위 목록]] →
