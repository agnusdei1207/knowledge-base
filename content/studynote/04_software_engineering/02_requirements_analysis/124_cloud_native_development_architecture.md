...
- **📢 섹션 요약 비유**: 12 Factor는 [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/531_cloud_native_architecture/)의 <strong>건축 법규</strong>다. 이 규칙을 따라야 건물(앱)이 안전하다.
...
| **배포** | 수동 | 수동 | <strong><a href="/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/">CI</a>/CD</strong> |
...
[클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/531_cloud_native_architecture/)는 <strong>현대 소프트웨어 개발의 표준 패러다임</strong>이며, [CNCF](/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/) 생태계가 사실상 모든 기술 스택을 포괄한다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| <strong><a href="/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/">CNCF</a></strong> | [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/531_cloud_native_architecture/) 재단 |
| **12 Factor** | 설계 원칙 |
...
| <strong><a href="/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/">서비스 메시</a></strong> | 통신 인프라 ([Istio](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)) |
