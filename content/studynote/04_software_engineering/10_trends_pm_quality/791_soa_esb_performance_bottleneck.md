...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">서비스 지향 아키텍처(SOA) ESB</div></div>
...
<div class="kb-diagram-note">서비스 지향 아키텍처(SOA) ESB 성능 병목 한계 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
