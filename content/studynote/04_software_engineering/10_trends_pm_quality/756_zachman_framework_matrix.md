...
결론적으로 잭맨 프레임워크는 소프트웨어를 '예술'이나 '마법'에서 <strong>'공학'과 '건축'의 반열로 끌어올린 위대한 철학</strong>이다. 기술사는 아무리 낡은 모델이라도 이 36칸의 매트릭스가 묻고 있는 "다각적 통찰(Holistic View)"을 머릿속에 장착하고, 파편화된 코드들을 하나의 거대한 비즈니스 생태계(Enterprise)로 엮어내는 거시적 시야를 가져야 한다.
