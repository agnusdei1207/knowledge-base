...
> 1. **본질**: [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
[잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/)는 6개의 '관점(행)'과 6개의 '질문(열)'이 교차하여 만들어진 36개의 셀(Cell)로 구성된다.

- **📢 섹션 요약 비유**: [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스은(는) 복잡한 공사 현장에서 설계도와 공정표를 기반으로 팀을 이끄는 현장 감독과 같다. 원칙 없이 무작정 짓기 시작하면 결국 재공사가 필요하듯, 소프트웨어도 올바른 원칙 위에서만 품질과 효율이 보장된다.

| 항목 | 설명 | 비고 |
| :--- | :--- | :--- |
| 핵심 특성 | [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스의 핵심 특성과 동작 방식 | 필수 이해 요소 |
...
[잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/)는 개념적으로 완벽하지만 실무에서 바로 쓰기엔 너무 무거웠다. 그래서 이를 바탕으로 더 실용적인 프레임워크들이 파생되었다.
...
- **📢 섹션 요약 비유**: [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/)는 약국의 '한약장(서랍)'이다. 약통에 이름표만 36개 붙여놨을 뿐이다. 반면 TOGAF는 "첫째 날엔 인삼을 다듬고, 둘째 날엔 불을 지펴라"라고 약을 달이는 순서([ADM](/knowledge-base/studynote/03_network/01_data_communication/066_적응형_델타_변조_ADM/))까지 알려주는 완벽한 제조 매뉴얼이다.
...
스타트업이나 작은 모바일 앱을 만들 때 [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/)를 들이대면 회사가 망한다. 하지만 수만 명의 직원이 쓰는 거대 은행 시스템 차세대 프로젝트에서는 반드시 이 뼈대가 필요하다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software Engineering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
| 품질 보증 (QA, Quality Assurance) | [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스 적용 결과는 QA 활동을 통해 검증되고 측정된다 |
...
1. [잭맨 프레임워크](/knowledge-base/studynote/12_it_management/03_ea_isp/112_zachman_framework/) 6x6 매트릭스은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
...
← **이전**: [755. PMO 전사 품질 통제 및 감사 조직](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/755_pmo_project_management_office/)
**다음**: [757. MoSCoW 요구사항 우선순위 판별](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/757_moscow_requirement_prioritization/) →
