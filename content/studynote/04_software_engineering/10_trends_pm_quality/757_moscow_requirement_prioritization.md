...
|:---|:---|:---|
| **MoSCoW** | **4단계 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)** (M/S/C/W) | 이해하기 가장 쉽고 직관적. **'Won't'를 통해 스코프 크립([Scope Creep](/knowledge-base/studynote/04_software_engineering/03_design_architecture/161_scope_creep_requirements_inflation_prevention/)) 방어에 탁월함.** |
...
보통 실무에서는 **MoSCoW로 대분류를 한 뒤, 'Must Have' 안에서 어떤 걸 먼저 개발할지는 가치/노력 매트릭스나 [스크럼](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/062_scrum_framework_overview/) 백로그를 써서 [미세 조정](/knowledge-base/studynote/10_ai/02_dl_architecture_new/133_fine_tuning/)**을 한다.
