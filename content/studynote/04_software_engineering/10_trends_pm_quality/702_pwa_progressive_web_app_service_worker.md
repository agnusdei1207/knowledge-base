...
> 1. **본질**: PWA (Progressive Web App) 오프라인 워커은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
결론적으로 PWA는 웹의 '[접근성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/292_accessibility_kwcag_wcag/)'과 네이티브의 '경험'을 통합하려는 [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 궁극적 지향점이다. 기술 리더는 앱스토어라는 남의 플랫폼에 종속되지 않고, 웹의 자유로움 속에서 비즈니스를 전개하기 위한 강력한 무기로 PWA 아키텍처를 선택해야 한다.

- **📢 섹션 요약 비유**: PWA는 통행료(앱스토어 수수료)를 내는 고속도로 대신, 우리 회사 마당으로 바로 이어지는 전용 터널을 뚫는 기술이다. 터널 공사([서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 워커)만 잘해두면 톨게이트를 거칠 필요가 없다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software Engineering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | PWA (Progressive Web App) 오프라인 워커의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | PWA (Progressive Web App) 오프라인 워커은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
...
← **이전**: [701. WebAssembly (Wasm) 프론트 성능 가속](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/701_webassembly_wasm_frontend_performance/)
**다음**: [703. 백파이어링 FP LOC 역산](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/703_backfiring_fp_loc_conversion/) →
