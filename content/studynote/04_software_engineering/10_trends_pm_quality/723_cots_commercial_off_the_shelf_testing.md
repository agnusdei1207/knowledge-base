...
> 1. **본질**: [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
| 항목 | 설명 | 비고 |
| :--- | :--- | :--- |
| 핵심 특성 | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅의 핵심 특성과 동작 방식 | 필수 이해 요소 |
...
소프트웨어 획득 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 3가지를 비교해 보면 COTS의 장단점이 명확해진다.

| 구분 | 자체 개발 (In-house / Custom) | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) (상용 기성품) | [OSS](/knowledge-base/studynote/12_it_management/05_security_compliance/191_oss_license_compliance/) ([오픈소스](/knowledge-base/studynote/12_it_management/05_security_compliance/191_oss_license_compliance/) 소프트웨어) |
|:---|:---|:---|:---|
...
[COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 프로젝트가 실패하는 가장 흔한 이유는 "COTS를 우리 회사 입맛에 맞게 소스코드를 고쳐서(Customization) 쓰려다" 망하는 것이다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software Engineering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
| 품질 보증 (QA, Quality Assurance) | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅 적용 결과는 QA 활동을 통해 검증되고 측정된다 |
| [형상 관리](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/) ([SCM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/167_scm_software_configuration_management/), [Software Configuration Management](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/)) | [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅에서 생성된 산출물은 SCM을 통해 체계적으로 관리된다 |
...
1. [COTS](/knowledge-base/studynote/04_software_engineering/06_software_architecture/372_cots/) 상용 기성품 통합 테스팅은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
...
← **이전**: [722. 어니언 아키텍처 도메인 코어 격리](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/722_onion_architecture_domain_isolation/)
**다음**: [724. 인프라스트럭처 애즈 코드 (IaC) 테라폼](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/724_infrastructure_as_code_terraform/) →
