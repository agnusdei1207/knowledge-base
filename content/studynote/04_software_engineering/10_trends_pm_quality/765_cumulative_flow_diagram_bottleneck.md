...
> 1. **본질**: [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
CFD는 X축을 시간(날짜), Y축을 누적된 티켓(이슈) 개수로 설정한 면적 [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/)다.

- **📢 섹션 요약 비유**: [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석은(는) 복잡한 공사 현장에서 설계도와 공정표를 기반으로 팀을 이끄는 현장 감독과 같다. 원칙 없이 무작정 짓기 시작하면 결국 재공사가 필요하듯, 소프트웨어도 올바른 원칙 위에서만 품질과 효율이 보장된다.

| 항목 | 설명 | 비고 |
| :--- | :--- | :--- |
| 핵심 특성 | [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석의 핵심 특성과 동작 방식 | 필수 이해 요소 |
...
프로젝트를 관리하는 대표적인 [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/) 도구들은 목적이 명확히 다르다.
...
[번다운 차트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/072_burndown_burnup_chart/)는 "이번 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) 목표 달성 가능한가?"를 보는 근시안적 도구라면, CFD는 "우리 조직 전체의 체질(파이프라인)이 건강한가?"를 보는 거시적 도구다.

- **📢 섹션 요약 비유**: [간트 차트](/knowledge-base/studynote/04_software_engineering/01_overview_principles/039_gantt_chart/)가 '열차 시간표'고, [번다운 차트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/072_burndown_burnup_chart/)가 '종점까지 남은 거리 표시기'라면, CFD는 '모든 역의 플랫폼에 승객이 몇 명이나 대기하고 있는지 보여주는 종합 관제 [모니터](/knowledge-base/studynote/02_operating_system/04_synchronization/229_monitor/)'다.
...
CFD를 그려보면 조직 내에서 누가 욕심을 부리고 있고, 누가 고통받고 있는지 [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/)의 모양(형태)만으로 진단할 수 있다.
...
[누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/)(CFD)를 도입하고 [모니터](/knowledge-base/studynote/02_operating_system/04_synchronization/229_monitor/)링하면, 핑계 대기 바빴던 부서 간의 책임 전가가 사라진다. "개발이 늦어서 배포가 늦었다", "QA가 느리다"라며 싸울 필요 없이, 객관적인 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(수학적 [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/))가 병목의 위치를 정확히 지목해 주기 때문이다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software Engineering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
| 품질 보증 (QA, Quality Assurance) | [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석 적용 결과는 QA 활동을 통해 검증되고 측정된다 |
...
1. [누적 흐름도](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/086_cumulative_flow_diagram_cfd/) 병목 지점 병목 분석은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
...
← **이전**: [764. 리드 타임 프로세스 시작부터 배포 완료](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/764_lead_time_process_deployment/)
**다음**: [766. 소프트웨어 노후화 기술 부채 연계](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/766_software_aging_technical_debt/) →
