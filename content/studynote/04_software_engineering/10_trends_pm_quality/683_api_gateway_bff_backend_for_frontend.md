...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">API 게이트웨이 BFF (Backe</div></div>
...
<div class="kb-diagram-note">API 게이트웨이 BFF (Backend for Frontend) 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
