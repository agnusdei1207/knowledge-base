...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">서비스 메시 (Istio) 사이드카</div></div>
...
<div class="kb-diagram-note">서비스 메시 (Istio) 사이드카 통신 제어 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
