...
| **치명적 단점**| 없음 (문법이 틀리면 제안하지 않음) | **[환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)([Hallucination](/knowledge-base/studynote/12_it_management/05_security_compliance/345_llm_foundation_model_hallucination/))** (그럴싸하지만 틀린 코드를 뱉어냄) |
