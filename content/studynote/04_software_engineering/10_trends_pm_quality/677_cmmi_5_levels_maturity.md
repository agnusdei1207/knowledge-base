...
> 1. **본질**: [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) 성숙도 5단계 ([초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/)-관리-정의-정량-최적)은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
과거의 소프트웨어 프로젝트는 뛰어난 개발자 한두 명의 역량에 크게 의존했다. 영웅적 개발자가 있을 때는 성공하지만 그가 퇴사하면 프로젝트가 무너지는 일(Hero Worship)이 빈번했다. **[CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) (Capability [Maturity Model](/knowledge-base/studynote/12_it_management/01_governance_strategy/011_maturity_model/) Integration)**는 이러한 개인 의존성을 탈피하여, '조직 전체의 시스템과 프로세스'로 고품질의 소프트웨어를 반복적으로 생산하기 위해 등장했다.
...
|:---|:---|:---|:---|
| **레벨 1** | **[초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) (Initial)** | 임기응변, 영웅적 노력 의존, 예측 불가 | (정의된 프로세스 없음) |
...
| **레벨 3** | **정의 (Defined)** | 조직 전체의 표준 프로세스 확립, 테일러링 | 조직 프로세스 초점, [리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/) 관리 |
...
| 비교 항목 | [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) (Capability [Maturity Model](/knowledge-base/studynote/12_it_management/01_governance_strategy/011_maturity_model/) Integration) | [SPICE](/knowledge-base/studynote/12_it_management/04_sdlc_testing/139_spice_iso_iec_15504_process_assessment/) (ISO/IEC 15504) | ISO 9001 |
|:---|:---|:---|:---|
| **주체/기원** | 미국 국방부 / SEI (현 [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) Institute) | ISO/IEC 국제 표준 | ISO 국제 표준 |
...
| **적용 분야** | IT, 시스템 엔지니어링 중심 | SW 엔지니어링, 자동차(A-[SPICE](/knowledge-base/studynote/12_it_management/04_sdlc_testing/139_spice_iso_iec_15504_process_assessment/)) 등 | 전 산업 분야 범용 |

CMMI가 "우리 회사는 전체적으로 레벨 3이야"라고 말하는 데 익숙하다면, SPICE는 "우리의 [형상 관리](/knowledge-base/studynote/04_software_engineering/01_overview_principles/020_software_configuration_management/) 프로세스는 레벨 4, 테스팅은 레벨 2야"라고 진단하는 데 더 적합한 구조를 갖는다.
...
실무에서 [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) 도입은 양날의 검이다. 제대로 적용하면 개발 체계가 비약적으로 발전하지만, 잘못하면 '문서 작업만 양산하는 [좀비 프로세스](/knowledge-base/studynote/02_operating_system/02_process_thread/109_zombie_process/)'가 된다.

- **📢 섹션 요약 비유**: [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) 성숙도 5단계 ([초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/)-관리-정의-정량-최적)은(는) 복잡한 공사 현장에서 설계도와 공정표를 기반으로 팀을 이끄는 현장 감독과 같다. 원칙 없이 무작정 짓기 시작하면 결국 재공사가 필요하듯, 소프트웨어도 올바른 원칙 위에서만 품질과 효율이 보장된다.
...
CMMI를 성공적으로 내재화하면 프로젝트의 납기 준수율이 획기적으로 높아지고 재작업(Rework) 비용이 감소한다. 조직의 지식이 개인의 머릿속이 아닌 시스템에 축적되므로 인력 교체에 따른 [리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/)도 최소화된다.

그러나 급변하는 현대 IT 환경([DevOps](/knowledge-base/studynote/04_software_engineering/uncategorized/652_devops_calms_culture/), [Cloud Native](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/199_cloud_native_architecture_msa_cicd_devops/))에서 CMMI의 무거운 심사 과정은 스타트업이나 [애자일](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/004_agile_relation/) 조직에게 부담이 된다. 따라서 최신 [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) V2.0 이상부터는 비즈니스 성과와 [애자일](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/004_agile_relation/) 프랙티스와의 결합을 강조하고 있다. 결론적으로 CMMI는 '인증서'가 아니라 '조직 역량의 지속적 진화를 위한 체계적 가이드'로 활용되어야 한다.
...
1. [CMMI](/knowledge-base/studynote/12_it_management/04_sdlc_testing/133_cmmi_capability_maturity_model_integration_levels/) 성숙도 5단계 ([초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/)-관리-정의-정량-최적)은 레고 블록으로 성을 만들 때처럼, 규칙을 정하고 역할을 나누어 함께 작업하는 방법이에요.
