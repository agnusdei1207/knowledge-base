...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">리팩토링 악취(Code Smell)</div></div>
...
<div class="kb-diagram-note">리팩토링 악취(Code Smell) 제거 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
