...
충실도 단계별 접근은 <strong>비용 효율적 UX <a href="/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/">검증</a>의 핵심</strong>이며, Lo-Fi에서 구조를 확정한 후 Hi-Fi로 진행한다.
...
### 👶 어린이를 위한 3줄 비유 설명
1. Lo-Fi는 <strong>연필 스케치</strong>예요. 빠르게 그려서 <strong>대략적인 모양</strong>을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해요.
