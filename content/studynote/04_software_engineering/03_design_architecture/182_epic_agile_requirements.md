...
> 1. **본질**: 에픽 ([Epic](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/244_epic/))은 한 번의 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) ([Sprint](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/)) 안에 끝내기 어려운 큰 요구사항을 사용자 가치 단위로 묶어 놓은 상위 백로그 항목이다.
> 2. **가치**: [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)적 목표와 실제 구현 사이에 중간 크기의 관리 단위를 두어, 큰 기능을 한꺼번에 상세 설계하지 않고도 우선순위·범위·진척을 체계적으로 다룰 수 있게 한다.
> 3. **판단 포인트**: 한 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) 안에 명확한 완료 기준으로 끝낼 수 있다면 이미 유저 스토리 ([User Story](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/081_user_story_invest/))여야 하며, 에픽은 반드시 분해 기준과 사업 성과 기준을 함께 가져야 한다.
...
| 구성 요소 | 질문 | 작성 포인트 |
| :--- | :--- | :--- |
| 비즈니스 목표 | 왜 이 요구가 필요한가? | [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)·지표·사용자 가치 연결 |
| 에픽 | 어떤 큰 결과를 만들 것인가? | 여러 스토리로 분해 가능한 수준 |
| 분해 기준 | 어떻게 쪼갤 것인가? | 사용자 흐름, 업무 규칙, 예외, 역할 등 |
| 유저 스토리 | 이번 반복에서 무엇을 전달할 것인가? | 한 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) 내 완료 가능해야 함 |
| 완료 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) | 에픽이 언제 끝났는가? | 하위 스토리 완료 + 성과 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) |
...
| :--- | :--- | :--- | :--- | :--- |
| [테마](/knowledge-base/studynote/04_software_engineering/03_design_architecture/184_theme_agile_requirements/)/이니셔티브 | 왜 이 방향이 중요한가? | 분기~반기 | [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 목표 달성 | 고객 이탈률 감소 |
| 에픽 | 어떤 큰 요구를 실현할 것인가? | 여러 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) | 관련 스토리 완료 + 가치 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) | 간편결제 도입 |
...
- "응용 프로그램 인터페이스 ([Application Programming Interface](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)) 개발", "화면 수정"처럼 활동 중심 이름만 붙여 요구사항 가치를 잃는 것
- [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) 직전까지 분해하지 않아 개발팀이 너무 큰 항목을 그대로 끌고 들어가는 것
- 에픽 진행을 단순 퍼센트로만 보고, 실제 전달 가치나 수용 여부를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하지 않는 것

[기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/) 해소나 플랫폼 교체도 에픽으로 관리할 수는 있다. 다만 그 경우에도 "왜 필요한가"가 사용자 경험, 운영 안정성, 규제 대응 같은 가치와 연결되어야 한다. 그렇지 않으면 에픽이 아니라 내부 작업 묶음으로 전락한다.
...
| 유저 스토리 ([User Story](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/081_user_story_invest/)) | 에픽을 실제 [스프린트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/067_sprint_timebox/) 단위로 분해한 결과다 |
| 백로그 정제 (Backlog Refinement) | 에픽을 스토리로 구체화하는 주요 활동이다 |
| 릴리스 계획 (Release Planning) | 에픽 단위 우선순위와 범위 조정이 이뤄진다 |
| 수용 기준 ([Acceptance Criteria](/knowledge-base/studynote/04_software_engineering/03_design_architecture/165_acceptance_criteria_definition/)) | 스토리 수준뿐 아니라 에픽 수준 완료 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)와 연결된다 |
| [기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/)/인에이블러 | 사용자 가치와 연결되면 에픽 형태로 관리될 수 있다 |
| [테마](/knowledge-base/studynote/04_software_engineering/03_design_architecture/184_theme_agile_requirements/)/이니셔티브 | 에픽보다 상위의 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)적 요구 단위다 |
