...
체계적 요구 프로세스는 **"올바른 시스템을 올바르게 만드는" 첫걸음**이며, RTM이 전 생명주기 추적의 핵심이다.
...
| **도출** | 인터뷰·JAD·프로토타이핑 |
| **SRS** | IEEE 830 명세서 |
| **[RTM](/knowledge-base/studynote/04_software_engineering/uncategorized/667_requirements_traceability_matrix/)** | 요구→테스트 추적 |
| **[CCB](/knowledge-base/studynote/04_software_engineering/03_design_architecture/160_change_control_board_ccb_requirements_review/)** | [변경 통제 위원회](/knowledge-base/studynote/12_it_management/02_itsm_itil/080_cab/) |
...
3. 약을 먹고 **경과를 지켜보며([검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))** 진료 기록(관리)을 남겨요!
