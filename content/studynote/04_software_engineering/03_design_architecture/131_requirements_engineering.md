...
← **이전**: [[130_acceptance_criteria_vs_dod|130. 인수 기준 vs 완료 정의 (Acceptance Criteria vs Definition of Done)]]
**다음**: [[132_types_of_requirements|132. 요구사항 유형 (기능·비기능·제약사항) - FR·NFR·Constraints 분류]] →
