...
관찰 기법은 <strong>암묵적 요구 발견의 가장 강력한 도구</strong>이며, Contextual Inquiry가 관찰+인터뷰의 최적 결합이다.
...
| **암묵적 요구** | 관찰의 핵심 목표 |
| **Journey Map** | 관찰 결과 [시각화](/studynote/16_bigdata/01_intro/003_bigdata_7v/) |
...
<- **이전**: [139. 프로토타입 충실도 (Fidelity Levels) - Lo-Fi·Mid-Fi·Hi-Fi](/studynote/04_software_engineering/03_design_architecture/139_prototyping_fidelity_levels/)
**다음**: [141. 포커스 그룹 인터뷰 (FGI) - 그룹 심층 인터뷰 기법](/studynote/04_software_engineering/03_design_architecture/141_focus_group_interview_fgi/) ->
