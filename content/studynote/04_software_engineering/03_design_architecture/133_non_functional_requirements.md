...
| NFR | 수치화 예 | 아키텍처 영향 |
|:---|:---|:---|
| <strong><a href="/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/">성능</a></strong> | P99 < 200ms | 캐시, [CDN](/knowledge-base/studynote/03_network/09_application_layer_web_email/506_cdn_content_delivery_network_edge_caching/) |
| <strong><a href="/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/">가용성</a></strong> | 99.99% | Active-Active |
| **확장성** | 10x 트래픽 | 오토스케일링 |
...
NFR은 <strong>아키텍처의 핵심 동인(<a href="/knowledge-base/studynote/12_it_management/05_security_compliance/319_architecture/">Architecture</a> Driver)</strong>이며, 수치로 명세하지 않으면 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)이 불가능하다.
...
| **ISO 25010** | 8대 품질 특성 |
| <strong><a href="/knowledge-base/studynote/04_software_engineering/04_testing_quality/229_atam_architecture_trade_off_analysis_method/">ATAM</a></strong> | NFR 트레이드오프 분석 |
| **QAW** | 품질 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) 워크숍 |
| <strong><a href="/knowledge-base/studynote/12_it_management/05_security_compliance/319_architecture/">Architecture</a> Driver</strong> | NFR이 아키텍처를 결정 |
