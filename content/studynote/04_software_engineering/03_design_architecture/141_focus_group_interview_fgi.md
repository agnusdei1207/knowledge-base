...
> 3. **판단 포인트**: 모더레이터의 중립성·[[216_progress_in_synchronization|진행]] 스킬이 성패를 좌우하며, 2~3회 반복 실시하여 포화(Saturation)에 도달해야 한다.
...
- **📢 섹션 요약 비유**: FGI는 **토크쇼**이다. MC(모더레이터)가 [[216_progress_in_synchronization|진행]]하고, 패널(참가자)이 서로 의견을 나누며 깊은 이야기가 나온다.
...
|:---|:---|
| **FGI** | 그룹 심층 인터뷰 |
| **모더레이터** | [[216_progress_in_synchronization|진행]] 촉진자 |
| **포화** | 새 인사이트 없으면 종료 |
| **인터뷰** | 1:1 (개별 대안) |
| **코딩 분석** | 질적 [[001_dikw_pyramid|데이터]] 분석 |
