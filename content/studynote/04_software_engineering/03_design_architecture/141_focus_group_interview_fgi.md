...
|:---|:---|
| **FGI** | 그룹 심층 인터뷰 |
| **모더레이터** | [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/) 촉진자 |
| **포화** | 새 인사이트 없으면 종료 |
| **인터뷰** | 1:1 (개별 대안) |
| **코딩 분석** | 질적 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석 |
