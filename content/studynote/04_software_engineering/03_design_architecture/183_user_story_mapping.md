...
| 릴리스 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/) | 이번에 전달할 범위 | 가로로 잘라 [end-to-end](/knowledge-base/studynote/03_network/08_transport_layer/401_transport_layer_role_end_to_end_multiplexing/) 가치 보장 |
| 메모/제약 | [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/), 예외, [리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/) | 스토리와 분리해 보조 정보로 유지 |
...
유저 스토리 맵은 플랫 백로그, 유저 저니 맵, [에픽](/knowledge-base/studynote/04_software_engineering/03_design_architecture/182_epic_agile_requirements/) 구조와 비슷해 보이지만 역할이 다르다. 핵심은 **"스토리 맵은 사용자 흐름과 제품 범위를 동시에 다룬다"** 는 점이다.
...
2. **범위를 얇게 잘라 릴리스해야 하는가?** [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) 도출이 필요하면 효과가 크다.
3. **스토리를 팀 내부 작업으로 적고 있지 않은가?** "[API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 개발"보다 "사용자가 결제 수단을 등록한다"처럼 사용자 행동으로 써야 한다.
4. **맵이 살아 있는가?** 워크숍 결과물을 백로그와 연결하지 않으면 벽 장식으로 끝난다.

### 대표적 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 프론트엔드/백엔드/[데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) ([Database](/knowledge-base/studynote/05_database/04_transactions_concurrency/501_database/)) 같은 기술 [컴포넌트](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/603_component_independent_deployment_unit/) 축으로 가로축을 만드는 것
...
| [Epic](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/244_epic/) | backbone 활동 아래로 분해되는 큰 요구 묶음과 연결된다 |
| [Theme](/knowledge-base/studynote/04_software_engineering/03_design_architecture/184_theme_agile_requirements/) | 스토리 맵이 실현하려는 상위 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 방향을 제공한다 |
| [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) ([Minimum Viable Product](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/)) | 스토리 맵의 첫 번째 릴리스 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)로 구체화된다 |
| Backlog Refinement | 스토리 맵을 실제 백로그 항목으로 구체화하는 활동이다 |
| Vertical [Slice](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/) | 사용자 가치를 유지하며 얇게 범위를 자르는 핵심 원칙이다 |
| Release Planning | [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)별 릴리스 순서를 정하는 과정과 직접 연결된다 |
...
← **이전**: [182. 에픽 (Epic) - 거시적 스토리 집합](/knowledge-base/studynote/04_software_engineering/03_design_architecture/182_epic_agile_requirements/)
**다음**: [184. 테마 (Theme) - 에픽들의 상위 카테고리](/knowledge-base/studynote/04_software_engineering/03_design_architecture/184_theme_agile_requirements/) →
