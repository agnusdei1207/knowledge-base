...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">마이크로서비스 아키텍처 (MSA, M</div></div>
...
<div class="kb-diagram-note">마이크로서비스 아키텍처 (MSA, Microservices Architecture) 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
