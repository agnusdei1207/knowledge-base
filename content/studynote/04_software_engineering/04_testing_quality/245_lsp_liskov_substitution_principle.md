...
← **이전**: [[244_ocp_open_closed_principle|244. OCP (Open-Closed Principle) - 개방-폐쇄 원칙 (확장엔 열려있고 변경엔 닫혀있음)]]
**다음**: [[246_isp_interface_segregation_principle|246. ISP (Interface Segregation Principle) - 인터페이스 분리 원칙]] →
