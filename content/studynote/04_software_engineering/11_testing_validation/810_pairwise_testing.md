...
<- **이전**: [417. 유스케이스 테스팅 (Use Case Testing)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/809_use_case_testing/)
**다음**: [418. 페어와이즈 테스팅 (Pairwise Testing) - 변수 값들의 모든 쌍(Pair) 조합이 최소 한 번 테스트되도록 최적화](/knowledge-base/studynote/04_software_engineering/11_testing_validation/810_pairwise_testing/) ->
