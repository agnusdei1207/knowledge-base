...
조건 커버리지(Condition Coverage)는 하나의 통나무 상자처럼 보였던 복합 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 분기문(`if문`)을 쪼개서 개별 세포들 단위의 건전성(Health)을 확보해 준 위대한 화이트박스 해단() 도구입니다.
