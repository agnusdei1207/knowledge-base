---
title: 544. 외부화된 구성 관리 (Externalized Configuration) - Config Server (Spring Cloud
  Config 등)
date: '2026-05-08'
tags:
...
**다음**: [[544_externalized_configuration|544. 외부화된 구성 관리 (Externalized Configuration) - Config Server]] →
