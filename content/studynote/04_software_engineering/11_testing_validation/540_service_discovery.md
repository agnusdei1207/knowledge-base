...
← **이전**: [[539_event_bus_stream_processing|539. 이벤트 버스 (Event Bus) 및 스트림 프로세싱]]
**다음**: [[540_service_discovery|540. 서비스 디스커버리 (Service Discovery) - 동적 IP/Port 레지스트리 (Eureka, Consul)]] →
