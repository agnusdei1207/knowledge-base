...
← **이전**: [[564_helm_chart_package_manager|564. 헬름 (Helm) 차트를 이용한 SW 패키지 관리]]
**다음**: [[565_operator_pattern_kubernetes_automation|565. 오퍼레이터 (Operator) 패턴 - 쿠버네티스 사용자 정의 컨트롤러 확장을 통한 복잡한 앱 관리 자동화]] →
