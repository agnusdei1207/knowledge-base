...
<- **이전**: [450. 벤치마크 테스트 (BMT, Benchmark Test) - 동일한 환경에서 여러 제품의 성능을 비교](/knowledge-base/studynote/04_software_engineering/11_testing_validation/842_benchmark_test/)
**다음**: [451. 사용성 테스트 (Usability Test) - 사용자가 시스템을 얼마나 쉽게 다룰 수 있는지 UI/UX 관점 평가](/knowledge-base/studynote/04_software_engineering/11_testing_validation/843_usability_test/) ->
