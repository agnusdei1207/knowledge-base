...
3. <strong>Step 3 (<a href="/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/631_decision_table_logical_combination/">결정 테이블</a> 치환★)</strong>: 이 복잡한 그림 회로의 모든 $0, 1$ (False, True) 경로를 거슬러 올라가며, 전 타임에 배웠던 그 유명한 <strong>"<a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/415_decision_table/">의사 결정 테이블</a>(<a href="/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/631_decision_table_logical_combination/">Decision Table</a>)"</strong> 엑셀 표로 강제 평면화시킵니다.
4. <strong>Step 4 (<a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/441_test_case/">테스트 케이스</a> <a href="/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/">생성</a>)</strong>: 테이블의 각 세로열(Rule)을 바탕으로 QA가 실행할 수 있는 `Test Case 시나리오 1번~15번`이 깔끔하게 완성됩니다.
