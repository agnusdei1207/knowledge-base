...
← **이전**: [[525_compliance_as_code_automation|525. 컴플라이언스 애즈 코드 (Compliance as Code) 자동화]]
**다음**: [[526_security_logging_and_monitoring_failures|526. 보안 로깅 (Logging) - 6하 원칙 기록, 중앙 집중식 보관(ELK), 위변조 방지 (WORM 스토리지)]] →
