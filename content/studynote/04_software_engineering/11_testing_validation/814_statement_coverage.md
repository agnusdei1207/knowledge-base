...
**다음**: [422. 구문 커버리지 (Statement Coverage) - 코드의 모든 문장을 최소 한 번 실행](/knowledge-base/studynote/04_software_engineering/11_testing_validation/814_statement_coverage/) ->
