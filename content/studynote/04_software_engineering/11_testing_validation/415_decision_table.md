...
수직으로 내려오는 하나의 열(Column), 즉 `조건+동작`의 조합을 <strong>규칙(Rule)</strong>이라 부르며, 이 Rule 하나가 곧잡아도 절대 틀리지 않는 <strong>"강력한 <a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/441_test_case/">테스트 케이스</a> 1개"</strong>로 치환됩니다.
