...
거대한 유스케이스 대본 안에는 무수한 [가지치기](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/435_pruning_hardware/)(Branch)가 들어있으며, QA는 이것들을 <strong>독립된 <a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/833_test_case/">테스트 케이스</a> 시나리오</strong>로 포장하여 뽑아냅니다.
...
**다음**: [418. 페어와이즈 테스팅 (Pairwise Testing)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/810_pairwise_testing/) ->
