...
<- **이전**: [433. 탐색적 테스팅 (Exploratory Testing) - 명세서 없이 테스터의 직관과 경험을 바탕으로 테스트 설계와 수행을 동시](/knowledge-base/studynote/04_software_engineering/11_testing_validation/825_exploratory_testing/)
**다음**: [434. 오류 추정 (Error Guessing) - 테스터의 경험을 바탕으로 결함이 발생할 만한 곳을 추정하여 테스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/826_error_guessing/) ->
