...
← **이전**: [[322_oop_4_characteristics|322. 객체지향 프로그래밍 (OOP)의 4대 특징 - 캡슐화, 상속, 다형성, 추상화]]
**다음**: [[324_functional_programming_core|324. 함수형 프로그래밍 (Functional Programming) - 일급 객체, 순수 함수, 불변성]] →
