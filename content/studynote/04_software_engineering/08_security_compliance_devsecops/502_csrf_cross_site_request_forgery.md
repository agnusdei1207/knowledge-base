...
<- **이전**: [501. XSS 유형 - Reflected XSS, Stored XSS, DOM-based XSS](/knowledge-base/studynote/04_software_engineering/11_testing_validation/893_xss_types/)
**다음**: [502. 크로스 사이트 요청 위조 (CSRF) 방어](/knowledge-base/studynote/04_software_engineering/11_testing_validation/894_csrf_defense/) ->
