...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software 엔진ering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | 사이버 레질리언스 (Cyber Resilience) 아키텍처의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
...
<- **이전**: [519. 사이버 레질리언스 (Cyber Resilience) 아키텍처](/knowledge-base/studynote/04_software_engineering/11_testing_validation/911_cyber_resilience/)
