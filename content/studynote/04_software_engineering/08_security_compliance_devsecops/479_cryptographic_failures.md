...
<- **이전**: [479. Cryptographic Failures (암호화 실패)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/871_cryptographic_failures/)
**다음**: [480. Injection (인젝션)](/knowledge-base/studynote/04_software_engineering/11_testing_validation/872_injection/) ->
