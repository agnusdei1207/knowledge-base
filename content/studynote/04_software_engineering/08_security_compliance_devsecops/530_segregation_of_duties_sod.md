...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">보안 조직 분리 정책 위반(SoD,</div></div>
...
<div class="kb-diagram-note">보안 조직 분리 정책 위반(SoD, Segregation of Duties)의 SW 통제 로직 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
