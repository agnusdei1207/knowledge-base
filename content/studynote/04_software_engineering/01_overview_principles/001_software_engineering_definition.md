...
> 2. **가치**: 예측 불가능한 소프트웨어 개발 과정의 비용과 일정을 통제하고, [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)/효율성/[유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/) 등의 핵심 품질 목표를 달성.
> 3. **융합**: 프로젝트 관리(PM), 품질 보증(QA), 시스템 아키텍처, 그리고 최근의 [DevOps](/knowledge-base/studynote/04_software_engineering/uncategorized/652_devops_calms_culture/) 및 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 기반 자동화와 결합하여 진화 중.
...
소프트웨어 공학의 3대 핵심 목표는 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) ([Reliability](/knowledge-base/studynote/04_software_engineering/06_software_architecture/345_reliability_security/)), 효율성 (Efficiency), [유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/) ([Maintainability](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/))으로 요약된다. 이 세 가지 축은 아키텍처 설계부터 테스트까지 전 과정에서 상호 작용하며 전체 품질을 결정한다.
...
```
**[도식 설명]**
이 그림은 소프트웨어 공학의 주요 목표들이 서로 트레이드오프(Trade-off) 관계에 놓일 수 있음을 시각화한 것이다. 예를 들어, 효율성을 극대화하기 위해 극단적으로 최적화된 저수준 코드를 작성하면 [유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)이 급격히 저하되는 병목이 발생할 수 있다. 반대로, [유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)을 위해 과도한 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/) 계층을 도입하면 실행 효율성([성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/))이 떨어지는 트레이드오프가 존재한다. 실무에서는 이 삼각형 내부의 적절한 균형점을 찾는 것이 아키텍트의 핵심 역할이다.

이러한 목표를 달성하기 위해 실무에서는 "[모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)화"를 가장 근본적인 원리로 사용한다. 내부 동작 원리는 다음과 같다. ① 거대한 문제를 독립적인 하위 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)로 분할(Decomposition)한다. ② 각 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)의 내부 [응집도](/knowledge-base/studynote/04_software_engineering/04_testing_quality/193_cohesion_levels/)는 높이고, [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/) 간의 [결합도](/knowledge-base/studynote/04_software_engineering/04_testing_quality/195_coupling_levels/)는 최소화(Low [Coupling](/knowledge-base/studynote/04_software_engineering/04_testing_quality/195_coupling_levels/), High [Cohesion](/knowledge-base/studynote/04_software_engineering/04_testing_quality/193_cohesion_levels/))하여 부작용(Side Effect)을 차단한다. ③ 각 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/) 단위로 독립적인 [단위 테스트](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/397_unit_test/)([Unit Test](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/397_unit_test/))를 수행하여 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)을 확보한다.

📢 **섹션 요약 비유**: 이는 마치 튼튼하고([신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)), 연비가 좋으며(효율성), 언제든 부품을 쉽게 갈아 끼울 수 있는([유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)) 이상적인 자동차 엔진 블록을 설계하는 메커니즘과 같습니다.
...
- **실무 시나리오**: 핵심 결제 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)의 업데이트
  - 상황: 기존 모놀리식 결제 시스템의 코드 복잡도가 높아 새로운 결제 수단 추가 시 다른 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)에 장애 발생 위험이 존재함.
  - 의사결정: 단기적으로는 효율성이 다소 저하되더라도, 결제 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)을 [마이크로서비스](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/532_microservices_decomposition_patterns/)로 분리(Decoupling)하고 인터페이스([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/))를 명확히 정의하여 향후 [유지보수성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/346_maintainability_portability/)과 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)을 우선 확보하도록 결정함.
