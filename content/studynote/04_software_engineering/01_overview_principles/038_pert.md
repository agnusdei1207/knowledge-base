...
## I. [PERT](/knowledge-base/studynote/12_it_management/04_sdlc_testing/151_pert_three_point_estimation/) 3점 추정
...
| [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 개발   | 3일   | 7일   | 21일  | 8.0일      | 3.0일   |
| UI 구현    | 4일   | 6일   | 8일   | 6.0일      | 0.67일  |

> 📢 **섹션 요약 비유**: DB 설계와 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 개발의 기대치는 같은 8일이지만, API의 표준편차(3일)가 DB(1일)의 3배 — 더 불확실하고 리스크가 높다.

---

## II. [PERT](/knowledge-base/studynote/12_it_management/04_sdlc_testing/151_pert_three_point_estimation/) vs [CPM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/150_cpm_critical_path_method/) 비교
...
## III. 임계 경로 완료 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 계산
...
> 📢 **섹션 요약 비유**: PERT로 "25일에 완료 예상, 28일이면 93% [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)"처럼 기간과 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)을 함께 고객에게 제시할 수 있다.
...
2. 수학 공식으로 "30일 안에 완료할 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)이 95%"처럼 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)도 알 수 있어요.
