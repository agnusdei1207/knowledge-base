...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">모델 기반 테스팅 (MBT, Mode</div></div>
...
<div class="kb-diagram-note">모델 기반 테스팅 (MBT, Model-Based Testing) 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
