...
> 1. **본질**: 테스트 절차 (Test Procedure) / 테스트 스크립트 (Test Script)은(는) [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 핵심 개념으로, 복잡한 시스템을 체계적으로 설계·관리하기 위한 원칙과 기법이다.
...
- **개념**: 테스트 절차(Test Procedure)는 특정 테스트 케이스를 실행하기 위해 필요한 단계별 지침을 상세히 기술한 문서이다. 각 단계는 명확한 작업(입력, 클릭, [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 등)과 예상되는 중간 결과를 포함한다. 테스트 스크립트(Test Script)는 이러한 절차를 프로그래밍 가능한 형태로 작성한 것으로, 도구를리용하여 자동으로 실행될 수 있다.

- **필요성**:측시용례가추상적 실행 지침만 제공하는 경우, 실제 실행할 때 실행자마다 접근 방식이 다를 수 있다. 테스트 절차는 이러한 variability를 방지하여 동일한 결과를 재현할 수 있게 한다. 특히 규제적업계(항공, 의료, 금융)에서는 [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 가능한 테스트 절차 문서가 필수적이다.
...
- **📢 섹션 요약 비유**: 테스트 절차 (Test Procedure) / 테스트 스크립트 (Test Script)의 기대효과는 마라톤 훈련과 같다. 처음에는 느리고 고통스럽지만, 올바른 훈련 원칙을 지킨 선수만이 결승선에서 최고의 기록을 낼 수 있다. [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)의 원칙도 단기 편의보다 장기 완성도를 위한 투자다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [소프트웨어 공학](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/) ([Software 엔진ering](/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/)) | 테스트 절차 (Test Procedure) / 테스트 스크립트 (Test Script)의 상위 학문 체계이며 품질·생산성 향상의 공통 목표를 공유한다 |
| [소프트웨어 생명주기](/knowledge-base/studynote/04_software_engineering/01_overview_principles/003_sdlc/) ([SDLC](/knowledge-base/studynote/12_it_management/04_sdlc_testing/131_sdlc_system_development_life_cycle_waterfall_agile/), Software Development Life Cycle) | 테스트 절차 (Test Procedure) / 테스트 스크립트 (Test Script)은 SDLC의 특정 단계에서 핵심적으로 적용된다 |
