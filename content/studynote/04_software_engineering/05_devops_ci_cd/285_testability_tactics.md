...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">시험 용이성 (Testability)</div></div>
...
<div class="kb-diagram-note">시험 용이성 (Testability) 개념 정립</div>
<div class="kb-diagram-connector">▼</div>
