...
> 2. [[185_k_anonymity_masking_data_pipeline|k-익명성]]([[185_k_anonymity_masking_data_pipeline|k-Anonymity]])은 어떤 레코드도 최소 k-1개의 다른 레코드와 구별할 수 없도록 일반화(Generalization)·[[656_ir_containment|억제]](Suppression)하는 모델로, k값이 클수록 강한 [[571_protection_vs_security|보호]]지만 [[001_dikw_pyramid|데이터]] 왜곡이 커지며 ℓ-다양성([[815_l_diversity|l-Diversity]])·[[816_t_closeness|t-근접성]]([[816_t_closeness|t-Closeness]])으로 확장 발전했다.
> 3. [[209_differential_privacy|차등 프라이버시]]([[817_differential_privacy|Differential Privacy]])는 [[185_k_anonymity_masking_data_pipeline|k-익명성]]의 재식별 취약점을 수학적으로 해결한 현대적 기법으로, Apple·Google·미국 인구조사국이 적용했으며 "어떤 개인의 포함/제외가 [[298_qkv_attention|쿼리]] 결과에 구분할 수 없는 차이만 만든다"는 수학적 보장을 제공한다.
...
## II. [[185_k_anonymity_masking_data_pipeline|k-익명성]]
...
> 📢 **섹션 요약 비유**: [[185_k_anonymity_masking_data_pipeline|k-익명성]]은 쌍둥이 이상인 그룹만 허용 — 적어도 k명이 같은 "외형(준식별자)"을 가져야 특정인 지목 불가.

---

## III. ℓ-다양성과 [[816_t_closeness|t-근접성]]
...
> 📢 **섹션 요약 비유**: k는 사람 수 보장, ℓ은 비밀 종류 다양성 보장, t는 비밀 분포 균형 보장 — 점점 강화되는 프라이버시 [[571_protection_vs_security|보호]].

---

## [[288_version_ihl_tos_total_length|IV]]. [[209_differential_privacy|차등 프라이버시]]
...
> 📢 **섹션 요약 비유**: [[209_differential_privacy|차등 프라이버시]]는 의도적 소음으로 진실을 흐리기 — 전체 평균은 정확하게 유지하면서 개인 정보는 노이즈로 숨기기.

---

## V. 실무 시나리오 — 의료 [[001_dikw_pyramid|데이터]] 공개
...
> 📢 **섹션 요약 비유**: 의료 [[001_dikw_pyramid|데이터]] 공개는 환자 정보를 마모시킨 신분증처럼 — 이름·주소는 지워도 의학적 패턴은 연구에 활용 가능하게.
