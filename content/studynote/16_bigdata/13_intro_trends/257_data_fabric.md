...
> 2. [[212_data_fabric_virtualization|데이터 패브릭]]의 핵심은 "지능형 [[012_metadata|메타데이터]] 레이어" — 능동 [[012_metadata|메타데이터]]([[483_active_vs_passive_ftp|Active]] [[012_metadata|Metadata]])가 [[001_dikw_pyramid|데이터]] 계보(Lineage), 품질, 접근 패턴을 자동 학습하여 [[001_dikw_pyramid|데이터]] 발견·통합·관리를 자동화하는 것이 기존 [[394_catalog_metadata|카탈로그]]와의 핵심 차별점이다.
> 3. Gartner는 2022년 [[212_data_fabric_virtualization|데이터 패브릭]]을 탑 [[001_dikw_pyramid|데이터]] 관리 트렌드로 선정 — 기업 [[001_dikw_pyramid|데이터]] 조직의 75%가 2026년까지 [[212_data_fabric_virtualization|데이터 패브릭]] 도입을 검토할 것으로 예측하며, IBM, Microsoft, Informatica 등이 주요 벤더다.

---

## Ⅰ. [[212_data_fabric_virtualization|데이터 패브릭]] 개념
...
> 📢 **섹션 요약 비유**: [[212_data_fabric_virtualization|데이터 패브릭]]은 스마트 번역기 — 각나라 말([[001_dikw_pyramid|데이터]] 소스)을 자동으로 이해하고 연결. [[012_metadata|메타데이터]](언어 사전)가 AI로 학습해 자동 통역!

---

## Ⅱ. 능동 [[012_metadata|메타데이터]]
...
> 📢 **섹션 요약 비유**: 능동 [[012_metadata|메타데이터]]는 [[190_ai_llm_requirements_specification|AI]] 사서 — 도서관 책([[001_dikw_pyramid|데이터]])에 대한 기록([[012_metadata|메타데이터]])을 AI가 자동 업데이트. "이 책 보면 저 책도 봐요" 자동 추천!

---

## Ⅲ. [[212_data_fabric_virtualization|데이터 패브릭]] 기술 구성
...
> 📢 **섹션 요약 비유**: [[212_data_fabric_virtualization|데이터 패브릭]] 아키텍처는 스마트 물류 센터 — 여러 공급처(소스)에서 물건([[001_dikw_pyramid|데이터]]) 받아 자동 [[104_classification_analysis|분류]]([[012_metadata|메타데이터]]), [[190_ai_llm_requirements_specification|AI]] 추천 경로(통합), 보안 관리(거버넌스)!

---

## Ⅳ. [[360_data_virtualization|데이터 가상화]]
...
> 📢 **섹션 요약 비유**: [[360_data_virtualization|데이터 가상화]]는 통합 은행 앱 — 여러 은행(소스) 계좌를 앱([[015_virtualization|가상화]])으로 한 번에 조회. 실제 돈([[001_dikw_pyramid|데이터]])은 각 은행에, 잔액 표시만 통합!

---

## Ⅴ. 실무 시나리오 — 금융그룹 [[212_data_fabric_virtualization|데이터 패브릭]]
...
> 📢 **섹션 요약 비유**: 금융 [[212_data_fabric_virtualization|데이터 패브릭]]은 가족 통합 다이어리 — 은행·증권·보험(3형제)이 각자 쓰던 일기(DB)를 [[190_ai_llm_requirements_specification|AI]] 비서(패브릭)가 자동 통합해서 가족 전체 상황(고객 360도) 한눈에!
