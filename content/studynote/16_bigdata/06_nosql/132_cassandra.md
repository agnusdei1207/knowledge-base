...
### 결론
Cassandra는 쓰기 집중, 고가용성, 멀티 리전이 필요한 대규모 서비스의 표준 선택지가 되었다. 기술사 시험에서는 <strong>마스터리스 링 구조의 동작 원리</strong>, <strong>RF·W·R 조합과 일관성 보장 수식</strong>, <strong>Compaction 전략별 적합 워크로드</strong>, <strong>CQL Primary Key 설계</strong>가 핵심 논점이다.
