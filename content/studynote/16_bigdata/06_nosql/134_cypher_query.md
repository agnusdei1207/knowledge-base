...
### 결론
Cypher는 그래프 패턴 매칭에 특화된 선언적 쿼리 언어로, 복잡한 관계 탐색을 직관적이고 간결하게 표현한다. 기술사 시험에서는 **패턴 매칭 문법 구조**, **MATCH/MERGE/WITH 절의 역할**, **가변 길이 탐색 문법**, <strong>추천·사기탐지 적용 쿼리 예시</strong>가 핵심 논점이다.
