...
> 3. **판단 포인트**: Oozie의 약점은 XML 기반 복잡한 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)과 현대 클라우드 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인과의 통합 어려움이다. 현대 [데이터 파이프라인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/645_data_pipeline_acceleration/)에서는 Apache Airflow가 Python 기반 DAG로 더 직관적이고 [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/923_cloud_native_architecture/) 통합이 뛰어난 대안이다.
