...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) ViewFS ([View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/) [File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) System)는 [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) 연합([Federation](/knowledge-base/studynote/09_security/11_iam_access_control/543_federation/)) 환경에서 여러 독립 [NameNode](/knowledge-base/studynote/14_data_engineering/01_infrastructure/014_namenode/) 클러스터를 단일 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) [네임스페이스](/knowledge-base/studynote/02_operating_system/01_overview_architecture/061_namespace/) `/user`, `/data`, `/tmp` 등으로 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/)하여 통합 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 뷰를 제공하는 클라이언트 측 가상 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/) 레이어다.
> 2. **가치**: [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) Federation은 단일 NameNode의 메모리 한계(수억 개 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) = ~GB 메모리)를 해결하기 위해 [네임스페이스](/knowledge-base/studynote/02_operating_system/01_overview_architecture/061_namespace/)를 [수평 분할](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/268_horizontal_fragmentation/)한다. ViewFS는 이 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)된 [네임스페이스](/knowledge-base/studynote/02_operating_system/01_overview_architecture/061_namespace/)를 사용자·애플리케이션 입장에서 단일 경로처럼 접근 가능하게 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/)하여 기존 [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) 코드 변경 없이 사용할 수 있다.
> 3. **판단 포인트**: ViewFS는 클라이언트 측 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/)이므로 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/) 포인트 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)이 각 클라이언트에 일치해야 하고, 크로스 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/) 포인트 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 이동(rename)이 불가능하다는 한계가 있다. 이 한계를 극복하기 위해 [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) [Federation](/knowledge-base/studynote/09_security/11_iam_access_control/543_federation/) + ViewFS + RBF(Router Based [Federation](/knowledge-base/studynote/09_security/11_iam_access_control/543_federation/))로 발전했다.
...
### ViewFS [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) (core-site.xml)
...
### ViewFS vs. RBF (Router-Based [Federation](/knowledge-base/studynote/09_security/11_iam_access_control/543_federation/))

| 비교 | ViewFS | RBF |
|:---|:---|:---|
| [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/) 위치 | 클라이언트 측 | 서버 측 (Router) |
| [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) 위치 | 각 클라이언트 | 중앙 Router 서버 |
...
| 비교 | 단일 [NameNode](/knowledge-base/studynote/14_data_engineering/01_infrastructure/014_namenode/) | [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/) [Federation](/knowledge-base/studynote/09_security/11_iam_access_control/543_federation/) | ViewFS |
|:---|:---|:---|:---|
| 확장성 | [NameNode](/knowledge-base/studynote/14_data_engineering/01_infrastructure/014_namenode/) 메모리 한계 | [네임스페이스](/knowledge-base/studynote/02_operating_system/01_overview_architecture/061_namespace/) [수평 분할](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/268_horizontal_fragmentation/) | 통합 뷰 제공 |
| [단일 장애점](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/454_spof/) | [NameNode](/knowledge-base/studynote/14_data_engineering/01_infrastructure/014_namenode/) HA 필요 | 독립 NN per 풀 | 클라이언트 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/) |
| 관리 복잡도 | 낮음 | 높음 | [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 관리 |
...
1. ViewFS는 여러 도서관을 하나의 검색창에서 찾을 수 있는 통합 앱이에요! 각 도서관([NameNode](/knowledge-base/studynote/14_data_engineering/01_infrastructure/014_namenode/))은 따로 있지만, 앱에서는 한 번에 검색할 수 있어요.
