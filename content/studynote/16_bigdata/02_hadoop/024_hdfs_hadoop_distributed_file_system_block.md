...
← **이전**: [[023_apache_hadoop_distributed_storage_processing|01. 아파치 하둡 (Apache Hadoop) - 분산 스토리지 및 처리]]
**다음**: [[025_namenode_metadata_spof_ha|03. 네임노드 (NameNode) - 메타데이터 관리와 고가용성]] →
