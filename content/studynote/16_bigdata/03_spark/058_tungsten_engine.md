...
| 최적화 기법 | 주요 내용 | 기대 효과 |
| :--- | :--- | :--- |
| **Off-[heap](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/078_heap_datastructure/) Memory** | JVM 힙 외부에서 메모리 직접 관리 | GC 부하 제거 및 대용량 메모리 효율성 |
...
- **메모리 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)**: `spark.memory.offHeap.enabled=true` [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)을 통해 Tungsten의 Off-[heap](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/078_heap_datastructure/) 기능을 활성화하여 GC 이슈가 잦은 대규모 워크로드를 안정화할 수 있다.
- **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 구조 선택**: RDD보다는 Tungsten의 혜택을 100% 받을 수 있는 DataFrame/Dataset [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 사용을 강력히 권고한다. RDD는 Java 객체 오버헤드를 그대로 가지기 때문이다.
