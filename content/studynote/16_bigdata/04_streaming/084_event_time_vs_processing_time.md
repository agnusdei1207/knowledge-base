...
| 시간 개념 | 정의 | 특징 |
|:---|:---|:---|
| Event Time | 이벤트 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 내 타임스탬프 | 정확한 비즈니스 시간, [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 이벤트 처리 필요 |
...
| 항목 | 이벤트 시간 | 처리 시간 |
|:---|:---|:---|
| [정확성](/knowledge-base/studynote/16_bigdata/01_intro/002_bigdata_5v/) | 높음 (실제 발생 시간 기준) | 낮음 (도착 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 영향) |
...
### 1. [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 이벤트(Late [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)) 처리 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)

이벤트 시간 처리에서 [Watermark](/knowledge-base/studynote/16_bigdata/04_streaming/085_watermark/) 이후에 도착한 이벤트는 "[지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 이벤트(Late Event)"다. 처리 옵션:
...
**📢 섹션 요약 비유**
> [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 이벤트 처리는 "늦게 도착한 참가자를 어디까지 허용하는 경기"와 같다. 5분까지 늦게 온 사람은 참가 허용(allowedLateness), 그 이상 늦은 사람은 대기실(side output)에서 따로 처리한다.
...
| 운영 대시보드 ([현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/)) | 처리 시간 — 지금 이 순간의 상태 |
| [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 센서 [이상 탐지](/knowledge-base/studynote/09_security/05_web_app_security/236_anomaly_based_detection_zero_day_false_positive/) | 이벤트 시간 — 센서 발생 시간 기준 |
| [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 집계 리포트 | 이벤트 시간 — [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 발생 시각 기준 통계 |

### 2. [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/)

- [ ] 이벤트 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 타임스탬프 필드 포함 여부 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)
- [ ] 타임존 처리: UTC 기준 저장 권장
...
| 재처리 안전성 | 동일한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 재처리 시 동일한 결과 |
| [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 허용 유연성 | Watermark로 정확도-[지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 균형 조절 |
...
|:---|:---|:---|
| [Watermark](/knowledge-base/studynote/16_bigdata/04_streaming/085_watermark/) | 이벤트 시간의 핵심 도구 | [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 허용 임계값 정의 |
| [Window Operations](/knowledge-base/studynote/16_bigdata/04_streaming/086_window_operations/) | 적용 대상 | 이벤트 시간 기반 윈도우 집계 |
| Side Output | [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 이벤트 처리 | 늦게 도착한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 대안 처리 경로 |
| Exactly-Once | 재처리 보장 | 이벤트 시간 사용 시 결정론적 결과 |
| Flink [Savepoint](/knowledge-base/studynote/05_database/04_transactions_concurrency/200_savepoint_partial_rollback/) | 연동 개념 | 이벤트 시간 기반 재처리를 위한 상태 보존 |
