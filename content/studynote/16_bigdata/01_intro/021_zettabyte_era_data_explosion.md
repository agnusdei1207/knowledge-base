...
[제타바이트 시대](/knowledge-base/studynote/16_bigdata/01_intro/004_bigdata_necessity/)의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 폭발은 단일 요인이 아닌 **'3대 [트리거](/knowledge-base/studynote/05_database/04_transactions_concurrency/507_acid_properties/)(Trigger)'**가 상호 작용하여 발생한 아키텍처적 빅뱅입니다.
...
| :--- | :--- | :--- | :--- |
| **핵심 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 유형** | [정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/) (텍스트, 회계 수치) | 반정형/[비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) (웹 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/), 이미지) | **기계 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)/[합성 데이터](/knowledge-base/studynote/09_security/16_data_privacy/818_synthetic_data/), 초고해상도 스트리밍** |
| **주요 스토리지** | RDBMS ([Oracle](/knowledge-base/studynote/05_database/03_relational_model/188_pl_sql_t_sql_procedural/)), [NAS](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/492_nas_network_attached_storage/)/[SAN](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/493_san_storage_area_network/) | [하둡](/knowledge-base/studynote/03_network/16_data_center_cloud/843_hadoop_rack_awareness_data_replication_topology/) 생태계 ([HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/)), [Data Warehouse](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/208_data_warehouse_schema_on_write_inmon/) | **클라우드 [Object Storage](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/494_object_storage/) (AWS S3), [Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)** |
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 처리 방식** | 정밀한 [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/) (ACID 보장) | 배치(Batch) 위주의 대규모 분석 연산 | **실시간 스트리밍 분석 ([Kafka](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/), Flink)** |
| **가치 창출 메커니즘**| 과거 실적 집계 및 리포팅 (BI) | 고객 타겟팅, 패턴 추천 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | **거대 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/)([LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/)) 모델 학습을 위한 핵심 먹이(Fuel)** |

### 제타바이트 인프라의 트레이드오프 (Trade-off)
기업은 무한한 클라우드 [오브젝트 스토리지](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/494_object_storage/)([Object Storage](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/494_object_storage/))를 통해 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 얼마든지 싼 값에 밀어 넣을 수 있게 되었습니다([Scale-out](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/)). 하지만, **"모아둔 쓰레기([Dark Data](/knowledge-base/studynote/12_it_management/02_itsm_itil/062_darkdata/))가 자산(Asset)을 압도하는 트레이드오프"**가 발생합니다.
...
- **아키텍처 룰**:
  1. 오늘 당장 실시간 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 추천 모델에 투입되는 1주일 치 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 가장 비싼 **인메모리 캐시([Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/), Spark RAM)나 [NVMe](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/) [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)**에 배치합니다.
  2. 1달이 지난 분석용 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 저렴한 **클라우드 스토리지(S3 Standard)**로 자동 이관합니다.
  3. 1년이 지나 법적 보관 의무([Compliance](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/058_it_compliance_sox_basel_gdpr_isms/)) 때문에 지울 수만 없는 쓰레기 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는, 꺼내는 데 12시간이 걸리지만 가격이 극단적으로 싼 **아카이브 스토리지(AWS Glacier 등)로 테이프 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)(Cold Tier)**하는 3단계 계층화 로직을 시스템에 강제 적용해야 합니다.
...
1. **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 중력([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) Gravity)의 가속화**
   제타바이트 급으로 거대해진 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 마치 블랙홀처럼 엄청난 중력(Gravity)을 가집니다. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 덩어리가 너무 무거워서 이제는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 분석 엔진이 있는 곳으로 이동시킬 수 없습니다(네트워크 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 마비). 따라서 미래 아키텍처는 **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 제자리에 가만히 두고, 분석 [연산 코드](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/159_opcode/)(Compute)나 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 모델이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 있는 스토리지 쪽으로 날아가 연산한 뒤 결과만 가져오는 방식**으로 패러다임이 완전히 뒤집히고 있습니다.

2. **DNA 스토리지 및 광학 스토리지의 등장 연구**
   현재의 자성(디스크)이나 [반도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/009_semiconductor/)([플래시 메모리](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/256_flash_memory/)) 기반 물리적 하드웨어 기술로는 요타바이트(Yottabyte, ZB의 1000배) 시대를 감당할 수 없다는 비관론이 나옵니다. 이에 마이크로소프트 등 빅테크는 살아있는 유기체인 **DNA의 염기 서열(A, C, G, T)**에 0과 1을 매핑하여 초고밀도로 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 영구 저장하는 생물학적 스토리지 연구에 천문학적 예산을 쏟고 있습니다.
...
*   **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 규모의 팽창 체계**
    *   Mega -> Giga -> Tera -> Peta([10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)^15) -> Exa([10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)^18) -> **Zetta([10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)^21)** -> Yotta([10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)^24)
*   **ZB 시대를 버텨내는 아키텍처 철학**
    *   **[Scale-out](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) (수평 확장)**: [Hadoop](/knowledge-base/studynote/03_network/16_data_center_cloud/843_hadoop_rack_awareness_data_replication_topology/), [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/), [카산드라](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/299_data_lake/)
    *   **[Cloud Native](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/199_cloud_native_architecture_msa_cicd_devops/)**: AWS S3, GCP Cloud Storage (무한 확장 객체 스토리지)
    *   **[Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) Tiering**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 수명 주기 관리 (Hot / Warm / Cold Storage)
*   **ZB 시대의 어두운 이면**
