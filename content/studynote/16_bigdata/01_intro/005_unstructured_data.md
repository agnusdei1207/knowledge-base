...
# [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 유형 및 처리 아키텍처

#### 핵심 인사이트 (3줄 요약)
> 1. **본질**: [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/)([Unstructured Data](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/))는 고정된 테이블 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/)에 담을 수 없는 텍스트, 미디어, 센서 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 등으로, 전체 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 80% 이상을 차지하는 핵심 정보의 보고다.
> 2. **가치**: 형태가 불규칙하여 전통적인 SQL로는 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)가 불가능하지만, NLP, 컴퓨터 비전 모델을 통해 수학적 벡터(Vector) 공간으로 [임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/)([Embedding](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/))함으로써 컴퓨터가 이해할 수 있는 연산 가능한 자산으로 탈바꿈한다.
> 3. **융합**: 원본 보존을 위한 [오브젝트 스토리지](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/494_object_storage/)(S3), 유연한 구조를 담는 [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/)([MongoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/540_mongodb/)), 그리고 시맨틱 검색을 위한 [Vector DB](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/151_vector_database_embedding_ann_search/)([Milvus](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/320_gnn_vector_db_recommendation/), Pinecone)가 결합하여 엔드투엔드([End-to-End](/knowledge-base/studynote/03_network/08_transport_layer/401_transport_layer_role_end_to_end_multiplexing/)) 처리 생태계를 이룬다.

---

### Ⅰ. 개요 및 필요성 ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) & Necessity)

현대 비즈니스 환경에서 발생하는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 크게 정형(Structured), 반정형(Semi-structured), 비정형(Unstructured) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)된다. RDBMS의 테이블 구조에 정확히 들어맞는 [정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/)는 기업 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 빙산의 일각(약 20% 미만)에 불과하다. 나머지 수면 아래의 거대한 영역은 소셜 미디어 텍스트, 고객 센터 통화 녹음(음성), [CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/) 영상(비디오), 그리고 초당 수만 건씩 쏟아지는 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 센서 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 같은 [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/)로 구성되어 있다.
...
> 📢 **섹션 요약 비유**: [정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/)가 규격이 딱 맞는 '퍼즐 블록'이라면, [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/)는 크기와 모양이 제각각인 '자연석 바위'와 같다. 규격화된 수납장(RDBMS)에는 바위가 들어가지 않으므로, 넓은 마당([Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/))에 쌓아두고 필요할 때 돌의 특징을 분석([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) [임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/))하여 활용하는 것이다.

---

### Ⅱ. 아키텍처 및 핵심 원리 (Deep Dive)

[비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 처리는 수집된 원본 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 보존하는 '스토리지 계층'과, 의미를 추출하는 '딥러닝/[임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/) 계층', 그리고 이를 색인하여 검색하는 '특수 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 계층'으로 구분된다.

| [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 유형 | 형태적 한계 | 파싱 및 추출 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | 저장 아키텍처 | 실무 활용 |
|:---|:---|:---|:---|:---|
| **텍스트 (SNS/리뷰)** | 문법 불규칙, 동음이의어 | NLP ([BERT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/301_bert_mlm/), [GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/)), 형태소 분석, [NER](/knowledge-base/studynote/16_bigdata/05_analysis/117_ner/) | 문서형 [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) ([MongoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/540_mongodb/)), [Vector DB](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/151_vector_database_embedding_ann_search/) | [감성 분석](/knowledge-base/studynote/12_it_management/03_ea_isp/889_exploratory_data_analysis/), 챗봇 |
...
> 📢 **섹션 요약 비유**: 외국인(컴퓨터)에게 한국어([비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/))를 그대로 들려주면 알아듣지 못한다. 중간에 훌륭한 통역사([임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/) 모델)가 한국어의 뜻을 외국인의 모국어(수학적 벡터 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/))로 실시간 번역해 주어야만 비로소 원활한 대화와 지시([유사도 검색](/knowledge-base/studynote/05_database/06_dw_olap_trends/348_similarity_search/))가 가능해진다.

---

### Ⅲ. 융합 비교 및 다각도 분석 (Comparison & Synergy)

[비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/)를 저장하기 위해서는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 특성에 맞는 적절한 스토리지 솔루션의 조합이 필수적이다. 비정형/[반정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/003_semi_structured_data/)를 다루는 3대 스토리지 시스템을 융합 관점에서 비교해 보자.

| 비교 매트릭스 | [Object Storage](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/494_object_storage/) (AWS S3) | [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) [Document](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/) ([MongoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/540_mongodb/)) | Search 엔진 ([Elasticsearch](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/302_cdc/)) |
|:---|:---|:---|:---|
...
> 📢 **섹션 요약 비유**: 도서관([비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 처리 시스템)에서 무거운 책 원본(미디어 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/))은 지하 서고(S3)에 보관하고, 책의 제목과 위치가 적힌 대출 카드([NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/))는 안내 데스크에 두며, 책 속 단어까지 빠르게 찾을 수 있는 컴퓨터 검색대([Elasticsearch](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/302_cdc/))를 따로 운영하여 효율성을 극대화하는 방식이다.
...
[비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 처리 아키텍처의 내재화는 기업이 '세상의 모든 소리'를 들을 수 있게 됨을 의미한다. 과거에는 매출 장표(정형)를 통해 '무엇이 얼마나 팔렸는가'라는 결과만 알 수 있었다면, 이제는 유튜브 댓글(텍스트)과 매장 [CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/)(영상) 분석을 통해 '고객이 이 제품을 왜 싫어하는지', '어떤 동선으로 매장을 이탈하는지'와 같은 인과관계(Why)를 정량적으로 파악할 수 있다.

향후 [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 처리의 패러다임은 대형 언어 모델([LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/)) 및 [멀티모달](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/158_multimodal_clip_vision_audio_encoding/)(Multi-modal) [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 시스템과 완벽히 융합되는 방향으로 진화하고 있다. 텍스트, 이미지, 음성을 개별 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인이 아닌 하나의 딥러닝 모델이 동시에 벡터화하여 통합된 문맥(Variability)을 이해하는 시대가 도래했으며, 이를 지탱하기 위한 고성능 [Vector DB](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/151_vector_database_embedding_ann_search/) ([Milvus](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/320_gnn_vector_db_recommendation/), Qdrant 등)의 확산이 빅데이터 표준 인프라의 핵심으로 확고히 자리 잡을 것이다.

> 📢 **섹션 요약 비유**: [비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/) 분석의 완성은 눈 감고 귀 막은 채 장부만 보며 장사하던 사장님(기존 RDBMS)이 비로소 눈을 뜨고 손님들의 표정, 말투, 행동 하나하나([비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/))를 깊이 있게 관찰하며 소통하는 진정한 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 장인으로 거듭나는 과정이다.
...
### 👶 어린이를 위한 3줄 비유 설명
1. 엑셀처럼 칸이 딱딱 나뉘어 있는 공책([정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/))도 있지만, 우리가 찍은 사진, 녹음한 목소리, 낙서장([비정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/004_unstructured_data/))은 그런 칸에 절대 들어가지 않아요.
2. 그래서 컴퓨터는 사진이나 목소리를 자기들만 아는 아주 길고 복잡한 숫자 암호(벡터 [임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/))로 바꾼 다음 넓은 마당([데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/))에 던져놓아요.
