...
FAIR는 단순 선언이 아니라 아키텍처상에 **영구 [식별자](/knowledge-base/studynote/03_network/06_network_layer_ip/289_identification_flags_fragmentation_offset/) 계층**과 **시맨틱(의미론적) 표현 계층**을 강제한다.
...
| **[접근성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/292_accessibility_kwcag_wcag/)** | 폐쇄망, 엄격한 [접근 통제](/knowledge-base/studynote/04_software_engineering/06_software_architecture/387_access_control_pattern/) | 제약 없는 다운로드 허용 | **표준 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)을 통한 명확한 [인가](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/509_authorization_models_rbac_abac/)/조회** | [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 표준화 |
| **[메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/)** | 기업 내부 양식 사용 (비표준) | 없거나 매우 부족함 (단순 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)명) | **기계가 파싱 가능한 구조화된 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) 강제** | [상호운용성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/287_interoperability_tactics/) 보장 |
...
**[안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/): "Open=FAIR"라는 착각으로 인한 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) 방치**
...
|:---|:---|:---|
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 활용률** | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 수집/정제에 전체 시간의 80% 낭비 | 기계가 자동 수집/연동, 분석 및 모델링에 역량 집중 |
| **[상호운용성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/287_interoperability_tactics/)** | 시스템 간 1:1 수동 하드코딩 인터페이스 | 온톨로지 기반의 N:N 자동 지식 연결 ([Knowledge Graph](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/160_knowledge_graph_graphrag_integration/)) |
...
- **[데이터 카탈로그](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/) ([Data Catalog](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/))** | FAIR의 Findable(F)을 위해 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/)를 통합 수집하여 전사적인 검색과 색인 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)를 제공하는 도구.
- **영구 [식별자](/knowledge-base/studynote/03_network/06_network_layer_ip/289_identification_flags_fragmentation_offset/) (PID, Persistent [Identifier](/knowledge-base/studynote/05_database/02_modeling_normalization/088_identifier_in_er_model/))** | DOI(Digital Object [Identifier](/knowledge-base/studynote/05_database/02_modeling_normalization/088_identifier_in_er_model/))처럼 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 물리적 위치가 변해도 항상 동일한 대상을 가리키는 고유 주소 체계.
- **[시맨틱 웹](/knowledge-base/studynote/06_ict_convergence/01_blockchain/003_semantic_web/) ([Semantic Web](/knowledge-base/studynote/06_ict_convergence/01_blockchain/003_semantic_web/))** | 웹에 존재하는 수많은 웹페이지와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)들에 의미(Semantics)를 부여하여 컴퓨터가 스스로 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)적 추론을 할 수 있게 하는 지능형 웹 환경.
