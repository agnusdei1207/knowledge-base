...
|:---|:---|:---|:---|:---|
| **[IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 센서** | 시계열(Time-series) 수치 | 초당 수십 회 / 수십 [Byte](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/074_byte/) | 초고빈도 동시 접속 (Connection & TPS) | 쏟아지는 모래알 |
| **SNS / [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)** | 비정형 텍스트, [JSON](/knowledge-base/studynote/11_design_supervision/06_exam_summary/343_json/) | 분당 수 회 / 수 KB | 텍스트 파싱 연산 및 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 유연성 | 날아오는 편지 뭉치 |
...
**운영/보안 [체크리스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/)**:
...
|:---|:---|:---|:---|
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 활용률** | 트래픽 폭증 시 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 강제 Drop | 비동기 큐를 통한 99.999% 수용 | 누락 없는 정교한 고객 타겟팅 |
