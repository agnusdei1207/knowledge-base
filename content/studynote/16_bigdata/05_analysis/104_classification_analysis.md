...
- **불균형 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 대응:** 암 진단이나 사기 탐지처럼 정답 비율이 극히 낮은 경우엔 단순 정확도보다 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)([Recall](/knowledge-base/studynote/10_ai/03_llm_nlp/254_recall_sensitivity/))과 F1-Score가 더 중요함.
...
- **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 불균형(Imbalance) 처리:** 실제 현업 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 대개 편향되어 있으므로 **[SMOTE](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/231_smote_oversampling_class_imbalance_augmentation/)**나 **[Oversampling](/knowledge-base/studynote/14_data_engineering/02_math_mining/096_oversampling_smote/)** 기법을 적용하여 모델이 소수 클래스를 학습하지 못하는 '정확도의 함정'을 피해야 함.
- **[앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/)([Ensemble](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/)) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/):** 단일 모델보다는 **XGBoost**나 **LightGBM** 같은 [부스팅](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) 모델을 사용하는 것이 실질적인 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)(Score) 확보에 유리함.
- **설명 가능성([XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/)):** 딥러닝 기반 분류 시 판단 근거를 알기 어려우므로, **[SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/)**이나 **[LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/)** 기표를 통해 변수 중요도를 역추적하는 것이 기술사적 필수 소양임.
