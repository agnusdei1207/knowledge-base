...
2. **[중심 극한 정리](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/) ([CLT](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/))**: 표본의 크기가 충분히 크면 표본 평균의 분포는 [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/)를 따름. 추론 통계의 수학적 토대.
3. **[유의 확률](/knowledge-base/studynote/06_ict_convergence/05_data_science/337_p_value_significance/) ([p-value](/knowledge-base/studynote/06_ict_convergence/05_data_science/337_p_value_significance/))**: "실제로는 효과가 없는데, 우연히 이런 결과가 나올 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)". 이 값이 낮을수록 결과에 대한 확신이 커짐.
...
| **[리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/)** | 오차의 정도를 알 수 없음 | 불확실성을 수치화하여 공유함 |
...
* **[확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 분포**: Normal, t, Chi-[square](/knowledge-base/studynote/04_software_engineering/06_software_architecture/341_iso_iec_25010/), F-distribution
