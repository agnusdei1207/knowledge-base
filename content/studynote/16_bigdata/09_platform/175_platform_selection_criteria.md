...
기술사 답안에서는 다음 세 가지가 중요하다. 첫째, **CapEx (Capital Expenditure) vs OpEx (Operational Expenditure)** 차이를 기술·재무 관점에서 설명할 것. 둘째, <strong>데이터 주권과 벤더 종속</strong>을 성능보다 상위 제약으로 볼 것. 셋째, <strong>출구 전략</strong>을 명시할 것. Parquet, Apache Iceberg, Trino 같은 개방형 기술을 일부라도 남겨 두면 나중에 재배치 비용을 줄일 수 있다.
