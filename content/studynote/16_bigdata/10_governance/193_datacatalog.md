...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [데이터 카탈로그](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/)([Data Catalog](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/))는 "기업 내에서하다(흩어져 있는) 모든 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 자산([데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/), 테이블, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/), [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 등)의 위치, [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/), 설명, 소유자, 품질 지표, 계보(Lineage) 정보를 한눈에 검색하고 발견할 수 있도록 중앙 집중식으로(정리)한 [메타데이터 관리 시스템](/knowledge-base/studynote/05_database/02_modeling_normalization/125_metadata_management_system_mms/)"이다.
> 2. **가치**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석가나 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 과학자가 "내 нужна 필요한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 어디에 있는지"를 수(수개월)에 걸쳐 탐색하는 '[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 사냥'을 제거하고, 5분 내 필요한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 검색하여 분석 시작 시간을 драстически(극적으로) 단축하며,(셀프서비스) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석 문화의 기반을 제공한다.
...
- **📢 섹션 요약 비유**: [데이터 카탈로그](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/) 도입은 "새로운 체육관실 사물함 시스템을 도입하는 것"과 같습니다. 사물함 위치와 키([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 위치)를 중앙 관리소([카탈로그](/knowledge-base/studynote/05_database/07_exam_summary/394_catalog_metadata/))에 등록해 두면 누군가 "내 사물함 어디 있지?"라고 물을 때(즉시) 찾아줍니다. 하지만 사물함에 물건([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))을(입력 누락)거나, 다른 사람 물건(잘못된 설명)을하면 시스템이 오히려을 야기하는 것처럼, [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) 입력의 질이 [카탈로그](/knowledge-base/studynote/05_database/07_exam_summary/394_catalog_metadata/)의을 결정합니다.
...
| **예산** | 관리형 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 비용 감당 가능 여부 | 관리형은Convenience지만cost, OSS는 부담 |
...
### 👶 어린이를 위한 3줄 비유 설명
1. [데이터 카탈로그](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/)'는 비빔밥을 만들 때 필요한 ' 목록'과 같아요.
2. 카드에는 "양파: 3번째 선반, 표고버섯: 1번째 냉장고, 소고기: 2번째 냉장고"와 같이 모든 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 어디에 있는지 적혀있어서, 필요한 재료를(바로 찾을) 수 있어요.
3. 컴퓨터에서도 수천 개의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 어디에 저장되어 있는지 목록을 만들어 놓으면, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 needed할 때 수 만에 찾아올 수 있는 것이 바로 '[데이터 카탈로그](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/)'예요!
