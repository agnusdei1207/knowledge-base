...
[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 품질 관리 도구([Data Quality](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/270_data_quality_great_expectations/) Tools)는 [데이터 파이프라인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/645_data_pipeline_acceleration/) 내에서 <strong>자동화된 품질 검사·<a href="/knowledge-base/studynote/02_operating_system/04_synchronization/229_monitor/">모니터</a>링·리포팅</strong>을 수행하는 소프트웨어다. 수동 SQL [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)로 품질을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 방식은 확장성이 없고, 새로운 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 소스 추가 시마다 검사 스크립트를 재작성해야 하는 문제가 있다.
...
- <strong><a href="/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/">파이프</a>라인 통합 필요</strong>: Airflow·dbt·Spark [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인에 품질 게이트를 코드로 정의
...
**📢 섹션 요약 비유**: DQ 도구는 <strong>자동화된 품질 검사 로봇</strong>이다. 공장 생산 라인에서 사람이 일일이 제품을 검사하던 것을 자동화 센서와 로봇이 대체하듯, DQ 도구는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 품질 검사를 자동화한다.
...
- <strong><a href="/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/">Data</a> Docs</strong>: 체크포인트 실행 결과를 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)하는 HTML 품질 문서

### AWS Deequ 핵심 개념

Deequ는 [Apache Spark](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/206_spark_inmemory_rdd_lazy_evaluation_lineage/) 위에서 동작하는 <strong>대규모 <a href="/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/">데이터</a>셋 제약 <a href="/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/">검증</a> <a href="/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/">라이브러리</a></strong>다. 수백억 레코드를 Spark [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 처리로 한 번의 패스에 검사한다.
...
Monte Carlo는 통계 기반 <strong>이상 감지(<a href="/knowledge-base/studynote/16_bigdata/05_analysis/111_anomaly_detection/">Anomaly Detection</a>)</strong>를 통해 품질 규칙을 명시적으로 정의하지 않아도 자동으로 이상을 감지한다:
- 레코드 수 급격한 변화 감지
- 컬럼 null 비율 갑작스러운 증가
- 수치형 컬럼 분포 변화 (Mean/StdDev 이상)
- 적재 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)(Freshness) 알림

**📢 섹션 요약 비유**: Great Expectations/Deequ/Soda가 <strong>정해진 규칙을 <a href="/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/">확인</a>하는 <a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/">체크리스트</a></strong>라면, Monte Carlo는 <strong>이상한 낌새를 자동으로 감지하는 <a href="/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/">AI</a> 경비원</strong>이다.
...
- Great Expectations는 <strong><a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/435_checklist_based_testing/">체크리스트</a>를 자동으로 <a href="/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/">확인</a>하는 로봇</strong>이에요: "이메일 빈칸 없어야 해, 나이는 0~150이어야 해" 같은 규칙을 코드로 쓰면 매번 자동으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해줘요.
- Deequ는 <strong>수십억 개 <a href="/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/">데이터</a>를 한 번에 검사하는 대형 품질 기계</strong>예요: 소규모 검사는 Great Expectations로, 엄청나게 큰 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 Deequ로 빠르게 처리해요.
