...
데이터 스튜어드는 거버넌스가 종이 위 선언에 머물지 않고 <strong>현장에서 살아 움직이게 만드는 핵심 역할</strong>이다. 기술사는 스튜어드가 비즈니스 역할임을 명확히 이해하고, Data Owner·Custodian과의 협력 구조, 이중 역할 부담 해소 방안, 성과 지표 설계까지 포괄적으로 제시할 수 있어야 한다.
