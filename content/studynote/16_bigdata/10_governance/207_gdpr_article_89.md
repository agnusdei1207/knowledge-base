...
GDPR Article 89는 <strong>개인정보 보호와 데이터 활용의 균형을 과학적 방법론으로 해결</strong>한 조항이다. 가명처리·데이터 최소화라는 기술적 수단으로 프라이버시 보호 수준을 유지하면서, 인류 공동의 지식 발전을 위한 데이터 활용을 허용한다. 컴퓨터시스템응용기술사는 빅데이터 연구 프로젝트 설계 시 Article 89 적용 요건과 국가별 구체화 법률을 반드시 검토해야 한다.
