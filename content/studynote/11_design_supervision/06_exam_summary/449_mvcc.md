...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Readers</div><div class="kb-diagram-cell">──▶</div><div class="kb-diagram-cell">Versioned Rows</div><div class="kb-diagram-cell">◀──</div><div class="kb-diagram-cell">Writers Create</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Snapshot</div><div class="kb-diagram-cell">MVCC Snapshot</div><div class="kb-diagram-cell">New Versions</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Row V1</div><div class="kb-diagram-cell">▶</div><div class="kb-diagram-cell">Row V2</div><div class="kb-diagram-cell">▶</div><div class="kb-diagram-cell">Row V3</div></div>
<div class="kb-diagram-note">── Writer Commit</div>
<div class="kb-diagram-tree-item" style="--depth:2">Reader Snapshot</div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">2PL Locking</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">MVCC Snapshot Read</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Opt. / Pess. Mix</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Isolation Tuning</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Vacuum Monitoring</div></div>
</div>
</div>
