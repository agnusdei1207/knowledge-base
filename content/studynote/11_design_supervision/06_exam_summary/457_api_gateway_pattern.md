...
<- **이전**: [456. 스트랭글러 패턴 레거시 전환](/knowledge-base/studynote/11_design_supervision/06_exam_summary/457_strangler_pattern/)
**다음**: [458. 서비스 디스커버리 레지스트리 패턴](/knowledge-base/studynote/11_design_supervision/06_exam_summary/458_service_discovery/) ->
