...
← **이전**: [[433_process|433. 파이프 필터 쉘 데이터 스트리밍 변환 (Pipe-Filter Pattern)]]
**다음**: [[435_dora|435. DORA 메트릭스 리드 타임 배포 빈도 지표 (DORA Metrics for Lead Time and Deployment Frequency)]] →
