...
> 3. **판단 포인트**: 모든 코드에 인터페이스를 남발하면 복잡도만 높아지므로, "외부 인프라인가?" 또는 "테스트에서 가짜 객체([Mock](/knowledge-base/studynote/04_software_engineering/11_testing_validation/854_mock_test_double/))로 대체해야 하는가?"를 기준으로 적용을 결정해야 한다.
...
DIP는 독단적으로 쓰이지 않고, 제어의 역전(IoC)이나 [의존성 주입](/knowledge-base/studynote/04_software_engineering/06_software_architecture/337_dependency_injection/)([DI](/knowledge-base/studynote/11_design_supervision/10_patterns_antipatterns/661_enterprise_di_framework_lifecycle/))과 함께 거대한 시너지를 만든다.
...
|:---|:---|:---|
| **의존성 주체** | 고수준 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)이 저수준 [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/)을 직접 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) (`new` 키워드) | 인터페이스에 의존, 외부([DI](/knowledge-base/studynote/11_design_supervision/10_patterns_antipatterns/661_enterprise_di_framework_lifecycle/) [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/))에서 객체 주입 |
...
| <strong><a href="/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/397_unit_test/">단위 테스트</a></strong> | 외부 DB, API가 없으면 테스트 불가 | 가짜 객체([Mock](/knowledge-base/studynote/04_software_engineering/11_testing_validation/854_mock_test_double/))를 주입하여 완벽한 고립 테스트 가능 |
