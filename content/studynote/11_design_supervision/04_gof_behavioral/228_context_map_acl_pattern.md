...
기술사 시험에서는 <strong>6가지 Context Map 관계 유형</strong>과 <strong>ACL이 방어하는 것(도메인 모델 오염)</strong>을 명확히 서술하고, <strong>ACL의 내부 구성요소(Adapter + Translator)</strong> 를 설명하는 것이 핵심이다.
