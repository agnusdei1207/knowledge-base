...
> 1. **본질**: [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object ([액티브](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) 오브젝트) 패턴은 메서드 호출(호출 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/))과 메서드 실행(실행 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/))을 분리하여, 비동기 호출자가 즉시 Future를 받고 실제 실행은 별도 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)에서 처리되도록 한다.
> 2. **가치**: 호출자와 실행자 사이의 완전한 분리로 높은 응답성(Responsiveness)을 달성하며, 요청 큐(ActivationQueue)로 실행 순서를 제어한다.
> 3. **판단 포인트**: Java의 `CompletableFuture`, `ExecutorService.submit()` 모두 [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object 패턴의 현대적 구현이다.
...
- **📢 섹션 요약 비유**: 택배 회사의 드라이브 스루 — 고객([Client](/knowledge-base/studynote/11_design_supervision/01_audit_framework/003_audit_stakeholders/))은 창구([Proxy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/))에 택배를 맡기고 영수증(Future)만 받아 떠난다. 배달기사(Servant)는 창고(ActivationQueue)에서 순서대로 꺼내 배달한다.
...
|:---|:---|
| [Command](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/271_command_pattern/) ([커맨드](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/271_command_pattern/)) | MethodRequest가 [Command](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/271_command_pattern/) 패턴으로 구현 |
| [Proxy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/) ([프록시](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/)) | [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object의 Proxy가 실제 객체처럼 보임 |
| [Strategy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) ([전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)) | Scheduler의 스케줄링 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 교체 가능 |
| [Observer](/knowledge-base/studynote/04_software_engineering/04_testing_quality/267_observer_pattern/) ([옵저버](/knowledge-base/studynote/04_software_engineering/04_testing_quality/267_observer_pattern/)) | Future 완료 시 Observer에게 알림 |

- **📢 섹션 요약 비유**: [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object는 "뛰어난 비서" — 상사(Scheduler)에게 할 일 목록(ActivationQueue)을 전달하고, 상사는 우선순위에 따라 실무자(Servant)에게 지시한다. 지시를 내린 사람([Client](/knowledge-base/studynote/11_design_supervision/01_audit_framework/003_audit_stakeholders/))은 결과를 기다리지 않고 다른 일을 한다.
...
- 호출 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)와 실행 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)의 **완전한 분리** 강조
...
- **📢 섹션 요약 비유**: [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object는 "비동기 은행 업무 시스템" — 창구 직원([Proxy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/))이 신청서(MethodRequest)를 받아 대기열(ActivationQueue)에 넣고, 처리 번호표(Future)를 준다. 처리 직원(Servant)이 순서대로 처리하고 알림 문자(결과)를 보낸다.
...
- **📢 섹션 요약 비유**: [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object는 "현대 전자정부 민원 시스템" — 민원 접수([Proxy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/)), 접수증(Future), 처리 대기열(ActivationQueue), 담당 공무원 배정(Scheduler), 실제 처리(Servant), 결과 통지(Future 완료).
...
| 하위 개념 | 6요소 ([Proxy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/264_proxy_pattern_surrogate_access_control/)/MethodRequest/[Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/)/Scheduler/Servant/Future) | 패턴 구성 요소 |
| 연관 개념 | CompletableFuture | Java의 [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object 현대 구현 |
| 연관 개념 | [Command Pattern](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/271_command_pattern/) | MethodRequest의 구현 방식 |
| 연관 개념 | Spring @Async | 선언적 [Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) Object |
...
2. 손님([Client](/knowledge-base/studynote/11_design_supervision/01_audit_framework/003_audit_stakeholders/))은 번호표 받고 자리에서 대화를 나눌 수 있어요 — 기다리는 동안 멈추지 않아요!
