...
> 1. **본질**: [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) ([Model-View-Presenter](/knowledge-base/studynote/04_software_engineering/04_testing_quality/211_mvp_mvvm_architecture_frontend/)) 는 Presenter가 View를 직접 참조해 [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) 제어하고, MVVM (Model-[View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/)-ViewModel) 은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 바인딩([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) Binding)으로 View와 ViewModel이 자동 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)된다.
> 2. **가치**: 두 패턴 모두 비즈니스 로직을 View에서 분리하여 테스트 가능성([Testability](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/285_testability_tactics/))을 높이지만, 바인딩 방식의 차이로 UI 복잡도와 테스트 전략이 달라진다.
> 3. **판단 포인트**: 단순 폼 처리는 [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/), 실시간 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 반응형 UI (User Interface) 는 MVVM이 적합하며, 선택 기준은 "View가 ViewModel을 아는가"의 의존 방향이다.

---

## Ⅰ. 개요 및 필요성
전통적인 MVC ([Model-View-Controller](/knowledge-base/studynote/11_design_supervision/06_exam_summary/405_mvc_m_v_c/)) 패턴에서 Controller가 비대해지면 테스트와 유지보수가 어렵다. [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) ([Model-View-Presenter](/knowledge-base/studynote/04_software_engineering/04_testing_quality/211_mvp_mvvm_architecture_frontend/)) 와 MVVM (Model-[View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/)-ViewModel) 은 이 문제를 해결하기 위해 프레젠테이션 로직을 [View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/) 바깥으로 추출한다.
...
| 연도 | 패턴 | 맥락 |
|:---:|:---|:---|
| [1996](/knowledge-base/studynote/09_security/02_crypto/098_md5/) | [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) | Taligent 설계, 마틴 파울러 정리 |
| 2004 | PM (Presentation Model) | [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) 진화 형태 |
...
## Ⅳ. 실무 적용 및 기술사 판단
- **Android** 레거시 코드: Activity가 [View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/) 역할, Presenter를 JUnit으로 테스트
- **ASP.NET WebForms**: Code-behind를 IView 인터페이스 뒤로 숨겨 Presenter 테스트 가능

- **Vue.js / Angular**: `v-model`, `[(ngModel)]`로 폼 상태 자동 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)
- **WPF**: INotifyPropertyChanged ([속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) 변경 알림 인터페이스) 구현으로 바인딩
- **Jetpack Compose**: `State<T>`, `StateFlow`로 선언적 UI ([Declarative](/knowledge-base/studynote/15_devops_sre/05_devsecops/219_declarative_yaml/) UI)
...
- **📢 섹션 요약 비유**: [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/) 매니저는 직접 전화해서 지시하고, MVVM 매니저는 공유 구글 시트에 상태를 업데이트하면 팀원들이 알아서 확인한다.
...
- **📢 섹션 요약 비유**: [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/)/MVVM은 "요리사와 홀 직원을 분리"한 레스토랑이다. 홀이 바뀌어도 주방은 그대로 운영된다.
...
|:---|:---|:---|
| 상위 개념 | MVC ([Model-View-Controller](/knowledge-base/studynote/11_design_supervision/06_exam_summary/405_mvc_m_v_c/)) | [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/)/MVVM의 원조 패턴 |
| 하위 개념 | Passive [View](/knowledge-base/studynote/05_database/03_relational_model/151_sql_view_virtual_table/) | MVP에서 View의 역할 (수동적) |
| 하위 개념 | Observable / StateFlow | MVVM [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 바인딩의 기술 구현체 |
| 연관 개념 | Flux / Redux | [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 흐름 패턴 (React 생태계) |
| 연관 개념 | [Clean Architecture](/knowledge-base/studynote/04_software_engineering/04_testing_quality/217_clean_architecture_dependency_rule/) | [MVP](/knowledge-base/studynote/12_it_management/01_governance_strategy/036_mvp/)/MVVM을 레이어 아키텍처에 통합 |
