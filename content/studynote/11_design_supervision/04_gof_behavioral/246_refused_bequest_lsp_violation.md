...
> 1. **본질**: [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) 거부 (Refused Bequest) 는 자식 클래스가 부모의 메서드나 속성을 사용하지 않거나 빈 구현으로 오버라이드함으로써 [리스코프 치환 원칙](/knowledge-base/studynote/11_design_supervision/06_exam_summary/357_process/) ([LSP](/knowledge-base/studynote/04_software_engineering/04_testing_quality/245_lsp_liskov_substitution_principle/): [Liskov Substitution Principle](/knowledge-base/studynote/04_software_engineering/04_testing_quality/245_lsp_liskov_substitution_principle/)) 을 위반하는 패턴이다.
> 2. **가치**: "is-a [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)"가 실제로는 성립하지 않는 [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/)을 발견·제거함으로써 시스템의 다형성 (Polymorphism) 신뢰성을 회복한다.
> 3. **판단 포인트**: "부모 타입 변수에 자식 인스턴스를 대입해도 프로그램이 올바르게 동작하는가?" — No라면 [LSP](/knowledge-base/studynote/04_software_engineering/04_testing_quality/245_lsp_liskov_substitution_principle/) 위반이다.
...
- **📢 섹션 요약 비유**: 스마트폰이 "전화기"를 [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/)받아 "팩스 기능 거부"를 오버라이드하는 것보다, 스마트폰이 전화 기능을 "내장"하고 별도로 존재하는 게 더 자연스럽다.
...
[상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) 거부 (Refused Bequest) 는 여러 [SOLID](/knowledge-base/studynote/04_software_engineering/04_testing_quality/242_solid_object_oriented_design_principles/) 원칙과 동시에 충돌한다.

| [SOLID](/knowledge-base/studynote/04_software_engineering/04_testing_quality/242_solid_object_oriented_design_principles/) 원칙 | 위반 방식 |
|:---|:---|
...
- **📢 섹션 요약 비유**: 알바생을 뽑을 때 "모든 업무 가능자"로 채용했는데 특정 업무는 아예 못 한다면, 처음부터 역할을 나눠 채용했어야 한다 — [인터페이스 분리 원칙](/knowledge-base/studynote/11_design_supervision/06_exam_summary/358_architecture/)이다.

---

## Ⅴ. 기대효과 및 결론
| 지표 | [LSP](/knowledge-base/studynote/04_software_engineering/04_testing_quality/245_lsp_liskov_substitution_principle/) 위반 유지 | [LSP](/knowledge-base/studynote/04_software_engineering/04_testing_quality/245_lsp_liskov_substitution_principle/) 준수 |
|:---|:---:|:---:|
...
3. [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) 거부 제거는 이처럼 "진짜 is-a [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)인지" 다시 확인하는 과정이다.
