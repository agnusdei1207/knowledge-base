...
> 1. **본질**: Null Object (널 객체) 패턴은 `null` [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 대신 "아무 일도 하지 않는" 기본 객체(NoOp, No-Operation 객체)를 반환하여, 호출자가 `null` 체크를 하지 않아도 되게 만든다.
...
## Ⅰ. 개요 및 필요성
Tony Hoare가 1965년 null [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)를 도입하면서 "10억 달러짜리 실수"라고 직접 표현했다. null이 문제인 이유:
...
|:---|:---|:---|
| 빈 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) `[]` | 원소 없는 컬렉션 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 포함 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) |
| `/dev/null` (Unix) | 쓰고 버리는 장치 | 실제 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) |
| `Collections.emptyList()` | 빈 리스트 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 리스트 |
...
- <strong><a href="/knowledge-base/studynote/04_software_engineering/06_software_architecture/382_defensive_programming/">방어적 프로그래밍</a>(<a href="/knowledge-base/studynote/04_software_engineering/06_software_architecture/382_defensive_programming/">Defensive Programming</a>)의 코드 제거</strong> 효과 강조
...
Null Object (널 객체) 패턴은 [방어적 프로그래밍](/knowledge-base/studynote/04_software_engineering/06_software_architecture/382_defensive_programming/)의 대안으로, 코드를 더 단순하고 NPE로부터 안전하게 만든다. 로거, 이벤트 핸들러, 기본 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 객체처럼 "없어도 동작이 계속되어야 하는" 컴포넌트에 특히 효과적이다.
...
| 연관 개념 | [Strategy Pattern](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | Null Object를 기본 전략으로 사용 |
| 연관 개념 | [State Pattern](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) | Null Object를 기본 상태로 사용 |
