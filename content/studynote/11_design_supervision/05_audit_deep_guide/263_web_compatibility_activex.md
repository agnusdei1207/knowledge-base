...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">브라우저 호환성 기준 수립</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">표준 대체 아키텍처 설계 반영</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">사용자 접근성 증적 확보</div></div>
</div>
</div>
