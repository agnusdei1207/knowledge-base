...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">인증서 자산목록 기준 수립</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">만료 알림 설계 반영</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">자동 갱신 증적 확보</div></div>
</div>
</div>
