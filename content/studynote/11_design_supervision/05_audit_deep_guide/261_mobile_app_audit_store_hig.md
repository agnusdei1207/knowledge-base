...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">디자인 시스템 기준 수립</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">탐색 일관성 설계 반영</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">스토어 심사 적합성 증적 확보</div></div>
</div>
</div>
