...
## Ⅰ. 개요 및 필요성
리틀의 법칙(Little's Law)은 1961년 존 리틀(John D.C. Little)이 증명한 큐잉 이론(Queuing Theory)의 기본 정리다. 원래는 대기열 분석에서 유도되었지만, IT [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 공학에서 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/)·DB 커넥션 풀·메시지 큐 크기 산정에 광범위하게 활용된다.

공공정보화 감리에서 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/)과 커넥션 풀 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)값은 핵심 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 파라미터다. 잘못된 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)은 서버 자원 낭비(과다 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)) 또는 요청 거부·[타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/)(과소 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/))을 유발한다.
...
| 변수 | 실무 매핑 | 예시 값 |
|:---|:---|:---|
| L | 필요 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 크기 (활성 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 수) | 50개 |
...
|:---|:---|:---|:---|
| WAS [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) | 활성 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 수 | TPS | 평균 [응답 시간](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/138_response_time/) |
| DB 커넥션 풀 | 활성 커넥션 수 | DB [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) TPS | 평균 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) 시간 |
| 메시지 큐 | 큐 적재 메시지 수 | 소비 TPS | 평균 처리 시간 |
| 네트워크 버퍼 | 버퍼 내 패킷 수 | 패킷/초 | [전송 지연](/knowledge-base/studynote/03_network/01_data_communication/017_전송_지연/) 시간 |

- **📢 섹션 요약 비유**: 리틀의 법칙은 "슈퍼마켓 계산대 수 결정"에서 "공장 생산라인 설계"까지 어디서나 통하는 범용 공식이다. 단지 IT에서는 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)와 커넥션에 적용할 뿐이다.

---

## Ⅳ. 실무 적용 및 기술사 판단
| 단계 | [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 항목 | 기대 결과 |
|:---|:---|:---|
| **1단계** | [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 목표 TPS 및 [응답 시간](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/138_response_time/) [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) | 요건 정의서에 명시 |
...
- **📢 섹션 요약 비유**: `maxThreads=200`으로 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)된 이유를 개발팀이 "기본값이라서요"라고 답한다면 감리 지적 대상이다. [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) 값에는 반드시 산정 근거가 있어야 한다.

---

## Ⅴ. 기대효과 및 결론
리틀의 법칙을 기반으로 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/)과 커넥션 풀을 산정하면 자원 낭비 없이 목표 TPS를 달성하는 최적 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)이 가능하다. 실무에서 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 과소 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)으로 인한 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/), 과다 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)으로 인한 GC([Garbage Collection](/knowledge-base/studynote/02_operating_system/06_memory_management/380_garbage_collection/)) 압박은 모두 리틀의 법칙 산정 미적용에서 비롯된다. 감리인은 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)값의 산정 근거 문서를 반드시 요구하고, 이론값과의 비교 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)을 수행해야 한다.
...
| 연관 개념 | P95 [응답 시간](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/138_response_time/) | W 값의 실무 측정 기준 |
...
2. [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 크기는 "롤러코스터 직원이 몇 명 필요한가"와 같아서, 너무 적으면 손님이 기다리다 포기하고, 너무 많으면 직원만 놀아.
3. 이 공식을 모르고 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)하는 건 "감으로 직원을 뽑는 것"이고, 리틀의 법칙을 쓰면 "정확한 계산으로 딱 맞는 직원 수를 구하는 것"이야.
