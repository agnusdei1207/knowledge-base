...
**미래 방향**: ① [의존성 주입](/knowledge-base/studynote/04_software_engineering/06_software_architecture/337_dependency_injection/) 프레임워크(Spring [DI](/knowledge-base/studynote/11_design_supervision/10_patterns_antipatterns/661_enterprise_di_framework_lifecycle/), Guice)와 결합한 팩토리 관리, ② 코드 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 도구(Lombok, 어노테이션 프로세서)로 보일러플레이트 자동화.
