...
← **이전**: [[185_peer_to_peer_architecture|185. 피어투피어 아키텍처 (Peer-to-Peer Architecture)]]
**다음**: [[186_space_based_tuple_mapping|186. 스페이스 기반 아키텍처 투플 맵핑 구조 (Space-Based Tuple Mapping)]] →
