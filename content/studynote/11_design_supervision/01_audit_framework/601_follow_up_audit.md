...
건물을 지을 때 감리사가 "기둥에 철근이 2개 빠졌으니 다시 넣으시오"라고 지적(시정요청)했다고 치자. 건설사가 "네, 넣겠습니다"라고 말로만 하고 시멘트를 발라버리면 아무 소용이 없다. 감리사가 며칠 뒤 다시 찾아가서 시멘트를 바르기 전 철근이 진짜 2개 들어갔는지 두 눈으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 작업, 이것이 바로 '[확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리'다.

소프트웨어 프로젝트도 마찬가지다. 단계 감리(설계 감리, 종료 감리 등)에서 나온 수십 개의 '개선 권고 사항'과 '필수 조치 사항'을 수행사가 '감리 조치 결과서'라는 문서로 낸다. [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리원은 문서를 믿지 않고 시스템에 직접 접속해 쿼리를 날려보거나 소스 코드를 열어보고, "조치 완료", "부분 조치", "미조치"라는 잔혹한 도장을 찍는다. 이 도장이 찍혀야만 프로젝트가 비로소 살아남아 돈(대금)을 받을 수 있다.

- **📢 섹션 요약 비유**: [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 의사의 '경과 관찰(Follow-up)'이다. 의사가 약을 처방(본 감리 지적)했다고 끝나는 게 아니라, 일주일 뒤 환자를 다시 불러서 피검사를 해보고 염증 수치가 진짜로 떨어졌는지(조치 완료) [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해야만 완치 판정을 내리고 진료를 끝내는 것과 완벽히 동일하다.
...
### 정기 감리 (Regular) vs [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리 (Follow-up)
...
- **📢 섹션 요약 비유**: 정기 감리가 경찰이 범죄자를 체포하여 재판에 넘기는 '기소' 과정이라면, [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 판사가 죄수가 교도소에서 진짜로 반성했는지 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하고 풀어줄지 말지 결정하는 '가석방 심사'다. 권한의 무게감이 다르다.
...
### 실무 시나리오
1. **대체 조치 (Alternative Action)에 대한 기술적 타당성 평가**: 수행사가 "감리원님이 지적하신 솔루션 도입은 예산이 없어서 못 했지만, 대신 오픈소스를 써서 스크립트로 동일한 보안 효과를 냈습니다"라고 보고할 때. [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리원은 이 대체 조치가 원래 요구했던 보안 수준([SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/))을 100% 충족하는지 아키텍처 관점에서 재평가(Re-evaluation)해야 한다. 여기서 감리원의 내공이 부족하여 어설픈 꼼수를 '조치 완료'로 통과시키면, 나중에 해킹이 터졌을 때 감리 법인도 연대 책임을 지고 소송에 휘말린다.
...
- **📢 섹션 요약 비유**: 캡처본만 보고 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리를 통과시키는 것은, 다이어트 캠프 코치가 참가자의 몸무게를 체중계에 올려보지 않고 참가자가 제출한 '포토샵으로 깎은 전신사진'만 보고 합격 도장을 찍어주는 것과 같다. 반드시 체중계(실제 시스템 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))에 올려야 한다.

---

## Ⅴ. 기대효과 및 결론

[확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 소프트웨어 공학의 품질 보증(QA) 라이프사이클에서 '[피드백 루프](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/005_feedback_loop/)([Feedback Loop](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/005_feedback_loop/))'를 닫아버리는 가장 중요한 마침표다.

감리가 단순히 지적을 위한 지적으로 끝나지 않고, 실제 시스템의 품질 향상이라는 물리적 결과물로 치환되기 위해서는 강제력을 가진 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 절차가 필수적이다. 아무리 뛰어난 아키텍트가 설계도를 리뷰했더라도, 마지막에 그 설계도대로 쇳덩어리가 조립되었는지 망치로 두들겨보지 않으면 그 시스템은 언제 무너질지 모르는 사상누각일 뿐이다. 결론적으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 IT 프로젝트 거버넌스의 신뢰성을 담보하는 최후의 자물쇠다.

- **📢 섹션 요약 비유**: [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 비행기 이륙 전 정비사의 '최종 사인'이다. 고장 났던 엔진 부품을 교체하라는 지시를 정비팀에 내렸더라도, 마지막에 책임 정비사가 진짜 새 부품이 끼워졌는지 두 눈으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하고 장부에 서명하지 않으면 비행기는 단 1cm도 활주로를 나설 수 없다.
...
1. [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리는 엄마의 '방 청소 검사'예요.
2. 처음에 엄마가 "책상 치우고 장난감 치워!(본 감리)"라고 소리쳤을 때, 내가 "다 했어요!"라고 대답만 한다고 끝나는 게 아니죠.
3. 엄마가 다시 내 방 문을 열고 들어와서 진짜 장난감이 상자에 다 들어갔는지 두 눈으로 꼼꼼히 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 무서운 시간이 바로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 감리랍니다!
...
<- **이전**: [13. 추가 감리 / 시정조치 확인 (Follow-up Audit) - 감리 지적 사항(조치 권고) 이행 여부 최종 점검](/knowledge-base/studynote/11_design_supervision/01_audit_framework/013_audit_planning/)
**다음**: [14. 감리 계획 수립 (Audit Planning) - 예비조사, 감리 일정 및 인력 배치, 감리 계획서 작성](/knowledge-base/studynote/11_design_supervision/01_audit_framework/014_audit_planning/) ->
