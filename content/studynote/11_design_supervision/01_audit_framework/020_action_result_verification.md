...
> 3. **판단 포인트**: '조치 완료' 판정을 내리기 위해서는 단순히 코드가 수정되었는지 보는 것을 넘어, 대체 조치(Alternative Action)가 원래 요구되었던 비즈니스 목표([SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/), [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/))를 100% 만족하는지에 대한 아키텍트적 쇳덩어리 재평가 역량이 필수적이다.
...
안타깝게도 IT 현장에는 캡처본을 조작하거나 테스트 DB에만 적용하고 운영 DB에는 배포하지 않는 꼼수가 난무한다. 이 거짓말을 잡아내지 못하면 시스템 오픈 날 대형 해킹 사고가 터지고, 감리 법인도 연대 책임을 지고 소송의 늪에 빠진다. <strong><a href="/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/">조치 결과 확인</a></strong>은 감리원이 직접 시스템에 접속해 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)를 날려보고 소스코드를 뜯어보는 '실사 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)' 과정이다. 이것은 수행사의 숙제 검사 수준을 넘어, 프로젝트의 생사(대금 지급)를 결정하는 최후의 법적 판결문이다.
...
[조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 주관적인 평가가 아니다. 1:1 매핑을 통한 기계적 판정 프로세스다.
...
특히 <strong>대체 조치(Alternative Action)</strong>에 대한 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)이 가장 고난도다. 수행사가 "돈이 없어서 상용 보안 솔루션 도입은 못 했지만, 파이썬 스크립트로 짰습니다"라고 할 때, 그 스크립트가 원래 요구했던 보안 수준([SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/))을 100% 만족하는지 아키텍처적 관점에서 재평가(Re-evaluation)해야 하기 때문이다.
...
### 문서 감리 (Paper [Audit](/knowledge-base/studynote/12_it_management/05_security_compliance/363_audit/)) vs 실사 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) (Physical [Verification](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))
[조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)이 탁상행정으로 전락할 때 프로젝트는 파멸한다.
...
수행사는 프로젝트 막바지에 시간에 쫓겨 조치를 한 척([Fake](/knowledge-base/studynote/04_software_engineering/11_testing_validation/855_fake_test_double/))만 하고 넘어가려는 강한 유혹을 받는다. 감리원이 시스템에 접속할 권한([VPN](/knowledge-base/studynote/03_network/19_frequent_topics_terms/983_vpn_virtual_private_network/), 계정)조차 받지 못하고 커피숍에서 문서만 보고 있다면, 그 [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 프로젝트 예산을 훔치는 범죄 행위나 다름없다.

- **📢 섹션 요약 비유**: 문서 감리가 이력서에 적힌 '토익 900점' 글자만 보고 영어를 잘한다고 믿고 채용하는 것이라면, 실사 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)은 면접장에 불러서 원어민 면접관과 영어로 프리토킹(시스템 시연)을 시켜서 진짜 실력을 까발리는 것이다.
...
- <strong><a href="/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/">조치 결과 확인</a> 단계에서의 새로운 요구사항 도출 (<a href="/knowledge-base/studynote/04_software_engineering/03_design_architecture/161_scope_creep_requirements_inflation_prevention/">Scope Creep</a>)</strong>: 최악의 감리원. 과거 지적 사항이 완벽히 조치된 것을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해 놓고는, 갑자기 화면을 보더니 "어, 근데 이 버튼 색깔이 마음에 안 드네? 이것도 바꾸시오. 미조치!"라고 몽니를 부린다. [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 과거와의 약속([Baseline](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/))을 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)하는 자리이지 새로운 설계를 하는 자리가 아니다. 이런 짓을 하면 수행사는 프로젝트를 영원히 끝내지 못하고 파산하며, 감리 거버넌스의 신뢰는 바닥으로 추락한다.
...
[조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)(Action Result [Verification](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))은 기나긴 시스템 구축 라이프사이클의 문을 닫는 가장 육중한 쇳덩어리 자물쇠다.

아무리 훌륭한 아키텍트가 설계 단계에서 완벽한 비전을 제시하고 수백 개의 결함을 찾아냈더라도, 마지막에 그 결함들이 시스템에 물리적으로 고쳐졌는지 두 눈으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하지 않는다면 모든 감리 활동은 값비싼 잔소리에 불과하다. 이 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 절차가 존재하기 때문에 수행사는 밤을 새워 코드를 고치고, 발주처는 안심하고 수십억 원의 대금을 지불할 수 있다. 결론적으로 [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 문서와 현실 사이의 간극을 파괴하고, 소프트웨어의 무결성을 증명하는 최후의 법정이다.

- **📢 섹션 요약 비유**: [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 식당 위생 단속반의 '불시 재점검'이다. 한 달 전 바퀴벌레가 나와서 경고(지적)를 받은 식당이 "방역 완료했습니다"라고 서류를 냈어도, 단속반원이 예고 없이 주방 구석을 랜턴으로 비춰보고(실사) 바퀴벌레가 한 마리라도 나오면 그 즉시 영업정지(미조치)를 때려버리는 냉혹하고 필수적인 생존 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)이다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| <strong><a href="/knowledge-base/studynote/11_design_supervision/01_audit_framework/601_follow_up_audit/">확인 감리</a> (<a href="/knowledge-base/studynote/11_design_supervision/01_audit_framework/601_follow_up_audit/">Follow-up Audit</a>)</strong> | [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)이라는 행위가 공식적인 프로젝트 마일스톤(단계)으로 격상되어 수행되는 전체 감리 프로세스의 이름. 사실상 같은 쇳덩어리다. |
...
1. [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/)은 엄마가 방 청소를 하라고 지시한 뒤, 진짜로 다 했는지 검사하는 시간이에요.
2. 내가 "다 했어요!"라고 대답만 한다고 믿어주는 게 아니라, 엄마가 내 방 문을 열고 장난감 상자 안까지 직접 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해 보는(실사) 거죠.
...
<- **이전**: [19. 종료 회의 (Exit Meeting) - 감리 결과 발표 및 이견 조율](/knowledge-base/studynote/11_design_supervision/01_audit_framework/019_exit_meeting/)
**다음**: [20. 조치 결과 확인 (시정조치 확인 보고서 발행)](/knowledge-base/studynote/11_design_supervision/01_audit_framework/602_follow_up_action_verification/) ->
