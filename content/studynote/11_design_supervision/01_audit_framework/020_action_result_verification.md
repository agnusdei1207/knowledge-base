...
[조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/)이 탁상행정으로 전락할 때 프로젝트는 파멸한다.
...
[조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/)(Action Result [Verification](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))은 기나긴 시스템 구축 라이프사이클의 문을 닫는 가장 육중한 쇳덩어리 자물쇠다.

아무리 훌륭한 아키텍트가 설계 단계에서 완벽한 비전을 제시하고 수백 개의 결함을 찾아냈더라도, 마지막에 그 결함들이 시스템에 물리적으로 고쳐졌는지 두 눈으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하지 않는다면 모든 감리 활동은 값비싼 잔소리에 불과하다. 이 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 절차가 존재하기 때문에 수행사는 밤을 새워 코드를 고치고, 발주처는 안심하고 수십억 원의 대금을 지불할 수 있다. 결론적으로 [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/)은 문서와 현실 사이의 간극을 파괴하고, 소프트웨어의 무결성을 증명하는 최후의 법정이다.

- **📢 섹션 요약 비유**: [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/)은 식당 위생 단속반의 '불시 재점검'이다. 한 달 전 바퀴벌레가 나와서 경고(지적)를 받은 식당이 "방역 완료했습니다"라고 서류를 냈어도, 단속반원이 예고 없이 주방 구석을 랜턴으로 비춰보고(실사) 바퀴벌레가 한 마리라도 나오면 그 즉시 영업정지(미조치)를 때려버리는 냉혹하고 필수적인 생존 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)이다.
...
1. [조치 결과 확인](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/)은 엄마가 방 청소를 하라고 지시한 뒤, 진짜로 다 했는지 검사하는 시간이에요.
...
**다음**: [20. 조치 결과 확인 (시정조치 확인 보고서 발행)](/knowledge-base/studynote/11_design_supervision/01_audit_framework/020_follow_up_action_verification/) →
