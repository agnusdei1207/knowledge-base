...
### [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) 통제 ([Baseline](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/)) vs 일반적인 변경 (Change)
[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 저장(Save)하는 것과 [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/)을 잡는(Commit) 것은 하늘과 땅 차이다.

| 비교 항목 | 일반적인 개발 중 변경 (Working Draft) | [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) 확정 후 변경 ([Baseline](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/) Change) |
|:---|:---|:---|
...
- **📢 섹션 요약 비유**: 일반 변경이 모래사장에서 막대기로 그림을 그렸다가 지우는 것이라면, [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) 확정은 그 그림을 시멘트 바닥에 칼로 새겨 넣고 굳혀버리는 것이다. 굳기 전엔 언제든 발로 지우면 되지만, 굳은([Baseline](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/)) 후에는 시멘트를 깨부수고([CCB](/knowledge-base/studynote/04_software_engineering/03_design_architecture/160_change_control_board_ccb_requirements_review/) 승인) 처음부터 다시 부어야 하는 엄청난 비용과 허락이 필요하다.
...
[베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)([Baseline](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/) [Verification](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/))은 끝없이 팽창하려는 인간의 욕망(추가 요구사항)을 쇳덩어리 사슬로 묶어 프로젝트의 폭주를 막는 소프트웨어 공학의 '법치주의'다.

고객의 요구는 항상 변하고, 개발자는 항상 깜빡한다. 이 카오스를 통제하는 유일한 방법은 중간중간 세이브(Save) 포인트를 박아놓고 절대 뒤로 돌아가지 못하게 대못을 박는(Freeze) 것뿐이다. [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/)이 명확히 세워지고 엄격하게 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)될 때, 발주처는 자신이 무엇을 받을지 정확히 확신할 수 있고, 수행사는 돈 받은 만큼만 개발하고 정시에 퇴근할 수 있는 기적 같은 평화(Win-Win)의 아키텍처가 완성된다.

- **📢 섹션 요약 비유**: [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)은 '등산 중간의 베이스캠프(Base Camp)' 확립이다. 에베레스트를 오를 때, 1캠프에 도달하면 거기에 텐트와 식량을 박아두고([기준선](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/) 확정), 폭풍우가 와도 그 밑으로는 절대 내려가지 않는 전진 기지로 삼는다. 베이스캠프([베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/)) 없이 산을 오르면 눈보라(요구사항 변경) 한 번에 산 밑바닥(프로젝트 실패)까지 다시 굴러떨어지게 된다.
...
1. [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/)은 블록 장난감을 조립할 때, 1단계(자동차 바퀴)를 다 만들고 나서 "여기엔 절대 손대지 않겠음!"이라고 일기장에 도장을 쾅 찍고 약속하는 거예요.
2. 만약 동생이 나중에 "바퀴를 네모 모양으로 바꿔줘!"라고 떼를 써도, "이미 도장 찍었어([베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/))! 바꾸려면 용돈(예산)을 더 내야 해!"라고 방어할 수 있죠.
3. [베이스라인](/knowledge-base/studynote/04_software_engineering/03_design_architecture/159_baseline_requirements_configuration_management/) [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)은 이렇게 미리 약속한 도장 찍은 도면대로 정말 똑같이 바퀴를 달았는지, 아빠(감리원)가 아주 깐깐하게 하나씩 비교해 보는 검사 시간이에요!
