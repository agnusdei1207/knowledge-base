...
> 📢 **섹션 요약 비유**: 77건 샘플에서 4건 오류 -> 전체 2,400건에서 약 125건 [오류 추정](/knowledge-base/studynote/04_software_engineering/11_testing_validation/826_error_guessing/) — 전수 검토 없이도 문제 규모 파악 가능.
