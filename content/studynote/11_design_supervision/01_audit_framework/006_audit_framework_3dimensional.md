...
*   **기술사적 판단**: 3차원 프레임워크의 영역 축을 인력 배치에 활용한다. 각 전문가에게 1개 영역씩 전문적으로 담당시키고, 관점과 단계는 공유된 검사リスト로 관리한다. 각 전문가가 담당 영역의 전관점(절차, 산출물, 성과)과 전단계(요구사항 정의, 설계, 종료)를 균등하게 커버하도록 하여, 전업성 깊이와업무효솔를 동시에 달성한다.
