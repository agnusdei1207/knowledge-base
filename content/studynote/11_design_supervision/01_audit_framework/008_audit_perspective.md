...
*   **기술사적 판단**: 이 경우 절차와 산출물 관점에서는 "적합" 판정을 내릴 수 있지만, 성과 관점에서는 "부적합" 판정이 내려진다. 감리인은 이러한 관점 간 불일치가 발생하는 근본 원인을 분석해야 한다.가능성 있는 원인으로는 (1) 사용자들의expectations가당초 요구사항보다 높아졌거나, (2) 시스템은 만들어졌지만 사용법에 대한 교육(성과에 영향을 미치는 절차)이 부족했거나, (3) 요구사항 자체가 용호실제 필요와 괴리 등이 있다. 감리인은 이러한 가능성을일つ씩Investigate하여 관점 불일치의 원인을 밝혀야 한다.
