...
← **이전**: [[106_dip_dependency_inversion_principle|106. DIP (Dependency Inversion Principle, 의존성 역전 원칙)]]
**다음**: [[107_dry_principle|107. DRY 원칙 (Don't Repeat Yourself) - 코드 중복 방지 (데이터 일관성 보장)]] →
