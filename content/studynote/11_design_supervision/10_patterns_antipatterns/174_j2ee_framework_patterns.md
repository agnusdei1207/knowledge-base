...
> 3. **판단 포인트**: 패턴의 이름을 외우는 것보다 "어떤 경계를 왜 분리하는가"가 중요하며, 현대 Spring/Jakarta EE 환경에서는 패턴의 의도는 살리되 [Service](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) Locator 같은 레거시 기법은 [DI](/knowledge-base/studynote/11_design_supervision/10_patterns_antipatterns/190_enterprise_di_framework_lifecycle/) ([Dependency Injection](/knowledge-base/studynote/04_software_engineering/06_software_architecture/337_dependency_injection/))로 대체하는 판단이 필요하다.
...
| [DI](/knowledge-base/studynote/11_design_supervision/10_patterns_antipatterns/190_enterprise_di_framework_lifecycle/) ([Dependency Injection](/knowledge-base/studynote/04_software_engineering/06_software_architecture/337_dependency_injection/)) | [Service](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) Locator를 대체하는 현대적 의존성 관리 방식이다. |
