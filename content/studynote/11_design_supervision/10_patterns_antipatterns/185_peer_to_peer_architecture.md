...
기술사 답안에서는 P2P를 "무조건 혁신적"이라고 쓰기보다, <strong>확장성과 회복력을 얻는 대신 중앙 통제·보안·관측성을 더 어렵게 만든 패턴</strong>으로 표현하는 편이 정확하다. 그리고 실제 서비스는 순수 P2P보다 하이브리드 P2P가 훨씬 많다는 점까지 쓰면 현실성이 높아진다.
