...
실무에서 좋은 [DRS](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/626_drs_storage_mirroring/)/BCP는 문서가 두꺼운 체계가 아니라 실제로 훈련 가능한 체계다. 특히 모의 훈련은 책상 위 검토([Tabletop Exercise](/knowledge-base/studynote/09_security/13_secops_ir_forensics/660_tabletop_exercise/)), 기술 [failover](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/300_failover_architecture/) 시험, 전체 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 중단 가정 훈련으로 나누어 반복하는 것이 효과적이다. 이때 단순 전환 성공 여부뿐 아니라 선언 시간, 연락 체계, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 정합성, 복귀 절차까지 함께 측정해야 한다.
