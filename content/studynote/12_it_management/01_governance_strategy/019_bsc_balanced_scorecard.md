...
> 1. **본질**: [균형 성과 기록표](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)의 핵심은 재무, 고객, 내부 프로세스, 학습과 성장 4가지 관점의 균형 평가 모델라는 점에 있다. 이를 현장 의사결정에 연결하는 분석 프레임 구조로 이해하면 된다.
...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">균형 성과 기록표</div></div>
<div class="kb-diagram-connector">▼</div>
...
이 흐름은 '[균형 성과 기록표](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)'이라는 이름의 개념이 기술 하나를 설명하는 용어가 아니라, 경영 요구와 운영 통제를 잇는 중간 다리라는 점을 보여 준다.
...
따라서 시험 답안에서는 "무엇과 다르며 왜 같이 보아야 하는가"를 짝지어 말하는 것이 중요하다. 실무에서도 현재 문제가 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 정렬인지, 운영 절차인지, 보안 통제인지에 따라 [균형 성과 기록표](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)의 사용 위치가 달라진다.
...
1. 현재 문제를 [균형 성과 기록표](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)의 관점으로 봐야 할 이유가 분명한가?
...
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">균형 성과 기록표</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">전략 체계도</div></div>
...
← **이전**: [19. 균형 성과 기록표 (BSC, Balanced Scorecard) - 재무, 고객, 내부 프로세스, 학습과 성장 4가지 관점의 균형](/knowledge-base/studynote/12_it_management/01_governance_strategy/019_bsc/)
**다음**: [20. IT BSC - 기업 BSC를 IT 부서에 맞게 변형 (기업 공헌, 사용자 지향, 운영 탁월성, 미래 지향)](/knowledge-base/studynote/12_it_management/01_governance_strategy/020_it_bsc/) →
