...
과거 기업의 평가는 단순히 "얼마를 투자해서 얼마를 벌었나"라는 재무제표의 결과(결론)에만 의존했습니다. 그러나 기업이 시장에서 경쟁 우위(Competitive Advantage)를 확보하려면 제품이 기획되고 만들어져 팔리기까지의 **과정([Process](/knowledge-base/studynote/12_it_management/05_security_compliance/300_process/)) 내부**를 들여다보아야 했습니다.
- 1985년, 하버드 경영대학원의 마이클 포터(Michael Porter)는 기업의 일련의 활동을 마치 사슬(Chain)처럼 연결된 가치 창출의 단계로 정의하고, 각 사슬의 마디마다 창출되는 부가가치의 합이 기업의 이익(Margin)을 결정한다는 **'[가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/)'** 모델을 창안했습니다.
...
*   **입고 물류 (Inbound Logistics)**: 원자재를 받아 창고에 저장하고 분배. **▶ [WMS](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/097_wms_warehouse_management_system/)(창고관리), [SCM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/167_scm_software_configuration_management/) 융합**
*   **운영/생산 (Operations)**: 원자재를 최종 완제품으로 가공. **▶ [ERP](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/081_erp_enterprise_resource_planning/)(생산모듈), [MES](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/119_mes_manufacturing_execution_system/), [스마트 팩토리](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/166_smart_factory/) 융합**
*   **출고 물류 (Outbound Logistics)**: 완제품을 포장하여 도매상/고객에게 배송. **▶ [TMS](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/098_tms_transportation_management_system/)(운송관리), [SCM](/knowledge-base/studynote/12_it_management/04_sdlc_testing/167_scm_software_configuration_management/) 융합**
*   **마케팅 및 영업 (Marketing & Sales)**: 고객이 제품을 인지하고 구매하도록 유도. **▶ [CRM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/107_crm_customer_relationship_management/)(고객관계관리) 융합**
*   **[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) ([Service](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/))**: 제품 가치를 유지하기 위한 사후 관리(A/S), 환불. **▶ [CRM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/107_crm_customer_relationship_management/)([서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)모듈) 융합**
...
*   **조달/구매 (Procurement)**: 부품/[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 구매 플랫폼 체계. **▶ e-Procurement, [SRM](/knowledge-base/studynote/12_it_management/03_ea_isp/118_srm_service_reference_model/)(공급사관계관리) 융합**
*   **기술 개발 (Tech Development)**: 제품 개선 R&D 및 정보 시스템 구축. **▶ [PLM](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/122_plm_product_lifecycle_management/)(제품수명주기관리) 융합**
*   **인적 자원 관리 (HRM)**: 역량 강화. **▶ e-HR, HRIS 융합**
*   **기업 인프라 (Infrastructure)**: 전사적 관리. **▶ [ERP](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/081_erp_enterprise_resource_planning/)(재무/회계/기획), EIP(기업포털) 융합**
...
| :--- | :--- | :--- | :--- |
| **[가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) ([Value Chain](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/))** | 기업의 **내부 활동 프로세스** | "우리의 어떤 부서/활동이 비용을 유발하고, 어디서 차별적 마진을 창출하는가?" | 내부 역량을 진단하는 해부도로 활용 |
...
[가치 사슬 분석](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/)을 통해 모든 활동을 기업 내부에 품는 '수직적 통합(Vertical Integration)'을 시도할 수 있지만, 이는 거대한 고정 비용(Fixed Cost)과 조직의 경직성을 낳는 **최악의 트레이드오프**를 유발합니다.
- 현대 경영 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)은 [가치 사슬 분석](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/) 후, 자사가 압도적 경쟁 우위를 갖는 사슬(예: 애플의 '기술 개발'과 '마케팅')만 내재화(Core Competence)하고, 상대적으로 부가가치가 낮은 사슬(예: 폭스콘을 통한 '운영/생산' 및 물류)은 철저하게 **외부 아웃소싱([BPO](/knowledge-base/studynote/12_it_management/01_governance_strategy/044_bpo_business_process_outsourcing/), [Business Process Outsourcing](/knowledge-base/studynote/12_it_management/01_governance_strategy/044_bpo_business_process_outsourcing/))**으로 잘라내는 이른바 **'[가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/)의 해체(Deconstruction)'** [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)을 택합니다.
...
*   **[가치 사슬 분석](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/) ([Value Chain Analysis](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/)) 코어**
    ...
    *   **지원 활동 ([Support](/knowledge-base/studynote/14_data_engineering/02_math_mining/084_support_association_rule_transaction/) Activities)**
...
*   **[전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) 모델 생태계 ([Strategy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) Frameworks)**
    ...
    *   내부 역량: **[Value Chain](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/)**, VRIO 자원기반관점
...
| **지원활동 ([Support](/knowledge-base/studynote/14_data_engineering/02_math_mining/084_support_association_rule_transaction/) Activities)** | 기업 인프라·HR·기술개발·조달 — 주활동을 돕는 간접 가치 창출 활동 |
| **[ERP](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/081_erp_enterprise_resource_planning/) ([Enterprise Resource Planning](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/081_erp_enterprise_resource_planning/))** | [가치 사슬](/knowledge-base/studynote/12_it_management/05_security_compliance/249_value_chain_competitive_analysis/) 전 구간의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 단일 시스템으로 통합하여 가시성과 효율을 극대화하는 IT 백본 |
...
| **[전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)적 아웃소싱 ([BPO](/knowledge-base/studynote/12_it_management/01_governance_strategy/044_bpo_business_process_outsourcing/))** | [가치 사슬 분석](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/026_value_chain_analysis/) 결과 비핵심·비경쟁 구간을 외부에 위탁하는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)적 자원 배분 의사결정 |
