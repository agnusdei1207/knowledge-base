...
> **핵심 인사이트**
> 1. [[041_growth_hacking|그로스 해킹]]([[041_growth_hacking|Growth Hacking]])은 마케팅·제품·[[001_dikw_pyramid|데이터]] 분석을 통합해 급속 성장을 달성하는 IT 관리 [[268_strategy_pattern|전략]]으로, [[039_okr_objectives_key_results|OKR]](Objectives and [[067_db_key_uniqueness_minimality|Key]] Results)과 연동하면 측정 가능한 성장 목표를 체계적으로 달성할 수 있다.
> 2. AARRR 퍼널([[042_aarrr_funnel|Acquisition]] → Activation → [[515_mvcc|Retention]] → Referral → Revenue)의 각 단계에서 병목([[617_io_bottleneck|Bottleneck]])을 [[001_dikw_pyramid|데이터]]로 식별하고 실험을 통해 개선하는 것이 [[041_growth_hacking|그로스 해킹]]의 핵심이며, 이는 전통 마케팅의 직관 의존을 [[001_dikw_pyramid|데이터]] 기반 의사결정으로 대체한다.
> 3. IT 관리 관점에서 [[041_growth_hacking|그로스 해킹]]은 단순한 마케팅 기법이 아니라 제품 로드맵, [[018_kpi|KPI]] 체계, 팀 구조(그로스 팀)까지 조직 전체를 성장 중심으로 재편하는 경영 방법론이다.

---

## Ⅰ. [[041_growth_hacking|그로스 해킹]] 개념과 IT 관리 연계
...
> 📢 **섹션 요약 비유**: [[041_growth_hacking|그로스 해킹]]은 디지털 대항해 — OKR이라는 목적지를 정하고, [[001_dikw_pyramid|데이터]]가 나침반, A/B 테스트가 바람의 방향 [[396_validation|확인]].
...
> 📢 **섹션 요약 비유**: 그로스 팀은 제약회사 임상팀 — 제품 PM이 어떤 약 개발할지 결정하고, [[001_dikw_pyramid|데이터]] 분석가가 임상 결과 해석, 엔지니어가 약 제조.

---

## Ⅳ. [[001_dikw_pyramid|데이터]] 기반 의사결정 체계
...
> 📢 **섹션 요약 비유**: [[001_dikw_pyramid|데이터]] 스택은 자동차 계기판 — 속도계(DAU), 연료계([[108_ltv_life_time_value|LTV]]/CAC), GPS(코호트 분석)가 모두 보여야 정확한 드라이빙.

---

## Ⅴ. 실무 시나리오 — [[309_saas|SaaS]] 기업 성장 [[268_strategy_pattern|전략]]
...
> 📢 **섹션 요약 비유**: [[041_growth_hacking|그로스 해킹]]은 스타트업의 바다에서 빠른 항해 — 목적지([[039_okr_objectives_key_results|OKR]])를 정하고 실험(A/B)으로 가장 빠른 바람(병목 해결)을 찾아 돛을 올리는 것.
...
1. [[041_growth_hacking|그로스 해킹]]은 빠른 성장을 위한 [[001_dikw_pyramid|데이터]] 실험 — 어떤 가게가 더 손님을 많이 끌어들이는지 A 간판 vs B 간판을 직접 비교해보는 것!
...
← **이전**: [[042_aarrr_funnel|42. AARRR 퍼널 (Acquisition)]]
**다음**: [[043_it_outsourcing_ito_strategy|043. IT 아웃소싱 (ITO) 전략]] →
