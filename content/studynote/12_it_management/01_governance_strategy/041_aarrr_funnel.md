...
> 📢 **섹션 요약 비유**: AARRR은 고깔 모양 체 — 넓게 들어오고([Acquisition](/knowledge-base/studynote/12_it_management/01_governance_strategy/042_aarrr_funnel/)), 경험하고(Activation), 남고([Retention](/knowledge-base/studynote/05_database/04_transactions_concurrency/515_mvcc/)), 퍼뜨리고(Referral), 수익을 낸다(Revenue).
...
> 📢 **섹션 요약 비유**: [LTV](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/108_ltv_life_time_value/) > 3×CAC는 고기잡이 법칙 — 낚싯대 구입 비용(CAC)의 3배 이상 물고기([LTV](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/108_ltv_life_time_value/))를 잡아야 장사가 된다.
