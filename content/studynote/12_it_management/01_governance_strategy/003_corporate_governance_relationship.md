...
### 거버넌스(Governance) vs 매니지먼트([Management](/knowledge-base/studynote/12_it_management/05_security_compliance/372_management/))
IT 세계에서 가장 혼동되는 두 개념의 쇳덩어리 분리.

| 구분 | IT 거버넌스 ([IT Governance](/knowledge-base/studynote/12_it_management/01_governance_strategy/001_it_governance/)) | IT 관리 (IT [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/372_management/)) |
|:---|:---|:---|
...
관리([Management](/knowledge-base/studynote/12_it_management/05_security_compliance/372_management/))가 "시스템이 안 뻗게 잘 돌아가게(Doing things right)" 하는 것이라면, 거버넌스(Governance)는 "애초에 돈이 되는 올바른 시스템을 만들고 있는가(Doing the right things)"를 감시하는 상위 계층의 감독관이다.
