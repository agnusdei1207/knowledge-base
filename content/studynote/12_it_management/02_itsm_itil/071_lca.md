...
> 2. **가치**: 계층 [[083_relationship_in_er_model|관계]] 질의, 거리 계산, 트리 기반 알고리즘에서 자주 쓰인다.
...
트리에서 두 노드가 어디서 만나는지 알면 [[083_relationship_in_er_model|관계]]를 빠르게 계산할 수 있다.
...
- **📢 섹션 요약 비유**: 친척 [[083_relationship_in_er_model|관계]]의 공통 조상을 빨리 찾는 도구다.
...
LCA를 알면 트리 기반 [[083_relationship_in_er_model|관계]] 질의를 효율적으로 처리할 수 있다.
...
← **이전**: [[071_four_dimensions|71. 4차원 모델 (Four Dimensions of Service Management)]]
**다음**: [[072_service_desk|72. 서비스 데스크 (Service Desk)]] →
