...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">QA and QC across SDLC: prevention + detection</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Requirements ─ Design ─ Build ─ Test ─ Release ─ Operate</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">QA: standards, process, audit, training, review rules</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">── QC: inspection, test, defect measure, acceptance</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Feedback loop: QC data ──▶ root cause analysis ──▶ QA process improvement</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">품질 목표 정의</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">QA: 표준 · 절차 · 교육 · 감사</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">QC: 리뷰 · 테스트 · 검수 · 결함 측정</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">결함 데이터 · 고객 이슈 수집</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">원인 분석 · 프로세스 개선 · 지속적 품질 향상</div>
</div>
</div>
