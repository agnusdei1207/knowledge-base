...
> 3. **판단 포인트**: 핵심 트레이드오프는 **빌드 볼륨 vs 해상도(EOS M400-4: 400×400×400 mm / 100 μm vs ICON Vulcan: 11.5×4.5 m / 수 mm)**, **재료 선택(Ti-6Al-4V SLM 시 다공도 <0.1% 확보 vs Inconel 718 시 cracking 대응)**, **DfAM 성숙도(Topology Optimization + Lattice Gen + Multi-Object DO)**, **인-시튜 모니터링(Melt Pool IR, Layer Imaging) -> 인증(AS9100D, ISO 13485, KS B ISO/ASTM 52900)** 간의 균형점 설계가 기술사의 핵심 판단 영역이다.
