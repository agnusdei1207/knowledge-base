...
1990년대 GSM(2G) 시기에 유럽 ETSI가 유럽 단일 규격을 만든 것이 3GPP의 모태가 되었고, 2000년대 IEEE 802.11g(54Mbps) 보급으로 WLAN이 데이터 트래픽의 60% 이상을 흡수하면서, 모바일 오프로드·5G NR-U(Unlicensed)와 같은 **수직적·수평적 컨버전스**가 가속화되었다. 기술사 입장에서 ICT 표준화 전략은 **R&D 투자 회수, 시장 진입 시점(First-Mover), 지적재산권(IP) 포트폴리오**를 결정짓는 핵심 의사결정이다.
