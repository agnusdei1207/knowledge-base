...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: LwM2M은 **OMA(Open Mobile Alliance)**가 정의한 **[CoAP](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/120_coap_constrained_application_protocol/) 기반 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스 관리 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)**로, 디바이스의 **등록·[펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 업데이트(FOTA)·원격 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)·모니터링**을 표준화한다.
> 2. **가치**: [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스가 수만~수억 대로 확장되면 개별 관리가 불가능하므로, LwM2M 서버에서 **원격으로 디바이스 [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/)·[설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) 변경·[펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 업데이트**를 일괄 수행할 수 있다.
> 3. **판단 포인트**: LwM2M은 **Object/Resource 모델**로 센서 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(온도=3303/0/5700)를 표준화하며, CoAP의 경량성 + [DTLS](/knowledge-base/studynote/03_network/12_iot_wpan_edge/644_dtls_datagram_tls_coap_security/) 보안을 활용한다.
...
- **📢 섹션 요약 비유**: LwM2M은 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스의 **원격 리모컨 표준**이다. 수만 대의 센서를 한 곳(서버)에서 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)·업데이트·모니터링할 수 있다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[CoAP](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/120_coap_constrained_application_protocol/)** | LwM2M의 전송 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) |
...
| **[DTLS](/knowledge-base/studynote/03_network/12_iot_wpan_edge/644_dtls_datagram_tls_coap_security/)** | LwM2M의 보안 계층 |
| **OMA** | LwM2M 표준 제정 기관 |
...
2. 리모컨(서버)으로 로봇(디바이스)의 **[설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)을 바꾸거나 업데이트(FOTA)**할 수 있어요.
