...
> 3. **판단 포인트**: Mercedes Drive Pilot(고속도로 60km/h 이하)·Honda SENSING Elite가 최초 L3 양산이며, **Takeover 시간(최소 10초)**과 [Fallback](/knowledge-base/studynote/13_cloud_architecture/03_msa_serverless/129_fallback/)(안전 정차) 설계가 핵심이다.
...
L3는 **자율주행 책임 전환의 분기점**이며, ODD 정의·Takeover·[Fallback](/knowledge-base/studynote/13_cloud_architecture/03_msa_serverless/129_fallback/) 설계가 기술·법적 핵심이다.
...
| **ODD** | 운행 설계 영역 |
| **Takeover** | 전환 요청 |
| **[Fallback](/knowledge-base/studynote/13_cloud_architecture/03_msa_serverless/129_fallback/)** | 안전 정차 |
...
3. 운전자가 안 받으면 **자동으로 안전하게 멈춰요([Fallback](/knowledge-base/studynote/13_cloud_architecture/03_msa_serverless/129_fallback/))**!
