...
### [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 보안 취약점

| 취약점 | 설명 |
|:---|:---|
| **기본 비밀번호** | admin/admin, root/1234 |
| **업데이트 불가** | FOTA 미지원 |
| **리소스 제한** | 백신·[IDS](/knowledge-base/studynote/02_operating_system/10_security/601_ids_ips_syscall_tracing/) 설치 불가 |
| **장기 방치** | 설치 후 관리 없음 |

- **📢 섹션 요약 비유**: [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스는 잠금장치가 없는 자전거(기본 비밀번호)와 같다. 도둑(해커)이 쉽게 훔쳐서(감염) 범죄(DDoS)에 사용한다.

---

## Ⅲ. 비교 및 연결

| 비교 | 전통 [봇넷](/knowledge-base/studynote/03_network/19_frequent_topics_terms/990_botnet_cnc/) ([PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/)) | [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) [봇넷](/knowledge-base/studynote/03_network/19_frequent_topics_terms/990_botnet_cnc/) |
|:---|:---|:---|
| **대상** | [PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/)·서버 | **IP 카메라·공유기** |
| **규모** | 수천~수만 | **수십만** |
| **방어** | 백신 가능 | **리소스 제한** |
...
### [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) [봇넷](/knowledge-base/studynote/03_network/19_frequent_topics_terms/990_botnet_cnc/) 대응 방안
1. **기본 비밀번호 변경 의무화** (법률·표준).
2. **네트워크 세그먼테이션**: [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 전용 [VLAN](/knowledge-base/studynote/09_security/05_web_app_security/224_vlan_virtual_lan_broadcast_domain/) 분리.
3. **FOTA**: [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 자동 보안 업데이트.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **Mirai** | 2016년 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) DDoS [봇넷](/knowledge-base/studynote/03_network/19_frequent_topics_terms/990_botnet_cnc/) |
| **DDoS** | [봇넷](/knowledge-base/studynote/03_network/19_frequent_topics_terms/990_botnet_cnc/)의 주요 공격 목적 |
| **기본 비밀번호** | [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 최대 취약점 |
| **FOTA** | [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 원격 업데이트 (보안 패치) |
| **네트워크 세그먼테이션** | [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 트래픽 격리 |
