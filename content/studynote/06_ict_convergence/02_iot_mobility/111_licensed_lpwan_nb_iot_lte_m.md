...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: 면허 대역 LPWAN은 통신사가 보유한 **[LTE](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/752_lte_long_term_evolution_4g/) 면허 주파수 대역**을 활용하여 [NB-IoT](/knowledge-base/studynote/03_network/12_iot_wpan_edge/620_nbiot_narrowband_iot_lte_guardband/)(200kHz 협대역)와 [LTE-M](/knowledge-base/studynote/03_network/12_iot_wpan_edge/621_ltem_emtc_iot_mobility_voice/)(1.4MHz 광대역)으로 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스에 **통신사급 [QoS](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/)(품질 보장)**를 제공하는 [3GPP](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/751_3gpp_3rd_generation_partnership_project/) 국제 표준 기술이다.
> 2. **가치**: 비면허 [LPWAN](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/109_lpwan_low_power_wide_area_network/)([LoRa](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/)·[Sigfox](/knowledge-base/studynote/03_network/12_iot_wpan_edge/1030_lpwan_sigfox/))이 Best Effort인 반면, 면허 대역은 통신사 기지국 인프라를 그대로 활용하여 **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/) 보장·이동성([Handover](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/556_handover_handoff_types_concept/))·양방향 통신**이 가능하며 별도 GW 구축이 불필요하다.
...
|:---|:---|:---|
| **[3GPP](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/751_3gpp_3rd_generation_partnership_project/) Release** | Rel-13 (2016) | Rel-13 (2016) |
| **[대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)** | 200 kHz (협대역) | 1.4 MHz |
...
| **음성** | 미지원 | **[VoLTE](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/758_volte_voice_over_lte_sip_qos/) 지원** |
| **전력 절감** | PSM + eDRX | PSM + eDRX |
| **커버리지 확장** | MCL 164 dB (지하 침투) | MCL 156 dB |
| **적합 용도** | 고정 센서, 스마트 미터 | 이동 추적, 웨어러블 |

### 전력 절감 메커니즘
- **PSM ([Power](/knowledge-base/studynote/14_data_engineering/02_math_mining/069_type_1_2_error_statistical_power/) Saving Mode)**: 통신 완료 후 모듈을 완전히 꺼서 수 μA 수준으로 대기.
...
| **[QoS](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/)** | Best Effort | **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/) 보장** | **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/) 보장** |
| **이동성** | 제한 | 제한 | **[Handover](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/556_handover_handoff_types_concept/)** |
| **비용** | GW 자체 구축 | 월정액 | 월정액 |
| **음성** | 불가 | 불가 | **[VoLTE](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/758_volte_voice_over_lte_sip_qos/)** |
...
|:---|:---|:---|:---|
| [QoS](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/) | Best Effort | **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/) 보장** | [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) 확보 |
| 인프라 구축 | 자체 GW 필요 | **통신사 전국망** | 즉시 사용 |
| 이동성 | 제한 | **[Handover](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/556_handover_handoff_types_concept/) ([LTE-M](/knowledge-base/studynote/03_network/12_iot_wpan_edge/621_ltem_emtc_iot_mobility_voice/))** | 이동 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 가능 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[NB-IoT](/knowledge-base/studynote/03_network/12_iot_wpan_edge/620_nbiot_narrowband_iot_lte_guardband/)** | 200kHz 협대역 면허 [LPWAN](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/109_lpwan_low_power_wide_area_network/), 고정 센서 |
| **[LTE-M](/knowledge-base/studynote/03_network/12_iot_wpan_edge/621_ltem_emtc_iot_mobility_voice/) (Cat-M1)** | 1.4MHz 면허 [LPWAN](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/109_lpwan_low_power_wide_area_network/), 이동+음성 |
| **PSM / eDRX** | 면허 LPWAN의 극저전력 메커니즘 |
| **[5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/) RedCap (Rel-17)** | [NB-IoT](/knowledge-base/studynote/03_network/12_iot_wpan_edge/620_nbiot_narrowband_iot_lte_guardband/)·[LTE](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/752_lte_long_term_evolution_4g/)-M의 [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/) 통합 후계자 |
