...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)의 3요소는 **①물리적 개체(Physical Entity)**, **②가상 모델(Virtual Model)**, **③연결(Connection)**이며, 이 삼각 구조가 [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)의 정의 그 자체이다.
> 2. **가치**: 물리 개체만 있으면 단순 설비이고, 가상 모델만 있으면 단순 시뮬레이션이지만, **실시간 양방향 연결**이 있어야 비로소 [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)이 되어 **예측·최적화·자율 제어**가 가능하다.
> 3. **판단 포인트**: 연결의 핵심은 **[IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 센서(물리→디지털)**와 **액추에이터(디지털→물리)**의 **양방향 [피드백 루프](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/005_feedback_loop/)**이며, [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/)·Edge Computing이 실시간성을 보장한다.
...
- **📢 섹션 요약 비유**: 3요소는 **거울(가상)·사람(물리)·빛(연결)**이다. 빛이 없으면 거울에 아무것도 비치지 않는다.
...
| **연결** | 양방향 실시간 | **[IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/)·[5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/)·Edge** |
...
| Level 3 | **예측 ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 기반 고장 예측)** |
...
|:---|:---|:---|:---|
| **물리 연결** | 없음 | 없음 | **실시간** |
| **[AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 예측** | 없음 | 제한적 | **있음** |
| **양방향** | 없음 | 없음 | **있음** |
...
3요소의 **양방향 실시간 연결**이 [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)의 핵심이며, [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/)·Edge·AI의 발전으로 Level 4(자율)까지 진화하고 있다.
...
| **[CPS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/167_cps_cyber_physical_system/)** | [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)의 이론적 기반 |
| **[OPC UA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/631_opc_ua_smart_factory_protocol/)** | 산업용 표준 통신 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) |
