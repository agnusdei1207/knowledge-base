...
> 2. **가치**: L3는 운전자가 항상 대기해야 하지만, L4는 **해당 ODD 내에서 완전 무인**이므로 로보택시·무인 셔틀·무인 배달이 가능하다.
...
- **📢 섹션 요약 비유**: L4는 **특정 노선의 무인 셔틀**이다. 정해진 구간에서는 완벽하지만, 구간 밖은 못 간다.

---

## Ⅱ~Ⅴ. 결론

L4는 **로보택시·무인 배달의 현실**이며, ODD 확장과 규제 정비가 대중화의 핵심이다.
...
### 👶 어린이를 위한 3줄 비유 설명
1. L4는 **정해진 구간의 무인택시**예요. 운전자가 **전혀 필요 없어요**!
