...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: V-[SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/)(Visual [SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/))은 **카메라 영상만으로 특징점을 추출·매칭하여 3D 지도를 작성하면서 동시에 카메라 위치를 추정**하는 기술이며, XR 헤드셋(Quest·Vision Pro)의 Inside-Out 트래킹 핵심이다.
> 2. **가치**: [LiDAR](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/140_lidar_light_detection_and_ranging_tof/) [SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/) 대비 **저비용(카메라만)·경량·소비 전력↓**이며, 스마트폰·AR 글래스·드론에 탑재 가능하다. 단, 조명·텍스처 부족 환경에서 정확도가 떨어질 수 있다.
...
- **📢 섹션 요약 비유**: V-SLAM은 **사진만 보고 방의 3D 지도를 그리면서 내 위치를 파악**하는 것이다.
...
| **[Direct](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/176_direct_addressing/)** | 픽셀 밝기 직접 비교 | LSD-[SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/) |
| **[Learning](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/240_switch_learning_forwarding_flooding/)** | DL 기반 깊이·포즈 | DROID-[SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/) |

---

## Ⅲ~Ⅴ. 결론

V-SLAM은 **XR·로봇·드론의 공간 인식 표준 기술**이며, VIO(카메라+IMU) 융합이 실시간 정밀도의 핵심이다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **V-[SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/)** | 카메라 기반 [SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/) |
| **ORB-[SLAM](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/131_slam_simultaneous_localization_mapping/)** | Feature-based 대표 |
| **VIO** | 카메라+IMU 융합 |
| **루프 클로징** | 재방문 시 오차 보정 |
