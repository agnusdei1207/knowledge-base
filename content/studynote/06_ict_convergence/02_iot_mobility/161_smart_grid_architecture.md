...
스마트 그리드는 기존 전력망의 물리 인프라 위에 센서, 통신망, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석, 자동 제어 기능을 얹어 공급자와 소비자가 양방향으로 연결되는 전력망이다. 전통적인 전력망은 발전소에서 전기를 보내고 소비자는 받기만 하는 [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) 구조에 가까웠다. 이 구조는 대규모 중앙 발전에는 적합했지만, 수요 변화와 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 자원 증가에 민감하게 대응하기 어려웠다.
...
스마트 그리드의 핵심은 전력 계통과 정보 계통이 겹쳐서 움직인다는 점이다. 현장에서는 스마트 미터가 사용량과 [전압](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/001_voltage/) 상태를 측정하고, 통신망은 이를 중앙 시스템으로 보내며, 운영 시스템은 분석 결과를 바탕으로 요금 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)나 제어 명령을 다시 내려보낸다. 이때 고급 계량 인프라 ([AMI](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/), [Advanced Metering Infrastructure](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/)), [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 에너지 자원 (DER, Distributed Energy Resource), [ESS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/164_ess_energy_storage_system/), 전기차 충전기, 배전 자동화 시스템이 주요 구성 요소가 된다.
...
| 구성 요소 | 역할 | 핵심 포인트 |
| :--- | :--- | :--- |
| 스마트 미터 | 세대·설비 단위 사용량 측정 | 시간대별 정밀 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 수집 |
| [AMI](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/) | 원격 검침과 양방향 통신 | 요금 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/), 원격 개폐, 검침 자동화 |
| [ESS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/164_ess_energy_storage_system/) | 전력 저장과 피크 완화 | 충방전 [스케줄](/knowledge-base/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/) 최적화 |
...
스마트 그리드의 경계는 기존 전력망과 비교할 때 가장 분명해진다. 기존 전력망은 중앙 발전과 수동 운영에 최적화되어 있어, 대규모 공급 안정성에는 강하지만 세밀한 수요 대응과 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 자원 통합에는 약하다. 반면 스마트 그리드는 실시간 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)와 자동 제어를 통해 계통 운영을 더 유연하게 만들지만, 그만큼 통신·보안·표준화 부담이 커진다.

| 항목 | 기존 전력망 | 스마트 그리드 |
| :--- | :--- | :--- |
| 전력 흐름 | 주로 [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) | 양방향 가능 |
| 정보 수집 | 주기적·[지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)성 큼 | 실시간 또는 준실시간 |
| 수요 대응 | 제한적 | [DR](/knowledge-base/studynote/03_network/07_network_layer_routing/360_ospf_dr_bdr_designated_router_lsa_flooding/), 실시간 요금, 원격 제어 |
| [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 자원 수용 | 낮음 | 높음 |
...
1. [AMI](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 과금뿐 아니라 부하 예측과 고장 대응에도 쓰이는가?
2. [ESS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/164_ess_energy_storage_system/), 태양광, [EV](/knowledge-base/studynote/12_it_management/04_sdlc_testing/154_ev_earned_value/) 충전 설비를 같은 운영 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 안에서 조정할 수 있는가?
3. 통신 장애가 발생해도 전력 설비는 안전하게 동작하는가?
4. 스마트 미터 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 보안·프라이버시 [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/) 대책이 있는가?
5. 표준 프로토콜과 장비 [상호운용성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/287_interoperability_tactics/)이 확보되어 있는가?
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [AMI](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/) ([Advanced Metering Infrastructure](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/)) | 스마트 그리드의 계측·통신 기반 |
| [DR](/knowledge-base/studynote/03_network/07_network_layer_routing/360_ospf_dr_bdr_designated_router_lsa_flooding/) (Demand Response) | 가격 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)와 제어를 통한 수요 조정 |
| [ESS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/164_ess_energy_storage_system/) ([Energy Storage System](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/164_ess_energy_storage_system/)) | 피크 저감과 재생에너지 보완 수단 |
| DER (Distributed Energy Resource) | [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)형 발전 자원의 계통 연계 |
| [마이크로그리드](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/163_microgrid_island_mode/) ([Microgrid](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/163_microgrid_island_mode/)) | 지역 단위 자율 운영이 가능한 확장 형태 |
...
← **이전**: [160. UWB (Ultra-Wideband / 초광대역) 통신 - 매우 짧은 임펄스(Impulse) 신호를 넒은 주파수에 걸쳐 송신,](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/160_uwb_ultra_wideband/)
**다음**: [162. AMI (Advanced Metering Infrastructure) - 지능형 원격 검침 인프라](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/162_ami_advanced_metering_infrastructure/) →
