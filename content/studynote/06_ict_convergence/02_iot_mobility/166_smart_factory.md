...
> 1. **본질**: 스마트 팩토리 (Smart Factory)는 센서, 제어기, 생산관리 시스템, [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/) ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/), [Artificial Intelligence](/knowledge-base/studynote/10_ai/01_ai_basics/001_artificial_intelligence/))을 연결해 공장의 상태를 실시간으로 보고 스스로 조정하는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 기반 제조 체계다.
> 2. **가치**: 단순 자동화를 넘어 다품종 소량생산, 품질 추적, 예지보전, 에너지 최적화를 동시에 지원하므로 제조 경쟁력과 운영 탄력성을 함께 높인다.
> 3. **판단 포인트**: 설비만 연결한다고 스마트 팩토리가 완성되는 것은 아니며, 운영기술 ([OT](/knowledge-base/studynote/09_security/18_iot_ot_physical/891_ot_operational_technology/), [Operational Technology](/knowledge-base/studynote/09_security/18_iot_ot_physical/891_ot_operational_technology/))과 정보기술 (IT, Information Technology)의 통합, 표준 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/), 보안, 현장 프로세스 혁신이 함께 따라와야 성과가 난다.
...
| 계층 | 대표 기술 | 역할 | 핵심 포인트 |
| :--- | :--- | :--- | :--- |
| 현장 계층 | 센서, 액추에이터, 로봇, 자동반송차 (AMR, Autonomous Mobile Robot) | 상태 수집과 실제 동작 수행 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 정확도, 설비 연결성 |
| 제어 계층 | [PLC](/knowledge-base/studynote/09_security/18_iot_ot_physical/896_plc_programmable_logic_controller/), 분산제어시스템 ([DCS](/knowledge-base/studynote/09_security/18_iot_ot_physical/895_dcs_distributed_control_system/), [Distributed Control System](/knowledge-base/studynote/09_security/18_iot_ot_physical/895_dcs_distributed_control_system/)), 감시제어시스템 ([SCADA](/knowledge-base/studynote/09_security/18_iot_ot_physical/894_scada/), Supervisory Control and [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [Acquisition](/knowledge-base/studynote/12_it_management/01_governance_strategy/042_aarrr_funnel/)) | 실시간 제어와 모니터링 | 지연시간, 안정성 |
| 운영 계층 | [MES](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/119_mes_manufacturing_execution_system/), 품질관리시스템 (QMS, Quality [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/) System) | 공정 추적, 작업지시, 이력 관리 | 표준 [데이터 모델](/knowledge-base/studynote/05_database/01_db_architecture_relational/014_data_model_components/) |
...
스마트 팩토리를 이해하려면 전통적 공장 자동화와 비교하는 것이 가장 쉽다. 자동화 공장은 반복 작업을 빠르게 수행하는 데 강하지만, 조건 변화에 대한 적응력은 낮다. 반면 스마트 팩토리는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 수집과 분석을 바탕으로 공정 조건, 유지보수 시점, 생산 순서를 동적으로 바꿀 수 있어 유연성이 크다.

| 항목 | 전통적 자동화 공장 | 스마트 팩토리 |
| :--- | :--- | :--- |
| 목표 | 반복 작업 자동화 | 실시간 최적화와 자율 조정 |
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 활용 | 설비 단위 국소 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | 공장 전체 통합 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) |
...
- **적용 방식**: 압력·온도·진동 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 실시간 수집하고, 엣지 분석으로 이상 패턴을 감지해 작업속도와 설비 조건을 자동 조정한다.
...
3. 생산망은 가용성과 보안이 동시에 중요하므로 [망분리](/knowledge-base/studynote/12_it_management/05_security_compliance/182_network_separation_model/), [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/), 패치 정책을 함께 설계한다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| 제조 실행 시스템 ([MES](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/119_mes_manufacturing_execution_system/), [Manufacturing Execution System](/knowledge-base/studynote/07_enterprise_systems/02_erp_systems/119_mes_manufacturing_execution_system/)) | 생산지시와 공정 이력의 중심 시스템 |
| 감시제어시스템 ([SCADA](/knowledge-base/studynote/09_security/18_iot_ot_physical/894_scada/), Supervisory Control and [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [Acquisition](/knowledge-base/studynote/12_it_management/01_governance_strategy/042_aarrr_funnel/)) | 설비 상태 감시와 제어를 담당 |
| 사이버 물리 시스템 ([CPS](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/167_cps_cyber_physical_system/), Cyber-Physical System) | 디지털 제어와 물리 설비를 연결하는 개념 |
| [디지털 트윈](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/) ([Digital Twin](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/126_digital_twin_concept/)) | 공정 상태를 가상 공간에서 분석·시뮬레이션 |
| 프라이빗 [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/) | 이동 설비와 고신뢰 무선 연결 지원 |
