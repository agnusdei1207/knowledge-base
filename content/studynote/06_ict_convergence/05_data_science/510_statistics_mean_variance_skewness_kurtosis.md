...
> 1. **본질**: [기술 통계](/knowledge-base/studynote/16_bigdata/05_analysis/100_descriptive_statistics/)([Descriptive Statistics](/knowledge-base/studynote/16_bigdata/05_analysis/100_descriptive_statistics/))는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 중심(Central Tendency), 산포(Spread), 형태(Shape)를 네 가지 척도로 압축한다.
> 2. **가치**: 같은 평균·[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)을 가진 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)도 분포 형태가 다를 수 있음을 애스컴 4중주(Anscombe's Quartet)가 증명 — [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/) 없는 요약 통계는 맹점을 낳는다.
> 3. **판단 포인트**: [왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)([Skewness](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)) > 1이면 변환([로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)·제곱근) 고려, 첨도(Kurtosis) > 3이면 두꺼운 꼬리([Fat](/knowledge-base/studynote/02_operating_system/09_file_system/525_fat_file_allocation_table/) Tail) 위험 관리 필요.

---

## Ⅰ. 개요 및 필요성

[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 처음 마주쳤을 때 가장 먼저 하는 작업이 [기술 통계](/knowledge-base/studynote/16_bigdata/05_analysis/100_descriptive_statistics/)다. 수천만 행을 몇 개의 숫자로 축약해 "이 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 어떻게 생겼는가"를 파악한다.

### 중심 경향 척도 (Central Tendency)

| 척도 | 정의 | 강점 | 약점 |
|:---|:---|:---|:---|
| 평균 (Mean) | Σxᵢ / n | 수학적 처리 용이 | 이상값([Outlier](/knowledge-base/studynote/14_data_engineering/02_math_mining/076_outlier_detection_iqr_dbscan_isolation_forest/))에 민감 |
| 중앙값 (Median) | 정렬 후 중앙 값 | 이상값에 강건(Robust) | 수학적 활용 제한 |
| 최빈값 (Mode) | 가장 자주 나타나는 값 | 범주형 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 적합 | 다봉 분포에서 복수 존재 |

**실무 판단**: 소득·주택가격처럼 우편향(Right-Skewed) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 중앙값이 대표성 높다.
...
| 척도 | 공식(표준화) | 해석 |
|:---|:---|:---|
| [왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/) ([Skewness](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)) | E[(X−μ)³] / σ³ | 0: 대칭, >0: 우편향, <0: 좌편향 |
| 첨도 (Kurtosis) | E[(X−μ)⁴] / σ⁴ | 정규=3, 초과 첨도=K−3: >0이면 두꺼운 꼬리 |

- **📢 섹션 요약 비유**: 산포는 선수들의 실력 편차고, [왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)는 "잘하는 선수가 더 많냐 못하는 선수가 더 많냐"의 기울어짐, 첨도는 "중간 실력 선수가 대부분이고 극단만 있냐(뾰족)"를 나타낸다.
...
|:---|:---|:---|
| 이상값 민감도 | 높음 | 낮음 |
| 활용 | 모델 학습, [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/) | [EDA](/knowledge-base/studynote/12_it_management/02_itsm_itil/064_eda/), 박스플롯 |
...
- 첨도 > 3 (두꺼운 꼬리): 금융 [리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/) 모델에서 VaR(Value at [Risk](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/)) 과소 추정 위험.

- **📢 섹션 요약 비유**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분석은 환자 혈액검사와 같다. 평균 혈당만 봐서는 안 되고, 얼마나 들쭉날쭉한지([분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)), 고혈당 쪽으로 치우쳤는지([왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)), 극단값이 자주 나타나는지(첨도)까지 종합 판단해야 한다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| 평균/중앙값 | 이상값 탐지, 편향 분석 · [EDA](/knowledge-base/studynote/12_it_management/02_itsm_itil/064_eda/) 1단계 |
| [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)/표준편차 | [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/), Z-Score · 표준화, [가설 검정](/knowledge-base/studynote/08_algorithm_stats/08_stats/145_hypothesis_testing/) |
| IQR | 박스플롯, Tukey 방법 · 이상값 제거 |
| [왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/) | [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 변환, 비모수 검정 · 전처리 판단 |
| 첨도 | 꼬리 [리스크](/knowledge-base/studynote/11_design_supervision/02_architecture_principles/096_risk_non_risk_architecture_evaluation_flaws/), [Fat](/knowledge-base/studynote/02_operating_system/09_file_system/525_fat_file_allocation_table/) Tail · 금융·보험 모델 |
...
2. [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)은 친구들의 키가 얼마나 들쭉날쭉한지를 나타내고, [왜도](/knowledge-base/studynote/14_data_engineering/02_math_mining/064_skewness_kurtosis_log_transformation/)는 키가 큰 쪽으로 몰렸는지 작은 쪽으로 몰렸는지를 알려줘.
