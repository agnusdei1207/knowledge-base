...
| 연결 관점 | [다중 공선성](/knowledge-base/studynote/14_data_engineering/02_math_mining/080_multicollinearity_vif_variance_inflation_factor_regression/)를 배경으로 [로지스틱 회귀](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/227_logistic_regression_clt_pvalue_type_error/)로 확장된다 | 독립 운영은 쉬우나 구조 확장성은 제한될 수 있다 |

또한 [다중 공선성](/knowledge-base/studynote/14_data_engineering/02_math_mining/080_multicollinearity_vif_variance_inflation_factor_regression/)는 왜 이 주제가 등장했는지 보여 주는 선행 개념이고, [로지스틱 회귀](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/227_logistic_regression_clt_pvalue_type_error/)는 실제 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 확장 또는 세부 기술로 이어지는 인접 개념이다. 시험 답안에서는 이런 연결선을 함께 말해야 현재 개념의 위치가 살아난다.
...
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">로지스틱 회귀</div></div>
...
이 흐름도는 [다중 공선성](/knowledge-base/studynote/14_data_engineering/02_math_mining/080_multicollinearity_vif_variance_inflation_factor_regression/)에서 출발해 현재 개념을 거쳐 [로지스틱 회귀](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/227_logistic_regression_clt_pvalue_type_error/)와 실시간 분석 방향으로 확장되는 학습 흐름을 보여 준다. 즉, 현재 개념은 독립된 섬이 아니라 앞 개념의 문제를 받아 다음 단계의 설계 선택으로 넘겨 주는 연결 고리다.
...
← **이전**: [329. 다중 공선성 (Multicollinearity)](/knowledge-base/studynote/06_ict_convergence/05_data_science/329_multicollinearity_vif/)
**다음**: [331. 로지스틱 회귀 (Logistic Regression)](/knowledge-base/studynote/06_ict_convergence/05_data_science/331_logistic_regression/) →
