...
> 1. **본질**: [중심 극한 정리](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/)([CLT](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/), Central Limit Theorem)는 "모집단 분포가 무엇이든 표본 크기 n ≥ 30이면 표본 평균이 [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/)에 수렴한다"는 통계 추론의 이론적 토대다.
> 2. **가치**: [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)(Law of Large Numbers)은 실험을 반복할수록 경험 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)이 이론 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)에 수렴함을 보장 — [머신러닝](/knowledge-base/studynote/10_ai/03_llm_nlp/241_machine_learning_basics/) 배치 학습, 보험 수리의 근거.
> 3. **판단 포인트**: [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/) 가정이 성립하면 Z-Score와 t-통계량으로 추론할 수 있으나, 극단값이 많은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 이항·포아송 분포를 별도 검토해야 한다.

---

## Ⅰ. 개요 및 필요성

통계적 추론의 대부분은 "[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/)를 따른다"는 가정 위에 세워진다. 그 가정이 왜 합리적인지를 설명하는 것이 CLT이고, CLT가 작동하는 전제 조건을 보증하는 것이 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)이다.

### [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/) (Normal / Gaussian Distribution)
...
### 약한 vs 강한 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)
...
- **📢 섹션 요약 비유**: 약한 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)은 "동전 던지기 많이 하면 앞면이 거의 50%가 될 것 같다"이고, 강한 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)은 "반드시 50%에 가까워진다"는 더 확실한 약속이야.
...
CLT와 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)은 통계적 추론의 정당성을 부여하며 [머신러닝](/knowledge-base/studynote/10_ai/03_llm_nlp/241_machine_learning_basics/)·A/B 테스트·품질 관리 전 분야에 걸쳐 활용된다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/) | Z-Score, [신뢰 구간](/knowledge-base/studynote/08_algorithm_stats/08_stats/146_confidence_interval/) · [가설 검정](/knowledge-base/studynote/08_algorithm_stats/08_stats/145_hypothesis_testing/), 이상값 탐지 |
| [CLT](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/) | 표본 평균 분포, A/B 테스트 · 통계 추론 기반 |
| [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/) | [기댓값](/knowledge-base/studynote/08_algorithm_stats/08_stats/135_expected_value/) 수렴, Monte Carlo · 시뮬레이션, 보험 수리 |
| t-분포 | 소표본 검정 · n<30 추론 |
...
1. 주사위를 많이 던질수록 각 숫자가 나오는 횟수가 점점 똑같아져 — 이게 [대수의 법칙](/knowledge-base/studynote/14_data_engineering/02_math_mining/074_law_of_large_numbers_lln_convergence_probability/)이야.
2. 그리고 주사위 여러 개를 동시에 던져서 평균을 내면, 그 평균은 항상 종 모양 분포가 돼 — 이게 [중심 극한 정리](/knowledge-base/studynote/08_algorithm_stats/08_stats/139_clt/)야.
3. [정규 분포](/knowledge-base/studynote/08_algorithm_stats/08_stats/138_normal_distribution/)는 그 종 모양의 공식 이름이고, 중간이 가장 많고 양 끝으로 갈수록 드물어지는 모양이야!
