...
**연속 배치(Continuous [Batching](/knowledge-base/studynote/05_database/06_dw_olap_trends/389_bulk_insert_batching_optimization/))**
...
**Tensor Parallelism(텐서 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/))**: 단일 레이어의 행렬을 여러 GPU에 열(Column)/행(Row) 분할
...
**[Pipeline](/knowledge-base/studynote/12_it_management/02_itsm_itil/082_pipeline/) Parallelism(파이프라인 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/))**: 레이어 그룹을 GPU에 순차 배분
...
4. **[LoRA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/) 서빙**: vLLM의 Punica 확장으로 다중 [LoRA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/) [어댑터](/knowledge-base/studynote/04_software_engineering/04_testing_quality/259_adapter_pattern_interface_wrapper/) 동시 서빙 가능
