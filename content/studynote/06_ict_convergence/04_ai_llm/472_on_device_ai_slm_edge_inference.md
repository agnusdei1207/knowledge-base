...
> 1. **본질**: 온디바이스 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/)([On-Device AI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/635_on_device_ai/))는 클라우드 없이 스마트폰·[PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/)·[IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 디바이스에서 직접 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 추론을 실행하며, [SLM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/313_slm/)([Small Language Model](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/313_slm/), 소형 언어 모델)과 모델 경량화 기술이 이를 가능하게 한다.
> 2. **가치**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 디바이스를 벗어나지 않아 프라이버시가 보장되고, 네트워크 없이도 동작하며, 클라우드 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 비용과 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)([Latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/))이 제거된다.
> 3. **판단 포인트**: [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)([Quantization](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)) INT4는 모델 크기를 75% 줄이지만 정확도 손실이 발생하므로, 배터리·발열·정확도 요구사항을 함께 고려한 최적화 조합을 선택해야 한다.
...
| 모델 | 파라미터 | 개발사 | 특징 |
|:---:|:---:|:---:|:---|
| Phi-3 Mini | 3.8B | Microsoft | 교과서 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 고품질 학습 |
| Gemma 2B | 2B | Google | Android/Chrome 온디바이스 |
| Llama 3.2 3B | 3B | Meta | [멀티모달](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/158_multimodal_clip_vision_audio_encoding/) 지원, 엣지 특화 |
...
|:---:|:---:|:---:|:---:|
| INT8 [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/) | 50% | 낮음 | ✗ |
| INT4 [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/) | 75% | 중간 | ✗ |
| 구조적 프루닝 | 30~50% | 중간 | ✓ |
| [지식 증류](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/252_knowledge_distillation_quantization_edge_slm_diffusion/) | 40~80% | 낮음 | ✓ |

- **📢 섹션 요약 비유**: [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)는 백과사전을 요약본으로 만들고, 증류는 전문가의 지식을 신입에게 전수하는 것이다.

---

## Ⅲ. 비교 및 연결

### [NPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/)([Neural Processing Unit](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/)) 칩 가속
...
| 항목 | 온디바이스 | 클라우드 |
|:---:|:---:|:---:|
| [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)([Latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/)) | 낮음([10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)~50ms) | 높음(500ms~2s) |
| 프라이버시 | 높음 | 중간~낮음 |
| 비용 | [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 배포 비용 | 사용량 기반 |
| [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) | 제한적 | 무제한 |
| 오프라인 | 가능 | 불가 |
...
온디바이스 AI와 SLM은 AI의 민주화와 프라이버시 보호를 동시에 실현한다. [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)·프루닝·[지식 증류](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/252_knowledge_distillation_quantization_edge_slm_diffusion/)의 조합으로 7B 이하 모델이 스마트폰에서 실질적인 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 제공하게 됐으며, [NPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/) 하드웨어의 발전과 함께 엣지 AI의 활용 범위가 급격히 확대되고 있다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [SLM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/313_slm/)([Small Language Model](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/313_slm/)) | 온디바이스 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) · 7B 이하 소형 언어 모델 |
| [양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)([Quantization](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)) | 경량화 기법 · INT4/INT8 [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/) 축소 |
| [지식 증류](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/252_knowledge_distillation_quantization_edge_slm_diffusion/) | 경량화 기법 · 교사-학생 모델 학습 |
| [NPU](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/424_npu/) | 하드웨어 · [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 연산 전용 칩 |
...
2. 책을 요약본으로 만들고([양자화](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/)), 불필요한 부분을 지우고(프루닝), 선생님이 학생에게 가르치듯(증류) 크기를 줄여요.
