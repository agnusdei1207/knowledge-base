...
한국 정부는 「디지털 전환 추진에 관한 기본법」(2022.9 시행)을 통해 DX를 국가 전략으로 채택하고, 「지능형 정부 기본계획(2023~2027)」, 「데이터 산업법」, 「AI 기본법」(2025.1 시행) 등을 통해 법적·제도적 기반을 마련하고 있다. 기술사 관점에서는 이러한 정책적 흐름을 이해하고, 산업별·도메인별 특성을 반영한 **융합 아키텍처 설계 역량**이 요구된다.
