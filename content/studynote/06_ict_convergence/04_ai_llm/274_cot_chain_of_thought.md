...
| 연결 관점 | [생각의 사슬](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/273_zero_few_shot_learning/)를 배경으로 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)로 확장된다 | 독립 운영은 쉬우나 구조 확장성은 제한될 수 있다 |

또한 [생각의 사슬](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/273_zero_few_shot_learning/)는 왜 이 주제가 등장했는지 보여 주는 선행 개념이고, [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)는 실제 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 확장 또는 세부 기술로 이어지는 인접 개념이다. 시험 답안에서는 이런 연결선을 함께 말해야 현재 개념의 위치가 살아난다.
...
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">환각</div></div>
...
이 흐름도는 [생각의 사슬](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/273_zero_few_shot_learning/)에서 출발해 현재 개념을 거쳐 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)와 [멀티모달](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/158_multimodal_clip_vision_audio_encoding/) 방향으로 확장되는 학습 흐름을 보여 준다. 즉, 현재 개념은 독립된 섬이 아니라 앞 개념의 문제를 받아 다음 단계의 설계 선택으로 넘겨 주는 연결 고리다.
...
← **이전**: [273. 생각의 사슬 (CoT, Chain-of-Thought)](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/273_zero_few_shot_learning/)
**다음**: [275. 환각 (Hallucination / 할루시네이션)](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/) →
