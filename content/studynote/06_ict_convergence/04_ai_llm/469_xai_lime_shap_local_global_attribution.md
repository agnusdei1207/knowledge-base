...
> 2. **가치**: [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/)(Local Interpretable Model-agnostic Explanations)은 개별 예측을, [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/)([SHapley Additive exPlanations](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/))은 게임 이론으로 각 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)의 공정한 기여도를 산출한다.
> 3. **판단 포인트**: EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act 등 규제 환경에서 의료·금융·법적 의사결정 시스템은 설명 가능성이 법적 의무이므로 [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/) 기법 선택이 시스템 설계의 핵심 조건이다.
...
### [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/) vs [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) 비교

| 항목 | [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/) | [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) |
|:---:|:---:|:---:|
| 이론 기반 | 국소 선형 근사 | 게임 이론(Shapley Value) |
| [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 보장 | ✗ (불안정) | ✓ (공리 보장) |
| 계산 비용 | 낮음 | 높음(TreeSHAP 제외) |
| 전역 해석 | ✗ | ✓ ([SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) 집계) |
| 주요 구현 | [lime](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/) [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) | [shap](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) |
...
### 모델 종류에 따른 [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) 최적화
...
XAI는 AI의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 신뢰를 동시에 달성하는 다리 역할을 한다. LIME은 빠른 국소 설명, SHAP은 이론적으로 엄밀한 기여도 분해를 제공한다. 규제 강화 트렌드와 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리 요구 속에서 XAI는 선택이 아닌 필수 엔지니어링 요소가 되고 있다.

향후 [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) 해석을 위한 Attention [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 분석, Probing 기법과 XAI의 통합이 중요 연구 방향이다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/) | [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/) 국소 · 국소 선형 근사 설명 |
| [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) | [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/) 국소/전역 · 게임 이론 기반 공정 기여도 |
| Shapley Value | [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/) 기반 · 협동 게임 이론 |
| [Feature Importance](/knowledge-base/studynote/10_ai/05_data_science_ml/355_random_forest_feature_importance/) | 전역 해석 · 전체 모델 수준 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 기여도 |
| EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act | 규제 · [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/) 법적 의무화 근거 |
