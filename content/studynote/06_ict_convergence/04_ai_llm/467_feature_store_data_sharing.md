...
> 1. **본질**: [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)([Feature Store](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/))는 여러 명의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 과학자가 각자 파이썬으로 땀 흘려 가공해 낸 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)(Feature, 특징 변수)들을 한 곳에 모아두고 언제든 꺼내 쓸 수 있게 만든 전사적 차원의 '[머신러닝](/knowledge-base/studynote/10_ai/03_llm_nlp/241_machine_learning_basics/) 반찬 가게(중앙 저장소)'다.
> 2. **가치**: 추천팀이 힘들게 만든 '유저별 최근 30일 접속 횟수'라는 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)를, 사기 탐지팀이 1초 만에 복사해서 쓸 수 있게 재사용성(Reusability)을 극대화하여 기업의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 가공 비용과 시간을 폭발적으로 줄여준다.
> 3. **판단 포인트**: 학습할 땐 어제 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 쓰지만(배치), 실제 서비스할 땐 방금 1초 전의 클릭 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 써야 한다(실시간). [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 이 '학습과 서빙의 속도 차이(Training-Serving Skew)'를 없애기 위해 오프라인 스토어(S3)와 온라인 스토어([Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/))를 한 몸처럼 묶어주는 미들웨어 역할을 한다.
...
- **📢 섹션 요약 비유**: 오프라인 스토어는 마트의 거대한 지하 창고(느리지만 대용량)이고, 온라인 스토어는 편의점의 앞 매대(용량은 작지만 1초 만에 바로 삼)다. [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 지하 창고의 물건을 앞 매대에 자동으로 셔틀 해주는 완벽한 재고 관리 시스템이다.
...
[피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)([Feature Store](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/))는 MLOps의 잃어버린 고리를 연결해 준 핵심 미들웨어다. 부서 간의 지독한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 칸막이([Silo](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/002_silo_hyeonhyung/))를 부수고, 누군가 고생해서 만들어낸 지식([피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/))을 전사적으로 복제하여 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 개발 속도를 월 단위에서 주 단위로 단축했다.

결론적으로 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 과학의 80%는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 전처리하는 노가다다. [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 이 80%의 노가다를 "한 번만 제대로 해두면 영원히 다시 하지 않아도 되는" 영구적인 자산으로 바꿔놓았다. 기술사는 모델의 파라미터 크기에 열광하기 전에, "우리 회사의 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)가 썩어가고 있지는 않은지, 파이썬 스크립트 안에 갇혀서 재사용되지 못하고 죽어가는지"를 점검하는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 중앙은행장이 되어야 한다.

- **📢 섹션 요약 비유**: 옛날엔 집을 지을 때마다 흙을 파서 벽돌([피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/))을 직접 구웠다. [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 전국에 깔린 거대한 벽돌 공장이다. 이제 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 집을 짓고 싶은 사람은 흙을 팔 필요 없이, [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)에 전화를 걸어 "규격에 맞는 벽돌 100개 보내주세요"라고 하면 1초 만에 배달이 오는 혁명의 시대다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| 상위 개념 | [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/), [데이터 아키텍처](/knowledge-base/studynote/12_it_management/03_ea_isp/104_da_as_is_analysis/) |
| 하위 개념 | 오프라인/온라인 스토어, SSOT, Training-Serving Skew |
| 연결 개념 | [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/), [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/), Feast, 배치/실시간 서빙 |
...
1. 요리사([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/))들이 요리할 때마다 각자 도마에서 양파를 까고 썰려니까 너무 힘들고 귀찮았어요.
2. 그래서 마을 한가운데에 '손질된 양파와 당근을 파는 마법의 반찬 가게([피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/))'를 열었어요.
