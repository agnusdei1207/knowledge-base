...
이 절망적인 상황에서, 인간이 직접 AI의 대답에 점수를 매기고 그 점수를 바탕으로 AI가 스스로 착한 대답만 뱉도록 강제하는 <strong><a href="/knowledge-base/studynote/14_data_engineering/05_exam_keywords/250_rlhf_human_feedback_reinforcement_alignment_cot/">RLHF</a></strong>라는 혁명적인 훈련 파이프라인이 챗GPT에 도입되었다.
