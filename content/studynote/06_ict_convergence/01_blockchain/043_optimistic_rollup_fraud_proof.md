...
> **핵심 인사이트**
> 1. 옵티미스틱 [[042_rollup_l2_solution|롤업]](Optimistic [[042_rollup_l2_solution|Rollup]])은 "일단 믿고, 문제 있으면 증명"하는 낙관적 가정으로 설계된 이더리움 Layer 2 확장 솔루션으로 — ZK [[042_rollup_l2_solution|롤업]]과 달리 [[191_transaction_concept_states|트랜잭션]] 유효성 증명을 즉시 생성하지 않아 [[024_gas|가스]] 비용이 낮지만, 출금 시 7일 이의제기 기간(Challenge Period)이 발생한다.
...
> 3. Optimism(OP [[057_stack|Stack]])과 Arbitrum이 양대 옵티미스틱 [[042_rollup_l2_solution|롤업]] 구현체이며 — OP Stack의 오픈소스화로 Base(Coinbase), Zora, Mantle 등 수십 개의 Layer 2 체인이 동일한 스택으로 구축되는 "Superchain" 생태계가 형성되고 있다.

---

## Ⅰ. 옵티미스틱 [[042_rollup_l2_solution|롤업]] 개념
...
> 📢 **섹션 요약 비유**: 옵티미스틱 [[042_rollup_l2_solution|롤업]]은 선불 여행 정산 — 회사 출장비를 먼저 쓰고(L2 실행), 나중에 영수증 제출(L1 제출). 7일 내 문제 제기 없으면 확정.
...
## Ⅳ. ZK [[042_rollup_l2_solution|롤업]]과의 비교
...
## Ⅴ. 실무 시나리오 — Base 체인 [[032_dapp_decentralized_application|DApp]] 배포
...
> 📢 **섹션 요약 비유**: Base/OP Stack은 이더리움의 고속도로 톨게이트 절감 — 원래 1만 원 톨비(이더리움 [[024_gas|가스]])를 100원(L2)으로 줄여주는 빠른 우회 도로.
...
1. 옵티미스틱 [[042_rollup_l2_solution|롤업]]은 "일단 믿어주는 빠른 계산기" — 수천 개 거래를 묶어서 이더리움에 제출하고, 7일 동안 아무도 문제 제기 안 하면 확정이에요!
...
← **이전**: [[042_rollup_l2_solution|042. 롤업 (Rollup) — Layer 2 트랜잭션 압축 기술]]
**다음**: [[044_zk_rollup_validity_proof|044. ZK-Rollup & 유효성 증명]] →
