...
[taxonomies]
tags = ["DID", "DeSoc", "NFT", "SBT", "Web3 identity", "non-transferable", "soulbound token", "studynote-ict", "verifiable credential"]
...
> 2. 학력증명, 직업 이력, 의료 기록 등 개인의 사회적 자본을 온체인 표현으로 관리해 [탈중앙화](/knowledge-base/studynote/06_ict_convergence/01_blockchain/010_decentralization/) 사회(DeSoc, Decentralized Society)를 지향한다.
> 3. 비양도성이 [개인정보](/knowledge-base/studynote/09_security/16_data_privacy/781_personal_information/) 보호와 충돌하는 문제(영구 온체인 기록)를 해결하기 위해 [영지식 증명](/knowledge-base/studynote/12_it_management/05_security_compliance/229_zkp_data_clean_room/)([ZKP](/knowledge-base/studynote/12_it_management/05_security_compliance/354_did_decentralized_identity_zkp/))과 결합한 프라이버시 SBT가 연구 중이다.
...
- **[DAO](/knowledge-base/studynote/06_ict_convergence/01_blockchain/054_dao_decentralized_autonomous_organization/) 투표 조작 방지**: SBT 기반 고유 신원 → [시빌 공격](/knowledge-base/studynote/06_ict_convergence/01_blockchain/070_sybil_attack_fake_nodes/) 방지
- **학력 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)**: 대학이 발행한 학위 SBT → 위조 불가
...
## Ⅳ. [개인정보](/knowledge-base/studynote/09_security/16_data_privacy/781_personal_information/) 이슈와 [ZKP](/knowledge-base/studynote/12_it_management/05_security_compliance/354_did_decentralized_identity_zkp/)
...
- **지갑 분실**: [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 메커니즘 미표준화 (커뮤니티 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) proposal 연구 중)
- **부정 SBT**: 원치 않는 SBT 강제 발행 (예: 범죄 기록) 거부 메커니즘 필요
- **[상호운용성](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/287_interoperability_tactics/)**: 체인 간 SBT 연동 미표준
