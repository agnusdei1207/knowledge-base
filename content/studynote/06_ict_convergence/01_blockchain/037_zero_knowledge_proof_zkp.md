...
> 2. ZKP의 3가지 [[082_attribute_types_er_model|속성]](완전성·건전성·영지식성)을 모두 만족해야 하며, zk-SNARK·zk-STARK는 이를 실용적인 [[004_blockchain|블록체인]] 스케일링과 프라이버시 [[571_protection_vs_security|보호]]에 적용한 현대적 구현이다.
> 3. ZKP는 신원 증명("나는 18세 이상입니다"를 나이를 공개하지 않고 증명), [[004_blockchain|블록체인]] [[042_rollup_l2_solution|롤업]]([[042_rollup_l2_solution|Rollup]]) [[395_verification_process_review|검증]], 의료·금융 [[001_dikw_pyramid|데이터]] 프라이버시 [[571_protection_vs_security|보호]] 등 "아는 것을 증명하되 내용은 숨기는" 모든 문제의 핵심 기술이다.
...
## II. [[354_did_decentralized_identity_zkp|ZKP]] 3가지 [[082_attribute_types_er_model|속성]]
...
| [[082_attribute_types_er_model|속성]]    | 의미                           | 동굴 비유                     |
|-------|-------------------------------|------------------------------|
...
|---------|----------------|-----------------|
| 증명 크기 | 수백 [[074_byte|바이트]] (소) | 수십 KB (대)    |
| 신뢰 [[009_config|설정]] | 필요            | 불필요           |
| 양자 안전 | 아님 (EC 기반)  | 안전 (해시 기반) |
| [[395_verification_process_review|검증]] 속도 | 빠름            | 상대적 느림      |

> 📢 **섹션 요약 비유**: zk-SNARK는 작고 빠른 [[359_usb|USB]] 키, zk-STARK는 양자 내성 금고 — 용도와 보안 요구에 따라 선택.

---

## [[288_version_ihl_tos_total_length|IV]]. [[354_did_decentralized_identity_zkp|ZKP]] 응용 분야
...
> 📢 **섹션 요약 비유**: 금융 기관에 "나는 신용이 좋습니다"를 계좌 내역 한 줄도 보여주지 않고 증명하는 시스템 — [[781_personal_information|개인정보]] 혁명.

---

## V. 실무 시나리오 — ZK-[[042_rollup_l2_solution|Rollup]] [[191_transaction_concept_states|트랜잭션]] [[395_verification_process_review|검증]]
