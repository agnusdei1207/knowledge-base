...
> 2. 락-앤-민트([Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)-and-Mint)와 번-앤-민트(Burn-and-Mint)가 크로스체인 브릿지의 두 핵심 메커니즘 — 원본 체인에서 자산을 잠그고([Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)) 목표 체인에서 동등한 래핑 토큰(Wrapped Token)을 발행(Mint)하거나, 원본을 소각(Burn)하고 목표 체인에서 민트하는 방식이다.
> 3. 크로스체인 브릿지는 [블록체인](/studynote/06_ict_convergence/01_blockchain/004_blockchain/) 생태계에서 가장 큰 해킹 피해를 낸 취약 지점 — 2022년 Ronin [Bridge](/studynote/04_software_engineering/04_testing_quality/260_bridge_pattern_abstraction_implementation/)($625M), Wormhole($320M), Nomad($190M) 등 단일 취약점이 수천억 원의 손실로 이어지며, [탈중앙화](/studynote/06_ict_convergence/01_blockchain/010_decentralization/) 검증과 다중 서명이 핵심 보안 요소다.
...
> 📢 **섹션 요약 비유**: [Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)-and-Mint = 짐 맡기고 영수증 받기 — 이더리움에 [ETH](/studynote/08_algorithm_stats/06_np_theory/118_eth/) 맡기고([Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)) 폴리곤에서 영수증(wETH) 받음. 반환 시 영수증 돌려주면 [ETH](/studynote/08_algorithm_stats/06_np_theory/118_eth/) 찾음. 브릿지가 금고!
...
## Ⅴ. 실무 시나리오 — [DeFi](/studynote/06_ict_convergence/01_blockchain/033_defi_decentralized_finance/) 멀티체인 [전략](/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)
...
> 📢 **섹션 요약 비유**: 멀티체인 브릿지 [전략](/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) = 도로망 최적 경로 — 이더리움-아비트럼(고속도로: 안전, [롤업](/studynote/06_ict_convergence/01_blockchain/042_rollup_l2_solution/) [상속](/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/)), 이더리움-솔라나(Wormhole: 빠름, 위험 관리). 자산 크기/용도별 경로 선택!
...
2. [Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)-and-Mint = 짐 맡기고 영수증 — 이더리움에 맡기고([Lock](/studynote/05_database/04_transactions_concurrency/510_lock/)) 폴리곤 영수증(wToken) 받음. 반환 시 돌려줌!
...
<- **이전**: [048. 소프트 포크 — Soft Fork & 하위 호환성](/studynote/06_ict_convergence/01_blockchain/048_soft_fork_backward_compatibility/)
**다음**: [SBT — 소울바운드 토큰 (Soulbound Token)](/studynote/06_ict_convergence/01_blockchain/050_sbt_soulbound_token/) ->
