...
| <strong><a href="/knowledge-base/studynote/03_network/07_network_layer_routing/371_vrf_virtual_routing_and_forwarding/">VRF</a> (무작위 함수)</strong> | Verifiable Random Function을 통한 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)자 선출 | 지분이 많다고 100% 독점하지 못하도록 난수 기반 무작위 추첨 적용 | [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 룰렛 돌리기 |
...
| <strong>디파이(<a href="/knowledge-base/studynote/06_ict_convergence/01_blockchain/033_defi_decentralized_finance/">DeFi</a>) 생태계 융합</strong> | 이더리움을 예치하고 무위험 이자를 받는 인터넷 채권 탄생 | 유동성 스테이킹(LSD) 붐 |
