...
> 1. **본질**: 하이퍼레저 패브릭은 허가된 조직만 참여하는 기업용 [블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/004_blockchain/) 프레임워크다.
> 2. **가치**: 채널과 권한 분리로 프라이버시를 지키면서도 합의와 추적성을 확보한다.
> 3. **판단 포인트**: MSP (Membership [Service Provider](/knowledge-base/studynote/09_security/11_iam_access_control/535_sp_service_provider/)), 채널, [체인코드](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/)([Chaincode](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/)), 합의 흐름을 함께 봐야 한다.

---

## Ⅰ. 개요 및 필요성

[퍼블릭 블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/019_public_blockchain/)은 누구나 들어올 수 있어 투명하지만, 기업 입장에서는 프라이버시와 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 부담된다.
...
## Ⅳ. [체인코드](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/)와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분리

스마트 컨트랙트는 [체인코드](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/)([Chaincode](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/))로 구현된다. 하지만 기업 환경에서는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 모든 사람에게 보이면 안 되므로 채널과 프라이빗 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 분리가 중요하다.

- 민감한 거래는 채널로 분리한다.
- 필요한 참여자만 장부를 본다.
- 규칙은 [체인코드](/knowledge-base/studynote/06_ict_convergence/01_blockchain/059_chaincode_smart_contract/)로 실행한다.
...
패브릭은 [공급망](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/520_supply_chain_attack_and_ci_cd_security/), 금융, 제조, 정산처럼 기업 간 협업이 필요한 곳에 잘 맞는다.
