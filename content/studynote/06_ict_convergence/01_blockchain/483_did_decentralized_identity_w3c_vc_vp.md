...
> 1. **본질**: [DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/)(Decentralized Identity, [탈중앙화](/knowledge-base/studynote/06_ict_convergence/01_blockchain/010_decentralization/) 신원)는 중앙 서버 없이 개인이 자신의 신원을 **자기 주권(Self-Sovereign Identity, SSI)**으로 관리하는 W3C 표준 기술이다.
> 2. **가치**: VC(Verifiable Credential, [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 가능 자격증명)는 Issuer(발급자)→Holder(보유자)→Verifier([검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)자) 신뢰 삼각형으로 **중앙 서버 조회 없이 오프라인 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)**이 가능한 디지털 자격증이다.
...
| 구성 요소 | 설명 | 예시 |
|:---|:---|:---|
| **[DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/)** | 전 세계 고유 [식별자](/knowledge-base/studynote/03_network/06_network_layer_ip/289_identification_flags_fragmentation_offset/), URI 형식 | `did:ethr:0x1234...` |
| **[DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/) [Document](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/)** | [DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/) 주체의 공개키·[인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)방법·[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 정의 | JSON-LD 형식 |
| **[DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/) Method** | 특정 [블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/004_blockchain/)/시스템에 [DID](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/) 등록 방식 | [did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):ethr, [did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):web, [did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):ion |
...
|:---|:---|:---|
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 위치** | 기업 서버 | 개인 지갑 |
| **[검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 방식** | 서버 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 호출 | 공개키 서명 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) |
| **오프라인 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)** | 불가 | 가능 |
...
|:---|:---|:---|:---|
| **[did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):ethr** | Ethereum | 이더리움 [스마트 컨트랙트](/knowledge-base/studynote/06_ict_convergence/01_blockchain/022_smart_contract/) | 공개 [블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/004_blockchain/) |
| **[did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):web** | 웹 서버 | [DNS](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/511_dns_hierarchical_distributed_architecture/) 기반, 가장 단순 | 기업 내부 |
| **[did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):ion** | Bitcoin(ION) | DPKI([분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [PKI](/knowledge-base/studynote/09_security/03_network_security/159_pki_public_key_infrastructure/)) | 대규모 공공 |
| **[did](/knowledge-base/studynote/12_it_management/05_security_compliance/231_did_decentralized_identity/):[key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/)** | 키 자체 | 서버 없음, 임시 신원 | 테스트·[IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) |

### 기술사 핵심 판단
1. **[ZKP](/knowledge-base/studynote/12_it_management/05_security_compliance/354_did_decentralized_identity_zkp/)([영지식 증명](/knowledge-base/studynote/12_it_management/05_security_compliance/229_zkp_data_clean_room/)) 연계**: VC의 선택적 공개를 ZKP로 강화 → 나이 범위만 공개 (나이 자체 비공개)
...
| 효과 항목 | 내용 |
|:---|:---|
| **[데이터 주권](/knowledge-base/studynote/09_security/16_data_privacy/809_data_sovereignty/) [회복](/knowledge-base/studynote/05_database/04_transactions_concurrency/233_recovery_database_restoration_overview/)** | 개인이 자신의 신원 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 직접 관리 |
