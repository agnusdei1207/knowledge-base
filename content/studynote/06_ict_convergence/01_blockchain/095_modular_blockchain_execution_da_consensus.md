...
← **이전**: [[094_data_availability_da_layer_celestia|94. 데이터 가용성 (Data Availability, DA) 계층]]
**다음**: [[096_monolithic_blockchain_solana|96. 모놀리식 블록체인 (Monolithic Blockchain) - 모든 작업을 단일 체인(솔라나, 앱토스 등)에서 처리]] →
