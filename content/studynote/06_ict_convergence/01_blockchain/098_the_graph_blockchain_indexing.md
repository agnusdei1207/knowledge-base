...
← **이전**: [[097_ecdsa_schnorr_signature_bitcoin|97. 타원곡선 디지털 서명 알고리즘 (ECDSA) 및 슈노르 서명 (Schnorr Signature - 다중 서명 병합 축소)]]
**다음**: [[099_brc_20_bitcoin_ordinals_protocol|99. BRC-20 표준 - 비트코인 네트워크 상에서의 토큰 발행 프로토콜 (오디널스 Ordinals)]] →
