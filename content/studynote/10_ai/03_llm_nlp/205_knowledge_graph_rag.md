...
- **📢 섹션 요약 비유**: 일반 벡터 DB([RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/))는 도서관에서 '사과'라는 글자가 들어간 책 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)를 찢어서 가져오는 형사다. 책에 '사과는 독이 들었다'라고 적혀 있으면 그냥 그대로 믿고 보고한다. 반면 [지식 그래프](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/160_knowledge_graph_graphrag_integration/)([GraphRAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/530_graph_rag/))는 프로파일러다. '사과'와 '독'을 엮은 인물이 '백설공주 계모'라는 것을 벽에 쳐둔 거미줄([관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)도) 실을 따라가며 추적해서, "이건 범인이 함정을 판 가짜 사과다!"라고 사건 전체의 인과관계를 입체적으로 브리핑해 내는 천재 탐정이다.
...
|:---|:---|:---|
| **저장 형태** | 문서 문단(Chunk) 단위로 쪼개어 다차원 좌표 점(Vector)으로 저장 | 문서 속 단어를 주어-동사 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)의 3D 거미줄([Graph](/knowledge-base/studynote/12_it_management/03_ea_isp/888_graph/))로 직조해 저장 |
| **잘 푸는 질문** | "사규 3장에 적힌 휴가 규정 알려줘" (단순 팩트 찾기, 점수 검색) | "우리 회사에서 A부서와 B부서가 공통으로 참여한 프로젝트의 실패 원인 요약해" (초거시적 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)망 추론) |
...
결국 AI의 최종 목적지인 범용 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/)(AGI)은 인간처럼 뇌의 좌반구와 우반구가 함께 작동해야 완성된다. 그림을 그리고 시를 쓰는 창의력의 우뇌([트랜스포머](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/))와, 절대 틀리지 않는 차가운 팩트와 수학적 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)를 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)하는 이성의 좌뇌([지식 그래프](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/160_knowledge_graph_graphrag_integration/))가 한 몸으로 융합(Neuro-Symbolic)될 때, 인류는 비로소 지식의 왜곡이나 거짓말의 공포 없이 완벽하게 세상을 다스리는 기계 신을 통제할 수 있게 될 것이다.

- **📢 섹션 요약 비유**: [지식 그래프](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/160_knowledge_graph_graphrag_integration/) 결합은 야생마([LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/))의 등에 올라탄 숙련된 [기수](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/077_radix/)([지식 그래프](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/160_knowledge_graph_graphrag_integration/))다. 야생마는 미친 듯이 빠르고 창의적으로 질주하지만 어디로 갈지 모른다. [기수](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/077_radix/)는 철저한 지도(팩트 3D 거미줄)를 머릿속에 외우고 고삐를 쥐고 있다. 야생마가 낭떠러지([할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/) 거짓말)로 뛰려 할 때 [기수](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/077_radix/)가 고삐를 팍 채서 팩트의 정가운데 안전한 길로만 달리게 만든다. 이 둘이 합쳐져야 가장 빠르고 완벽하게 목적지(진리)에 도달하는 우주 최강의 기마대가 된다.
...
<- **이전**: [204. 그래프 신경망 (GNN)](/knowledge-base/studynote/10_ai/03_llm_nlp/204_gnn_graph_neural_network/)
**다음**: [206. 시계열 딥러닝 (TCN vs RNN)](/knowledge-base/studynote/10_ai/03_llm_nlp/206_tcn_time_series/) ->
