...
|:---|:---|:---|
| **저장 형태** | 문서 문단(Chunk) 단위로 쪼개어 다차원 좌표 점(Vector)으로 저장 | 문서 속 단어를 주어-동사 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)의 3D 거미줄([Graph](/knowledge-base/studynote/12_it_management/03_ea_isp/104_graph/))로 직조해 저장 |
