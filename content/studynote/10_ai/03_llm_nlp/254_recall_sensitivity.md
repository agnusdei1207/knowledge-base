...
> 1. **본질**: [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)(Recall)은 실제 Positive 중 모델이 올바르게 Positive로 예측한 비율 — FN(False Negative)을 최소화하는 지표.
> 2. **가치**: 암 진단·사기 탐지처럼 "놓치면 안 되는" 상황에서 [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)보다 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)을 우선시해야 한다.
> 3. **판단 포인트**: 임계값(Threshold)을 낮추면 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)이 오르지만 [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)가 떨어지는 트레이드오프를 반드시 이해해야 한다.
...
[재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)이 중요한 대표 사례:

| [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) | 문제 | 놓쳤을 때 결과 |
|:---|:---|:---|
| 암 진단 | 암 환자를 정상으로 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) | 치료 기회 상실 (생명 위협) |
| 금융 사기 탐지 | 사기 거래를 정상으로 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) | 금전 피해 발생 |
...
| 지표 | 분모 | 목적 |
|:---|:---|:---|
| [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/) / 민감도 (Sensitivity) | 실제 Positive 전체 | FN 최소화 |
| 특이도 (Specificity) | 실제 Negative 전체 | [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/) 최소화 |
| [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/) ([Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)) | 예측 Positive 전체 | [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/) 최소화 |
| 정확도 (Accuracy) | 전체 샘플 | 전반적 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) |

### 임계값과 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)의 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)
...
### [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)-[재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/) 트레이드오프 ([Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)-Recall Tradeoff)
...
- **📢 섹션 요약 비유**: [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)는 "쐈을 때 얼마나 명중하는가", [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)은 "과녁을 얼마나 빠짐없이 맞히는가"다. 좋은 저격수는 둘 다 높아야 한다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/) (Recall) | TP, FN, 민감도(Sensitivity) / 실제 Pos 탐지율 |
| [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/) ([Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)) | TP, [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/) / 예측 Pos [정확성](/knowledge-base/studynote/16_bigdata/01_intro/002_bigdata_5v/) |
| 특이도 (Specificity) | TN, [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/) / 실제 Neg 탐지율 |
| F1 스코어 ([F1-Score](/knowledge-base/studynote/10_ai/03_llm_nlp/255_f1_score/)) | 조화 평균(Harmonic Mean) / [Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)·Recall 균형 |
| ROC 곡선 ([ROC Curve](/knowledge-base/studynote/10_ai/03_llm_nlp/256_roc_auc/)) | TPR, FPR, AUC / 임계값별 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/) |
| 임계값 (Threshold) | 이진 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/), [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 출력 / Recall/[Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/) 조정 레버 |
...
1. 선생님이 반에서 감기 걸린 아이를 찾는다고 해보자. [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)은 감기 걸린 아이 중 실제로 찾아낸 비율이다.
2. 아이를 너무 조심스럽게 찾으면(높은 임계값) 몇 명을 놓치는데, 그게 FN이다.
3. 중요한 것을 놓치면 안 될 때는 좀 더 넓게 의심해서 다 잡아내는 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 바로 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)을 높이는 것!
