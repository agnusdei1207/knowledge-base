...
> 1. **본질**: [혼동 행렬](/knowledge-base/studynote/14_data_engineering/02_math_mining/089_confusion_matrix_tp_fp_fn_tn/)([Confusion Matrix](/knowledge-base/studynote/14_data_engineering/02_math_mining/089_confusion_matrix_tp_fp_fn_tn/), 오차 행렬)은 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) 모델의 예측 결과를 **실제 정답과 비교하여 4가지 경우(TP, TN, [FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/), FN)로 세분화**한 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 분석 도구다.
...
→ 이런 상황에서 정확도는 오해를 유발. **[혼동 행렬](/knowledge-base/studynote/14_data_engineering/02_math_mining/089_confusion_matrix_tp_fp_fn_tn/) 기반 세부 지표 필수**
...
- **[FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/) (False Positive, 1종 오류)**: 실제 음성 → 양성으로 잘못 예측 ❌
...
| **[정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)([Precision](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/))** | TP / (TP+[FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/)) | Positive 예측 중 실제 Positive 비율 |
| **[재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)([Recall](/knowledge-base/studynote/10_ai/03_llm_nlp/254_recall_sensitivity/))** | TP / (TP+FN) | 실제 Positive 중 맞게 예측한 비율 |
| **[F1-Score](/knowledge-base/studynote/10_ai/03_llm_nlp/255_f1_score/)** | 2 × (P×R)/(P+R) | [정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)와 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)의 조화평균 |
...
- **AUROC (Area Under [ROC Curve](/knowledge-base/studynote/10_ai/03_llm_nlp/256_roc_auc/))**: 면적이 1에 가까울수록 우수한 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)기
...
### 4.3 기술사 핵심 판단 포인트
- **클래스 불균형 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에서 정확도(Accuracy)만 보고하는 것은 오류**
...
- **다중 클래스 [혼동 행렬](/knowledge-base/studynote/14_data_engineering/02_math_mining/089_confusion_matrix_tp_fp_fn_tn/)**: n×n 행렬로 확장, Macro/Micro/Weighted F1 사용
...
1. [혼동 행렬](/knowledge-base/studynote/14_data_engineering/02_math_mining/089_confusion_matrix_tp_fp_fn_tn/)은 **받아쓰기 성적표**예요 — 맞힌 것(TP, TN)과 틀린 것([FP](/knowledge-base/studynote/12_it_management/05_security_compliance/293_fp_function_point/), FN)을 4가지로 나눠요.
