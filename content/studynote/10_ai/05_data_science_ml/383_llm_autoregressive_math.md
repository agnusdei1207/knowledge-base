...
> 1. **본질**: 자기 회귀 (Auto-Regressive) 언어 모델은 시퀀스의 결합 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)을 연쇄 법칙 (Chain Rule)으로 분해하여, 이전 토큰들이 주어졌을 때 다음 토큰의 [조건부 확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/132_conditional_probability/)을 순차적으로 곱하는 방식으로 텍스트를 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)한다.
> 2. **가치**: [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 우도 (Log-Likelihood) 최대화를 학습 목표로 삼으면, 교사 강요 (Teacher Forcing)로 안정적이고 효율적인 학습이 가능하며 [GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/) 계열 모델의 사전학습 방법이다.
...
언어 모델의 궁극적 목표는 자연어 텍스트의 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 분포 P(x₁, x₂, …, xₙ)를 학습하는 것이다. 자기 회귀 접근은 이를 [조건부 확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/132_conditional_probability/)의 곱으로 분해해 각 단계를 독립적으로 학습 가능하게 만든다.
...
### 결합 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)의 연쇄 법칙 분해
...
### 학습 목표: [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 우도 최대화
...
| 모델 | PPL (PTB) | 비고 |
|:---|:---|:---|
| n-gram (3-gram) | ~[10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)0 | 고전 |
| [LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/) | ~65 | 딥러닝 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) |
| [GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/)-2 | ~35 | [트랜스포머](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) |
| [GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/)-3 | ~20 | 대규모 [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) |
...
자기 회귀 언어 모델의 우도 수식은 단순하지만, 그 위에 [스케일링](/knowledge-base/studynote/10_ai/03_llm_nlp/249_scaling_normalization_standardization/)을 통해 [GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/)-4, LLaMA 3, Claude 등 현대 LLM이 만들어졌다. [조건부 확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/132_conditional_probability/) 분해의 이론적 완결성과 교사 강요의 실용성이 결합된 이 방법은 사전학습의 표준이 됐다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| 자기 회귀 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) | 연쇄 법칙, [조건부 확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/132_conditional_probability/) / [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 원리 |
| [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/) 우도 | 교차 [엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/), 최대화 / 사전학습 목표 함수 |
| 교사 강요 | Teacher Forcing, 학습 효율 / 안정적 학습 기법 |
| 퍼플렉시티 | PPL, 지수 [엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/) / 언어 모델 평가 지표 |
| Beam Search | k 후보, [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 최대화 / 추론 디코딩 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
| Exposure [Bias](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/094_bias/) | 학습-추론 불일치 / AR 모델 한계 |
...
2. 퍼플렉시티는 모델이 "다음 단어로 몇 가지를 고민하는지"야. [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)이면 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/)가지 후보 중 고민, 100이면 100가지 중 고민하는 것처럼 헷갈리는 거야.
