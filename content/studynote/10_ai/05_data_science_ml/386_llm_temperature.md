...
LLM은 각 토큰 위치에서 어휘 전체에 대한 로짓 벡터를 출력한다. 이 로짓을 [소프트맥스](/knowledge-base/studynote/10_ai/03_llm_nlp/270_softmax/)로 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)로 변환할 때 온도 T를 적용해 분포의 형태를 조절한다.
...
### 온도 적용 [소프트맥스](/knowledge-base/studynote/10_ai/03_llm_nlp/270_softmax/)
...
|:---|:---|:---|
| 0.0 ~ 0.3 | 결정론적, 반복적 | 코드 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/), 사실 Q&A |
| 0.5 ~ 0.8 | 균형 잡힌 다양성 | 요약, 번역 |
| 0.8 ~ 1.2 | 창의적 | 글쓰기, 브레인스토밍 |
| 1.5 이상 | [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 저하, 헛소리 | (권장 안함) |
...
| [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) 온도 (Temperature) 파라미터 | [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 실용성의 균형 | 대표적인 실무 적용 |
...
- **📢 섹션 요약 비유**: 온도·[Top-K](/knowledge-base/studynote/06_ict_convergence/05_data_science/414_llm_decoder_top_k_temperature/)·Top-P는 "삼중 필터 커피"다. 온도는 원두 농도, Top-K는 선택 원두 가짓수, Top-P는 사용할 원두 비율을 조절한다.
...
온도 파라미터는 단 하나의 스칼라로 LLM의 창의성-[신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) 트레이드오프를 제어하는 직관적인 도구다. 볼츠만 분포에서 영감을 받은 이 메커니즘은 오늘날 모든 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)의 핵심 파라미터가 됐다. 올바른 온도 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)은 [프롬프트 엔지니어링](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/149_prompt_engineering_cot_few_shot/)과 함께 [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) 응용의 품질을 결정한다.
