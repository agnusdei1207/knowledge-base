...
|:---|:---|:---|:---|
| [Bagging](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/) | 높은 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) (과적합) | [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 평균/투표 | [Random Forest](/knowledge-base/studynote/06_ict_convergence/05_data_science/353_random_forest/) |
| [Boosting](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) | 높은 편향 (과소적합) | 순차 잔차 학습 | XGBoost, LightGBM |
| Stacking | 편향+[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) | 메타 모델 결합 | 다양한 기반 모델 |
...
| 측면 | [Bagging](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/) | [Boosting](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) |
|:---|:---|:---|
| 학습 방식 | [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) (독립) | 순차 (의존) |
| 주 효과 | [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 감소 | 편향 감소 |
| 과적합 위험 | 낮음 | 높음 (깊은 트리, 높은 반복) |
| 노이즈 강인성 | 강함 | 약함 (아웃라이어 증폭) |
| 해석 가능성 | 중간 | 낮음 (복잡한 결합) |

- **📢 섹션 요약 비유**: Bagging은 안전하게 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 투자하는 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)폴리오, Boosting은 집중 투자로 높은 수익을 노리지만 변동성도 큰 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이다.
...
편향-[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 수식은 모델 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 개선의 방향성을 제시하는 나침반이다. Bagging은 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)을 √n 배 감소시키는 수학적 보장이 있으며, Boosting은 약한 학습기를 결합해 강한 학습기를 만들 수 있다는 [AdaBoost](/knowledge-base/studynote/12_it_management/02_itsm_itil/077_Adaboost/) 이론에 기반한다. 두 방법의 특성을 정확히 이해하면 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)/문제에 맞는 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)을 선택할 수 있다.

- **📢 섹션 요약 비유**: [편향-분산 트레이드오프](/knowledge-base/studynote/14_data_engineering/02_math_mining/110_bias_variance_tradeoff/)는 "[정밀도](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/233_precision_recall_f1_roc_auc_threshold/)와 [재현율](/knowledge-base/studynote/14_data_engineering/02_math_mining/092_recall_sensitivity_hit_rate/)의 트레이드오프"와 같은 AI의 기본 딜레마다. Bagging과 Boosting은 각각 한쪽을 잡아주는 두 가지 도구다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| 편향-[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 분해 | [MSE](/knowledge-base/studynote/10_ai/01_ai_basics/076_mse_mean_squared_error_regression/), 일반화 오차 / 오차 원천 분석 |
| [Bagging](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/) | 부트스트랩, [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) / [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 감소 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) |
| [Random Forest](/knowledge-base/studynote/06_ict_convergence/05_data_science/353_random_forest/) | max_features, 특성 무작위 / [Bagging](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/) + 특성 샘플링 |
| [Boosting](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) | 잔차 학습, 순차 / 편향 감소 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) |
| XGBoost | [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/) 트리 [부스팅](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) / 실용적 [Boosting](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/) 대표 |
| 상관계수 ρ | 트리 간 유사도 / [Bagging](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/) 효과 결정 |
...
1. 편향은 활이 항상 왼쪽으로 휘어지는 것, [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)은 쏠 때마다 방향이 달라지는 것이야.
