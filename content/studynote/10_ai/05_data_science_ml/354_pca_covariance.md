...
> 2. **가치**: 수천 차원의 이미지·유전자 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 2~3차원으로 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)해 [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/)하거나, 차원의 저주([Curse of Dimensionality](/knowledge-base/studynote/12_it_management/02_itsm_itil/864_curse_of_dimensionality/))를 방지하고 K-Means 등 하위 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 극적으로 향상시킨다.
...
| 차원의 저주 ([Curse of Dimensionality](/knowledge-base/studynote/12_it_management/02_itsm_itil/864_curse_of_dimensionality/)) | 고차원 / PCA가 해결하는 핵심 문제 |
