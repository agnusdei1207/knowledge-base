...
| 구성 요소 | 역할 | 내부 동작 |
|:---|:---|:---|
| **Goal [Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)** | [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)해야 할 목표/가설 보관 | 현재 목표를 Pop하고, 필요 조건(하위 목표)을 Push하는 LIFO 구조 |
...
**[전향 추론](/knowledge-base/studynote/10_ai/03_llm_nlp/235_forward_backward_chaining/) vs 후향 추론 비교 매트릭스**
...
| **적합한 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)** | 시스템 [모니터](/knowledge-base/studynote/02_operating_system/04_synchronization/229_monitor/)링, 프로세스 제어 | 질병 진단, 고장 수리, 디버깅 | 반응형 처리인가 vs 분석형 처리인가 |
...
**실무 [의사결정 트리](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/124_decision_tree/) ([Decision Tree](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/124_decision_tree/))**
```text
[문제 정의]
   ↓
...
**실무 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) (주의사항)**
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[전향 추론](/knowledge-base/studynote/10_ai/03_llm_nlp/235_forward_backward_chaining/) ([Forward Chaining](/knowledge-base/studynote/10_ai/01_ai_basics/010_forward_chaining/))** | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에서 출발해 결론을 도출하는 반대 방향 추론 방식 |
| **규칙 베이스 (Rule Base)** | IF-THEN 형식으로 지식을 표현하는 후향 추론의 지식 저장소 |
| **Goal [Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)** | 현재 증명해야 할 하위 목표들을 쌓아두는 후향 추론의 핵심 자료구조 |
| **설명 가능한 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) ([XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/))** | 후향 추론의 추적 가능한 인과 경로를 현대 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 해석 가능성에 활용 |
| **뉴로-심볼릭 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) (Neuro-Symbolic [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/))** | LLM의 직관적 결론을 심볼릭 역추론으로 사후 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)하는 하이브리드 아키텍처 |
### 📈 관련 키워드 및 발전 흐름도
