...
# 16. [언덕 오르기 탐색](/knowledge-base/studynote/10_ai/03_llm_nlp/237_hill_climbing_local_optima/) ([Hill Climbing](/knowledge-base/studynote/10_ai/03_llm_nlp/237_hill_climbing_local_optima/))

#### 핵심 인사이트 (3줄 요약)
> 1. **본질**: [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/)를 기준으로 이웃한 상태들의 [휴리스틱](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/210_heuristics_scheduling/)([Heuristic](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/236_a_star_heuristic_minimax_mcts_monte_carlo/)) 가치를 평가하여, 단기적으로 가장 높은 가치를 가지는 방향으로만 이동하는 그리디(Greedy) 기반 국지적 최적화 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)이다.
> 2. **가치**: 메모리에 [현재 상태](/knowledge-base/studynote/04_software_engineering/03_design_architecture/178_as_is_to_be_analysis/)만 유지하면 되므로 [공간 복잡도](/knowledge-base/studynote/08_algorithm_stats/01_basics/003_space_complexity/)가 O(1) 수준으로 극히 낮으며, 복잡한 연속 최적화 문제에서 매우 빠르게 근사해를 찾을 수 있다.
> 3. **융합**: 지역 최적해(Local Maxima)의 함정을 극복하기 위해 시뮬레이티드 어닐링(Simulated Annealing)이나 유전 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)(Genetic [Algorithm](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/))과 같은 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)적 메타휴리스틱 기법으로 확장된다.
...
> 📢 **섹션 요약 비유**: 마치 라디오 채널을 돌릴 때 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)음이 가장 뚜렷해지는 한 방향으로만 다이얼을 돌리고, 조금이라도 지지직거리면 바로 멈추는 아날로그 다이얼 방식과 같습니다.

---

### Ⅲ. 융합 비교 및 다각도 분석 (Comparison & Synergy)

최적화 문제에서 언덕 오르기 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)의 위치를 다른 주요 탐색 기법과 비교 분석한다. 메모리 효율성과 해의 완전성(Completeness) 간의 트레이드오프가 극명하게 드러난다.
...
3. 그러다 제일 높은 동네 뒷산 봉우리에 도착하면 진짜 에베레스트산인 줄 알고 멈춰버리는 게 바로 이 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)이랍니다!
