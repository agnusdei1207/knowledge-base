...
### [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) 수식
...
### [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) 비율 가이드

| 레이어 | 권장 p | 이유 |
|:---|:---|:---|
| 은닉층 ([FC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/696_fibre_channel_protocol/)) | 0.5 | 표준 [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) |
| 입력층 | 0.1~0.2 | 너무 많이 제거하면 정보 손실 |
| [CNN](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/243_cnn_stride_pooling_resnet_residual_yolo_object_detection/) [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)맵 | 0.2~0.3 | 공간 정보 보존 |
| [Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) FFN | 0.1~0.2 | 현대 [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) 표준 |

- **📢 섹션 요약 비유**: [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) 비율은 팀에서 빠지는 선수 비율이다. 50%가 빠지면(p=0.5) 각 선수가 독립적으로 강해지지만, 90%가 빠지면(p=0.9) 팀이 너무 약해져서 아무것도 배울 수 없다.

---

## Ⅲ. 비교 및 연결

| 비교 | L2 규제 | [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) | Batch Norm |
|:---|:---|:---|:---|
| 메커니즘 | [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 축소 | 랜덤 비활성화 | 분포 [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/) |
| [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) 효과 | ❌ | ✅ 암묵적 | ❌ |
| 현대 사용 | AdamW 통합 | [Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) | [CNN](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/243_cnn_stride_pooling_resnet_residual_yolo_object_detection/)·[Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) |
| 컴퓨팅 | 낮음 | 낮음 | 추가 파라미터 |

- **📢 섹션 요약 비유**: 규제 방법들은 식이 조절 방법이다. L2는 모든 음식을 조금씩 줄이기, [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)은 매일 다른 음식을 빼기(랜덤 다이어트), Batch Norm은 영양 균형 맞추기다.
...
| 기대효과 | 내용 |
|:---|:---|
| **과적합 방지** | 암묵적 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/)로 일반화 향상 |
| **불확실성 추정** | MC Dropout으로 베이지안 근사 |
| **규제 단순성** | 구현 단순, 효과 강력 |

[드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)은 Hinton 등이 2014년 제안한 이래 딥러닝의 표준 규제 기법이 됐다. 현대 Transformer에서는 낮은 비율(0.1)로 사용되며, MC Dropout은 의료·자율주행 AI에서 모델 불확실성 정량화의 실용적 방법으로 활용된다.

- **📢 섹션 요약 비유**: [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)은 군대 훈련법이다. 소대원 절반이 무작위로 빠진 상태로 훈련하면 모든 병사가 의존 없이 독립적으로 강해진다. [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 모델도 마찬가지로 [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)이 각 뉴런을 독립적으로 강화한다.
...
1. [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)은 매 훈련마다 팀원 일부를 랜덤으로 빠지게 하는 거예요! 그래서 모든 선수가 어떤 조합에서도 잘 플레이하게 돼요.
2. 과적합을 막는 동시에 수천 가지 다른 팀을 동시에 훈련하는 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) 효과가 있어요!
3. MC Dropout은 추론할 때도 [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)을 켜서 "이 예측이 얼마나 확실한가?"를 측정하는 데 써요!
...
← **이전**: [28. L1/L2 규제화 상세 (L1/L2 Regularization)](/knowledge-base/studynote/10_ai/01_ai_basics/028_l1_l2_regularization/)
**다음**: [30. 검증 세트 — 하이퍼파라미터 튜닝의 심판](/knowledge-base/studynote/10_ai/01_ai_basics/030_validation_set/) →
