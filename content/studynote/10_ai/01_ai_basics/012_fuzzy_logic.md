...
| **Inference Engine** | 퍼지 규칙 연산 및 결합 | [MIN-MAX](/knowledge-base/studynote/14_data_engineering/02_math_mining/078_data_scaling_normalization_min_max_standardization_z_score/) 연산 (AND는 MIN 연산, OR는 MAX 연산)을 통해 조건부 결론의 퍼지 집합 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) |
