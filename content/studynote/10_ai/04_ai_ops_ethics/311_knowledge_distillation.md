...
<strong><a href="/knowledge-base/studynote/14_data_engineering/05_exam_keywords/252_knowledge_distillation_quantization_edge_slm_diffusion/">지식 증류</a> vs <a href="/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/434_quantization/">양자화</a> vs 프루닝 비교</strong>:
...
1. <strong><a href="/knowledge-base/studynote/14_data_engineering/05_exam_keywords/252_knowledge_distillation_quantization_edge_slm_diffusion/">지식 증류</a></strong>는 박사 교수(큰 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/))가 "고양이는 개와 비슷하고 자동차와는 달라"라는 <strong>세세한 지식</strong>을 작은 학생 AI에게 가르쳐주는 방법이에요!
2. 단순히 "정답은 고양이야"가 아니라 교수의 <strong>"고양이일 <a href="/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/">확률</a> 90%, 개일 <a href="/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/">확률</a> 7%"라는 분포</strong> 전체를 학생이 배우는 거예요.
