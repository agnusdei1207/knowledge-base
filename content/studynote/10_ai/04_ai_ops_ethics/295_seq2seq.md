...
| 구성 | 역할 | 특징 |
|:---|:---|:---|
| [인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/) ([Encoder](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)) | 입력 시퀀스 -> 문맥 벡터 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) | 마지막 은닉 상태가 문맥 벡터 |
| 문맥 벡터 ([Context Vector](/knowledge-base/studynote/10_ai/02_dl_architecture_new/120_context_vector/)) | 입력 전체 요약 | 고정 크기, 병목 발생 원인 |
| [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) ([Decoder](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)) | 문맥 벡터 -> 출력 시퀀스 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) | 자기회귀([Autoregressive](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/248_bert_encoder_mlm_gpt_decoder_autoregressive_comparison/)) 방식 |
| 교사 강요 (Teacher Forcing) | 학습 시 정답 토큰을 [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) 입력으로 | 훈련 가속, 추론 시 노출 편향 발생 |

- **📢 섹션 요약 비유**: 문맥 벡터의 병목은 10권짜리 소설의 내용을 명함 한 장에 요약하는 것이다. 200페이지 정도면 명함 요약이 가능하지만, 3,000페이지가 넘어가면 중요한 사건이 빠지기 시작한다. 어텐션은 [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)가 각 단어를 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)할 때 소설 원본 전체([인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/) 모든 시점의 은닉 상태)를 직접 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)하는 방법으로 명함 한 장 병목을 우회한다.
...
|:---|:---|:---|:---|
| 기본 [Seq2Seq](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/245_seq2seq_context_vector_attention_dynamic_weight/) | 단일 고정 문맥 벡터 | — | 취약 |
| [Seq2Seq](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/245_seq2seq_context_vector_attention_dynamic_weight/) + Attention | 없음 (동적 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/)) | [어텐션 메커니즘](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/296_attention_mechanism/) | 양호 |
| [Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) | 없음 | 셀프 어텐션 전체 | 완벽 |

- **📢 섹션 요약 비유**: 기본 Seq2Seq는 1980년대 전화기(고정 병목), [Seq2Seq](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/245_seq2seq_context_vector_attention_dynamic_weight/)+Attention은 2000년대 이메일(필요한 원본 첨부 가능), Transformer는 화상통화(모든 정보 동시 전달)다. 통신 기술이 진화하듯 문맥 전달 능력이 진화했다.
...
Seq2Seq는 입력-출력 길이 비대칭 문제를 [인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)-[디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) 패턴으로 우아하게 해결하여 기계 번역·챗봇·요약·이미지 캡셔닝 등 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 응용의 지평을 넓혔다. 비록 고정 문맥 벡터의 병목이라는 한계를 가졌지만, 이 한계가 [어텐션 메커니즘](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/296_attention_mechanism/)과 [Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) 탄생의 씨앗이 되었다. 현대 ChatGPT, Claude 등 대화형 AI는 모두 Seq2Seq의 [인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)-[디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) 또는 [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) 전용 아키텍처에서 직접 진화한 결과물이다.

- **📢 섹션 요약 비유**: Seq2Seq는 현대 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 번역기의 설계도다. 완벽하지는 않았지만 "입력을 이해하고([인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)) 출력을 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)한다([디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/))"는 이 두 단계 사고 방식은 오늘날 모든 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) AI의 뼈대로 이어지고 있다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/) ([Encoder](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)) | [LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/), 문맥 벡터 / 입력 시퀀스를 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) |
| [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) ([Decoder](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/)) | [LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/), 자기회귀 / 문맥 벡터로 출력 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) |
| 문맥 벡터 ([Context Vector](/knowledge-base/studynote/10_ai/02_dl_architecture_new/120_context_vector/)) | 고정 크기, 병목 / Seq2Seq의 정보 전달 매개체 |
| [어텐션 메커니즘](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/296_attention_mechanism/) | 동적 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/), 병목 해소 / [Seq2Seq](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/245_seq2seq_context_vector_attention_dynamic_weight/) 병목의 해결책 |
| 빔 서치 (Beam Search) | K개 후보, 탐색 / [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) 출력 품질 향상 기법 |
...
<- **이전**: [294. GRU (Gated Recurrent Unit)](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/294_gru/)
**다음**: [296. 어텐션 메커니즘 (Attention Mechanism)](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/296_attention_mechanism/) ->
