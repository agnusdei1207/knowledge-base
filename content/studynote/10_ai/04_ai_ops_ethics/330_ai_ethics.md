...
> 1. **본질**: [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리 ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Ethics)는 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 시스템이 사회에 미치는 영향을 인간의 가치·권리·존엄성 관점에서 평가하고, 공정성(Fairness)·투명성(Transparency)·책임성(Accountability)·안전성(Safety)·프라이버시(Privacy) 등의 원칙을 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 개발·배포·운영 전 주기에 내재화하는 원칙과 실천의 체계다.
> 2. **가치**: EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act(세계 최초 포괄적 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 규제)·미국 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 안전 행정명령·한국 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 기본법 등 전 세계적으로 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리가 법제화되며, [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 제품의 시장 진입 요건이 됨으로써 기술사가 설계 단계부터 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리를 반영해야 하는 것이 법적 의무가 됐다.
> 3. **판단 포인트**: [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 편향([Bias](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/094_bias/))의 근원은 "편향된 학습 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)", "편향된 레이블링", "편향된 목적 함수 설계"이며, 기술적 해결책([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 균형·[XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/)·공정성 [메트릭](/knowledge-base/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/))과 조직적 해결책(다양성 팀·윤리 위원회·[알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/))을 함께 적용해야 한다.
...
|:---|:---|:---|
| 공정성 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 균형, 공정성 [메트릭](/knowledge-base/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/) | 다양성 팀, 편향 [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) |
| 투명성 | [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/)([SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/), [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/)), 모델 카드 | [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 영향 평가 |
| 책임성 | Human-in-the-Loop, 로깅 | [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리 위원회, 구제 절차 |
| 프라이버시 | [연합 학습](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/256_federated_learning_privacy_model_security/), [차등 프라이버시](/knowledge-base/studynote/16_bigdata/10_governance/209_differential_privacy/) | [GDPR DPO](/knowledge-base/studynote/09_security/16_data_privacy/797_gdpr_dpo/) ([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [보호](/knowledge-base/studynote/02_operating_system/10_security/571_protection_vs_security/) 책임자) |
| 안전성 | 테스트, [레드팀](/knowledge-base/studynote/09_security/14_threat_hunting_adversarial/681_red_team/) 공격 | [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 안전 평가, 단계적 배포 |

- **📢 섹션 요약 비유**: 공정성 세 가지 정의의 상충 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)는 저울의 3자 딜레마다. "남자와 여자 합격률 동등(인구통계학적 동등)"이라는 저울이 평형이면, "남자와 여자 실력자 합격률 동등(기회 균등)"의 저울이 기울어질 수 있다. 수학적으로 세 저울을 동시에 완벽히 평형으로 맞추는 것은 불가능하다. 어떤 공정성을 우선시할지는 사회적 가치 판단의 문제다.
...
| [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리 ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Ethics) | [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)과 실용성의 균형 | 대표적인 실무 적용 |
...
[AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리는 기술 문제가 아닌 사회 문제다. 최고 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) AI도 편향·불투명·책임 불명확이 있으면 사회에 배포될 수 없는 시대가 됐다. EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act·미국 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 안전 행정명령·한국 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 기본법이 글로벌 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 규제의 삼각 축을 형성하며, [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리 준수는 글로벌 시장 진입의 필수 조건이 됐다. 기술사는 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 시스템 설계 시 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 요구사항과 동등한 비중으로 윤리적 요구사항을 아키텍처에 내재화해야 한다.

- **📢 섹션 요약 비유**: [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리는 건축 설계의 내진 설계 의무와 같다. 지진 발생 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/)이 낮다고 내진 설계를 생략하면 인허가(EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act 승인)를 받지 못한다. AI도 "나는 차별하지 않겠다(공정성)"는 설계 원칙을 기술적으로 증명해야 시장에 진입할 수 있다. 내진 설계가 건물의 비용이 아니라 생명 안전 투자인 것처럼, [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리도 비용이 아닌 사회적 신뢰 투자다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 편향 ([AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) [Bias](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/094_bias/)) | 학습 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 편향, 증폭 / [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리의 가장 핵심적 기술 문제 |
| [XAI](/knowledge-base/studynote/12_it_management/05_security_compliance/227_xai_explainable_ai_lime_shap/) | [SHAP](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/327_shap/), [LIME](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/326_lime/), 투명성 / 투명성 원칙의 기술적 구현 |
| EU [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) Act | 고위험 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/), 설명 의무 / [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 윤리의 글로벌 법적 기준 |
| [연합 학습](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/256_federated_learning_privacy_model_security/) | 프라이버시 보존 / 프라이버시 원칙의 기술적 구현 |
