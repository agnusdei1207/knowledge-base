...
| 요구사항 | 권장 기법 | 이유 |
|:---|:---|:---|
| 단순 질문·[분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) | Standard Prompt | 비용 최소화 |
| 수학 계산·[논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 추론 | [CoT](/knowledge-base/studynote/10_ai/02_dl_architecture_new/146_chain_of_thought_cot/) 또는 SC | 단계별 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 필요 |
| 퍼즐·복잡 계획·다단계 문제 | **ToT** | [백트래킹](/knowledge-base/studynote/08_algorithm_stats/01_basics/010_backtracking/)·분기 탐색 필요 |
