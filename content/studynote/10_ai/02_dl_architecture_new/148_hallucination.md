...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/) ([Hallucination](/knowledge-base/studynote/12_it_management/05_security_compliance/345_llm_foundation_model_hallucination/))은 [대규모 언어 모델](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/582_llm_based_code_generation_tools/)([LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/))이 사실이 아니거나 근거가 없는 허위 정보를 마치 명백한 진실인 것처럼 유창하고 그럴싸하게 꾸며내어 답변하는 치명적 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/) 현상이다.
> 2. **가치(원인)**: LLM은 사실(Fact)을 검색해 오는 지식 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/)가 아니라, 방대한 학습 텍스트의 통계적 분포를 바탕으로 문맥상 가장 그럴싸한 다음 단어를 '예측(Generate)'하는 거대한 [확률](/knowledge-base/studynote/08_algorithm_stats/08_stats/130_probability/) 기계이기 때문에 필연적으로 발생한다.
> 3. **판단 포인트**: 기업 B2B 환경이나 전문 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)(의료/법률)에 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)형 AI를 도입할 때 [할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/)을 완벽히 0%로 제거하는 것은 불가능하므로, 외부 팩트 문서를 주입하는 [RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/)([검색 증강 생성](/knowledge-base/studynote/12_it_management/05_security_compliance/222_rag_retrieval_augmented_generation/)) 아키텍처 설계와 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인 도입이 절대적으로 필요하다.

---

## Ⅰ. 개요 및 필요성

[할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/) ([Hallucination](/knowledge-base/studynote/12_it_management/05_security_compliance/345_llm_foundation_model_hallucination/))은 [인공지능](/knowledge-base/studynote/10_ai/03_llm_nlp/231_ai_turing_test/)이 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)을 본 것처럼 존재하지 않는 정보를 사실처럼 출력하는 현상을 말한다. "조선시대 세종대왕이 맥북프로를 던진 사건에 대해 설명해 줘"라는 엉뚱한 질문에, AI가 "세종대왕이 훈민정음 창제 중 스트레스를 받아 신하에게 맥북을 던졌습니다"라고 천연덕스럽게 소설을 쓰는 것이 대표적인 예다.

[생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)형 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 시대가 도래하면서 [할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/)은 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 상용화의 가장 거대한 장벽이 되었다. 사람들은 AI의 완벽한 문장력(Fluency)에 속아 허위 정보를 진실로 맹신하게 된다. 만약 챗봇이 환자에게 엉터리 약을 처방하거나, 변호사에게 없는 판례를 지어내어 제출하게 만든다면 그 피해는 돌이킬 수 없다. 이는 AI의 뛰어난 '말재주'가 완벽한 '지능과 진실'로 오해받으면서 터지는 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) 파괴 현상이다.

- **📢 섹션 요약 비유**: [할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/)은 아는 척하기 좋아하는 '뻔뻔한 거짓말쟁이'와 같습니다. 내용은 100% 가짜지만 목소리와 억양이 너무 당당하고 유창해서 듣는 사람이 깜빡 속아 넘어가게 만드는 현상입니다.
...
[할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/)은 발생 패턴에 따라 내재적 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)과 외재적 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)으로 나뉘며, 이에 따라 방어 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 달라진다.
...
[할루시네이션](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/251_hallucination_rag_augmented_retrieval_vector_db/)은 정보의 부재에서 오는 자연스러운 현상이지만, 이를 악용하는 '[프롬프트 인젝션](/knowledge-base/studynote/09_security/19_ai_advanced_security/955_prompt_injection/)([Prompt Injection](/knowledge-base/studynote/09_security/19_ai_advanced_security/955_prompt_injection/))'이나 '[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 오염([Data Poisoning](/knowledge-base/studynote/09_security/19_ai_advanced_security/947_data_poisoning/))' 공격과 결합하면 AI가 의도적으로 가짜 뉴스를 무한 살포하는 사이버 무기로 전락할 수 있다.

- **📢 섹션 요약 비유**: 내재적 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)은 책을 읽고 독후감을 쓰는데 주인공 이름을 반대로 적는 '실수'라면, 외재적 [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)은 아예 읽지도 않은 책의 내용을 지어내서 줄거리를 이야기하는 '소설'입니다.
