...
> 3. **판단 포인트**: Bi-RNN은 **전체 시퀀스가 주어진 경우([NER](/knowledge-base/studynote/16_bigdata/05_analysis/117_ner/)·기계 번역 [인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)·[감성 분석](/knowledge-base/studynote/12_it_management/03_ea_isp/105_exploratory_data_analysis/))**에 적합하지만, **실시간 스트리밍(음성 인식 실시간·자동 완성)**에서는 미래 정보가 없으므로 사용 불가하다.
...
|:---|:---|:---|
| **[컨텍스트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/)** | 과거만 | **과거 + 미래** |
| **파라미터** | 1× | **2× (두 방향)** |
| **실시간** | 가능 | **불가 (전체 시퀀스 필요)** |
| **적합** | [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)·스트리밍 | **[분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)·[NER](/knowledge-base/studynote/16_bigdata/05_analysis/117_ner/)·[인코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/040_encoder/)** |
...
실무에서는 바닐라 Bi-RNN보다 **Bi-[LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/)·Bi-[GRU](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/294_gru/)**를 사용하여 [장기 의존성](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/291_long_term_dependency/)도 양방향으로 포착한다.
...
|:---|:---|:---|:---|
| **[컨텍스트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/)** | 과거 | 과거+미래 | **전체 (Attention)** |
...
| 개념 | 연결 포인트 |
|:---|:---|
| **Bi-[LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/)** | 양방향 + [장기 의존성](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/291_long_term_dependency/) 해결 |
| **[BERT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/301_bert_mlm/)** | 양방향 [Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/) (Bi-RNN의 계승) |
| **[GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/)** | [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) [디코더](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/039_decoder/) (자기회귀) |
| **[NER](/knowledge-base/studynote/16_bigdata/05_analysis/117_ner/)** | Bi-RNN의 대표적 적용 [태스크](/knowledge-base/studynote/02_operating_system/02_process_thread/150_task/) |
