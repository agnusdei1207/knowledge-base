...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: BPTT([Backpropagation](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/) Through Time)는 RNN의 순환 구조를 **시간 축으로 펼친(Unfolding) 후 일반 [역전파](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/)를 적용**하는 학습 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)이며, 펼친 길이 T에 비례하여 $O(T)$의 시간·메모리 비용이 발생한다.
> 2. **가치**: 시퀀스 길이 T가 길수록 과거 정보를 반영할 수 있지만, [기울기 소실](/knowledge-base/studynote/10_ai/01_ai_basics/088_vanishing_gradient_relu_skip_connection/)/폭발이 심해지고 메모리가 폭발하므로 실무에서는 **Truncated BPTT(일정 길이 k로 잘라서 [역전파](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/))**를 사용한다.
...
|:---|:---|:---|
| **[역전파](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/) 범위** | 전체 시퀀스 T | **k 스텝만** |
| **메모리** | $O(T)$ | $O(k)$ |
| **[장기 의존성](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/291_long_term_dependency/)** | 이론적 가능 (소실 문제) | k 이내만 |
| **실무** | 짧은 시퀀스만 | **대부분 사용** |
...
| **[가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 공유** | **$W_h$ 모든 시간 단계에서 공유** | 레이어별 독립 |
...
- **[LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/) + k = 35**: PyTorch 기본 언어 모델 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/).
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[역전파](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/) ([Backpropagation](/knowledge-base/studynote/10_ai/03_llm_nlp/272_backpropagation/))** | BPTT의 기반 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) |
| **[기울기 소실](/knowledge-base/studynote/10_ai/01_ai_basics/088_vanishing_gradient_relu_skip_connection/)/폭발** | BPTT에서 T가 클 때 발생하는 문제 |
| **Truncated BPTT** | 메모리·기울기 문제 해결을 위한 절단 기법 |
| **[LSTM](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/292_lstm/)** | BPTT의 [기울기 소실](/knowledge-base/studynote/10_ai/01_ai_basics/088_vanishing_gradient_relu_skip_connection/)을 게이트로 완화 |
| **[Transformer](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/246_transformer_self_attention_parallel_positional_encoding/)** | BPTT 불필요, Self-Attention으로 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 학습 |
