...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: RAG는 **LLM이 답변 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 전에 외부 지식 저장소(벡터 DB)에서 관련 문서를 검색(Retrieve)하여 프롬프트에 포함**시킨 후 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)(Generate)하는 기법이며, [환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)([Hallucination](/knowledge-base/studynote/12_it_management/05_security_compliance/345_llm_foundation_model_hallucination/))을 줄이고 최신 정보를 반영한다.
> 2. **가치**: LLM의 파라메트릭 지식은 **학습 시점에 고정**되지만, RAG는 **외부 DB를 실시간 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)**하여 학습 이후의 최신 정보·사내 문서·[도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 지식을 반영한다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/)** | 검색+[생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) |
...
| **[환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/)** | RAG의 핵심 해결 대상 |
...
2. 교과서 없이 기억만으로 쓰면 **틀릴 수 있지만([환각](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/275_react_framework/))**, 책을 보면 정확해요.
3. AI도 **검색해서 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)**하고 답하면 더 정확해요!
