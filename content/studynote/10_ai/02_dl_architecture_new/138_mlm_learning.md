...
> 3. **판단 포인트**: MLM은 **이해(NLU)에 최적**이지만 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)에는 부적합하며, Generative 작업에는 CLM([GPT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/302_gpt_autoregressive/))·Prefix LM(T5)이 적합하다.
...
- **📢 섹션 요약 비유**: MLM은 **빈칸 채우기 시험**이다. 양쪽 [힌트](/knowledge-base/studynote/05_database/03_relational_model/167_sql_hint_optimizer_override/)를 보고 빈칸에 들어갈 단어를 맞춘다.

---

## Ⅱ~Ⅴ. 결론

MLM은 **양방향 언어 이해의 핵심 학습 방식**이며, [BERT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/301_bert_mlm/)·RoBERTa·DeBERTa의 사전 학습 기반이다.
...
| **[BERT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/301_bert_mlm/)** | MLM 기반 모델 |
...
2. 앞뒤 단어를 **모두 [힌트](/knowledge-base/studynote/05_database/03_relational_model/167_sql_hint_optimizer_override/)로** 사용해서 빈칸을 맞춰요.
