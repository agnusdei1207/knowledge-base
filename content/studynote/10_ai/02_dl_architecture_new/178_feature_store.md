...
> 1. **본질**: [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/) ([Feature Store](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/))는 모델이 사용하는 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 정의, 시점별 값, 온라인·오프라인 제공 경로를 한곳에서 관리해 학습과 추론이 같은 의미의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 보게 만드는 [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/) ([Machine Learning Operations](/knowledge-base/studynote/12_it_management/05_security_compliance/220_mlops_machine_learning_operations/)) 인프라다.
> 2. **가치**: 중복 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 엔지니어링을 줄이고, Point-in-Time Join과 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 관리를 통해 [Training](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/588_mlops_pipeline_automation/)-Serving Skew를 [억제](/knowledge-base/studynote/09_security/13_secops_ir_forensics/656_ir_containment/)하며, 여러 모델이 같은 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)를 재사용하도록 만든다.
...
[피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 "모델에 먹이는 재료를 어떻게 표준화할 것인가"에 대한 답이다. [머신러닝](/knowledge-base/studynote/10_ai/03_llm_nlp/241_machine_learning_basics/) 프로젝트에서 가장 많은 시간이 드는 작업은 종종 모델 자체보다 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 엔지니어링이다. 원천 [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)와 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/)에서 유의미한 숫자를 뽑고, 결측치를 처리하고, 윈도우 집계를 만들고, 이를 학습과 추론에 동시에 맞추는 과정이 반복되기 때문이다.
...
[피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)의 핵심은 보통 네 가지 축으로 설명된다. 첫째, [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 정의와 [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/)를 관리하는 [레지스트리](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/). 둘째, 대규모 학습 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 보관하는 오프라인 스토어. 셋째, 밀리초 단위 추론을 지원하는 온라인 스토어. 넷째, 두 경로가 같은 의미를 유지하도록 만드는 물질화(Materialization)와 시점 정합성 관리다.

| 구성 요소 | 역할 | 핵심 설계 포인트 |
| :--- | :--- | :--- |
| Feature [Registry](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) | [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 이름, 엔터티, 소유자, [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/), 정의 관리 | 검색 가능성, 거버넌스, 폐기 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) |
| Offline Store | 학습·백필(Backfill)용 대규모 시계열 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 저장 | Point-in-Time [Join](/knowledge-base/studynote/05_database/04_transactions_concurrency/521_join/), 재현성 |
| Online Store | 실시간 추론용 최신 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 캐시 | [지연 시간](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/), [TTL](/knowledge-base/studynote/03_network/06_network_layer_ip/294_ttl_time_to_live_looping_prevention/) ([Time To Live](/knowledge-base/studynote/03_network/06_network_layer_ip/294_ttl_time_to_live_looping_prevention/)), 최신성 |
| Materialization [Pipeline](/knowledge-base/studynote/12_it_management/02_itsm_itil/082_pipeline/) | 배치/스트리밍 결과를 스토어에 반영 | 오프라인·온라인 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) |
| Serving SDK / [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) | 모델이 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)를 읽는 통로 | 동일한 엔터티 키와 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 보장 |
...
- **📢 섹션 요약 비유**: 오프라인 스토어가 "지난달까지의 모든 요리 기록을 보관한 레시피 창고"라면, 온라인 스토어는 "지금 손님 주문에 바로 넣을 재료를 담아 둔 앞쪽 냉장고"이고, [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 두 곳의 재료 이름과 맛이 틀어지지 않게 맞춰 주는 주방 총괄 책임자다.
...
| :--- | :--- | :--- | :--- |
| 핵심 자산 | 분석용 정제 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | 모델 입력용 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) | 학습된 모델 [아티팩트](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/075_artifact_management_nexus_docker_registry/) |
| 주요 질문 | 어떤 지표를 분석할까 | 어떤 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)를 일관되게 쓸까 | 어떤 모델을 배포할까 |
| 시점 보존 | 보통 집계/이력 중심 | Point-in-Time 조회가 핵심 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 시점보다 모델 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 중심 |
...
| 도입 상황 | 우선순위 | 이유 |
| :--- | :--- | :--- |
| 실시간 추천·사기 탐지·광고 입찰 | 매우 높음 | 온라인 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 조회와 학습-추론 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)이 핵심 |
| 여러 팀이 같은 고객 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/)를 반복 사용 | 높음 | 재사용성과 거버넌스 효과가 큼 |
| 규제·[감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 대응이 필요한 ML [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) | 높음 | [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 출처와 시점 추적이 중요 |
| 단일 배치 모델 PoC (Proof of [Concept](/knowledge-base/studynote/14_data_engineering/02_math_mining/120_concept/)) | 낮음~중간 | 플랫폼 비용보다 실험 속도가 더 중요할 수 있음 |
...
- [Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/) 같은 온라인 캐시만 두고 이를 [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)라고 부르는 구조
- 과거 학습용 시점 정합성 없이 최신 집계값을 그대로 학습 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 붙이는 설계
- 모델마다 별도의 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 저장소를 만들어 재사용성을 잃는 운영
...
| [Model Registry](/knowledge-base/studynote/14_data_engineering/04_mlops/166_model_registry_versioning_mlflow/) | [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)와 함께 모델 계보를 완성하는 짝 구조다. |
| Drift Monitoring | [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 분포 변화와 의미 변화를 관찰해 재계산·재학습을 유도한다. |
...
1. [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)는 로봇 요리사가 먹을 재료를 미리 같은 크기로 잘라 놓는 똑똑한 냉장고예요.
