---
title: "703. 클라우드 아키텍처 핵심 토픽 703번 시험 요약 (Cloud Architecture Core Topic 703 Exam Summary)"
date: 2026-05-09
tags:
...
│   └─────────────┘   └─────────────┘   └─────────────┘            │
│        │                                                        │
│        ▼ (2006~ AWS S3/EC2, 2010~ OpenStack, 2013~ Docker)       │
│                                                                  │
...
| **Cold Start** | 없음 (상시 기동) | 10~30초 | 없음 | 100ms~3s (SnapStart로 200ms↓) | 100ms~1s |
