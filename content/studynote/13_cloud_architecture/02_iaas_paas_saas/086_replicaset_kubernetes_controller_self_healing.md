...
노드 장애나 앱 크래시가 잦은 클라우드에서는 이 자동 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)가 가용성을 지켜 준다.
...
| 요소 | 역할 | 포인트 |
|:---|:---|:---|
| desired replicas | 목표 [Pod](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/198_pod_kubernetes_minimum_deployment_unit/) 수 | spec.replicas |
...
## Ⅲ. 비교 및 연결
| 비교 항목 | ReplicaSet | [Deployment](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/087_deployment_kubernetes_workload_rolling_update/) | ReplicationController |
|:---|:---|:---|:---|
| 핵심 기능 | [Pod](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/198_pod_kubernetes_minimum_deployment_unit/) 수 유지 | 배포·롤아웃 관리 | [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 카운트 유지 |
| 업데이트 | 직접 제어 | [롤링 업데이트](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/117_rolling_update_deployment/) 지원 | 제한적 |
...
- [ ] Pod가 사라졌을 때 자동 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)가 되는지 검증한다.
- [ ] 원하는 수와 실제 수의 차이를 모니터링한다.

- ❌ ReplicaSet을 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 배포 도구로 오해하는 것
...
- **📢 섹션 요약 비유**: 개수 유지가 자동 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/)로 이어진다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| ReplicaSet | 원하는 [Pod](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/198_pod_kubernetes_minimum_deployment_unit/) 개수를 지킨다. |
| [Deployment](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/087_deployment_kubernetes_workload_rolling_update/) | 배포와 롤아웃을 관리한다. |
