...
> 3. MSP 선택 시 RACI 매트릭스와 SLA가 핵심 — 어떤 작업이 MSP의 책임이고 고객의 책임인지(RACI), 어떤 수준의 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)가 보장되는지([SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/))를 계약 전 명확히 정의하지 않으면 책임 분쟁이 지속된다.
...
3. MSP [ROI](/knowledge-base/studynote/12_it_management/01_governance_strategy/012_roi_return_on_investment/) = 전문가 효율 — 클라우드 전문가 채용보다 MSP가 비용 절감 + 인시던트 감소로 162% [ROI](/knowledge-base/studynote/12_it_management/01_governance_strategy/012_roi_return_on_investment/)!
