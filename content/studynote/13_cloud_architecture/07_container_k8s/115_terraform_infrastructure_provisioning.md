...
| 비교 | [Terraform](/knowledge-base/studynote/15_devops_sre/05_devsecops/195_terraform_hashicorp_agnostic_aws_gcp/) | CloudFormation | Pulumi |
|:---|:---|:---|:---|
| **클라우드** | **멀티** | AWS 전용 | 멀티 |
...
| 지표 | 콘솔 수동 | [Terraform](/knowledge-base/studynote/15_devops_sre/05_devsecops/195_terraform_hashicorp_agnostic_aws_gcp/) | 개선 |
|:---|:---|:---|:---|
| 인프라 재현성 | 불가 | **100%** | 코드로 보장 |
| 변경 추적 | 불가 | **Git 이력** | [감사](/knowledge-base/studynote/02_operating_system/10_security/606_auditing_linux_auditd/) 가능 |
| [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) | 시간 단위 | **분 단위** | 자동화 |

Terraform은 OpenTofu([OSS](/knowledge-base/studynote/12_it_management/05_security_compliance/191_oss_license_compliance/) Fork)와의 생태계 분화가 [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/) 중이며, [Terraform](/knowledge-base/studynote/15_devops_sre/05_devsecops/195_terraform_hashicorp_agnostic_aws_gcp/) CDK(TypeScript/Python으로 HCL [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/))로 프로그래밍 언어 생태계와 통합되고 있다.
