...
### 지원 매니페스트 형식
- **Plain YAML**, <strong><a href="/knowledge-base/studynote/13_cloud_architecture/01_virtualization/056_helm_chart/">Helm Chart</a></strong>, <strong><a href="/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/091_kustomize_kubernetes_declarative_overlay_manifest/">Kustomize</a></strong>, **Jsonnet**
...
|:---|:---|:---|:---|
| **방식** | Push | <strong>Pull (<a href="/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/119_gitops_single_source_of_truth/">GitOps</a>)</strong> | Pull ([GitOps](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/119_gitops_single_source_of_truth/)) |
| **보안** | CI에 클러스터 권한 | **클러스터 내부** | 클러스터 내부 |
| **UI** | [Jenkins](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/071_jenkins_ci_cd_pipeline_automation/) 대시보드 | <strong>리소스 트리 <a href="/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/">시각화</a></strong> | CLI 중심 |
| <strong><a href="/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/">CNCF</a></strong> | - | **Graduated** | Graduated |
...
2. <strong><a href="/knowledge-base/studynote/09_security/11_iam_access_control/569_rbac/">RBAC</a></strong>: Argo CD 프로젝트별 접근 제어.
...
| 개념 | 연결 포인트 |
|:---|:---|
| <strong><a href="/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/119_gitops_single_source_of_truth/">GitOps</a></strong> | Argo CD가 구현하는 배포 패러다임 |
...
| <strong><a href="/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/207_helm_kubernetes_package_manager_chart/">Helm</a> / <a href="/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/091_kustomize_kubernetes_declarative_overlay_manifest/">Kustomize</a></strong> | Argo CD가 지원하는 매니페스트 형식 |
| <strong><a href="/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/">Config</a> Repo 패턴</strong> | 앱 코드와 매니페스트 레포 분리 |
