...
📢 **섹션 요약 비유**: Schema-on-Write는 공항 입국 심사와 같다. 비행기에서 내릴 때(저장 전) 여권·비자([스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/))를 검사하여 통과한 사람만 입국(저장)할 수 있다. 입국한 사람은 모두 신원이 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)된 상태다.
...
### [Schema-on-Write](/knowledge-base/studynote/14_data_engineering/01_infrastructure/010_schema_on_write/) vs [Schema-on-Read](/knowledge-base/studynote/14_data_engineering/01_infrastructure/009_schema_on_read/) 완전 비교
...
| 상황 | [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
|:---|:---|
| 고정된 BI [KPI](/knowledge-base/studynote/12_it_management/01_governance_strategy/018_kpi/), 정기 리포트 | [Schema-on-Write](/knowledge-base/studynote/14_data_engineering/01_infrastructure/010_schema_on_write/) ([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)) 적합 |
| 탐색적 분석, ML [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) | [Schema-on-Read](/knowledge-base/studynote/14_data_engineering/01_infrastructure/009_schema_on_read/) (레이크) 적합 |
| 두 요건 모두 | [레이크하우스](/knowledge-base/studynote/16_bigdata/07_data_lake/146_lakehouse/) ([Medallion Architecture](/knowledge-base/studynote/14_data_engineering/04_mlops/194_medallion_architecture_bronze_silver_gold/)) |
| [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 변경 잦음 | [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) [레지스트리](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) + Avro/Protobuf 활용 |

**기술사 핵심 판단**: 시험에서는 Schema-on-Write를 "[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 품질 보장"의 긍정적 측면과 "[스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 경직성·변경 비용"의 트레이드오프를 함께 서술하고, 현대적 [레이크하우스](/knowledge-base/studynote/16_bigdata/07_data_lake/146_lakehouse/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)으로의 진화 맥락을 연결한다.

📢 **섹션 요약 비유**: Schema-on-Write의 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) 변경은 건물 설계를 바꾸는 것과 같다. 처음 지을 때 튼튼하게 설계했지만(품질 우수), 나중에 방 하나 추가하려면 전체 구조를 다시 검토해야 한다(변경 비용 고비용).
...
| 개념 | 연결 포인트 |
|:---|:---|
| [Schema-on-Read](/knowledge-base/studynote/14_data_engineering/01_infrastructure/009_schema_on_read/) | 대립 개념, [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)의 핵심 철학 |
| [ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/) | [Schema-on-Write](/knowledge-base/studynote/14_data_engineering/01_infrastructure/010_schema_on_write/) 구현의 핵심 메커니즘 |
| [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) | Schema-on-Write의 주요 적용 플랫폼 |
| [ELT](/knowledge-base/studynote/14_data_engineering/01_infrastructure/034_elt/) | ETL의 현대적 대안, 변환 단계를 [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 내부로 이동 |
| [레이크하우스](/knowledge-base/studynote/16_bigdata/07_data_lake/146_lakehouse/) | Schema-on-Write와 Schema-on-Read를 Zone별 결합 |
| [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) [레지스트리](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) | [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/) [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 관리로 드리프트 방지 |
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 품질 ([Data Quality](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/270_data_quality_great_expectations/)) | Schema-on-Write가 보장하는 핵심 가치 |

### 👶 어린이를 위한 3줄 비유 설명
1. Schema-on-Write는 학교 급식실에서 음식을 담을 때, 반찬 종류와 양을 미리 정해서 담는 것처럼, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 저장하기 전에 정해진 형식에 맞게 정리한다.
