...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">퍼시스턴트 볼륨 스토리지 분리가 필요한 이유: 선언 상태와 실제 상태의 차이를 줄임</div></div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">퍼시스턴트 볼륨 스토리지 분리 핵심 원리</div></div>
