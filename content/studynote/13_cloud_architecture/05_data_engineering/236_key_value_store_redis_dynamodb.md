...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [키-값 저장소](/knowledge-base/studynote/14_data_engineering/01_infrastructure/036_key_value/)([Key-Value Store](/knowledge-base/studynote/14_data_engineering/01_infrastructure/036_key_value/))는 고유한 키([Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/))로 값(Value)을 O(1) 시간에 조회하는 가장 단순한 [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) 구조로, **밀리초 이하 응답 속도**가 핵심 가치다.
> 2. **가치**: Redis는 인메모리 기반으로 문자열·해시·리스트·셋·정렬셋 등 **풍부한 자료구조**를 제공해 [세션](/knowledge-base/studynote/02_operating_system/02_process_thread/160_session_controlling_terminal/)·캐시·리더보드에, DynamoDB는 완전관리형 [서버리스](/knowledge-base/studynote/12_it_management/05_security_compliance/206_serverless_cold_start/)로 **무한 확장**에 적합하다.
> 3. **판단 포인트**: Redis는 단일 서버 메모리 용량이 한계이므로 대용량 영구 저장은 DynamoDB가 적합하고, 두 시스템을 **[DynamoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/545_dynamodb/) DAX(캐시) + [DynamoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/545_dynamodb/)(영구)**처럼 조합하는 패턴이 일반적이다.
...
**[키-값 저장소](/knowledge-base/studynote/14_data_engineering/01_infrastructure/036_key_value/) 주요 사용 사례:**
- **[세션 관리](/knowledge-base/studynote/04_software_engineering/08_security_compliance_devsecops/507_session_management_security/)**: [로그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/)인 사용자 [세션](/knowledge-base/studynote/02_operating_system/02_process_thread/160_session_controlling_terminal/) 토큰 저장 ([TTL](/knowledge-base/studynote/03_network/06_network_layer_ip/294_ttl_time_to_live_looping_prevention/) 자동 만료)
...
- **[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 락**: [동시성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/014_concurrency/) 제어 (Redlock [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/))
- **[Rate Limiting](/knowledge-base/studynote/09_security/05_web_app_security/520_rate_limiting/)**: [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 요청 속도 제한 (Sliding Window)
...
| 옵션 | 설명 | 특성 |
|:---|:---|:---|
| **RDB ([Snapshot](/knowledge-base/studynote/02_operating_system/10_security/637_zfs_snapshot_cow_architecture/))** | 주기적 [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 저장 | 빠른 [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/), 마지막 [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/) 이후 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 손실 |
...
| **응답 속도** | 마이크로초~밀리초 | 밀리초 |
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 크기** | 수십GB ~ 수TB | 무제한 |
...
| **[트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)** | 제한적 (MULTI/EXEC) | ACID (같은 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)) |
...
| 패턴 | 설명 | 특성 |
|:---|:---|:---|
| **Cache Aside ([Lazy](/knowledge-base/studynote/06_ict_convergence/05_data_science/380_computational_graph_lazy_eager_execution/))** | 캐시 미스 시 앱이 DB 조회 후 캐시 저장 | 가장 일반적 |
...
| **[Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/) 메모리 한계** | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 메모리를 초과하면 Eviction 발생 |
| **[DynamoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/545_dynamodb/) 비용** | 읽기/[쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 단위([RCU](/knowledge-base/studynote/02_operating_system/04_synchronization/254_rcu_read_copy_update/)/WCU)로 과금, 예측 어려움 |
| **핫 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/)** | [DynamoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/545_dynamodb/) PK 설계 오류 시 특정 [파티션](/knowledge-base/studynote/02_operating_system/09_file_system/514_partition_slice_volume/) 과부하 |
