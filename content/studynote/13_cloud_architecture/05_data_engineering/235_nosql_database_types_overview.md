...
### [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) 4가지 유형 상세

#### 1. [Key-Value Store](/knowledge-base/studynote/14_data_engineering/01_infrastructure/036_key_value/)
```
...
#### 2. [Document Store](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/)
```
구조: JSON/BSON 계층 문서
{
  "_id": "order_001",
...
📢 **섹션 요약 비유**: Wide-Column은 스프레드시트를 세로로 무한 확장한 것이다. 각 행([IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 기기)의 열(측정값)이 기기마다 달라도 되고, 수십억 행도 여러 서버에 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)해 저장할 수 있다.
...
📢 **섹션 요약 비유**: [폴리글랏 퍼시스턴스](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/308_pgvector/)는 도구 상자에 다양한 공구를 갖추는 것이다. 나사엔 드라이버, 못엔 망치, 파이프엔 렌치를 쓰듯이, 각 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 요건에 맞는 DB를 선택하는 것이 최선이다.
...
📢 **섹션 요약 비유**: NoSQL은 전문 레스토랑 체인과 같다. 각 레스토랑(DB)은 해당 음식(액세스 패턴)에서 최고지만, 여러 레스토랑을 동시에 운영하는 관리(폴리글랏 운영)는 복잡하다. 처음엔 RDBMS 하나로 시작하고, 병목 지점이 생기면 전문 NoSQL을 도입하는 단계적 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)이 현명하다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [CAP](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/341_process/) 정리 | NoSQL이 RDBMS와 다른 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/)·[가용성](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/) 트레이드오프 |
| [Key-Value Store](/knowledge-base/studynote/14_data_engineering/01_infrastructure/036_key_value/) ([Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/)) | [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) 4가지 유형 중 가장 단순·고속 |
| [Document Store](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/) ([MongoDB](/knowledge-base/studynote/05_database/04_transactions_concurrency/540_mongodb/)) | 유연한 [JSON](/knowledge-base/studynote/11_design_supervision/06_exam_summary/343_json/) 구조, [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/)리스 |
| Wide-Column ([Cassandra](/knowledge-base/studynote/05_database/04_transactions_concurrency/541_cassandra/)) | 시계열·대용량 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/) 특화 |
| [Graph DB](/knowledge-base/studynote/14_data_engineering/01_infrastructure/039_graph_db/) (Neo4j) | [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/) 탐색 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) 특화 |
| [폴리글랏 퍼시스턴스](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/308_pgvector/) | 여러 DB를 목적에 맞게 혼용하는 아키텍처 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
| ACID vs BASE | RDBMS와 NoSQL의 [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 모델 차이 |

### 👶 어린이를 위한 3줄 비유 설명
1. NoSQL의 4가지 종류는 4가지 장난감 수납 방법이다. 키-값은 라벨 달린 상자(빠른 찾기), 도큐먼트는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 폴더(자세한 내용), 와이드컬럼은 대형 선반(엄청 많은 양), [그래프](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/070_graph_datastructure/)는 거미줄(연결 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/))이다.
