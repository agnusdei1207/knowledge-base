...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">마이크로VM (파이어크래커) 서버리스 초고속 부팅 보안 격리가 필요한 이유: 요구사항과 운영 현실의 간극을 줄임</div></div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">마이크로VM (파이어크래커) 서버리스 초고속 부팅 보안 격리 핵심 원리</div></div>
