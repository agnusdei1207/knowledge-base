...
> 1. **본질**: 코드 재배포 없이 런타임에 특정 기능을 ON/OFF하거나 특정 사용자 그룹에게만 노출하는 소프트웨어 조건 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)다.
> 2. **가치**: 배포(Deploy)와 출시(Release)를 분리하여, 코드가 프로덕션에 존재하더라도 비즈니스 결정 시점에 기능을 노출할 수 있는 유연성을 제공한다.
> 3. **판단 포인트**: [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)는 [기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/)가 될 수 있으므로, [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/) [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 시 만료일·책임자·용도를 명시하고 완료 후 반드시 코드에서 제거해야 한다.
...
📢 **섹션 요약 비유**: [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)는 새 조명을 집에 설치해두고 전기 연결만 잠깐 끊어두는 것과 같다. 조명은 이미 설치됐지만 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)만 ON/OFF하면 언제든지 켤 수 있다. 공사(배포)와 개통(출시)이 완전히 분리된다.

---

## Ⅱ. 아키텍처 및 핵심 원리

### [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) 유형 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)

| 유형 | 수명 | 사용 목적 |
|:---|:---:|:---|
| Release Toggle | 단기 (수 일~수 주) | 미완성 기능 숨기기, Trunk-based 개발 |
| Experiment Toggle | 중기 (수 주~수 달) | A/B 테스트, 통계적 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) |
| Ops Toggle | 단기~장기 | 운영 비상 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/), 기능 긴급 비활성화 |
...
📢 **섹션 요약 비유**: [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) 관리 서버는 마치 중앙 전등 제어반과 같다. 건물 안 어떤 방의 어떤 조명이든 원격에서 ON/OFF할 수 있고, 특정 층만, 특정 호실만, 또는 모든 방 동시에 제어 가능하다.

---

## Ⅲ. 비교 및 연결

### [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) vs [카나리 배포](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/115_canary_deployment_gradual_rollout/) vs A/B 테스트

| 기준 | [Feature Flag](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) | [Canary Release](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/195_canary_release_deployment/) | A/B Test |
|:---|:---|:---|:---|
| 제어 단위 | 기능(Feature) | 서버 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) | UI 변형 |
| 변경 방법 | 런타임 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) | 배포 | 런타임 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) |
| 통계 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) | 선택적 | 아님 | 필수 |
| 즉시 [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/) | ✅ ([플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/) OFF) | 빠름 | ✅ |
| 코드 재배포 | ❌ 불필요 | ✅ 필요 | ❌ 불필요 |

### [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) [기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/) 관리
...
📢 **섹션 요약 비유**: [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)를 관리하지 않으면 집 안에 쓸모없는 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)가 수백 개 쌓이는 것과 같다. 어떤 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)가 뭘 켜는지 모르게 되고, 잘못 건드리면 예상치 못한 곳이 꺼진다.
...
📢 **섹션 요약 비유**: [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)는 마술 지팡이와 같다. 올바르게 사용하면 원하는 기능을 원하는 사람에게만, 원하는 시간에 나타나게 할 수 있다. 하지만 지팡이를 너무 많이 만들면 어떤 지팡이가 어떤 마법인지 아무도 모르게 된다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [Trunk-Based Development](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/040_trunk_based_development/) | [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) 없이는 TBD가 미완성 기능 노출 위험 |
| [Canary Release](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/195_canary_release_deployment/) | [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)와 결합하면 더 정밀한 점진 출시 구현 |
| A/B Testing | Experiment Toggle이 A/B 테스트의 인프라 구현체 |
| LaunchDarkly / Unleash | [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) 관리 플랫폼의 대표 도구 |
| [기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/) | 미제거 [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/)가 누적되는 [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/) 지옥 |
| 킬 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) | Ops Toggle로 장애 시 즉각 기능 비활성화 |

### 👶 어린이를 위한 3줄 비유 설명

1. [피처 플래그](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/576_feature_flag_ab_testing_rollout/)는 장난감 가게에서 새 장난감을 진열장에 올려두되, 포장 상자를 아직 안 뜯어둔 것과 같아.
