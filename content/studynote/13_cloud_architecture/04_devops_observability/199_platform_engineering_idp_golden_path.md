...
📢 **섹션 요약 비유**: [플랫폼 엔지니어링](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/109_platform_engineering_cognitive_load/)은 도시가 개인에게 "도로 공사법을 배워서 직접 도로를 만들라"고 하지 않고, 시청(플랫폼 팀)이 잘 닦인 도로(골든 패스)를 미리 만들어 누구나 쉽게 이용하게 하는 것이다.
...
| 셀프서비스 | 없음 (티켓 요청) | IDP를 통한 즉시 [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) |
| [DORA](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/523_dhcp_dora_process/) 목표 | 팀별 달성 | 플랫폼으로 조직 전체 향상 |

### 주요 [IDP](/knowledge-base/studynote/09_security/11_iam_access_control/536_idp_identity_provider/) 도구 비교
...
| 개념 | 연결 포인트 |
|:---|:---|
| [IDP](/knowledge-base/studynote/09_security/11_iam_access_control/536_idp_identity_provider/) ([Internal Developer Platform](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/200_internal_developer_platform_backstage/)) | [플랫폼 엔지니어링](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/109_platform_engineering_cognitive_load/)의 핵심 산출물 |
| Backstage ([CNCF](/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/)) | 가장 많이 사용되는 [오픈소스](/knowledge-base/studynote/12_it_management/05_security_compliance/191_oss_license_compliance/) [IDP](/knowledge-base/studynote/09_security/11_iam_access_control/536_idp_identity_provider/) 프레임워크 |
| Team Topologies | 플랫폼 팀 조직 설계의 이론적 토대 |
| 골든 패스 (Golden Path) | 플랫폼이 제공하는 표준화된 권장 경로 |
| [인지 부하](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/686_cognitive_load_team_topologies/) ([Cognitive Load](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/686_cognitive_load_team_topologies/)) | [플랫폼 엔지니어링](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/109_platform_engineering_cognitive_load/)이 해결하려는 핵심 문제 |
| [DORA Metrics](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/201_dora_metrics_devops_performance/) | 플랫폼 도입 효과를 측정하는 조직 성과 지표 |

### 👶 어린이를 위한 3줄 비유 설명

1. [플랫폼 엔지니어링](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/109_platform_engineering_cognitive_load/)은 학교 급식처럼, 학생들이 요리법을 배울 필요 없이 맛있는 밥이 미리 준비되어 있는 것과 같아.
