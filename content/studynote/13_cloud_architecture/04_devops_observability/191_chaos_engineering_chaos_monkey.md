...
### [카오스 엔지니어링](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/751_chaos_engineering/) 실험 절차

| 단계 | 설명 |
|:---|:---|
| 1. Steady [State](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 정의 | 시스템이 정상인 상태를 측정 가능한 지표로 명확히 정의 |
| 2. 가설 수립 | "이 장애를 주입해도 Steady State가 유지될 것이다" |
| 3. 실험 설계 | 최소 폭발 반경(Blast [Radius](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/541_radius_remote_authentication_aaa/)) 최소화, 단계적 확대 |
| 4. 실험 실행 | 자동화 도구([Chaos Monkey](/knowledge-base/studynote/15_devops_sre/03_sre_observability/149_chaos_monkey_chaos_mesh/), LitmusChaos, Gremlin)로 주입 |
| 5. 결과 분석 | Steady [State](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 이탈 여부 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 및 근본 원인 파악 |
| 6. 개선 반영 | 취약점 보강 후 재실험으로 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) |
...
| 목적 | 미지의 취약점 발견 | 절차 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) | [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 한계 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) |
| 빈도 | 지속적 자동화 | 연 1~2회 | 릴리즈 전 |
| 핵심 도구 | [Chaos Monkey](/knowledge-base/studynote/15_devops_sre/03_sre_observability/149_chaos_monkey_chaos_mesh/), LitmusChaos, Gremlin | [DR](/knowledge-base/studynote/03_network/07_network_layer_routing/360_ospf_dr_bdr_designated_router_lsa_flooding/) [플레이북](/knowledge-base/studynote/09_security/13_secops_ir_forensics/637_playbook/) | JMeter, Gatling |

### [CNCF](/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/) 도구 비교
...
| 개념 | 연결 포인트 |
|:---|:---|
| [서킷 브레이커](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/307_circuit_breaker_pattern/) ([Circuit Breaker](/knowledge-base/studynote/12_it_management/05_security_compliance/304_circuit_breaker/)) | 카오스 실험으로 실제 동작 여부를 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)하는 핵심 대상 |
| [Observability](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/642_observability_telemetry/) (관찰성) | Steady [State](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 측정과 이탈 감지를 위한 필수 인프라 |
| [SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) [Error Budget](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/101_error_budget_sre/) | 카오스 실험 허용 범위를 Error Budget으로 관리 |
| LitmusChaos / Chaos [Mesh](/knowledge-base/studynote/01_computer_architecture/10_parallel_processing_architecture/389_mesh_topology/) | K8s 환경의 [CNCF](/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/) 공인 [카오스 엔지니어링](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/751_chaos_engineering/) 도구 |
| GameDay | 팀 전체가 참여하는 카오스 실험 이벤트 |
| 폭발 반경 (Blast [Radius](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/541_radius_remote_authentication_aaa/)) | 실험 영향 범위를 최소화하는 설계 원칙 |

### 👶 어린이를 위한 3줄 비유 설명

1. 레고 탑이 얼마나 튼튼한지 보려고 일부러 한 조각을 빼보는 것처럼, [카오스 엔지니어링](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/751_chaos_engineering/)은 서버를 일부러 꺼봐서 나머지가 잘 버티는지 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)해.
