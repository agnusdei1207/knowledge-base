...
클라우드 도입 초기에는 "[온프레미스](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/061_on_premise_legacy_infrastructure/) 대비 비용 절감"이 명분이었다. 그러나 실제 클라우드 사용량이 늘면서 예상치 못한 비용 폭증, 좀비 리소스(사용하지 않는 인스턴스), 과다 프로비저닝이 새로운 문제로 등장했다. Gartner 연구에 따르면 기업 클라우드 지출의 약 35%가 낭비되고 있다.

[FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/)(Financial Operations)는 이 문제를 해결하기 위해 [FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) Foundation이 체계화한 클라우드 재무 관리 프레임워크다. "클라우드를 사용하는 모든 사람이 비용 의식을 갖는" 문화와 "엔지니어링 속도를 포기하지 않는" 균형을 추구한다.
...
| 단계 | 핵심 활동 | 도구/방법 |
|:---|:---|:---|
| **Inform** | 비용 가시성 확보, 팀·[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)별 할당 | AWS Cost Explorer, 태깅 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) |
| **Optimize** | 미사용 리소스 제거, RI/[SP](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/166_sp/) 구매, 적정 사이징 | Reserved Instance, Spot, Rightsizing |
...
**[FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) 조직 구조 ([FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) Foundation 모델)**:
- **[FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) Practitioner**: 비용 최적화를 조율하는 중앙 팀
...
| 개념 | 연결 포인트 |
|:---|:---|
| 태깅 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | [FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) 가시성(Inform)의 출발점 |
| Reserved Instance / Savings Plans | [FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) 최적화(Optimize) 핵심 도구 |
| [Spot Instance](/knowledge-base/studynote/06_ict_convergence/03_cloud_infrastructure/209_spot_instance_cloud_cost_optimization/) | 배치 워크로드 비용 최대 90% 절감 |
| 자동화 스케줄링 | 개발/테스트 환경 야간 셧다운으로 즉각 절약 |
| 단위 비용 (Unit Economics) | 비즈니스 KPI와 클라우드 비용을 연결하는 지표 |
| [FinOps](/knowledge-base/studynote/12_it_management/05_security_compliance/344_finops/) Foundation | 프레임워크 표준화 및 자격증 운영 기관 |
