...
**Golden [Signals](/knowledge-base/studynote/09_security/12_identity_threat_advanced/611_conditional_access_signals/) 기반 [Grafana](/knowledge-base/studynote/16_bigdata/08_visualization/168_grafana/) 대시보드 구성:**
...
**행 2: [Latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/) 패널**
- p50/p95/p99 레이턴시 추이
...
**[Latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/) 측정의 핵심**: 평균(average)이 아닌 백분위수(percentile) 사용 필수
