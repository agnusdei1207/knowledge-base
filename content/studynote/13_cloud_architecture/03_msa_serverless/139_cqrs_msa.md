...
<div class="kb-diagram-note">쓰기 모델: INSERT/UPDATE → 정규화 RDBMS (정합성↑)</div>
<div class="kb-diagram-note">이벤트 발행: Outbox → Kafka → 프로젝션</div>
<div class="kb-diagram-note">읽기 모델: SELECT → 비정규화 뷰/ElasticSearch (성능↑)</div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row"><div class="kb-diagram-node">CRUD (단일 모델)</div><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">CQS (Bertrand Meyer, 1988)</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">CQRS (Greg Young, 2010)</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">CQRS + Event Sourcing (2012~)</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">→</div><div class="kb-diagram-node">현재: Axon Framework — CQRS+ES 통합</div></div>
</div>
</div>
