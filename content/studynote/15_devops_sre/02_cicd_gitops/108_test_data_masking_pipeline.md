...
개발자들이 가장 싫어하는 것은 로컬에서 가짜 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)([Mock](/knowledge-base/studynote/04_software_engineering/11_testing_validation/462_mock_test_double/) [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))로 테스트했을 때는 완벽했는데, 막상 상용 서버에 배포하니 예상치 못한 진짜 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 기괴한 패턴 때문에 버그가 터지는 상황이다. 이 때문에 개발자는 항상 "운영 DB 좀 테스트 서버로 떠주세요"라고 애원한다.

하지만 실제 고객의 주민번호, 연락처, 카드 번호를 개발망([망분리](/knowledge-base/studynote/12_it_management/05_security_compliance/182_network_separation_model/) 외곽)으로 무단 반출하는 것은 보안 사고의 1순위 원인이자 강력한 법적 처벌 대상이다. 그렇다고 수작업으로 사람이 엑셀을 열고 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 조작하면 하루 종일 걸려 [애자일](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/004_agile_relation/)([Agile](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/004_agile_relation/)) 사이클이 박살 난다. 따라서 [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/)/CD 배포 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인의 일부로, 운영 DB의 [스냅샷](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/022_snapshot_backup_architecture/)을 뜰 때 보안 엔진을 통과시켜 민감 정보만 즉시 수학적으로 오염(Masking)시킨 뒤 테스트 DB에 꽂아주는 완전 자동화 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인 구축이 현대 DevSecOps의 핵심 과제로 떠올랐다.
...
안전한 [테스트 데이터](/knowledge-base/studynote/04_software_engineering/11_testing_validation/444_test_data_management/)를 확보하는 3가지 접근법을 비교한다.
...
- **📢 섹션 요약 비유**: 과거에는 자동차 충돌 테스트를 위해 사람이 직접 타거나([운영 환경 테스트](/knowledge-base/studynote/04_software_engineering/11_testing_validation/468_testing_in_production/)의 위험성), 골판지 박스([Mock](/knowledge-base/studynote/04_software_engineering/11_testing_validation/462_mock_test_double/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))를 썼습니다. [데이터 마스킹](/knowledge-base/studynote/09_security/16_data_privacy/819_data_masking/) [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인은 사람과 똑같은 뼈와 관절을 가진, 피만 흘리지 않는 '안전한 [더미](/knowledge-base/studynote/04_software_engineering/11_testing_validation/459_dummy_test_double/) 인형'을 공장에서 매일 무한대로 찍어내 테스트 차량에 태워주는 최고의 충돌 실험실입니다.
