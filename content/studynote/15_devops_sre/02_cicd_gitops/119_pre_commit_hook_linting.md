...
> 2. **가치**: CI에서 린트를 실행하면 커밋->푸시->[CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/) 실패->수정->재커밋의 <strong><a href="/knowledge-base/studynote/15_devops_sre/01_culture_methodology/005_feedback_loop/">피드백 루프</a>가 10분 이상</strong>이지만, Pre-commit Hook은 커밋 시점에 <strong>즉시(수 초) 피드백</strong>하여 불량 코드가 리포지토리에 들어가는 것을 원천 차단한다.
...
| 비교 | [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/) 린트만 | Pre-commit + [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/) |
|:---|:---|:---|
| **피드백 시간** | 10분+ | **수 초** |
| **불량 코드 커밋** | 가능 | **차단** |
| <strong><a href="/knowledge-base/studynote/15_devops_sre/01_culture_methodology/058_dx_developer_experience/">개발자 경험</a></strong> | 느린 루프 | **즉시 수정** |
...
| 지표 | [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/) 린트만 | Pre-commit | 개선 |
|:---|:---|:---|:---|
...
| [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/) 실패율 | 높음 | **낮음** | 효율 ^ |
...
| <strong><a href="/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/">CI</a> 린트</strong> | Pre-commit의 보완 (이중 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)) |
...
2. 보안 검색은 **몇 초만에 끝나서** 공항([CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/874_configuration_item/))까지 가지 않아도 바로 알 수 있어요.
