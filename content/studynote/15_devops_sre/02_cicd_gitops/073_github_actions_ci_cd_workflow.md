...
GitHub Actions는 [CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/)/CD라는 거대하고 무거운 인프라 엔지니어링의 영역을, 개발자 누구나 숨 쉬듯 사용할 수 있는 '코드의 일부([Pipeline as Code](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/072_declarative_pipeline_jenkinsfile_as_code/))'로 추락(대중화)시킨 가장 위대한 [데브옵스](/knowledge-base/studynote/04_software_engineering/uncategorized/652_devops_calms_culture/) 혁명이다.
