...
← **이전**: [[096_k8s_sealed_secrets_gitops_encryption|96. K8s Sealed Secrets - GitOps 시크릿 암호화 관리]]
**다음**: [[098_rollback_strategy_pipeline_error_threshold|98. 롤백 (Rollback) 전략 - 파이프라인 에러율 기반 자동 복구]] →
