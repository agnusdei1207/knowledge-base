...
| :-- | :-- |
| Branch | 변경 분리 |
| [[153_requirements_review_inspection_walkthrough|Review]] | 품질 검토 |
| [[090_configuration_item|CI]] | 자동 [[395_verification_process_review|검증]] |
| Merge | 본선 반영 |

PR은 사람의 판단과 자동 [[395_verification_process_review|검증]]이 만나는 지점이다.

- **📢 섹션 요약 비유**: 선생님이 내용 [[396_validation|확인]]을 하고, 계산기가 숫자를 다시 보는 과정이다.
...
1. 리뷰 규칙이 있는가?
2. [[090_configuration_item|CI]] 통과 후 머지하는가?
3. 작은 단위로 PR을 내는가?
4. 승인 책임이 분명한가?
5. 변경 이력이 추적되는가?
...
기술사 관점에서는 PR을 "검토와 [[395_verification_process_review|검증]]을 포함한 [[079_change_enablement|변경 관리]]"로 설명해야 한다.

- **📢 섹션 요약 비유**: 결과만 던지지 말고, [[396_validation|확인]]받고 들어가야 한다.
...
- **📢 섹션 요약 비유**: 문 앞에서 [[396_validation|확인]]받고 들어가는 입장 절차다.
