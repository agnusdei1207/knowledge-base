...
개발, [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/), 운영을 브랜치와 연결하면 릴리스 상태를 명확하게 추적할 수 있다.
...
| 브랜치 | 의미 |
| :-- | :-- |
| main | [기준선](/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/) |
| dev | 개발 환경 |
| staging | 사전 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) |
| prod | 운영 반영 |
...
| [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | 특징 | 강점 | 한계 |
| :-- | :-- | :-- | :-- |
| [GitHub Flow](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/054_github_flow/) | 단순 | 빠른 CD | 환경 표현 약함 |
...
기술사 관점에서는 GitLab Flow를 환경 중심 배포 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)으로 보고, 운영 통제와 릴리스 추적성을 강조해야 한다.
