...
← **이전**: [[221_k8s_clusterip_nodeport_loadbalancer_ingress|221. K8s 서비스 퍼블리싱 (ClusterIP, NodePort, LoadBalancer, Ingress) 라우팅 패러다임]]
**다음**: [[223_csi_container_storage_interface_pv|223. CSI (Container Storage Interface) 퍼시스턴트 볼륨(PV/PVC) 동적 스토리지 할당]] →
