...
| Compute Engine | SQL·[ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/)·ML 실행 | Spark, Trino, Flink 연계 |



<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">files metadata</div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Object Store</div><div class="kb-diagram-cell">▶</div><div class="kb-diagram-cell">Table Format</div><div class="kb-diagram-cell">▶</div><div class="kb-diagram-cell">Catalog</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">batch / stream</div><div class="kb-diagram-cell">snapshots</div><div class="kb-diagram-cell">policy</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">ETL / ML</div><div class="kb-diagram-cell">ACID Table</div><div class="kb-diagram-cell">BI / Query</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-note">Data Lake</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">Warehouse-grade Metadata</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">ACID Table Format</div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-note">Lakehouse + BI/ML/DataOps Integration</div>
</div>
</div>
