...
<div class="kb-diagram-row"><div class="kb-diagram-node">컨테이너 도커 이미지 레이어</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">컨테이너 도커 이미지 레이어 (Container Docker Image Layer)</div></div>
