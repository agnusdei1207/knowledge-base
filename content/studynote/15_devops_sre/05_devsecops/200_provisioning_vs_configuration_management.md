...
| 비교 축 | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/) | [Provisioning](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) |
|:---|:---|:---|
| 중심 목표 | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)의 목적에 맞춘 제어와 자동화 | 더 전통적이거나 대안적인 운영 방식 |
...
1. [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)의 목표 지표가 명확한가?
...
기술사 답안에서는 "도입"만 쓰지 말고, [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)가 어떤 상황에서는 채택되고 어떤 상황에서는 단계적으로 적용되어야 하는지를 비용, 복잡도, 보안, 운영 역량 기준으로 분리해 적는 것이 좋다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [Ansible](/knowledge-base/studynote/15_devops_sre/05_devsecops/198_ansible_os_configuration_management_ssh/) | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)를 이해할 때 직접 연결되는 기반 개념 |
| Idempotent [Task](/knowledge-base/studynote/02_operating_system/02_process_thread/150_task/) | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)의 설계·운영 판단 기준을 보완하는 개념 |
| [Terraform](/knowledge-base/studynote/15_devops_sre/05_devsecops/195_terraform_hashicorp_agnostic_aws_gcp/) | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)를 자동화·확장 측면에서 연결하는 개념 |
| CloudFormation | [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/) 적용 후 후속 발전 방향을 설명하는 개념 |
...
### 👶 어린이를 위한 3줄 비유 설명
1. [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) vs [구성 관리](/knowledge-base/studynote/12_it_management/02_itsm_itil/873_configuration_management/)는 복잡한 일을 순서와 규칙으로 정리해서 실수하지 않게 도와주는 방법이에요.
