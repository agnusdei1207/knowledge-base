...
기술사 답안에서는 Buffer/Queue Telemetry를 단순 "큐 모니터링"이 아니라, <strong>경계 포화의 선행 지표, 파생 지표(time-to-drain), autoscaling/backpressure 연계, DLQ 해석, per-partition skew</strong>까지 포함해 설명해야 한다.
