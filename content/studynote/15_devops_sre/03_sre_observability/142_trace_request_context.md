...
> 3. **판단 포인트**: W3C Trace [Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/)(traceparent: 00-traceId-spanId-flags)가 표준이며, B3(Zipkin)에서 W3C로 수렴 중이다. [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/945_service_mesh_istio/)([Istio](/knowledge-base/studynote/12_it_management/05_security_compliance/945_service_mesh_istio/))가 자동 전파를 지원한다.
...
<- **이전**: [141. 분산 트레이싱 (Distributed Tracing) - MSA 요청 흐름 추적](/knowledge-base/studynote/15_devops_sre/03_sre_observability/141_distributed_tracing_msa_request_flow/)
**다음**: [143. Span 상세 - 서비스·오퍼레이션 단위 추적](/knowledge-base/studynote/15_devops_sre/03_sre_observability/143_span_service_operation_unit/) ->
