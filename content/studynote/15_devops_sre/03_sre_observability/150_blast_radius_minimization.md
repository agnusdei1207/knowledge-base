...
블라스트 반경 최소화(Blast [Radius](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/541_radius_remote_authentication_aaa/) Minimization)를 K8s 인프라와 배포 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인([CI](/knowledge-base/studynote/12_it_management/02_itsm_itil/090_configuration_item/)/CD) 심장에 내재화 융합시키면, 장애는 더 이상 회사를 파산시키는 대재앙의 공포가 아니라, 매일 대낮에 일어나는 코딱지만 한 찰과상 모기 물림 수준의 일상(Routine)으로 치환 격하된다.
