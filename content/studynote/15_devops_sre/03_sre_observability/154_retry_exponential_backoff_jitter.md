...
| <strong><code>503 Service Unavailable</code></strong> | **[일시적 과부하 뻗음 💥]** "아 ㅆㅂ 나 지금 배포(Deploy) 중이거나 잠시 램 터져서 기절했음 1분만 기달 ㅠ." | **[지수 백오프 텐트 록온 🚀]** 1초 ➔ 3초 ➔ 7초 넉넉히 서버 심호흡 부팅 [회복](/knowledge-base/studynote/05_database/04_transactions_concurrency/233_recovery_database_restoration_overview/) 숨통 시간 열어주며 핑퐁 찔러 인공호흡 쳐 생존 돌파. |
| <strong><code>504 Gateway Timeout</code></strong> | **[일시적 핑 미아 💀]** "야 내가 찔렀는데 인터넷 허공 랜선에서 짤려 응답이 안 옴 좆망 ㅋ." | <strong><a href="/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/194_idempotency/">멱등성([Idempotency</a>) 절대 검열 사살 방폭문 🛡️]</strong> 야 씨발 잠깐 멈춰 쾅!! 결제 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 찔렀는데 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) 난 거면 ➔ 상대방은 돈 빼갔는데 응답 텍스트만 내게 오다 끊긴 거일 수도 있어 💀!! 걍 무지성 2번 재시도 때리면 유저 통장 돈 2번 이중 과금 폭파 멸망 파산 소송 터짐 쾅 🪓!! <strong><a href="/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/171_idempotency_iac_terraform/">하늘이 두 쪽 나도 "이 주문번호 123번 재시도요 ㅋ" [멱등성</a> 키(<a href="/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/">Key</a>) 텍스트를 헤더에 쑤셔 박아 무결점 스캔 검열 <a href="/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/">확인</a> 후 찔러 록온 박아 🚀!!]</strong> |
| <strong><code>400 Bad Request</code> / <code>401 Unauthorized</code></strong> | **[영구 불변 팩트 에러 쓰레기 💀]** "니가 보낸 [JSON](/knowledge-base/studynote/11_design_supervision/06_exam_summary/343_json/) 문법 괄호 틀렸거나 비번 틀림 ㅂㅅ아 컷 ㅋ." | **[절.대. 재시도 금지 영구 차단 사살 컷 🪓!!!]** 야 이 미친놈아 문법 틀린 쓰레기 텍스트를 백날 1,000번 다시 쏜다고 서버가 "아 정답으로 봐줄게 ㅋ" 하고 뚫어 주냐 미친아 쾅!! 이거 재시도 치면 니 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 대기 랙만 타죽고 네트워크 쓰레기 트래픽 디도스 낭비 연쇄 뻗음이다 당장 재시도 0회 세팅 Fail Fast 즉사 차단 드랍 쳐 🚀!!! |
...
이 낡은 AWS 재시도 폭풍 백오프 철학이 모던 스프링 부트(Spring Boot)와 K8s [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/945_service_mesh_istio/)([Service Mesh](/knowledge-base/studynote/03_network/16_data_center_cloud/828_service_mesh_microservice_communication_infrastructure/)) 엣지 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인에서 어떻게 0.1초 컷 오토 방폭문으로 부활 영혼 환생 빙의했는가 🚀.
...
| <strong><a href="/knowledge-base/studynote/15_devops_sre/04_iac_cloud_native/194_idempotency/">Idempotency</a> (<a href="/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/171_idempotency_iac_terraform/">멱등성</a> 부적 쉴드 락킹 🔑)</strong> | 재시도를 쏠 때 앞단 무조건 깔려있어야 하는 0순위 전제 조건 방벽 헌법. 내가 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) 뻗어 에러 터져서 '결제 재시도' 핑퐁 3번 날렸는데 ➔ 상대방이 3번 다 받아쳐 먹고 유저 계좌 돈 3번 이중 출금 깎아 파산 멸망 폭사 100억 소송 터지는 걸 100% 막으려면 ➔ 헤더 대가리에 `[주문 123번 고유 텐트 ID]` 멱살 잡아 쑤셔 박아 던져 "야 나 아까 온 새끼야 중복 컷 무시 쳐 쾅!" 방폭문 검열 걸러내는 [제로 트러스트](/knowledge-base/studynote/02_operating_system/10_security/667_zero_trust_runtime_integrity_measurement/)([Zero Trust](/knowledge-base/studynote/02_operating_system/10_security/667_zero_trust_runtime_integrity_measurement/)) 무결점 텐트. |
| <strong><a href="/knowledge-base/studynote/12_it_management/05_security_compliance/304_circuit_breaker/">Circuit Breaker</a> (<a href="/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/307_circuit_breaker_pattern/">서킷 브레이커</a> 방폭문 ⚡)</strong> | 재시도의 영혼 단짝 십자 융합 형님 쉴드. "야 3번 지터 섞어 찔렀는데 계속 뻗네? 이 새끼 진짜 불타 뒈진 팩트 록온 쾅 💥!" ➔ 그 0.1초 순간 인간 묻지 말고 즉각 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) 찰칵 오픈(OPEN) 차단 내려 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/) 100% 절단 고립 찢어버리고 ➔ 걍 내 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 나 홀로 Fail Fast 쾌속 튕겨내기 방어 기동 쳐서 램 뻗음 파국 차단 척살해 생존하는 최후의 인프라 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/) 에어백 생명 연장술. |
...
2. 그래서 똑똑한 천재 매니저(아키텍트 대장님 🪓)가 마법의 룰을 정했어요! <strong>"야!! 에러 나면 처음엔 1초 기다렸다가 F5 누르고, 또 안 되면 2초, 그다음엔 4초, 8초 대기 타며 점점 뒤로 물러서서 기다려(지수 백오프 텐트 🚀)!! 서버 아저씨가 물 마시고 기계 고치고 숨통 쉴 수 있게 배려 락킹(<a href="/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/">Lock</a>) 치란 말이야 쾅!!"</strong>
