...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: SLO는 **[SLI](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/102_sli_slo_service_level_indicator_objective/)(측정 지표)에 대한 목표 [임계치](/knowledge-base/studynote/03_network/08_transport_layer/431_ssthresh_slow_start_threshold/)**이며, "[가용성](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/) [SLI](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/102_sli_slo_service_level_indicator_objective/) ≥ 99.9%"처럼 정의하여 **[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/)의 정량적 기준**을 제공한다.
> 2. **가치**: SLO가 없으면 "[서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)가 괜찮은가?"에 대한 판단이 주관적이지만, SLO가 있으면 **[Error Budget](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/101_error_budget_sre/)(100%-[SLO](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/181_slo_service_level_objective/))이 남았는가?**로 **[피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 개발 vs 안정화의 우선순위를 객관적으로** 결정할 수 있다.
> 3. **판단 포인트**: SLO는 100%로 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)하면 안 되며(혁신 불가), **사용자 기대+비즈니스 목표**에 맞춰 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)해야 한다. [SLO](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/181_slo_service_level_objective/) ≤ [SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/)(계약)이어야 내부 목표가 계약보다 엄격하다.
...
| 단계 | 정의 | 예 |
|:---|:---|:---|
| **[SLI](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/102_sli_slo_service_level_indicator_objective/)** | 측정 | [가용성](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/452_availability/) 99.95% |
| **[SLO](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/181_slo_service_level_objective/)** | 목표 | ≥ 99.9% |
| **[Error Budget](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/101_error_budget_sre/)** | 여유 | 0.1% (43분) |
| **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/)** | 계약 | ≥ 99.5% (위반 시 크레딧) |
...
SLO는 **SRE의 가장 핵심적 의사결정 도구**이며, Error Budget을 통해 엔지니어링 팀과 비즈니스 팀 간의 갈등(속도 vs 안정)을 **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 해결**한다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[SLI](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/102_sli_slo_service_level_indicator_objective/)** | SLO의 측정 기반 |
| **[Error Budget](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/101_error_budget_sre/)** | SLO에서 파생되는 허용 장애 시간 |
| **[SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/085_sla/)** | SLO보다 느슨한 고객 계약 |
...
3. 덕분에 "얼마나 더 실험([피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/))해도 되는지" **숫자로 판단**할 수 있답니다!
