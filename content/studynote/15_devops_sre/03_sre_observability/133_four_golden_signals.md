...
- **📢 섹션 요약 비유**: 4대 [골든 시그널](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/186_golden_signals_sre_monitoring/)은 자동차의 **속도계·RPM·경고등·연료 게이지** — 이 4개만 보면 차 상태를 안다.
