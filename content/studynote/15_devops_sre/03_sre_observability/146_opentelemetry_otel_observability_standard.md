...
> 3. **판단 포인트**: OTel SDK(계측)->OTel Collector(수집·처리·내보내기)->Backend([Prometheus](/studynote/15_devops_sre/03_sre_observability/136_prometheus/)·Jaeger·Loki)의 3계층이며, Auto-instrumentation으로 코드 변경 없이 계측할 수 있다.
...
OpenTelemetry는 <strong>Observability의 <a href="/studynote/15_devops_sre/04_iac_cloud_native/190_cncf_landscape_observability/">CNCF</a> 통합 표준</strong>이며, Vendor-neutral로 백엔드 교체가 자유롭다.
...
|:---|:---|
| **OTel** | 통합 텔레메트리 |
| **SDK** | 계측 [라이브러리](/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) |
| **Collector** | 수집·처리·내보내기 |
| **OTLP** | 전송 [프로토콜](/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) |
...
3. OTel 하나면 <strong><a href="/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/">메트릭</a>·<a href="/studynote/04_software_engineering/09_cloud_native_ai_architecture/568_logs_distributed_logging_elk_fluentd/">로그</a>·트레이스</strong>를 모두 같은 방식으로 수집해요!
...
<- **이전**: [145. Jaeger & Zipkin - 분산 트레이싱 백엔드 비교](/studynote/15_devops_sre/03_sre_observability/145_jaeger_zipkin_distributed_tracing_backend/)
**다음**: [147. eBPF (Extended Berkeley Packet Filter) - 커널 레벨 샌드박스 관측 기술](/studynote/15_devops_sre/03_sre_observability/147_ebpf_kernel_observability_cilium/) ->
