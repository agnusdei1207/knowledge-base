...
> 2. 심리적 안전이 없으면 개발자는 버그를 숨기고, 배포 실패를 보고하지 않으며, 개선 아이디어를 말하지 않는다 — DevOps의 [[523_dhcp_dora_process|DORA]] 지표(배포 빈도·[[451_mttr|MTTR]])는 심리적 안전이 높은 팀에서만 지속 개선된다.
...
## II. 심리적 안전과 [[652_devops_calms_culture|DevOps]] 성과
...
| [[652_devops_calms_culture|DevOps]] 행동          | 심리적 안전 높음     | 심리적 안전 낮음    |
|-------------------|--------------------|-------------------|
| 장애 보고          | 즉시 투명하게       | 숨기거나 [[015_지연_데이터_관점|지연]]       |
| 포스트모템         | 비난 없는 원인 분석  | 책임자 찾기         |
| [[330_code_review|코드 리뷰]]          | 건설적 피드백        | 방어적 반응         |
...
> 📢 **섹션 요약 비유**: 1단계는 반에 잘 적응하기, 2단계는 손 들고 질문하기, 3단계는 발표하기, 4단계는 선생님 의견에 [[369_logic_bomb|논리]]적으로 반박하기.

---

## [[288_version_ihl_tos_total_length|IV]]. 심리적 안전 구축 실천
...
← **이전**: [[035_blameless_postmortem|035. 무결함 사후 검토 (Blameless Postmortem)]]
**다음**: [[037_agile_pmo|037. 애자일 PMO (Agile PMO)]] →
