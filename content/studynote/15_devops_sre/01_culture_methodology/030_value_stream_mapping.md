...
| 기호/개념 | 의미 |
|:---|:---|
| **[Process](/knowledge-base/studynote/12_it_management/05_security_compliance/300_process/) Box** | 실제 작업 단계 |
...
| 기대효과 | 내용 |
|:---|:---|
| **[리드 타임](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/085_lead_time_cycle_time/) 단축** | 대기 시간 제거로 배포 속도 향상 |
...
|:---|:---|
| **린 소프트웨어** | VSM 이론적 기원 |
| **[DORA](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/523_dhcp_dora_process/) [메트릭](/knowledge-base/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/)** | VSM 개선 측정 지표 |
| **WIP 제한** | 재고 낭비 제거 수단 |
| **[칸반](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/084_kanban_board_wip_limit/)** | VSM 흐름 관리 [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/) |
