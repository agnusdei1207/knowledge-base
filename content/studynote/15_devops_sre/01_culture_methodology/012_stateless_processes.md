---
title: 12. 무상태 프로세스 (Stateless Processes) - 애플리케이션은 상태를 공유하지 않고 무상태로 실행되며, 상태는 DB
  등에 저장
date: '2026-04-05'
tags:
- devops_sre
...
← **이전**: [[011_build_release_run|11. 빌드, 릴리스, 실행 (Build, Release, Run) 단계의 엄격한 분리]]
**다음**: [[013_port_binding|13. 포트 바인딩 (Port Binding) - 자체적으로 포트를 바인딩하여 웹 서비스 노출]] →
