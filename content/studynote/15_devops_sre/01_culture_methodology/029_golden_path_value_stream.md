...
### 린 낭비 7가지 (소프트웨어 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/))

| 린 낭비 | 소프트웨어 예시 |
|:---|:---|
| **과생산** | 아무도 안 쓰는 기능 개발 |
| **재고** | 검토 대기 중인 코드 [PR](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/067_pull_request_pr_merge_request_code_review/) |
| **이동** | 팀 간 핸드오프, 승인 대기 |
| **불량** | 버그·[기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/), 재작업 |
...
### [VSM](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/030_value_stream_mapping/) 실시 방법
...
- **📢 섹션 요약 비유**: [VSM](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/030_value_stream_mapping/) 병목 해결은 교통 체증 분석이다. GPS [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 어디서 막히는지 파악하고([VSM](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/030_value_stream_mapping/)), [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)등 최적화·도로 확장(자동화)으로 교통 흐름을 개선한다.
...
| 기대효과 | 내용 |
|:---|:---|
| **[리드 타임](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/085_lead_time_cycle_time/) 단축** | 대기 시간 제거로 전달 속도 향상 |
| **[DORA](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/523_dhcp_dora_process/) 개선** | 배포 빈도↑, [리드 타임](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/085_lead_time_cycle_time/)↓ |
| **[개발자 경험](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/058_dx_developer_experience/)** | 골든 패스로 마찰 없는 개발 환경 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[DORA](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/523_dhcp_dora_process/) [메트릭](/knowledge-base/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/)** | 가치 흐름 개선 측정 지표 |
| **[플랫폼 엔지니어링](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/109_platform_engineering_cognitive_load/)** | 골든 패스 제공 주체 |
| **린 소프트웨어** | 가치 흐름 이론 기원 |
| **[GitOps](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/119_gitops_single_source_of_truth/)** | 승인 병목 자동화 패턴 |
...
1. [가치 흐름 맵핑](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/030_value_stream_mapping/)은 피자 배달 과정 분석이에요! 피자 만들기(20분)보다 대기(40분)가 더 길다는 것을 발견해서 개선해요.
