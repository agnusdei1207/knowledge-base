...
> 3. Google [[100_sre_site_reliability_engineering_error_budget|SRE]] 팀에 의해 체계화되었으며, 사후 검토를 팀 학습 기회로 전환해 동일 인시던트 반복을 방지하고 엔지니어 [[036_psychological_safety|심리적 안전]]감을 높인다.
...
| 관점       | [[352_defect_definition|결함]]-중심 (Blame)        | Blameless             |
|-----------|-------------------------|-----------------------|
| 원인 귀결  | "누가 실수했나?"          | "어떤 조건이 실수를 만들었나?" |
| 처리 결과  | 처벌/징계                | 시스템 개선             |
| 문화 효과  | 은폐, 두려움              | 투명성, [[036_psychological_safety|심리적 안전]]      |
| 학습 효과  | 최소                     | 최대                   |
...
> 📢 **섹션 요약 비유**: 비행기 사고 조사 보고서처럼 — 조종사를 탓하는 게 아니라 기체 [[352_defect_definition|결함]], 관제 절차, 훈련 미흡을 찾아 개선한다.
...
## [[288_version_ihl_tos_total_length|IV]]. Postmortem 문화 구축
...
| [[451_mttr|MTTR]]            | 장애 [[658_ir_recovery|복구]] 평균 시간 감소 추세  |
...
## V. 실무 시나리오 — [[100_sre_site_reliability_engineering_error_budget|SRE]] 팀 Postmortem 운영
...
| 5 (격주)     | 액션 아이템 [[216_progress_in_synchronization|진행]] 상황 리뷰                 |
