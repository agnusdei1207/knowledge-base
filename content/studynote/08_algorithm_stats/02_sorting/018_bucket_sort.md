...
📢 **섹션 요약 비유**: 버킷 정렬은 대형 도서관의 코너별 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)와 같다. 책을 장르별 코너로 먼저 배분하고(버킷 분배), 각 코너 내에서 제목순으로 정리([삽입 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/052_insertion_sort_algorithm/))하면, 사서 한 명이 전체를 혼자 정리하는 것보다 훨씬 빠르다.
...
1. **분배 (Scatter)**: 각 원소 x를 버킷 [index](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) = floor(n·x)에 할당
2. **정렬 (Sort)**: 각 버킷 내부를 [삽입 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/052_insertion_sort_algorithm/)로 정렬
...
| [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | 최적 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | 시간 | 공간 | 안정 |
|:---|:---|:---:|:---:|:---:|
| [계수 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/016_counting_sort/) | 소범위 정수 | O(n+k) | O(n+k) | ✅ |
| [기수 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/017_radix_sort/) | 고정 자릿수 정수/문자열 | O(d·(n+k)) | O(n+k) | ✅ |
...
📢 **섹션 요약 비유**: 계수·[기수](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/077_radix/)·버킷 정렬은 각기 다른 전문 창고다. [계수 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/016_counting_sort/) 창고는 물건 번호(정수)에 최적화, [기수 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/017_radix_sort/) 창고는 바코드 자릿수에 최적화, 버킷 정렬 창고는 무게 분포가 고른 물건에 최적화되어 있다.
