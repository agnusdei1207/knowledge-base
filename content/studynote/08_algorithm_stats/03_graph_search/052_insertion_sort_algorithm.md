...
### 시간/[공간 복잡도](/knowledge-base/studynote/08_algorithm_stats/01_basics/003_space_complexity/) 분석
...
| [조기 종료](/knowledge-base/studynote/10_ai/03_llm_nlp/281_early_stopping/) | ✅ (버블 [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/)) | ❌ | **✅ (구조적)** |
| 안정 정렬 | ✅ | ❌ | **✅** |
...
**삽입 정렬을 선택해야 하는 상황**:
- [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 크기가 50개 이하인 소규모 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)
- 이미 거의 정렬된 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 1~2개 원소가 추가되는 온라인 정렬 (Online Sort) 시나리오
...
| [이진 탐색](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/031_binary_search_algorithm/) ([Binary Search](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/031_binary_search_algorithm/)) | 이진 삽입 정렬에서 삽입 위치 탐색에 활용 |
