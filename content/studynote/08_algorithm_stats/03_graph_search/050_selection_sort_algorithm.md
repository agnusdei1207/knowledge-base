...
1. <strong><a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">힙 정렬</a>(<a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">Heap Sort</a>)로의 완전한 승계</strong>
   [선택 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/024_selection_sort/)의 근본적인 문제는 "N개 중에서 제일 작은 것을 찾는데 O(N)이나 걸린다"는 점입니다. 이 [선형 탐색](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/030_linear_search/)의 비효율을 트리 구조(Complete [Binary Tree](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/060_binary_tree/))를 이용해 O(log N)으로 확 줄여버린 것이 바로 <strong><a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">힙 정렬</a>(<a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">Heap Sort</a>)</strong>입니다. [힙 정렬](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/)은 사실상 '[선택 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/024_selection_sort/)의 완전체 진화형'이며, 실무에서 [선택 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/024_selection_sort/)이 설 자리를 100% 빼앗았습니다.

2. <strong>학습/평가 기준점(<a href="/knowledge-base/studynote/04_software_engineering/01_overview_principles/025_baseline/">Baseline</a>)으로서의 역할</strong>
...
| 개념 | 연결 포인트 |
|:---|:---|
| <strong><a href="/knowledge-base/studynote/08_algorithm_stats/03_graph_search/030_linear_search/">선형 탐색</a> (<a href="/knowledge-base/studynote/08_algorithm_stats/03_graph_search/030_linear_search/">Linear Search</a>)</strong> | [선택 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/024_selection_sort/)의 핵심 기관 — 매 패스마다 O(N)으로 최솟값 [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/)를 찾아내는 과정 |
| <strong><a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">힙 정렬</a> (<a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/">Heap Sort</a>)</strong> | [선택 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/024_selection_sort/)의 직계 후손 — 최솟값 탐색을 이진 힙(O(log N))으로 가속하여 O(N log N) 달성 |
