...
B-트리([B-Tree](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/064_b_tree/))는 <strong>Rudolf Bayer와 Edward McCreight(1972)</strong>가 대용량 디스크 저장소를 위해 설계한 자기 균형 탐색 트리다.
