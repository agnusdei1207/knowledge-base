...
| 비교 | [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) | 큐 | 덱 |
|:---|:---|:---|:---|
| 삽입 | 한쪽 끝 | 한쪽 끝 | 양쪽 끝 |
| 삭제 | 같은 끝 | 반대 끝 | 양쪽 끝 |
| 패턴 | LIFO | [FIFO](/knowledge-base/studynote/02_operating_system/04_synchronization/261_fifo_page_replacement/) | 둘 다 |

- **📢 섹션 요약 비유**: [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)·큐·덱은 도로 구조다. [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)은 막힌 골목(한쪽만 출입), 큐는 일방통행 도로(한쪽 입구·반대쪽 출구), 덱은 양방향 도로(양쪽 모두 출입 가능)다.

---

## Ⅳ. 실무 적용 및 기술사 판단

### [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 응용
...
- **📢 섹션 요약 비유**: 0-1 [BFS](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/035_bfs/) + 덱은 급행·완행이 혼합된 지하철이다. 급행([가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 0)은 맨 앞에 서고, 완행([가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 1)은 맨 뒤에 서서 항상 가장 빠른 경로가 앞에 있도록 관리한다.
