...
- **📢 섹션 요약 비유**: 큰 카드 더미를 한 번에 줄 세우기 어렵다면, 먼저 반씩 나눠 작은 더미로 만든 뒤 정리된 더미끼리 합치는 편이 훨씬 쉽다. [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)은 이 단순한 원리를 끝까지 밀어붙인 방식이다.
...
| :--- | :--- | :--- | :--- |
| 분할 | [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)을 절반으로 나눔 | 깊이 `log n` 형성 | [재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/) 또는 반복 구현 |
| 정복 | 더 이상 나눌 수 없는 크기까지 [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/) | 길이 1은 이미 정렬 상태 | [재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/) 종료 조건 필요 |
...
[합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)의 장점을 제대로 보려면 [퀵 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/047_quick_sort/) ([Quick Sort](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/047_quick_sort/)), [힙 정렬](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/) ([Heap Sort](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/)) 과 비교해야 한다. 세 알고리즘은 모두 `O(n log n)` 영역에 속하지만, 강점의 방향이 다르다.
...
[퀵 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/047_quick_sort/)은 평균적으로 매우 빠르고 캐시 친화적이지만, [피벗](/knowledge-base/studynote/12_it_management/01_governance_strategy/829_pivot/) 선택이 나쁘면 최악 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 급격히 나빠질 수 있다. [힙 정렬](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/)은 추가 메모리 없이 최악도 보장하지만, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 접근이 분산되어 실제 체감 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 떨어질 수 있다. [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)은 이 둘 사이에서 <strong>안정성과 예측 가능성</strong>을 가장 강하게 제공한다.
...
실무적으로는 [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)이 현대 라이브러리의 하이브리드 정렬로도 이어진다. 예를 들어 [Timsort](/knowledge-base/studynote/08_algorithm_stats/02_sorting/019_timsort/) 는 [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)의 병합 구조 위에 "이미 부분 정렬된 구간(run)"을 활용하는 아이디어를 얹어 실제 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에서 더 좋은 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 낸다.

- **📢 섹션 요약 비유**: [퀵 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/047_quick_sort/)은 재빠른 단거리 선수, [힙 정렬](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/080_heap_sort/)은 힘 좋은 등산가, [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)은 꾸준하고 질서 있는 마라토너에 가깝다. 어떤 레이스인지에 따라 가장 빛나는 선수가 달라진다.
...
1. 최악 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 흔들리면 안 되는가?
2. 동일 키의 기존 순서를 보존해야 하는가?
3. [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 디스크, 스트림, [연결 리스트](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/056_linked_list/)처럼 순차 접근 중심인가?
4. [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 정렬이라면 `O(n)` 보조 메모리를 감당할 수 있는가?
5. 이미 부분 정렬된 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 많다면 [Timsort](/knowledge-base/studynote/08_algorithm_stats/02_sorting/019_timsort/) 같은 변형이 더 적합한가?

### 자주 나오는 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- 메모리가 매우 작은 환경에서 무심코 [재귀](/knowledge-base/studynote/08_algorithm_stats/01_basics/014_recursion/)형 [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)을 쓰는 경우
- 병합용 임시 버퍼를 매 단계마다 비효율적으로 재할당하는 경우
- 안정성이 필요 없는데도 단순히 "최악 보장"만 보고 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 정렬의 기본값으로 남용하는 경우

현실적인 판단은 이렇다. [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)에서 절대 메모리를 아껴야 하면 [합병 정렬](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/)이 부담스럽다. 하지만 안정성이 중요하거나 [외부 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/023_external_sort/)·[연결 리스트](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/056_linked_list/)·[병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 병합처럼 순차적 합치기가 중심인 문제에서는 여전히 매우 강한 선택지다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [분할 정복](/knowledge-base/studynote/08_algorithm_stats/01_basics/005_divide_and_conquer/) ([Divide and Conquer](/knowledge-base/studynote/08_algorithm_stats/01_basics/005_divide_and_conquer/)) | [Merge Sort](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/) 의 가장 핵심적인 설계 원리 |
| 안정 정렬 (Stable Sort) | 동일 키의 상대적 순서를 보존하는 성질 |
| [외부 정렬](/knowledge-base/studynote/08_algorithm_stats/02_sorting/023_external_sort/) ([External Sort](/knowledge-base/studynote/08_algorithm_stats/02_sorting/023_external_sort/)) | 디스크 기반 대용량 정렬에서 [Merge Sort](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/) 를 확장해 사용 |
| [연결 리스트](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/056_linked_list/) 정렬 | 순차 접근 구조에서 [Merge Sort](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/) 가 특히 강함 |
| 다방향 병합 (Multi-way Merge) | 여러 정렬 런(run)을 한 번에 합치는 확장 기법 |
| [Timsort](/knowledge-base/studynote/08_algorithm_stats/02_sorting/019_timsort/) | [Merge Sort](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/044_merge_sort/) 의 병합 구조를 활용한 실용 하이브리드 정렬 |
