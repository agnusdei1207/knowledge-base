...
> 3. **판단 포인트**: [채널 용량](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/155_channel_capacity/) C = max I(X;Y), ML 특성 선택, 클러스터링 평가([NMI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/558_nmi/)) — 실무 세 곳에서 동시에 쓰이므로 수식과 해석을 함께 암기하라.
...
- **H(X) + H(Y) - H(X,Y)**: 두 [엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/)의 합에서 결합 [엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/)를 뺀 "중복분"
...
- **H(X,Y)**: 두 원의 합집합 (전체 결합 [엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/))
...
📢 **섹션 요약 비유**: [채널 용량](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/155_channel_capacity/)은 "파이프의 최대 [처리량](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/139_throughput/)"이다 — 어떤 입력 분포를 써야 파이프를 가장 효율적으로 사용하는지를 상호 정보량 최대화로 계산한다.
...
📢 **섹션 요약 비유**: [NMI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/558_nmi/) 클러스터 평가는 "지도 대조"와 같다 — 예측한 클러스터 지도와 실제 정답 지도가 얼마나 일치하는지를 0~1 사이로 표현한다.
...
| 개념 | 수식 | 연결 |
|:---|:---|:---|
| 상호 정보량 I(X;Y) | H(X) - H(X\|Y) | [채널 용량](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/155_channel_capacity/), 특성 선택 |
| [NMI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/558_nmi/) | 2I/(H(X)+H(Y)) | 클러스터링 평가 |
| [채널 용량](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/155_channel_capacity/) C | max_{P(X)} I(X;Y) | 섀넌 채널 한계 |
