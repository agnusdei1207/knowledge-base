...
> 2. **가치**: 심플렉스법 ([Simplex](/studynote/06_ict_convergence/05_data_science/406_linear_programming_simplex/) Method) 이 실용적으로 빠르고, 내점법 (Interior Point Method) 이 이론적으로 [다항식](/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 복잡도를 보장하며, 쌍대 LP가 경제 해석과 [알고리즘](/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 분석에 활용된다.
...
### 심플렉스 [알고리즘](/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) ([Simplex](/studynote/06_ict_convergence/05_data_science/406_linear_programming_simplex/) Method)
...
- 실용: 평균 [다항식](/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 시간 (m+n개 꼭짓점 정도 탐색)
...
카마르카 (Karmarkar) [알고리즘](/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) (1984): 최초 [다항식](/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 시간 LP [알고리즘](/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/).
...
| 항목 | 심플렉스 | 내점법 |
|:---|:---|:---|
| 이론 복잡도 | 지수 최악 | [다항식](/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) 보장 |
| 실용 [성능](/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) | 보통 빠름 | 대규모 희소 LP에 빠름 |
| 수렴 경로 | 꼭짓점 경유 | 내부 통과 |
| 구현 | 단순 | 복잡 |
...
| GLPK | [오픈소스](/studynote/12_it_management/05_security_compliance/191_oss_license_compliance/) | GNU LP Kit |
...
LP는 **20세기 가장 영향력 있는 최적화 기법** 중 하나 — 항공 [스케줄](/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/)링, 물류 최적화, 금융 포트폴리오, 전력망 운영의 핵심이다.

실용적 활용 현황:
- 항공사 운항 [스케줄](/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/) 최적화: LP + 정수 계획법
- 구글 광고 입찰: LP 기반 실시간 최적화
- 전력망 경제 급전: LP 매 5분 실행
- 물류 [라우팅](/studynote/03_network/07_network_layer_routing/339_routing_overview_best_path_selection/): LP + 네트워크 플로우
...
| 내점법 | 내부 통과, [다항식](/studynote/03_network/04_data_link_layer_error/195_polynomial_generator_crc/) | 대규모 LP |
| LP 쌍대 | min bᵀy, Aᵀy≥c | Shadow Price, [SVM](/studynote/14_data_engineering/05_exam_keywords/238_svm_margin_kernel_trick_naive_bayes/) |
...
LP 최적화 이론이 단순 선형 문제에서 정수 계획과 [머신러닝](/studynote/10_ai/03_llm_nlp/241_machine_learning_basics/) 응용으로 확장된 흐름이다.
...
<- **이전**: [7. 라그랑주 승수법 (Lagrange Multiplier) — 제약 최적화](/studynote/08_algorithm_stats/10_linear_algebra/166_lagrange_multiplier/)
**다음**: [9. 정수 프로그래밍 (IP, Integer Programming) — 분기 한정, MILP](/studynote/08_algorithm_stats/10_linear_algebra/168_integer_programming/) ->
