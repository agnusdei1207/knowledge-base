...
> 3. NP-Hard와 NP-Complete의 [관계](/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)는 포함 [관계](/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)([NP-Complete](/studynote/08_algorithm_stats/06_np_theory/108_np_complete/) ⊆ NP-Hard)로, NP-Complete는 "NP-Hard이면서 NP에도 속하는" 문제이며 NP-Hard에서 결정 문제 부분이 NP-Complete가 된다.
...
> 📢 **섹션 요약 비유**: NP-Hard는 "어려운 문제들의 클럽" 전체이고, NP-Complete는 그 클럽 중 "답 [확인](/studynote/04_software_engineering/12_testing_maintenance/396_validation/)이 빠른(NP)" 멤버만 따로 모은 것.

---

## Ⅱ. [NP-Complete](/studynote/08_algorithm_stats/06_np_theory/108_np_complete/) vs NP-Hard 차이
...
> 📢 **섹션 요약 비유**: NP-Complete는 "어렵지만 답이 맞는지 빠르게 [확인](/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 가능", NP-Hard는 "어렵고 답 [확인](/studynote/04_software_engineering/12_testing_maintenance/396_validation/)도 어려울 수 있음" — 더 넓은 범위.
...
## Ⅴ. 실무 시나리오 — 제조 [스케줄](/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/)링
...
> 📢 **섹션 요약 비유**: NP-Hard 제조 [스케줄](/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/)링은 퍼즐 맞추기 제한 시간 도전 — 완벽한 정답을 5분 안에 못 맞추지만, 98% 완성된 것으로 공장을 돌린다.
...
1. NP-Hard는 "세상에서 가장 어려운 문제들의 집합" — NP-완전보다 더 넓어서, 답이 맞는지 빠르게 [확인](/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 것조차 어려운 문제도 포함돼요!
2. 공장 작업 [스케줄](/studynote/05_database/04_transactions_concurrency/208_schedule_history_transaction_execution_order/) 짜기, 물류 경로 최적화 같은 현실 문제가 NP-Hard이기 때문에 완벽한 답 대신 "충분히 좋은 답"을 빠르게 찾는 알고리즘을 써요.
...
<- **이전**: [003. NP-완전 (NP-Complete)](/studynote/08_algorithm_stats/06_np_theory/108_np_complete/)
**다음**: [005. P = NP 문제](/studynote/08_algorithm_stats/06_np_theory/110_p_equals_np/) ->
