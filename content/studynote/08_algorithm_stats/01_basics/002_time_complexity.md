...
| 복잡도 | 이름 | n=[10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/) | n=100 | n=1000 | 예시 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) |
|:---:|:---|:---:|:---:|:---:|:---|
| O(1) | 상수 | 1 | 1 | 1 | [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/) 접근, 해시 조회 |
...
📢 **섹션 요약 비유**: 정렬 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 비교는 마라톤 선수 선발 같다. 평균 기록(평균 케이스)도 중요하지만, 기록이 가장 안 좋을 때(최악 케이스)에도 완주를 보장할 수 있어야 실전 투입이 가능하다.
