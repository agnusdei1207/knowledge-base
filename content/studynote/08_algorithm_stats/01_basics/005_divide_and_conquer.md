...
분할 정복은 계산궤과학의 가장 기초적인 설계 패러다임 중 하나이다. 이 패러다임을 이해하면 합병 정렬, 퀵 정렬, FFT, Strassen 등 주요 알고리즘의 설계 원리를 직관적으로 이해할 수 있게 된다. 기술사 시험에서도 재귀 관계 도출, 마스터 정리 적용, 분할 정복 vs 동적 프로그래밍 구분 등이 빈번하게 출제된다.
