...
2. **접미사 트리 vs [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)**: 트리는 최강의 검색 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)(O(m))을 자랑하고, [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)은 구현의 간결함과 메모리 효율성(O(n))에서 우위를 점합니다.
...
1. **Ukkonen's [Algorithm](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)**: 접미사 트리를 O(N) 시간에 구축하는 선형 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/).
2. **Suffix [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) Construction**: 보통 SA-IS [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)을 통해 O(N)에 구축하며, [LCP](/knowledge-base/studynote/03_network/04_data_link_layer_error/225_lcp_link_control_protocol/) [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)과 함께 사용되어 트리 기능을 대체함.
...
- **[데이터 압축](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/159_compression/)**: BWT(Burrows-Wheeler Transform)와 결합하여 bzip2 등 고효율 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 엔진의 핵심 로직이 됩니다.
- **[LCS](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/053_lcs/)(Longest Common Substring)**: 여러 문자열 간에 공통으로 나타나는 가장 긴 문자열을 찾는 문제에 최적입니다.

**기술사적 판단:**
"이론적으로는 트리가 우수하지만, 메모리 소모가 극심해 실무적으로는 **Suffix [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) + [LCP](/knowledge-base/studynote/03_network/04_data_link_layer_error/225_lcp_link_control_protocol/) [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)** 조합이 사실상의 표준입니다. 특히 현대적 아키텍처에서는 메모리 계층(Cache) 효율성 때문에 연속된 메모리 공간을 사용하는 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)이 트리보다 실제 속도가 더 빠른 경우가 많습니다."
