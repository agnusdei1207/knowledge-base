...
> 1. **본질**: Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 문자열 S의 각 위치 i에서 시작하는 부분 문자열이 S의 접두사(Prefix)와 얼마나 일치하는지를 나타내는 Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) (Z-[Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/))을 O(n)에 계산하는 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)이다.
> 2. **가치**: Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 하나로 패턴 매칭을 O(n+m)에 수행하며, [KMP](/knowledge-base/studynote/08_algorithm_stats/05_string/094_kmp_algorithm/) ([Knuth-Morris-Pratt](/knowledge-base/studynote/08_algorithm_stats/05_string/094_kmp_algorithm/)) 실패 함수와 개념적으로 동등하지만 구현이 더 직관적이라는 장점이 있다.
> 3. **판단 포인트**: 단일 패턴 매칭에서 KMP와 동일한 성능을 제공하며, 주기(Period) 탐색·최소 반복 단위 찾기 문제에서 Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)이 KMP보다 직접적으로 활용된다.
...
### Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) vs [KMP](/knowledge-base/studynote/08_algorithm_stats/05_string/094_kmp_algorithm/) [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)

| 항목 | Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | [KMP](/knowledge-base/studynote/08_algorithm_stats/05_string/094_kmp_algorithm/) [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) |
|:---|:---|:---|
| 전처리 | Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) (O(n)) | 실패 함수 π (O(m)) |
| 패턴 매칭 | O(n+m) | O(n+m) |
| 구현 직관성 | 높음 | 낮음 |
| 주기 탐색 | Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 직접 활용 | π [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) 활용 |
...
Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 Z-box 재활용으로 O(n) 시간 복잡도를 달성하여 KMP와 동등한 패턴 매칭 성능을 제공한다. 구현이 직관적이고 주기 탐색·문자열 분석에 직접 활용 가능하다는 장점이 있다. 다중 패턴 동시 매칭이 필요하면 [아호-코라식](/knowledge-base/studynote/08_algorithm_stats/05_string/098_aho_corasick/), 임의 부분 문자열 탐색이면 서픽스 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)로 확장한다.

**결론**: 단일 패턴 매칭과 문자열 주기 분석에서 Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 O(n+m)의 최적 복잡도를 제공하며, KMP보다 구현이 단순하여 실전에서 선호되는 경우가 많다.
...
|:---|:---|
| [KMP](/knowledge-base/studynote/08_algorithm_stats/05_string/094_kmp_algorithm/) [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) | 동등 성능의 패턴 매칭 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) |
| [아호-코라식](/knowledge-base/studynote/08_algorithm_stats/05_string/098_aho_corasick/) ([Aho-Corasick](/knowledge-base/studynote/08_algorithm_stats/05_string/098_aho_corasick/)) | 다중 패턴으로 확장한 방식 |
| 서픽스 [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) (Suffix [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)) | 임의 부분 문자열 탐색 |
| Z-box | Z [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)의 O(n) 핵심 최적화 |
| 주기 탐색 (Period Finding) | Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)의 주요 응용 |
| [트라이](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/087_trie/) ([Trie](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/066_trie/)) | 접두사 기반 탐색 자료구조 |
...
1. Z [배열](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/)은 문자열의 각 위치에서 "여기서 시작하는 단어가 맨 앞과 몇 글자 같아?"를 기록한 표야.
