...
### 1. 트레이드오프 전선 종결: 상태 비저장([Stateless](/knowledge-base/studynote/15_devops_sre/05_devsecops/239_stateless_redis/)) 아키텍처의 광기와 혁명 렌더뷰
"NFS v2, v3은 서버가 꺼졌다 켜져도 클라이언트가 에러를 내지 않는다." $\to$ [세션](/knowledge-base/studynote/02_operating_system/02_process_thread/160_session_controlling_terminal/)과 기억을 원천 거세시킨 기형적 생존력.
...
- 'NFS (Network [File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) System 둔갑 원격 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/) 렌더)' 아키텍처는 "내 로컬 디스크 껍데기([VFS](/knowledge-base/studynote/02_operating_system/09_file_system/517_virtual_file_system_vfs/) 계층 공간)" 에 보이지 않는 네트워크 전송 포털 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)([RPC](/knowledge-base/studynote/02_operating_system/02_process_thread/126_rpc/))를 박아 넣어, 유저 레벨 응용 프로그램이 단 한 줄의 코드 수정([FTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/482_ftp_file_transfer_protocol/) 업/다운 연동 로직 따위) 없이 수 천 킬로미터 밖의 원격 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)토리지를 0.1mm 코앞의 로컬 디스크처럼 부리게 만든 위대한 투명성(Transparency 확장) 기판의 선구자 뼈대다.
- 초창기 상태 비저장([Stateless](/knowledge-base/studynote/15_devops_sre/05_devsecops/239_stateless_redis/) 망각의 여신) 메커니즘을 극한으로 쪼아 [SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 서버 고장 재부팅 상황에서도 100% 자가 무인 치유 스왑이 넘어가는 클러스터의 미친 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/) 내성([Fault Tolerance](/knowledge-base/studynote/02_operating_system/11_exam_summary/800_system_architecture_fault_tolerance_dual/) [복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) 부스트)을 이룩하며 수만 대의 리눅스 서버가 단 하나의 NAS를 거머리처럼 연합해 물고 빠는 인프라 생태계를 단일 제패하고 있다 선고.
- 비록 IP 스푸핑이나 허술한 ID/권한 탈취([Security](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/283_security_tactics/) Breach [단편화](/knowledge-base/studynote/03_network/06_network_layer_ip/291_fragmentation_and_reassembly_process/) 노출 랙)에 숭숭 뚫려버리는 원시적인 보안 오버헤드 데들락 늪을 안고 태어났으나, 이마저도 NFS v4 버전의 **상태 유지(Stateful 락킹 룰) 방어** 와 강력한 [Kerberos](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/545_kerberos_kdc_ticket_based_auth/) 암호화 티켓 스위칭 장갑을 둘러 거시적 하이엔드 전송 시스템의 절대 방패 권위로 종결 진화되었다 통달 보장.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [LFS](/knowledge-base/studynote/02_operating_system/09_file_system/541_log_structured_file_system/) ([Log-structured File System](/knowledge-base/studynote/02_operating_system/09_file_system/541_log_structured_file_system/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [COW](/knowledge-base/studynote/02_operating_system/09_file_system/542_cow_file_system/) ([Copy-On-Write](/knowledge-base/studynote/02_operating_system/09_file_system/542_cow_file_system/)) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 (ZFS, Btrfs) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
...
← **이전**: [542. COW (Copy-On-Write) 파일 시스템 (ZFS, Btrfs) - 스냅샷 및 롤백 기능 내장](/knowledge-base/studynote/02_operating_system/09_file_system/542_cow_file_system/)
**다음**: [544. AFS (Andrew File System) / SMB/CIFS (Windows 파일 공유)](/knowledge-base/studynote/02_operating_system/09_file_system/544_afs_smb_cifs_file_system/) →
