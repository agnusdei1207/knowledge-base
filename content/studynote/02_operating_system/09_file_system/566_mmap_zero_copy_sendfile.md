...
> 2. **가치**: 이 미친 CPU 낭비를 부수기 위해 탄생한 신성 로마 제국 급 마법이 제로 카피(`sendfile` 및 `mmap` 빔)다. 넷플릭스 서버는 아예 유저(웹서버)가 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 자기 입으로 만지지도 않는다. [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에게 **"야, 내 하드 [물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/)(A)부터 네트워크 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/) [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)(B)까지 내가 손 안 댈 테니까, [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) 칩아 네가 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 밑바닥에서 직통으로 쏟아부어라! ([Zero](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/585_zero_skipping/)-Copy 록백)"** 라고 명령 1줄만 던지고 자기는 퇴근해 버린다 포팅.
> 3. **한계**: 가장 치명적인 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 가공 불가의 딜레마. 이 제로 카피 특급 열차(sendfile)를 타면, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)이 유저 영역(웹서버 코드)으로 아예 안 올라오기 때문에 **"[압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)을 하거나, 암호화([HTTPS](/knowledge-base/studynote/03_network/09_application_layer_web_email/471_https_http_over_tls/)/SSL)를 씌워서 보낼 수가 없는([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) Manipulation 차단 데들락 랙!)"** 치명상을 맞게 된다. 즉 순수 원본(Static [File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/))만 통째로 던질 땐 광속이지만, 가공이 1바이트라도 필요한 순간 열차가 멈춰버리는 영원한 트레이드오프 파단을 낳았다 결착.
...
- **필요성**: 유튜브나 넷플릭스 같은 글로벌 [CDN](/knowledge-base/studynote/03_network/09_application_layer_web_email/506_cdn_content_delivery_network_edge_caching/) 시스템이 10GB/s 회선 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)을 꽉 채우려면, C언어 프로그램이 `for` 문 돌리면서 메모리를 1바이트씩 복사하는 미친 CPU 낭비를 [SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 인프라 최하단에서 도살해 버릴 OS 차원의 하드웨어 릴레이 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/)연결 스토리지 아크가 21세기 필연적으로 부합 요구되었다 증명 록보장.
  ...
  - **([mmap](/knowledge-base/studynote/02_operating_system/11_exam_summary/749_memory_mapped_file_mmap/)/sendfile 제로 카피 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 다이브 기전!)**: 똑똑한 1성급 Nginx 선장은 **[하청업체 거대 크레인 하드웨어([DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) 컨트롤러 빔!)]** 을 개설합니다 스왑! "야 선원들아, 내 방에 사과 1알도 갖고 오지 마!(User Space 완전 패스 렌더!) 기차에서 사과칸 포장 안 뜯고 통째로 집어서 다이렉트 수출 배 짐칸으로 던져 꽂아버려!([Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 안에서 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인 우회 록백!)" 손가락(CPU 연산) 하나 까딱 안 하고 100만 톤 사과 배송이 끝나 서버 폭주(동시접속 100만 유저)를 견뎌내는 신앙 시스템입니다 결속!

- **전통 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 전송 vs 제로 카피([Zero](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/585_zero_skipping/)-Copy) [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 패스 [ASCII](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/103_ascii/) 폭주 뷰**:
...
|:---|:---|:---|
| **User-[Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 메모리 카피 수 스왑** | 1번! [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)이 램에 올라오면, 유저가 그걸 읽을 수 있게 **포인터(가상 주소 매핑)를 같이 쓰며 1번 절약 복사 스피드.** | 0번 ([Zero](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/585_zero_skipping/)-copy)! 유저는 **아예 주소조차 알지 못하고 관여 불가 100% 고립 패스.** |
| **[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 내용물 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 가공 여부 랙** | 앱 코드가 메모리를 들여다보므로 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 내용을 일부 **수정/필터링/[압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)(Gzip) 하는 연산 기능 쾌조.** | 유저는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 내용을 1도 구경 못하므로 **오직 순수 원본 10GB 짜리를 퍼부을 때만 발동되는 통치 늪.** |
| **태생적 [Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/) 덫 병목** | 디스크에서 덜 올라왔는데 유저가 덥석 읽으려 하면 **가상메모리 7단원 [Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/)([OOM](/knowledge-base/studynote/02_operating_system/02_process_thread/157_oom_killer/) 랙 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)) 직격탄 지옥.** | 애초에 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 뱃속 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)에서 DMA가 주도하므로 **앱이 블로킹 당하거나 메모리 뻗을 위험 파단 면역 결속.** |
...
- **[안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) 오염 발생 미스터리 (SSL 암호화 덧씌우기와 sendfile 의 무덤 파단 랙)**: 
...
- **[SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 극복 솔루션 패치 타결 조율 (SSL [Offloading](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/440_offloading/) 보조칩 및 kTls [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 레벨 암호화 강제 록백!!)**: 
...
- **[안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) 충돌 (JVM 메모리에 빅데이터 메시지를 쌓는 [OOM](/knowledge-base/studynote/02_operating_system/02_process_thread/157_oom_killer/) 마비 멸망 파단 랙)**: 
...
- **[SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 엔지니어 도축 솔루션 (아파치 [Kafka](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/) 의 NIO transferTo 제로카피 렌더 방어 빔!)**: 
...
2. 그래서 초천재 네이버 넷플릭스 주방장이 **"[mmap](/knowledge-base/studynote/02_operating_system/11_exam_summary/749_memory_mapped_file_mmap/) 센드파일 제로카피 무지성 컨베이어 빔!(sendfile 튜브 록백!)"** 기계를 창조했어요! 웨이터 엄마가 짐을 2층 자기 방으로 안 올려요! 아예 그냥 1층 항구([커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 메모리 스페이스 스피드!)에 거대한 **직통 철제 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)([DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/) 로봇 조종 부스트!)** 만 탁! 꽂아버려요. "야 내 방에 해물 가져오지 마, 바다에서 바로 트럭 짐칸으로 밀어버려 무결!" 엄마는 손가락 까닥 안 하고 0번의 힘([Zero](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/585_zero_skipping/) CPU Copy 노동 스왑!) 으로 100만 명 세계 손님에게 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 광속 투척하는 무적 방어(스루풋 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 100% 점유 스피드!)를 달성해요 도출!
