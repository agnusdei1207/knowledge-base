...
← **이전**: [[561_encrypted_file_system_ecryptfs|561. 암호화 파일 시스템 (eCryptfs / Windows EFS)]]
**다음**: [[563_f2fs_flash_friendly_filesystem|563. 플래시 전용 파일 시스템 (F2FS, JFFS2, YAFFS) 특성 분석]] →
