...
- **NTFS Alternate [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [Stream](/knowledge-base/studynote/03_network/09_application_layer_web_email/467_http2_stream_multiplexing_tcp_hol/) (ADS) 명령 프롬프트 은닉 [ASCII](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/103_ascii/) 폭쇄 뷰**:
...
|:---|:---|:---|
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 및 기타 [속성](/knowledge-base/studynote/05_database/02_modeling_normalization/082_attribute_types_er_model/) 보관 장부 늪** | 모든 텍스트는 Main 공간 하나에! 썸네일이나 부가 정보는 **아예 별개의 폴더나 다른 확장자 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)로 분리 보관 도출.** | [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 1개 안에 **[Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 공간(본문) / Resource 공간(아이콘, 썸네일, 보안 캐시)을 동시에 평행 격리 삽입 통치.** |
| **FAT32 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 호환 이동 시([USB](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/359_usb/) 복사) 데들락 랙** | [USB](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/359_usb/) (FAT32) 로 복사하든 말든 100% 아무 타격 없이 **완벽 호환 복사 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 생존 $O(1)$ 스루풋.** | NTFS에서 FAT32 USB로 카피하는 순간? **"뒷면 공간(ADS)의 소중한 메타(아이콘 등) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 몽땅 증발 소멸 컷!"** |
| **태생적 보안 블라인드(Stealth) 취약점 파단 부스트** | 눈으로 `ls -l` 치면 무조건 100% 모든 용량과 바이트가 드러나는 **투명 직관성 및 [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/)(No Stealth) 방패.** | 백신이 우회로를 검사 안 하면 0바이트 **유령(Ghost) [랜섬웨어](/knowledge-base/studynote/09_security/15_malware_attack_vectors/730_ransomware/)가 디스크를 파먹는 암흑 맹점 지대 늪.** |
...
- **[안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) 오염 발생 미스터리 (인터넷 찌꺼기의 [파일 속성](/knowledge-base/studynote/02_operating_system/09_file_system/502_file_attributes_metadata/) 유실과 무방비 [바이러스](/knowledge-base/studynote/02_operating_system/10_security/589_virus/) 실행 랙)**: 
...
- **[SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 극복 솔루션 패치 타결 조율 (NTFS Zone.[Identifier](/knowledge-base/studynote/05_database/02_modeling_normalization/088_identifier_in_er_model/) ADS 은닉 차단 록백!!) / 스마트 방패**: 
  - 마이크로소프트의 보안 1방!: 윈도우 크롬이나 엣지 브라우저는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 하드에 저장하는 그 1초 찰나에, NTFS 기전을 역이용해! 부모 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 배꼽 뒤에 몰래 **`가짜 그림자 스트림 (Zone.Identifier)`** 을 묶어서 함께 구워버린다.
...
- **[안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) 충돌 (ADS [루트킷](/knowledge-base/studynote/02_operating_system/10_security/603_rootkit_syscall_hooking/) 감시망 회피 멸망 파단 랙)**: 
...
- **[SRE](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/100_sre_site_reliability_engineering_error_budget/) 엔지니어 보안 도축 솔루션 (dir /R 및 PowerShell 스트림 정밀 스캐너 렌더 방어 빔!)**: 
