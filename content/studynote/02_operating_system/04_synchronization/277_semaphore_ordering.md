...
> 1. **본질**: [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)를 이용한 순서 제어 (Ordering)는 [상호 배제](/knowledge-base/studynote/02_operating_system/05_deadlock/283_mutual_exclusion/)([Lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/)) 용도를 넘어, [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) A가 특정 작업을 완료해야만 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) B가 자신의 다음 작업을 진행하게 강제하는 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 간 비동기 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/) 랑데부 메커니즘이다.
> 2. **가치**: [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)의 실행 순서는 운영체제의 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) 마음(비결정성, Non-determinism)에 달려있으나, `초기값 0`인 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)([Signal](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) 변수)를 활용하면 개발자가 의도한 선후 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)(순차 실행성)를 우아하고 확실하게 하드 코딩할 수 있다.
> 3. **융합**: 생산자-소비자(Producer-Consumer) 큐에서의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 로드-소비 순서 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/), 안드로이드나 iOS의 백그라운드 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 간 이벤트를 대기(Condition Variable의 구형 역할) 및 멀티 코어 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 조립 과정 등에서 파이프라인을 구축하는 뼈대 기술로 기능한다.
...
| 구분 | 루프 기반 순서 대기 ([Busy Wait](/knowledge-base/studynote/02_operating_system/11_exam_summary/700_spinlock_busy_waiting/)) | 0 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) Wait (Sleep) |
|:---|:---|:---|
...
| 개념 | 연결 포인트 |
|:---|:---|
| [락 경합](/knowledge-base/studynote/02_operating_system/04_synchronization/275_lock_contention_monitoring/) ([Lock Contention](/knowledge-base/studynote/02_operating_system/04_synchronization/275_lock_contention_monitoring/)) 모니터링 도구 | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| 데드락 회피를 위한 [Lock Hierarchy](/knowledge-base/studynote/02_operating_system/04_synchronization/276_lock_hierarchy/) ([락 순서화](/knowledge-base/studynote/02_operating_system/04_synchronization/276_lock_hierarchy/)) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [이진 세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/225_binary_semaphore/) vs 뮤텍스 차이 ([소유권 유무](/knowledge-base/studynote/02_operating_system/04_synchronization/278_binary_semaphore_vs_mutex/)) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
...
1. [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)로 순서를 조종하는 건 운동회 릴레이 배턴과 같아요!
2. 뒷사람([스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) B)은 배턴이 없으면 아무리 뛸 준비가 됐어도 달리지 못하고 멈춰 서서 기다려야 하죠. (Wait)
3. 앞사람([스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) A)이 달려와 "자, 여기 배턴!" 하고 내밀어 주면 ([Signal](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)) 그제서야 풀려나 즐겁게 뛰어나갑니다!
