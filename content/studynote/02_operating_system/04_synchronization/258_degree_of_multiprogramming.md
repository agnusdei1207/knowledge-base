...
- **개념**: 컴퓨터 시스템 안에서 디스크에 잠들어 있지 않고, 실제로 메모리를 차지한 채 실행을 위해 CPU를 노리고 있는 활성 프로세스([Active](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) [Process](/knowledge-base/studynote/12_it_management/05_security_compliance/943_process/))의 숫자를 뜻한다.
