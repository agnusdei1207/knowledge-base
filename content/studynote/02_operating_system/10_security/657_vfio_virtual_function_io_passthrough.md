...
← **이전**: [[656_hardware_transactional_memory_htm|656. 하드웨어 트랜잭셔널 메모리 활용 Lock-Free 자료구조 시스템 구현 사례 (Hardware Transactional Memory]]
**다음**: [[658_virtio_paravirtualization_vring|658. Virtio - 반가상화 I/O 백엔드/프론트엔드 링버퍼(Vring) 디바이스 드라이버 구조]] →
