...
| **[JIT](/knowledge-base/studynote/09_security/11_iam_access_control/568_jit_access/) ìíìë** | ëìíìëë ëìíë ìëë ëí | x86, ARM ë ê ìííìë ììí ìë ìì |
| **ë(Maps)** | ìëê ììì êêì êìíë ëìí ììì | íì ë, ëì, ìí, í ë ëìí ìëêì |
| **íí íìí(Hook Points)** | íëêëì ììëë ìë ë ìì | ììí ì, ëíìí ìì, íëë ë |
| ** attach/maps [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)** | ììì êêìì eBPF íëêëì ììíë ìííìì | [bpf](/knowledge-base/studynote/02_operating_system/01_overview_architecture/069_ebpf/)() ììí ì, BCC, libbpf ë |
...
| ëê | ëì | ìì |
|---|---|---|
| **BCC ([BPF](/knowledge-base/studynote/02_operating_system/01_overview_architecture/069_ebpf/) Compiler Collection)** | C + Python/Luaë eBPF íëêë ìì | execsnoop, opensnoop, network monitoring |
...
| **[Cilium](/knowledge-base/studynote/03_network/16_data_center_cloud/825_cilium_ebpf_kubernetes_networking_security/)** | ìëëíì ëíìí ë ëì | L7 ìì ìì, ëíìí ëëíë |
...
**eBPF/[XDP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/670_xdp/) êë ëì**:
...
- **BCC ([BPF](/knowledge-base/studynote/02_operating_system/01_overview_architecture/069_ebpf/) Compiler Collection)**: [https](/knowledge-base/studynote/03_network/09_application_layer_web_email/471_https_http_over_tls/)://github.com/iovisor/bcc
...
| êë ëì | êê ë ìëì ìë |
|---|---|
| **[XDP](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/670_xdp/) ([eXpress Data Path](/knowledge-base/studynote/02_operating_system/10_security/661_ebpf_xdp_express_data_path/))** | eBPFë íìí ìêì ëíìí íí ìë íëììíë, ìë ëíìí ìí ììì ííì ìëíë. |
...
| **BCC ([BPF](/knowledge-base/studynote/02_operating_system/01_overview_architecture/069_ebpf/) Compiler Collection)** | Cììë eBPF íëêëì ìê ììí ì ìëë íë íëììíìë. |
