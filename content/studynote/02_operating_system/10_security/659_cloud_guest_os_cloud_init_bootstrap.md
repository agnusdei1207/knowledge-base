...
← **이전**: [[658_virtio_paravirtualization_vring|658. Virtio - 반가상화 I/O 백엔드/프론트엔드 링버퍼(Vring) 디바이스 드라이버 구조]]
**다음**: [[660_kernel_crash_dump_kdump_architecture|660. 커널 덤프 (Kdump) 시스템 크래시 원인 분석 커널 구조]] →
