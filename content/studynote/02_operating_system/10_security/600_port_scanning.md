...
3. **방어자의 의사결정 (대응 아키텍처)**:
   - 단순 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 스캔 시도는 완전한 차단이 불가능하므로, 방어자는 불필요한 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 자체를 OS 레벨에서 완전히 내리는(Kill [Process](/knowledge-base/studynote/12_it_management/05_security_compliance/943_process/)) <strong>공격 표면 관리(ASM, Attack Surface <a href="/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/">Management</a>)</strong>가 최우선이다.
