...
← **이전**: [[661_ebpf_xdp_express_data_path|661. eBPF 기반 XDP (eXpress Data Path) 커널 네트워크 스택 우회 초고속 패킷 드롭/전달 프레임워크]]
**다음**: [[663_macos_ios_gcd_grand_central_dispatch|663. macOS/iOS Grand Central Dispatch (GCD) 블록 및 디스패치 큐 기반 동시성 구조]] →
