...
← **이전**: [[593_dep_nx_bit|593. 버퍼 오버플로우 방어 하드웨어 기술 (NX Bit / Data Execution Prevention, DEP)]]
**다음**: [[595_canary_stack_smashing_protector|595. 카나리 (Canary) / 스택 스매싱 가드 (Stack Smashing Protector) - 컴파일러 수준 버퍼 변조 탐지]] →
