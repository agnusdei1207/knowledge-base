...
← **이전**: [[633_live_patching_ksplice|633. 무정전 업데이트 (Ksplice 등 커널 재부팅 없는 패치망 체계 구조)]]
**다음**: [[635_concurrency_debugging_tsan|635. 동시성 디버깅 경쟁 조건 재현 기법 퍼저/스레드 새니타이저 (ThreadSanitizer)]] →
