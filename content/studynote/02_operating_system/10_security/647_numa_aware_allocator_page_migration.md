...
← **이전**: [[646_syscall_table_hooking_expansion|646. 리눅스 시스템 콜 테이블 (sys_call_table) 확장 및 보안 훅 추가]]
**다음**: [[648_process_checkpoint_restore_criu|648. 프로세스 체크포인트/리스토어 (CRIU) 컨테이너 마이그레이션 도구 구조]] →
