...
- **📢 섹션 요약 비유**: 의자 50개에 학생 이름이 붙어 있을 때, 처음부터 의자를 다 돌아보며 내 이름을 찾는 노가다([선형 탐색](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/030_linear_search/))를 피하려고, 교실 입구에 내 이름을 넣으면 대충 몇 분단인지 알려주는 번호표 자판기([해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/))를 추가로 설치한 셈입니다.

---

## Ⅲ. 비교 및 연결

### 비교 1: 3대 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 아키텍처 결산
...
### 모바일과 임베디드의 고민
메모리가 1GB도 안 되는 초경량 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 기기에서는 장부 크기 자체가 큰 짐이다. 소프트웨어적으로 역 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 구조를 차용하여 커널의 메모리 풋프린트(Footprint)를 극단적으로 다이어트하는 연구가 지속되고 있다.

- **📢 섹션 요약 비유**: 연비(메모리 절약)를 극한으로 끌어올린 하이브리드 스포츠카(역 테이블)를 만들었지만, 트렁크에 여러 사람 짐(공유 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/))을 실을 수 없고 기존 도로 주유소([호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/))와 규격이 안 맞아 대중화에 실패한 비운의 명차입니다.
...
역 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) (Inverted [Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/))은 가상 메모리의 가장 큰 모순인 "가짜(가상)를 관리하려다 진짜(램)를 탕진한다"는 병폐를 물리 프레임 중심의 [전역 테이블](/knowledge-base/studynote/02_operating_system/10_security/574_global_table/) 설계로 가장 우아하게 부숴버린 걸작이다. 비록 [해시 충돌](/knowledge-base/studynote/05_database/04_transactions_concurrency/563_hash_collision_chaining_linear_probing/)과 공유 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 매핑 불가라는 가시밭길을 걸으며 인텔 x86 범용 시장의 패권을 [다단계 페이징](/knowledge-base/studynote/02_operating_system/06_memory_management/361_hierarchical_paging/)에 넘겨주었지만, 메모리 최적화의 극단을 달리는 클라우드 [하이퍼바이저](/knowledge-base/studynote/02_operating_system/01_overview_architecture/054_hypervisor/) 튜닝이나 64비트를 넘어선 128비트 슈퍼컴퓨팅 아키텍처의 설계 보드 위에서는 언제나 가장 강력한 대체 카드(Plan B)로 살아 숨 쉬고 있다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [다단계 페이징](/knowledge-base/studynote/02_operating_system/06_memory_management/361_hierarchical_paging/) ([Hierarchical Paging](/knowledge-base/studynote/02_operating_system/06_memory_management/361_hierarchical_paging/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [해시 페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/362_hashed_page_table/) ([Hashed Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/362_hashed_page_table/)) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [세그멘테이션](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/) ([Segmentation](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/)) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [세그먼트 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/365_segment_table/) ([Segment Table](/knowledge-base/studynote/02_operating_system/06_memory_management/365_segment_table/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. 역 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) (Inverted [Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/))은 컴퓨터가 메모리를 방처럼 나눠 쓰고 주소를 찾는 방법이에요.
2. 먼저 [해시 페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/362_hashed_page_table/) ([Hashed Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/362_hashed_page_table/))을 이해하면 역 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) (Inverted [Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/))이 왜 필요한지 더 쉽게 보여요.
3. 그래서 역 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) (Inverted [Page Table](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/))을 잘 알면 나중에 [세그멘테이션](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/) ([Segmentation](/knowledge-base/studynote/02_operating_system/06_memory_management/364_segmentation/))도 훨씬 쉽게 배울 수 있어요.
