...
옛날 옛적 도스(MS-[DOS](/knowledge-base/studynote/02_operating_system/10_security/599_dos_ddos_attack/)) 시절에는 환상이 없었다. 개발자가 코드에 `포인터 1000번지`라고 쓰면, 진짜 RAM 하드웨어 소켓의 1000번째 구멍을 찔렀다.
...
**📢 섹션 요약 비유**: 스티븐 스필버그 영화 <트루먼 쇼>를 생각하세요. 트루먼(CPU)은 자기가 걷는 번지수가 진짜 지구([물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/))인 줄 알지만, 사실 거대한 세트장 안의 가짜 주소([논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소)로 둘러싸인 채 연기를 하고 있는 겁니다!
...
**📢 섹션 요약 비유**: [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소는 설계도면 상의 "거실, 안방, 화장실 공간" 같은 아름다운 스케치선이고, [물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/)는 그 도면을 바탕으로 진짜 땅바닥에 박힌 콘크리트 기둥의 "위도/경도 좌표"입니다. 보통 둘은 완전히 다른 숫자를 갖습니다.
...
| 기준 | [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소 개념 부재 시 ([DOS](/knowledge-base/studynote/02_operating_system/10_security/599_dos_ddos_attack/) 시절) | [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소 세계관 도입 시 (현대 OS) |
|:---|:---|:---|
...
| 개념 | 연결 포인트 |
|:---|:---|
| [2단계 잠금 프로토콜](/knowledge-base/studynote/02_operating_system/05_deadlock/320_two_phase_locking_deadlock/) ([2PL](/knowledge-base/studynote/02_operating_system/05_deadlock/320_two_phase_locking_deadlock/))과 데드락 ([데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 연관) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [메모리 계층 구조](/knowledge-base/studynote/02_operating_system/04_synchronization/252_memory_hierarchy/) ([Memory Hierarchy](/knowledge-base/studynote/02_operating_system/04_synchronization/252_memory_hierarchy/))와 레지스터-캐시-메인메모리 접근 | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/) ([Physical Address](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/)) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [주소 바인딩](/knowledge-base/studynote/02_operating_system/06_memory_management/324_address_binding_stages/) ([Address Binding](/knowledge-base/studynote/02_operating_system/06_memory_management/324_address_binding_stages/)) 3단계 시점 | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. "[물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/)"가 우리 집의 진짜 '도로명 주소(서울시 강남구...)'라면, "[논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소"는 엄마가 정해준 '내 방, 누나 방' 같은 가짜 별명 주소예요.
2. 내가 일기장(CPU)에 "나 오늘 '내 방'에서 놀았어!"([논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/) 주소 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/))라고 쓰면, 우체부 아저씨([MMU](/knowledge-base/studynote/02_operating_system/06_memory_management/328_mmu/) 장비)가 그걸 보고 "아! 내 방은 진짜 공간으론 서울시 강남구 203호구나!" 하고 변역해서 찾아([물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/)) 주는 거예요.
3. 이 가짜 주소([논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)) 덕분에 컴퓨터의 모든 프로그램은 "내 방이 제일 넓고 나만 혼자 쓰고 있어!"라고 똑같이 착각하며 마음 편히(해킹 충돌 없이) 놀 수 있게 된 거랍니다!
