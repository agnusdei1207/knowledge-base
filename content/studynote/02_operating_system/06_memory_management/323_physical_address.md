...
### [주소 버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/346_address_bus/)([Address Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/346_address_bus/))와 메모리 칩의 조우
...
| 기준 | 물리 주소 노출/공유 (원시 OS) | [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)/물리 주소 분리 (현대 OS) |
|:---|:---|:---|
...
| [논리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/322_logical_virtual_address/) (Logical/Virtual Address) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [주소 바인딩](/knowledge-base/studynote/02_operating_system/06_memory_management/324_address_binding_stages/) ([Address Binding](/knowledge-base/studynote/02_operating_system/06_memory_management/324_address_binding_stages/)) 3단계 시점 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [컴파일 시간 바인딩](/knowledge-base/studynote/02_operating_system/06_memory_management/325_compile_time_binding/) ([Compile Time](/knowledge-base/studynote/02_operating_system/06_memory_management/325_compile_time_binding/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
2. 반면에 "[논리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/322_logical_virtual_address/)"는 내 마음속에서 "아~ 여기는 내 아지트!" 하고 상상으로 부르는 가짜 이름이죠.
3. 아무리 마음속으로 예쁘게 "로봇아 내 비밀의 방([논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/))에 가져다 줘"라고 명령해도, 로봇(컴퓨터 기계)은 그걸 들으면 결국 "아 삐리빅, 바닥 번호 3번 칸(물리)을 말하는군!" 하고 기계 번호로 번역해야만 짐을 내려놓을 수 있는 진짜 현실 세계랍니다!
...
<- **이전**: [322. 논리 주소 (Logical/Virtual Address) - CPU가 생성하는 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/322_logical_virtual_address/)
**다음**: [324. 주소 바인딩 (Address Binding) 3단계 시점](/knowledge-base/studynote/02_operating_system/06_memory_management/324_address_binding_stages/) ->
