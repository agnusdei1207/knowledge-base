...
- **개념**: 동적 연결 (Dynamic Linking)은 실행 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)(Compile & Link) 시점에 시스템 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) 코드를 포함하지 않고, 오직 '이 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)를 쓸 것이다'라는 포인터([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/))만 남겨둔 채, 실제 프로그램이 실행되어 해당 함수가 호출될 때 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)가 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)를 찾아 메모리에 적재하고 주소를 연결해주는 메커니즘이다.
...
|:---|:---|:---|:---|:---|
| <strong>실행 <a href="/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/">파일</a> (Executable)</strong> | 사용자 프로그램 본체 | 내부에 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) 코드 대신 스터브([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/))를 포함함 | .exe, .elf | 집을 짓기 위한 설계도 |
...
### 스터브([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/)) 기반의 동적 링킹 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 연결([Lazy](/knowledge-base/studynote/06_ict_convergence/05_data_science/380_computational_graph_lazy_eager_execution/) Binding) 흐름
...
### 비교 1: [정적 연결](/knowledge-base/studynote/02_operating_system/06_memory_management/334_static_linking/) ([Static Linking](/knowledge-base/studynote/02_operating_system/06_memory_management/334_static_linking/)) vs 동적 연결 (Dynamic Linking)
...
| 관점 | [동적 적재](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/) ([Dynamic Loading](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/)) | 동적 연결 (Dynamic Linking) |
|:---|:---|:---|
...
1. **상황**: 전 세계 컴퓨터에 깔린 OpenSSL [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)에서 치명적인 하트블리드([Heartbleed](/knowledge-base/studynote/09_security/03_network_security/297_heartbleed/)) 보안 결함이 발견되었다.
2. **동적 연결 환경의 대처**:
...
2. **사이드 이펙트**: 기존의 `v10` [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/)에 강하게 의존하여 동적 연결을 수행하던 업무용 프로그램 B가, 바뀐 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) 규격을 이해하지 못하고 실행 시 크래시(Crash)를 일으킨다.
3. **해결책 (OS의 진화)**: 이 끔찍한 "DLL 지옥"을 막기 위해, 현대 OS는 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)의 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/)별 [병렬](/knowledge-base/studynote/05_database/07_exam_summary/430_index_fast_full_scan/) 설치를 지원하거나(리눅스의 [심볼릭 링크](/knowledge-base/studynote/02_operating_system/09_file_system/512_symbolic_link/) [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 관리), 프로그램 폴더 내부에 로컬 DLL을 두면 시스템 폴더보다 우선적으로 링킹해주는(Side-by-side Assembly) 방어 메커니즘을 구축했다.
...
| 구분 | 내용 |
|:---|:---|
| **스토리지/메모리 절감**| 수천 개의 프로그램이 [공유 라이브러리](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/)를 사용함에 따라 OS 전체의 램과 하드디스크 점유율을 수십 GB 이상 절약 |
| **패치 배포 속도** | 공용 SO/DLL [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 교체만으로 시스템 전체의 취약점을 즉각 방어 ([Zero-day](/knowledge-base/studynote/02_operating_system/10_security/597_zero_day_exploit/) 대응에 필수적) |
| **런타임 확장성** | 프로그램 재배포 없이, 써드파티 개발자가 DLL 형태의 플러그인만 제공하여 본체 기능 확장 가능 |

### 결론 및 미래 전망

동적 연결 (Dynamic Linking)은 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)가 개별 프로그램을 넘어 시스템 전체의 자원을 통제하고 조율하는 '플랫폼'으로 진화하는 데 결정적 기여를 한 아키텍처다. 스터브([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/))를 통한 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 바인딩과 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)를 통한 [물리 주소](/knowledge-base/studynote/02_operating_system/06_memory_management/323_physical_address/) 공유는 컴퓨터 과학이 추구하는 "[추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/)"와 "중복 제거"의 극치를 보여준다. 최근 [도커](/knowledge-base/studynote/02_operating_system/01_overview_architecture/063_docker_architecture/)([Docker](/knowledge-base/studynote/02_operating_system/01_overview_architecture/063_docker_architecture/)) [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/)나 Go, [Rust](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/782_memory_safety_rust_compiler_verification/) 언어의 부상으로 다시 정적 링킹이 재평가받고 있지만, 이는 서버나 클라우드라는 특수 환경에서의 배포 편의성 때문이며, 여전히 모바일(Android/iOS)이나 데스크톱 OS의 코어 생태계는 메모리 한계를 극복하기 위해 강력한 동적 연결 메커니즘 위에서 돌아가고 있다.

- **📢 섹션 요약 비유**: 각자 자동차를 소유하는([정적 연결](/knowledge-base/studynote/02_operating_system/06_memory_management/334_static_linking/)) 시대를 넘어, 도시 전체에 촘촘히 깔린 대중교통망(동적 연결)을 구축함으로써 도로는 덜 막히고 사람들은 더 가볍게 이동할 수 있게 만든 현대 소프트웨어 생태계의 대동맥입니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [한계 레지스터](/knowledge-base/studynote/02_operating_system/06_memory_management/330_limit_register/) ([Limit Register](/knowledge-base/studynote/02_operating_system/06_memory_management/330_limit_register/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [동적 적재](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/) ([Dynamic Loading](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/)) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [공유 라이브러리](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/) ([Shared Library](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/)) 스터브 ([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/)) 코드 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [정적 연결](/knowledge-base/studynote/02_operating_system/06_memory_management/334_static_linking/) ([Static Linking](/knowledge-base/studynote/02_operating_system/06_memory_management/334_static_linking/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
2. 먼저 [동적 적재](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/) ([Dynamic Loading](/knowledge-base/studynote/02_operating_system/06_memory_management/331_dynamic_loading/))을 이해하면 동적 연결 (Dynamic Linking)이 왜 필요한지 더 쉽게 보여요.
3. 그래서 동적 연결 (Dynamic Linking)을 잘 알면 나중에 [공유 라이브러리](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/) ([Shared Library](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/)) 스터브 ([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/852_stub_test_double/)) 코드도 훨씬 쉽게 배울 수 있어요.
