...
- **개념**: 동적 연결 (Dynamic Linking)은 실행 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)(Compile & Link) 시점에 시스템 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) 코드를 포함하지 않고, 오직 '이 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)를 쓸 것이다'라는 포인터([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/460_stub_test_double/))만 남겨둔 채, 실제 프로그램이 실행되어 해당 함수가 호출될 때 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)가 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)를 찾아 메모리에 적재하고 주소를 연결해주는 메커니즘이다.
...
| [공유 라이브러리](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/) ([Shared Library](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/)) 스터브 ([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/460_stub_test_double/)) 코드 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
...
3. 그래서 동적 연결 (Dynamic Linking)을 잘 알면 나중에 [공유 라이브러리](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/) ([Shared Library](/knowledge-base/studynote/02_operating_system/06_memory_management/333_shared_library/)) 스터브 ([Stub](/knowledge-base/studynote/04_software_engineering/11_testing_validation/460_stub_test_double/)) 코드도 훨씬 쉽게 배울 수 있어요.
