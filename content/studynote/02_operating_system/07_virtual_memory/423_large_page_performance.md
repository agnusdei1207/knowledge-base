...
- **개념**: 가상 주소 공간과 물리 램을 연결하는 덩어리([페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/))의 사이즈업(Size-up) 버전이다. 64비트 x86_64 아키텍처에서 기본은 4KB(4096 [바이트](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/074_byte/))지만, 하드웨어가 2MB(Large [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/))와 1GB(Gigantic [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)) 매핑을 추가로 지원한다. 운영체제는 이 거대한 뭉텅이를 하나의 PTE([페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/) 엔트리)에 꽂아버린다.
...
### 대형 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/)가 치러야 할 잔혹한 트레이드오프
...
### 수동 [거대 페이지](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)(HugeTLBfs) vs 투명한 [거대 페이지](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)(THP)

리눅스 진영은 이 [거대 페이지](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)를 어떻게 유저에게 먹일지 두 가지 방법을 내놓았다.

| 옵션 | 1. 명시적 수동 할당 (Explicit [Huge Pages](/knowledge-base/studynote/02_operating_system/06_memory_management/371_huge_pages/)) | 2. 투명한 자동 할당 (THP, Transparent Hugepage) |
|:---|:---|:---|
| **작동 방식** | 관리자가 부팅할 때 램 10GB를 2MB짜리 덩어리로 미리 잘라 락([Lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/))을 걸어둠. | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 데몬(`khugepaged`)이 몰래 돌아다니다 4KB 조각 512개를 뭉쳐서 2MB로 합쳐줌. |
| **개발자 세팅**| 소스코드에서 `mmap()` 특수 [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/) 쓰거나 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/) 지점 맞춰야 함 (어려움) | 아무 짓도 안 해도 OS가 눈치껏 백그라운드에서 합쳐줌 (편함) |
| **안정성** | **완벽함.** 컴팩션 렉 없고 파편화 안 터짐. | **최악의 시한폭탄.** 뭉칠 때마다 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)([Compaction](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/)) 렉 터짐. |
| **주 사용처** | [Oracle](/knowledge-base/studynote/05_database/03_relational_model/188_pl_sql_t_sql_procedural/) DB, [KVM](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/713_kvm_over_ip/) [가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/) 호스트 등 초거대 서버 | 웬만하면 끄는 게(Disable) 실무 백엔드([Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/))의 국룰 |
...
대형 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (Large [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) / Hugepage) 기술은 "세밀한 관리(4KB)가 항상 옳다"는 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)의 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 강박관념을 부수고, "때로는 무식하게 크게 썰어주는 통나무(1GB)가 복잡한 캐시 회로를 뚫어버리는 엑스칼리버가 된다"는 통쾌한 아키텍처적 반항이다. 비록 공간의 낭비([내부 단편화](/knowledge-base/studynote/02_operating_system/06_memory_management/341_internal_fragmentation/))와 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)([Compaction](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/))이라는 흉터를 남겼지만, 메모리 가격이 껌값이 되고 속도가 생명인 빅데이터 시대에서는 공간을 제물로 바쳐 시간을 벌어오는 가장 확실한 연금술로 찬양받고 있다. 앞으로 [CXL](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/441_cxl/)([Compute Express Link](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/441_cxl/))과 옵테인(Optane) 계열의 차세대 [메모리 풀링](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/442_memory_pooling/) 아키텍처가 랙(Rack) 단위로 확장되면, 4KB [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 단위는 아예 자취를 감추고 2MB/1GB 단위의 거대 단위 스왑과 할당이 현대 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)센터를 관통하는 유일한 혈관 규격으로 진화할 것이다.

- **📢 섹션 요약 비유**: 옛날엔 돈(램 용량)이 아까워서 쌀을 10원어치(4KB)씩 매번 봉투에 덜어 샀다면, 부자가 된 현대(64비트 시대)에는 쌀 20kg 포대(2MB [Huge Page](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/517_huge_page/))를 한 방에 사다 놓고 창고에 쑤셔 박아, 밥할 때마다 쌀 사러 나가는 시간([TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) Miss)을 0으로 만들어버리는 플렉스(Flex) 최적화입니다. 쌀벌레(내부 낭비)가 좀 생겨도 내 알 바 아닙니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 메모리 할당의 특징 | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
...
| ZRAM / [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 스왑 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 기술 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [OOM Killer](/knowledge-base/studynote/02_operating_system/07_virtual_memory/425_oom_killer_score/) ([Out-of-Memory](/knowledge-base/studynote/02_operating_system/07_virtual_memory/425_oom_killer_score/)) 작동 우선순위 점수 (oom_score) 매커니즘 | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. 대형 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (Large [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) / Transparent Hugepage)의 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 이점은 컴퓨터가 메모리를 더 크게 보이게 하고 부족함을 숨기는 방법이에요.
2. 먼저 [페이지 고정](/knowledge-base/studynote/02_operating_system/07_virtual_memory/422_page_pinning_locking/) ([Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) Pinning / [Locking](/knowledge-base/studynote/05_database/04_transactions_concurrency/213_locking_mechanism_concurrency_control/))을 이해하면 대형 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (Large [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) / Transparent Hugepage)의 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 이점이 왜 필요한지 더 쉽게 보여요.
3. 그래서 대형 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) (Large [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) / Transparent Hugepage)의 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 이점을 잘 알면 나중에 ZRAM / [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 스왑 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 기술도 훨씬 쉽게 배울 수 있어요.
...
← **이전**: [422. 페이지 고정 (Page Pinning / Locking) - I/O 대기 중인 페이지가 스왑아웃되지 않게 고정 (mlock)](/knowledge-base/studynote/02_operating_system/07_virtual_memory/422_page_pinning_locking/)
**다음**: [424. ZRAM / 커널 스왑 압축 기술 (Zram Swap Compression)](/knowledge-base/studynote/02_operating_system/07_virtual_memory/424_zram_swap_compression/) →
