...
- **등장 배경 및 I/O 병목의 분쇄**:
  1. **[System Call](/knowledge-base/studynote/02_operating_system/01_overview_architecture/013_system_call/) 오버헤드**: `read()` 루프를 100만 번 돌리면 시스템 콜 100만 번이 터져 서버가 기어갔다.
  ...
  3. **[가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) 융합**: 어차피 [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) 시스템이 스왑 디스크를 램처럼 매핑하는 짓([Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/))을 잘하니까, 스왑 대신 일반 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 꽂아버려도 완벽히 똑같이 돌겠다는 천재적인 깨달음.
...
- `mmap` 함수 자체는 램에 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 1바이트도 올리지 않는다. 그냥 프로세스 [페이지 테이블](/knowledge-base/studynote/02_operating_system/06_memory_management/353_page_table/)(장부) 10GB어치를 모두 **`Invalid(I)`** 비트로 도배해 놓고 끝난다. (0.001초 컷).
- 프로그래머가 10GB 중 중간에 있는 5GB 위치의 픽셀을 포인터로 찌른다. (`pixel = p[5000000];`)
- 그 순간 하드웨어 MMU가 `I` 비트를 밟고 **[페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/)([Page Fault](/knowledge-base/studynote/02_operating_system/07_virtual_memory/387_page_fault/))**를 터뜨린다.
...
- 즉, **[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 다루는 모든 I/O 작업이 [가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/)의 [페이지 폴트](/knowledge-base/studynote/02_operating_system/11_exam_summary/720_page_fault_isr/) 엔진에 100% 흡수**되어 버린다. 시스템 개발자는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) I/O 코드를 짤 필요조차 없어진다!
...
|:---|:---|:---|
| **[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 복사(Copy)** | 디스크 -> [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) -> 유저 (2회 복사) | 디스크 -> [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) (**1회 복사, [Zero-copy](/knowledge-base/studynote/02_operating_system/09_file_system/566_mmap_zero_copy_sendfile/)**) |
| **적합한 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 크기** | 수십 KB 수준의 작은 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) | **기가바이트 단위의 초대형 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)** |
...
- 시스템 콜 0회, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 복사 0회. **세상에서 존재하는 가장 빠르고 폭력적인 [프로세스 간 통신](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/)([IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/)) 채널이 바로 이 `mmap` [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)다.**
...
1. **MongoDB의 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 실수**: 
...
| 구분 | 내용 |
|:---|:---|
| **[Zero-Copy](/knowledge-base/studynote/02_operating_system/09_file_system/566_mmap_zero_copy_sendfile/) [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 달성** | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 메모리에서 유저 메모리로의 이중 복사를 원천 차단하여, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) I/O에 소모되는 CPU 사이클과 램 대역폭을 사실상 0으로 수렴 |
| **[요구 페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/255_demand_paging/)의 I/O 융합** | C언어의 포인터 접근(`*p`) 하나만으로 복잡한 디스크 섹터 읽기를 하드웨어 [Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) Fault로 퉁쳐버리는 우아한 코드 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/) |
| **가장 빠른 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 제공** | 수백 MB의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 프로세스끼리 주고받을 때 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)이나 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)의 병목 없이 램 스피드(GB/s)로 통신하는 물리적 지름길 제공 |
