...
← **이전**: [[715_paging_system_frame_table|715. 페이징 시스템 프레임 테이블 (Paging System Frame Table)]]
**다음**: [[717_hierarchical_paging_multi_level|717. 다단계 페이지 테이블 사이즈 줄이기 (Hierarchical Paging Multi Level)]] →
