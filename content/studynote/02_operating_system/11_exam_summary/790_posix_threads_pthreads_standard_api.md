...
|:---|:---|:---|
| <strong><a href="/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/">스레드</a> 관리 (<a href="/knowledge-base/studynote/12_it_management/05_security_compliance/372_management/">Management</a>)</strong> | `pthread_create`, `pthread_join`, `pthread_detach`, `pthread_exit` | [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)를 낳고, 죽이고, 결과값을 받아오거나 아예 고아로 버려버리는(detach) 생명주기 관리. |
