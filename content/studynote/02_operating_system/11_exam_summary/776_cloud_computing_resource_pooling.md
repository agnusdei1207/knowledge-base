...
← **이전**: [[775_partition_mbr_gpt_size_limit|775. 파티션 MBR GPT 크기 제한 (Partition MBR GPT Size Limit)]]
**다음**: [[777_oom_killer_memory_protection|777. OOM 킬러 메모리 보호 정책 (OOM Killer Memory Protection)]] →
