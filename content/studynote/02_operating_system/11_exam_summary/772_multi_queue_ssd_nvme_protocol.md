...
← **이전**: [[771_flash_memory_wear_leveling|771. 플래시 메모리 마모 평준화 (Wear Leveling)]]
**다음**: [[773_object_storage_metadata_decoupling|773. 오브젝트 스토리지 메타데이터 분리 (Object Storage Metadata Decoupling)]] →
