...
|:---|:---|:---|:---|
| <strong>스풀 <a href="/knowledge-base/studynote/02_operating_system/09_file_system/506_directory_structure_symbol_table/">디렉터리</a> (Spool <a href="/knowledge-base/studynote/02_operating_system/09_file_system/506_directory_structure_symbol_table/">Directory</a>)</strong> | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 임시로 적재되는 디스크 내 저장소 | 애플리케이션의 출력 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 포맷으로 변환해 차곡차곡 저장 | `/var/spool/cups/` 경로 내 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) |
| <strong>제어 <a href="/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/">파일</a> (Control <a href="/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/">File</a>)</strong> | [메타데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) 유지 | 원본 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 주인이 누구인지, 인쇄 옵션, 우선순위 등을 기록 | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 옆에 함께 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)되는 작업 헤더 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) |
...
|:---|:---|:---|
| <strong>데드락 (<a href="/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/">Deadlock</a>) 발생</strong> | 디스크 스풀 영역이 100MB인데, App A가 60MB, App B가 60MB짜리 이미지를 동시에 인쇄 버튼을 눌렀다. 스풀 공간이 꽉 차서 A도 B도 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 100% 다 넘기지 못해 인쇄 시작을 못 하고 영원히 기다린다. ([Hold and Wait](/knowledge-base/studynote/02_operating_system/05_deadlock/284_hold_and_wait/)) | <strong>스풀 <a href="/knowledge-base/studynote/02_operating_system/09_file_system/551_quota_disk_limit/">할당량</a>(<a href="/knowledge-base/studynote/02_operating_system/09_file_system/551_quota_disk_limit/">Quota</a>) 강제 및 사전 예약제</strong>: OS는 스풀 공간이 전체 작업 크기를 감당할 수 있을 때만 작업을 접수하고, 부족하면 작업을 거부(Reject)하여 한 작업이라도 끝마칠 수 있게 스풀 스케줄링을 조정한다. |
| **보안 유출 (Information Leak)**| 남의 민감한 서류가 내 디스크의 `/var/spool/`에 장시간 머무름. | <strong><a href="/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/">파일</a> 시스템 접근 제어 (DAC)</strong>: 스풀 폴더의 권한을 root나 특수 `lp` 그룹만 읽고 쓸 수 있도록 엄격히 차단(Permission 700)한다. |
| <strong>장애 시 유실 (<a href="/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/">Data</a> Loss)</strong> | 스풀 [디렉터리](/knowledge-base/studynote/02_operating_system/09_file_system/506_directory_structure_symbol_table/)에 작업이 쌓여있는데 서버 전원이 강제로 나감. | <strong>영구 큐 지속성 (Persistent <a href="/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/">Queue</a>)</strong>: 시스템 재부팅 시 OS(CUPS 데몬)가 스풀 폴더를 스캔하여 덜 찍힌 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 재개(Resume)시킨다. |

### 과목 융합 관점

- <strong><a href="/knowledge-base/studynote/04_software_engineering/01_overview_principles/001_software_engineering_definition/">소프트웨어 공학</a> (SE)</strong>: [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/) 아키텍처는 현대 [마이크로서비스](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/532_microservices_decomposition_patterns/)([MSA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/619_msa_traffic_hardware/)) 디자인 패턴의 <strong><a href="/knowledge-base/studynote/07_enterprise_systems/03_eai_esb_msa/145_message_broker_sync_async/">메시지 브로커</a>(<a href="/knowledge-base/studynote/07_enterprise_systems/03_eai_esb_msa/145_message_broker_sync_async/">Message Broker</a>)</strong> 패턴과 정확히 일치한다. 주문 시스템(App)이 결제 시스템(Printer)을 직접 동기식(Sync)으로 호출하지 않고, [카프카](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/)([Kafka](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/))나 래빗MQ(RabbitMQ)라는 거대한 스풀 영역(Topic/[Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/))에 비동기식(Async)으로 이벤트를 던져놓고 빠지는 Event-driven 아키텍처의 원형이 바로 OS [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/)이다.
- <strong>네트워크 메일 전송 (<a href="/knowledge-base/studynote/03_network/09_application_layer_web_email/488_smtp_simple_mail_transfer_protocol/">SMTP</a>)</strong>: 이메일을 보낼 때 내 PC가 상대방 PC에 직접 쏘지 않는다. 내 메일이 네이버 메일 서버(MTA)의 `/var/spool/mail` 폴더에 임시로 쌓이고([Spooling](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/)), 백그라운드 릴레이 데몬이 상대 구글 서버가 응답할 때까지 재시도하며 전송한다. 인터넷 메일 시스템 전체가 거대한 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/) 시스템이다.
...
### 미래 전망
- <strong><a href="/knowledge-base/studynote/12_it_management/05_security_compliance/206_serverless_cold_start/">서버리스</a> 워크플로우 (<a href="/knowledge-base/studynote/12_it_management/05_security_compliance/206_serverless_cold_start/">Serverless</a> <a href="/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/073_container_orchestration_tools/">Orchestration</a>)</strong>: 단순한 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 쌓기 수준의 [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/)을 넘어서, AWS Step Functions이나 Apache Airflow처럼 "스풀에 쌓인 작업들이 실패하면 재시도하고, A가 끝나면 B 장치로 던진다"는 복잡한 파이프라인 제어 로직을 품은 거대한 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 워크플로우 엔진으로 진화했다.
- <strong>엣지 단말 기반 <a href="/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/">스풀링</a> (Edge <a href="/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/">Spooling</a>)</strong>: [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) 센서 장비들이 네트워크가 끊겼을 때 클라우드로 쏠 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 자체 내장 SD카드에 [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/)(로컬 큐잉)해 두었다가, 통신이 연결되면 다시 백그라운드 릴레이로 밀어 올리는 단절 내성(DTN: Delay-Tolerant Networking) 아키텍처의 기본 기능으로 장착되고 있다.

### 참고 표준
- <strong>IPP (Internet Printing <a href="/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/">Protocol</a>)</strong>: [TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/)/IP 위에서 현대의 인쇄 작업과 스풀 큐의 상태를 관리하기 위해 IETF에서 제정한 개방형 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 프린팅 표준.
- <strong>AMQP (Advanced Message Queuing <a href="/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/">Protocol</a>)</strong>: [스풀링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/457_spooling/)의 현대적 통신 규격이라 할 수 있는 엔터프라이즈 비동기 메시지 지향 미들웨어 표준.
