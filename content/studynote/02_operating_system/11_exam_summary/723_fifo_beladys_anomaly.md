...
← **이전**: [[722_page_replacement_lru_principle|722. 페이지 교체 LRU 원리 (Page Replacement Lru Principle)]]
**다음**: [[724_optimal_page_replacement_unrealizable|724. 최적 알고리즘 (OPT) 구현 불가]] →
