...
← **이전**: [[686_cpu_bound_vs_io_bound_workload|686. CPU 바운드 vs I/O 바운드 (CPU Bound Vs I/O Bound Workload)]]
**다음**: [[688_fcfs_convoy_effect_bottleneck|688. FCFS 호위 효과 (Convoy Effect)]] →
