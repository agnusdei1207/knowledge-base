...
> 1. **본질**: 시스템 콜 ([System Call](/knowledge-base/studynote/02_operating_system/01_overview_architecture/013_system_call/))은 일반 응용 프로그램(User Mode)이 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 읽기, 네트워크 통신, 메모리 할당 등 하드웨어 접근이 필요한 특권 작업을 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)([Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) Mode)에게 **'대신해달라고 부탁하는' 유일한 합법적 소프트웨어 [트랩](/knowledge-base/studynote/02_operating_system/11_exam_summary/677_trap_based_system_call_implementation/)([Trap](/knowledge-base/studynote/02_operating_system/11_exam_summary/677_trap_based_system_call_implementation/))** 통로다.
...
- **필요성(문제의식)**: 
  ...
  - **해결책**: "어떤 프로그램도 하드웨어에 손대지 마라! 오직 전지전능한 '[커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)'만이 하드웨어를 만질 수 있는 **[듀얼 모드](/knowledge-base/studynote/02_operating_system/01_overview_architecture/011_dual_mode/)([Dual Mode](/knowledge-base/studynote/02_operating_system/01_overview_architecture/011_dual_mode/))**를 하드웨어(CPU) 수준에서 강제하자!"
  ...
  - 이 과정에서 공무원이 신분증을 확인하고(권한 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)), 원본을 찾아서 복사본을 내어주기까지 **'기다리는 시간(오버헤드)'**이 발생한다.
...
|:---|:---|:---|
| **1. 모드 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) (Mode [Switch](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/))** | 하드웨어 링(Ring) 레벨이 3에서 0으로 승격되었다가 다시 3으로 강등됨. 보안 [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) 회로가 개입함. | 수십 나노초. (가장 기본적인 시간 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)) |
| **2. 문맥 저장과 복원 ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) Save/Restore)**| 유저 프로그램이 쓰던 CPU [레지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/057_register/) 값([PC](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/164_pc/), [SP](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/166_sp/), Flags 등)을 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)([Stack](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/))에 [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)하고, [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)용 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)을 새로 꺼내 세팅해야 함. | 수십~수백 나노초. 메모리 I/O 동반. |
| **3. 매개변수 복사 (Copy from/to User)** | 유저의 버퍼(`char *buf`) 주소를 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)이 바로 믿고 쓰면 해킹됨. [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)은 그 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 안전한 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 메모리 공간으로 **'물리적 복사(Copy)'**해 와서 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)한 뒤 사용. | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 크기에 비례하여 수 마이크로초 소모. (가장 큰 병목) |
| **4. 캐시와 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인 오염 (Pollution)**| [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 코드가 실행되면서 기존 유저 프로그램이 따뜻하게 데워놓은 L1 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)/[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 캐시(Cache)와 CPU [분기 예측](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/231_branch_prediction/)([Pipeline](/knowledge-base/studynote/12_it_management/02_itsm_itil/082_pipeline/))이 통째로 쫓겨남. | 수십 마이크로초 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/). (눈에 안 보이지만 시스템 전체를 가장 느리게 만드는 악질 병목) |
...
|:---|:---|:---|
| **실행 공간** | **유저 모드 (Ring 3)** | **[커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 모드 (Ring 0)** |
...
| **상호 [관계](/knowledge-base/studynote/05_database/02_modeling_normalization/083_relationship_in_er_model/)** | 래퍼(Wrapper). OS 이식성을 위해 API를 감싸 제공 | [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 안에서 궁극적으로 하드웨어를 다룰 때만 은밀히 호출됨 |

**※ 표준 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)(libc)의 [버퍼링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/454_buffering/) 꼼수**: `printf`를 1만 번 호출한다고 시스템 콜 `write`가 1만 번 불리지 않는다. C [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/)([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/))는 유저 공간의 메모리에 글자들을 조용히 모아두었다가([Buffering](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/454_buffering/)), 버퍼가 꽉 차거나 개행문자(`\n`)를 만날 때만 단 1번 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에 `write()` 시스템 콜을 날린다. **시스템 콜의 횟수를 줄이는 것이 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 최적화의 1원칙**이기 때문이다.

### 과목 융합 관점

- **[가상 메모리](/knowledge-base/studynote/02_operating_system/07_virtual_memory/381_virtual_memory/) ([TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) / [KPTI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/578_kpti/))**: 인텔 CPU의 [스펙터](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/483_spectre/)/[멜트다운](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/482_meltdown/)([Meltdown](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/482_meltdown/)) 보안 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/) 사태 이후, 시스템 콜 오버헤드는 최악의 재앙을 맞았다. [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 공간과 유저 공간의 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 테이블을 완전히 찢어버리는 **[KPTI](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/578_kpti/) ([Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) Page-Table [Isolation](/knowledge-base/studynote/05_database/04_transactions_concurrency/195_isolation_concurrency_control/))** 패치가 적용되면서, 시스템 콜을 부를 때마다 [페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 테이블을 통째로 교체하고 [TLB](/knowledge-base/studynote/02_operating_system/06_memory_management/357_tlb/) 캐시를 다 날려버려야 했다. 이로 인해 I/O 집약적 서버(DB, [Redis](/knowledge-base/studynote/05_database/04_transactions_concurrency/542_redis/))의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 하루아침에 30% 폭락하는 초유의 사태가 있었다.
- **[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 시스템 ([MSA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/619_msa_traffic_hardware/))**: [마이크로서비스](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/532_microservices_decomposition_patterns/) 환경에서 수많은 [REST API](/knowledge-base/studynote/03_network/09_application_layer_web_email/477_rest_api_architecture/)([HTTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/461_http_stateless_connection_oriented/)) 통신은 내부적으로 무수한 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/) `read/write` 시스템 콜을 유발한다. 이 통신 오버헤드를 견디다 못해 최근의 [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/531_cloud_native_architecture/) 아키텍처는 유저 스페이스 내에서 바이패스 통신을 하거나 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 레이어에서 바로 [라우팅](/knowledge-base/studynote/03_network/07_network_layer_routing/339_routing_overview_best_path_selection/)([eBPF](/knowledge-base/studynote/02_operating_system/10_security/615_ebpf/))을 쳐버리는 [서비스 메시](/knowledge-base/studynote/12_it_management/05_security_compliance/302_service_mesh_istio/)([Service Mesh](/knowledge-base/studynote/03_network/16_data_center_cloud/828_service_mesh_microservice_communication_infrastructure/))로 진화 중이다.
...
1. **시나리오 — Nginx 정적 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)(이미지, 동영상) 서빙 서버의 CPU 병목**: 클라이언트가 1GB짜리 영상을 요청했다. 기존 방식으로 `read()` 로 디스크에서 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)로, 다시 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에서 유저 공간 버퍼로 퍼 올린 뒤, 다시 `write()`로 유저에서 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 네트워크 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/) 버퍼로 넘겨서 전송했다. 이 헛짓거리 탓에 10Gbps [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)을 다 [쓰기](/knowledge-base/studynote/13_cloud_architecture/05_data_engineering/289_cqrs_db/)도 전에 CPU 사용률이 100%를 치고 뻗었다.
   - **아키텍트 판단 (sendfile / [Zero-copy](/knowledge-base/studynote/02_operating_system/09_file_system/566_mmap_zero_copy_sendfile/))**: 디스크에 있는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 유저가 굳이 눈으로 볼(조작할) 필요 없이 바로 네트워크로 쏴버려도 된다면, 유저 공간으로 가져오는 행위 자체가 사치다. 리눅스의 **`sendfile()` 시스템 콜**을 사용한다. 이 함수를 부르면 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 내부 공간에서 디스크 버퍼 큐 $\rightarrow$ 네트워크 카드 큐로 직접 [DMA](/knowledge-base/studynote/02_operating_system/11_exam_summary/746_io_direct_memory_access_dma/)([Direct Memory Access](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/318_dma/)) 전송을 꽂아버린다. 유저-[커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 복사 비용이 0이 되는 "[Zero-copy](/knowledge-base/studynote/02_operating_system/09_file_system/566_mmap_zero_copy_sendfile/)" 마법으로 CPU 사용률을 5% 미만으로 떨어뜨린다.

2. **시나리오 — 고빈도 트레이딩 및 [패킷 스니핑](/knowledge-base/studynote/09_security/03_network_security/272_packet_sniffing/) 장비의 한계 돌파 ([DPDK](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/671_dpdk/))**: 초당 1,000만 개의 미세한 네트워크 패킷([UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/))을 처리해야 하는 방화벽이나 금융 거래 장비를 만들고 있다. [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/) `recvfrom()` 시스템 콜을 천만 번 부르면 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 스위칭 오버헤드만으로 시스템이 녹아내린다.
   - **아키텍트 판단 ([Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) Bypass 적용)**: [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)의 시스템 콜과 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 네트워크 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)을 100% 버린다. 인텔의 **[DPDK](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/671_dpdk/) ([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) Plane Development Kit)** 프레임워크를 도입한다. 랜카드([NIC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/587_nic_offloading/))의 메모리 주소를 유저 공간(User Space)의 앱 메모리에 `mmap`으로 직접 매핑하고, 앱이 무한 루프([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/))를 돌며 랜카드에서 직접 패킷을 퍼올린다. 시스템 콜이 아예 0번 발생하므로, 마이크로초(µs) 단위의 극단적 초저지연을 달성한다.
...
| **정량 ([컨텍스트](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) 오버헤드)**| CPU 사이클의 40%가 sys([커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)) 영역 점유 | sys 점유율 5% 미만으로 하락 | 사용자의 비즈니스 로직(us)에 CPU 연산 자원 몰빵 가능 |
