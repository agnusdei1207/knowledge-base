...
|:---|:---|:---|:---|
| 예방 (Prevention) | 4조건 중 1개 시스템 개조 파괴 | [동시성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/014_concurrency/) 극저하, 우회비용 거대 | [Lock Hierarchy](/knowledge-base/studynote/02_operating_system/04_synchronization/276_lock_hierarchy/) 외엔 사멸 |
| **회피 (Avoidance)** | **허락하되 불안전 진입로 차단** | **CPU 연산 O(N^2) 막대, 미래 예측치 강제** | **이론상 완벽하나 학술용 박제** |
| 탐지 ([Detection](/knowledge-base/studynote/09_security/19_ai_advanced_security/961_deepfake_detection/)) | 터지면 끊음 ([타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/)) | [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/) 비용, 가끔 멈춤 | DB 엔진 등 가장 선호 |
| 무시 (Ostrich) | 재부팅 유도 (알빠노 방치) | 1년에 한 번 데이지망(블루스크린) | 인류의 지배적 표준 OS 채택 |

**📢 섹션 요약 비유**: 예방이 성곽벽을 세우는 무식한 막기라면, 회피는 CCTV와 예측 인공지능으로 범죄자를 미리 골라내는 아름다운 예술입니다. 단지 [CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/) 유지비가 국가 예산보다 비싸서(오버헤드) 박물관에 모셔뒀을 뿐입니다.
...
|:---|:---|:---|
| 데드락 안정성 | 상호배제, 선점 같은 제약을 깨부수지 않고도 100% 데드락 없는 자유의지 도출에 성공 | 결국 남은 확률의 도피처가 '안전 구역([Safe State](/knowledge-base/studynote/02_operating_system/05_deadlock/298_safe_state/))'이라는 추상성 |
| 시스템 수용성 | 우아한 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)의 극치, [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 교육의 전설적 유산 ([다익스트라](/knowledge-base/studynote/08_algorithm_stats/03_graph_search/036_dijkstra/)의 영광) | 유저가 미래 자원 사용량을 미리 신고해야 하는 구조 (예측 불가성 앞 붕괴) |

`교착 상태 회피` [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 비록 퍼스널 컴퓨터나 리눅스 범용 서버에 탑재되지는 못했지만, 다중 자원과 스레드가 얽히는 병목의 순간에 "지금 자원이 있어도 주지 않음으로써 대위기([Unsafe State](/knowledge-base/studynote/02_operating_system/05_deadlock/299_unsafe_state/))를 피한다"는 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 할당의 철학적 통찰을 선사했다. 이는 이후 백엔드 소프트웨어 병목 제어나 [MSA](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/619_msa_traffic_hardware/) 회로 차단기([Circuit Breaker](/knowledge-base/studynote/12_it_management/05_security_compliance/304_circuit_breaker/))의 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 설계의 이념적 조상이 되었다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [비선점 부정](/knowledge-base/studynote/02_operating_system/05_deadlock/295_deny_no_preemption/) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [순환 대기 부정](/knowledge-base/studynote/02_operating_system/05_deadlock/296_deny_circular_wait/) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [안전 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/298_safe_state/) ([Safe State](/knowledge-base/studynote/02_operating_system/05_deadlock/298_safe_state/)) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [불안전 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/299_unsafe_state/) ([Unsafe State](/knowledge-base/studynote/02_operating_system/05_deadlock/299_unsafe_state/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. [교착 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/) 회피는 "엄마 나 이 장난감 줘!" 할 때 엄마가 속으로 엄청나게 빨리 미래를 상상해 보는(시뮬레이션) 똑똑한 계산 놀이예요.
...
← **이전**: [296. 순환 대기 부정 (Deny Circular Wait)](/knowledge-base/studynote/02_operating_system/05_deadlock/296_deny_circular_wait/)
**다음**: [298. 안전 상태 (Safe State) - 모든 프로세스가 정상 종료될 수 있는 안전 순서(Safe Sequence)가 존재](/knowledge-base/studynote/02_operating_system/05_deadlock/298_safe_state/) →
