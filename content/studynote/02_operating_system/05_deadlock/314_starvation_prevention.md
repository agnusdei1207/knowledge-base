...
너무 똑똑한 OS가 있다 치자. 교차로에서 4대가 멱살 잡고 데드락 떴을 때 `최소 비용(Min Cost) 수식`을 적용해 무조건 똥차(가벼운 프로세스)인 A를 강제로 [후퇴](/knowledge-base/studynote/02_operating_system/05_deadlock/313_rollback/)([Rollback](/knowledge-base/studynote/02_operating_system/05_deadlock/313_rollback/))시켰다.
...
### Victim 횟수 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/) 기반 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 부여 (Max-Retries Limit)
...
| 상태 및 징후 | [교착 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/) ([Deadlock](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/)) | 기아 상태 (Starvation) |
|:---|:---|:---|
...
| 기준 | [Victim Selection](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/) 단독 운용 | [Victim Selection](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/) + [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/)(기아 쉴드) 기법 융합 |
|:---|:---|:---|
...
| 개념 | 연결 포인트 |
|:---|:---|
| [희생자 선택](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/) ([Victim Selection](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/)) 최소 비용 기준 | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [후퇴](/knowledge-base/studynote/02_operating_system/05_deadlock/313_rollback/) ([Rollback](/knowledge-base/studynote/02_operating_system/05_deadlock/313_rollback/)) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [라이브락](/knowledge-base/studynote/02_operating_system/05_deadlock/315_livelock_vs_deadlock/) ([Livelock](/knowledge-base/studynote/02_operating_system/05_deadlock/315_livelock_vs_deadlock/))과 [교착 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/)의 차이점 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [동기화 결함](/knowledge-base/studynote/02_operating_system/05_deadlock/316_synchronization_bug_debugging/) ([순환 의존성](/knowledge-base/studynote/02_operating_system/05_deadlock/316_synchronization_bug_debugging/)) 코드 레벨 디버깅 기법 | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
← **이전**: [313. 후퇴 (Rollback) - 프로세스를 안전한 상태로 롤백 후 재시작](/knowledge-base/studynote/02_operating_system/05_deadlock/313_rollback/)
**다음**: [315. 라이브락 (Livelock)과 교착 상태의 차이점](/knowledge-base/studynote/02_operating_system/05_deadlock/315_livelock_vs_deadlock/) →
