...
| 기준 | [Abort All](/knowledge-base/studynote/02_operating_system/05_deadlock/308_abort_all/) (전체 죽임) | One-by-One (순차 죽임) |
|:---|:---|:---|
...
| 개념 | 연결 포인트 |
|:---|:---|
| [교착 상태 복구](/knowledge-base/studynote/02_operating_system/05_deadlock/307_recovery_from_deadlock/) ([Recovery from Deadlock](/knowledge-base/studynote/02_operating_system/05_deadlock/307_recovery_from_deadlock/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [프로세스 종료](/knowledge-base/studynote/02_operating_system/02_process_thread/107_process_termination/) 방식 | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [종료 대상 선택](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/) ([희생자 선택](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/)) 기준 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [자원 선점](/knowledge-base/studynote/02_operating_system/05_deadlock/311_resource_preemption/) ([Resource Preemption](/knowledge-base/studynote/02_operating_system/05_deadlock/311_resource_preemption/)) 방식 | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. "전체 종료([Abort All](/knowledge-base/studynote/02_operating_system/05_deadlock/308_abort_all/))"가 장난감 싸움하는 애들 4명 다 놀이터에서 쫓겨나는 무시무시한 전체 벌칙이잖아요?
...
← **이전**: [308. 프로세스 종료 방식 - 교착 상태 프로세스 전체 강제 종료 (Abort all)](/knowledge-base/studynote/02_operating_system/05_deadlock/308_abort_all/)
**다음**: [310. 종료 대상 선택 (희생자 선택) 기준 (Victim Selection)](/knowledge-base/studynote/02_operating_system/05_deadlock/310_victim_selection/) →
