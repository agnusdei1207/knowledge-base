...
### 실무 시나리오
1. **[데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/) 교착**: T1이 row A를 잠금하고 row B를 요청, T2가 row B를 잠금하고 row A를 요청 → 교착. DB는 [대기 그래프](/knowledge-base/studynote/02_operating_system/05_deadlock/305_wait_for_graph/)로 탐지 후 한 [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)을 [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/).
...
- **[락 순서화](/knowledge-base/studynote/02_operating_system/04_synchronization/276_lock_hierarchy/)**: 여러 락이 필요하다면 전역 순서를 정해 반드시 오름차순으로 획득.
- **[타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/)**: 락 획득에 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/)을 설정하여 영구 대기 방지.
- **[Thread](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) Dump 분석**: JVM `jstack`, Linux `pstack`으로 교착 스레드의 락 상태 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/).
