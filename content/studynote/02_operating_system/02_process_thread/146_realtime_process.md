...
<div class="kb-diagram-row"><div class="kb-diagram-node">실시간 프로세스 (Real-time Process)</div></div>
<div class="kb-diagram-connector">▼</div>
...
| 개념 | 연결 포인트 |
|:---|:---|
| CPU 친화성 ([CPU Affinity](/knowledge-base/studynote/02_operating_system/02_process_thread/144_cpu_affinity/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| NUMA-인식 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 스케줄링 | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [스레드 안전](/knowledge-base/studynote/02_operating_system/02_process_thread/147_thread_safe/) ([Thread-safe](/knowledge-base/studynote/02_operating_system/02_process_thread/147_thread_safe/)) 함수 및 [라이브러리](/knowledge-base/studynote/04_software_engineering/06_software_architecture/336_library_vs_framework/) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [재진입 가능 코드](/knowledge-base/studynote/02_operating_system/02_process_thread/148_reentrant_code/) ([Reentrant Code](/knowledge-base/studynote/02_operating_system/02_process_thread/148_reentrant_code/) / Pure [Code](/knowledge-base/studynote/02_operating_system/02_process_thread/082_process_memory_structure/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row"><div class="kb-diagram-node">NUMA-인식 스레드 스케줄링</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">실시간 프로세스 (Real-time Process)</div></div>
...
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">재진입 가능 코드 (Reentrant Code / Pure Code)</div></div>
</div>
</div>
...
← **이전**: [145. NUMA-인식 스레드 스케줄링 (NUMA Thread Scheduling)](/knowledge-base/studynote/02_operating_system/02_process_thread/145_numa_thread_scheduling/)
**다음**: [147. 스레드 안전 (Thread-safe) 함수 및 라이브러리](/knowledge-base/studynote/02_operating_system/02_process_thread/147_thread_safe/) →
