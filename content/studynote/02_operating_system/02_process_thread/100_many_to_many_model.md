...
다대다 모델의 아키텍처는 사용자 공간과 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 공간을 이어주는 가상의 매개체인 경량 프로세스 (LWP, Lightweight [Process](/knowledge-base/studynote/12_it_management/05_security_compliance/943_process/))와, 두 공간 사이의 통신 메커니즘으로 완성된다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| <strong>경량 프로세스 (LWP, Lightweight <a href="/knowledge-base/studynote/12_it_management/05_security_compliance/943_process/">Process</a>)</strong> | 사용자 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)와 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 사이의 인터페이스 역할을 하며, 스케줄링의 징검다리가 되는 자료 구조 |
