...
|:---|:---|:---|:---|
| **[커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 지원** | 전용 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) [모듈](/knowledge-base/studynote/04_software_engineering/04_testing_quality/192_module_independence/) ([binder](/knowledge-base/studynote/02_operating_system/10_security/662_android_binder_ipc_thread_pool/).ko) | 사용자 공간 데몬 | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 시스템 콜 |
...
| **[스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 관리** | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)이 수신자 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) | 수신자가 직접 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 관리 | 수신자가 직접 관리 |
| **객체 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/) 전달** | [Binder](/knowledge-base/studynote/02_operating_system/10_security/662_android_binder_ipc_thread_pool/) 핸들 (Handle) | [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 이름 + 객체 경로 | 미지원 ([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)만 전달) |
| **단일 [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)** | 원자적 처리 | 메시지 단위 분할 가능 | N/A |
...
**실무 시나리오 1. Activity 전환 시의 [Binder](/knowledge-base/studynote/02_operating_system/10_security/662_android_binder_ipc_thread_pool/) [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) (Jank) 분석**:
...
**실무 시나리오 2. [Binder](/knowledge-base/studynote/02_operating_system/10_security/662_android_binder_ipc_thread_pool/) [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 고갈로 인한 ANR (Application Not Responding)**:
...
| **[스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 관리** | 수동 | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 자동 (풀 관리) | 개발 복잡도 감소 |
| **객체 [참조](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/316_reference_pattern_nosql/)** | 이름 기반 | 핸들 (Handle) 기반 | 타입 안전한 [RPC](/knowledge-base/studynote/02_operating_system/02_process_thread/126_rpc/) 보장 |
