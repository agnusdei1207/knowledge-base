...
> 2. **가치**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 전달보다는 이벤트 알림에 특화된 가장 경량화된 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) (Inter-[Process](/knowledge-base/studynote/12_it_management/05_security_compliance/300_process/) Communication) 수단으로, 프로세스 간 (kill 시스템 콜) 또는 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에서 프로세스로 (SIGSEGV, SIGFPE 등) 단순한 통지를 전송할 때 오버헤드가 극히 낮으며, 프로세스 생명주기 관리 (SIGKILL, SIGTERM)와 예외 상태 통보의 표준 수단이다.
