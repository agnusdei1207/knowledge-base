...
> 1. **본질**: POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) (Inter-Process Communication)는 IEEE Std 1003.1 (POSIX.1) 표준에 규격화된 [프로세스 간 통신](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 메커니즘 세트로, [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) ([Shared Memory](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)), [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) ([Semaphore](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)), 메시지 큐 (Message [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/))를 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터 ([File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) Descriptor) 기반으로 제공하여 System V IPC의 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 복잡성과 이식성 문제를 근본적으로 해결한 차세대 표준이다.
> 2. **가치**: [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터 기반이므로 `select()`/`poll()`/`epoll()` 등 기존 I/O 멀티플렉싱 (I/O [Multiplexing](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/071_다중화_Multiplexing/)) 프레임워크와 자연스럽게 통합되며, 마지막 프로세스가 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터를 닫으면 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)이 자동으로 객체를 정리하므로 System V IPC의 [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/) 문제가 원천적으로 방지된다.
> 3. **융합**: POSIX 메시지 큐의 우선순위 기반 메시지 순서 기능은 실시간 [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) (RTOS, Real-Time [Operating System](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/))의 우선순위 스케줄링과 연계되어, 네트워크 패킷 처리, 금융 거래 시스템의 주문 큐, 멀티미디어 스트리밍의 프레임 버퍼 관리 등 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 민감형 (Latency-Sensitive) 시스템에서 핵심 역할을 수행한다.

---

## Ⅰ. 개요 및 필요성

- **개념**: POSIX IPC는 POSIX (Portable [Operating System](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) Interface) 표준의 일부로 정의된 세 가지 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 메커니즘 -- POSIX [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/), POSIX [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) (명명된/익명), POSIX 메시지 큐 -- 의 총칭이다. System V IPC가 정수 키 (`key_t`)와 전용 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) (`xxxget`/`xxxop`/`xxxctl`)를 사용하는 반면, POSIX IPC는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 네임스페이스에 객체를 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)하고 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터 (`int fd`)로 접근한다는 근본적 차이가 있다. `shm_open()`은 `/dev/shm` (Linux) 또는 `/tmp` (macOS)에 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 형태로 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) 객체를 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)하며, `sem_open()`은 명명된 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)를 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 경로로 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/)하고, `mq_open()`은 [마운트](/knowledge-base/studynote/02_operating_system/09_file_system/516_mount_mechanism/)된 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 (일반적으로 `/dev/mqueue`)에 메시지 큐를 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)한다.

- **필요성**: System V IPC는 1980년대에 설계된 훌륭한 기술이지만, 세 가지 근본적 한계가 존재한다. 첫째, `ftok()` 기반의 키 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/)은 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) i-node 변경 시 불일치 위험이 있고 디버깅이 어렵다. 둘째, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터가 아닌 정수 [식별](/knowledge-base/studynote/09_security/13_secops_ir_forensics/655_ir_detection_analysis/)자를 사용하므로 `select()`/`poll()`/`epoll()` 같은 표준 I/O 멀티플렉싱에 통합할 수 없다. 셋째, [프로세스 종료](/knowledge-base/studynote/02_operating_system/02_process_thread/107_process_termination/) 후에도 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 객체가 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에 영구 존재하므로 명시적 정리가 누락되면 [메모리 누수](/knowledge-base/studynote/02_operating_system/10_security/612_memory_leak_detection/)가 발생한다. POSIX IPC는 이 세 가지 문제를 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터 기반 아키텍처로 일괄 해결한다. [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터 기반이므로 기존 I/O 모델과 완벽하게 통합되고, `close()` 시 자동 정리되며, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 경로 기반이므로 `ls`/`rm` 등 familiar한 도구로 관리할 수 있다.

- **등장 배경 및 발전 과정**:
  1. **POSIX.1 (1990년)**: System V IPC와 BSD [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)의 장점을 통합한 표준 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 규격의 필요성이 제기되었다.
  2. **POSIX.1b (Real-time Extensions, 1993년)**: `shm_open()`, `sem_open()`, `mq_open()` 등 POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) API가 표준으로 제정되었다. [실시간 시스템](/knowledge-base/studynote/02_operating_system/01_overview_architecture/009_real_time_system/)의 요구에 맞춰 우선순위 메시지 큐와 우선순위 [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) ([Priority Inheritance](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/206_priority_inheritance/)) [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)가 포함되었다.
  3. **Linux 2.6 (2003년) 이후**: POSIX IPC가 Linux [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에 완전히 통합되어, `CONFIG_POSIX_MQUEUE`, `CONFIG_POSIX_SHARED_MEMORY_OBJECTS` 등 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) 옵션으로 지원되기 시작했다. 현재는 대부분의 리눅스 배포판에서 기본 활성화되어 있다.
...
- **📢 섹션 요약 비유**: System V IPC가 전용 사원증([key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/))과 관리실(ipcs)이 필요한 폐쇄적인 회사 시설이라면, POSIX IPC는 일반 건물 주소([파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 경로)와 현관문(close)이 있는 개방적인 시설로, 기존의 우편 배달 시스템([select](/knowledge-base/studynote/05_database/04_transactions_concurrency/520_select/)/poll)과도 자연스럽게 연결됩니다.
...
|:---|:---|:---|:---|:---|
| **shm_open() / shm_unlink()** | [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 기반 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/) 객체 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)/삭제 | `/dev/shm/`에 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 형태로 객체 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 후 fd 반환 | `ftruncate()`, `mmap()` | 공용 화이트보드 예약 |
| **sem_open() / sem_close() / sem_unlink()** | 명명된 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)/닫기/삭제 | [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/)에 명명된 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) 객체 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/), fd 반환 | `sem_wait()`, `sem_post()` | 회의실 예약 시스템 |
| **sem_init() / sem_destroy()** | 익명 [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) 초기화/해제 | 프로세스 또는 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 간 [공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/)에 배치 | `pshared` [플래그](/knowledge-base/studynote/03_network/04_data_link_layer_error/186_character_stuffing_dle_stx_etx/) | 가벼운 사내 규칙 |
| **mq_open() / mq_close() / mq_unlink()** | 우선순위 기반 메시지 큐 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)/닫기/삭제 | `/dev/mqueue/`에 큐 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/), fd 반환 | `mq_send()`, `mq_receive()` | 우선순위 우편함 |
| **mq_notify()** | 메시지 도착 시 시그널 또는 콜백 등록 | 비동기 통지를 위해 시그널 또는 SIGEV_THREAD [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) | 시그널, 콜백 함수 | 도착 알림 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) |
...
① `mq_open()`으로 메시지 큐 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) -> ② `mq_send(mqd, data, len, priority)`로 우선순위와 함께 메시지 송신 -> ③ 큐 내부가 우선순위 순으로 자동 정렬 -> ④ `mq_receive(mqd, buf, maxlen, &priority)`로 최고 우선순위 메시지 수신 -> ⑤ `mq_close(mqd)`로 fd 닫기, `mq_unlink(name)`으로 큐 삭제.
...
### 비교 2: POSIX [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) vs System V [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/)
...
- **📢 섹션 요약 비유**: 모든 편지함(POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/))이 같은 우편 배달부(epoll)가 순회할 수 있는 한 건물 안에 있는 반면, 일부 편지함([System V IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/132_system_v_ipc/))은 별도의 건물에 있어서 전용 배달부(별도 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/))를 고용해야 하는 것이 실무적 차이입니다.
...
- **기술적**: POSIX 메시지 큐의 `msg_max`, `msgsize_max` [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 파라미터가 애플리케이션 요구를 충족하는가? `mq_notify()` 기반 비동기 통지가 시그널 안전 함수만 사용하는가?
- **운영 보안적**: `/dev/mqueue/`의 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 권한이 최소 원칙을 따르는가? [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/) 환경에서 [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 자원이 노드 전체에 공유되는 것에 대한 자원 제한 (Resource Limit) 정책이 수립되었는가?
...
| 구분 | [System V IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/132_system_v_ipc/) | POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) | 개선 효과 |
|:---|:---|:---|:---|
| **정량** | 메시지 큐 감시에 별도 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 필요 | fd 기반으로 단일 epoll 통합 | [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/) 수 **N에서 1로 감소** |
| **정량** | `msgrcv` 수신 시 타입별 [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) 필요 | `mq_receive`가 최고 우선순위 자동 반환 | 우선순위 [처리 지연](/knowledge-base/studynote/03_network/01_data_communication/019_처리_지연/) **0** |
| **정성** | `ipcrm` 수동 정리, 누수 빈발 | `close()` + `unlink()` 후 자동 정리 | 운영 오버헤드 **대폭 감소** |
| **정성** | [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 학습 곡선 가파름 | `open/close/wait/post` 직관적 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) | 개발 생산성 향상 |
...
- **Linux man pages**: `mq_overview(7)`, `sem_overview(7)`, `shm_overview(7)` POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) 개요
- **Real-time POSIX.1b (IEEE 1003.1b-1993)**: 우선순위 메시지 큐, 우선순위 [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/) 등 실시간 확장 규격

POSIX IPC는 System V IPC가 40년간 축적한 실무 경험을 바탕으로, [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 디스크립터라는 범용 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/)를 통해 IPC를 현대 리눅스의 이벤트 드리븐 아키텍처에 자연스럽게 통합한 설계다. System V IPC의 핵심 기능 ([공유 메모리](/knowledge-base/studynote/02_operating_system/02_process_thread/118_shared_memory/), [세마포어](/knowledge-base/studynote/02_operating_system/04_synchronization/224_semaphore/), 메시지 큐)을 유지하면서도, [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 단순화, 자동 메모리 정리, [이벤트 루프](/knowledge-base/studynote/02_operating_system/02_process_thread/142_event_loop/) 통합이라는 세 가지 치명적 개선을 달성했다. 새로운 프로젝트에서 [System V IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/132_system_v_ipc/) 대신 POSIX IPC를 기본 선택하는 것은, 더 나은 이식성과 유지보수성을 확보하는 합리적인 기술사적 판단이다.

- **📢 섹션 요약 비유**: 40년 된 건물([System V IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/132_system_v_ipc/))의 훌륭한 설계를 인정하면서도, 그 건물에 현대적인 자동문(fd 기반), 자동 소화 설비(자동 정리), 중앙 제어 시스템(epoll 통합)을 설치하여 새 건물(POSIX [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/))로 개조한 것이 바로 POSIX IPC의 설계 철학입니다.
...
| 시스템 V [IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/117_ipc/) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [D-Bus](/knowledge-base/studynote/02_operating_system/02_process_thread/134_dbus/) ([Desktop Bus](/knowledge-base/studynote/02_operating_system/02_process_thread/134_dbus/)) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [안드로이드 바인더](/knowledge-base/studynote/02_operating_system/02_process_thread/135_android_binder/) ([Android Binder](/knowledge-base/studynote/02_operating_system/02_process_thread/135_android_binder/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. POSIX IPC는 도로명 주소가 적힌 일반 건물이에요. 공용 게시판(shm_open), 회의실 예약 시스템(sem_open), 우선순위 우편함(mq_open)이 모두 건물 주소([파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 경로)로 찾을 수 있어요.
...
<- **이전**: [132. 시스템 V IPC (System V IPC)](/knowledge-base/studynote/02_operating_system/02_process_thread/132_system_v_ipc/)
**다음**: [134. D-Bus (Desktop Bus) - 리눅스 데스크톱 환경 IPC](/knowledge-base/studynote/02_operating_system/02_process_thread/134_dbus/) ->
