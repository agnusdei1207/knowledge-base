...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">실시간 시스템의 핵심: 타이밍 파라미터</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Event Occur (t0)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">▼ &lt;--- Latency (지연 시간)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Task Start (t1)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">▼ &lt;--- Execution Time (실행 시간)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Task End (t2)</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">Deadline (D)</div><div class="kb-diagram-node">성공 여부 판단</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">1. t2 &lt;= D : 성공 (Success)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">2. t2 &gt; D : 실패 (System Failure)</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">실시간 시스템의 분류 및 가치 곡선</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">가치</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">1.0</div><div class="kb-diagram-cell">1. Hard Real-time (에어백)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">- 데드라인 위반 = 대참사</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">2. Soft Real-time (동영상 스트리밍)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">- 위반 시 품질 저하, 시스템 유지</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">시간 (Time)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">Deadline</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">* Hard RT: 데드라인 즉시 가치가 -∞ 로 수렴</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">* Soft RT: 데드라인 이후 가치가 서서히 감소</div></div>
</div>
</div>
...
<div class="kb-diagram" data-diagram="ascii-converted">
<div class="kb-diagram-flow">
<div class="kb-diagram-row"><div class="kb-diagram-node">임베디드 시스템 — 장치 제어의 시작</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">실시간 OS(RTOS) — 지연 예측 가능성 확보</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">하드/소프트 실시간 분류 — 기한 위반 허용 범위 구분</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">스케줄링 정책(EDF, RMS) — 마감 시점 중심 배치</div></div>
<div class="kb-diagram-connector">▼</div>
<div class="kb-diagram-row"><div class="kb-diagram-node">자율주행/산업제어 응용 — 안전 핵심 시스템 적용</div></div>
</div>
</div>
