...
> 1. **본질**: [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/) ([Starvation](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)) 또는 무기한 봉쇄 (Indefinite [Blocking](/knowledge-base/studynote/02_operating_system/02_process_thread/122_sync_async_communication/))는 시스템 전체는 계속 일하고 있지만, 특정 프로세스나 [스레드](/knowledge-base/studynote/02_operating_system/02_process_thread/092_thread_lwp/)가 불공정한 선택 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 때문에 실행 기회를 무기한 뒤로 미루는 현상이다.
> 2. **가치**: [교착 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/) ([Deadlock](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/))처럼 모두가 멈추는 문제는 아니어서 더 위험할 수 있으며, 겉보기 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 좋아도 일부 작업이 영원히 끝나지 않는 구조적 불공정을 드러낸다.
> 3. **판단 포인트**: [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/), [SJF](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/) ([Shortest Job First](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/)), 단일 [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/) 같은 고효율 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)은 반드시 [에이징](/knowledge-base/studynote/02_operating_system/07_virtual_memory/411_aging_algorithm/) ([Aging](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/)), [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) (Round Robin), 공정 큐잉, 자원 분리 같은 보정 장치와 함께 설계해야 한다.
...
| 발생 조건 | 설명 | 대표 사례 |
| :--- | :--- | :--- |
| 엄격한 선호 규칙 | 특정 큐나 짧은 작업을 항상 먼저 선택 | 고정 우선순위, [SJF](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/) |
...
| :--- | :--- | :--- | :--- |
| [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/) ([Starvation](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)) | 다른 작업은 계속 [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/) | 불공정한 선택 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) | [에이징](/knowledge-base/studynote/02_operating_system/07_virtual_memory/411_aging_algorithm/), 공정 큐, [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) |
| [교착 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/) ([Deadlock](/knowledge-base/studynote/02_operating_system/05_deadlock/281_deadlock_definition/)) | 관련 작업 모두 정지 | 순환 자원 대기 | 예방, 회피, 탐지/[복구](/knowledge-base/studynote/09_security/13_secops_ir_forensics/658_ir_recovery/) |
| [우선순위 역전](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/205_priority_inversion/) ([Priority Inversion](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/205_priority_inversion/)) | [진행](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/216_progress_in_synchronization/)은 되지만 고우선 작업 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) | 낮은 우선순위 작업이 락 보유 | 우선순위 [상속](/knowledge-base/studynote/04_software_engineering/04_testing_quality/234_uml_class_relationships_generalization_dependency/) |
...
1. **최대 대기 시간이 상한 없이 증가하는가?** 평균보다 최댓값과 꼬리 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)을 봐야 한다.
2. **특정 우선순위나 작업 유형만 반복적으로 밀리는가?** 클래스별 편향을 측정해야 한다.
3. **대기 보정이 있는가?** [에이징](/knowledge-base/studynote/02_operating_system/07_virtual_memory/411_aging_algorithm/), 큐 승급, 최소 지분 보장, [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) 혼합 여부를 확인한다.
4. **공유 자원을 한 풀에 몰아넣었는가?** [스레드 풀](/knowledge-base/studynote/02_operating_system/02_process_thread/103_thread_pool/), 커넥션 풀, 락 구조를 분리할 필요가 있다.
...
- 오래 기다린 작업의 우선순위를 점진적으로 올리는 [에이징](/knowledge-base/studynote/02_operating_system/07_virtual_memory/411_aging_algorithm/) 적용
- 같은 우선순위 내부에는 RR을 섞어 독점을 방지
- 배치, 실시간, 외부 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 호출용 풀을 분리해 자원 독점 차단
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/) ([Priority Scheduling](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/)) | [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)를 가장 직접적으로 만들 수 있는 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)이다 |
| [SJF](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/) ([Shortest Job First](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/)) | 짧은 작업 우대가 긴 작업 기아로 이어질 수 있다 |
| [에이징](/knowledge-base/studynote/02_operating_system/07_virtual_memory/411_aging_algorithm/) ([Aging](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/)) | 오래 기다린 작업의 우선순위를 높여 기아를 완화한다 |
| [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) (Round Robin) | 실행 기회를 순환시켜 [bounded waiting](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/217_bounded_waiting/) 보장에 도움을 준다 |
| [MLFQ](/knowledge-base/studynote/02_operating_system/11_exam_summary/691_mlfq_multi_level_feedback_queue/) (Multilevel Feedback [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/)) | 동적 승급과 강등으로 응답성과 공정성을 절충한다 |
| CFS (Completely Fair Scheduler) | [가상 실행 시간](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/203_virtual_runtime_vruntime/) 기반으로 장기 공정성을 추구한다 |
| [우선순위 역전](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/205_priority_inversion/) ([Priority Inversion](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/205_priority_inversion/)) | [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)와 헷갈리기 쉬운 인접 현상이다 |
...
1. [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)는 줄이 끊어진 게 아니라, 앞사람만 계속 먼저 불려서 어떤 친구가 영원히 자기 차례를 못 받는 일이에요.
...
← **이전**: [180. 우선순위 스케줄링 (Priority Scheduling) - 무한 대기 문제 발생 가능](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/)
**다음**: [182. 노화 (Aging) - 기아 상태 해결책 (우선순위 점진적 상승)](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/182_aging/) →
