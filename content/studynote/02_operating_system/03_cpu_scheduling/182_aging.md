...
> 1. **본질**: 노화 (Aging)는 레디 큐 ([Ready Queue](/knowledge-base/studynote/02_operating_system/02_process_thread/088_ready_queue/))에서 오래 기다린 프로세스의 우선순위를 시간에 비례해 점진적으로 높여, 결국 CPU (Central Processing Unit) 실행 기회를 얻도록 만드는 동적 스케줄링 보정 기법이다.
> 2. **가치**: [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/)이나 [SJF](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/) ([Shortest Job First](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/))의 효율을 완전히 버리지 않으면서도, 낮은 우선순위나 긴 작업이 영원히 밀리는 [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/) ([Starvation](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/))를 [bounded waiting](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/217_bounded_waiting/) 관점에서 완화한다.
> 3. **판단 포인트**: 승급 주기, 승급 폭, 최고 우선순위 상한을 어떻게 잡느냐에 따라 공정성과 응답성의 균형이 갈리며, 현대의 [MLFQ](/knowledge-base/studynote/02_operating_system/11_exam_summary/691_mlfq_multi_level_feedback_queue/) (Multilevel Feedback [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/))와 CFS (Completely Fair Scheduler)는 이 철학을 서로 다른 방식으로 계승한다.
...
| 구성 요소 | 역할 | 설계 포인트 |
| :--- | :--- | :--- |
| 기본 우선순위 (Base Priority) | 작업의 원래 중요도 표현 | [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 차등 유지 기준 |
| 대기 시간 [카운터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/059_counter/) | 큐에서 기다린 시간 누적 | [tick](/knowledge-base/studynote/02_operating_system/01_overview_architecture/073_tick_jiffies/) 또는 ms 단위로 측정 |
| 노화 규칙 | 우선순위 재계산 | 승급 주기와 승급 폭이 핵심 |
| 재정렬 | 우선순위 변화 반영 | 힙, 트리, 다단계 큐 재배치 필요 |
| 상한/리셋 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) | 무한 승급 방지 | 실행 후 원복 혹은 감쇠 고려 |
...
| :--- | :--- | :--- | :--- | :--- |
| 고정 [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/) | 중요 작업 응답성 높음 | 하위 작업 무기한 대기 가능 | 높음 | 하드 실시간, 강한 우선권 필요 |
| 노화 적용 [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/) | 우선순위 의미 유지 + 공정성 보완 | 승급 규칙 튜닝 필요 | 낮음 | 범용 [시분할 시스템](/knowledge-base/studynote/02_operating_system/01_overview_architecture/003_time_sharing_system/) |
| [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) (Round Robin) | 실행 기회 순환 보장 | 중요도 차등 표현 약함 | 매우 낮음 | 같은 클래스 내부 공정 배분 |
...
- 너무 드문 승급으로 사실상 기아를 방치하는 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)
- 너무 잦은 승급으로 우선순위 체계를 무력화하는 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| [기아 상태](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/) ([Starvation](/knowledge-base/studynote/02_operating_system/05_deadlock/314_starvation_prevention/)) | 노화가 해결하려는 직접 대상이다 |
| [bounded waiting](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/217_bounded_waiting/) | 노화의 설계 목표를 설명하는 기준이다 |
| [우선순위 스케줄링](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/) ([Priority Scheduling](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/180_priority_scheduling/)) | 노화가 가장 자주 결합되는 기본 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/)이다 |
| [SJF](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/) ([Shortest Job First](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/175_sjf_scheduling/)) | 긴 작업 기아 문제와 연결된다 |
| [MLFQ](/knowledge-base/studynote/02_operating_system/11_exam_summary/691_mlfq_multi_level_feedback_queue/) (Multilevel Feedback [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/)) | periodic boost 형태로 노화 철학을 계승한다 |
| CFS (Completely Fair Scheduler) | 명시적 승급 대신 vruntime으로 유사 효과를 낸다 |
| [RR](/knowledge-base/studynote/03_network/16_data_center_cloud/834_load_balancing_algorithm_round_robin_least_connection/) (Round Robin) | 같은 우선순위 내부 공정 배분의 비교 기준이다 |
