...
- **개념**: SSD는 '[Solid](/knowledge-base/studynote/04_software_engineering/04_testing_quality/242_solid_object_oriented_design_principles/) [State](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/)', 즉 모터나 톱니바퀴같이 물리적으로 움직이는 부품(기계적 구동부)이 단 하나도 없이 순수하게 고체 [반도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/009_semiconductor/)([트랜지스터](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/014_transistor/))의 전기 신호만으로 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 영구 저장하는 드라이브다. 안에 뜯어보면 작은 낸드(NAND) 칩 몇 개와 두뇌 역할을 하는 컨트롤러(Controller), 캐시용 램([DRAM](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/251_dram/))이 기판에 박혀있을 뿐이다.
- **필요성**: CPU 클럭은 기가헤르츠(GHz)를 뚫고 램은 DDR4로 날아다니는데, 가장 중요한 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 저장소인 HDD는 여전히 1950년대 LP판처럼 바늘을 덜그럭거리며 돌리고 있었다. 아무리 비싼 인텔 i9 CPU를 꽂아도 윈도우 부팅에 1분이 걸렸고 포토샵 켜는 데 30초가 걸렸다. "컴퓨터의 모든 체감 렉은 저 빌어먹을 디스크 바늘([Seek Time](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/467_disk_access_time/)) 때문이다! 모터를 아예 뜯어버리고, 전기를 쏴서 빛의 속도로 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 낚아채는 매체가 없다면 컴퓨터의 진화는 끝이다!"라는 절박함이 [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/) 시대를 강제로 열어젖혔다.
...
### 낸드 플래시의 치명적 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/) 2가지 (근원적 병목)
...
### 구원자 [FTL](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/478_ftl_flash_translation_layer/) ([Flash Translation Layer](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/478_ftl_flash_translation_layer/))의 흑마술 매핑
...
### 비교 1: [SLC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/597_slc_caching/) vs MLC vs TLC vs QLC (자본주의의 극한 [압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/))
...
솔리드 [스테이트](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 드라이브 ([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/), [Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) 구조는 반세기 동안 인류의 발목을 잡고 있던 '아날로그 기계식 모터([HDD](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/465_hdd_structure/))'의 사슬을 끊어버린 컴퓨터 아키텍처 역사상 가장 통쾌한 혁명이다. "바늘이 없으니 무조건 빠를 것이다"라는 환상과 달리, 덮어쓰기가 불가능한([Erase-before-write](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/476_flash_memory_limitations/)) 플래시 소자의 태생적 하자를 덮기 위해 [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/) 내부에서는 FTL이라는 초고도화된 '[가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/) 사기극'이 1나노초마다 피 터지게 벌어지고 있다. 오늘날 SATA의 좁은 문을 부수고 [PCIe](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/) 고속도로에 직접 꽂히는 [NVMe](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/) 시대를 열어젖힌 이 괴물은, 향후 디스크라는 개념 자체를 지워버리고 영구적으로 전원이 꺼지지 않는 램(PMEM, NVDIMM)과 [CXL](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/441_cxl/) 풀링으로 융합되며 "저장소(Storage)와 메모리(Memory)"라는 100년 된 계급 차이를 완벽히 붕괴시키는 종착역을 향해 달려가고 있다.

- **📢 섹션 요약 비유**: 두꺼운 백과사전([HDD](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/465_hdd_structure/))을 뒤적거리며 답을 찾던 인류가, 뇌에 칩([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/))을 꽂아 질문하는 즉시 머릿속에 정답이 팍 떠오르는 초능력을 얻었습니다. 비록 그 칩이 뇌세포를 조금씩 갉아먹는 수명 제한(Wear-out)이 있고 밤마다 뇌 속 쓰레기를 청소(GC)해야 하는 부작용이 있지만, 이 압도적인 지식의 속도 쾌감을 맛본 이상 다시는 무겁고 먼지 나는 책장([HDD](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/465_hdd_structure/)) 앞으로 돌아갈 수 없는 것입니다.
...
| 리눅스 I/O [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [플래시 메모리](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/256_flash_memory/) 한계 | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [가비지 컬렉션](/knowledge-base/studynote/02_operating_system/06_memory_management/380_garbage_collection/) ([Garbage Collection](/knowledge-base/studynote/02_operating_system/06_memory_management/380_garbage_collection/) in [SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. 솔리드 [스테이트](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 드라이브 ([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/), [Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) 구조은 컴퓨터가 디스크와 장치가 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 주고받는 길을 정리하는 방법이에요.
2. 먼저 리눅스 I/O [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/)을 이해하면 솔리드 [스테이트](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 드라이브 ([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/), [Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) 구조이 왜 필요한지 더 쉽게 보여요.
3. 그래서 솔리드 [스테이트](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/272_state_pattern/) 드라이브 ([SSD](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/), [Solid State Drive](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/327_ssd/)) 구조을 잘 알면 나중에 [플래시 메모리](/knowledge-base/studynote/01_computer_architecture/06_memory_hierarchy_cache/256_flash_memory/) 한계도 훨씬 쉽게 배울 수 있어요.
...
← **이전**: [474. 리눅스 I/O 스케줄러 - NOOP, CFQ(Completely Fair Queuing), Deadline, BFQ](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/474_linux_io_schedulers/)
**다음**: [476. 플래시 메모리 한계 - 덮어쓰기 불가(Erase-before-write), 쓰기 횟수 제한(Wear-out)](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/476_flash_memory_limitations/) →
