...
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">계층적 파일시스템(NAS) vs 거대 평면 오브젝트 스토리지</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">기존 NAS (Hierarchical File System 계층 구조) 병목</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-connector">▶</div><div class="kb-diagram-node">😺 cat.jpg</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">(경로를 다이렉토리 인덱스 락을 거쳐가며 타고 타고 탐색해야 함)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">* 약점: 폴더 안에 파일이 천만 개면 탐색 트리가 비대해져서 속도 멸망 폭발!</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">차세대 Object Storage (Flat Namespace 분산 무한 확장 병렬 바닥)</div></div>
<div class="kb-diagram-row"><div class="kb-diagram-node">거대 버킷 Bucket (수천 대 서버 노드가 하나인 척하는 무한 IP 평면 바닥)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">─ 📦 Object: ID "http://aws.s3/img/A1B2C3" (데이터 + 메타)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">─ 📦 Object: ID "http://aws.s3/img/X9Y8Z7" (데이터 + 메타)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">─ 📦 Object: ID "http://aws.s3/doc/123456" (데이터 + 메타)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">(수십억 개가 그냥 납작하게 평면으로 배열 ID 해시로 누워있음)</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">💡 동작 스택방식: 앱이 "폴더 마운트"를 하지 않음. 그냥 브라우저처럼</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">HTTP RESTful <code>GET http://.../A1B2C3</code> 주소를 때리면</div></div>
<div class="kb-diagram-row kb-diagram-grid-row"><div class="kb-diagram-cell">오브젝트 덩어리(Payload)가 인터넷 선을 타고 JSON이랑 같이 툭 튀어나옴!</div></div>
</div>
</div>
