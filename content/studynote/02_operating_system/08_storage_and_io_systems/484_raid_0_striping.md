...
> 1. **본질**: [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ([스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/), Striping) ([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 Striping)은 스토리지와 입출력 경로 최적화에서 핵심 흐름을 결정하는 개념으로, 시스템이 무엇을 먼저 관리하고 어떤 순서로 제어할지를 분명하게 만든다.
> 2. **가치**: 이 개념을 이해하면 자원 효율, [응답 시간](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/138_response_time/), 안정성 사이의 균형을 더 정확하게 설명할 수 있고, [RAID 1](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/485_raid_1_mirroring/) ([미러링](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/333_raid_1/), Mirroring)로 이어지는 이유도 자연스럽게 파악된다.
> 3. **판단 포인트**: [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) (Redundant [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) of Independent Disks)과의 관계를 함께 봐야 [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ([스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/), Striping) ([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 Striping)을 단순 정의가 아니라 실제 설계·운영 판단 기준으로 사용할 수 있다.
...
- **ð ìì ìì ëì**: ìì ëì ìë 10ìì êìëë([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0)ë ëì ìëì ìì ëë ì ìê ëëììë, ìêì ëë êê ë 1ê (êë ëìí 1ê)ëë ëëìë ê ììëë ìëë êìëë ììê ìëì(ëìí ëê 0%)ëì íìëë êëìì ìêìëë.
...
[RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0ì ìë íëì íìì **ìí íê(Chunk Size = Stripe Size)** ì ììêì ëë êì ëë ìë. ìêì ìíëìììì I/O íì(ëë vs ìì, íìì íê)ê ìëíê ëìëììë ì ìëì ëííë.
...
### êí íìë ([Fault Tolerance](/knowledge-base/studynote/02_operating_system/11_exam_summary/800_system_architecture_fault_tolerance_dual/))ê ìíììë '0'ì ìì
...
- **ð ìì ìì ëì**: ë(ëìí)ë ìë ì ëìì ë(I/O ìëí)ë ë êì ììë ìëí ìëì ìëë ìì(ìë ìí)í ì ììë, ëì ìë ëë ì ë íëëë ëì ëê êëììë([SPOF](/knowledge-base/studynote/01_computer_architecture/13_reliability_power_management/454_spof/)), ëìëë ëë ì(ìíëìí ë íí)ê ììëì ë ëëììë ìì ìë(100% ëìí íê)ëë ìêì ììì ìíê ëì ëì êìëë.
...
### ëë [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) ëëêì íëìëìí ìí ëê

[RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0ì ëììíë ìëì ììì ëìë íêíë ëêë, **'êì êëí ìë(Usable Capacity)' íì 100%ì ìë íì 100%** ëë íì ììì ëííë ìíë êëììë.

| ëê íì | [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 (ìíëìí) | [RAID 1](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/485_raid_1_mirroring/) (ëëë) | [RAID 5](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/487_raid_5_distributed_parity/) (íëí) |
|:---|:---|:---|:---|
...
### Non-[RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) ëë ìì (JBOD/Spanning) êììì íìí ìì
...
- **ð ìì ìì ëì**: JBODê í êë ìë êë ëë ë ëìì íë ë ì ëêì ììê ëì êë ìë ìììì ìììëë, [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0ë ëë êë ìíë ììëê ìììë ìì êì ì ìêëì ëìì ëê êì ëë ììëê ëë ìì ëì ëë íìëìëë.
...
### ëì ìíëìí (ììì ìê ìë)
- **ììì**: [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ëë ëì OS(ìììì)ì ëí ëëìë ììíì ììí Swap ííìì ëììììë íìëì ììëê?
- **ìë ë IO ëì**: ëëìë ëì ì, ëëì êìíë Nêì ëìí ìëê ìí(RPM íì íëì íì)ì ëìí êììë ëììëê? (ìì êì ëì íí íìí ìíëìíê ìíëëë ëë ëì íì).

- **ð ìì ìì ëì**: ì êëí ììì([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0)ë ëì ìëìì êììì ììëí, ììë, ëí, ëì ìëìë ëìë ëìë ëê(ììë/ìëíë)ë 0ìë ëëê ìëìë êëììë ëëì ì êíì F1 ëì êì íë(ì ëëíëë ìì!)ê ëëëë ëêìëë.

---

### ìë/ìì êëíê

| êë | ëì ì (ëì ëìí íì ëë [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) ìì) | [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ìíëìí ëë êí ìííì ìë ì | ìììë íëì êì íê |
|:---|:---|:---|:---|
| **ìë (I/Oë)** | 1 Gbps [SATA](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/341_sata/) ìì ìë íê | 8Gps ìì (ëìí 8ê ìì ì ëëì ìì êì) | ìíëì ëíëì ëì(Lane) íì **íêêì ìí ëí(Linear Growth)** |
| **ìë (ìëì)** | [RAID 1](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/485_raid_1_mirroring/) ìí ëìë 50%ì ìì ëì/ëë | ìë íì(Usable Capacity) **íí ìì 100% íë** | êë ìì [TCO](/knowledge-base/studynote/12_it_management/01_governance_strategy/016_tco/) (êí ëì ìì ì) êì ììí ëì ìë |
...
- **ð ìì ìì ëì**: ì êì([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0)ì ìëë ëê ìí ëì ëìë ëìììì ìêì ìì ëìëìê 8ëë ëëì ìëêì ë íì êì êëê ëì ìëë ëëê ëììíë, êì ëìíê íìë ê ìë ìì ìíë ììíëëë êìì(Berserker) ëê ììê êìëë.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [NVMe](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/) ([Non-Volatile Memory Express](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
| [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) (Redundant [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) of Independent Disks) | 현재 개념이 등장하게 만든 직접적인 선행 흐름이다. |
| [RAID 1](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/485_raid_1_mirroring/) ([미러링](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/333_raid_1/), Mirroring) | 현재 개념이 구현·세분화될 때 바로 연결되는 후속 개념이다. |
| [RAID 4](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/486_raid_4_dedicated_parity/) (블록 단위 [스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/) + 단일 패리티 디스크) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ([스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/), Striping) ([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 Striping)은 컴퓨터가 디스크와 장치가 데이터를 주고받는 길을 정리하는 방법이에요.
2. 먼저 [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) (Redundant [Array](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/055_array/) of Independent Disks)을 이해하면 [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ([스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/), Striping) ([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 Striping)이 왜 필요한지 더 쉽게 보여요.
3. 그래서 [RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 ([스트라이핑](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/332_raid_0/), Striping) ([RAID](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/483_raid_overview/) 0 Striping)을 잘 알면 나중에 [RAID 1](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/485_raid_1_mirroring/) ([미러링](/knowledge-base/studynote/01_computer_architecture/08_io_storage_systems/333_raid_1/), Mirroring)도 훨씬 쉽게 배울 수 있어요.
