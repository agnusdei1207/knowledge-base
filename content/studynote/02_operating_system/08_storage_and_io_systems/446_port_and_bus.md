...
### 비교 1: 4대 저장장치 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 규격 대격돌
...
포트 (Port)와 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) ([Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/))는 컴퓨터의 심장(CPU)과 외부 세계(기계장치)를 이어주는 찬란한 혈관이자 고속도로다. 이 도로망이 좁고 구불구불하던([ISA](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/157_isa/), [PCI](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/355_pci/)) 시절, 운영체제는 교통체증([Interrupt](/knowledge-base/studynote/02_operating_system/01_overview_architecture/016_interrupt_mechanism/) Storm, I/O Wait)을 막기 위해 [버퍼 캐시](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/) 같은 온갖 소프트웨어 꼼수를 동원해 병목을 숨겨야 했다. 그러나 하드웨어 엔지니어들이 PCIe와 NVMe라는 빛의 속도에 근접한 [직렬](/knowledge-base/studynote/03_network/03_physical_layer_media/149_serial_communication_rs232_rs485/) 고속도로를 뚫어주자, 운영체제는 거추장스러운 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)등(Single [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/) [Lock](/knowledge-base/studynote/05_database/04_transactions_concurrency/510_lock/))을 다 뽑아버리고 멀티 큐(Multi-[Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/))라는 아우토반을 깔며 완벽하게 화답했다. 다가올 [CXL](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/441_cxl/)([Compute Express Link](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/441_cxl/)) 3.0 시대에는 이 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/)의 개념이 섀시(본체)를 뚫고 밖으로 나가, [데이터센터](/knowledge-base/studynote/03_network/16_data_center_cloud/801_data_center_3_tier_architecture_core_aggregation_access/) 내의 모든 서버 램과 GPU가 하나의 [PCIe](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/) 핏줄로 완벽히 융합되는, 물리적 경계가 붕괴된 진정한 '[분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/)(Disaggregated [Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/)) 생태계'를 맞이하게 될 것이다.

- **📢 섹션 요약 비유**: 옛날엔 마을(CPU)에서 강 건너 밭(디스크)으로 가려면 나룻배(구형 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/))를 타야 해서, 마을 이장(OS)이 배가 뜰 때까지 짐([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))을 창고(캐시)에 쟁여두는 관리에 목숨을 걸었습니다. 하지만 지금은 다이렉트 해저 터널([NVMe](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/482_nvme/)/[PCIe](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/356_pcie/))이 뚫려서 창고에 짐을 쌓아둘 필요 없이 트럭들이 쌩쌩 달리기만 하면 되는 물류의 신세계가 열린 것입니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [네트워크 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/444_network_device/) ([소켓 인터페이스](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/444_network_device/)) | 현재 개념으로 들어오기 전에 함께 이해하면 경계가 선명해지는 기반 개념이다. |
...
| [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) ([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/) / Programmed I/O) | 확장 학습이나 심화 비교로 이어지는 다음 단계의 키워드다. |
...
1. 포트 (Port) / [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) ([Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/))은 컴퓨터가 디스크와 장치가 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 주고받는 길을 정리하는 방법이에요.
2. 먼저 I/O 하드웨어 인터페이스 요소을 이해하면 포트 (Port) / [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) ([Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/))이 왜 필요한지 더 쉽게 보여요.
3. 그래서 포트 (Port) / [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) ([Bus](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/))을 잘 알면 나중에 메모리 맵 I/O (Memory-mapped I/O) vs 분리된 I/O (Isolated I/O / Port I/O)도 훨씬 쉽게 배울 수 있어요.
