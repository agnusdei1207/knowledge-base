...
> 1. **본질**: [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)는 세상에 존재하는 수만 가지의 각기 다른 하드웨어 I/O 기기들을 통제하기 위해, 이들을 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 전송 단위와 탐색(Seek) 가능 여부에 따라 크게 **'[블록 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/442_block_device/)([Block Device](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/442_block_device/))'와 '[문자 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/)([Character Device](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/))'라는 두 개의 거대한 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/) 클래스로 쪼개어 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)**한다.
> 2. **가치**: 이 이분법적 [분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/) 덕분에 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 개발자는 마우스 제조사나 하드디스크 제조사가 누군지 알 필요 없이, **[블록 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/442_block_device/)에는 [버퍼 캐시](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/)([Buffer Cache](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/))를 달아주고, [문자 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/)에는 스트림 큐([Stream](/knowledge-base/studynote/03_network/09_application_layer_web_email/467_http2_stream_multiplexing_tcp_hol/) [Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/))를 달아주는 표준화된 [VFS](/knowledge-base/studynote/02_operating_system/09_file_system/517_virtual_file_system_vfs/)(가상 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템) 인터페이스를 구축**할 수 있게 되었다.
...
- **등장 배경 및 유닉스 철학의 완성**:
  1. **초창기 디바이스 [종속성](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/008_dependencies/)**: [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 컴퓨터는 새로운 프린터를 사면 OS 소스코드 전체를 뜯어고쳐야 했다.
  2. **[Device Driver](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/495_device_driver/) 계층 분리**: OS [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 본체와 하드웨어 사이에 '디바이스 드라이버'라는 번역기를 끼워 넣음.
  3. **[VFS](/knowledge-base/studynote/02_operating_system/09_file_system/517_virtual_file_system_vfs/) ([Virtual File System](/knowledge-base/studynote/02_operating_system/09_file_system/517_virtual_file_system_vfs/)) 표준화**: "드라이버야, 네가 키보드든 SSD든 상관 안 할 테니 나한테 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 줄 땐 딱 2가지 폼(블록/문자)으로만 포장해서 올려라!"라며 OS가 인터페이스를 천하통일함.
...
여기서 맨 앞의 **`b`**가 [Block Device](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/442_block_device/)(하드디스크 `sda`), **`c`**가 [Character Device](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/)(터미널 화면 `tty`)를 뜻한다.
...
OS는 편애를 심하게 한다. [블록 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/442_block_device/)에게만 램(RAM)의 거대한 특수 공간인 **'[버퍼 캐시](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/)([페이지](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) 캐시)'**를 허락한다.
...
| **캐시(Cache) 유무**| OS의 **[버퍼 캐시](/knowledge-base/studynote/02_operating_system/09_file_system/536_buffer_cache_page_cache/)([Page](/knowledge-base/studynote/01_computer_architecture/07_virtual_memory_os_integration/286_page_frame/) Cache)**를 적극 활용 (비동기) | 캐시 없이 **다이렉트([Direct](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/176_direct_addressing/)) 전송** (동기/즉각적) |
| **[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템** | EXT4, FAT32 등 **[파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템을 포맷해서 얹을 수 있음** | [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 시스템 못 얹음 (그냥 [raw](/knowledge-base/studynote/01_computer_architecture/05_control_unit_pipelining/225_raw/) 스트림) |
...
- 그래서 [네트워크 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/444_network_device/)는 `/dev` 밑에 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)로 존재하지 않고, **[소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)([Socket](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/))**이라는 완전히 독립된 제3의 통신 인터페이스([API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/)) 계층을 부여받아 `ifconfig`나 `ip addr`로 관리되는 독자 노선을 걷게 되었다. (후속 키워드에서 상세 설명)
...
리눅스의 "모든 것은 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)이다"라는 철학은 쇠덩어리 하드웨어뿐만 아니라, **"형체가 없는 소프트웨어 로직"조차 [문자 장치](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/)([Character Device](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/443_character_device/))로 둔갑시키는 흑마술**을 부렸다.
1. **`/dev/null` (블랙홀 장치)**:
...
2. **`/dev/random` (난수 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 장치)**:
...
| 구분 | 내용 |
|:---|:---|
| **하드웨어 [추상화](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/)(Hardware [Abstraction](/knowledge-base/studynote/04_software_engineering/04_testing_quality/198_abstraction_control_data_process/))**| 수만 개의 칩셋 코드를 VFS라는 단일 인터페이스 밑으로 숨겨, 앱 개발자가 장비 매뉴얼을 안 보고도 포인터와 `read/write` 만으로 코딩할 수 있게 함 |
...
| **[운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) 이식성(Portability) 폭발**| 제조사가 제공하는 디바이스 드라이버만 교체하면 윈도우, 리눅스, 맥 어디서든 똑같은 하드웨어가 작동하는 플러그 앤 플레이(PnP) 생태계 구축 |
