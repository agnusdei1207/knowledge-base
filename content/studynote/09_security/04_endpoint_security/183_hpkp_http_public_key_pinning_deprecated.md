...
| [HSTS](/knowledge-base/studynote/09_security/05_web_app_security/268_hsts/) | "이 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)은 항상 HTTPS로만 접근해야 하는가?" | [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 다운그레이드 방지 | 인증서 오발급 자체는 못 막음 |
