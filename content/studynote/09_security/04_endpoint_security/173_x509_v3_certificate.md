...
기술사 관점에서는 "X.509 v3 = 공개키를 담은 파일"이라고 적으면 얕다. 더 정확한 답은 <strong>"표준화된 신원·용도·정책 메타데이터를 공개키와 함께 묶고 CA 서명으로 보호하는 구조"</strong>라고 서술해야 한다. 그래야 Subject/Issuer, SAN, Key Usage, NSC의 차이와 실무 판단까지 연결된다.
