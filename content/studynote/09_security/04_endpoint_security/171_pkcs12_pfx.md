...
기술사 답안에서는 "PKCS#12는 편의와 보안을 절충한 이동 포맷"이라고 정리하는 것이 좋다. 즉 키를 파일에 넣는 순간 위험이 0이 되는 것은 아니며, 표준은 그 위험을 <strong>관리 가능한 수준으로 낮추는 운반 규격</strong>일 뿐이다. 따라서 적용 판단은 항상 "이 파일이 필요한가"와 "필요하다면 얼마나 짧게, 얼마나 적게 존재하게 할 것인가"까지 포함해야 한다.
