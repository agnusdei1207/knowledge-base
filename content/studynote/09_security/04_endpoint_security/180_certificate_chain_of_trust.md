...
기술사 답안에서는 <strong>"인증서 체인 검증은 End Entity부터 Root Certificate Authority까지의 신뢰 경로를 검증하는 과정이며, 실제 설계 포인트는 루트 보호·중간 발급 위임·체인 완전성·클라이언트 호환성 확보"</strong>라고 정리하면 핵심이 살아난다.
