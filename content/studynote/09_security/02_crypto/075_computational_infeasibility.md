...
> 2. **가치**: [AES](/knowledge-base/studynote/03_network/13_network_security_basics/656_aes_advanced_encryption_standard_rijndael/) ([Advanced Encryption Standard](/knowledge-base/studynote/03_network/13_network_security_basics/656_aes_advanced_encryption_standard_rijndael/)), [RSA](/knowledge-base/studynote/09_security/03_network_security/110_rsa/) (Rivest–Shamir–Adleman), [ECC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/554_ecc_circuit/) ([Elliptic Curve Cryptography](/knowledge-base/studynote/09_security/03_network_security/119_ecc_elliptic_curve_cryptography/))는 각각 다른 난제와 보안 마진을 이용해 공격 비용을 폭발시킨다.
> 3. **판단 포인트**: [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)이 지금 안 깨졌다는 사실보다 키 길이·공격 모델·양자 위협까지 고려해 "얼마나 오래 안전한가"를 판단해야 한다.
...
암호학은 보통 one-way function과 큰 [key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/) space를 활용한다. 입력은 쉽게 만들 수 있지만, 역으로 복원하는 데는 엄청난 계산이 필요해야 한다.

| 문제 | 왜 어려운가 | 보안 의미 |
| :--- | :--- | :--- |
| Brute-force [key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/) search | 경우의 수가 기하급수적으로 증가 | 키 길이가 중요 |
| Integer factorization | 효율적 일반 해법이 없음 | [RSA](/knowledge-base/studynote/09_security/03_network_security/110_rsa/) 기반 |
| Discrete logarithm | 역함수 계산이 어려움 | [ECC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/554_ecc_circuit/) 기반 |
| Hash preimage | 원하는 입력 찾기가 매우 어려움 | [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) 기반 |
...
또 classical과 quantum의 차이도 중요하다. 양자 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 일부 난제를 더 빠르게 풀 수 있으므로, 보안은 현재가 아니라 미래의 계산 모델까지 본다.
...
실무에서는 키 길이, [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 수명, 공격 모델을 같이 본다. 단순히 "안 깨졌다"가 아니라, 5년·10년 뒤에도 버틸 수 있는지 따져야 한다.
...
따라서 좋은 설계는 현재의 난제뿐 아니라 미래의 계산 환경까지 생각한다. 이 관점을 잡아야 키 길이, [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/) 선택, 폐기 주기가 일관된다.
