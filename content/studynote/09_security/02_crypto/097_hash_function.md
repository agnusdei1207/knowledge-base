...
> 1. **본질**: [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/) ([Hash Function](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/))는 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 크기에 상관없이 임의의 길이의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 입력받아, 고정된 길이(예: 256비트)의 무작위 문자열인 '디지털 지문(Digest)'을 뱉어내는 [단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/) 수학 함수다.
> 2. **가치**: 입력값이 단 1비트만 달라져도 완전히 다른 해시값이 튀어나오는 눈사태 효과 (Avalanche Effect)를 통해 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 전송 중에 변조되지 않았음([무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/))을 완벽하게 증명한다.
> 3. **판단 포인트**: [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/) 자체는 기밀성을 보장하는 암호화가 아니며, 패스워드 저장이나 [전자서명](/knowledge-base/studynote/03_network/13_network_security_basics/675_digital_signature_process_asymmetric_key/) 시 발생할 수 있는 해킹 공격(레인보우 테이블)을 막기 위해 [솔트](/knowledge-base/studynote/03_network/13_network_security_basics/671_password_hash_salt_pbkdf2_bcrypt_argon2/)([Salt](/knowledge-base/studynote/03_network/13_network_security_basics/671_password_hash_salt_pbkdf2_bcrypt_argon2/)) 및 [키 스트레칭](/knowledge-base/studynote/09_security/02_crypto/109_key_stretching/) 기법과 반드시 병행해야 한다.
...
일반적인 [체크섬](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/112_checksum/)([Checksum](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/112_checksum/))용 함수와 달리, '암호학적 (Cryptographic)' [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)로 인정받으려면 해커의 공격을 버티는 3가지 강력한 수학적 저항성 ([Resistance](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/003_resistance/))을 반드시 갖춰야 한다.
...
- **📢 섹션 요약 비유**: 사과를 갈면 무조건 사과 주스가 나오지만(결정성), 사과 주스를 아무리 뭉쳐도 원래의 사과 모양으로 되돌려 놓을 수는 없는([단방향](/knowledge-base/studynote/03_network/01_data_communication/008_단방향_반이중_전이중/)성) 절대 깨지지 않는 요술 믹서기다.

---

## Ⅲ. 비교 및 연결

[해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)는 [데이터베이스 암호화](/knowledge-base/studynote/05_database/06_dw_olap_trends/365_tde/), [전자 서명](/knowledge-base/studynote/03_network/19_frequent_topics_terms/988_digital_signature/), [블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/004_blockchain/) 등 전방위적으로 사용되며 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 끊임없이 진화해 왔다. 해커들이 컴퓨터 속도를 높여 '생일 공격 (Birthday Attack)' 등으로 충돌을 찾아내면 그 [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)는 사망 선고를 받는다.
...
- **📢 섹션 요약 비유**: 해시 [알고리즘](/knowledge-base/studynote/08_algorithm_stats/01_basics/001_algorithm_definition/)은 '금고 다이얼의 자릿수' 진화와 같다. 도둑의 손놀림이 빨라지자 다이얼 3개짜리([MD5](/knowledge-base/studynote/03_network/13_network_security_basics/668_md5_hash_collision_vulnerability/))는 버려졌고, 지금은 우주 나이만큼 돌려도 못 맞추는 다이얼 100개짜리(SHA-256)를 표준으로 쓴다.
...
암호화가 남의 눈을 가리는 '마스크'라면, [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)는 남의 위조를 거부하는 '봉인 (Seal)'이다.
[해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)는 복호화가 불가능하다는 태생적 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/)을 가장 강력한 무기([무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/) 증명)로 승화시킨 암호학의 천재적인 발명품이다. 아무리 방대한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)라도 짧은 거울에 그 본질을 완벽히 비추어 담아내며, 오늘날 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/), [전자 서명](/knowledge-base/studynote/03_network/19_frequent_topics_terms/988_digital_signature/), [블록체인](/knowledge-base/studynote/06_ict_convergence/01_blockchain/004_blockchain/) 등 전산망의 신뢰를 담보하는 가장 단단한 주춧돌로 군림하고 있다.

- **📢 섹션 요약 비유**: [해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)는 고대의 '밀랍 인장'이다. 편지 내용을 숨기지는 않지만, 인장이 온전하게 도착했다는 사실 하나만으로 중간에 편지가 뜯어지거나 내용이 조작되지 않았음을 100% 보증하는 신뢰의 징표다.
...
2. 그래서 편지를 '[해시 함수](/knowledge-base/studynote/03_network/13_network_security_basics/667_hash_function_integrity_one_way/)'라는 믹서기에 넣고 돌렸더니, `A9!#`라는 짧은 4글자 지문이 튀어나와서 편지 겉면에 적어 보냈어요.
...
← **이전**: [096. IND-CCA2 — 강인한 암호학적 안전성](/knowledge-base/studynote/09_security/02_crypto/096_ind_cca2/)
**다음**: [098. MD5 — 128비트 해시, 충돌 공격 실용화 (1996)](/knowledge-base/studynote/09_security/02_crypto/098_md5/) →
