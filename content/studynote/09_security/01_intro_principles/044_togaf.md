...
> 3. TOGAF의 아키텍처 저장소([Architecture](/studynote/12_it_management/05_security_compliance/319_architecture/) Repository)와 아키텍처 역량 프레임워크(ACF)는 조직이 [EA](/studynote/12_it_management/03_ea_isp/110_enterprise_architecture_ea/) 역량을 성숙시키는 로드맵을 제공하며 — IT 거버넌스, 비용 최적화, 비즈니스-IT 정렬의 실질적 도구로 금융·공공·제조 등 대규모 조직에서 광범위하게 활용된다.

---

## Ⅰ. [TOGAF](/studynote/12_it_management/03_ea_isp/113_togaf/) 개요
...
> 📢 **섹션 요약 비유**: TOGAF는 도시 마스터플랜 — 건물(비즈니스)·도로([데이터](/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))·시설(애플리케이션)·인프라(기술)의 4개 레이어를 통합적으로 설계하는 도시 계획 표준.

---

## Ⅱ. [ADM](/studynote/03_network/01_data_communication/066_적응형_델타_변조_ADM/) 사이클
...
> 📢 **섹션 요약 비유**: [ADM](/studynote/03_network/01_data_communication/066_적응형_델타_변조_ADM/) 9단계는 건물 설계 프로세스 — 비전(설계 콘셉트) -> 비즈니스(용도) -> [데이터](/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)/앱(내부 구조) -> 기술(자재) -> 공사 계획 -> 시공 감리 -> 준공 후 유지.

---

## Ⅲ. [TOGAF](/studynote/12_it_management/03_ea_isp/113_togaf/) 핵심 개념
...
> 📢 **섹션 요약 비유**: [TOGAF](/studynote/12_it_management/03_ea_isp/113_togaf/) 보안 통합은 건물 보안 설계 — 설계 초기부터 잠금장치(보안)를 설계에 포함. 완공 후 자물쇠 붙이기보다 훨씬 효과적이고 저렴해요.

---

## Ⅴ. 실무 시나리오 — 공공기관 차세대 [EA](/studynote/12_it_management/03_ea_isp/110_enterprise_architecture_ea/)
...
1. TOGAF는 도시 마스터플랜 — 건물(비즈니스), 도로([데이터](/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)), 시설(앱), 인프라(기술) 4개 레이어를 통합 설계하는 표준 계획서예요!
2. [ADM](/studynote/03_network/01_data_communication/066_적응형_델타_변조_ADM/) 9단계는 건물 설계~시공 과정 — 비전->비즈니스->기술 순서로 설계하고, 마이그레이션 계획으로 단계적으로 옮겨가요.
3. [EA](/studynote/12_it_management/03_ea_isp/110_enterprise_architecture_ea/) 없이 IT 투자하면 낭비 — 한 팀이 만든 시스템이 다른 팀 시스템과 안 맞으면 다시 만들어야 해요. TOGAF는 이 낭비를 막는 설계도예요!
...
<- **이전**: [043. OSA — 오픈 보안 아키텍처 (Open Security Architecture)](/studynote/09_security/01_intro_principles/043_osa/)
**다음**: [045. NIST 사이버보안 프레임워크 2.0 — NIST CSF 2.0](/studynote/09_security/01_intro_principles/045_nist_csf_2_0/) ->
