...
1. [정보보안 3요소 — CIA (기밀성·무결성·가용성)](/studynote/09_security/01_intro_principles/001_cia_triad/)
...
6. [부인방지 (Non-repudiation) — 전자서명, 타임스탬프, 로그, 감사 추적](/studynote/09_security/01_intro_principles/006_security_governance/)
7. [책임추적성 (Accountability) — 감사 로그, 감사 기록, 사용자 행동 추적](/studynote/09_security/01_intro_principles/007_security_policy/)
...
9. [정보보안 6요소 — CIA + 인증성 + 부인방지 + 책임추적성](/studynote/09_security/01_intro_principles/009_incident_response/)
...
16. [실패 안전 원칙 (Fail-Safe) — 기본값 거부, 오류 시 안전 상태](/studynote/09_security/01_intro_principles/016_data_privacy/)
...
22. [정보보안 정책 — 최고 경영진 승인, 문서화된 규칙](/studynote/09_security/01_intro_principles/022_information_security_policy/)
23. [정보보안 표준 — 정책실시 위한 구체적 기준](/studynote/09_security/01_intro_principles/023_information_security_standard_guideline/)
...
34. [위험 회피 (Risk Avoidance) — 위험 원천 제거](/studynote/09_security/01_intro_principles/034_risk_avoidance/)
...
39. [검출 위험 (Detected Risk) vs 미검출 위험 (Undetected Risk)](/studynote/09_security/01_intro_principles/039_detected_vs_undetected_risk/)
...
45. [NIST CSF 2.0 — Identify/Protect/Detect/Respond/Recover + Govern](/studynote/09_security/01_intro_principles/045_nist_csf_2_0/)
...
57. [상실 통제 (Compensating Controls) — 기존 통제 우회 조치](/studynote/09_security/01_intro_principles/057_compensating_controls/)
...
70. [개살 암호 (Caesar Cipher) — 알파벳 3자리 이동](/studynote/09_security/02_crypto/070_caesar_cipher/)
...
74. [일다음성밀마본 (One-Time Pad) — 정보 이론적으로 완벽한 안전성](/studynote/09_security/02_crypto/074_one_time_pad/)
75. [현대 암호학 기본 가정 — computationally infeasible](/studynote/09_security/02_crypto/075_computational_infeasibility/)
...
78. [하이브리드 암호 — 대칭+비대칭 결합 (키 교환+데이터 암호화)](/studynote/09_security/02_crypto/078_hybrid_encryption/)
...
82. [Salsa20/ChaCha20 — ARX 기반 스트림 암호, TLS 1.3](/studynote/09_security/02_crypto/082_salsa20_chacha20/)
...
96. [IND-CCA2 — 강인한 암호학적 안전성](/studynote/09_security/02_crypto/096_ind_cca2/)
...
102. [BLAKE2/BLAKE3 — 채택성능 해시, AES 대체](/studynote/09_security/02_crypto/102_blake2_blake3/)
...
115. [Carmichael 수 — RSA 안전성 분석 관련](/studynote/09_security/03_network_security/115_carmichael_number/)
...
145. [NIST PQC 표준화 — 2016년 시작, 2024년 4개 알고리즘 선정](/studynote/09_security/03_network_security/145_nist_pqc_standardization/)
146. [CRYSTALS-Kyber — 격자 기반 KEM, NIST PQC 표준](/studynote/09_security/03_network_security/146_crystals_kyber_ml_kem/)
...
153. [.crypto agility — 알고리즘 교체 능력, PQC 이전 준비](/studynote/09_security/03_network_security/153_crypto_agility/)
154. [키 관리 생명주기 — 생성/분배/저장/사용/순환/폐기](/studynote/09_security/03_network_security/154_key_management_lifecycle/)
...
169. [PKCS#10 — 인증서 서명 요청 (CSR) 형식](/studynote/09_security/04_endpoint_security/169_pkcs10_csr/)
170. [PKCS#7 / CMS — 인증서 envelope 형식](/studynote/09_security/04_endpoint_security/170_pkcs7_cms/)
171. [PKCS#12 — 인증서+개인키 보관 형식 (.pfx)](/studynote/09_security/04_endpoint_security/171_pkcs12_pfx/)
172. [DER / PEM 인코딩 — 인증서 인코딩 형식](/studynote/09_security/04_endpoint_security/172_der_pem_encoding/)
173. [X.509 v3 인증서 — Subject/Issuer/SAN/Key Usage/NSC](/studynote/09_security/04_endpoint_security/173_x509_v3_certificate/)
...
179. [Self-signed 인증서 — 자체 발급 인증서, 내부용](/studynote/09_security/04_endpoint_security/179_self_signed_certificate/)
...
181. [브릿지 CA (Bridge CA) — 교차 인증](/studynote/09_security/04_endpoint_security/181_bridge_ca_cross_certification/)
...
184. [Certificate Patrol / Security/Telemetry — Firefox 브라우저 핀닝](/studynote/09_security/04_endpoint_security/184_certificate_patrol_telemetry_firefox_pinning/)
185. [동적 핀닝 — CT 로그 기반pins](/studynote/09_security/04_endpoint_security/185_dynamic_pinning_ct_log_based/)
...
215. [애플리케이션 게이트웨이 (Proxy) — 7층 프로토콜 검사](/studynote/09_security/05_web_app_security/215_application_gateway_proxy_firewall/)
...
237. [HIDS/HIPS — 호스트 기반 IDS/IPS](/studynote/09_security/05_web_app_security/237_hids_hips_host_based_intrusion_detection/)
...
243. [OWASP Core Rule Set — WAF 규칙 세트](/studynote/09_security/05_web_app_security/243_owasp_core_rule_set_crs_waf_anomaly_scoring/)
...
248. [DDoS 공격 — 고의적 서비스 중단 공격](/studynote/09_security/03_network_security/248_ddos_attack/)
249. [DDoS 3유형 — 볼류메트릭/프로토콜/애플리케이션 계층](/studynote/09_security/03_network_security/249_ddos_three_types/)
250. [DDoS 방어 기법 — Rate Limiting, Anycast, Scrubbing Center](/studynote/09_security/03_network_security/250_scrubbing_center/)
...
306. [Perfect Forward Secrecy — 각 세션독립적밀월](/studynote/09_security/03_network_security/306_pfs_detail/)
...
361. [사용자모드 루트킷 — 애플리케이션 레벨](/studynote/09_security/04_endpoint_security/361_user_mode_rootkit/)
...
392. [SEV-ES — VM 레지스터 state 암호화](/studynote/09_security/04_endpoint_security/392_sev_es/)
...
414. [시스템 강화 — Hardening, 불필요 서비스 제거](/studynote/09_security/05_web_app_security/414_authentication_failures/)
415. [CIS Benchmarks — Center for Internet Security 강화 가이드](/studynote/09_security/05_web_app_security/415_integrity_failures/)
...
417. [A01. 취약한 접근 제어 — IDOR, 권한 없는 기능 접근](/studynote/09_security/05_web_app_security/417_broken_access_control/)
...
421. [Local File Inclusion (LFI) —본지 파일 포함](/studynote/09_security/05_web_app_security/421_local_file_inclusion_lfi/)
422. [Remote File Inclusion (RFI) — 원격 파일 포함](/studynote/09_security/05_web_app_security/422_remote_file_inclusion_rfi/)
...
424. [A02. 암호화 실패 — 안전하지 않은 암호화 사용](/studynote/09_security/05_web_app_security/424_cryptographic_failures/)
425. [하드코딩 자격증명](/studynote/09_security/05_web_app_security/425_hardcoded_credentials/) — 소스코드 내 평문 비밀번호
426. [약한 TLS 버전 — TLS 1.0/1.1 사용](/studynote/09_security/05_web_app_security/426_weak_tls_version/)
427. [Certificate Pinning](/studynote/09_security/05_web_app_security/427_certificate_pinning_bypass/) 우회 — Frida, Objection
428. [A03. 인젝션 — 입력값 검증 부재로 인한 코드 실행](/studynote/09_security/05_web_app_security/428_injection_overview/)
429. [SQL 인젝션 — 데이터베이스 쿼리Manipulation](/studynote/09_security/05_web_app_security/429_sql_injection_deep/)
...
432. [Time-based Blind SQL Injection — SLEEP() 함수로 반응 지연](/studynote/09_security/05_web_app_security/432_time_based_blind_sqli/)
...
440. [A04. 안전하지 않은 설계 — threat modeling 부재](/studynote/09_security/05_web_app_security/440_insecure_design/)
...
444. [A05. 보안 설정 오류 — 잘못된 구성으로 인한 노출](/studynote/09_security/05_web_app_security/444_security_misconfiguration_deep/)
445. [기본 계정 —엄상 제공 기본 비밀번호](/studynote/09_security/05_web_app_security/445_default_accounts/)
446. [불필요 서비스 — 사용 안 하는 서비스 running](/studynote/09_security/05_web_app_security/446_unnecessary_services/)
447. [오류 메시지 정보 유출 — 내부 경로/스택 트레이스](/studynote/09_security/05_web_app_security/447_error_message_info_leak/)
...
451. [A06. 취약한 컴포넌트 — 알려진 취약점 포함 라이브러리](/studynote/09_security/05_web_app_security/451_vulnerable_components/)
...
454. [A07. 인증 실패 — 부적절한 인증 메커니즘](/studynote/09_security/05_web_app_security/454_authentication_failures/)
...
461. [A08. 무결성 실패 — 소프트웨어 무결성 검증 부재](/studynote/09_security/05_web_app_security/461_integrity_failures/)
...
468. [A10. SSRF — 서버 사이드 요청 위조](/studynote/09_security/05_web_app_security/468_ssrf/)
...
471. [반사형 XSS — URL 파라미터 반영](/studynote/09_security/05_web_app_security/471_reflected_xss/)
472. [저장형 XSS — DB에 저장, 모든 사용자에게 발동](/studynote/09_security/05_web_app_security/472_stored_xss/)
...
477. [SameSite 쿠키 — CSRF 방어](/studynote/09_security/05_web_app_security/477_samesite_cookie/)
478. [CSRF Token](/studynote/09_security/05_web_app_security/478_csrf_token/) — 난수 토큰 요구
479. [쌍중 Submit Cookie — 쿠키+파라미터 대조](/studynote/09_security/05_web_app_security/479_double_submit_cookie/)
480. [Clickjacking](/studynote/09_security/05_web_app_security/480_clickjacking/) — 투명 iframe 덮기
481. [X-Frame-Options — frame embedding 차단](/studynote/09_security/05_web_app_security/481_x_frame_options/)
...
507. [OAuth 2.0 4가지 Grant — Authorization Code/PKCE/Client Credentials/ROP](/studynote/09_security/05_web_app_security/507_oauth_2_0_grants/)
...
513. [Access Token vs Refresh Token — 수명 차이](/studynote/09_security/05_web_app_security/513_access_token_vs_refresh_token/)
...
532. [SAML 2.0 — XML 기반 SSO 프로토콜](/studynote/09_security/11_iam_access_control/532_saml_2_0/)
533. [SAML Assertion](/studynote/09_security/11_iam_access_control/533_saml_assertion/) — 신원 정보 포함 XML
534. [SAML Request/Response — SP-Initiated/IdP-Initiated](/studynote/09_security/11_iam_access_control/534_saml_request_response/)
...
542. [OAuth 2.0 vs OIDC — 델리게이션 vs 인증](/studynote/09_security/11_iam_access_control/542_oauth2_vs_oidc/)
...
605. [Golden/Silver Ticket mitigation — KRBTGT 비밀번호 주월적 교체](/studynote/09_security/12_identity_threat_advanced/605_golden_silver_ticket_mitigation/)
606. [Protected Users 그룹 — Kerberos 전용 인증](/studynote/09_security/05_web_app_security/606_csrf/)
...
610. [Azure AD조건부 액세스 — 정책 기반 접근 제어](/studynote/09_security/05_web_app_security/610_memory_management/)
...
617. [SCIM 2.0 — 자동 사용자 프로비저닝 프로토콜](/studynote/09_security/12_identity_threat_advanced/617_scim_2_0/)
...
627. [Normalizzazione — 다양 로그 형식 정규화](/studynote/09_security/13_secops_ir_forensics/627_normalization/)
...
646. [UNC/APT 그룹 — APT 집합 명칭 (MITRE)](/studynote/09_security/13_secops_ir_forensics/646_unc_apt_groups/)
...
698. [브라우저 canary — 세션 탈취 탐지](/studynote/09_security/14_threat_hunting_adversarial/698_browser_canary/)
...
701. [FTK / EnCase — 포렌식 도구](/studynote/09_security/05_web_app_security/701_password_authentication/)
...
703. [UAC요과 — 사용자 계정 컨트롤 우회](/studynote/09_security/05_web_app_security/703_totp_otp/)
704. [LSASS 추출 — Mimikatz, procdump](/studynote/09_security/05_web_app_security/704_mfa_authentication/)
...
709. [NTDS.dit 추출 — DC 데이터베이스 직접 추출](/studynote/09_security/14_threat_hunting_adversarial/709_ntds_dit/)
...
723. [웹orm — 네트워크 통해 само복제, 독립 실행](/studynote/09_security/15_malware_attack_vectors/723_worm/)
...
735. [이중extortion — 암호화+데이터 유출](/studynote/09_security/15_malware_attack_vectors/735_double_extortion/)
...
738. [wipers — 데이터 파괴 목적](/studynote/09_security/15_malware_attack_vectors/738_wiper/)
...
741. [애드웨어 (Adware) — 강제 광고 표시](/studynote/09_security/15_malware_attack_vectors/741_adware/)
...
751. [First Initial Access — 최초 침투 수단](/studynote/09_security/15_malware_attack_vectors/751_initial_access/)
...
787. [정보보호 관리체계 (ISMS-P) — 한국 통합 인증](/studynote/09_security/16_data_privacy/787_isms_p/)
...
789. [리용약관 — 서비스 제공을 위한 기본 계약](/studynote/09_security/16_data_privacy/789_terms_of_use/)
...
794. [Right to be Forgotten — 삭제권 (GDPR 17조)](/studynote/09_security/16_data_privacy/794_right_to_be_forgotten/)
...
807. [과태료/벌칙 — 한국 개인정보보호법 제64조](/studynote/09_security/16_data_privacy/807_penalties_fines/)
...
821. [TTT (Tokenization-as-a-Service) — 클라우드 토큰화](/studynote/09_security/16_data_privacy/821_taas/)
...
826. [네트워크 DLP — 네트워크 경계 데이터 통제](/studynote/09_security/16_data_privacy/826_network_dlp/)
827. [엔드포인트 DLP — 단말기 내 데이터 통제](/studynote/09_security/16_data_privacy/827_endpoint_dlp/)
828. [클라우드 DLP — SaaS/ PaaS/IaaS 데이터 보호](/studynote/09_security/16_data_privacy/828_cloud_dlp/)
...
832. [DB 감사 — 접속 기록, 질의 로그](/studynote/09_security/16_data_privacy/832_database_auditing/)
...
836. [ISO/IEC 27001 — 정보보안 management 시스템 (ISMS)](/studynote/09_security/17_framework_compliance/836_iso_27001_isms/)
...
846. [NIST CSF 2.0 —Identify/Protect/Detect/Respond/Recover + Govern](/studynote/09_security/17_framework_compliance/846_nist_csf_2_0/)
...
873. [ITGrc — IT 거버넌스/리스크/컴플라이언스](/studynote/09_security/17_framework_compliance/873_it_grc/)
...
885. [FIPS 140-2/3 — 암호 모듈 보안 표준](/studynote/09_security/17_framework_compliance/885_fips_140_3_cryptographic_module/)
...
898. [Modbus 프로토콜 — 산업용 직렬 통신, 암호화 없음](/studynote/09_security/18_iot_ot_physical/898_modbus_protocol/)
...
902. [Purdue 모델 — IT/OT 네트워크 5단계분층](/studynote/09_security/18_iot_ot_physical/902_purdue_model/)
903. [Purdue 레벨 0~5 — Field/Level 1~2 (OT)/Level 3 (DMZ)/Level 4~5 (IT)](/studynote/09_security/18_iot_ot_physical/903_purdue_levels/)
...
909. [Zone 맵핑 — 자산 분류-> security level](/studynote/09_security/18_iot_ot_physical/909_zone_mapping/)
...
912. [OWASP IoT Top 10 — 취약한 펌웨어/기본 계정/불안전한 접구](/studynote/09_security/18_iot_ot_physical/912_owasp_iot_top_10/)
...
918. [RoT 구성요소 — CRTM, Bootloader, Bootloader certificates](/studynote/09_security/18_iot_ot_physical/918_rot_components/)
...
924. [ISO/SAE 21434 — 자동차 사이버보안 엔지니어링](/studynote/09_security/18_iot_ot_physical/924_iso_sae_21434/)
...
932. [물리적 보안 3대 요소 —위섭/ Delay/ Detection](/studynote/09_security/05_web_app_security/932_sniffing_detection_arp_ping_promiscuous_mode/)
...
934. [접근 제어 시스템 — 카드/RFID/바이오메트릭](/studynote/09_security/05_web_app_security/934_routing_protocol_authentication_bgp_md5_tcp_hijacking/)
...
968. [대항성훈련 — 적대적 예제 포함한 재훈련](/studynote/09_security/19_ai_advanced_security/968_adversarial_training/)
...
975. [OWASP LLM Top 10 — LLM 보안 취약점](/studynote/09_security/19_ai_advanced_security/975_owasp_llm_top10/)
976. [LLM01: Prompt Injection — 프롬프트 조작](/studynote/09_security/05_web_app_security/976_dns_spoofing_cache_poisoning_dnssec_arp/)
977. [LLM02: Insecure Output — 출력 검증 없이 신뢰](/studynote/09_security/19_ai_advanced_security/977_llm02_insecure_output/)
978. [LLM03: Training Data Poisoning — 훈련 데이터 오염](/studynote/09_security/19_ai_advanced_security/978_llm03_training_data_poisoning/)
979. [LLM04: Model Denial of Service — 비용거대적 입력 유발](/studynote/09_security/05_web_app_security/979_ipsec_tunnel_transport_mode_vpn_encapsulation/)
980. [LLM05: Supply Chain — 공급망 취약점](/studynote/09_security/05_web_app_security/980_ah_authentication_header_ipsec_integrity_no_encryption/)
981. [LLM06: Sensitive Information Disclosure — 훈련 데이터 유출](/studynote/09_security/05_web_app_security/981_esp_encapsulating_security_payload_ipsec_confidentiality/)
982. [LLM07: Plugin Abuse — 플러그인 악용](/studynote/09_security/05_web_app_security/982_ssl_tls_handshake_session_key_exchange_https/)
983. [LLM08: Autonomous Agent — 자가 실행 에이전트 위험](/studynote/09_security/05_web_app_security/983_vpn_virtual_private_network_tunneling_encryption/)
...
985. [양자 위협 — RSA/ECC 깨뜨릴 Shor 알고리즘](/studynote/09_security/05_web_app_security/985_x509_certificate_pki_digital_signature_format/)
...
987. [NIST PQC 표준 — Kyber/Dilithium/Falcon/SPHINCS+](/studynote/09_security/05_web_app_security/987_hash_function_one_way_integrity_avalanche_sha256/)
...
989. [블록체인 보안 — 51% 공격, 이중지불, 스마트 컨트랙트](/studynote/09_security/05_web_app_security/989_dos_ddos_denial_of_service_drdos_amplification_reflection/)
990. [Reentrancy 공격 — 스마트 컨트랙트 재진입취약점](/studynote/09_security/05_web_app_security/990_botnet_cnc_zombie_pc_ddos_infrastructure/)
...
1000. [_entropy — 난수 생성 품질](/studynote/09_security/05_web_app_security/1000_cloud_native_network_cni_kubernetes_pod_overlay/)
...
1014. [Bring Your Own Key (BYOK) — 고객 관리 키](/studynote/09_security/02_crypto/1014_bring_your_own_key_byok/)
1015. [Hold Your Own Key (HYOK) — 외부 키 보관](/studynote/09_security/02_crypto/1015_hold_your_own_key_hyok/)
...
- [HSTS (HTTP Strict Transport Security)](/studynote/09_security/05_web_app_security/1031_hsts/)
- [A0X Injection Overview](/studynote/09_security/05_web_app_security/1032_a0x_injection_overview/)
- [OWASP Top 10 2021 Overview (OWASP Top 10 2021 Overview)](/studynote/09_security/05_web_app_security/1033_owasp_top10_2021_overview/)
- [CSRF (Cross-Site Request Forgery)](/studynote/09_security/17_framework_compliance/1037_csrf/)
- [Memory Management Security](/studynote/09_security/17_framework_compliance/1040_memory_management/)
- [Password Authentication](/studynote/09_security/17_framework_compliance/1046_password_authentication/)
- [One-Time Password & Time-Based OTP](/studynote/09_security/17_framework_compliance/1048_totp_otp/)
- [Multi-Factor Authentication, MFA](/studynote/09_security/17_framework_compliance/1049_mfa_authentication/)
- [Sniffing Detection Arp Ping Promiscuous Mode](/studynote/09_security/17_framework_compliance/1066_sniffing_detection_arp_ping_promiscuous_mode/)
- [Routing Protocol Authentication Bgp MD5 Tcp Hijacking](/studynote/09_security/17_framework_compliance/1068_routing_protocol_authentication_bgp_md5_tcp_hijacking/)
- [DNS Spoofing](/studynote/09_security/17_framework_compliance/1074_dns_spoofing_cache_poisoning_dnssec_arp/)
- [Ipsec Tunnel Transport Mode VPN Encapsulation](/studynote/09_security/17_framework_compliance/1075_ipsec_tunnel_transport_mode_vpn_encapsulation/)
- [AH (Authentication Header)](/studynote/09_security/17_framework_compliance/1076_ah_authentication_header_ipsec_integrity_no_encryption/)
- [ESP (Encapsulating Security Payload)](/studynote/09_security/17_framework_compliance/1077_esp_encapsulating_security_payload_ipsec_confidentiality/)
- [Ssl TLS Handshake Session Key Exchange Https](/studynote/09_security/17_framework_compliance/1078_ssl_tls_handshake_session_key_exchange_https/)
- [Vpn Virtual Private Network Tunneling Encryption](/studynote/09_security/17_framework_compliance/1079_vpn_virtual_private_network_tunneling_encryption/)
- [X509 Certificate PKI Digital Signature Format](/studynote/09_security/17_framework_compliance/1081_x509_certificate_pki_digital_signature_format/)
- [Hash Function](/studynote/09_security/17_framework_compliance/1083_hash_function_one_way_integrity_avalanche_sha256/)
- [DoS/DDoS](/studynote/09_security/17_framework_compliance/1085_dos_ddos_denial_of_service_drdos_amplification_reflection/)
- [Botnet Cnc Zombie Pc Ddos Infrastructure](/studynote/09_security/17_framework_compliance/1086_botnet_cnc_zombie_pc_ddos_infrastructure/)
- [Cloud Native Network Cni Kubernetes Pod Overlay](/studynote/09_security/17_framework_compliance/1096_cloud_native_network_cni_kubernetes_pod_overlay/)
- [Blind SSRF (Blind Server-Side Request Forgery)](/studynote/09_security/17_framework_compliance/857_blind_ssrf/)
- [XXE (XML External Entity Injection)](/studynote/09_security/17_framework_compliance/858_xxe/)
- [XXE Attack Flow](/studynote/09_security/17_framework_compliance/859_xxe_attack_flow/)
- [Insecure Deserialization](/studynote/09_security/17_framework_compliance/860_insecure_deserialization/)
- [Java Deserialization](/studynote/09_security/17_framework_compliance/861_java_deserialization/)
- [pickle Deserialization (Python Pickle Insecure Deserialization)](/studynote/09_security/17_framework_compliance/862_pickle_deserialization/)
- [PHP Object Injection (PHP Object Injection)](/studynote/09_security/17_framework_compliance/863_php_object_injection/)
- [Prototype Pollution (JavaScript Prototype Pollution)](/studynote/09_security/17_framework_compliance/864_prototype_pollution/)
- [ReDoS (Regular Expression Denial of Service)](/studynote/09_security/17_framework_compliance/865_redos/)
- [Open Redirect](/studynote/09_security/17_framework_compliance/866_open_redirect/)
- [Host Header Injection](/studynote/09_security/17_framework_compliance/867_host_header_injection/)
- [HTTP](/studynote/09_security/17_framework_compliance/868_http_response_splitting/)
- [Subdomain Takeover](/studynote/09_security/17_framework_compliance/869_subdomain_takeover/)
