...
- **📢 섹션 요약 비유**: 클럽 입장을 방어선에 비유해 봅시다. [방화벽](/knowledge-base/studynote/03_network/13_network_security_basics/690_firewall_generation_evolution/)(L4)은 "슬리퍼 신은 놈, 20살 미만(금지 IP, [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/))은 무조건 입구 컷"시키는 덩치 큰 기도입니다. 하지만 턱시도를 입고(정상 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 80번) 들어오는 손님 몸속에 숨겨진 독약은 [방화벽](/knowledge-base/studynote/03_network/13_network_security_basics/690_firewall_generation_evolution/) 기도가 찾지 못합니다. WAF(L7)는 정문을 통과해 들어온 손님을 밀실로 데려가서 엑스레이를 찍고 위장 내시경([HTTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/461_http_stateless_connection_oriented/) 페이로드 딥 검사)까지 해서 알약 하나 크기의 독약(SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/) 코드)마저 완벽하게 집어내는 초정밀 의료 검색대입니다.
