...
← **이전**: [[671_password_hash_salt_pbkdf2_bcrypt_argon2|671. 솔트 (Salt) 첨가 패스워드 해시 (PBKDF2, bcrypt, Argon2) 체계]]
**다음**: [[673_mac_message_authentication_code|673. MAC (Message Authentication Code) 변수 및 기능]] →
