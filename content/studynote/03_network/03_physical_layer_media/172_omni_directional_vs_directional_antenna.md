...
> 1. **본질**: 무지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) (Omni-Directional [Antenna](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/))는 넓은 방향으로 전파를 퍼뜨리고, 지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) (Directional [Antenna](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/))는 특정 방향에 전파를 집중해 방사 패턴 (Radiation Pattern)을 다르게 설계하는 방식이다.
> 2. **가치**: 같은 송신 전력이라도 빔 폭과 [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/) ([Antenna](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) Gain)이 달라지면 커버리지, 도달 거리, 간섭 수준이 크게 달라지므로 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 단순 부품이 아니라 무선 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 영역을 결정하는 핵심 설계 변수다.
> 3. **판단 포인트**: 사용자가 사방에 흩어지고 이동하면 무지향성이 유리하고, 단말 위치가 고정되거나 장거리 링크가 필요하면 지향성이 유리하므로 "어디에 얼마나 퍼뜨릴 것인가"를 먼저 정하고 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)를 고르는 것이 맞다.
...
- **📢 섹션 요약 비유**: 무지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 공원 가운데 놓인 분수처럼 사방으로 물을 뿌리고, 지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 소방 호스처럼 한쪽 방향으로 물줄기를 멀리 보내는 방식과 같다.

---

## Ⅱ. 아키텍처 및 핵심 원리

두 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)의 핵심 차이는 빔 폭 (Beamwidth), [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/), 정렬 요구 조건에 있다. 무지향성은 넓은 빔 폭을 통해 여러 방향을 한 번에 덮지만, 같은 에너지를 넓게 나누므로 이득이 낮은 편이다. 지향성은 에너지를 좁은 각도로 재배치해 높은 이득을 얻고, 대신 송수신 정렬 오차에 더 민감해진다.

| 항목 | 무지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) | 지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) |
| :--- | :--- | :--- |
| 기본 패턴 | 넓은 수평 커버리지 | 좁은 특정 방향 커버리지 |
| [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/) | 상대적으로 낮음 | 상대적으로 높음 |
| 도달 거리 | 짧거나 중간 거리 | 중장거리 링크에 유리 |
| 단말 이동성 | 높아도 대응 쉬움 | 정렬이 어긋나면 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 급락 |
| 간섭 특성 | 주변으로 spillover 많음 | 불필요한 방향 간섭 [억제](/knowledge-base/studynote/09_security/13_secops_ir_forensics/656_ir_containment/) 가능 |
| 대표 형태 | dipole, monopole | panel, yagi, [parabolic](/knowledge-base/studynote/03_network/03_physical_layer_media/176_antenna_yagi_parabolic_patch/) |
...
무지향성과 지향성은 서로의 대체재이면서도, 실제 무선망에서는 중간 형태와 함께 쓰인다. 예를 들어 셀룰러 기지국은 360도 전체를 하나의 무지향성으로 처리하기보다 60도나 120도 섹터 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)로 나누어 용량과 간섭을 조절한다. 즉 현실 설계는 "완전한 전방향"과 "매우 좁은 빔" 사이의 다양한 타협점 위에서 움직인다.

| 비교 축 | 무지향성 | 섹터 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) | 지향성 |
| :--- | :--- | :--- | :--- |
| 커버 범위 | 거의 전방향 | 제한된 부채꼴 | 특정 좁은 방향 |
| 대표 용도 | 가정용 Wi-Fi, 실내 [AP](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/572_ap_access_point_ds_distribution_system/) | 기지국 셀 분할 | [백홀](/knowledge-base/studynote/03_network/20_performance_evaluation_advanced/1009_backhaul_network_base_station_core_connection/), 포인트투포인트 |
| 설치 난이도 | 낮음 | 중간 | 높음 |
| 간섭 제어 | 약함 | 중간 | 강함 |
| 이동 단말 대응 | 좋음 | 보통 | 제한적 |

또한 이 주제는 [등방성 안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/173_isotropic_antenna_theory/), [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/), EIRP, [빔포밍](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/101_beamforming/) ([Beamforming](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/101_beamforming/))과 직접 연결된다. [등방성 안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/173_isotropic_antenna_theory/)는 계산 기준점이고, 무지향성은 그보다 현실적인 넓은 커버리지 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)이며, 지향성은 에너지를 모아 이득을 끌어올린 형태다. 이후의 [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/)과 EIRP 계산은 바로 이 방사 패턴 차이를 수치로 표현한 결과라고 볼 수 있다.

특히 무선랜과 셀룰러에서는 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) 선택이 간섭 재사용 구조까지 바꾼다. 무지향성은 설치는 쉽지만 같은 채널을 넓게 퍼뜨려 인접 셀 간섭을 키울 수 있고, 지향성은 필요한 곳만 비춰 주파수 재사용을 더 정교하게 할 수 있다. 그래서 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 물리 계층 부품이면서 동시에 용량 설계 도구이기도 하다.
...
1. [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 영역이 360도 전체인지, 특정 구역이나 경로인지 먼저 도면으로 확인한다.
2. 송신 전력뿐 아니라 EIRP 제한과 주변 간섭 환경을 함께 검토한다.
3. 단말이 이동하는 환경인지, 고정된 링크인지에 따라 정렬 허용 오차를 판단한다.
4. 실내 다층 건물이라면 단순 고이득 무지향성보다 [AP](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/572_ap_access_point_ds_distribution_system/) [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 배치가 더 나은지 비교한다.

### 자주 나오는 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/)

- "이득이 높을수록 무조건 좋다"며 고이득 지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)를 일반 실내 커버리지에 그대로 쓰는 경우
...
[안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) 유형을 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 구조에 맞게 고르면 같은 무선 장비로도 커버리지 품질, 도달 거리, 간섭 수준을 크게 개선할 수 있다. 무지향성은 설치와 운영이 단순하고 이동 단말 친화적이며, 지향성은 긴 거리와 높은 링크 품질, 채널 재사용 최적화에 강하다. 결국 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 송신기 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 보완하는 것이 아니라 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 영역을 직접 설계하는 도구다.
...
| [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/) ([Antenna](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) Gain) | 빔 집중 정도를 수치로 나타내는 값 |
| 빔 폭 (Beamwidth) | 커버리지 각도와 정렬 허용 범위를 결정 |
| EIRP (Effective Isotropic Radiated [Power](/knowledge-base/studynote/14_data_engineering/02_math_mining/069_type_1_2_error_statistical_power/)) | 송신 출력과 [안테나 이득](/knowledge-base/studynote/03_network/03_physical_layer_media/174_antenna_gain_dbi_dbd/)을 합쳐 본 실제 복사 기준 |
| 섹터 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/) | 무지향성과 지향성 사이의 실무적 절충안 |
| [빔포밍](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/101_beamforming/) ([Beamforming](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/101_beamforming/)) | 방향성을 동적으로 조정하는 발전형 기술 |
...
1. 무지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 여러 친구에게 한꺼번에 들리게 말하는 확성기 같아요.
2. 지향성 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)는 한 친구를 향해 소리를 모아 멀리까지 들리게 하는 메가폰 같아요.
...
← **이전**: [171. 안테나 (Antenna) 기본 원리 (공진/다이폴)](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)
**다음**: [173. 등방성 안테나 (Isotropic Antenna)](/knowledge-base/studynote/03_network/03_physical_layer_media/173_isotropic_antenna_theory/) →
