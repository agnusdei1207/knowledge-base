...
> 1. **본질**: 동축 케이블(Coaxial Cable)은 중심 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/)와 이를 둘러싼 튜브 형태의 외부 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/)가 같은 축(Co-axial)을 공유하여 전자기장을 내부 [절연체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/010_insulator/)에 가두는 고주파 전송 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)이다.
> 2. **가치**: [UTP](/knowledge-base/studynote/03_network/03_physical_layer_media/124_unshielded_twisted_pair/) 케이블보다 외부 노이즈 차단력과 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) 감쇠 저항이 월등히 뛰어나, 장거리 영상 전송([CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/))이나 [케이블 모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/147_cable_modem_docsis/) 기반의 광대역 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 전송에 필수적이다.
...
동축 케이블 (Coaxial Cable)은 하나의 축을 중심으로 내부 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/)(Core)와 외부 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/)(Shield)가 동심원 모양으로 겹쳐진 형태의 케이블이다. [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 전기 통신망에서 평행한 두 선(Twin-lead)은 주파수가 높아질수록 선 자체가 [안테나](/knowledge-base/studynote/03_network/03_physical_layer_media/171_antenna_basic_dipole_resonance/)처럼 작용하여 전파를 방사(Radiation)하거나 외부 전자기파를 흡수하는 치명적인 한계가 있었다. 이를 해결하기 위해 전기장이 케이블 외부로 빠져나가지 못하도록 한 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/) 안에 다른 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/)를 가두는 혁신적인 설계가 도입되었다.

[데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)와 고화질 영상 등 높은 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)([Bandwidth](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/))이 필요한 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)는 고주파로 전송되는데, [UTP](/knowledge-base/studynote/03_network/03_physical_layer_media/124_unshielded_twisted_pair/) 케이블은 장거리 고주파 전송 시 감쇠(Attenuation)가 심하게 발생한다. 따라서 외부 간섭(EMI/RFI)이 극심한 공장 지대나, 수백 미터 이상 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/) 손실 없이 [기저대역](/knowledge-base/studynote/03_network/19_frequent_topics_terms/940_baseband_line_coding_nrz_rz_manchester/)([Baseband](/knowledge-base/studynote/03_network/19_frequent_topics_terms/940_baseband_line_coding_nrz_rz_manchester/)) 혹은 대역통과(Broadband) [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)를 보내야 하는 실무 환경(아날로그/[SDI](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/499_sdi_hardware_dependency/) [CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/), 유선 방송망)에서는 동축 케이블이 필수 불가결한 대안이 된다.
...
동축 케이블의 성능은 4가지 주요 구성 계층의 물리적 특성과 정밀한 [임피던스](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/004_impedance/)([Impedance](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/004_impedance/)) 매칭에 의해 결정된다.
...
- **📢 섹션 요약 비유**: 수압이 강한 물(고주파 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/))을 보낼 때 호스가 팽창하거나 터지지 않도록, 고무 호스([절연체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/010_insulator/)) 겉을 단단한 쇠그물(외부 [도체](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/008_conductor/))로 꽉 감싸고, 빠지지 않는 특수 수도꼭지(BNC 커넥터)로 연결하는 구조와 같습니다.

---

## Ⅲ. 비교 및 연결

물리 계층 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)로서 동축 케이블을 [UTP](/knowledge-base/studynote/03_network/03_physical_layer_media/124_unshielded_twisted_pair/) 및 광케이블과 정량적, 구조적으로 비교한 매트릭스이다.
...
- **📢 섹션 요약 비유**: 철길(동축 케이블) 폭([임피던스](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/004_impedance/) 75옴)을 맞춰 기차([신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/))를 달려야 하는데, 중간에 50옴짜리 좁은 레일을 연결해버리면 기차가 부딪혀서 뒤로 튕겨 나가는 대형 사고(반사파)가 발생하는 원리와 같습니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [UTP](/knowledge-base/studynote/03_network/03_physical_layer_media/124_unshielded_twisted_pair/) 케이블 ([Unshielded Twisted Pair](/knowledge-base/studynote/03_network/03_physical_layer_media/124_unshielded_twisted_pair/)) | 동축 케이블을 대체하여 현대 기업용/가정용 구내 통신망을 장악한 쌍꼬임 선 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/) |
| HFC (Hybrid Fiber Coaxial) | 백본은 광케이블을, 가입자 말단은 동축 케이블을 사용하여 경제성과 광대역을 동시 달성한 유선 통신망 |
| DOCSIS | 케이블 TV용 동축 케이블 망 위에서 [이더넷](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 패킷을 초고속으로 전송하기 위한 국제 통신 표준 |
| [광섬유 케이블](/knowledge-base/studynote/03_network/03_physical_layer_media/128_optical_fiber_cable/) (Optical Fiber) | 동축 케이블의 고주파 대역 한계와 구리 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/)의 물리적 한계를 완전히 극복한 빛 기반 전송 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/) |
| 베이스밴드/브로드밴드 ([Baseband](/knowledge-base/studynote/03_network/19_frequent_topics_terms/940_baseband_line_coding_nrz_rz_manchester/)/Broadband) | 동축 케이블에서 디지털 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)를 변조 없이 통째로 쏘거나(베이스밴드), 여러 주파수로 나누어 [다중화](/knowledge-base/studynote/03_network/02_multiplexing_multiple_access/071_다중화_Multiplexing/)(브로드밴드)하는 전송 방식 |
...
1. 동축 케이블은 마치 단단한 쇠 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/) 안에 얇은 구리선을 숨겨둔 마법의 빨대 같아요.
2. [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)가 겉에서 들어오는 나쁜 전파 괴물들을 다 튕겨내기 때문에, 구리선 안으로 아주 깨끗하고 선명한 [CCTV](/knowledge-base/studynote/09_security/18_iot_ot_physical/933_cctv/) 화면이나 인터넷 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)를 멀리까지 안전하게 보낼 수 있어요.
3. 선 끝에는 톱니바퀴처럼 꽉 물려서 절대 빠지지 않는 전용 자물쇠(BNC 커넥터)가 있어서 거친 환경에서도 [신호](/knowledge-base/studynote/02_operating_system/02_process_thread/130_signal/)가 멈추지 않는답니다.
