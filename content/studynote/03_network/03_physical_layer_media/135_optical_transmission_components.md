...
- **기술사적 판단**: 장거리용 고출력(LD)과 고감도(APD) 모듈을 근거리에서 테스트하거나 임시 연결할 때는 반드시 물리적 <strong>광 감쇠기(Optical Attenuator)</strong>를 중간에 삽입하여 빛의 세기를 -10dBm 이하 안전 범위로 인위적으로 깎아주어야 장비 소손을 막을 수 있다.
