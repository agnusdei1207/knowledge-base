...
### 3. DOCSIS [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) 진화

| [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/) | 발표년도 | 다운스트림 이론 최대 | 업스트림 이론 최대 | 주요 기술 |
|:---:|:---:|:---:|:---:|:---|
| DOCSIS 1.0 | 1997 | 42 Mbps | [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/) Mbps | SC-QAM |
...
### 케이블 [모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/146_modem_modulator_demodulator/) vs. DSL vs. FTTH

| 구분 | 케이블 [모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/146_modem_modulator_demodulator/) (HFC) | DSL (전화선) | FTTH (광섬유) |
|:---|:---|:---|:---|
...
| 상황 | 권장 선택 | 이유 |
|:---|:---|:---|
| 소규모 가정 인터넷 | 케이블 [모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/146_modem_modulator_demodulator/) (DOCSIS 3.1) | 비용 대비 충분한 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) |
| 기가비트 인터넷 필요 (개인) | FTTH 또는 DOCSIS 3.1 | [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 보장 |
| 소규모 오피스 (보장 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 필요) | FTTH 전용 회선 | 공유 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 불확실성 제거 |
| 피크 타임 속도 저하가 심각한 지역 | FTTH 전환 검토 | HFC 공유 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 문제 |
...
케이블 [모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/146_modem_modulator_demodulator/)과 DOCSIS 표준은 기존 CATV 인프라를 최대한 재활용하면서 광대역 인터넷 보급을 앞당긴 핵심 기술이다. DOCSIS 3.1의 OFDM 도입은 최대 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/) Gbps 이론 속도를 가능하게 했으며, DOCSIS 4.0의 풀 듀플렉스(Full Duplex ESD) 기술은 업스트림도 대폭 향상시켜 FTTH와의 격차를 줄이고 있다.

**한계**: 공유 [매체](/knowledge-base/studynote/03_network/03_physical_layer_media/121_transmission_media_guided_unguided/) 특성상 가입자 밀도가 높으면 피크 타임 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)이 저하된다. 또한 [동축 케이블](/knowledge-base/studynote/03_network/03_physical_layer_media/127_coaxial_cable/)의 물리적 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)은 광섬유에 비해 절대적으로 좁아, 수십 Gbps 이상의 차세대 인터넷에서는 FTTH로의 전환이 불가피하다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **HFC (Hybrid Fiber-Coaxial)** | 케이블 [모뎀](/knowledge-base/studynote/03_network/03_physical_layer_media/146_modem_modulator_demodulator/)이 사용하는 광+동축 혼합 망 구조 |
