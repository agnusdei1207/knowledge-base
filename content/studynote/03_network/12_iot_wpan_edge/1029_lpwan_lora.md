...
|:---:|:---|:---|:---|
| **주파수 대역** | 비면허 대역 (무료, 한국 900MHz) | 비면허 대역 (무료) | <strong>면허 대역 (<a href="/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/752_lte_long_term_evolution_4g/">LTE</a>/<a href="/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/">5G</a>, 통신비 발생)</strong> |
...
LoRa망을 설계할 때는 <strong>'Duty Cycle(통신 시간 제한)'과 '<a href="/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/">데이터</a> 페이로드 한계'</strong>를 반드시 아키텍처에 반영해야 한다.
