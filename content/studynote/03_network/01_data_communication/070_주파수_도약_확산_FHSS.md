...
> 2. **가치**: 좁은 시간에 여러 주파수를 번갈아 사용하므로 [[701_sniffing_eavesdropping_promiscuous|도청]]/간섭 회피에 유리하다.
> 3. **판단**: 송수신 [[212_synchronization_mechanisms|동기화]]와 홉 패턴 관리가 핵심이다.
...
그래서 무선 통신과 [[605_bluetooth_ieee_802_15_1_piconet_scatternet|블루투스]] 계열에서 자주 언급된다.
...
| [[212_synchronization_mechanisms|Synchronization]] | 송수신 동기 |
| Anti-jamming | 재밍 회피 |
...
| [[956_dsss_direct_sequence_spread_spectrum_chipping_code|DSSS]] | 코드 확산 | 처리 이득 |

| 개념 | 의미 |
| :-- | :-- |
| Hop Sequence | 이동 순서 |
| [[068_스펙트럼_확산_Spread_Spectrum|Spread Spectrum]] | 확산 통신 |
...
1. [[212_synchronization_mechanisms|동기화]]가 가능한가?
2. 홉 패턴이 관리되는가?
3. 재밍 대응이 필요한가?
...
- 홉 패턴 없이 무작정 바꾸는 설계
- [[212_synchronization_mechanisms|동기화]] 실패를 무시하는 설계
- DSSS와 혼동하는 설계
- 주파수 규제를 고려하지 않는 설계
