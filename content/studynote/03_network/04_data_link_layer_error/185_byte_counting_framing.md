...
기술사 답안에서는 바이트 카운트를 단순히 "길이를 적는다"에서 끝내지 말고, <strong>오버헤드는 작지만 동기화 상실에 약하다</strong>는 본질을 분명히 써야 한다. 그리고 현대 설계에서는 보통 보호 장치와 함께 쓰거나, delimiter 기반 방식으로 진화했다는 연결까지 보여 주는 것이 좋다.
