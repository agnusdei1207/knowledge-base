...
- 사내 규정에 맞지 않게 평문으로 저장된 고객 주민등록번호 수만 개 엑셀([다크 데이터](/knowledge-base/studynote/12_it_management/02_itsm_itil/062_darkdata/))이 발견되면, 관리자에게 알람을 울리거나 문서를 강제로 암호화([DRM](/knowledge-base/studynote/12_it_management/03_ea_isp/903_drm_data_reference_model_standard/))해 버려 해킹을 사전에 차단합니다.
