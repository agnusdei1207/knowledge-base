...
← **이전**: [[741_casb_cloud_access_security_broker|741. CASB (Cloud Access Security Broker 클라우드 망 접속 보안 모니터/가시성 유지 시스템)]]
**다음**: [[743_cspm_cwpp_cloud_security_posture|743. CSPM / CWPP 보안 설정 모니터링 관리 및 워크로드 분산망 보안 맵 체계 가시화 기술 모델화 적용 시스템]] →
