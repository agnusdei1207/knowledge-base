...
XSS 개요와 3대 기법을 볼 때는 앞뒤 개념과의 경계를 함께 봐야 전체 흐름이 선명해진다. [스키밍](/knowledge-base/studynote/03_network/14_network_security_threats/725_port_scanning_full_open_vs_stealth_half_open/) 공격이 기반 조건을 만든다면, XSS 개요와 3대 기법은 그 위에서 핵심 메커니즘을 구현하고, SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/)은 이를 더 확장된 적용 단계로 연결한다. 따라서 단일 정의보다 탐지 가능성과 복구성에 어떤 차이를 만드는지 비교하는 것이 중요하다.

| 관점 | 선행 개념 | 현재 개념 | 확장 개념 |
|:---|:---|:---|:---|
| 초점 | [스키밍](/knowledge-base/studynote/03_network/14_network_security_threats/725_port_scanning_full_open_vs_stealth_half_open/) 공격의 기반 정리 | XSS 개요와 3대 기법의 핵심 동작 | SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/)의 확장 적용 |
...
실무에서는 XSS 개요와 3대 기법을 단독 개념으로 외우기보다 어떤 병목을 줄이기 위한 선택인지 먼저 따져야 한다. 특히 [스키밍](/knowledge-base/studynote/03_network/14_network_security_threats/725_port_scanning_full_open_vs_stealth_half_open/) 공격 수준의 기본 대책으로 충분한지, 아니면 XSS 개요와 3대 기법이 제공하는 메커니즘이 실제로 필요한지 구분해야 한다. 이후 확장 단계에서는 SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/)와 같은 후속 기술, 자동화 체계, 표준 호환성까지 함께 검토해야 한다.
...
3. 도입 후에는 인접 기술인 SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/)와의 연계 방식을 함께 검증한다.
...
| SQL [인젝션](/knowledge-base/studynote/04_software_engineering/11_testing_validation/480_injection/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
