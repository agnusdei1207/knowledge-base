...
> 1. **본질**: TI 융합 / STIX, TAXII 표준 지…는 [네트워크 보안](/knowledge-base/studynote/03_network/20_performance_evaluation_advanced/1117_network_security_zero_trust_policy/) 위협과 대응에서 핵심 동작과 제약을 이해하게 해 주는 개념이다.
...
|:---|:---|:---|:---|
| 초점 | SOAR의 기반 정리 | TI 융합 / STIX, TAXII 표준 지…의 핵심 동작 | [웹쉘](/knowledge-base/studynote/03_network/14_network_security_threats/747_web_shell_file_upload_vulnerability/)의 확장 적용 |
...
- 사내 [SIEM](/knowledge-base/studynote/09_security/13_secops_ir_forensics/624_siem/) 관제 화면에 어떤 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)이 찍힙니다. SIEM은 이 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)의 해시값을 즉시 인터넷망의 TI(위협 인텔리전스) 서버에 던져 질문합니다.
- TI 서버가 0.1초 만에 "그거 어제 북한 킴수키 해커 그룹이 뿌린 신종 악성코드임!"이라고 STIX 문서로 답장을 줍니다.
- 사내 [SOAR](/knowledge-base/studynote/03_network/14_network_security_threats/745_soar_security_orchestration_automation_response/)(자동화 장비)가 이 답장을 읽고, 사내망 스위치와 백신([EDR](/knowledge-base/studynote/09_security/04_endpoint_security/325_edr/))에 "그 해시값 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 가진 놈 다 찢어죽여!"라고 자동 방역 명령을 하달합니다. 완전한 자동 방어 생태계입니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [SOAR](/knowledge-base/studynote/03_network/14_network_security_threats/745_soar_security_orchestration_automation_response/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [웹쉘](/knowledge-base/studynote/03_network/14_network_security_threats/747_web_shell_file_upload_vulnerability/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
← **이전**: [745. SOAR (Security Orchestration, Automation and Response)](/knowledge-base/studynote/03_network/14_network_security_threats/745_soar_security_orchestration_automation_response/)
**다음**: [747. 웹쉘 (Web Shell 모니터, 디렉토리 실행 등 권한 취약 방지 스캔)](/knowledge-base/studynote/03_network/14_network_security_threats/747_web_shell_file_upload_vulnerability/) →
