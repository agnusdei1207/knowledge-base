...
- **규칙 1**: 입력단의 모든 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)는 중간단에 있는 모든 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)와 각각 1가닥씩 선을 무조건 연결(Full-Mesh)해야 합니다.
- **규칙 2 (논블로킹의 비밀)**: 중간단에 배치하는 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)의 개수를 "입력 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)의 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 수보다 2배 정도(정확히는 $2n-1$)" 많게 넉넉히 깔아둡니다.
- **왜?**: 내가 1번 입력단에서 2번 출력단으로 가려는데 중간단 1번 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)가 다른 놈 때문에 꽉 막혀있더라도, 2번, 3번, 4번... 우회할 수 있는 중간 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)가 미친 듯이 많이 널려 있기 때문에 패킷은 절대 막히지 않고 빈 구멍을 찾아 빠져나갑니다. **(논블로킹, Non-blocking 달성)**
