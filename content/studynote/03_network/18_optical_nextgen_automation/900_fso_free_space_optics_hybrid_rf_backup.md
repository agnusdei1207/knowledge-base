...
|:---|:---|:---|:---|
| 초점 | [다크 파이버](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/899_dark_fiber_unlit_infrastructure_lease/)의 기반 정리 | 무선 광통신의 핵심 동작 | AIOps의 확장 적용 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| [다크 파이버](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/899_dark_fiber_unlit_infrastructure_lease/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [AIOps](/knowledge-base/studynote/12_it_management/02_itsm_itil/099_aiops_chatbot_itsm_automation/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
← **이전**: [899. 다크 파이버 (Dark Fiber)](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/899_dark_fiber_unlit_infrastructure_lease/)
**다음**: [901. AIOps (인공지능 IT 운영)](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/901_aiops_artificial_intelligence_it_operations_observability/) →
