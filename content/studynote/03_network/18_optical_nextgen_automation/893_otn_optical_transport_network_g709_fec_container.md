...
OTN를 볼 때는 앞뒤 개념과의 경계를 함께 봐야 전체 흐름이 선명해진다. [ASON](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/892_ason_automatically_switched_optical_network_gmpls/) (Automatically Swit…가 기반 조건을 만든다면, OTN는 그 위에서 핵심 메커니즘을 구현하고, OAM는 이를 더 확장된 적용 단계로 연결한다. 따라서 단일 정의보다 전송 용량과 자동 제어성에 어떤 차이를 만드는지 비교하는 것이 중요하다.

| 관점 | 선행 개념 | 현재 개념 | 확장 개념 |
|:---|:---|:---|:---|
| 초점 | [ASON](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/892_ason_automatically_switched_optical_network_gmpls/) (Automatically Swit…의 기반 정리 | OTN의 핵심 동작 | OAM의 확장 적용 |
...
- 내용물을 건드리지 않습니다([Client](/knowledge-base/studynote/11_design_supervision/01_audit_framework/003_audit_stakeholders/) Transparent). [이더넷](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/) 패킷이 1번 서버에서 OTN 강철 [컨테이너](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/561_container_based_deployment/)에 들어간 뒤(In), 미국을 찍고 2번 서버에 나올 때 껍질을 벗기면(Out) 원본 [이더넷](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/) 패킷에 단 1비트의 손상이나 변형도 없습니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [ASON](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/892_ason_automatically_switched_optical_network_gmpls/) (Automatically Swit… | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
← **이전**: [892. ASON (자동 교환 광네트워크)](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/892_ason_automatically_switched_optical_network_gmpls/)
**다음**: [894. OAM 망 결함 관리](/knowledge-base/studynote/03_network/18_optical_nextgen_automation/894_oam_operations_administration_maintenance_fault_management/) →
