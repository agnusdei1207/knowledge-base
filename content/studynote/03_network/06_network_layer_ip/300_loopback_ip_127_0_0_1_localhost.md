...
### 1. [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 수준의 U턴 (Bypassing [NIC](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/587_nic_offloading/))
...
그래서 실제로 터미널에서 `ping 127.255.10.1`이나 `ping 127.0.0.99`를 쳐도 `127.0.0.1`과 완벽히 똑같이 내 컴퓨터가 응답한다. ([IPv4](/knowledge-base/studynote/03_network/06_network_layer_ip/286_ipv4_internet_protocol_version_4_rfc_791/) 고갈의 원흉 중 하나다. 참고로 차세대 IPv6에서는 이 낭비를 깨닫고 딱 한 개의 주소 `::1` 만을 루프백으로 지정했다.)
...
루프백 IP를 볼 때는 앞뒤 개념과의 경계를 함께 봐야 전체 흐름이 선명해진다. 사설 IP 영역: [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/).x, 172.16.x…가 기반 조건을 만든다면, 루프백 IP는 그 위에서 핵심 메커니즘을 구현하고, APIPA / [링크 로컬 주소](/knowledge-base/studynote/03_network/06_network_layer_ip/329_ipv6_link_local_fe80_site_local/)는 이를 더 확장된 적용 단계로 연결한다. 따라서 단일 정의보다 주소 효율과 도달성에 어떤 차이를 만드는지 비교하는 것이 중요하다.

| 관점 | 선행 개념 | 현재 개념 | 확장 개념 |
|:---|:---|:---|:---|
| 초점 | 사설 IP 영역: [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/).x, 172.16.x…의 기반 정리 | 루프백 IP의 핵심 동작 | APIPA / [링크 로컬 주소](/knowledge-base/studynote/03_network/06_network_layer_ip/329_ipv6_link_local_fe80_site_local/)의 확장 적용 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| 사설 IP 영역: [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/).x, 172.16.x… | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| APIPA / [링크 로컬 주소](/knowledge-base/studynote/03_network/06_network_layer_ip/329_ipv6_link_local_fe80_site_local/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
← **이전**: [299. 사설 IP (Private IP) 영역: 10.x, 172.16.x~172.31.x, 192.168.x](/knowledge-base/studynote/03_network/06_network_layer_ip/299_private_ip_ranges_10_172_192/)
**다음**: [301. APIPA / 링크 로컬 주소 (169.254.x.x)](/knowledge-base/studynote/03_network/06_network_layer_ip/301_apipa_link_local_address_169_254/) →
