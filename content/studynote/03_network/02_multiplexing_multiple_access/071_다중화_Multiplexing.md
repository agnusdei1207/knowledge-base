...
> 1. **본질**: 다중화는 하나의 전송 [[121_transmission_media_guided_unguided|매체]]를 여러 신호가 공유하도록 묶는 기술이다.
...
1. [[944_mux_demux_multiplexer_demultiplexer_circuit_sharing|MUX]]/DeMUX 구조를 아는가?
2. TDM/FDM/WDM 차이를 설명할 수 있는가?
3. 자원 효율을 계산할 수 있는가?
4. [[140_bandwidth|대역폭]]/지연을 고려하는가?
5. 전송 [[121_transmission_media_guided_unguided|매체]] 특성에 맞는가?
...
- 방식별 차이를 무시하는 설계
- 회선 효율을 고려하지 않는 설계
- 물리 [[121_transmission_media_guided_unguided|매체]] 특성을 무시하는 설계
...
결론적으로 다중화는 하나의 [[121_transmission_media_guided_unguided|매체]]를 여러 신호가 공유하게 하는 기술이다.
