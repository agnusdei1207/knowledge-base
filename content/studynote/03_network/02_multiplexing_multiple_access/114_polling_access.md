...
심층 동작 제어:
1. **[타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) 감시**: 주국이 Poll을 던진 후 일정 시간(타이머) 종국의 응답이 없으면, 해당 종국이 죽은 것으로 간주(단선/고장)하고 즉각 다음 차례 노드로 스킵한다.
2. **[폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/) 리스트 ([Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/) List)**: 단순 라운드-로빈 방식 외에도, 우선순위가 높은 종국을 리스트에 여러 번 배치하여 더 자주 기회를 부여하는 '[가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 우선순위 [폴링](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/448_polling_programmed_io/)(Weighted [Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/))' 구성이 가능하다.
...
**실무 [안티패턴](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/128_water_scrum_fall_anti_pattern/) 및 최악의 아키텍처**:
