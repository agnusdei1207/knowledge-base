...
> 2. **가치**: FTP를 이해하면 응답 시간과 [호환성](/knowledge-base/studynote/04_software_engineering/06_software_architecture/344_compatibility_usability/) 사이의 균형을 더 정확히 볼 수 있다.
...
- **개념**: FTP([File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) Transfer [Protocol](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/))는 [TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/)/IP 네트워크(인터넷) 상에서 컴퓨터들이 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 교환하기 위해 만든 클라이언트-서버 모델 기반의 최상위 응답 계층(Application Layer) 표준 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)이다.

- **필요성**: 인터넷이 갓 태동하던 1970년대, 멀리 떨어진 메인프레임 컴퓨터 사이에 연구 자료(수십 MB)를 복사하는 것은 엄청난 고역이었다. 당시엔 이메일이나 웹 브라우저도 없었다. 폴더 목록을 조회하고, 다운로드를 걸어놓고, 중간에 끊기면 이어받아야 했다. 이를 위해 "[명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)만 빠릿빠릿하게 치는 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)" 하나와 "무식하게 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 덩어리만 묵묵히 쏘는 [소켓](/knowledge-base/studynote/02_operating_system/02_process_thread/125_socket/)" 하나를 철저하게 나누어 역할 분담을 시키는 고효율의 투트랙(Two-Track) 전송 체계가 필요했다.
...
- <strong>주요 <a href="/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/">명령어</a> (<a href="/knowledge-base/studynote/11_design_supervision/01_audit_framework/003_audit_stakeholders/">Client</a> ➔ Server)</strong>
  ...
  - `RETR` (Retrieve) : [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 다운로드
...
두 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 모두 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/)을 다운로드할 수 있지만, 아키텍처 철학이 완전히 반대다.
...
과거에는 "웹페이지는 HTTP로 보고 대용량 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 첨부는 무조건 FTP로 분리해라"가 국룰이었다. 그러나 [HTTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/461_http_stateless_connection_oriented/)/2와 클라우드 S3의 발전, 인터넷 속도의 상향 평준화로 인해 굳이 [방화벽](/knowledge-base/studynote/03_network/13_network_security_basics/690_firewall_generation_evolution/) 세팅이 골치 아픈 FTP를 유지할 가성비가 떨어져 전부 [HTTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/461_http_stateless_connection_oriented/) 기반 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 다운로드로 통합되었다.
...
| 구분 | FTP 전송 아키텍처 ([포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 21) | [SFTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/485_sftp_ssh_file_transfer/) ([포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 22) / [HTTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/461_http_stateless_connection_oriented/) 아키텍처 | 개선 효과 |
|:---|:---|:---|:---|
...
### 참고 표준
- **RFC 959**: [File](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) Transfer [Protocol](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) (1985년 스펙 확정, 원시 표준)
- **RFC 2228**: FTP [Security](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/283_security_tactics/) Extensions ([FTPS](/knowledge-base/studynote/03_network/09_application_layer_web_email/486_ftps_ftp_over_ssl_tls/) 스펙)
- **RFC 4253**: The [Secure Shell](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/538_ssh_vs_telnet_secure_remote/) ([SSH](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/538_ssh_vs_telnet_secure_remote/)) Transport Layer [Protocol](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) (SFTP의 근간)

FTP는 인터넷 초창기, 모든 자원과 대역폭이 귀중했던 시기에 "제어와 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)의 철저한 분리"라는 놀랍도록 우아한 엔지니어링 통찰로 대용량 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 전송의 제왕으로 군림했다. 그 직관적인 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/) 통신 체계와 에러 코드 3자리 설계는 HTTP를 비롯한 현대 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)들의 유전자에 깊이 새겨졌다. 비록 보안이라는 시대적 파도를 넘지 못하고 도태되었으나, 네트워크 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) 아키텍처의 교과서로서 그 가치는 영원히 기억될 것이다.

- **📢 섹션 요약 비유**: 수백 년 전 튼튼한 마차(FTP)는 황무지를 뚫고 짐을 나르는 최고의 도구였지만, 사방에 매복한 산적(해커)을 피할 튼튼한 장갑(암호화)을 덧씌우지 못해 결국 역사의 뒤안길로 사라지고 튼튼한 장갑차([SFTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/485_sftp_ssh_file_transfer/))에 자리를 내어준 노장입니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [SSE](/knowledge-base/studynote/03_network/09_application_layer_web_email/481_sse_server_sent_events/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [액티브](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) FTP vs 패시브 FTP 동작 원리… | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
<- **이전**: [481. SSE (Server-Sent Events)](/knowledge-base/studynote/03_network/09_application_layer_web_email/481_sse_server_sent_events/)
**다음**: [483. 액티브(Active) FTP vs 패시브(Passive) FTP 동작 원리 차이](/knowledge-base/studynote/03_network/09_application_layer_web_email/483_active_vs_passive_ftp/) ->
