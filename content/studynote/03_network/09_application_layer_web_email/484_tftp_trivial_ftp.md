...
- **💡 비유**: 일반 **[FTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/482_ftp_file_transfer_protocol/)**가 택배 기사가 신분증(ID/PW)을 꼼꼼히 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하고 인수증에 사인([TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/))을 받은 뒤 무거운 짐을 집 안까지 안전하게 날라주는 **우체국 안심 택배**라면, **TFTP**는 드라이브스루 창구에서 이름표 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)도 없이 그냥 종이봉투([UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/))를 던져주고 돈도 안 받고 차를 보내버리는 **초간단 패스트푸드 픽업**과 같습니다.
...
| **3** | **[DATA](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)** | 실제 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/). `[Opcode: 3][블록 번호 2바이트][데이터(최대 512바이트)]` |
...
TFTP 서버는 기본적으로 [UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/) 69번 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)를 리스닝(Listening)하며 클라이언트의 RRQ/WRQ 요청을 기다린다. 하지만 **실제 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 전송(DATA와 ACK 교환)은 69번 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)에서 일어나지 않는다.**
...
|:---|:---|:---|
| **전송 계층** | **[TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/)** ([신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) 있는 스트림) | **[UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/)** (비연결형 다이어그램) |
| **[포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 사용** | 제어(21) + [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(20/랜덤) 이중 채널 | [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 접속(69) + [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(임시 랜덤) 단일 핑퐁 |
| **[인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/) ([Authentication](/knowledge-base/studynote/02_operating_system/10_security/604_authentication_factors/))**| `USER/PASS` 필수 | **없음 (묻지도 따지지도 않음)** |
...
| **[흐름 제어](/knowledge-base/studynote/03_network/04_data_link_layer_error/213_flow_control_buffer_overflow/) / 혼잡 제어** | [TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/) 슬라이딩 윈도우로 고속 펌핑 | **Stop-and-Wait (ACK 올 때까지 대기)**, 속도 극악 |
| **주 사용처** | 인터넷망 대용량 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 송수신 (과거) | **LAN 폐쇄망 내부 라우터/[스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) [펌웨어](/knowledge-base/studynote/02_operating_system/01_overview_architecture/032_firmware/) 업데이트, PXE 부팅** |

### 과목 융합 관점

- **[운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/) (OS)**: 디스크 없는(Diskless) 환경에서 OS를 올리려면 [DHCP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/522_dhcp_dynamic_host_configuration_protocol/), TFTP, BootP [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)이 3인 1조로 융합되어 동작한다.
...
1. **시나리오 — 대규모 IDC 베어메탈 서버 [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/) (PXE Boot) 자동화**: 클라우드 인프라팀이 500대의 신규 블레이드 서버를 랙(Rack)에 꽂았다. 사람이 일일이 USB를 들고 가서 OS를 깔 수 없으므로, 사내 망에 DHCP와 TFTP 서버(dnsmasq, tftpd)를 구축했다. 서버 전원을 켜면 NIC가 알아서 TFTP를 통해 Ubuntu Kickstart 부트 이미지를 빨아들여 동시에 500대가 자동 포맷되고 OS 세팅이 완료되는 인프라 코드화([IaC](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/793_iac_idempotency_template/)) 파이프라인을 완성했다.
...
2. **시나리오 — [Cisco](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/) 라우터 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) [백업](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)([Config](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) [Backup](/knowledge-base/studynote/02_operating_system/09_file_system/555_backup_and_restore_strategy/)) [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/) 장애**: 네트워크 엔지니어가 본사에서 지방 지사에 있는 [Cisco](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/) 라우터에 접속해 [명령어](/knowledge-base/studynote/01_computer_architecture/04_instruction_set_architecture/158_instruction/)를 쳤다. `copy running-config tftp://10.0.0.5/backup.cfg`. 라우터 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)을 중앙 TFTP 서버로 덤프 뜨려는 시도였다. 하지만 [파일](/knowledge-base/studynote/02_operating_system/09_file_system/501_file_definition_logical_record/) 용량이 2MB가 넘었고 핑(Ping)이 50ms인 지방 WAN 구간이라, TFTP의 지독한 Stop-and-Wait 전송 속도 탓에 전송이 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)되다 결국 [타임아웃](/knowledge-base/studynote/04_software_engineering/09_cloud_native_ai_architecture/573_timeout_retry_backoff_strategy/)으로 실패했다.
...
1. 일반 **[FTP](/knowledge-base/studynote/03_network/09_application_layer_web_email/482_ftp_file_transfer_protocol/)**가 우체국 아저씨가 신분증 검사 다 하고 무거운 짐을 집 안까지 튼튼한 수레([TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/))로 옮겨주는 거라면요.
2. **TFTP**는 이름 검사도 없이, 작은 삽(512바이트)으로 모래([데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))를 한 번 푸고 "받았어?(ACK)" [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하면 다시 한 삽 푸는 **초간단 노가다([UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/))**예요.
