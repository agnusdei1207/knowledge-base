...
> 1. **본질**: 노스바운드 인터페이스는 [SDN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/633_sdn_whitebox/)/NFV에서 핵심 동작과 제약을 이해하게 해 주는 개념이다.
> 2. **가치**: 노스바운드 인터페이스를 이해하면 [정책](/knowledge-base/studynote/10_ai/02_dl_architecture_new/164_policy/) 유연성과 자동화 수준 사이의 균형을 더 정확히 볼 수 있다.
...
|:---|:---|:---|:---|
| 초점 | [사우스바운드 인터페이스](/knowledge-base/studynote/03_network/17_sdn_nfv/853_southbound_interface_api_controller_switch/)의 기반 정리 | 노스바운드 인터페이스의 핵심 동작 | [OpenFlow](/knowledge-base/studynote/03_network/17_sdn_nfv/855_openflow_standard_protocol_sdn_southbound/) [SDN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/633_sdn_whitebox/) 1세대 표준 규격의 확장 적용 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| [사우스바운드 인터페이스](/knowledge-base/studynote/03_network/17_sdn_nfv/853_southbound_interface_api_controller_switch/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [OpenFlow](/knowledge-base/studynote/03_network/17_sdn_nfv/855_openflow_standard_protocol_sdn_southbound/) [SDN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/633_sdn_whitebox/) 1세대 표준 규격 | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
← **이전**: [853. 사우스바운드 인터페이스 (SBI)](/knowledge-base/studynote/03_network/17_sdn_nfv/853_southbound_interface_api_controller_switch/)
**다음**: [855. OpenFlow (오픈 플로우 표준)](/knowledge-base/studynote/03_network/17_sdn_nfv/855_openflow_standard_protocol_sdn_southbound/) →
