...
|:---|:---|:---|:---|
| **정량** | 캐시 포이즈닝 공격 성공 시간 | 수 분 이내 ([엔트로피](/knowledge-base/studynote/08_algorithm_stats/09_info_theory/151_entropy/) 부족) | **무한대 ([브루트포스](/knowledge-base/studynote/09_security/05_web_app_security/456_brute_force/) 수학적 불가)** |
| **정량** | 통신 프라이버시 노출률 | 100% (ISP가 모든 방문 사이트 추적) | **0% ([DoH](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/520_doh_dns_over_https/) 암호화 터널 통과 시)** |
