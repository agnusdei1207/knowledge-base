...
> 1. **본질**: [네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/)은 빈출 주제와 용어에서 핵심 동작과 제약을 이해하게 해 주는 개념이다.
> 2. **가치**: [네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/)을 이해하면 구분 명확성과 설명력 사이의 균형을 더 정확히 볼 수 있다.
...
- **개념**: [네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/) ([Network Slicing](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/))은 물리적인 망을 논리적으로 분리하여, 서로 간섭받지 않는 다수의 가상 네트워크를 구성하는 기술이다. 각 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)는 특정한 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 유형이나 고객의 요구사항에 맞춰 네트워크 자원(무선, 전송, 코어 망)과 [가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/)된 네트워크 기능([VNF](/knowledge-base/studynote/03_network/17_sdn_nfv/866_vnf_virtual_network_function_software_appliance/))을 동적으로 조합하여 구성된 독립적인 '엔드투엔드([E2E](/knowledge-base/studynote/15_devops_sre/05_devsecops/265_e2e_end_to_ui_selenium/)) 논리망'이다.

- **필요성**: 기존 4G [LTE](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/752_lte_long_term_evolution_4g/) 망은 스마트폰 중심의 모바일 브로드밴드 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)에 최적화된 "One-Size-Fits-All(일률 적용)" 구조였다. 하지만 [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/) 시대에는 [초고속](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/148_5g_embb_urllc_mmtc/)으로 4K 영상을 보는 스마트폰 사용자, 1ms 이하의 초저지연이 생명인 자율주행차, 한 달에 한 번씩 아주 적은 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 보내는 수백만 개의 농업용 스마트 센서가 동시에 망을 사용한다. 이처럼 요구사항이 완전히 다른 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)들을 하나의 물리망에서 기존 [QoS](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/) ([Quality of Service](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/)) 방식의 우선순위 조절만으로 처리하면 필연적으로 자원 충돌과 장애 전파가 발생한다. 따라서 각 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 특성에 맞춘 완전히 독립된 가상의 '차선'을 깔아주는 슬라이싱 기술이 필수 불가결해졌다.

- **💡 비유**: 물리적 네트워크가 거대한 '왕복 10차선 고속도로'라면, 슬라이싱은 이 도로에 차단벽을 세워 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 전용차로([초고속](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/148_5g_embb_urllc_mmtc/)), 구급차 전용차로(초저지연), 자전거 전용차로(초연결)를 물리적으로 분리하는 것과 같습니다. 구급차 차로에 일반 차량이 들어올 수 없으므로 교통 체증이 서로에게 영향을 주지 않습니다.

- **등장 배경 및 발전 과정**:
  과거 네트워크 분리는 [VLAN](/knowledge-base/studynote/09_security/05_web_app_security/224_vlan_virtual_lan_broadcast_domain/) ([Virtual LAN](/knowledge-base/studynote/09_security/05_web_app_security/224_vlan_virtual_lan_broadcast_domain/))이나 [VPN](/knowledge-base/studynote/03_network/19_frequent_topics_terms/983_vpn_virtual_private_network/) (Virtual Private Network) 수준의 L2/L3 패킷 격리에 머물렀으며, 기지국(RAN)부터 코어망(Core)까지 전체 경로를 완전히 쪼개는 것은 불가능했다. 그러나 통신 장비가 전용 하드웨어에서 벗어나 x86 서버 위에서 소프트웨어로 구동되는 [NFV](/knowledge-base/studynote/03_network/17_sdn_nfv/865_nfv_network_functions_virtualization_architecture/) 패러다임이 안착하고, 트래픽 경로를 중앙에서 제어하는 [SDN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/633_sdn_whitebox/) 컨트롤러가 상용화되면서 비로소 엔드투엔드([E2E](/knowledge-base/studynote/15_devops_sre/05_devsecops/265_e2e_end_to_ui_selenium/)) 슬라이싱 구현의 물리적 기반이 마련되었다.
...
- **📢 섹션 요약 비유**: 종합 병원이라는 건물(물리망) 하나에, 전염병을 다루는 격리 병동, 신속함이 생명인 응급실, 대규모 환자를 수용하는 외래 진료실을 완전히 독립된 환기 및 인력 시스템([슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/))으로 나누어 운영하는 것과 같습니다.

---

## Ⅱ. 아키텍처 및 핵심 원리

[네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/)은 단순히 망을 나누는 기술을 넘어, 고객의 비즈니스 요구사항을 받아 수 분 내에 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)를 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)(Instantiation)하고 라이프사이클을 관리하는 거대한 자동화 체계다. [3GPP](/knowledge-base/studynote/03_network/15_nextgen_communication_architecture/751_3gpp_3rd_generation_partnership_project/) 규격에서는 이를 [오케스트레이션](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/073_container_orchestration_tools/)([Orchestration](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/073_container_orchestration_tools/)) 구조로 정의한다.
...
**[다이어그램 해설]** 이 흐름도는 제로 터치 [프로비저닝](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/)(Zero-touch [Provisioning](/knowledge-base/studynote/09_security/11_iam_access_control/528_provisioning/))의 핵심이다. 기업 고객이 포털에서 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 요구사항([SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/))을 입력하면, 최상위 CSMF가 이를 네트워크 파라미터로 번역한다. 중간 관리자인 NSMF는 이를 받아 [E2E](/knowledge-base/studynote/15_devops_sre/05_devsecops/265_e2e_end_to_ui_selenium/) [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)를 구성하기 위해 각 영역의 하위 관리자인 NSSMF들에게 구체적인 명령을 내린다. 무선망(RAN) NSSMF는 기지국의 물리적 주파수 자원(PRB)을 쪼개어 할당하고, 코어망(Core) NSSMF는 [NFV](/knowledge-base/studynote/03_network/17_sdn_nfv/865_nfv_network_functions_virtualization_architecture/) 인프라 위에 [가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/)된 코어 노드(UPF 등)를 엣지에 배포하며, 전송망(Transport) NSSMF는 [SDN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/633_sdn_whitebox/) 컨트롤러를 통해 해당 트래픽이 통과할 라우터들의 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)을 예약한다. 이 모든 과정이 소프트웨어적으로 자동화되어 수분 내에 새로운 전용망이 뚝딱 탄생하게 되며, 이것이 NaaS (Network [as](/knowledge-base/studynote/03_network/07_network_layer_routing/344_as_autonomous_system_asn/) a [Service](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/))의 실체다.

### [E2E](/knowledge-base/studynote/15_devops_sre/05_devsecops/265_e2e_end_to_ui_selenium/) 자원 격리 ([Isolation](/knowledge-base/studynote/05_database/04_transactions_concurrency/195_isolation_concurrency_control/)) 메커니즘

슬라이싱의 가장 중요한 기술적 과제는 자원의 완벽한 '격리([Isolation](/knowledge-base/studynote/05_database/04_transactions_concurrency/195_isolation_concurrency_control/))'다. 하나의 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)에서 트래픽 폭주가 발생해도 다른 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)에 절대 영향을 주지 않아야 한다.
1. **RAN 구간**: [MAC](/knowledge-base/studynote/03_network/13_network_security_basics/673_mac_message_authentication_code/) 계층 스케줄러가 주파수 자원 블록(PRB, Physical Resource Block)을 [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)별로 하드/소프트 격리하여 스케줄링.
2. **Transport 구간**: FlexE (Flexible [Ethernet](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/)) 기술이나 [Segment](/knowledge-base/studynote/03_network/08_transport_layer/407_tcp_segment_header_structure_20_60_bytes/) [Routing](/knowledge-base/studynote/03_network/07_network_layer_routing/339_routing_overview_best_path_selection/) 기반의 VPN을 사용하여 L2/L3 계층에서 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)을 하드 격리(Hard [Isolation](/knowledge-base/studynote/05_database/04_transactions_concurrency/195_isolation_concurrency_control/)).
3. **Core 구간**: 컨테이너나 가상머신([VM](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/598_vm_migration_nic/)) 레벨에서 자원을 격리하고, 독립된 [VNF](/knowledge-base/studynote/03_network/17_sdn_nfv/866_vnf_virtual_network_function_software_appliance/)([가상 네트워크 기능](/knowledge-base/studynote/03_network/17_sdn_nfv/866_vnf_virtual_network_function_software_appliance/)) 인스턴스를 할당하여 프로세스 수준의 완전한 논리적 분리 구현.
...
| 비교 항목 | [VPN](/knowledge-base/studynote/03_network/19_frequent_topics_terms/983_vpn_virtual_private_network/) ([IPSec](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/589_ipsec_offload/)/[MPLS](/knowledge-base/studynote/03_network/07_network_layer_routing/373_mpls_multiprotocol_label_switching_20bit/)) | [Network Slicing](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/) | 판단 포인트 |
|:---|:---|:---|:---|
| **제공 계층** | 주로 L3 (네트워크 계층) [라우팅](/knowledge-base/studynote/03_network/07_network_layer_routing/339_routing_overview_best_path_selection/) 분리 | 기지국(L1/L2)부터 코어(L7)까지 [E2E](/knowledge-base/studynote/15_devops_sre/05_devsecops/265_e2e_end_to_ui_selenium/) 전 계층 | 격리의 폭 |
| **자원 보장성** | 논리적 암호화/[터널링](/knowledge-base/studynote/03_network/07_network_layer_routing/377_tunneling_mechanism_overview/) 위주 (Best Effort) | [SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/) 기반의 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/)/[지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)시간 확정적 보장 (Hard [QoS](/knowledge-base/studynote/03_network/07_network_layer_routing/388_qos_quality_of_service_best_effort_intserv_diffserv/)) | [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 품질 보장력 |
| **운영 주체** | 기업 IT 부서 또는 통신사 B2B 망 | 이동통신사 핵심망 내부의 [오케스트레이션](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/073_container_orchestration_tools/) | 관리의 복잡도 |
| **유연성** | 수동 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/), 정적 경로 [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/) 위주 | 동적 인스턴스화, 수분 내 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 및 소멸 가능 | 민첩성과 클라우드 친화성 |

VPN이 [터널링](/knowledge-base/studynote/03_network/07_network_layer_routing/377_tunneling_mechanism_overview/)을 통해 보안 관점의 분리를 제공했다면, 슬라이싱은 무선 주파수 자원과 컴퓨팅 파워까지 쪼개어 품질 관점의 확정적 보장(Deterministic Guarantee)을 제공한다는 점이 본질적 차이다.

- **📢 섹션 요약 비유**: 기존 QoS가 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/) 좌석에 경로 우대석을 스티커로 붙여놓는 것이라면, [네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/)은 아예 노인 전용 [버스](/knowledge-base/studynote/01_computer_architecture/09_system_bus_interconnects/344_bus/)를 따로 배차하여 일반 승객의 혼잡에 절대 영향을 받지 않도록 분리하는 차원입니다.
...
|:---|:---|:---|:---|
| **정량** | 새로운 전용망 구축에 수개월 소요 | 소프트웨어 기반 수 분(Minutes) 내 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) | TTM (Time to Market) 극적 단축 및 민첩성 |
| **정량** | 유휴 [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 낭비 발생 | 요구사항에 딱 맞는 자원만 동적 할당 | 네트워크 자원 이용 효율(Utilization) 40% 이상 개선 |
| **정성** | 장애 발생 시 전체 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/) 동시 타격 | [슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/)별 장애 완벽 격리 (Fault [Isolation](/knowledge-base/studynote/05_database/04_transactions_concurrency/195_isolation_concurrency_control/)) | 고가용성 [SLA](/knowledge-base/studynote/12_it_management/02_itsm_itil/869_sla/) 계약(99.999%)의 기술적 담보 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| [IDS](/knowledge-base/studynote/02_operating_system/10_security/601_ids_ips_syscall_tracing/) / [IPS](/knowledge-base/studynote/03_network/13_network_security_basics/695_ips_network_intrusion_prevention_system/) 탐지 차단율 | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
| 정의 (Definition) | 용어의 시작점을 분명하게 만든다. |
| 비교 (Comparison) | 헷갈리는 개념의 경계를 드러낸다. |
| [NFV](/knowledge-base/studynote/03_network/17_sdn_nfv/865_nfv_network_functions_virtualization_architecture/) 기반 [가상화](/knowledge-base/studynote/13_cloud_architecture/01_virtualization/015_virtualization/) [VNF](/knowledge-base/studynote/03_network/17_sdn_nfv/866_vnf_virtual_network_function_software_appliance/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
2. 예전에는 그냥 섞어서 구웠다면, '[네트워크 슬라이싱](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/149_network_slicing_5g_architecture/)' 기술은 피자를 조각([슬라이스](/knowledge-base/studynote/05_database/06_dw_olap_trends/331_neuromorphic_ai_db/))별로 정확히 나누어 고기 전용 조각, 야채 전용 조각, 치즈 듬뿍 조각으로 완벽히 다르게 굽는 마법이에요.
...
<- **이전**: [994. IDS / IPS 탐지 차단율](/knowledge-base/studynote/03_network/19_frequent_topics_terms/994_ids_ips_detection/)
**다음**: [996. NFV 기반 가상화 VNF](/knowledge-base/studynote/03_network/19_frequent_topics_terms/996_nfv_virtual_network_function/) ->
