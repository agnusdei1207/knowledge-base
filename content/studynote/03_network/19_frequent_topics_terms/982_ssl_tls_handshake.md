...
- **💡 비유**: 핸드셰이크는 낯선 두 [스파이](/knowledge-base/studynote/04_software_engineering/11_testing_validation/461_spy_test_double/)가 광장에서 만나 서로의 암구호 수첩(Cipher Suite)을 맞추고, 본부에서 발급한 신분증([인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서)을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)한 뒤, 오늘 하루 동안만 사용할 '비밀 무전 주파수([Session Key](/knowledge-base/studynote/09_security/03_network_security/140_session_key/))'를 귓속말로 정하는 은밀한 만남의 과정이다.
- **등장 배경 및 발전 과정**:
...
1. 핸드셰이크는 [스파이](/knowledge-base/studynote/04_software_engineering/11_testing_validation/461_spy_test_double/) 두 명이 처음 만나서 진짜 우리 편이 맞는지 신분증([인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서)을 꼼꼼히 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 비밀 접선 과정이에요.
...
3. 이 인사가 끝나고 나면, 두 [스파이](/knowledge-base/studynote/04_software_engineering/11_testing_validation/461_spy_test_double/)는 아무리 나쁜 악당이 엿듣고 있어도 그 비밀번호로만 해석할 수 있는 외계어로 대화하며 안전하게 정보를 주고받을 수 있답니다!
