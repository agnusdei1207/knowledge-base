...
> 1. **본질**: [PKI](/knowledge-base/studynote/09_security/03_network_security/159_pki_public_key_infrastructure/) ([Public Key Infrastructure](/knowledge-base/studynote/09_security/uncategorized/1080_pki_public_key_infrastructure_ca_ra_certificate/))는 디지털 세계에서 '신뢰'를 구조화하는 근간으로, [비대칭키 암호](/knowledge-base/studynote/09_security/02_crypto/077_asymmetric_encryption/) 체계를 기반으로 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서(Certificate)를 발급, [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/), 관리하는 일련의 정책과 기술적 인프라이다.
> 2. **가치**: 불특정 다수가 참여하는 오픈 네트워크(인터넷) 상에서 상호 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/), [기밀성](/knowledge-base/studynote/09_security/01_intro_principles/002_confidentiality/), [무결성](/knowledge-base/studynote/09_security/01_intro_principles/003_integrity/), 부인 방지를 보장하여 전자상거래, [HTTPS](/knowledge-base/studynote/03_network/09_application_layer_web_email/471_https_http_over_tls/) 통신, [전자서명](/knowledge-base/studynote/03_network/13_network_security_basics/675_digital_signature_process_asymmetric_key/)의 기술적 신뢰를 완성한다.
> 3. **판단 포인트**: X.509 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 형식과 [TLS](/knowledge-base/studynote/02_operating_system/11_exam_summary/694_thread_local_storage_tls/) (Transport Layer [Security](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/283_security_tactics/)) [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)에 결합되어 작동하며, [양자 컴퓨터](/knowledge-base/studynote/01_computer_architecture/12_accelerators_ai_hardware/447_quantum_computer/) 시대의 도래와 함께 [PQC](/knowledge-base/studynote/12_it_management/05_security_compliance/992_quantum_computing_pqc_transition/) ([Post-Quantum Cryptography](/knowledge-base/studynote/14_data_engineering/04_mlops/183_post_quantum_cryptography_key_transition/)) 기반의 새로운 [PKI](/knowledge-base/studynote/09_security/03_network_security/159_pki_public_key_infrastructure/) 체계로 진화하고 있다.

---

## Ⅰ. 개요 및 필요성

- **개념**: [PKI](/knowledge-base/studynote/09_security/03_network_security/159_pki_public_key_infrastructure/) ([Public Key Infrastructure](/knowledge-base/studynote/09_security/uncategorized/1080_pki_public_key_infrastructure_ca_ra_certificate/))는 제3자 신뢰 기관 ([TTP](/knowledge-base/studynote/09_security/04_endpoint_security/329_ttp/), Trusted Third Party)인 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)기관 ([CA](/knowledge-base/studynote/06_ict_convergence/01_blockchain/089_contract_account_smart_contract/), Certificate Authority)을 통해 각 주체의 공개키 (Public [Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/))와 신원을 바인딩하는 전자 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 체계를 의미한다. 이를 통해 수신자는 전달받은 공개키가 정말로 자신이 통신하고자 하는 상대방의 것임을 암호학적으로 확신할 수 있다.

- **필요성**: 비대칭키 (공개키/개인키) 시스템만으로는 [중간자 공격](/knowledge-base/studynote/03_network/14_network_security_threats/706_mitm_man_in_the_middle_hsts/) (MITM, Man-In-The-Middle)을 방어할 수 없다. 해커가 통신 중간에서 자신의 공개키를 정상적인 공개키인 것처럼 속여 전달하면, 송신자는 해커의 공개키로 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 암호화하게 되고 결국 [기밀성](/knowledge-base/studynote/09_security/01_intro_principles/002_confidentiality/)이 완전히 무너진다. PKI는 '이 공개키는 누구의 것이 맞다'라고 공인된 기관이 [전자서명](/knowledge-base/studynote/03_network/13_network_security_basics/675_digital_signature_process_asymmetric_key/)해주는 메커니즘을 제공하여 이러한 신뢰의 공백을 메워주는 필수 불가결한 안전망이다.

- **💡 비유**: PKI는 국가가 발급하는 "주민등록증 발급 시스템"과 같다. 내가 누군가에게 "내 이름은 홍길동이야"라고 말할 때(공개키 전달), 그것을 그냥 믿는 대신 국가([인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)기관)가 도장을 찍어준 신분증([인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서)을 보여주면 상대방은 국가의 도장을 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하고 나의 신원을 확신할 수 있다.
...
- **📢 섹션 요약 비유**: 마치 온라인 중고거래에서 상대방이 보낸 계좌번호가 진짜 판매자의 것인지 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)할 수 없어 불안할 때, '안심결제 에스크로 [서비스](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/090_service_kubernetes_network_load_balancing/)'가 그 계좌의 진위를 보증해주는 것과 같습니다.
...
| <strong><a href="/knowledge-base/studynote/09_security/03_network_security/161_ra_registration_authority/">RA</a> (<a href="/knowledge-base/studynote/09_security/03_network_security/161_ra_registration_authority/">Registration Authority</a>)</strong> | 사용자의 신원을 대면/비대면으로 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) | CA의 업무를 위임받아 신원 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 수행 | KYC (Know Your [C고객](/knowledge-base/studynote/12_it_management/01_governance_strategy/820_three_c_analysis/)) | 동주민센터 신원 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/) 창구 |
...
### [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 체인 구조 (Certificate Chain)
...
- **📢 섹션 요약 비유**: 마치 결재 서류에 팀장, 실장, 본부장의 도장이 차례대로 찍혀 있어서, 최종 대표이사가 직접 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하지 않아도 그 서류의 효력을 전사적으로 믿고 승인할 수 있는 계층적 결재 라인과 같습니다.

---

## Ⅲ. 비교 및 연결

[인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서가 발급 후 탈취되거나 손상되면 만료일 전이라도 폐지해야 한다. 클라이언트가 이 폐지 상태를 [확인](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/396_validation/)하는 방식의 발전은 통신 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)을 줄이는 방향으로 진화했다.
...
- **기술적**: 웹 서버(Nginx/Apache)에 만료된 하위 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 체인이 누락되지 않고 온전한 Certificate Chain (Fullchain)이 설정되었는가? 만료 30일 전 자동 알람 혹은 ACME 기반 자동 갱신 스크립트가 구성되었는가?
- **운영·보안적**: Private [Key](/knowledge-base/studynote/05_database/02_modeling_normalization/067_db_key_uniqueness_minimality/) (개인키)가 [HSM](/knowledge-base/studynote/01_computer_architecture/14_hardware_security_trends/475_hsm/) ([Hardware Security Module](/knowledge-base/studynote/09_security/03_network_security/157_hsm_hardware_security_module/))이나 [AWS KMS](/knowledge-base/studynote/09_security/20_extra_exam_prep/1013_aws_kms/) 등 안전한 저장소에 보관되고 있는가? Root [CA](/knowledge-base/studynote/06_ict_convergence/01_blockchain/089_contract_account_smart_contract/) 오프라인 보관 수칙을 준수하고 있는가?
...
- **RFC 6960**: X.509 인터넷 공개키 인프라스트럭처 온라인 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 상태 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/) - [OCSP](/knowledge-base/studynote/03_network/13_network_security_basics/679_ocsp_online_certificate_status_protocol/)
- **RFC 8555**: ACME (Automatic Certificate [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/) [Environment](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/066_gitlab_flow_environment_branch_strategy/))
...
| 개념 | 연결 포인트 |
|:---|:---|
| [VPN](/knowledge-base/studynote/03_network/19_frequent_topics_terms/983_vpn_virtual_private_network/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
| 정의 (Definition) | 용어의 시작점을 분명하게 만든다. |
| 비교 (Comparison) | 헷갈리는 개념의 경계를 드러낸다. |
| X.509 [인증](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/303_authentication_authorization_patterns/)서 | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
