...
> 1. **본질**: 타임 센시티브 네트워킹은 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 평가와 고급 분석에서 핵심 동작과 제약을 이해하게 해 주는 개념이다.
...
### 1. 1048번 PTP 시각 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/) (IEEE 802.1AS)
- 모든 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)와 로봇 팔의 시계([Clock](/knowledge-base/studynote/01_computer_architecture/01_basic_electronics_logic/045_clock/))가 마이크로초(µs) 단위로 완벽하게 100% 똑같이 똑딱거려야(시간 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)) 시간표를 짤 수 있습니다. (자세한 건 다음 1048번 문서)

### 2. TAS 시간 인식 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) (IEEE 802.1Qbv) 🌟 - "모세의 기적"
TSN의 가장 위대한 핵심 기술입니다.
- [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) 출구에는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 나가는 8개의 큐([Queue](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/058_queue/), 대기열 줄)가 있습니다.
- [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/)가 [스케줄러](/knowledge-base/studynote/13_cloud_architecture/02_iaas_paas_saas/079_kube_scheduler_pod_placement/) 시간표를 봅니다. "오전 9시 00분 00초부터 9시 00분 01초까지는 **무조건 공장 로봇 팔 VIP 패킷만 쏘는 시간이다!**"
...
|:---|:---|:---|:---|
| 초점 | [P4](/knowledge-base/studynote/03_network/17_sdn_nfv/874_p4_programming_data_plane_pipeline_int_telemetry/) 네트워크 프로그래밍 모델 플로우의 기반 정리 | 타임 센시티브 네트워킹의 핵심 동작 | IEEE 1588 PTP 시각 동기망의 확장 적용 |
...
- [스마트 팩토리](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/166_smart_factory/)의 수만 개 센서와 로봇을 조종하기 위한 산업용 통신망.
- 1024번의 자율주행 자동차([V2X](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/141_v2x_vehicle_to_everything_communication/)) 뱃속 네트워크. (센서에서 "장애물 발견!" [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 0.1초 늦게 브레이크로 전달되면 차가 부딪힙니다. 차체 내부의 랜선 통신망을 모두 [TSN](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/546_tsn_hardware/) [이더넷](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/)으로 갈아엎고 있습니다.)
...
| 개념 | 연결 포인트 |
|:---|:---|
| [P4](/knowledge-base/studynote/03_network/17_sdn_nfv/874_p4_programming_data_plane_pipeline_int_telemetry/) 네트워크 프로그래밍 모델 플로우 | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
← **이전**: [1046. P4 네트워크 프로그래밍 모델 플로우](/knowledge-base/studynote/03_network/20_performance_evaluation_advanced/1046_p4_programming_protocol_independent_packet_processors/)
**다음**: [1048. IEEE 1588 PTP 시각 동기망](/knowledge-base/studynote/03_network/20_performance_evaluation_advanced/1048_ptp_ieee_1588_precision_time_protocol_sync/) →
