...
- **개념**: 서버 A의 메인 메모리(RAM)에서 서버 B의 메인 메모리로, **양쪽 서버의 CPU, 캐시, [운영체제](/knowledge-base/studynote/02_operating_system/01_overview_architecture/001_operating_system_purpose/)(OS [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/))의 개입을 100% 무시하고 랜카드(RNIC) 하드웨어끼리 다이렉트로 메모리에 데이터를 꽂아 넣는([Zero-Copy](/knowledge-base/studynote/02_operating_system/09_file_system/566_mmap_zero_copy_sendfile/), [Kernel](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) Bypass) [초고속](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/148_5g_embb_urllc_mmtc/)/초저지연 메모리 전송 기술**입니다.
...
- 애초에 슈퍼컴퓨터들의 [RDMA](/knowledge-base/studynote/02_operating_system/10_security/639_rdma_kernel_bypass/) 통신을 위해 만들어진 **오리지널 순혈 [초고속](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/148_5g_embb_urllc_mmtc/) 네트워크망**입니다.
...
- **[RoCE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/523_roce/) v1 vs v2**:
  ...
  - **[RoCE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/523_roce/) v2 (현재 천하 통일)**: IP 주소와 [UDP](/knowledge-base/studynote/03_network/08_transport_layer/406_udp_user_datagram_protocol_connectionless_fast/) 헤더(L3/L4 계층)를 뒤집어씌워 라우팅이 가능해졌습니다. 그냥 **흔한 인터넷 IP 환경 인프라를 그대로 쓰면서도 [커널](/knowledge-base/studynote/02_operating_system/01_overview_architecture/022_kernel_role/) 바이패스의 달콤한 [RDMA](/knowledge-base/studynote/02_operating_system/10_security/639_rdma_kernel_bypass/) 속도 꿀을 빠는 궁극의 하이브리드 타협 기술**입니다. 
...
- **[iWARP](/knowledge-base/studynote/03_network/16_data_center_cloud/814_iwarp_tcp_ip_based_rdma_compatibility/)**: "그냥 안전 빵 튼튼한 [TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/)/IP 뼈대 위에서 RDMA를 돌리자!"는 파생형인데, [TCP](/knowledge-base/studynote/03_network/08_transport_layer/405_tcp_transmission_control_protocol_connection_oriented/) 특유의 무거운 오버헤드 때문에 속도에서 밀려 지금은 [RoCE](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/523_roce/) v2에 거의 압살당했습니다.
