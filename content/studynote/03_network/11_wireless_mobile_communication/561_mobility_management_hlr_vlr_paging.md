...
엔지니어는 Location Area([TA](/knowledge-base/studynote/12_it_management/03_ea_isp/106_ta_as_is_analysis/))의 크기를 정할 때 지독한 딜레마에 빠진다. LA를 크게 잡으면 [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/)이 폭발하고, 작게 잡으면 위치 등록이 폭발한다.
...
| **정량 (무선 자원 효율)** | 단말기 1개 찾으려고 서울시 전체 [Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) 폭발 | 적절한 [TA](/knowledge-base/studynote/12_it_management/03_ea_isp/106_ta_as_is_analysis/) 크기 조절로 [페이징](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) 방송 효율화 | 무선 [Paging](/knowledge-base/studynote/02_operating_system/04_synchronization/259_paging/) 채널(PCH) 가용량 및 용량 **50% 여유 확보** |
