...
- **📢 섹션 요약 비유**: [WAVE](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/590_wave_ieee_802_11p_dsrc_v2x/) 진영은 자율주행 차들을 위해 산속에 새로 흙길을 파서 공짜로 자전거 도로를 뚫어주겠다고 했습니다(오래 걸리고 돈 듦). [C-V2X](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/143_c_v2x_cellular_based_communication/) 진영은 "이미 전국에 뚫려있는 [5G](/knowledge-base/studynote/07_enterprise_systems/09_digital_transformation/418_5g_embb_urllc_mmtc_slicing/) 고속도로(통신사 망)가 있는데 왜 바보같이 흙길을 파냐? 그냥 고속도로에 자율주행 전용 파란 선(Slicing) 하나 긋고 쓰자!"라고 제안했습니다. 당연히 국가 입장에선 C-V2X가 훨씬 천재적이고 돈 덜 드는 제안이었죠.

---

## Ⅲ. 비교 및 연결

C-V2X를 볼 때는 앞뒤 개념과의 경계를 함께 봐야 전체 흐름이 선명해진다. [WAVE](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/590_wave_ieee_802_11p_dsrc_v2x/) DSRC가 기반 조건을 만든다면, C-V2X는 그 위에서 핵심 메커니즘을 구현하고, [위성 통신](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/592_satellite_communication_characteristics/) 특징은 이를 더 확장된 적용 단계로 연결한다. 따라서 단일 정의보다 스펙트럼 효율과 이동성에 어떤 차이를 만드는지 비교하는 것이 중요하다.

| 관점 | 선행 개념 | 현재 개념 | 확장 개념 |
|:---|:---|:---|:---|
| 초점 | [WAVE](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/590_wave_ieee_802_11p_dsrc_v2x/) DSRC의 기반 정리 | C-V2X의 핵심 동작 | [위성 통신](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/592_satellite_communication_characteristics/) 특징의 확장 적용 |
...
| 개념 | 연결 포인트 |
|:---|:---|
| [WAVE](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/590_wave_ieee_802_11p_dsrc_v2x/) [DSRC](/knowledge-base/studynote/03_network/12_iot_wpan_edge/1025_c_v2x_wave_dsrc/) | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [위성 통신](/knowledge-base/studynote/03_network/11_wireless_mobile_communication/592_satellite_communication_characteristics/) 특징 | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
2. [C-V2X](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/143_c_v2x_cellular_based_communication/) 기술은 자동차에게 "투시하는 초능력 귀(전파 텔레파시)"를 달아준 거예요. 눈으로 담벼락 뒤를 보지는 못해도, 자동차들끼리 "야 담벼락 뒤에 자전거 튀어나가 조심해!"라고 0.01초 만에 귓속말을 해주죠.
