...
- **개념**: RMON은 [IETF](/knowledge-base/studynote/03_network/12_iot_wpan_edge/635_ietf_core_working_group_coap/) 표준 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)로, [SNMP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/528_snmp_simple_network_management_protocol/) (Simple Network [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/) [Protocol](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/)) 확장판의 성격을 띤다. 네트워크 상의 케이블이나 [스위치](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/238_switch_operation_principles/) [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/)에 연결된 에이전트 장비(RMON Probe)가 특정 세그먼트를 지나가는 모든 패킷을 모니터링하여 자체적으로 [MIB](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/529_mib_oid_snmp_architecture/) ([Management Information Base](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/529_mib_oid_snmp_architecture/))에 통계를 누적하고, 중앙 관리자에게 전송하는 구조를 갖는다.
...
### 구성 요소 (RMON [MIB](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/529_mib_oid_snmp_architecture/) 및 Probe 구조)
...
- **📢 섹션 요약 비유**: 건물 내에 연기가 피어오를 때 관리실에서 수시로 "연기 납니까?" 묻지 않아도, 천장에 달린 화재 감지기(RMON Alarm)가 알아서 연기 농도(에러 패킷)를 재다가 위험 수준을 넘기면 왱~ 하고 비상벨([Trap](/knowledge-base/studynote/02_operating_system/11_exam_summary/677_trap_based_system_call_implementation/))을 울리는 자율 방어 체계입니다.

---

## Ⅲ. 비교 및 연결

현대 네트워크 모니터링은 장비 중심([SNMP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/528_snmp_simple_network_management_protocol/)), 세그먼트 중심(RMON), 플로우 흐름 중심([NetFlow](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/))의 세 가지 축으로 발전해 왔다. 이들의 기술적 포지션을 비교하면 각각의 트레이드오프가 명확해진다.

| 비교 기준 | [SNMP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/528_snmp_simple_network_management_protocol/) (기본 [MIB](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/529_mib_oid_snmp_architecture/)) | RMON (Remote Network Monitoring) | [NetFlow](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/) / IPFIX |
|:---|:---|:---|:---|
...
- **📢 섹션 요약 비유**: SNMP가 청진기를 대고 환자(장비)의 심장 박동(CPU)을 듣는 것이라면, RMON 1은 내시경을 넣어 식도(케이블)에 난 상처([이더넷](/knowledge-base/studynote/03_network/05_lan_wan_l2_devices/230_ethernet_structure_and_principles_ieee_802_3/) 에러)를 찾는 것이고, RMON 2와 NetFlow는 피를 뽑아 어떤 [바이러스](/knowledge-base/studynote/02_operating_system/10_security/589_virus/)(L7 [프로토콜](/knowledge-base/studynote/03_network/06_network_layer_ip/295_protocol_field_tcp_udp_icmp/))가 돌고 있는지 정밀 혈액 검사를 하는 것과 같습니다.
...
| 구분 | [SNMP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/528_snmp_simple_network_management_protocol/) 기반 수동 관제 (RMON 미적용) | RMON [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)/자율 관제 적용 시 | 개선 효과 |
|:---|:---|:---|:---|
| **정량 (가시성)** | 라우터 [포트](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/446_port_and_bus/) 사용량, UP/DOWN 상태 파악 | L1/L2 패킷 찌그러짐, 크기, [CRC](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/113_crc/) 불량률 전수 파악 | 물리적 선로/광모듈 노후화 및 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/) 탐지율 **100% 확보** |
| **정량 (네트워크 오버헤드)** | NMS가 초당 수천 번 [SNMP](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/528_snmp_simple_network_management_protocol/) [Polling](/knowledge-base/studynote/02_operating_system/11_exam_summary/747_io_polling_overhead/) 시도 (WAN [대역폭](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/140_bandwidth/) 점유율 5% 초과) | 이상 [임계치](/knowledge-base/studynote/03_network/08_transport_layer/431_ssthresh_slow_start_threshold/) 도달 시에만 NMS로 [Trap](/knowledge-base/studynote/02_operating_system/11_exam_summary/677_trap_based_system_call_implementation/) 푸시 | 관제 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 트래픽 **90% 이상 대폭 절감** |
...
- <strong>RFC <a href="/knowledge-base/studynote/04_software_engineering/11_testing_validation/869_owasp_top_10_2021/">2021</a></strong>: Remote Network Monitoring [Management Information Base](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/529_mib_oid_snmp_architecture/) Version 2 (RMON 2)
...
- **📢 섹션 요약 비유**: RMON은 병원에 가지 않아도 내 손목에서 심박수 불규칙(네트워크 [결함](/knowledge-base/studynote/04_software_engineering/06_software_architecture/352_defect_definition/))을 알아서 분석하고 위험할 때만 삐삐 울려서 병원(NMS)에 알려주는 첨단 스마트워치 헬스케어 기술의 1세대 할아버지 격 모델입니다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| [NetFlow](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/) / sFlow 트래픽 흐름 모… | 현재 개념이 등장하기 전에 갖춰야 할 배경이나 인접 선행 개념이다. |
...
| [RADIUS](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/541_radius_remote_authentication_aaa/) | 현재 개념이 확장되거나 적용 단계로 이어질 때 자주 함께 언급된다. |
...
<- **이전**: [539. NetFlow (Cisco) / sFlow 트래픽 흐름 모니터링 분석 프로토콜](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/539_netflow_sflow_traffic_monitoring/)
**다음**: [541. RADIUS (Remote Authentication Dial-In User Service)](/knowledge-base/studynote/03_network/10_application_layer_dns_mgmt/541_radius_remote_authentication_aaa/) ->
