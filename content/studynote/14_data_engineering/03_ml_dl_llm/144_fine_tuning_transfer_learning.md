...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: Fine-tuning은 **사전 학습된 Foundation Model의 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/)를 특정 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)·작업의 라벨 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)로 추가 학습**하여 적응시키는 [Transfer Learning](/knowledge-base/studynote/10_ai/02_dl_architecture_new/132_transfer_learning/) 기법이다.
> 2. **가치**: 처음부터 학습하면 **수백만 달러·수개월**이 소요되지만, Fine-tuning은 **소량 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(수천~수만)로 수시간**만에 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 특화 모델을 만들어 비용을 100배+ 절감한다.
...
Fine-tuning은 **FM을 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/)에 적응시키는 핵심 기법**이며, [LoRA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/)/QLoRA가 효율적 표준이다.
...
| 개념 | 연결 포인트 |
|:---|:---|
| **[Fine-tuning](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/304_fine_tuning/)** | [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 적응 |
| **[Transfer Learning](/knowledge-base/studynote/10_ai/02_dl_architecture_new/132_transfer_learning/)** | 지식 이전 |
| **[LoRA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/)** | 저랭크 [PEFT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/306_peft_lora/) |
