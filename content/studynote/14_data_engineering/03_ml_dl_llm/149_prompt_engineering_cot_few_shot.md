...
<- **이전**: [148. RLHF (인간 피드백 기반 강화학습) - 인간 피드백 정렬](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/148_rlhf_human_feedback_reinforcement/)
**다음**: [150. 할루시네이션(Hallucination)과 RAG(검색 증강 생성) 융합 방어막](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/150_hallucination_rag_retrieval_augmented_generation/) ->
