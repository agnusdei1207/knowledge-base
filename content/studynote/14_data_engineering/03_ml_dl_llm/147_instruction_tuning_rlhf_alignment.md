...
- IT 미적용: 지시를 무시하고 관련 없는 텍스트 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)
- [RLHF](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/250_rlhf_human_feedback_reinforcement_alignment_cot/) 미적용: 지시는 따르지만 유해·편향 콘텐츠 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 가능
...
| [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)셋 | 특징 |
|:---|:---|
| **FLAN (Google)** | 수백 개의 NLP 태스크를 IT 형식으로 변환 |
| **Alpaca (Stanford)** | GPT-3.5로 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/)한 52K 인스트럭션 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) |
...
| 목표 | 권장 기법 | 이유 |
|:---|:---|:---|
| 특정 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 지시 따르기 (의료·법률) | SFT ([도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) IT [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)) | [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 특화 지식 주입 |
| 응답 안전성·유해성 제거 | [RLHF](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/250_rlhf_human_feedback_reinforcement_alignment_cot/) 또는 [RLAIF](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/269_vector_database/) | 사람 선호 정렬 필수 |
| 빠른 정렬 ([RLHF](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/250_rlhf_human_feedback_reinforcement_alignment_cot/) 없이) | [DPO](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/270_embedding_model/) | 보상 모델 학습 생략 |
| 프라이버시 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) | [On-premise](/knowledge-base/studynote/07_enterprise_systems/01_strategy_governance/061_on_premise_legacy_infrastructure/) SFT | 외부 [API](/knowledge-base/studynote/02_operating_system/01_overview_architecture/014_api_posix/) 사용 불가 |
...
**양보다 질**: 인스트럭션 튜닝 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 100만 개의 저품질 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)보다 1,000개의 고품질 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 효과적이다(LIMA 논문). 자동 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 오류·편향이 섞이면 오히려 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 저하가 발생한다.

- **📢 섹션 요약 비유**: 저품질 대량 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)는 **'잘못된 교과서 100권'** 과 같습니다. 책이 아무리 많아도 내용이 틀리면 잘못된 지식만 학습됩니다. 1권의 완벽한 교과서가 낫습니다.
...
**미래 방향**: ① [DPO](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/270_embedding_model/)·ORPO 등 보상 모델 없는 정렬 기법 확산, ② 자동화된 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 피드백([RLAIF](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/269_vector_database/)) 주류화, ③ [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/) 자체 평가 능력을 활용한 Self-Play 정렬.

인스트럭션 튜닝은 "모델을 더 크게 만드는 것"이 아니라, **"모델이 사람의 의도를 정확히 이해하고 따르도록 방향을 맞추는 것"** 이라는 관점이 핵심이다.

- **📢 섹션 요약 비유**: 인스트럭션 튜닝+RLHF는 **'천재 박사생을 실력 있는 선생님으로 교육하는 과정'** 입니다. 지식은 이미 가득하지만(사전 학습), 학생에게 이해하기 쉽게 설명하는 법(IT)과 학생이 싫어하는 방식은 피하는 법([RLHF](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/250_rlhf_human_feedback_reinforcement_alignment_cot/))을 배워야 훌륭한 선생님이 됩니다.
