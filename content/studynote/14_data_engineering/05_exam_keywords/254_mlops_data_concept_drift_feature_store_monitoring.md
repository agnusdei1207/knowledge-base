...
## 핵심 인사이트 (3줄 요약)
> 1. **본질**: [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/)([Machine Learning Operations](/knowledge-base/studynote/12_it_management/05_security_compliance/220_mlops_machine_learning_operations/))는 ML 모델을 실험 단계에서 프로덕션(Production)까지 [신뢰성](/knowledge-base/studynote/04_software_engineering/10_trends_pm_quality/642_reliability_mtbf_mttr_mttf_availability/) 있게 운영하는 [DevOps](/knowledge-base/studynote/04_software_engineering/uncategorized/652_devops_calms_culture/) 확장 패러다임이다.
> 2. **가치**: [데이터 드리프트](/knowledge-base/studynote/14_data_engineering/04_mlops/163_data_drift_statistical_distribution_shift/)([Data Drift](/knowledge-base/studynote/14_data_engineering/04_mlops/163_data_drift_statistical_distribution_shift/))와 [컨셉 드리프트](/knowledge-base/studynote/14_data_engineering/04_mlops/164_concept_drift_target_mapping_change/)([Concept Drift](/knowledge-base/studynote/14_data_engineering/04_mlops/164_concept_drift_target_mapping_change/)) 자동 탐지 및 [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)([Feature Store](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/))를 통한 특징 재사용이 ML 시스템의 안정성과 개발 생산성을 동시에 높인다.
> 3. **판단 포인트**: 드리프트 탐지 후 자동 재훈련(Retraining) [트리거](/knowledge-base/studynote/05_database/04_transactions_concurrency/507_acid_properties/) 임계값(Threshold) [설정](/knowledge-base/studynote/15_devops_sre/01_culture_methodology/009_config/)이 과민 재훈련(비용 낭비)과 방치([성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 저하) 사이의 균형을 결정한다.

---

## Ⅰ. 개요 및 필요성

### 1.1 MLOps가 필요한 이유: ML [기술 부채](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/)(ML [Technical Debt](/knowledge-base/studynote/12_it_management/02_itsm_itil/100_technical_debt_monitoring_release_policy/))
...
📢 **섹션 요약 비유**: MLOps는 항공기 정비 시스템이다. 비행기(ML 모델)는 한 번 만들어 출고하면 끝이 아니라, 지속적 점검(모니터링), 부품 교체(재훈련), 새로운 유형의 모델로의 점진적 전환([카나리 배포](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/115_canary_deployment_gradual_rollout/))이 필수적이다. 정비 없는 항공기는 언젠가 추락한다.

---

## Ⅴ. 기대효과 및 결론

### 5.1 [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/) 도입 효과

| 지표 | [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/) 전 | [MLOps](/knowledge-base/studynote/12_it_management/05_security_compliance/348_mlops/) 후 |
|:---|:---|:---|
...
| 인프라 | [피처 스토어](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)([Feature Store](/knowledge-base/studynote/14_data_engineering/04_mlops/165_feature_store_training_serving_consistency/)) | 온·오프라인 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 중앙 관리 |
| 플랫폼 | [MLflow](/knowledge-base/studynote/10_ai/02_dl_architecture_new/180_mlflow/) | 실험 추적·[모델 레지스트리](/knowledge-base/studynote/14_data_engineering/04_mlops/166_model_registry_versioning_mlflow/) |
| 배포 [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) | [카나리 배포](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/115_canary_deployment_gradual_rollout/)([Canary Deployment](/knowledge-base/studynote/04_software_engineering/02_requirements_analysis/115_canary_deployment_gradual_rollout/)) | 소규모 트래픽 점진 확대 |
| 자동화 | [CT](/knowledge-base/studynote/14_data_engineering/04_mlops/162_continuous_training_pipeline_model_retraining/)([Continuous Training](/knowledge-base/studynote/14_data_engineering/04_mlops/162_continuous_training_pipeline_model_retraining/)) | 드리프트 탐지 → 자동 재훈련 |

### 👶 어린이를 위한 3줄 비유 설명
1. MLOps는 AI를 만들고 잊어버리는 것이 아니라, 계속 건강하게 유지하는 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 병원이에요.
...
← **이전**: [253. 강화 학습 (Reinforcement Learning) MDP 정책 가치 Q러닝 DQN](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/253_reinforcement_learning_mdp_policy_value_q_learning_dqn/)
**다음**: [255. XAI (Explainable AI) 설명 가능 AI LIME SHAP 기여도 분할](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/255_xai_lime_shap_explainable_contribution/) →
