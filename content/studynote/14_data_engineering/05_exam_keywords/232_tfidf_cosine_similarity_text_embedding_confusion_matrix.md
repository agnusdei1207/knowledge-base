...
**IDF (Inverse [Document](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/) Frequency, 역문서 빈도)**
```
IDF(t) = log( N / df(t) )
...
**TF-IDF 최종 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/)**
```
