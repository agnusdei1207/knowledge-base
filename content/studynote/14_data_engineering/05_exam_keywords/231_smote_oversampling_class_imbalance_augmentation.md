...
**[생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 공식:**
```
...
1. **비율 [10](/knowledge-base/studynote/02_operating_system/08_storage_and_io_systems/489_raid_10_hybrid/):1 이하**: 단순 클래스 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/)(class_weight='balanced') 조정으로 충분
2. **비율 100:1 이상**: SMOTE + 언더샘플링 조합(SMOTEENN, SMOTETomek) 권장
3. **고차원 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)**: SMOTE 직전 [PCA](/knowledge-base/studynote/08_algorithm_stats/10_linear_algebra/163_pca/)([Principal Component Analysis](/knowledge-base/studynote/08_algorithm_stats/10_linear_algebra/163_pca/)) [차원 축소](/knowledge-base/studynote/14_data_engineering/02_math_mining/081_dimensionality_reduction_pca_principal_component_analysis/) 권장
4. **범주형 [피처](/knowledge-base/studynote/10_ai/03_llm_nlp/247_feature_label_variables/) 혼합**: SMOTENC 또는 인코딩 후 표준 SMOTE 적용
