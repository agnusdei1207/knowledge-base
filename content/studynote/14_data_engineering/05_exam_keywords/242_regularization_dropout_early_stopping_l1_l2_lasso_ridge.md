...
- **특성 선택(Feature [Selection](/knowledge-base/studynote/10_ai/01_ai_basics/022_mcts_four_stages/))** 효과 자동 달성
...
- **[가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) 축소([Weight](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/) Shrinkage)**: 모든 [가중치](/knowledge-base/studynote/10_ai/03_llm_nlp/267_weight_bias_activation/)를 0에 가깝게 (0은 아님)
- **안정성**: 입력 간 상관관계에 강인
...
**[앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/) 효과**: 매 배치마다 다른 부분 네트워크 훈련 → 암묵적 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/)
...
2. **[드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/) 작동 원리**: 훈련 시 비활성화, 추론 시 [스케일링](/knowledge-base/studynote/10_ai/03_llm_nlp/249_scaling_normalization_standardization/)
3. **[조기 종료](/knowledge-base/studynote/10_ai/03_llm_nlp/281_early_stopping/) 기준**: patience, best checkpoint 저장
4. **[Elastic Net](/knowledge-base/studynote/06_ict_convergence/05_data_science/374_elastic_net_regression/)**: L1+L2 혼합 필요성 설명
5. **[배치 정규화](/knowledge-base/studynote/10_ai/03_llm_nlp/282_batch_normalization/)와 [드롭아웃](/knowledge-base/studynote/10_ai/03_llm_nlp/280_dropout/)** 동시 사용 시 주의사항
