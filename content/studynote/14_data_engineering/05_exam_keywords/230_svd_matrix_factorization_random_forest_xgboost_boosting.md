...
**[랜덤 포레스트](/knowledge-base/studynote/06_ict_convergence/05_data_science/353_random_forest/) 추가 무작위성**: 각 분기(Split)마다 전체 특성 중 √d개([분류](/knowledge-base/studynote/16_bigdata/05_analysis/104_classification_analysis/)) 또는 d/3개(회귀)만 후보로 사용 → 트리 간 상관 감소 → [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 더 감소
...
기술사 시험에서 [앙상블](/knowledge-base/studynote/10_ai/03_llm_nlp/257_ensemble_learning/)은 **"[배깅](/knowledge-base/studynote/10_ai/03_llm_nlp/259_bagging_random_forest/)([분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 감소) vs [부스팅](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/127_boosting/)(편향 감소) + [편향-분산 트레이드오프](/knowledge-base/studynote/14_data_engineering/02_math_mining/110_bias_variance_tradeoff/)"** 를 핵심 축으로, SVD는 **"잠재 요인 분해와 추천·[압축](/knowledge-base/studynote/02_operating_system/06_memory_management/347_compaction/) 활용"** 을 중심으로 서술해야 한다.
