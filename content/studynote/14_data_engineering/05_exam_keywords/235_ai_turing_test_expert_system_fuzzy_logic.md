...
**[튜링 테스트](/knowledge-base/studynote/10_ai/01_ai_basics/002_turing_test/)의 한계:**
...
- **현대 [LLM](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/263_llm_large_language_model/)**: GPT-4는 사실상 [튜링 테스트](/knowledge-base/studynote/10_ai/01_ai_basics/002_turing_test/)를 통과하지만 AGI로 보기 어렵다는 논쟁 지속
...
전통 [논리](/knowledge-base/studynote/09_security/04_endpoint_security/369_logic_bomb/)는 "참(1) 또는 거짓(0)"이지만, [퍼지 논리](/knowledge-base/studynote/10_ai/01_ai_basics/012_fuzzy_logic/)([Fuzzy Logic](/knowledge-base/studynote/10_ai/03_llm_nlp/234_fuzzy_logic/), Lotfi Zadeh, 1965)는 **소속 정도(Membership Degree)**를 [0, 1] 연속 값으로 표현한다.
...
**[퍼지 논리](/knowledge-base/studynote/10_ai/01_ai_basics/012_fuzzy_logic/) 연산:**
```
