...
# 05. [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) ([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/), [Data Warehouse](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/208_data_warehouse_schema_on_write_inmon/))

#### 핵심 인사이트 (3줄 요약)
> 1. **본질**: [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) ([Data Warehouse](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/208_data_warehouse_schema_on_write_inmon/))는 기업 내 여러 시스템에 흩어져 있는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 의사결정(BI)을 위해 '주제 지향적, 통합적, 시계열적, 비휘발성'으로 모아놓은 중앙 집중형 [정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/) 저장소이다.
> 2. **가치**: 운영 시스템([OLTP](/knowledge-base/studynote/05_database/06_dw_olap_trends/327_hint_handoff/))과 분석 시스템([OLAP](/knowledge-base/studynote/12_it_management/05_security_compliance/316_olap/))을 물리적으로 분리함으로써, 원장 DB의 [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/) 저하 없이 복잡한 다차원 통계 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)와 전사적 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 마이닝을 가능하게 한다.
> 3. **융합**: [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 수집/정제하는 [ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/) 파이프라인과 부서별 분석용 [데이터 마트](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/)([Data Mart](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/)), 그리고 다차원 큐브(Cube) 및 [시각화](/knowledge-base/studynote/16_bigdata/01_intro/003_bigdata_7v/) 도구(BI)와 결합하여 전사적 분석 아키텍처 생태계를 완성한다.

---

### Ⅰ. 개요 및 필요성 ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) & Necessity)
[데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) ([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/), [Data Warehouse](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/208_data_warehouse_schema_on_write_inmon/))의 개념은 1990년대 빌 인몬(Bill [Inmon](/knowledge-base/studynote/12_it_management/05_security_compliance/953_inmon/))에 의해 정립되었으며, 기업의 전략적 의사결정을 지원하기 위한 분석 전용 인프라다.
과거 기업들은 인사, 재무, 영업 등 각 부서별로 별도의 관계형 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/)([OLTP](/knowledge-base/studynote/05_database/06_dw_olap_trends/327_hint_handoff/))를 운영했다. 경영진이 "지난 5년간 특정 상품의 부서별 판매 추이"를 묻는 복잡한 통계 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)를 운영 DB에 날리자, CPU 자원이 고갈되어 실제 고객의 결제 시스템이 멈추는 대형 장애(병목)가 발생했다. 또한 각 DB마다 '고객'을 뜻하는 코드(형식)가 달라 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 전사적 불일치 현상이 심각했다.
...
[데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 아키텍처는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)가 추출되어 사용자에게 도달하기까지 철저하게 통제된 여러 계층(Layer)을 거친다.
...
| <strong>EDW (Enterprise <a href="/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/">DW</a>)</strong> | 전사 통합 중앙 저장소 | [Inmon](/knowledge-base/studynote/12_it_management/05_security_compliance/953_inmon/) 모델에 따른 [제3정규형](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/)([3NF](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/)) 기반의 비휘발성 이력 누적 저장 | 단일 진실 공급원 (Single Source of Truth) |
| <strong><a href="/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/">데이터 마트</a> (<a href="/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/">Data Mart</a>)</strong> | 부서별(영업, 마케팅 등) 맞춤형 소규모 [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) | [Kimball](/knowledge-base/studynote/12_it_management/05_security_compliance/954_kimball/) 모델에 따른 다차원 [스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/)([Star Schema](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/296_star_schema/)) 요약 테이블 구성 | 분석가의 실제 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) 접근점 및 BI 연동 |
...
[DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 설계의 두 양대 산맥인 빌 인몬([Inmon](/knowledge-base/studynote/12_it_management/05_security_compliance/953_inmon/))의 하향식 모델과 랄프 킴볼([Kimball](/knowledge-base/studynote/12_it_management/05_security_compliance/954_kimball/))의 상향식 모델은 근본적인 철학 차이가 있다.

| 비교 항목 | Bill [Inmon](/knowledge-base/studynote/12_it_management/05_security_compliance/953_inmon/) (하향식, EDW 중심) | Ralph [Kimball](/knowledge-base/studynote/12_it_management/05_security_compliance/954_kimball/) (상향식, [Data Mart](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/) 중심) | 판단 포인트 |
|:---|:---|:---|:---|
| **설계 사상** | [Top-Down](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/402_top_down_integration/) (전사 통합 후 부서 분배) | [Bottom-Up](/knowledge-base/studynote/04_software_engineering/12_testing_maintenance/403_bottom_up_integration/) (부서별 마트부터 짓고 통합) | 프로젝트 예산 및 [초기](/knowledge-base/studynote/03_network/08_transport_layer/459_quic_fec_forward_error_correction/) 구축 시간 |
| **핵심 구조** | 전사 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 기반 3차 [정규화](/knowledge-base/studynote/01_computer_architecture/02_data_representation_arithmetic/093_normalization/)([3NF](/knowledge-base/studynote/05_database/02_modeling_normalization/105_third_normal_form_3nf_transitive/)) 모델 | [다차원 모델링](/knowledge-base/studynote/05_database/06_dw_olap_trends/333_multidimensional_modeling/) ([스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/), 팩트/차원) | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 중복 허용 여부 |
| **장점** | 완벽한 전사 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/), 중복 없음 | 빠른 구축, 비즈니스 분석가 친화적 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/) | 유지보수 안정성 vs 비즈니스 민첩성 |
...
📢 **섹션 요약 비유**: 옛날엔 밀가루를 밖에서 다 반죽([ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/))한 뒤에 좁은 오븐([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/))에 넣었다면, 지금은 마법의 초대형 오븐(클라우드 [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)) 안에 밀가루와 물을 그냥 들이부으면([ELT](/knowledge-base/studynote/14_data_engineering/01_infrastructure/034_elt/)) 안에서 알아서 엄청난 속도로 빵을 구워내는 셈입니다.

### Ⅴ. 기대효과 및 결론 (Future & Standard)
[데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)는 지난 30년간 기업의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 비즈니스 인텔리전스로 변환하는 가장 확고한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 플랫폼 역할을 수행해왔다.

| 관점 | [DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/) 도입의 기술/비즈니스적 효과 | 정량적 지표 |
|:---|:---|:---|
...
* [OLAP](/knowledge-base/studynote/12_it_management/05_security_compliance/316_olap/) ([On-Line Analytical Processing](/knowledge-base/studynote/05_database/06_dw_olap_trends/328_lsm_tree_compaction/)) | 다차원 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 대해 복잡한 분석 [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/)를 고속으로 수행하는 기술
* [ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/) (Extract, Transform, Load) | 다양한 소스에서 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 추출, 정제하여 목표 저장소에 적재하는 파이프라인
* [데이터 마트](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/) ([Data Mart](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/209_data_mart_kimball_star_schema/)) | DW에서 파생되어 특정 부서나 주제(영업, 재무 등)에 맞게 요약된 소규모 분석 [데이터베이스](/knowledge-base/studynote/05_database/01_db_architecture_relational/002_database_definition/)
* [스타 스키마](/knowledge-base/studynote/05_database/06_dw_olap_trends/334_star_schema/) ([Star Schema](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/296_star_schema/)) | 중심의 [팩트 테이블](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/210_fact_dimension_table_snowflake_schema/)과 주변의 [차원 테이블](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/273_dimension_table_analysis_perspective/)들이 별 모양으로 연결된 다차원 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 모델링 기법
* [데이터 레이크하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/210_data_lakehouse_delta_lake/) ([Data Lakehouse](/knowledge-base/studynote/12_it_management/05_security_compliance/210_data_lakehouse_delta_lake/)) | [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)의 유연성과 저비용 특성에 DW의 ACID [트랜잭션](/knowledge-base/studynote/05_database/04_transactions_concurrency/191_transaction_concept_states/)과 SQL [성능](/knowledge-base/studynote/04_software_engineering/05_devops_ci_cd/282_performance_tactics/)을 융합한 최신 아키텍처
...
### 👶 어린이를 위한 3줄 비유 설명
1. [데이터 웨어하우스](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/)는 여러 동네에서 흩어져 들어오는 다양한 블록 장난감을 모아두는 아주 커다란 중앙 창고예요.
2. 이 창고에 넣기 전에 부서진 블록은 빼고 깨끗하게 닦아서([ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/)), 색깔별로 예쁘게 분류해 놓는답니다.
