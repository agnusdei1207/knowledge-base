...
# 01. 빅데이터 3V / 5V (Big [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 3V / 5V)

#### 핵심 인사이트 (3줄 요약)
> 1. **본질**: 빅데이터는 단순한 크기(Volume)의 확장이 아닌, [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 속도(Velocity)와 형태의 다양성(Variety)이 결합되어 기존 관계형 패러다임으로는 처리가 불가능한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 집합을 의미한다.
> 2. **가치**: 불확실성을 내포한 원시 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(Veracity)에서 정제 및 분석을 거쳐 비즈니스적 통찰(Value)을 도출함으로써, 기업의 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 주도적([Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)-Driven) 의사결정을 실현한다.
> 3. **융합**: 이 5가지 특성을 감당하기 위해 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 컴퓨팅([Hadoop](/knowledge-base/studynote/03_network/16_data_center_cloud/843_hadoop_rack_awareness_data_replication_topology/), Spark), 스트리밍 엔진([Kafka](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/)), [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) 등의 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 아키텍처 생태계가 필연적으로 결합된다.

---

### Ⅰ. 개요 및 필요성 ([Context](/knowledge-base/studynote/02_operating_system/01_overview_architecture/033_context/) & Necessity)
빅데이터 (Big [Data](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/))의 3V는 가트너(Gartner)의 더그 레이니(Doug Laney)가 제안한 볼륨(Volume), 속도(Velocity), 다양성(Variety)의 3가지 차원을 의미하며, 이후 IBM 등이 진실성(Veracity)과 가치(Value)를 추가하여 5V 모델로 확장되었다.
전통적인 RDBMS (Relational [Database](/knowledge-base/studynote/05_database/04_transactions_concurrency/501_database/) [Management](/knowledge-base/studynote/12_it_management/05_security_compliance/1013_management/) System) 환경에서는 테라바이트 급의 [정형 데이터](/knowledge-base/studynote/14_data_engineering/01_infrastructure/002_structured_data/)를 일괄 처리(Batch)하는 데 초점을 맞추었으나, 스마트폰과 [IoT](/knowledge-base/studynote/06_ict_convergence/02_iot_mobility/101_iot_concept/) (Internet of Things) 기기의 폭발적인 보급으로 인해 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 성격이 완전히 달라졌다. 실시간으로 쏟아지는 방대한 비정형/반정형 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 수용해야 하는 한계에 직면한 것이다.
...
빅데이터의 5V 특성은 [데이터 파이프라인](/knowledge-base/studynote/01_computer_architecture/15_advanced_topics/645_data_pipeline_acceleration/)의 각 단계에 직접적인 영향을 미치며, 이를 처리하기 위한 특정 기술 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/)을 강제한다.

| 특성 | 설명 | 기술적 과제 | 대응 아키텍처 및 기술 [스택](/knowledge-base/studynote/08_algorithm_stats/04_datastructure/057_stack/) | 비유 |
|:---|:---|:---|:---|:---|
| **Volume** (규모) | 테라바이트, 페타바이트를 넘어선 거대한 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 양 | 단일 디스크의 한계, 스토리지 비용의 기하급수적 증가 | [분산 파일 시스템](/knowledge-base/studynote/02_operating_system/09_file_system/553_distributed_file_system/) ([HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/), S3), [Scale-out](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/202_scale_out_distributed_horizontal_expansion/) 기반 노드 확장 | 무한히 늘어나는 거대한 물류 창고 |
| **Velocity** (속도) | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 [생성](/knowledge-base/studynote/02_operating_system/02_process_thread/087_process_state_transition/) 및 유입, 처리 속도의 실시간성 요구 | 디스크 I/O 병목, 배치 처리의 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)([Latency](/knowledge-base/studynote/01_computer_architecture/03_architecture_basics_performance/141_latency/)) 문제 극복 | 인메모리(In-Memory) 처리(Spark), 스트리밍 플랫폼 ([Kafka](/knowledge-base/studynote/14_data_engineering/04_mlops/179_kafka_flink_watermark_time_window/), Flink) | 쉴 새 없이 돌아가는 컨베이어 벨트 |
| **Variety** (다양성) | 정형(RDB), 반정형([JSON](/knowledge-base/studynote/11_design_supervision/06_exam_summary/343_json/)/XML), 비정형(텍스트/영상) 등 다변화된 형태 | [스키마 온 라이트](/knowledge-base/studynote/14_data_engineering/01_infrastructure/010_schema_on_write/)([Schema-on-Write](/knowledge-base/studynote/14_data_engineering/01_infrastructure/010_schema_on_write/))의 불가능, [ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/) 전처리 오버헤드 | [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)([Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)), [NoSQL](/knowledge-base/studynote/14_data_engineering/01_infrastructure/035_nosql/) ([Document](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/), [Graph](/knowledge-base/studynote/12_it_management/03_ea_isp/888_graph/), Wide-Column) DB | 규격이 제각각인 온갖 재활용품 |
| **Veracity** (진실성) | 원시 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)에 포함된 노이즈, 편향, 결측치 등 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 [신뢰도](/knowledge-base/studynote/14_data_engineering/02_math_mining/085_confidence_association_rule_conditional_probability/) | 가비지 인 가비지 아웃(GIGO) 방지, [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 품질 확보 | [데이터 정제](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/266_data_cleansing/) 파이프라인, [데이터 거버넌스](/knowledge-base/studynote/12_it_management/01_governance_strategy/842_data_governance_framework/) 및 리니지 추적 ([Data Catalog](/knowledge-base/studynote/12_it_management/05_security_compliance/213_data_catalog_metadata/)) | 진흙탕 물을 식수로 바꾸는 정수 필터 |
...
빅데이터 패러다임(3V/5V)은 기존 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)웨어하우스 관점과 설계 철학에서 극명한 차이를 보인다.
...
```
이 흐름도는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 적재 시점의 패러다임 변화를 나타낸다. 전통적 방식은 저장하기 전에 미리 정제([ETL](/knowledge-base/studynote/12_it_management/05_security_compliance/215_etl_vs_elt_pipeline/))해야 하므로 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) 유입 속도(Velocity)를 따라가지 못하고 버려지는 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)(Variety)가 많다. 반면 빅데이터 방식은 일단 [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)에 쏟아붓고([ELT](/knowledge-base/studynote/14_data_engineering/01_infrastructure/034_elt/)) 필요할 때 컴퓨팅 자원을 동원해 해석하므로 5V를 모두 충족할 수 있다. 하지만 읽기 시점의 연산 비용이 크다는 트레이드오프가 존재한다.

📢 **섹션 요약 비유**: 기존 방식이 잘 정돈된 도서관([DW](/knowledge-base/studynote/12_it_management/05_security_compliance/209_data_warehouse_schema_on_write/))이라면, 5V 빅데이터 방식은 일단 모든 물건을 때려 넣은 창고([Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/))에서 강력한 [AI](/knowledge-base/studynote/04_software_engineering/03_design_architecture/190_ai_llm_requirements_specification/) 검색기([분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) [쿼리](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/298_qkv_attention/))로 필요한 것을 그때그때 찾아내는 것과 같습니다.

### Ⅳ. 실무 적용 및 기술사적 판단 ([Strategy](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/) & Decision)
실무에서 5V를 맹목적으로 추종하면 '[데이터 늪](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/288_data_swamp_metadata_management_absence/)([Data Swamp](/knowledge-base/studynote/07_enterprise_systems/05_data_bi/288_data_swamp_metadata_management_absence/))'에 빠질 수 있으므로, 비즈니스 목적에 맞는 선택적 취사가 필요하다.

1. **Volume의 함정 (비용 통제 실패)**: 모든 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)를 [Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)(S3, [HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/))에 무기한 저장하면 스토리지 비용이 선형적으로 증가한다.
...
빅데이터 5V 특성은 단일 저장소의 한계를 깨고 [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/923_cloud_native_architecture/) 기반의 스토리지-컴퓨팅 분리 아키텍처를 탄생시켰다.
...
* [하둡](/knowledge-base/studynote/03_network/16_data_center_cloud/843_hadoop_rack_awareness_data_replication_topology/) 생태계 ([Hadoop Ecosystem](/knowledge-base/studynote/13_cloud_architecture/04_devops_observability/211_hadoop_ecosystem_mapreduce/)) | 대용량 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/) [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 저장([HDFS](/knowledge-base/studynote/14_data_engineering/01_infrastructure/013_hdfs/)) 및 [맵리듀스](/knowledge-base/studynote/14_data_engineering/01_infrastructure/018_mapreduce/) 연산 생태계
* [데이터 레이크](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/) ([Data Lake](/knowledge-base/studynote/12_it_management/05_security_compliance/208_data_lake_schema_on_read/)) | 5V 특성을 모두 수용하는 원시 [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 무제한 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 저장소
* 스parks ([Apache Spark](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/206_spark_inmemory_rdd_lazy_evaluation_lineage/)) | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 Velocity와 연산 병목을 인메모리 기반으로 해결하는 엔진
* [데이터 거버넌스](/knowledge-base/studynote/12_it_management/01_governance_strategy/842_data_governance_framework/) ([Data Governance](/knowledge-base/studynote/12_it_management/01_governance_strategy/842_data_governance_framework/)) | [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)의 진실성(Veracity)과 품질을 통제하는 관리 체계
* [다크 데이터](/knowledge-base/studynote/12_it_management/02_itsm_itil/062_darkdata/) ([Dark Data](/knowledge-base/studynote/12_it_management/02_itsm_itil/062_darkdata/)) | 저장되었으나 Value로 연결되지 못하고 방치된 Variety [데이터](/knowledge-base/studynote/05_database/01_db_architecture_relational/001_dikw_pyramid/)
