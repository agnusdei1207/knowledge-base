...
- **Separation of Compute and Storage** | 컴퓨팅 엔진과 저장 스토리지를 물리적으로 분리하여 각각 독립적으로 탄력적 스케일링을 가능하게 하는 [클라우드 네이티브](/knowledge-base/studynote/04_software_engineering/11_testing_validation/923_cloud_native_architecture/)의 핵심 사상.
