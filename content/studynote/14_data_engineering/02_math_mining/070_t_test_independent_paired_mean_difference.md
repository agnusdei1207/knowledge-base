...
> 3. **판단**: 정규성, [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/), 표본 구조를 먼저 확인해야 한다.
...
t-검정은 표본평균과 [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/)을 이용해 차이가 우연인지 계산한다. 표본 구조에 따라 적절한 종류를 골라야 한다.
...
| :-- | :-- |
| Normality | 정규성 |
| [Variance](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) | [분산](/knowledge-base/studynote/08_algorithm_stats/08_stats/136_variance/) 고려 |
...
- 무조건 t-검정부터 하는 설계
- 대응표본을 독립표본으로 보는 설계
- 가정 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/) 없이 결론내는 설계
...
결론적으로 t-검정은 평균 차이를 통계적으로 [검증](/knowledge-base/studynote/04_software_engineering/07_object_oriented/395_verification_process_review/)하는 방법이다.
