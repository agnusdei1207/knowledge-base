...
📢 **섹션 요약 비유**: [협업 필터링](/knowledge-base/studynote/06_ict_convergence/05_data_science/345_collaborative_filtering/)은 마치 영화 추천에서 "당신과 같은 영화를 좋아한 사람들이 이 영화도 좋아했어요"라는 구전() 방식이다. 처음 온 손님(신규 사용자)에게는 구전 정보가 없으니 추천이 어렵다.
