...
데이터 카탈로그와 계보는 현대 데이터 거버넌스의 핵심 인프라이며, GDPR/CCPA 규정 준수와 데이터 신뢰성 확보를 위한 필수 요소다. 기술사 관점에서는 <strong>OpenLineage 표준 기반 자동 계보 수집, 태그 기반 ABAC 보안 정책, GDPR 삭제권 이행과 계보의 연계 방법</strong>을 명확히 설명할 수 있어야 한다.
