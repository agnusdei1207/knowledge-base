...
프롬프트는 더 이상 코드 안의 긴 문자열이 아니다. 템플릿 변수, 시스템 지시, 출력 [스키마](/knowledge-base/studynote/05_database/01_db_architecture_relational/005_schema/), 안전 제약, 대상 모델 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/)이 함께 묶인 배포 단위다. 그래서 운영 관점에서는 템플릿 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/), 실험군 비율, 승인 상태, 연결된 평가셋을 같이 관리해야 한다. 좋은 프롬프트 [레지스트리](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/)는 "v1.3이 v1.2보다 어떤 질문군에서 더 나았는가"를 추적할 수 있어야 한다.
...
| [Embedding](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/) version | [임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/) 모델 변경 감지 | 벡터 공간 혼합으로 검색 품질 저하 |
| [Tombstone](/knowledge-base/studynote/05_database/05_distributed_nosql_newsql/300_schema_on_write_vs_read/) | 삭제 문서 전파 | 퇴역 문서가 계속 검색됨 |
| [Metadata](/knowledge-base/studynote/05_database/01_db_architecture_relational/012_metadata/) [ACL](/knowledge-base/studynote/02_operating_system/09_file_system/549_acl_access_control_list/) | 권한 기반 검색 | 민감 문서가 잘못 노출됨 |
...
LLMOps에서 가장 흔한 오판은 Prompt, [RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/), PEFT의 역할 경계를 흐리는 것이다. 프롬프트 템플릿은 지시 방식과 출력 형식을 바꾸는 데 강하고, RAG는 최신 정보와 기업 내부 지식을 붙이는 데 강하며, PEFT는 특정 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 문체·추론 습관·응답 경향을 안정적으로 학습시키는 데 강하다.

| 변화 요구 | 우선 수단 | 이유 |
| :--- | :--- | :--- |
| 답변 형식, 톤, 시스템 규칙 변경 | Prompt Template | 즉시 변경 가능, [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/) 쉬움 |
| 문서 최신화, 사내 지식 반영 | [RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/) Sync | 재학습 없이 지식 반영 가능 |
| 특정 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 스타일 고착화 | [PEFT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/306_peft_lora/) | 반복적 행동 변화를 모델에 내재화 |
| 셋이 동시에 필요 | Prompt + [RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/) + [PEFT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/306_peft_lora/) 조합 | 계층별 역할 분리 필요 |

벡터 DB [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/) [전략](/knowledge-base/studynote/04_software_engineering/04_testing_quality/268_strategy_pattern/)도 비교가 필요하다. 전체 재색인(Full Rebuild)은 단순하지만 큰 저장소에서 비싸고 느리다. 증분 업서트(Incremental Upsert)는 효율적이지만 삭제·권한 변경 누락에 취약하다. [Change Data Capture](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/217_cdc_binlog_change_capture_debezium/) ([CDC](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/217_cdc_binlog_change_capture_debezium/)) 기반 이벤트 [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/)는 가장 운영 친화적이지만 소스 시스템과 인덱싱 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/)라인의 계약이 명확해야 한다.

| [동기화](/knowledge-base/studynote/02_operating_system/03_cpu_scheduling/212_synchronization_mechanisms/) 방식 | 장점 | 약점 | 적합 상황 |
| :--- | :--- | :--- | :--- |
| Full Rebuild | [일관성](/knowledge-base/studynote/05_database/04_transactions_concurrency/194_consistency_database_integrity/) 확보가 쉬움 | 비용 큼, [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/) 큼 | 작은 코퍼스, 야간 재빌드 |
| Incremental Upsert | 빠르고 저렴함 | 삭제·권한 변경 추적 필요 | 중간 규모 [문서 저장소](/knowledge-base/studynote/14_data_engineering/01_infrastructure/037_document/) |
| [CDC](/knowledge-base/studynote/14_data_engineering/05_exam_keywords/217_cdc_binlog_change_capture_debezium/)/Event-driven | 거의 실시간 반영 | 운영 복잡도 높음 | 자주 바뀌는 엔터프라이즈 지식 |
...
[LLMOps](/knowledge-base/studynote/12_it_management/05_security_compliance/221_llmops_large_language_model_ops/) 체계가 자리 잡으면 지식 업데이트 주기는 짧아지고, 프롬프트 실험은 안전해지며, [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 특화 [어댑터](/knowledge-base/studynote/04_software_engineering/04_testing_quality/259_adapter_pattern_interface_wrapper/) 운영도 반복 가능해진다. 그 결과 모델 하나를 거대한 블랙박스로 다루는 대신, 바뀌기 쉬운 요소와 바뀌기 무거운 요소를 분리해 운영할 수 있다. 이는 비용 절감뿐 아니라 장애 분석과 품질 개선 속도까지 높인다.
...
| 개념 | 연결 포인트 |
| :--- | :--- |
| Prompt Template [Registry](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) | 프롬프트 [버전](/knowledge-base/studynote/03_network/06_network_layer_ip/288_version_ihl_tos_total_length/), 실험, [롤백](/knowledge-base/studynote/15_devops_sre/02_cicd_gitops/098_rollback_strategy_pipeline_error_threshold/)을 관리하는 제어면 |
| [RAG](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/276_fine_tuning/) [Pipeline](/knowledge-base/studynote/12_it_management/02_itsm_itil/082_pipeline/) | 외부 지식을 검색해 컨텍스트로 주입하는 온라인 경로 |
| [Vector DB](/knowledge-base/studynote/14_data_engineering/03_ml_dl_llm/151_vector_database_embedding_ann_search/) Sync | 문서 변경을 [임베딩](/knowledge-base/studynote/06_ict_convergence/04_ai_llm/278_instruction_tuning/) [인덱스](/knowledge-base/studynote/05_database/03_relational_model/154_database_index_b_tree_search_optimization/)에 반영하는 운영 [파이프](/knowledge-base/studynote/02_operating_system/02_process_thread/123_pipe/) |
| [PEFT](/knowledge-base/studynote/10_ai/04_ai_ops_ethics/306_peft_lora/) / [LoRA](/knowledge-base/studynote/03_network/12_iot_wpan_edge/617_lora_lorawan_css_chirp_spread_spectrum/) | 베이스 모델을 바꾸지 않고 [도메인](/knowledge-base/studynote/05_database/02_modeling_normalization/064_relation_domain/) 적응을 수행하는 방법 |
| [Adapter](/knowledge-base/studynote/04_software_engineering/04_testing_quality/259_adapter_pattern_interface_wrapper/) [Registry](/knowledge-base/studynote/15_devops_sre/05_devsecops/235_registry_immutable_tag/) | 여러 경량 [어댑터](/knowledge-base/studynote/04_software_engineering/04_testing_quality/259_adapter_pattern_interface_wrapper/)의 배포·승격·폐기를 추적하는 저장소 |
| Faithfulness | 응답이 검색 문맥에 얼마나 충실한지 보는 핵심 품질 지표 |
| TTFT | 사용자 체감 [지연](/knowledge-base/studynote/03_network/01_data_communication/015_지연_데이터_관점/)을 나타내는 대표 운영 [메트릭](/knowledge-base/studynote/03_network/07_network_layer_routing/342_routing_metric_hop_bandwidth_delay/) |
...
<- **이전**: [173. Tensor Core·HBM 기반 혼합 정밀도 학습 (Mixed Precision Training)](/knowledge-base/studynote/14_data_engineering/04_mlops/173_tensor_core_hbm_mixed_precision_training/)
**다음**: [175. Reinforcement Learning from Human Feedback (RLHF) 기반 랭킹 선호 모델과 인간 라벨러](/knowledge-base/studynote/14_data_engineering/04_mlops/175_rlhf_ranking_reward_model_human_labeler/) ->
