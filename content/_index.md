...
*   **주요 문서:** `[사업기획](/knowledge-base/work/business/)`, `[프로젝트현황](/knowledge-base/work/projects/)`, `[기술개발](/knowledge-base/work/development/)`, `[운영관리](/knowledge-base/work/operations/)`, `[영업자료](/knowledge-base/work/sales/)`.
*   **시스템 관리:** `[AI Ops](/knowledge-base/work/claude-code-mcp/)`, `[검색 파이프라인](/knowledge-base/work/knowledge-pipeline/)`, `[CMS 가이드](/knowledge-base/work/decap-cms/)`.

### **Personal (개인 서재 & 로그)**
*   **목적:** 지극히 개인적인 일상, 성장 기록, 취미, 재정 계획을 관리하는 안식처.
*   **주요 문서:** `[데일리저널](/knowledge-base/personal/journal/)`, `[인생목표](/knowledge-base/personal/life-goals/)`, `[자산플래너](/knowledge-base/personal/finances/)`, `[취미&독서](/knowledge-base/personal/hobby/)`.
...
정기적으로 이 공간을 비우며 적절한 카테고리(Work, Personal, StudyNote, R&D)로 이동시키면 지식베이스의 신선함이 유지됩니다.
