...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **개요** | 웹 애플리케이션에서 가장 중요한 보안 위험 10개를 정리한 OWASP의 인식·교육 기준 | "핵심 기술 요소" |
| **왜 필요한가** | 웹 보안은 취약점 종류가 많아 우선순위가 흐려지기 쉽다 | "핵심 기술 요소" |
| **핵심 직관** | 병원 응급실의 중증도 분류처럼 모든 약점을 같은 무게로 보지 않고 자주 발생하고 피해가 큰 위험군부터 관리하는 목록이다 | "핵심 기술 요소" |
| **배경·문제의식** | 개발팀은 SQL Injection, XSS 같은 공격명을 외워도 실제 설계에서는 인증, 권한, 로깅, 공급망 통제를 놓친다 | "데이터 질의 언어" |
| **비유** | 자동차 정비에서 엔진, 브레이크, 타이어, 전자장치, 사고기록을 우선 점검하는 표준 체크리스트와 같다 | "핵심 기술 요소" |
| **흔한 오해·주의점** | OWASP Top 10은 상세 보안 요구사항 전체가 아니다 | "핵심 기술 요소" |
| **본질** | OWASP Top 10은 웹 애플리케이션의 주요 보안 위험군을 우선순위화한 표준 인식 문서임 | "핵심 기술 요소" |
