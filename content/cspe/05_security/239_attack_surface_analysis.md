...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **핵심 직관** | **"보안팀의 자산대장 vs 해커의 구글링 결과"** | "핵심 기술 요소" |
| **배경** | 과거의 취약점 진단(CVE 스캐닝)은 "내가 아는 자산"만 점검했습니다 | "핵심 기술 요소" |
...
| **Shadow IT (섀도우 아이티)** | 현업 부서나 개발자가 IT/보안팀 몰래 퍼블릭 클라우드(AWS, SaaS)를 개통하여 사용하는 현상 (주요 공격 표면) | "소프트웨어 구독" |
| **OSINT (Open-Source Intelligence)** | 구글링, 깃허브 검색, Shodan 등 공개된 출처에서 위협 정보를 수집하는 기술 (EASM의 핵심 기술) | "건물 관리실" |
