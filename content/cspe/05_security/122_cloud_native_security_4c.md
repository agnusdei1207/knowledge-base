...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 클라우드와 컨테이너를 처음 도입하는 회사들은 혼란에 빠졌습니다 | "이 개념의 핵심" |
| **핵심 직관** | **"마트료시카(러시아 인형) 성벽 방어 체계"** | "이 개념의 핵심" |
| **등장 배경** | 과거에는 웹 서버 $\rightarrow$ WAS $\rightarrow$ DB라는 단순한 3계층 물리 방어선이 다였습니다 | "이 개념의 핵심" |
| **가치** | "보안 사각지대 제로화 가이드" | "이 개념의 핵심" |
| **4C 방어의 승리** | 위 사태를 막으려면 4개 중 딱 1개의 성벽만 제대로 작동해도 됩니다 | "이 개념의 핵심" |
| **주의점 및 흔한 오해** | - "이 4가지를 한 팀이 다 막나요?" $\rightarrow$ 아닙니다 | "이 개념의 핵심" |
