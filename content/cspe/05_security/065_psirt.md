...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **개요** | 제품 취약점 접수부터 공개 권고까지 책임지는 제품 보안 대응 조직 | "핵심 기술 요소" |
| **왜 필요한가** | 제품 취약점은 고객 시스템, 공급망, 규제 보고, 브랜드 신뢰에 영향을 준다 | "핵심 기술 요소" |
| **핵심 직관** | 제품에서 결함이 발견되면 고객센터가 아니라 전문 사고 지휘소가 원인 분석, 수리 일정, 고객 공지를 조율하는 구조임 | "핵심 기술 요소" |
| **배경·문제의식** | 보안 연구자, 고객, 내부 테스트, bug bounty에서 취약점이 제보되면 개발팀만으로는 재현, 심각도, 공개 일정, 법무 검토를 동시에... | "핵심 기술 요소" |
| **비유** | 자동차 리콜 조직과 같다 | "핵심 기술 요소" |
| **흔한 오해·주의점** | PSIRT는 SOC나 CSIRT와 다르다 | "보안 운영 팀" |
