...
- 개요: 단말 행위 탐지·대응
- 배경: 랜섬웨어, 무파일 공격, 정상 관리 도구 악용 공격은 파일 서명 중심 통제에서 정상 프로세스 실행처럼 보일 수 있음.
- 필요성: EDR은 agent coverage 95%, MTTD 10분, containment 5분 기준으로 프로세스 트리·행위 타임라인·IOC sweep을 운영해야 함.
