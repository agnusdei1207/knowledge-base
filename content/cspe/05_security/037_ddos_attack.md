...
- 개요: 분산 서비스 거부 공격
- 배경: 봇넷과 반사 증폭은 회선, TCP 세션, CPU, DB 연결을 소진시켜 침해 없이도 서비스 접속 실패를 유발함.
- 필요성: 전자상거래·금융·공공 서비스는 ISP scrubbing, CDN/WAF, rate limit을 사전 구성하고 RTO 30분 기준으로 우회·복구를 검증해야 함.
