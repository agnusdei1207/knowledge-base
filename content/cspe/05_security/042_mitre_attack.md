...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 보안 알람이 울리면 "악성코드 감염!"이라고만 뜹니다 | "이 개념의 핵심" |
| **핵심 직관** | **"축구 상대 팀 전술 분석 보드"** | "이 개념의 핵심" |
| **등장 배경** | 기존의 사이버 킬체인(Cyber Kill Chain)은 "1 | "학습하는 기계" |
| **가치** | 글로벌 보안 업계의 **통일된 언어(공용어)** 가 되었습니다 | "이 개념의 핵심" |
| **전술 (Tactics - "WHY")** | 세로 열(Column) 14개 | "이 개념의 핵심" |
| **기법 (Techniques - "HOW")** | 가로 행(Row) 수백 개 | "이 개념의 핵심" |
| **위협 헌팅 (Threat Hunting)** | EDR 로그에 알 수 없는 PowerShell 실행 기록이 뜹니다 | "이 개념의 핵심" |
