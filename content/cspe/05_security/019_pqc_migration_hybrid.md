...
PQC 전환은 암호체계 교체 프로그램이다.
RSA/ECC 기반 키 교환·서명은 대규모 양자컴퓨터에 취약하고, 장기 보관 데이터는 HNDL 위험을 가진다.
전환은 NIST FIPS 203/204/205, CNSA 2.0, 하이브리드 프로토콜, crypto agility를 기준으로 단계 수행함.
