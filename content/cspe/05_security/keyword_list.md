...
컴퓨터시스템응용기술사 시험 출제동향 기반으로 엄선한 시스템 보안 핵심 키워드입니다.

---

## 1. 암호학 (Cryptography) (30개)
1. 대칭 암호화 — AES·DES·3DES (Symmetric Encryption) [출제:122회]
2. 비대칭 암호화 — RSA·ECC (Asymmetric Encryption) [출제:122회]
3. 하이브리드 암호 (Hybrid Cryptography) [출제:122회]
4. 해시 알고리즘 — SHA-256·SHA-3 (Hash Algorithm) [출제:121회]
5. HMAC 메시지 인증 코드 (HMAC) [출제:121회]
6. 디피-헬만 키 교환 (Diffie-Hellman Key Exchange) [출제:128회]
7. 타원 곡선 암호 ECC (Elliptic Curve Cryptography)
8. 전자 서명 (Digital Signature)
9. PKI 공개키 기반구조 (Public Key Infrastructure) [출제:120,138회]
10. X.509 인증서 (X.509 Certificate) [출제:120회]
11. CA 인증 기관·인증서 발급 절차 (Certificate Authority) [출제:120회]
12. CRL·OCSP 인증서 폐지 (CRL OCSP Certificate Revocation) [출제:120회]
13. TLS·SSL 프로토콜 (TLS SSL Protocol)
14. TLS 1.3 핸드셰이크 (TLS 1.3 Handshake) [전망]
15. 양자내성암호 PQC (Post-Quantum Cryptography) [출제:126,129,135,136회]
16. ML-KEM CRYSTALS-Kyber (ML-KEM CRYSTALS-Kyber) [출제:136회]
17. ML-DSA CRYSTALS-Dilithium (ML-DSA CRYSTALS-Dilithium) [출제:136회]
18. SLH-DSA 해시 기반 서명 (SLH-DSA Hash-Based Signature) [전망]
19. PQC 전환 로드맵·하이브리드 방식 (PQC Migration Hybrid) [출제:133회]
20. QKD 양자 키 분배 (Quantum Key Distribution) [출제:126회]
21. 동형 암호 (Homomorphic Encryption) [출제:132,135회]
22. 영지식 증명 ZKP (Zero-Knowledge Proof) [출제:132회]
23. 안전한 다자간 연산 MPC (Secure Multi-Party Computation) [출제:135회]
24. 차등 프라이버시 (Differential Privacy) [출제:134,135회]
25. 신뢰 실행 환경 TEE (Trusted Execution Environment) [전망]
26. 기밀 컴퓨팅 (Confidential Computing) [전망]
27. 랜덤 오라클 모델 (Random Oracle Model)
28. 스트림 암호 — ChaCha20 (Stream Cipher ChaCha20)
29. 블록 암호 운영 모드 — CBC·CTR·GCM (Block Cipher Modes)
30. 키 관리 — HSM·KMS (Key Management HSM KMS)

## 2. 네트워크·시스템 보안 (Network/System Security) (38개)
31. 방화벽 — 패킷 필터·상태기반·NGFW (Firewall) [출제:129,137회]
32. 차세대 방화벽 NGFW vs WAF vs CASB 비교 (NGFW WAF CASB Comparison) [출제:137회]
33. IDS·IPS 탐지 vs 차단 (IDS IPS) [출제:129,134회]
34. 침입 탐지 — 서명 기반·이상 탐지 (Intrusion Detection)
35. 허니팟·허니넷 (Honeypot Honeynet)
36. 네트워크 스푸핑 — ARP·IP·DNS (Network Spoofing) [출제:128,134회]
37. DDoS 공격·대응 — SYN Flood·반사 증폭 (DDoS Attack) [출제:125회]
38. 맬웨어 유형 — 바이러스·웜·트로이·랜섬웨어 (Malware Types) [출제:121회]
39. 랜섬웨어 공격 분석·대응 (Ransomware) [출제:121회]
40. APT 고급 지속 위협 (Advanced Persistent Threat) [출제:128,134회]
41. 사이버 킬체인 (Cyber Kill Chain) [출제:130,137회]
42. MITRE ATT&CK 프레임워크 (MITRE ATT&CK) [출제:124,130,137회]
43. 위협 헌팅 (Threat Hunting) [출제:138회]
44. 사이버 위협 인텔리전스 CTI (Cyber Threat Intelligence) [출제:123,138회]
45. STIX·TAXII 위협 공유 (STIX TAXII) [출제:123,138회]
46. MISP 위협 공유 플랫폼 (MISP) [출제:138회]
47. SOC 보안 운영 센터 (Security Operations Center) [출제:128,129회]
48. SIEM — 보안 이벤트 집계·분석 (SIEM) [출제:128,129,138회]
49. SOAR — 보안 자동화·대응 (SOAR) [출제:127,138회]
50. SIEM vs SOAR 비교 (SIEM vs SOAR) [출제:138회]
51. UEBA 사용자·엔티티 행동 분석 (UEBA) [출제:138회]
52. NDR 네트워크 탐지·대응 (NDR Network Detection Response) [전망]
53. XDR 확장 탐지·대응 (XDR Extended Detection Response) [전망]
54. EDR 엔드포인트 탐지·대응 (EDR Endpoint Detection Response) [출제:121회]
55. 보안 정보 관리 SIM vs SEM (SIM SEM) [전망]
56. CTEM 지속적 위협 노출 관리 (CTEM Continuous Threat Exposure Management) [출제:136,137회]
57. 취약점 스캔 — Nessus·OpenVAS (Vulnerability Scanner)
58. 침투 테스트 방법론 (Penetration Testing Methodology)
59. 버그 바운티 (Bug Bounty) [전망]
60. 레드팀·블루팀·퍼플팀 (Red Blue Purple Team) [출제:124회]
61. 제로데이 취약점·대응 체계 (Zero-Day Vulnerability) [출제:134,136회]
62. CVE·CVSS 취약점 채점 (CVE CVSS) [출제:127,130회]
63. NVD 국가 취약점 DB (NVD National Vulnerability Database) [출제:130회]
64. 패치 관리·가상 패치 (Patch Management Virtual Patching) [출제:136회]
65. PSIRT 제품 보안 대응 팀 (PSIRT) [출제:136회]
66. 보안 구성 관리 (Security Configuration Management)
67. 최소 권한 원칙 (Principle of Least Privilege)
68. 심층 방어 전략 (Defense in Depth)

## 3. 웹·애플리케이션 보안 (Web/App Security) (23개)
69. OWASP Top 10 (OWASP Top 10) [출제:120,129회]
70. SQL 인젝션 (SQL Injection) [출제:120,123회]
71. XSS 크로스사이트 스크립팅 (XSS) [출제:120회]
72. CSRF 크로스사이트 요청 위조 (CSRF) [출제:131회]
73. XXE 외부 엔티티 인젝션 (XXE External Entity Injection)
74. SSRF 서버측 요청 위조 (SSRF Server-Side Request Forgery) [전망]
75. 인증·권한 결함 (Broken Authentication Authorization)
76. 민감 데이터 노출 (Sensitive Data Exposure)
77. 보안 오설정 (Security Misconfiguration)
78. 취약한 의존성 컴포넌트 (Vulnerable Components)
79. 로깅·모니터링 불충분 (Insufficient Logging Monitoring)
80. 스택 오버플로우 공격 (Stack Overflow Attack) [출제:136회]
81. 버퍼 오버플로우 — 카나리·DEP·ASLR (Buffer Overflow Canary DEP ASLR) [출제:125,136회]
82. 쉘코드·ROP 공격 (Shellcode ROP) [출제:125회]
83. 포맷 스트링 공격 (Format String Attack)
84. Use-after-free 취약점 (Use-After-Free)
85. 시큐어 코딩 가이드 (Secure Coding Guide) [출제:126회]
86. 입력값 검증·파라미터 바인딩 (Input Validation Parameter Binding) [출제:123회]
87. 보안 API 설계 — JWT·OAuth·mTLS (Secure API Design) [출제:123회]
88. 콘텐츠 보안 정책 CSP (Content Security Policy) [전망]
89. 서브리소스 무결성 SRI (Subresource Integrity) [전망]
90. 웹 서비스 보안 — SAML·WS-Security (Web Service Security)
91. API 보안 게이트웨이 (API Security Gateway) [전망]

## 4. 인증·접근 제어 (Authentication & Access Control) (23개)
92. 인증 방식 — 지식·소유·생체 (Authentication Factors)
93. MFA 다중 인증 (Multi-Factor Authentication)
94. FIDO2·WebAuthn (FIDO2 WebAuthn) [출제:138회]
95. 패스키 비밀번호 없는 인증 (Passkey Passwordless) [출제:138회]
96. OAuth 2.0·OIDC (OAuth 2.0 OIDC) [출제:123회]
97. SAML 2.0 (SAML 2.0) [출제:123회]
98. SSO 단일 로그인 (Single Sign-On SSO)
99. RBAC 역할 기반 접근 제어 (Role-Based Access Control) [출제:122회]
...
## 5. 클라우드·컨테이너 보안 (Cloud/Container Security) (19개)
...
## 7. 개인정보·프라이버시 보호 (Privacy Protection) (13개)
...
## 8. 보안 관리·거버넌스 (Security Management) (22개)
...
## 9. 보안 운영·신기술 (Security Operations) (12개)
...
## 10. 임베디드·하드웨어 보안 (Embedded/HW Security) (16개)
