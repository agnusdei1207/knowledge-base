...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 쿠버네티스 서버가 인터넷(도커 허브)에서 'nginx'라는 컨테이너 이미지를 다운받아 실행하려고 합니다 | "이 개념의 핵심" |
| **핵심 직관** | **"관공서의 인감 증명서와 투명한 기록 장부"** | "이 개념의 핵심" |
| **Sigstore (Cosign)** | 클라우드 시대의 '무료 온라인 주민센터' | "이 개념의 핵심" |
| **등장 배경** | 소프트웨어 공급망 보안(SLSA 프레임워크 등)의 핵심은 "서명(Signing)"입니다 | "이 개념의 핵심" |
| **가치** | "Keyless(키 없는) 서명의 혁신" | "이 개념의 핵심" |
| **구체적 사례** | - 쿠버네티스(Kubernetes) 1 | "이 개념의 핵심" |
| **주의점 및 흔한 오해** | - "파일에 서명만 하면 바이러스가 없는 건가요?" $\rightarrow$ 아닙니다 | "이 개념의 핵심" |
