...
| **핵심 직관** | 위험한 실험은 실험실에서 하고, 실험실 밖 문은 잠그는 구조임 | "핵심 기술 요소" |
| **배경·문제의식** | LLM은 명령 의도를 완전하게 판별하지 못한다 | "핵심 기술 요소" |
| **작동 원리** | 샌드박스는 프로세스, 파일시스템, 네트워크, 시스템 호출, 자원 사용량을 제한한다 | "핵심 기술 요소" |
| **비유** | 어린이가 과학 실험을 할 때 책상 위 보호매트, 장갑, 제한된 시약, 감독자를 두는 것과 같다 | "핵심 기술 요소" |
| **흔한 오해·주의점** | 컨테이너 하나만으로 충분하다고 보면 안 된다 | "핵심 기술 요소" |
