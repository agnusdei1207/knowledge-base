...
- 개요: 공격 가능 노출 관리 체계
- 배경: 클라우드, SaaS, API, 원격접속이 늘어나면 자산 목록과 CVE 목록만으로 실제 침투 경로와 조치 우선순위를 판단하기 어려움.
- 필요성: CTEM은 scope, discover, prioritize, validate, mobilize를 반복하고 critical 7일 SLA, retest pass 95% 기준으로 노출을 재검증해야 함.
