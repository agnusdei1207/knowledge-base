...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 직원이 노트북을 카페에서 도둑맞았습니다 | "핵심 기술 요소" |
| **핵심 직관** | **"노트북과 일심동체가 된 지문 인식 금고"** | "핵심 기술 요소" |
| **TPM (하드웨어 암호화 칩)** | 열쇠(암호 키)는 메인보드에 땜질된 TPM 칩 안에 박혀 있음 | "핵심 기술 요소" |
| **등장 배경** | 과거에는 이런 하드웨어 칩이 기업용 비싼 서버(HSM)에만 있었습니다 | "핵심 기술 요소" |
| **가치** | "모든 PC의 평등한(Default) 하드웨어 보안" | "핵심 기술 요소" |
| **구체적 사례 (Windows Hello 지문/안면 인식)** | - 내 얼굴이나 지문으로 윈도우 11 잠금을 풉니다(Windows Hello) | "핵심 기술 요소" |
| **주의점 및 흔한 오해** | - "TPM과 208번에서 배운 HSM은 똑같은 건가요?" $\rightarrow$ **원리는 같지만 체급(용도)이 다릅니다 | "핵심 기술 요소" |
