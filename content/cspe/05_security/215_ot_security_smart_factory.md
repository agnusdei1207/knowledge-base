...
- 개요: 생산 제어망 가용성·안전 보호 체계
- 배경: IT와 OT가 MES, IIoT, 원격정비로 연결되면서 랜섬웨어와 계정 탈취가 PLC 제어값, 품질 lot, 생산계획에 영향을 줌
- 필요성: 생산중단 1시간이 수천만 원 손실로 이어질 수 있어 IEC 62443 zone/conduit, OT DMZ, patch window 기준으로 제어망을 운영해야 함
