...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **개요** | CVE는 취약점 이름표, CVSS는 취약점 심각도 계산 체계 | "핵심 기술 요소" |
| **왜 필요한가** | 조직은 매일 다수의 취약점 알림을 받는다 | "핵심 기술 요소" |
| **핵심 직관** | CVE는 환자 등록번호이고, CVSS는 증상의 심각도를 표준 항목으로 점수화한 진단표임 | "핵심 기술 요소" |
| **배경·문제의식** | 벤더마다 취약점 명칭이 다르면 동일 이슈를 추적하기 어렵다 | "핵심 기술 요소" |
| **작동 원리** | CVSS 3.1은 Base, Temporal, Environmental로 구성된다 | "핵심 기술 요소" |
| **비유** | 같은 화재라도 건물 종류와 사람 밀집도에 따라 대응 우선순위가 달라진다 | "핵심 기술 요소" |
| **구체 예시** | CVSS 9.8 RCE라도 내부망 개발 서버면 30일 SLA가 가능할 수 있고, CVSS 7 | "서비스 약속" |
