...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 북한 해커가 어제 미국 국방부를 뚫을 때 썼던 신종 악성코드(해시값)가 오늘 아침 뉴스에 떴습니다 | "핵심 기술 요소" |
| **핵심 직관** | **"전 세계 경찰서의 지명수배 전단지 실시간 동기화"** | "핵심 기술 요소" |
| **등장 배경** | 해킹 기술이 발전하며, 어제 쓰던 해커의 IP 주소를 차단해 봐야 해커는 오늘 1만 개의 다른 IP로 공격을 들어옵니다 | "인터넷 주소" |
| **가치** | "사후 약방문에서 선제적 방어(Proactive Defense)로의 진화" | "핵심 기술 요소" |
| **구체적 사례 (Log4j 사태의 CTI 자동 방어)** | - 과거: Log4j 해킹 사태가 터지자, 보안팀은 인터넷 기사를 뒤져가며 "이 IP가 해커 꺼래!"라며 엑셀로 정리하고 방화벽에 수동으로... | "일지 기록" |
| **주의점 및 흔한 오해** | - "이거 하면 백신이나 침입탐지시스템(IPS)은 안 사도 되나요?" $\rightarrow$ **아닙니다 | "인터넷 주소" |
| **판단 포인트** | IT 아키텍트는 "CTI 피드(Feed)를 많이 구독할수록 좋다"는 착각을 경계해야 합니다 | "핵심 기술 요소" |
