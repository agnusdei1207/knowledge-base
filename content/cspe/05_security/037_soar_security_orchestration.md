...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **핵심 직관** | **"보안팀의 자율주행 교향악단 지휘자"** | "핵심 기술 요소" |
| **등장 배경** | SIEM(통합 로그 분석기)이 너무 똑똑해져서 하루에도 수천 개의 해킹 의심 알람을 띄워줬습니다 | "보안 관제 센터" |
| **가치** | 보안 인력 부족 문제를 해결하는 가장 현실적인 답안지 | "핵심 기술 요소" |
| **구체적 사례** | - **새벽 3시 랜섬웨어 감염 시나리오**: 새벽에 직원의 PC가 랜섬웨어에 감염(EDR 알람)됩니다 | "재해 복구" |
