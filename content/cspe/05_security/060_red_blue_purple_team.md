...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 수백억짜리 방화벽과 SIEM을 샀더라도, 막상 진짜 해커가 침투했을 때 관제 직원이 알람을 놓치거나 당황해서 조치를 못 하면 끝입니다 | "이 개념의 핵심" |
| **핵심 직관** | **"군대 대항군 훈련과 훈련 통제관"** | "이 개념의 핵심" |
| **레드팀 (북한군 역할)** | "우리가 진짜 북한 해커(라자루스)라고 빙의해서, 경계망을 피해 부대(회사 서버) 안으로 몰래 잠입해 보자 | "이 개념의 핵심" |
| **블루팀 (아군 방어 부대)** | "CCTV(SIEM) 모니터링 똑바로 해라! 어? 3초소에 수상한 놈이 떴다 | "이 개념의 핵심" |
| **등장 배경** | 과거에는 외부 업체에 돈을 주고 짧게 '모의 해킹(Pentest)'만 받고 끝냈습니다 | "품질 검사" |
| **가치** | "우리 회사가 진짜 해킹당하면 어떻게 될까?"에 대한 가장 현실적인 답을 줍니다 | "이 개념의 핵심" |
| **목표** | 블루팀(관제 요원)의 눈을 피해서(Stealth), 사장님 메일이나 고객 DB 등 최종 목표(Crown Jewels)를 탈취하는 것 | "이 개념의 핵심" |
