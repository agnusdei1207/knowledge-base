...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **채널 용량 — 섀넌 한계** | 채널 용량 — 섀넌 한계 (Shannon Channel Capacity)의 핵심 개념 | "이 주제의 본질" |
...
- 개요: 잡음 채널의 최대 정보율
- 배경: 모든 통신 시스템은 대역폭, 송신 전력, 잡음 조건에 따라 전송 가능한 정보율의 상한을 가진다.
- 필요성: Shannon 식은 변조·코딩·MIMO 설계가 넘을 수 없는 기준선을 제시해 링크 예산과 성능 평가 기준이 된다.
