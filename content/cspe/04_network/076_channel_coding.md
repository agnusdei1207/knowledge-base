...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **채널 코딩 — 해밍·Reed-Solomon·터보** | 채널 코딩 — 해밍·Reed-Solomon·터보 (Channel Coding)의 핵심 개념 | "이 주제의 본질" |
...
- 개요: 오류 정정을 위한 중복 부호화
- 배경: 실제 통신 채널은 잡음과 간섭으로 비트 오류가 발생해 원 데이터와 수신 데이터가 달라질 수 있다.
- 필요성: 채널 코딩은 수신 측 오류 검출·정정으로 BER, 재전송 지연, 대역폭 사용량을 통제한다.
