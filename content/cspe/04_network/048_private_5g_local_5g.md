...
5G 특화망·로컬 5G는 특정 지역에서 전용 5G 기능을 제공하는 사설 이동통신망이다. 스마트팩토리, 항만, 캠퍼스는 이동성·QoS·데이터 경계·현장 지연시간을 통제해야 하므로 local 5GC와 MEC 기반 구조가 필요하다. 답안은 Wi-Fi와 공용망 대비 선택 기준을 포함해야 한다.
