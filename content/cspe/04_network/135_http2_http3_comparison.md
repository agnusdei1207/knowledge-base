...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **HTTP** | HyperText Transfer Protocol. 웹 통신의 기본 프로토콜 | "웹의 공용어" |
| **REST** | 자원 중심 API 설계 스타일. HTTP 메서드로 CRUD | "표준화된 주문 방식" |
| **상태 코드** | 서버 응답 결과를 나타내는 3자리 숫자. 200/404/500 등 | "주문 결과 알림" |
