...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **IP 주소** | 네트워크에서 장치를 식별하는 논리적 주소 | "인터넷 주소" |
| **서브넷 마스크** | IP 주소에서 네트워크/호스트를 구분하는 비트 마스크 | "동/호수 구분선" |
| **CIDR** | Classless Inter-Domain Routing. 접두사 길이로 네트워크 크기 표현 | "유연한 주소 분류" |
