...
FHSS·DSSS는 신호 에너지를 넓은 주파수 대역에 분산하는 확산 스펙트럼 기술이다. 무선 환경의 협대역 간섭, 재밍, 다중 사용자 충돌을 줄이기 위해 송수신자가 공유한 hopping pattern 또는 PN code를 사용한다. 답안은 확산 이득과 동기 제약을 함께 제시해야 한다.
