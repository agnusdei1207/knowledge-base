...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **HDLC 프레임 구조·동작 모드** | HDLC 프레임 구조·동작 모드 (HDLC)의 핵심 개념 | "이 주제의 본질" |
...
- 개요: 비트 지향 링크 제어 프로토콜
- 배경: 물리 회선은 연속 비트열만 전달하므로 송수신 노드는 프레임 경계, 오류검출, 재전송, 흐름제어 규칙이 필요하다.
- 필요성: HDLC는 0x7E flag, FCS, I/S/U 프레임으로 점대점·다중점 회선의 링크 제어 기준을 제공한다.
