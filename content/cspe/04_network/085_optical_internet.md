...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **광 인터넷** | 광 인터넷 (Optical Internet)의 핵심 개념 | "이 주제의 본질" |
...
- 개요: IP와 광 전송망 연동 구조
- 배경: 클라우드, CDN, AI 학습 트래픽은 100G/400G 포트와 Tbps 백본을 요구하고 전기 라우터 hop 증가는 지연과 전력 소모를 키운다.
- 필요성: 광 인터넷은 DWDM 파장, OTN, ROADM, SDN 제어를 결합해 대용량 장거리 인터넷 백본을 구성한다.
