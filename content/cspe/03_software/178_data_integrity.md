...
- 배경: 식별자·참조 관계·속성값 규칙을 위반한 데이터의 저장 방지
| 구분 | 내용 |
|------|------|
...
> 요약: 개체·참조·도메인 제약으로 식별자, 관계, 속성값의 유효성을 검사함
...
4. Commit: 모든 무결성 조건 만족 시 트랜잭션 결과 확정
> 요약: 변경 데이터가 제약 조건을 만족하면 반영하고 위반하면 트랜잭션을 취소함
