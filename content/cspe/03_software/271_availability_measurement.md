...
- 배경: 서비스 중단 허용 시간과 복구 목표를 비즈니스 영향에 맞춰 정량화할 필요
...
> 요약: MTBF와 MTTR로 가용성을 계산하고 이중화·복구 절차가 두 지표에 미치는 영향을 측정함
...
> 요약: 목표 가용성에 따라 SPOF를 식별하고 장애 전환·복구 시간을 시험하여 SLO 충족 여부를 검증함
