...
> 요약: 가용성, 변경 용이성 등 시스템 성공을 좌우하는 핵심 성능 지표들의 집합임
...
## Ⅳ. 문제점
- 원인이 명시된 문제/한계: 품질 속성 간 상충 관계(예: 보안성 강화 시 성능 저하) 미고려 시 설계 실패함

## Ⅴ. 개선방안
- Ⅳ의 문제에 대응하는 방안: 트레이드 오프(Trade-off) 분석 수행 및 의사결정 기록(ADR) 관리함
