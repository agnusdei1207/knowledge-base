...
- **정의/개념**: AUTOSAR는 차량 ECU 소프트웨어를 응용 기능, 런타임, 기본 소프트웨어, 하드웨어 추상화 계층으로 나누고 재사용성·공급사 독립성·안전·보안 요구를 기준으로 표준 인터페이스와 설정 모델로 통합하는 자동차 소프트웨어 플랫폼임
