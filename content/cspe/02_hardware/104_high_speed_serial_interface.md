...
# 고속 직렬 인터페이스 - USB·Thunderbolt (High-Speed Serial Interface)
...
- **정의/개념**: 고속 직렬 인터페이스는 USB·Thunderbolt처럼 차동 lane과 패킷 프로토콜을 이용해 데이터, 전력, 영상, PCIe 트래픽을 외부 케이블로 전송하는 연결 기술임.
