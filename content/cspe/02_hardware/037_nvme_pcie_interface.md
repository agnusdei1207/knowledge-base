...
| NVMe Controller | 명령 해석·DMA·namespace 관리를 수행해 실제 SSD 동작을 제어함 |
...
> 요약: NVMe는 host driver, submission/completion queue, controller, PCIe link로 병렬 I/O를 처리함.
...
- NVMe·PCIe는 장치 속도보다 큐 구조, doorbell, completion path, PCIe 전달 흐름으로 설명함
