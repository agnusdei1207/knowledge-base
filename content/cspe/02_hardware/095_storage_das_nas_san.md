...
# 스토리지 계층 - DAS·NAS·SAN (Storage DAS NAS SAN)
...
- **정의/개념**: DAS·NAS·SAN은 서버와 저장장치를 연결하는 위치, 프로토콜, 공유 범위를 기준으로 구분하는 스토리지 계층 구조임. 업무의 성능, 공유성, 관리성, 비용 요구에 맞는 저장 방식 선택을 위해 사용함.
