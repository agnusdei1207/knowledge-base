...
## 한눈에
- **정의**: 엣지 장치에서 TensorFlow Lite 모델을 저전력으로 실행하는 Google 계열 AI 가속기
...
Edge TPU는 엣지 AI 전용 추론 가속기임. 현장 영상·센서 분석은 네트워크 지연과 데이터 전송 비용을 줄여야 하므로, 단말 근처에서 저전력 INT8 추론을 수행함.
