...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 아무리 우수한 전문가(Expert)가 많아도, 토큰이 엉뚱한 곳으로 배정되거나 한 명의 전문가에게만 업무가 몰리면 모델 전체의 성능이 붕괴... | "핵심 기술 요소" |
...
| **구체 예시** | 토큰 "사과"가 들어오면, 라우터 네트워크가 [문법 전문가: 0 | "핵심 기술 요소" |
| **흔한 오해/주의점** | 라우터 자체가 무거워지면 MoE의 연산 절감 효과가 사라짐 | "핵심 기술 요소" |
| **Mixture of Experts (MoE)** | 라우터 네트워크가 존재하는 전체 아키텍처 | "핵심 기술 요소" |
