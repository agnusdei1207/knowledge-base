...
## 한눈에
- **정의**: 학습 후 추론 단계에서 연산량·후보 수·검증 횟수를 늘려 정답률을 높이는 기법
...
Inference Scaling은 추론 단계 연산 확대 전략임. 파라미터 증설·재학습 없이 후보 풀이 수와 검증 횟수를 늘려 복잡 추론 정답률을 높이며, reasoning LLM 운영의 비용·정확도 균형점이 됨.
