...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 클라우드에 데이터를 올릴 때 저장할 때 암호화하고 전송할 때도 암호화함 | "핵심 기술 요소" |
| **핵심 직관** | 호텔 방 안의 강철 금고 | "핵심 기술 요소" |
| **배경** | 스마트폰 시대가 오면서 지문/홍채 인식 정보, 삼성페이 결제 정보를 안드로이드 OS에 그냥 저장하면 해킹당할 위험이 커짐 | "건물 관리실" |
