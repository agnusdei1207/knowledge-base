...
| **Collector (수집기)** | 모든 서버에서 뿜어져 나오는 데이터(OTLP 포맷)를 OTel Collector라는 중앙 수집기가 다 빨아들인다 | "핵심 기술 요소" |
...
| **구체 예시** | Java Spring Boot 앱을 띄울 때 `opentelemetry-javaagent | "핵심 기술 요소" |
| **흔한 오해/주의점** | "OTel을 깔면 그 자체로 예쁜 대시보드 그래프를 볼 수 있나?" → 절대 아니다! OTel은 데이터를 '수집해서 배달'하는 우체부(파이... | "핵심 기술 요소" |
