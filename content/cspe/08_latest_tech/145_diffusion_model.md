...
| 용어 | 뜻 | 비유 |
|:---|:---|:---|
| **필요성** | 기존 이미지 생성 짱이었던 GAN은 학습이 너무 불안정하고 자기가 잘 그리는 그림만 주야장천 그리는 치명적 단점(Mode Collapse)... | "위조범vs감정사" |
| **배경** | 열역학의 잉크 확산(Diffusion) 현상에서 아이디어를 빌려옴 | "핵심 기술 요소" |
| **작동 원리** | 1. **Forward Process (학습 단계)**: 고화질 강아지 사진에 가우시안 노이즈(TV 지지직)를 $T$번(예: 1000번)에... | "독립된 사무실" |
| **Denoising U-Net 학습** | 딥러닝 모델에게 $t$ 시점의 약간 더러워진 사진을 주면서 "방금 추가된 노이즈가 어떤 모양이게?" 맞히게 훈련시킴 | "핵심 기술 요소" |
...
| **흔한 오해/주의점** | "GAN보다 속도도 빠르고 완벽한가요?" $\rightarrow$ 절대 아님! 치명적인 단점이 '느려 터졌다'는 것임 | "위조범vs감정사" |
