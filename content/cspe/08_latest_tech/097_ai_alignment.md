...
- 개요: AI 행동을 의도·정책에 맞추는 체계
- 배경: 생성형 AI는 사용자 의도, 법규, 조직 정책을 벗어난 답변이나 도구 호출을 생성할 수 있음.
- 필요성: SFT/RLHF/DPO, guardrail, red-team, monitoring으로 정책 위반율·거절 정확도·감사로그를 관리해야 함.
