...
| **Multi-hop QA (다중 홉 추론)** | 한 번의 검색으로 알 수 없고, A를 찾아 B를 알고, B를 찾아 C를 알아야 하는 연쇄적 질문 | "이 개념의 핵심" |
