...
## 한눈에
- **정의**: 사람이 일일이 선호를 라벨링하지 않고, 명시된 원칙 목록(constitution)에 따라 AI가 자기 비판·수정을 수행하게 하는 정렬 방식
...
Constitutional AI는 원칙 기반 AI 정렬 기법임. 인간 선호 라벨링 비용과 일관성 문제를 줄이기 위해, 명시된 규칙에 따라 모델이 자기 비판·수정 데이터를 생성하고 학습함.
