...
- 개요: LLM 첫 토큰 생성 지연 시간
- 배경: 프롬프트 길이와 모델 크기가 커질수록 prefill 연산량이 늘어나 사용자 대기 시간이 증가함.
- 필요성: 대화형 LLM은 p99 TTFT 500ms 이하 등 SLA 기준으로 prefix caching·chunked prefill·TP 분산을 설계해야 함.
