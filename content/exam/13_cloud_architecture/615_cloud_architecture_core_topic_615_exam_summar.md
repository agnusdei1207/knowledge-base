---
title: "Cloud Architecture Core Topic 615 Exam Summary"
date: 2026-05-09
tags:
...
**3. 비용 최적화 6대 레버**: RI 1~3년 약정(40~60%v) + Savings Plan(전체 컴퓨트 30%v) + Spot Instance(Fargate Spot 70%v) + Right-Sizing(CloudOptimo 25%v) + Lifecycle Policy(IA->Glacier 80%v) + Graviton(ARM64, x86 대비 40% price/perf)
