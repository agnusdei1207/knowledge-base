...
# 🌌 종합 지식 포털 (Unified Hub)

이곳은 **업무(Work)**, **개인(Personal)**, 그리고 **학습(Study)** 영역을 모두 아우르는 통합 지식 허브입니다.
...
```text
       ...
       ┌───────────────────────┼───────────────────────┐
       ▼                       ▼                       ▼
 🏢 기업 업무 허브       🏠 개인 서재 & 로그      🎓 학습 및 R&D 허브
   (Work Workspace)       (Personal Workspace)      (Study Workspace)
  - 사업 기획 & GTM       - 데일리 저널 (일기)     - 기술사 16과목 노트
  - 프로젝트 & 태스크     - 인생 목표 & 버킷       - R&D 가설 및 실험
  - 기술 아키텍처 & Ops    - 개인 자산 & 재정       - 연구 개발 로드맵
  - 에이전트 인프라       - 취미 및 독서 기록      - 학습 일지 및 아카이브
```
...
*   **목적:** 회사 비즈니스, 프로젝트 관리, 개발 스택 및 시스템 인프라 아카이빙.
...
### 🎓 **[[study/_index|Study (학습 및 R&D 허브)]]**
*   **목적:** 방대한 스터디 노트와 연구 개발 로드맵을 연동하여 지식 자산을 마스터하는 공간.
*   **주요 문서:** `[[study/_index#📚-과목-바로가기|기술사 16과목 스터디노트]]`, `[[r-and-d|R&D 연구가설]]`, `[[r-and-d-roadmap|R&D 로드맵]]`.
...
정기적으로 이 공간을 비우며 적절한 카테고리(Work, Personal, Study)로 이동시키면 지식베이스의 신선함이 유지됩니다.
...
> - 새로운 문서를 만들고 연결하려면 대괄호 두 개 `[[새로운 문서 이름]]`을 본문에 적으세요.
