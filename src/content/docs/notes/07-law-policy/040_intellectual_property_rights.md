...
- **지식재산 체계**: 지식재산 체계는 발명·표현·표지·비밀을 서로 다른 성립 요건과 권리 범위로 보호한다.
...
- **선제 확인성**: 선제 확인성은 공개·출시 전에 권리 귀속·이용 범위·등록 가능성과 타인 특허 침해 가능성을 점검하는 특성이다.
...
- **계약·라이선스**: 계약·라이선스는 개발 성과의 권리 귀속과 이용 범위·기간·지역·대가를 명확히 정한다.
...
- **2. 선행기술·타인 권리 조사**: 지식재산 담당은 권리 등록 가능성을 보는 선행기술 조사와 사업화 침해 위험을 보는 FTO 조사를 구분해 수행한다.
...
- **영업비밀**: 영업비밀은 비공지성·경제적 유용성·비밀관리성을 유지하는 동안 기술·경영 정보를 공개 없이 보호한다.
...
- **귀속 분쟁**: 귀속 분쟁은 공동·외주 개발에서 배경 지식재산과 신규 성과의 소유·이용 범위를 계약으로 정하지 않을 때 발생한다.
...
- **특허·영업비밀**: 역설계 가능성과 공개 이익을 비교해 기술을 특허·영업비밀로 보호하고 표현·표지는 저작권·상표권으로 보완한다.
