...
- 정의/개념: 발명•표현•표지•비밀을 성립 요건별 **법적 권리**로 보호하는 **지식재산 체계**이다.
- 배경/필요성: 단일 보호 방식은 자산별 **권리 공백**과 불필요한 공개•침해을 초래한다.

#### 한줄 요약
- 공개 이익•역설계 가능성에 따라 **특허•영업비밀**을 선택한다.
...
- 공개•출시 전에 귀속•이용 범위•FTO를 보는 **선제 확인성**이 핵심이다.

#### 한줄 요약
- 외주 계약에 **저작권•특허 귀속**과 이용 범위 명시가 핵심이다.
...
#### 한줄 요약
- 신기술 공개 전에 **권리 유형•보호 방식** 확정이 핵심이다.
...
1. **성과•기여자 기록 전달**: 보호할 개발 성과와 기여 내용•시점을 기록한다.
2. **선행기술•타인 권리 조사**: 등록 가능성과 FTO를 구분해 검색한다.
3. **등록 가능성•침해 위험 분석**: 권리 취득 가능성과 타인 권리 침해 위험을 판정한다.
4. **공개•등록•비밀 전략 제안**: 사업 가치와 역설계 가능성에 따라 보호 방식을 조합한다.
5. **출원•계약•감시 실행 승인**: 권리 확보와 이용 허락 및 침해 대응 체계를 운영한다.

#### 한줄 요약
- **선행기술**은 등록 가능성, **FTO**는 침해 위험을 평가한다.
...
#### 한줄 요약
- 공개 허용 시 **특허**, 비밀 유지 가능 시 **영업비밀**을 선택한다.
...
#### 한줄 요약
- 생성형 AI의 **인간 기여•입력 라이선스** 증빙 보관이 핵심이다.
...
- 역설계•공개 이익에 따라 **특허•영업비밀**을 고르고 표현•표지는 **저작권•상표권**으로 보호가 핵심이다.
