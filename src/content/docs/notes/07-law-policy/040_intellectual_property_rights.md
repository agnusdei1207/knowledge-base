...
- **복합 보호성**: 보호 대상과 성립 요건 및 존속 기간이 달라 같은 성과에도 복수 권리를 조합
- **권리 성립성**: 특허·상표는 등록으로, 저작권은 창작으로, 영업비밀은 비밀관리로 보호 근거를 확보
- **선제 확인성**: 공개·계약·출시 전에 기여자와 권리 귀속 및 이용 범위와 FTO를 확인
