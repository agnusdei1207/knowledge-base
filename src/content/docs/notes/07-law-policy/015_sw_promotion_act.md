...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "소프트웨어 진흥법"
date: "2026-08-06T16:43:00+09:00"
tags:
  - "notes-law_policy"
weight: 15
extra:
...
- **소프트웨어 진흥법**: SW 산업 지원과 공공사업 발주 질서의 법률
...
- **과업 통제**: 계약 전 범위와 계약 후 변경•대가•기간 심의
- **상용 소프트웨어 직접구매**: 상용 SW를 통합사업과 분리해 직접 구매
- **소프트웨어사업 영향평가**: 공공사업의 민간 시장 영향을 분석
...
- **과업심의위원회**: 과업 내용•기간과 변경 대가의 적정성 심의
</details>
...
- **제안요청서(RFP)**: 과업•기간•산출물•평가 조건의 발주 문서
- **대가•기간 조정**: 과업 변경을 계약금액•수행 기간에 반영
...
- **공공 SW사업**: 과업심의•적정 기간•대가 기준의 공공 발주
- **과업심의**: 계약 전 과업과 계약 후 변경•대가•기간 심의
...
- **구두•무상 과업**: 변경 기록•대가•기간 조정 없는 추가 과업
- **기술지원 책임**: 설치•연동•하자•복구의 공급자별 책임
...
#### 한줄 요약
- 계약 후 기능 추가는 **과업심의**로 **범위•대가•기간** 조정
...
- **과업 변경 통제**: 추가 범위를 대가•기간과 함께 조정하는 절차
...
#### 한줄 요약
- **과업•대가•기간**을 계약•변경에 반영해 **정당한 가치** 보장
