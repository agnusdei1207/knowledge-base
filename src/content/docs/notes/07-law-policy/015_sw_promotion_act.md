...
- **산업 진흥 법률**: 소프트웨어 진흥법은 산업·기술·인력을 지원하고 공공 소프트웨어사업의 공정한 발주 질서를 규율하는 산업 진흥 법률이다.
- **공공 소프트웨어사업**: 국가·공공기관이 소프트웨어의 기획·구축·운영·유지관리를 발주하는 사업이다.

</details>

- 정의/개념: 소프트웨어 산업과 공공사업 발주 질서를 규율하는 **산업 진흥 법률**
...
- **상용 소프트웨어 직접구매**: 발주기관이 대상 상용 제품을 통합사업과 분리해 구매하고 설치·연동 책임을 구분하는 조달 방식이다.
- **소프트웨어사업 영향평가**: 공공사업의 구축 범위가 민간 소프트웨어 시장과 상용 제품을 침해하는지 검토하는 제도이다.
...
- **상용 소프트웨어 직접구매**: 사업 준비 단계에서 통합 발주와 분리해 구매할 상용 제품을 검토하는 제도이다.
...
- **공공 소프트웨어사업(Public Software Project, 공공 SW사업)**: 국가·공공기관이 발주하며 과업심의·적정 기간·대가 조정 등 법정 기준을 적용하는 사업이다.
...
- **제안요청서(Request for Proposal, RFP)**: 기능·산출물·완료 기준과 계약 범위를 공급자에게 제시하는 발주 문서이다.
- **과업심의**: 제안요청서와 계약의 과업 범위 및 변경 대가·기간을 공식적으로 검토하는 절차이다.
...
- **대가·기간 조정**: 공공 소프트웨어사업은 과업을 사전 심의하고 변경 승인 시 범위와 함께 대가·기간 조정을 반영해야 한다.
- **과업심의**: 계약 전 과업을 확정하고 계약 후 변경 필요성과 조정 근거를 검토하는 법정 절차이다.

</details>

- 공공 소프트웨어사업은 **과업심의** 후 계약하고 변경 시 **대가·기간 조정**
