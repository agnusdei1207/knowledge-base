...
- **거버넌스 중심성**: Govern이 정책·책임·위험 허용수준을 정하고 나머지 다섯 기능을 지속적으로 조정
- **성과 계층성**: 기능·범주·하위범주로 기술과 산업에 중립적인 보안 성과를 계층화
- **목표 지향성**: 현재·목표 프로파일로 성과 격차를 찾고 구현 등급으로 위험관리의 엄격성을 표현
