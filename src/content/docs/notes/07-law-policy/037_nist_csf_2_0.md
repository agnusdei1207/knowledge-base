...
- **미국 국립표준기술연구소(National Institute of Standards and Technology, NIST)**: 미국 정부의 표준 및 기술 연구 기관
- **사이버보안 프레임워크(Cybersecurity Framework, CSF)**: 사이버보안 위험관리를 위한 성과 기반 프레임워크
...
- **정의/개념**: 보안 위험관리 성과를 공통 언어로 묶은 프레임
- **배경/필요성**: 경영 목표와 현장 보안 과제의 우선순위 연결
...
- Govern이 나머지 다섯 기능을 통제한다.
- 기능·범주·하위범주가 성과를 계층화한다.
- 기술·산업 중립적 보안 결과를 제시한다.
- 프로파일·등급이 목표와 엄격성을 구분한다.
...
|:---|:---|:---|
| 핵심 특징 | 5개 기능 중심의 위험관리 | Govern을 더한 6개 기능 |
| 적용 기준 | 기존 1.1 프로파일 유지·참조 | 새 프로파일·전사 거버넌스 정렬 |
| 주요 위험 | 경영 책임·공급망 가시성 약화 | Govern을 문서 조직도로만 구현 |
