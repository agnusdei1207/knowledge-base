...
date: "2026-07-30T14:21:00+09:00"
tags:
  - "notes-law-policy"
weight: 37
extra:
...
- 정의/개념: 조직이 사이버보안 위험을 경영 목표와 연계해 관리하도록 성과 분류체계와 프로파일 및 구현 등급을 제공하는 지침
- 배경/필요성: 개별 통제 목록만으로는 경영 위험과 목표 보안 성과 및 투자 우선순위를 일관되게 연결하기 곤란
...
- Govern이 정책·책임·위험 허용수준을 정하고 나머지 다섯 기능을 지속적으로 조정
- 기능·범주·하위범주로 기술과 산업에 중립적인 보안 성과를 계층화
- 현재·목표 프로파일로 성과 격차를 찾고 구현 등급으로 위험관리의 엄격성을 표현
...
| Respond·Recover | 사고를 분석·완화하고 자산과 서비스를 복구 |
...
| 현재 프로파일 작성 요청 | 하위범주별 현재 성과 조사 |
| 현재 성과·격차 보고 | 통제 결과와 목표 대비 차이 확인 |
| 목표 프로파일·우선과제 제안 | 위험·비용·의존성으로 실행 순서 결정 |
| 목표 승인·실행 지시 | 필요한 보안 성과와 투자 우선순위 확정 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 프레임워크를 통제 목록으로 오용 | 업무 임무와 위험 허용수준에서 목표 하위범주를 도출 | 위험 기반 보안 목표 정렬 |
| 현재 성과의 근거 부족 | 프로파일 항목마다 지표·증적·책임자를 지정 | 성과 격차의 객관적 측정 |
| 개선과제 우선순위 충돌 | 위험 감소·비용·의존성을 기준으로 투자 순서 승인 | 제한된 예산의 효율적 배분 |
...
- 전사 사이버 위험을 경영 의사결정에 연결해야 하면 CSF 2.0을 선택하고, 위험 허용수준에 맞는 목표 프로파일과 구현 등급으로 투자 우선순위를 확정
