...
date: "2026-07-30T14:18:00+09:00"
tags:
  - "notes-law-policy"
weight: 36
extra:
...
- 정의/개념: 적용 기업이 ESRS에 따라 환경·사회 영향과 재무 위험·기회를 경영보고서에 공시하도록 한 EU 지침
- 배경/필요성: 기존 비재무 보고만으로는 기업별 지속가능성 정보의 범위와 비교 가능성 및 검증 수준을 일관되게 확보하기 곤란
...
- 이중 중대성 평가로 사람·환경에 미치는 영향과 기업의 재무 위험·기회를 함께 판정
- ESRS로 가치사슬의 정책·행동·목표·지표를 표준화하고 디지털 태그를 부여
- 경영보고서에 공시를 통합하고 내부통제와 제한적 확신으로 근거를 검증
...
| 외부 확신·공시 이용자 | 독립 검증을 거친 정보를 투자자·시민·고객에게 제공 |
...
| 절차 | 설명 |
|:---|:---|
| 가치사슬 경계·IRO 자료 요청 | 연결기업과 상·하류 활동의 조사 범위 확정 |
| 영향·위험·기회 데이터 제공 | 정책·행동·목표·지표의 원천 자료 수집 |
| 중대성 평가·ESRS 보고서 제출 | 영향·재무 중요성을 판정하고 표준 항목 작성 |
| 제한적 확신 결과 제공 | 통제·산식·표본을 독립적으로 검증 |
| 경영보고서·디지털 태그 공시 | 검증 결과를 반영해 기계 판독 형식으로 공개 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 간소화 지침에 따른 적용 범위 변경 | 직원 1,000명 초과와 순매출 4억 5천만 유로 초과 여부 및 국내 이행법 확인 | 불필요한 공시와 누락 방지 |
| 가치사슬 자료의 신뢰성 부족 | IRO별 데이터 소유자와 산식·승인·변경 증거를 내부통제로 관리 | 외부 검증 가능성 확보 |
| ESRS 간소화와 디지털 형식 변경 | 최신 위임규정과 태깅 분류체계를 공시 일정에 반영 | 규정 개정에 따른 재작성 최소화 |
...
- 직원 수와 순매출 기준으로 CSRD 적용 여부를 먼저 정하고, 적용 기업은 이중 중대성 평가에서 중요한 IRO만 ESRS 공시와 외부 검증 대상으로 확정
