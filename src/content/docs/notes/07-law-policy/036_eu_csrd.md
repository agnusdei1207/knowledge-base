...
- **이중 중대성**: 사람·환경에 미치는 영향과 기업의 재무 위험·기회를 함께 판정
- **표준 공시성**: ESRS로 가치사슬의 정책·행동·목표·지표를 표준화하고 디지털 태그를 부여
- **검증 가능성**: 경영보고서에 공시를 통합하고 내부통제와 제한적 확신으로 근거를 검증
...
block-beta
    columns 3
    G["경영기구"]:3
    V["가치사슬·IRO"] M["이중 중대성 평가"] R["ESRS 보고·내부통제"]
    A["외부 확신·공시 이용자"]:3
    G -- V
    V -- M
    M -- R
