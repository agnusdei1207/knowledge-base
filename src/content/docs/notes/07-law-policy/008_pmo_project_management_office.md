...
- **프로젝트 관리 조직**은 공통 표준을 기반으로 여러 프로젝트의 성과와 위험을 통합 관리하여 의사결정을 지원하는 **프로젝트 거버넌스 조직**
...
| 절차 | 핵심 활동 |
|:---|:---|
| 관리 기준 배포 | 표준 양식·관리 지침과 보고 주기 정의 |
| 사업 현황 보고 | 진척·비용·품질·위험 자료 수집 |
| 쟁점·대안 보고 | 영향도와 대응 대안을 분석하여 의사결정 요청 |
| 조치 결정 | 발주기관이 범위·자원·일정 변경 여부 승인 |
| 이행 지시·추적 | 결정 사항의 수행 결과와 잔여 위험 점검 |
