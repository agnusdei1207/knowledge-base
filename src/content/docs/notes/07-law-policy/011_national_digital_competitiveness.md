...
- **국가 디지털 경쟁력 지수**는 국가가 디지털 기술을 개발·채택하여 경제·사회 혁신에 활용하는 역량을 지식·기술·미래준비도로 비교하는 **복합 평가 지표**
...
| 절차 | 핵심 활동 |
|:---|:---|
| 평가 지표·자료 요청 | 요인·세부 지표·표본과 기준시점 결정 |
| 통계·설문 자료 제공 | 정량 통계와 경영진 설문 응답 확보 |
| 표준화 점수·순위 제시 | 단위가 다른 지표를 표준화하여 요인 점수와 국가 순위 산출 |
| 취약 요인 분석 요청 | 목표 국가와 비교하여 경쟁력이 낮은 세부 지표 식별 |
| 개선 우선순위 제안 | 영향도와 실행 가능성을 기준으로 정책 과제 도출 |
