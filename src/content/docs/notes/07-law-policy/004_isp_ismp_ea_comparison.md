...
date: "2026-08-06T15:31:00+09:00"
tags:
  - "notes-law_policy"
weight: 4
extra:
...
- **정보시스템 마스터플랜(ISMP)**: 개별 사업의 요구•규모•예산 계획
- **전사 아키텍처(EA)**: 전사 정보자원의 구조•표준•변경 통제 체계
...
- **제안요청서(RFP)**: 요구•규모•예산•평가•검수 기준의 발주 문서
- **구조 축**: EA로 현행•목표 구조•표준•변경 정합성 유지
...
#### 한줄 요약
- **ISP•ISMP**는 투자•발주, **EA**는 구조•표준•변경 관리
...
- **전주기 거버넌스**: 투자•발주•구축•EA 현행화의 승인 연결
...
#### 한줄 요약
- **ISP 과제**를 ISMP가 발주화하고 **EA**가 구조 정합성 통제
...
- **구조•표준•중복 검토**: 현행 자원•공동 활용•표준과 과제 대조
...
1. **ISP 우선 과제 선정**: 기여도•효과•시급성•실행성으로 투자 선정
2. **구조•표준•중복 검토**: 공동 활용•연계•표준•폐기 대상 확인
3. **ISMP•RFP 기준 확정**: 요구•규모•예산•계약•검수 기준 전환
4. **구축 구조•변경 결과 회신**: 실구축 자원•예외•성과 증거 제공

#### 한줄 요약
- **ISP•EA 검토** 후 ISMP로 발주화하고 **구축 결과** 재반영
...
- **정보화 계획 체계**: 중장기 투자•개별 발주•전사 구조 연결
...
#### 한줄 요약
- **ISP•ISMP**는 투자•계약, **EA**는 구조 원칙•표준 결정
...
- **사업 목적 변질**: ISP 과제와 ISMP 요구•검수의 추적 단절
- **과제 식별자(과제 ID)**: 과제를 요구•산출물•검수까지 잇는 번호
- **EA 저장소**: 현행 자원•목표 구조•표준•구축 결과 저장소
...
#### 한줄 요약
- **ISP 과제**를 EA와 대조한 뒤 **ISMP•RFP**로 구체화
...
- **전사 구조**: EA로 통제하고 투자•발주는 ISP•ISMP로 구체화
...
#### 한줄 요약
- **ISP•ISMP•EA 산출물**을 연결해 **중복•분쟁** 방지
