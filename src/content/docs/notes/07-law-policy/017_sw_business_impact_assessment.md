...
- 배경/필요성: 공공 직접 개발의 **민간시장 중복·대체 방지**
...
| 소프트웨어사업자 재평가 요청 | 공시 결과 이의·검토 요청 |
| 과학기술정보통신부 검토·개선조치 | 결과 검토와 개선 요청 |
...
1. **영향평가 결과 공시**: 대상·제외 여부를 확인하고 민간 유사 서비스와 대체성을 분석한 결과 공개
2. **재평가 요청**: 소프트웨어사업자가 공시된 평가의 근거·결론에 이의를 제기
3. **평가·재평가 결과 제출**: 발주기관이 정부 검토를 위해 결과서와 조치 내용을 제출
4. **시장침해 개선조치 요청**: 침해 가능성이 예상되면 민간 활용·기능 축소 등 개선 요구
5. **조정 사업계획 공개**: 평가 결과에 따라 범위·확보 방식을 조정하여 사업 추진
