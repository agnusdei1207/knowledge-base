...
- **소프트웨어(Software, SW) 사업 영향평가**: 공공 SW사업이 민간 제품•서비스를 중복하거나 대체할 가능성을 검토하는 제도이다.
...
- **시장 대체성**: 공공사업이 기존 민간 제품•서비스의 수요를 대신하거나 경쟁 기회를 줄일 가능성이다.
- **자체평가**: 발주기관이 직접 개발 필요성과 민간 대체성을 스스로 검토하는 절차이다.
- **사전 조정**: 입찰공고 전에 평가 결과에 따라 사업 기능과 범위를 바꾸는 조치이다.
- **재평가 요청**: 민간 사업자가 공시된 영향평가의 근거와 시장 침해 판단을 다시 검토해 달라고 요구하는 절차이다.
...
- **영향평가 결과 공시**: 발주기관이 평가 기준•근거와 민간시장 침해 가능성을 사업자에게 공개하는 절차이다.
- **개선조치 요청**: 과학기술정보통신부가 평가 결과의 시장 침해 가능성을 줄이도록 기능•범위•조달 방식의 수정을 요구하는 조치이다.
...
- **시장 중복•대체 분석**: 공공사업의 기능이 기존 민간 제품•서비스와 겹치거나 그 수요를 대신할 가능성을 분석하는 절차이다.
- **영향 재평가**: 사업자가 제시한 이의 근거와 최초 평가 자료를 다시 검토해 시장 영향 판단을 갱신하는 절차이다.
- **개선조치**: 민간시장 침해를 줄이기 위해 사업 기능 축소•민간 활용•조달 방식 변경을 요구하는 조치이다.
...
- **변경 이력**: 평가•재평가•개선조치에 따라 사업 기능•범위•조달 방식을 바꾼 근거와 결과의 기록이다.
