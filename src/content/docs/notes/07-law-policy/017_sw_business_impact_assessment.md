...
date: "2026-07-25T22:32:00+09:00"
tags:
  - "notes-law_policy"
weight: 17
extra:
...
- 평가 결과를 공시해 사업자의 재평가 요청을 보장한다.
- 검토 결과를 사업계획과 발주 문서에 반영한다.
...
| 판단 근거 | 공공성·보안·연속성 | 시장·유사성·대체성 |
| 영향 통제 | 범위 조정 통해 침해 방지 | 연계·표준·구매 책임 관리 |
...
2. 유사 민간 서비스 기능 비교 분석 근거의 재현 가능성 확보

### 쉽게 이해하기 (학습용)

- 법령상 시기와 절차에 맞춰 평가서를 작성하고 결과를 공시해 평가 의무를 이행합니다.
- 유사 민간 제품이 존재하는지 검색하고 분석한 세부 근거 자료를 감사나 검증이 가능하도록 명확하게 기록으로 남긴다.

## Ⅶ. 결론

- 민간 대체재가 있으면 사업 범위를 줄인다
