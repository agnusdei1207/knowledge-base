...
date: "2026-08-02T13:28:00+09:00"
tags:
  - "notes-law_policy"
weight: 28
extra:
...
- **인공지능기본법**: AI 산업 진흥과 고영향·생성형 AI의 안전·신뢰·투명성 의무를 함께 규율하는 기본법이다.
- **인공지능**: 학습·추론·판단을 통해 분류·예측·생성 등의 결과를 만드는 기술이다.
...
- **고영향 인공지능**: 사람의 생명·신체·기본권에 중대한 영향을 미쳐 추가 안전·설명 의무가 적용되는 AI이다.
...
- **고영향 AI**: 생명·신체·기본권에 중대한 영향을 주는 분야에서 의사결정에 사용되는 AI이다.
...
- **워터마크**: 결과물의 AI 생성 사실이나 출처를 식별할 수 있도록 삽입하는 표시이다.
- **딥페이크**: 딥러닝으로 실제와 유사하게 합성·변조한 음성·영상이다.
- **분류 오류**: 실제 고영향 이용인데 제품 명칭이나 범용 모델이라는 이유로 의무 적용을 누락하는 문제이다.
...
- **용도 기반 규율**: 같은 기반 모델도 실제 배치 분야·결정 영향·이용 목적에 따라 고영향 여부와 통제가 달라진다는 원칙이다.
- **진흥-신뢰 균형**: AI 연구·산업 지원과 기본권·안전 보호를 함께 달성하도록 위험에 비례하여 의무를 적용하는 관계이다.
