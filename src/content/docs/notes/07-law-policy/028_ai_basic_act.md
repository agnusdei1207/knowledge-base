...
date: "2026-07-25T14:28:00+09:00"
tags:
  - "notes-law_policy"
weight: 28
extra:
...
- 고영향 여부 확인은 적용 의무의 오판을 줄인다
- 위험관리·설명·감독은 권리·안전 피해를 줄인다
- 생성형 AI 고지·표시는 합성물 오인을 막는다
- 영향평가 권고는 기본권 위험의 사전 완화를 돕는다
...
| 핵심 의무 | 위험관리·설명·인간 감독 | AI 이용 고지·생성물 표시 | 일반 신뢰확보 노력 |
| 주요 위험 | 권리 침해·안전사고 | 합성물 오인·딥페이크 악용 | 결과 오류·과신 |
...
2. 생성형 AI 이미지에 워터마크를 삽입한다

### 쉽게 이해하기 (학습용)

- 의료 인공지능을 도입하기 전에 환자의 권리와 안전에 미칠 영향을 평가하고 사람의 감독 절차를 정한다.
- 생성형 인공지능이 만든 이미지에 식별 표식을 넣어 이용자가 실제 촬영물로 오인하지 않게 한다.

## Ⅶ. 결론

- 고영향 여부와 생성 기능으로 적용 의무를 결정한다.
