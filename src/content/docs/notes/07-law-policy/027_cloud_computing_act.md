...
date: "2026-08-02T13:27:00+09:00"
tags:
  - "notes-law_policy"
weight: 27
extra:
...
- **클라우드서비스 제공자(Cloud Service Provider, CSP)**: 클라우드 자원과 운영·보안 기능을 서비스로 제공하고 인증 범위의 기반 통제를 담당하는 사업자이다.
...
- **클라우드서비스 보안인증(Cloud Security Assurance Program, CSAP)**: 공공기관용 클라우드서비스가 보안기준을 충족하는지 평가·인증하는 제도이다.
- **클라우드서비스 제공자(Cloud Service Provider, CSP)**: 클라우드 자원과 운영 기능을 제공하고 인증 범위의 보호와 중단 대응을 담당하는 사업자이다.
...
- **반환·파기 검증**: 계약 종료 전 대체 환경에서 복원 가능성을 확인하고 제공자의 원본·복제·백업 데이터 삭제 증거를 검토하는 절차이다.
- **클라우드서비스 보안인증(Cloud Security Assurance Program, CSAP)**: 공공기관용 서비스의 보안 적합성을 평가하며 업무 중요도에 따라 등급과 인증 범위를 확인하는 제도이다.
- **서비스 수준 협약(Service Level Agreement, SLA)**: 가용성·복구·지원·책임과 종료 조건을 이용기관과 제공자가 계약으로 정한 합의이다.
- **클라우드서비스 제공자(Cloud Service Provider, CSP)**: 전환·운영·사고 대응 증적과 종료 시 데이터 반환·파기 결과를 제공하는 사업자이다.
...
- **인증 상태·적용 조건 확인**: 인증 서비스·책임 경계·제외 항목과 최신 상태 확인
- **서비스 수준·책임·종료 조건 계약**: 가용성·복구·보안·비용·자료 이전·파기와 감사 권한 명시
- **전환·운영·사고 대응 증적 확인**: 데이터 이전·복구 시험·변경·취약점·중단 대응 결과를 이용기관에 보고
...
- **공동 책임**: 클라우드서비스 제공자(Cloud Service Provider, CSP)와 이용기관이 기반·계정·설정·데이터 보호 책임을 나누는 모델이다.
...
- **클라우드서비스 보안인증(Cloud Security Assurance Program, CSAP)**: 공공기관용 클라우드서비스의 보안기준 충족 여부와 인증 범위를 확인하는 제도이다.
...
- **클라우드서비스 보안인증(Cloud Security Assurance Program, CSAP)**: 공공 업무의 중요도에 맞춰 적용 등급과 실제 서비스 범위를 확인해야 하는 보안인증 제도이다.
- **공동 책임**: 제공자와 이용기관의 보안·운영 통제 경계를 계약 전에 명확히 나누는 모델이다.
