...
- **클라우드서비스 제공자(CSP)**: 컴퓨팅 자원과 클라우드 운영·보안 기능을 서비스로 제공하는 사업자이다.
...
- **클라우드서비스 보안인증(CSAP)**: 공공기관용 클라우드서비스가 보안기준을 충족하는지 평가·인증하는 제도이다.
- **서비스 수준 협약(SLA)**: 이용기관과 제공자가 가용성·복구·지원·책임 기준을 정한 협약이다.
...
- **하이브리드 클라우드**: 자체 환경과 외부 클라우드를 연결하여 데이터 중요도·부하에 따라 업무를 나누는 배치 방식이다.
...
- **오토스케일링**: 부하에 따라 컴퓨팅 자원을 자동 증감하는 기능이다.
...
- **이용자 보호**: 중단·침해·계약 종료 시 통지·복구·자료 반환·파기와 책임을 계약 및 법적 의무로 보장하는 체계이다.
