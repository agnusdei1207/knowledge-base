...
date: "2026-07-25T14:26:00+09:00"
tags:
  - "notes-law_policy"
weight: 27
extra:
...
| 주요 위험 | 공급자 종속·책임 경계 누락 | 과잉 용량·증설 지연 |
...
2. 계약 종료 시 데이터 반출·파기를 시험한다

### 쉽게 이해하기 (학습용)

- 공공기관은 업무 중요도에 맞는 CSAP 등급과 인증 유효 여부를 확인한 뒤 하이브리드 배치를 정한다.
- 계약이 끝나기 전에 데이터를 다른 환경으로 반출하고 CSP에 남은 복제본의 파기 결과를 확인한다.

## Ⅶ. 결론

- 업무 중요도로 CSAP 등급과 종료 조건을 결정한다.
