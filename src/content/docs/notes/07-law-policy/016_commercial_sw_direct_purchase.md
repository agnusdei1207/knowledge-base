...
date: "2026-07-25T22:31:00+09:00"
tags:
  - "notes-law_policy"
weight: 16
extra:
...
- 규격·기술평가·BMT를 제품 특성에 맞게 적용한다.
- 유지관리 계약을 연계해 기술지원 공백을 줄인다.
...
| 비교축 | 직접 구매 | SI 일괄 구매 | 구독 계약 |
|:---|:---|:---|:---|
| 적용 기준 | 고시 금액 이상 상용SW | 자체 개발과 밀접한 연계 요구 시 | 클라우드 자원 활용 시 |
| 계약 대상 | 제품 및 유지관리 분리 | 시스템 구축 일괄 위탁 | 사용권 및 서비스 수준 통합 |
| 비용 구조 | 조달 단가 기반 개별 집행 | 용역비 내 제품 가격 포함 | 월간/연간 사용량 비례 청구 |
| 운영 책임 | 제조사 직접 기술지원 | 주사업자 통합 유지보수 | 서비스 제공사 관리 이행 |
...
2. 클라우드 SaaS 직접구매와 연계

### 쉽게 이해하기 (학습용)

- 대규모 데이터베이스 소프트웨어 도입 시 조달청 분리발주 제도를 적용해 예산 낭비를 막고 제조사의 기술지원을 확보한다.
- 클라우드 SaaS 도입 시 제공사와 이용자 간의 서비스 수준 협약(SLA)에 따라 성능과 보안 책임을 정의한다.
