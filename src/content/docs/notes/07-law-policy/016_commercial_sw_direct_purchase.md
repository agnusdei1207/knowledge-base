...
- **법적 근거•대상**: 「소프트웨어 진흥법」 제54조와 「소프트웨어사업 계약 및 관리감독에 관한 지침」에 따라 총사업규모 3억 원 이상인 소프트웨어사업에서 종합쇼핑몰•디지털서비스몰 등록 제품 또는 5천만 원 이상인 인증•검증 제품의 직접구매 여부를 판단한다.
...
- **벤치마크 테스트(Benchmark Test, BMT)**: 공통 규격과 시험 조건에서 후보 제품의 기능•성능•호환성•기술지원 능력을 비교하는 시험이다.
- **라이선스**: 선정 제품의 사용자•장치•기간•기능별 이용 권리와 제약을 계약으로 확정한 조건이다.
...
- **벤치마크 테스트(Benchmark Test, BMT)**: 직접구매 후보 제품을 동일한 조건에서 비교하는 시험이다.
...
- **중립 규격**: 특정 제품에 유리하지 않게 필요한 기능•성능•호환성으로 작성한 구매 기준이다.
- **총소유비용(Total Cost of Ownership, TCO)**: 도입•운영•유지관리•전환•폐기까지의 비용을 합산한 판단 기준이다.
