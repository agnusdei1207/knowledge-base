...
| 절차 | 설명 |
|:---|:---|
| 직접구매 규격·평가 공고 | 의무 대상과 예외 여부를 검토하고 중립적 요구 규격 제시 |
| 제품 제안·시험 지원 | 공급자가 기능·성능·호환성 자료와 시험 환경 제공 |
| 제품 선정·공급 계약 | 평가 결과에 따라 라이선스·납기·기술지원 조건 계약 |
| 제품 납품·설치 지원 | 공급자와 구축 사업자가 설치·연동 책임에 따라 협업 |
| 연동 시험·인수 요청 | 통합 기능·성능·장애 대응과 인수 기준 충족 여부 확인 |
