...
date: "2026-08-06T16:52:00+09:00"
tags:
  - "notes-law_policy"
weight: 16
extra:
...
- **상용 소프트웨어**: 완제품 형태로 판매•라이선스되는 소프트웨어
- **공공 조달 제도**: 상용 SW를 구축 용역과 분리해 직접 계약
...
- 적용 근거: 「소프트웨어 진흥법」 제54조와 **관리감독 지침**
- 사업 기준: 총사업규모 **3억 원 이상**
- 제품 기준: 종합쇼핑몰 등록 SW 또는 **5천만 원 이상 인증제품**

#### 한줄 요약

- **직접구매 대상 SW**를 구축 용역과 분리해 **별도 계약**
...
- **적합성 검증**: 중립 규격•BMT•유지관리 조건의 제품 검증
- **벤치마크 테스트(BMT)**: 동일 조건에서 기능•성능•호환성 비교
...
- **제품 직접 선정**과 **공급•구축 책임 연계**로 공백 방지
...
- **조달 계약**: 제품•라이선스•납기•기술지원•하자 책임 명시
...
- **통합 검증•운영 지원**: 호환성•성능•장애 책임과 운영 인계 확인
...
- **제품 평가•BMT**: 규격•시험•유지관리 조건으로 적합성 검증
...
1. **대상•제외 검토와 규격 공고**: 법정 대상•예외와 중립 규격 확인
2. **제품 제안•BMT 지원**: 기능•성능•호환성과 지원 능력 검증
3. **제품 선정•공급 계약**: **라이선스•납기•기술지원 조건** 확정
4. **제품 납품•설치 지원**: **설치•연동 책임** 에 따라 공급•구축 협업
5. **연동 시험 결과**: **통합 기능•성능•장애 대응** 인수 기준 확인

#### 한줄 요약

- **대상•제품 계약** 후 구축사업자와 **통합 작동** 검증
...
- **직접 구매**: 제품 분리 계약으로 가격•기술지원 책임 관리
- **SI 일괄 구매**: 상용 제품을 구축 용역에 포함하는 조달
- **서비스형 소프트웨어(SaaS)**: 네트워크로 구독하는 소프트웨어
- **서비스 수준 협약(SLA)**: 가용성•성능•지원•미달 책임의 합의
</details>
...
- **책임 공백**: 공급자의 지원과 구축자의 설치•연동 범위 단절
- **중립 규격**: 특정 제품이나 공급자에 유리한 고유 명칭 대신 필요한 기능•성능•호환성으로 작성한 규격이다.
- **총소유비용(TCO)**: 도입•운영•유지관리•전환•폐기의 전체 비용
