...
date: "2026-07-30T10:38:00+09:00"
tags:
  - "notes-law_policy"
weight: 9
extra:
...
- **디지털 플랫폼 정부**는 부처별 공공 데이터와 행정 서비스를 표준으로 연결하고 민간 역량과 결합하여 맞춤형 서비스를 제공하는 **정부 운영 모델**
- **배경/필요성**: 기관별 칸막이로 인한 정보의 반복 제출과 생애주기 서비스 단절 해소
...
- **국민 중심**: 국민의 생애주기와 상황에 맞춘 선제적·맞춤형 서비스 제공
...
1. **맞춤 서비스 요청**: 국민 여정과 상황을 기반으로 요구 접수
2. **이용 근거·동의 확인**: 법적 근거·정보주체 동의·접근 권한 검증
3. **공공 데이터 조회**: 공통 응용 프로그래밍 인터페이스로 기관 자료 요청
4. **검증 데이터 제공**: 제공 기관이 품질과 정합성을 확인한 자료 전달
5. **융합 서비스 제공**: 기관 기능과 민간 서비스를 결합한 원스톱 결과 제공
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 기관별 데이터 형식과 품질 차이 | 공통 표준·메타데이터·품질 책임자를 지정 | 기관 간 연계 정확도 향상 |
| 개인정보의 목적 외 이용 위험 | 법적 근거·동의·최소 권한을 확인하고 접근 이력을 감사 | 정보주체 권리 보호와 책임 추적 |
| 민관 서비스의 책임 경계 불명확 | 데이터 제공·서비스 운영·사고 대응 책임을 협약으로 명시 | 장애·침해 사고의 신속한 대응 |
...
- 생애주기 행정의 반복 제출과 서비스 단절을 해소하려면 **데이터 이용 근거와 기관별 책임을 먼저 확정하고 표준 API로 민관 서비스를 연결하는 단계적 플랫폼 전환** 필요
