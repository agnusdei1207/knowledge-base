...
- **응용 프로그래밍 인터페이스(Application Programming Interface, API)**: 기관 간 데이터와 기능을 공통 규칙으로 요청•제공하게 하는 연계 접점이다.
...
- **응용 프로그래밍 인터페이스 플랫폼(Application Programming Interface Platform, API 플랫폼)**: 기관별 데이터와 행정 기능을 표준 접점으로 연결해 공동 활용하게 한다.
...
- **보안•개인정보 보호**: 데이터 결합과 서비스 연계 과정에서 최소권한•목적 제한•추적성으로 권리와 신뢰를 보호하는 통제이다.
...
- **응용 프로그래밍 인터페이스(Application Programming Interface, API)**: 권한을 확인한 플랫폼이 기관의 검증 데이터를 표준 방식으로 조회하는 접점이다.
...
- **디지털 플랫폼 정부**: 디지털 플랫폼 정부는 기관별 절차 온라인화를 넘어 데이터•기능을 연계한 생애주기 맞춤 서비스를 지향한다.
- **응용 프로그래밍 인터페이스(Application Programming Interface, API)**: 디지털 플랫폼 정부가 기관 데이터•기능을 연결하는 표준 접점이다.
- **디지털 플랫폼 정부(Digital Platform Government, DPG)**: 전자정부의 기관별 온라인화를 넘어 데이터•기능 연결과 맞춤 서비스를 지향하는 모델이다.
...
- **최소 권한**: 목적 달성에 필요한 데이터와 기능에만 접근하도록 권한 범위를 제한하는 원칙이다.
...
- **표준 응용 프로그래밍 인터페이스(Standard Application Programming Interface, 표준 API)**: 민관 서비스가 동일한 요청•응답•보안 규칙으로 데이터와 기능을 연계하는 접점이다.
- **최소 권한**: 개인정보 처리 목적에 필요한 범위만 접근 권한으로 부여하는 원칙이다.
