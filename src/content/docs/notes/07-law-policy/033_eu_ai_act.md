...
1. 적용 일정은 **2025년 금지·GPAI와 2026년 일반 적용 구분**
2. GPAI는 **기본 의무와 시스템적 위험 추가 의무 구분**

### 쉽게 이해하기 (학습용)
- 금지·AI 리터러시는 2025년 2월, GPAI는 2025년 8월, 일반 규정은 2026년 8월 적용을 구분함
- GPAI 기본 의무와 시스템적 위험 모델의 추가 평가·사고·사이버보안 의무를 구분한다.

## Ⅶ. 결론

- **의도된 목적·사업자 역할·위험 분류·적용일**로 의무 결정
