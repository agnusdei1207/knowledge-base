...
date: "2026-07-25T22:28:00+09:00"
tags:
  - "notes-law_policy"
weight: 13
extra:
...
- **시퀀스 기호(->>)**: ‘요청 전달’로 읽고 이중 화살촉은 접근성 요구·구현·검증 책임의 인계를 나타냄

## Ⅰ. 개요

- **정의/개념**: 장애·연령·환경 무관한 정보 인식·운용·이해 설계
- **배경/필요성**: 접근성 결함에 따른 서비스 배제 방지
...
- 키보드·대비·대체 텍스트를 구현 단계에서 검증한다.
- 자동 진단과 보조기술 사용자 시험을 함께 수행한다.
...
| 판단 기준 | 인식성 | 운용성 | 이해성 | 견고성 |
|:---|:---|:---|:---|:---|
| 핵심 초점 | 정보의 감각적 인지 | UI 기능 조작 | 콘텐츠 의미 파악 | 보조기술 호환 |
| 주요 항목 | 대체 텍스트, 대비 | 키보드 접근, 시간 조절 | 가독성, 오류 방지 | 표준 마크업 준수 |
