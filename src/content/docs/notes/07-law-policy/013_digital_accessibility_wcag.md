...
- **WAI-ARIA 역할·상태**: WAI-ARIA 역할·상태는 동적 사용자 인터페이스의 의미와 현재 상태를 보조기술에 전달한다.
...
- **3. 키보드·보조기술 시험**: 사용자 시험은 키보드 초점 순서와 화면 낭독기의 의미 구조 해석이 실제 과업을 완결하는지 확인한다.
...
- **WCAG 2.2 AA**: 공공·필수 서비스는 WCAG 2.2 AA 성공 기준과 보조기술 시험을 개발 완료 조건으로 적용해야 한다.
