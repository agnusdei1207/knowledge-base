...
- **자동화된 결정**: 인공지능 기술을 포함한 자동화 시스템으로 개인정보를 처리하여 이루어지는 결정이다.
...
- **권리 적용 대상 확인**: 해당 정보·결정·처리자가 전송요구권이나 자동화 결정 권리의 법정 적용 범위인지 판단하는 단계이다.
- **본인 확인**: 권리 요청자가 실제 정보주체인지 안전한 인증 수단으로 검증하는 절차이다.
...
- **전송 범위 과다**: 제3자의 개인정보·영업비밀·보안정보까지 함께 전송하여 다른 권리를 침해하는 문제이다.
- **설명 불충분**: 자동화 결정의 주요 기준과 영향이 정보주체가 이해하기 어려운 형태로 제공되는 문제이다.
- **국외 이전 통제**: 이전 근거·수신자·국가·보호조치와 중지 명령 대응을 관리하는 절차이다.
...
- **개인정보보호법**: 개인정보 처리 원칙과 정보주체 권리를 규정한 일반법이다.
