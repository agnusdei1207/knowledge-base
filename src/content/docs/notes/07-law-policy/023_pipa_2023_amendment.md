...
| 절차 | 설명 |
|:---|:---|
| 전송·거부·설명 요구 | 권리 유형·대상 정보·자동화된 결정 내용을 식별하여 접수 |
| 본인 확인·보완 요청 | 정보주체 또는 대리인의 신원과 요청 권한을 안전하게 확인 |
| 적용 대상·예외 판단 통지 | 법정 대상·제외 사유와 처리 가능 범위를 근거와 함께 안내 |
| 전송·설명·인적 검토 수행 | 안전한 형식으로 전송하거나 결정 기준·절차를 설명하고 필요한 조치 수행 |
| 조치 결과·구제 절차 통지 | 처리 결과·거절 사유·이의 및 피해구제 방법을 기록하여 통지 |
