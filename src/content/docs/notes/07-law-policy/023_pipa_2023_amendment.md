...
date: "2026-07-25T22:38:00+09:00"
tags:
  - "notes-law_policy"
weight: 23
extra:
...
- **배경/필요성**: 데이터 이동성과 처리자 간 규제 격차 대응
...
- 전송요구권을 도입해 개인정보 이동권을 확대했다.
- 자동화된 결정의 거부·설명·검토 요구권을 신설했다.
- 형벌을 정비하고 전체 매출액 기준 과징금을 도입했다.
- 온·오프라인 특례를 정비해 동일 행위를 함께 규율한다.
...
| 권리 범위 | 개인정보 전송요구권 및 자동화 결정 설명 | 열람, 정정, 삭제, 처리정지 등 기본권 |
| 규제 일원화 | 온·오프라인 처리자 단일 규제 통합 적용 | 일반법 및 정보통신망법 이원화 적용 |
