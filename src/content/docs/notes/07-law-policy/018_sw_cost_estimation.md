...
date: "2026-07-25T22:33:00+09:00"
tags:
  - "notes-law_policy"
weight: 18
extra:
...
- 구축·운영·유지관리 유형별 산정 기준을 적용한다.
- 데이터·AI·클라우드 비용은 별도 작업량으로 반영한다.
...
| 판단 기준 | 투입공수 | 기능점수 | AI 도입 |
|:---|:---|:---|:---|
| 적용 기준 | 정형화가 어려운 연구·유지관리 시 | 일반적 소프트웨어 개발 및 재구축 시 | 데이터 전처리 및 모델 학습 필요 시 |
| 산정 방식 | 투입 인력의 기술 등급별 노임 단가 | 논리적 데이터 및 트랜잭션 규모 | 인프라 이용료 및 AI 학습 작업량 |
| 통제 항목 | 인력 투입 및 성과 검증 | 시스템 경계 및 내부 논리 파일 식별 | 학습 데이터 품질 및 전처리 범위 |
...
1. 고시 단가로 기능점수 예산 수립
2. 데이터 준비와 AI 학습 대가 분리

### 쉽게 이해하기 (학습용)

- 공공 정보화사업에서 적용하는 산정 기준과 기능점수 단가로 개발비 근거를 투명하게 작성합니다.
- 대화형 챗봇 구축 시 시나리오 구성에 필요한 데이터 전처리 및 인공지능 모델 튜닝 비용을 각각 분리하여 산출한다.
