...
- **소프트웨어 대가**: 사업 규모•작업량•단가•보정에 따른 적정 비용
- **원가 추정 체계**: 규모•작업량과 단가•보정으로 비용 계산
...
- **기능점수(FP)**: 데이터•입력•출력•조회 기능의 규모 단위
- **인공지능 사업**: 데이터•학습•검증•배포•맞춤화 사업
- **추적 가능성**: 기능 기준선과 규모•기간•대가 증감의 연결
...
- **외부 조회(EQ)**: 내부 변경 없이 조건에 맞는 정보를 반환
...
- **투입공수 방식**: 직무•등급•투입 기간을 인월로 산정
- **혼합 산정**: 기능은 FP, 데이터•모델 작업은 투입공수 적용
