...
- 정의/개념: 디지털 **정보·도구**를 비판적·책임 있게 활용하는 **복합 역량**
- 기존 한계: 기기 조작 능력만으로 **정보 신뢰성·안전·AI 편향** 판단 곤란
...
- **기술 활용**과 정보 출처·신뢰성 판단
- **디지털 시민성**과 저작권·개인정보 규범 준수
- **AI 편향·디지털 격차**를 인식한 책임 있는 활용
