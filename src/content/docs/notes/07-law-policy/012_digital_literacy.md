...
- **디지털 리터러시**는 디지털 정보와 도구를 접근·이해·평가·생산하고 안전하며 책임 있게 활용하는 **복합 시민 역량**
...
| 절차 | 핵심 활동 |
|:---|:---|
| 역량 진단 참여 | 접근·활용·정보 평가·안전 수준 측정 |
| 맞춤 교육 제공 | 대상과 생활 맥락에 맞는 정보 판별·도구 활용 교육 |
| 정보 판별·안전 실습 | 실제 사례로 허위정보·피싱·개인정보 침해 대응 훈련 |
| 취약 역량 지원 요청 | 진단 결과를 바탕으로 기기·통신·보조 교육 연계 |
| 접근·활용 환경 보완 | 취약계층의 접근 조건과 지속 학습 기회 지원 |
