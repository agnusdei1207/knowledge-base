...
- **시퀀스 기호(->>)**: ‘요청 전달’로 읽고 이중 화살촉은 진단·교육·보정 단계의 책임 인계를 나타냄

## Ⅰ. 개요

- **정의/개념**: 디지털 정보·도구를 비판적·책임 있게 활용하는 역량
- **배경/필요성**: 서비스 디지털화에 따른 정보 판별·안전 수요 증가
...
- AI 결과의 편향을 인식하고 책임 있게 쓴다
- 접근 격차 해소 뒤에도 활용 성과 차이는 남는다
...
| 판단 기준 | 디지털 리터러시 (현재) | 컴퓨터 리터러시 | AI 리터러시 |
|:---|:---|:---|:---|
| 핵심 초점 | 정보·안전 활용 | 기기·SW 조작 | AI 결과·책임 판단 |
| 대상 범위 | 정보 환경 기반 | 하드웨어 기반 | 인공지능 기반 |
...
2. 업무 내 생성형 AI 도구의 비판적 검토 체계

### 쉽게 이해하기 (학습용)
- 노령 사용자에게 키오스크 결제법을 가르치는 동시에, 문자 메시지로 오는 금융 사기 링크를 누르지 않도록 예방함
- 신입 사원이 업무 보고서를 작성할 때 챗GPT의 그럴싸한 오답(할루시네이션)이 섞이지 않도록 보고서 검증 가이드를 도입함

## Ⅶ. 결론

- 활용 역량 수준에 부합하는 보안 통제와 정보 검증 체계 확립
