...
date: "2026-07-31T05:54:35+09:00"
tags:
  - "notes-law_policy"
weight: 12
extra:
...
- **디지털 리터러시(Digital Literacy)**: 디지털 정보와 도구를 접근·이해·평가·생산하고 안전하며 책임 있게 활용하는 역량
...
- **컴퓨터 리터러시(Computer Literacy)**: 컴퓨터 기기와 소프트웨어를 기본적으로 조작하고 활용하는 역량

> **키워드:** 디지털 리터러시 (Digital Literacy)
