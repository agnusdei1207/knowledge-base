...
date: "2026-08-06T15:44:00+09:00"
tags:
  - "notes-law_policy"
weight: 6
extra:
...
- **ITIL v4**: 기회•수요를 가치로 전환하는 ITSM 프레임워크
- **IT 서비스 관리(ITSM)**: IT 서비스의 기획•제공•지원•개선 활동
...
#### 한줄 요약
- 고객 요구부터 성과 개선까지 **서비스 가치 흐름**으로 관리
...
- **서비스 가치 시스템(SVS)**: 원칙•거버넌스•가치사슬•관행•개선 체계
- **서비스 가치 사슬(SVC)**: 여섯 활동을 상황에 맞춰 조합한 운영 모델
- **4차원 검토**: 조직•기술•파트너•가치 흐름을 함께 검토
...
- **지도 원칙**: 가치 중심•현재 위치•반복 개선의 의사결정 권고
- **관리 관행**: 일반•서비스•기술 관리 자원과 활동의 묶음
- **지속적 개선**: 현재와 목표를 비교한 서비스 성과 향상
- **거버넌스**: 서비스 활동의 평가•지시•감독 구성요소
...
- **서비스 수준 협약(SLA)**: 서비스 목표•측정 기준•책임의 합의
- **가치 흐름**: 수요를 가치로 전환하는 활동•관행•역할 경로
- **이용자 경험 지표**: 만족도•편의성•성공 여부의 이용자 측정값
...
1. **가치 흐름•관리 관행 구성**: 활동•서비스 자원 조합
2. **서비스 수준•경험 지표 회신**: SLA•이용자 경험 측정
3. **지속적 개선안 반환**: 측정값을 가치 흐름과 관행에 반영

#### 한줄 요약
- **고객 요구**로 가치 흐름을 구성하고 **운영 지표**로 개선
...
- **ITIL v3 서비스 생명주기**: 전략•설계•전환•운영•개선 모델
...
#### 한줄 요약
- **v3**는 생명주기 통제, **v4**는 관행의 가치 흐름 조합
...
- **도입 부담**: 모든 관리 관행의 일괄 적용에 따른 비용•저항
- **가치 기여도**: 관행 개선이 이용자 경험•사업 성과에 기여한 정도
