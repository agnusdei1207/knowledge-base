...
- 정의/개념: **ITIL v4**는 서비스 가치 시스템의 구성요소를 연계하여 기회와 수요를 공동 창출 가치로 전환하는 **IT 서비스 관리 지침**
...
1. **기회·수요 제시**: 이해관계자의 요구 가치와 기대 성과 식별
2. **가치 흐름 설계**: 활동·서비스 자원 조합
3. **서비스 제공·지원**: 설계·전환·구축·운영 관행을 연계하여 서비스 제공
4. **성과 피드백**: 서비스 수준과 이용자 경험을 측정하여 개선 요구 도출
5. **지속적 개선**: 측정 결과를 가치 흐름과 관리 관행에 반영
