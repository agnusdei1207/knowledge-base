...
- 정의/개념: **NIST AI RMF**는 AI 맥락•영향을 4대 기능으로 처리하는 **자발적 위험관리 틀**
- 배경/필요성: 정확도 최적화 과정의 **공정성•설명성 저하** 통제 곤란

#### 한줄 요약
- 사용 맥락별 **AI 위험**을 식별•측정하고 대응
...
#### 한줄 요약
- **Govern** 아래 Map•Measure•Manage 기능 연계
...
#### 한줄 요약
- **Map의 영향 대상**이 Measure의 위험 지표 결정
...
#### 한줄 요약
- 사용사례는 **AI RMF**, 조직 관리체계는 **ISO 42001**
...
- 사용사례별 **AI RMF 1.0**을 적용하고 **잔여 위험**이 허용될 때만 배포

#### 한줄 요약
- **TEVV 결과**를 배포•완화•중단 결정으로 연결
