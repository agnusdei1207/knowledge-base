...
| 절차 | 설명 |
|:---|:---|
| 정책·역할·위험 허용수준 전달 | 책임과 의사결정 기준 및 문서 체계화 |
| 목적·맥락·영향 확인 | 사용 환경과 AI 행위자 및 긍정·부정 영향 파악 |
| 피해 경험·요구사항 제공 | 영향받는 공동체의 관점과 수용 조건 반영 |
| TEVV 결과·처리안 보고 | 위험·신뢰성·불확실성을 측정하고 대안 비교 |
| 배포·완화·중단 결정 | 잔여 위험을 허용수준과 비교해 조치 선택 |
