...
1. 생성형 AI: 프로필로 환각·저작권 위험 매핑
2. 의료 AI: 불확실성으로 배포·인간 검토 결정

### 쉽게 이해하기 (학습용)
- 생성형 AI 프로필의 위험을 서비스 맥락에 맞춰 골라 지표·완화·운영 감시로 연결함
- 신뢰도가 낮은 진단은 자동 확정하지 않고 의사 검토로 보내며 성능 변화 때 기준을 다시 평가함
