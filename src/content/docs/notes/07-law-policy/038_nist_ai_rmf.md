...
- 정의/개념: AI 위험을 사용 맥락별로 관리하는 **자발적 위험관리 프레임워크**
- 기존 한계: 기술 성능 평가만으로 사람·조직·사회에 미치는 AI 위험 통제 곤란
...
- AI의 신뢰성과 위험을 수명주기 전반에서 관리하기 위해 **사용 맥락·영향 대상·TEVV 결과·통제 효과·잔여 위험 허용수준**을 검토하고, NIST AI RMF에 따라 배포와 지속 사용을 결정해야 한다.
