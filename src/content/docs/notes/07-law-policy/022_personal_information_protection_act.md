...
date: "2026-07-25T22:37:00+09:00"
tags:
  - "notes-law_policy"
weight: 22
extra:
...
- **72시간**: 개인정보 유출 등의 통지 기한이며, 신고는
  유출 규모·정보 유형·침해 경로 등 법정 요건도 확인한다.

## Ⅰ. 개요

- **정의/개념**: 개인정보 처리 전 과정과 정보주체 권리를 규율
- **배경/필요성**: 데이터 활용에 따른 오남용·권리 침해 방지
...
- 처리 근거·최소 수집·목적 제한·안전조치를 적용한다.
- 열람·정정·삭제·처리정지 등 권리 절차를 보장한다.
- 가명정보 특례로 데이터 보호와 활용을 조정한다.
- 유출 통지·신고와 피해 대응을 보안 운영에 연계한다.
...
| 식별 수준 | 특정 개인을 알아볼 수 있는 상태 | 추가 정보 없이는 알아보기 어려운 상태 |
| 안전 통제 | 처리 근거·권리·안전조치 준수 | 추가 정보 분리·재식별 금지 |
