...
- **개인정보**: 살아 있는 개인에 관한 정보로서 그 개인을 알아볼 수 있거나 다른 정보와 쉽게 결합하여 알아볼 수 있는 정보이다.
...
- **열람·정정**: 삭제·처리정지와 함께 처리 결과를 통제하는 권리
- **전송요구·자동화결정**: 개인정보 이동과 AI 결정에 대한 통제권
...
- **개인정보보호위원회**: 개인정보 보호 정책과 법 집행을 총괄하는 중앙행정기관이다.
...
- **자동화된 결정 통제**: AI 등 자동화 시스템의 결정에 대해 거부·설명 요구 등 정보주체 권리를 보장하는 절차이다.
