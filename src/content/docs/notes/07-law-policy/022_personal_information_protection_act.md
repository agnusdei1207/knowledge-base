...
date: "2026-08-06T17:45:00+09:00"
tags:
  - "notes-law_policy"
weight: 22
extra:
...
- **개인정보보호법**: 처리 원칙•처리자 의무•정보주체 권리의 일반법
- **개인정보**: 살아 있는 개인을 식별하거나 식별 가능한 정보
...
- **전 과정 안전성**: 수집•보유•제공•파기의 보호조치 적용
- **열람권**: 정보주체가 자신의 개인정보 처리 현황과 내용을 확인하도록 요구하는 권리이다.
- **정정권**: 정보주체가 잘못된 개인정보를 바로잡도록 요구하는 권리이다.
- **전송요구권**: 개인정보를 본인•지정 기관에 전송할 요구권
- **자동화된 결정**: 완전 자동 처리로 권리•의무에 중대한 영향의 결정
...
- **개인정보보호위원회(PIPC)**: 보호 정책•법 집행•피해구제 감독 기관
...
- **파기**: 기간 종료•목적 달성 정보를 복구 불가능하게 제거
...
2. **수집•이용•제공 통제**: 최소 항목•목적 범위•위탁 책임 관리
...
- **일반 처리**와 **가명정보 특례**의 근거•제한 비교

## Ⅵ. 실무 고려사항 및 대책

<details><summary>핵심 용어</summary>

- **개인정보 유출**: 무권한 공개 또는 정보의 분실•도난•유출 사고
...
- **유출 인지 후 72시간** 내 통지하고 요건 시 **신고**

## Ⅶ. 결론

<details><summary>핵심 용어</summary>

- **개인정보 자기결정권**: 정보 처리 시기•방법•범위를 통제할 권리
- **수명주기 통제**: 근거•목적•보유•제공•파기•권리의 연결 관리
