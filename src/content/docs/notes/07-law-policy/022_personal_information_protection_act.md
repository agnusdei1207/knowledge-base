...
- 배경/필요성: 무제한 처리로부터 **사생활·자기결정권 보호 필요**
...
| 수탁자·제3자 | 위탁·제공 근거 범위에서 처리 |
| 개인정보 보호책임자 | 내부통제·권리 대응·사고 예방 총괄 |
| 개인정보보호위원회 | 정책·법 집행·피해구제 감독 |
...
1. **목적·근거 고지·최소 수집**: 처리 목적·항목·기간·권리를 알리고 필요한 최소 정보만 수집
2. **위탁 범위·안전조치 지시**: 수탁자의 목적 외 처리 금지와 보호조치를 문서화하고 감독
3. **처리 현황·위험 보고**: 제공·접근·보유 현황과 침해 징후를 점검하여 처리자에게 보고
4. **열람·정정·삭제 등 요구**: 본인 확인 후 법정 권리의 수용·제한 근거와 조치 결과 통지
5. **권리 조치·보존 종료 파기**: 요구 결과를 반영하고 보유 목적이 끝난 정보를 복구 불가능하게 파기
