...
| 절차 | 핵심 활동 |
|:---|:---|
| 평가 범위·자료 요청 | 대상·모형·기준시점을 정하고 자료 기준 제시 |
| 지표 자료 제공 | 온라인 서비스·통신·인적 자본·참여 자료 확보 |
| 지수 산출·격차 진단 | 표준화한 지표를 결합하고 목표 대비 취약 영역 식별 |
| 개선 과제 실행 | 서비스 완결성·참여·접근성·기관 연계 개선 |
| 개선 성과 제출 | 개선 결과를 재측정하여 성숙 단계 갱신 |
