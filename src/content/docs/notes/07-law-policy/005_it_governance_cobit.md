...
- **EDM 영역**: EDM 영역은 경영진이 대안을 평가하고 방향·위험 한도를 지시하며 성과와 준수를 감독하는 거버넌스 영역이다.
...
- **3. 개선·위험 수용 결정 전송**: 거버넌스는 관리 활동의 증거를 목표와 위험 한도에 대조해 개선 조치나 잔여 위험 수용을 결정한다.
...
- **EDM**: EDM은 경영진의 평가·지시·감독을 담당하고 관리 영역은 승인된 방향을 계획·구축·운영한다.
