...
| 절차 | 설명 |
|:---|:---|
| 평가 항목·배점 공고 | 사업 목표와 위험에 맞는 기술 평가 기준·증빙·배점 공개 |
| 제안서·실증 자료 제출 | 제안자가 구현 방안·수행 조직·실적·검증 자료 제시 |
| 발표 평가·질의 | 제안 내용의 구체성·진위·위험 대응 가능성을 확인 |
| 독립 채점 결과 제출 | 위원이 이해충돌을 배제하고 근거와 함께 개별 채점 |
| 우선협상대상 통지 | 기술·가격 점수를 종합하여 순위와 협상 대상 결정 |
