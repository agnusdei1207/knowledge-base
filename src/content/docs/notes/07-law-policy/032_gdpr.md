...
- **개인정보 보호 규정**: GDPR은 개인정보 처리 원칙·정보주체 권리·조직 책임·국외이전을 EU 전역에서 직접 규율하는 개인정보 보호 규정이다.
...
- **위험·책임 기반성**: 위험·책임 기반성은 처리 위험에 비례해 영향평가·보호책임자·설계 통제를 적용하고 준수 증거를 보존하는 특성이다.
...
- **처리자**: 처리자는 개인정보 처리의 목적과 수단을 결정하며 수탁자에게 업무를 맡겨도 정보주체 권리와 준수 책임을 진다.
...
- **2. 열람·삭제·이동·반대 요구**: 처리자는 본인을 확인한 뒤 권리별 적용 조건·예외·처리 기한을 판단해 정보주체 요구에 응답한다.
...
- **이동권**: 이동권은 동의·계약에 근거해 자동 처리한 정보를 구조화된 기계 판독 형식으로 받거나 다른 처리자에게 보내게 할 권리다.
...
- **삭제권·법정 보존 충돌**: 삭제권·법정 보존 충돌은 정보주체의 삭제 요구와 세법 등 별도 법률의 보존 의무가 동시에 적용되는 문제다.
