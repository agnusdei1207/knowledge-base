...
date: "2026-07-30T13:49:00+09:00"
tags:
  - "notes-law_policy"
weight: 32
extra:
...
- **GDPR**은 유럽연합의 개인정보 처리 원칙·적법 근거·정보주체 권리·처리자와 수탁자의 책임·침해 대응·역외 적용·국외이전을 통합 규율하는 **개인정보 보호 규정**
- **배경/필요성**: 회원국별로 분산된 규율과 국경을 넘는 디지털 처리에서 정보주체 권리와 조직의 책임성을 일관되게 보장
...
| 절차 | 설명 |
|:---|:---|
| 목적·근거·처리정보 고지 | 목적·법적 근거·항목·보유기간·수신자·국외이전·권리를 명확히 안내 |
| 열람·삭제·이동·반대 요구 | 본인 확인 후 권리별 적용 조건·예외·기한을 판단하여 접수 |
| 위탁 범위·보안·권리 조치 지시 | 수탁자 계약에 목적 외 처리 금지·보안·재위탁·권리 지원·삭제 의무 반영 |
| 처리 증거·침해 사실 통보 | 수탁자가 지시 준수 증거와 침해 사실을 처리자에게 지체 없이 제공 |
| 고위험 협의·침해 신고 | 잔여 고위험은 감독기관과 사전 협의하고 침해는 가능한 경우 72시간 내 신고 |
...
| 핵심 특징 | 법정 사유가 있으면 개인정보 삭제 요구 | 구조화되고 통상적이며 기계 판독 가능한 형식으로 수령·이전 | 특정 근거의 처리 또는 직접 마케팅 중단 요구 |
| 한계 | 법적 보존·표현의 자유 등 예외 판단 필요 | 타인의 권리·자유와 기술적 가능성 고려 필요 | 우월한 정당한 근거와 법적 청구 예외 판단 필요 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 모든 처리를 동의에 의존 | 목적별 적법 근거와 특별 범주 예외를 처리기록에 매핑 | 동의 철회 후 불법 처리와 근거 오용 방지 |
| 삭제권과 법정 보존의 충돌 | 삭제 대상과 보존 의무 데이터를 분리하고 보존 근거·기간·접근 제한 기록 | 권리 보장과 법적 의무의 동시 충족 |
| 국외이전 근거와 실제 흐름 불일치 | 수신국·수신자·하위 수탁자·이전 도구·추가 보호조치를 데이터 흐름과 정기 대조 | 역외 처리의 투명성과 보호 연속성 확보 |
...
- 유럽연합 정보주체의 개인정보를 처리하려면 **목적별 적법 근거와 데이터 흐름을 기록하고 권리·위탁·국외이전·고위험 영향평가·72시간 침해 대응이 실제 작동한 증거로 GDPR 책임성을 입증하는 전 과정 관리** 필요
