...
- **생애주기 보안성**: 제조자는 제품을 안전하게 설계하고 지원기간 동안 취약점과 보안 업데이트를 관리
- **위험 비례성**: 제품의 중요도와 위험에 따라 자체 평가 또는 제3자 적합성 평가를 적용
- **공급망 책임성**: 수입자·유통업자는 CE 표시와 기술문서를 확인하고 부적합 제품의 유통을 차단하며, 오픈소스는 상업 활동과 관리자 역할에 따라 의무를 구분
