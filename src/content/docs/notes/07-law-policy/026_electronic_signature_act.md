...
- **보증수준**: 거래 금액·법적 효과·부정 사용 피해에 맞춰 정하는 본인확인과 인증 강도의 수준이다.
- **전자서명인증사업자**: 가입자 본인확인과 전자서명 생성·검증에 필요한 인증서비스를 제공하는 주체이다.
...
- **거래 위험·보증수준 결정**: 거래 금액·법적 효과·부정 사용 피해로 본인확인과 증거 수준 결정
...
- **보증수준**: 거래 피해와 법적 효과에 맞춰 인증수단의 본인확인 강도를 구분한 수준이다.
- **문서 해시·서명값 결합**: 서명 당시 원문의 해시와 서명값을 연결해 문서 변경 여부와 서명 의사를 함께 입증하는 방식이다.
...
- **원문 해시·검증 시각**: 서명 대상 문서의 무결성과 서명 검증 당시의 유효 상태를 장기간 입증하는 핵심 증거이다.
