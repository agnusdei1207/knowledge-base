...
#### 한줄 요약
- **국제표준**은 국가•산업 간 상호운용성•품질 기준을 합의한 규격이다.
...
#### 한줄 요약
- **합의 절차**는 **공식 합의**와 **개방 참여** 방식을 구분하며 **표준필수특허** 조건도 함께 다룬다.
...
#### 한줄 요약
- 각 **표준개발기구(SDO)**의 기술조직이 초안을 합의•투표해 산출물을 발행한다.
...
- **작업 항목•개발 범위 승인**: 담당 위원회•작업반•일정과 표준화 범위를 확정하는 단계이다.
- **기술 의견 해결•초안 개정**: 요구사항•규격과 공개 검토 의견을 조정하는 단계이다.
- **합의•투표 승인 결정**: 기구별 승인 규칙에 따라 최종 표준안의 채택 여부를 정하는 단계이다.
...
#### 한줄 요약
- **작업 항목•개발 범위 승인** 후 **합의•투표 승인 결정**으로 표준을 발행한다.
...
#### 한줄 요약
- 국가 회원 절차와 전문가 공개 절차의 차이를 산출물별로 구분한다.
...
#### 한줄 요약
- 대상 분야의 **적합성 평가**와 상호운용성 목표에 맞는 기구•산출물•승인 절차를 선택한다.
