...
- 정의/개념: 국제 권고•표준•RFC를 개발•승인•배포하는 **SDO**이다.
- 배경/필요성: 개별 규격만으로는 국가 간 **상호운용성 확보** 및 무역•안전 기준 통일하기 어렵다.

#### 한줄 요약
- 국가•산업 간 **상호운용성•품질 기준**을 합의가 핵심이다.
...
#### 한줄 요약
- **기술조직 초안**을 합의•투표해 표준 산출물 발행이 핵심이다.
...
1. **작업 항목•개발 범위 승인**: 담당 위원회•작업반•일정을 확정한다.
2. **기술 의견 해결•초안 개정**: 요구사항•규격 작성과 공개 의견을 조정한다.
3. **합의•투표 승인 결정**: 기구별 규칙에 따른 회원 합의와 공식을 승인한다.

#### 한줄 요약
- 작업 항목을 정하고 **기술 합의•투표** 후 표준 발행이 핵심이다.
...
#### 한줄 요약
- 국가 규격은 **회원 기구형**, 인터넷 구현은 **기술 공동체형**이 핵심이다.
...
#### 한줄 요약
- **판•개정연도•프로파일**을 고정해 호환성 오류 차단이 핵심이다.
...
- 공식 합의는 **ITU•ISO•IEC**, 구현 합의는 **IEEE•IETF** 중심으로 선정이 핵심이다.

#### 한줄 요약
- 대상 분야에 맞는 **기구•산출물•승인 절차**를 선택한다.
