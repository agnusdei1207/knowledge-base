...
- **정의/개념**: 기술 규격을 합의·제정하는 국제 기구
- **배경/필요성**: 국가·기업 간 규격 불일치 해소
...
- IEEE SA는 전문가 참여로 기술 표준을 개발한다.
- IETF는 공개 토론·구현 경험으로 RFC를 발행한다.
- 기구 간 협력이 표준 중복을 줄인다.
...
2. 표준 특허 라이선스 조건 및 침해 리스크 분석

### 쉽게 이해하기 (학습용)
- 신기술 적용 시 해당 규격의 승인 연도와 유효한 버전 번호를 추적해 호환성 오류를 차단합니다.
- 표준 규격을 무단으로 상용화했을 때 지불해야 할 특허 로열티 조건(RAND 등)과 특허 침해 여부를 법률 검토합니다.
