...
date: "2026-08-06T17:35:00+09:00"
tags:
  - "notes-law_policy"
weight: 21
extra:
...
- **AI•데이터 확산**에 따른 **국가 정책•권리 보호** 기본법

## Ⅱ. 특징

<details><summary>핵심 용어</summary>

- **계획 연계성**: 종합계획과 기관 실행계획의 목표•사업•예산 연결
- **기반 조성**: 지능정보서비스에 필요한 데이터•기술•표준•전문인력을 확보하는 정책 기능이다.
- **활용 촉진**: 지능정보서비스의 공공•민간 도입과 이용을 넓히는 정책 기능이다.
- **투자 조정성**: 계획 점검•예산 의견•중복 방지의 사업 조정
...
- **종합계획**에 맞춰 매년 **실행계획•추진 실적** 작성

## Ⅴ. 종류 및 비교

<details><summary>핵심 용어</summary>

- **기본법**: 분야의 정책 방향•책무•계획 체계를 정한 법률
- **개별 사업법**: 서비스•기술•산업의 인허가•지원•의무 법률
- **인공지능**: 학습•추론으로 분류•예측•생성을 수행하는 기술
