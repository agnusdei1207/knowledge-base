...
date: "2026-07-25T22:36:00+09:00"
tags:
  - "notes-law_policy"
weight: 21
extra:
...
- 종합계획과 연도별 실행계획으로 정책을 연계한다.
- 데이터·기술·인력 기반을 조성해 활용을 촉진한다.
- 접근성·교육 지원으로 정보격차 완화를 추진한다.
- 역기능 예방과 이용자 보호를 진흥 정책에 결합한다.
...
| 정책 초점 | 인공지능 윤리 및 디지털 포용 | 유무선 인프라 및 전자정부 구축 |
| 관리 항목 | 역기능 방지 및 정보 격차 해소 | 통신망 보안 및 정보시스템 안전성 |
...
1. AI기본법·개인정보보호법 요건 비교
2. 공공 서비스 취약계층의 웹 접근성 수준 및 정보 격차 측정

### 쉽게 이해하기 (학습용)

- 공공 지능정보화사업은 기본법의 계획·포용 기준과 인공지능기본법·개인정보 보호법의 개별 의무를 구분해 검토합니다.
- 고령층과 장애인이 모바일 신분증이나 무인 단말기를 어려움 없이 사용할 수 있도록 공공 웹과 앱의 편의성 검사를 철저히 수행한다.

## Ⅶ. 결론

- 기본계획에 포용성과 영향평가를 반영한다
