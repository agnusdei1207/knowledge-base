...
- **과제 포트폴리오**: 후보 과제의 타당성과 의존성을 함께 비교해 투자심의에 제출하는 통합 목록이다.
...
- **전사 아키텍처(Enterprise Architecture, EA)**: 현행 시스템과 표준 구조를 기준으로 신규 과제의 중복·통합 가능성을 검토하는 체계이다.
...
- **효과·시급성·실행성**: 과제의 기대 성과, 추진 시점의 긴급성, 자원·역량으로 완수할 가능성을 함께 비교하는 우선순위 기준이다.
