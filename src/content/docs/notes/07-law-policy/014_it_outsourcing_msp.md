...
| 절차 | 핵심 활동 |
|:---|:---|
| 위탁 요구·책임 제시 | 위탁 범위·통제권·이행 주체와 책임 경계 정의 |
| 서비스 수준·이행안 합의 | 측정 가능한 품질 목표·보고·보상 조건 계약 |
| 운영 성과·위험 보고 | 비용·가용성·장애·보안 지표와 개선 필요 사항 제출 |
| 개선·변경 승인 | 목표 미달의 원인을 분석하고 고객이 개선·변경 여부 결정 |
| 자산·데이터·지식 이전 | 계약 종료 조건에 따라 후속 사업자로 안전하게 전환 |
