...
date: "2026-07-25T22:29:00+09:00"
tags:
  - "notes-law_policy"
weight: 14
extra:
...
- **약어 읽기·표기**: MSP는 ‘엠에스피’, SLA는 ‘에스엘에이’, SLM은 ‘에스엘엠’으로 읽으며 영문 정식명의 머리글자로 제공사·서비스 약속·관리 활동을 구분함
- **시퀀스 기호(->>·opt/end)**: ‘요청 전달·선택 절차’로 읽고 계약 종료 시 출구 전략을 수행하는 조건 흐름을 나타냄

## Ⅰ. 개요

- **정의/개념**: IT 업무 외부 위탁 및 책임 기반 성과 통제
- **배경/필요성**: 전문 역량 활용과 위탁 위험 관리 필요
...
- MSP가 비용·성능·보안을 지속 관리한다.
- 핵심 통제권과 내부 기술 역량을 유지해야 한다.
...
| 판단 기준 | IT 아웃소싱 | MSP |
|:---|:---|:---|
| 적용 대상 | 인프라 운영 및 개발 인력 위탁 | 멀티·하이브리드 클라우드 최적화 |
| 계약 성과 | 업무 범위 및 인력 투입 중심 | 서비스 수준(SLA) 및 비용 지표 중심 |
| 주요 위험 | 범위 분쟁 및 내부 기술 역량 약화 | 플랫폼 종속 및 접근 권한 통제 결여 |
...
1. 태깅 체계 기반 클라우드 멀티 계정 비용 추적 관리
2. 아웃소싱 계약 종료를 고려한 소스 코드 및 데이터 반환

### 쉽게 이해하기 (학습용)
- 클라우드 자원에 부서와 용도 태그를 붙여 계정별 비용과 불필요한 사용을 추적합니다.
- 계약 종료 조건에 소스 코드·데이터·운영 문서의 반환 형식과 검증 절차를 명시합니다.

## Ⅶ. 결론

- 출구 전략을 수립하고 SLA 기반 지속 평가 체계 구축
