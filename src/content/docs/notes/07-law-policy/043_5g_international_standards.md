...
- **성능 기준성**: ITU-R은 IMT-2020의 성능 요구와 후보 무선 인터페이스 평가·승인 권고를 관리
- **상세 규격성**: 3GPP는 RAN과 SA·CT 작업을 통해 NR·코어망의 상세 구현 규격을 개발
- **단계 상용성**: 3GPP 릴리즈별 기능 동결과 지역 표준 채택 및 장비 호환 검증을 거쳐 상용화
...
block-beta
    columns 3
    I["ITU-R·IMT-2020"]:3
    R["3GPP RAN"] S["3GPP SA·CT"] E["지역 표준·산업 생태계"]
    I -- R
    I -- S
    R -- E
    S -- E
