...
date: "2026-07-31T05:54:55+09:00"
tags:
  - "notes-law-policy"
weight: 43
extra:
...
- IMT-2020 요구와 무선 승인을 다루는 **성능 기준성**
- NR·코어망 구현 규격을 만드는 **상세 규격성**
- 릴리즈 동결·채택·호환 검증을 거치는 **단계 상용성**
...
| Release 19 동결·20 진행 | 제품 기준은 동결본, 선행 개발은 **Release 20** 추적 | 버전 선택의 **시점 오류** 방지 |
