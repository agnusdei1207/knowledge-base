...
- **정의/개념**: ITU·3GPP가 분담하는 5G 국제 표준
- **배경/필요성**: 기기 상호운용·글로벌 로밍 보장
...
- 릴리즈 15는 5G, 18은 5G-Advanced를 연다.
- 지역 기관 승인 연계가 상용화를 확산한다.
...
1. 5G-Advanced 릴리즈 18 규격 기술 검토
2. 단말과 기지국 코어망 간 규격 릴리즈 일치 검증

### 쉽게 이해하기 (학습용)
- 5G 성능 고도화를 위해 도입된 릴리즈 18의 빔포밍 기술과 위성 통신 결합 사양을 사전 검증합니다.
- 단말기 모뎀과 통신사 기지국이 서로 다른 릴리즈 사양으로 구성될 경우 통신 단절이 발생하므로 세부 버전을 조율합니다.
