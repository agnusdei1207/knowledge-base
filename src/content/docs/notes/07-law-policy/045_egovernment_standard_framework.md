...
- **개방 표준성**: 오픈소스 기반의 공개 구조와 표준 인터페이스로 특정 상용 벤더 종속을 완화
- **전주기 지원성**: 개발환경·실행환경·운영관리환경을 연계해 구현부터 배포·운영까지 공통 기반을 제공
- **재사용·호환성**: 공통컴포넌트를 표준 확장점에 결합하고 지원체계의 적용 가이드와 호환성 확인으로 외부 연동 위험을 통제
