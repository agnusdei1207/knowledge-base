...
| 절차 | 설명 |
|:---|:---|
| 사업·기술·표준 요구 전달 | 공공 사업의 기능과 품질 및 적용 지침 식별 |
| 버전·구조·공통컴포넌트 지정 | 지원 기준과 재사용 범위 및 확장 방식 확정 |
| 표준 확장점·업무 로직 구현 | 공통 기능을 재사용하고 기관별 업무를 분리 개발 |
| 아키텍처·제품 호환성 검증 요청 | 외부 라이브러리·WAS·연계 제품의 충돌 확인 |
| 운영 전환·관측 결과 보고 | 배포·모니터링·변경관리 절차를 구성해 서비스 인계 |
