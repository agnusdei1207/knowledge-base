...
- **융합 영향 분석**: 사이버 침해가 정보기술(Information Technology, IT)과 운영기술(Operational Technology, OT)의 연결을 통해 물리 설비와 국민 안전으로 확산하는 영향을 분석하는 방식이다.
...
- **중앙행정기관·위원회**: 후보 시설의 지정 여부를 심의하고 기반시설 보호정책과 기관 간 역할을 조정하는 주체이다.
...
- **취약점 분석·평가**: 정보기술·운영기술 자산의 위협·취약점·업무 영향을 분석하여 보호대책의 근거를 만드는 절차이다.
- **보호대책**: 평가한 위험의 우선순위에 따라 예방·탐지·대응·복구 통제를 수립하고 시행하는 계획이다.
...
- **지정 후보·파급성 심의**: 업무 중요도·대체 가능성·상호의존성과 침해 피해 규모 분석
- **기반시설 지정 결과 통보**: 심의 결과와 관리기관의 보호 의무·대상 범위 명확화
- **취약점 분석·평가**: 정보기술·운영기술 자산의 위협·취약점·업무 영향 평가
- **보호대책 수립·시행**: 위험 우선순위에 따라 예방·탐지·대응·복구 통제 이행
...
- **정보통신기반 보호법**: 주요정보통신기반시설의 지정·취약점 분석·보호대책을 규율하는 법률이다.
...
- **공급망·연계 위험**: 협력업체·외부 접속·다른 기반시설과의 의존 관계를 통해 침해와 장애가 시설 경계 안으로 확산하는 위험이다.
- **보완통제·단계 패치**: 즉시 패치하기 어려운 운영기술에 대체 보호조치를 먼저 적용하고 검증된 순서로 패치를 배포하는 방식이다.
- **격리·오프라인 복구**: 침해 구간을 분리하고 공격자가 접근할 수 없는 백업으로 핵심 기능을 안전하게 복원하는 대응이다.
...
- **정보기술(Information Technology, IT)·운영기술(Operational Technology, OT) 위험**: 정보망과 제어망의 연결을 통해 사이버 침해가 물리 공정으로 확산하는 위험이다.
- **공급망 위험**: 협력업체·외부 서비스·납품 장비의 취약점이나 침해가 기반시설에 전파되는 위험이다.
