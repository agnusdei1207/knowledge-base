...
- **침해사고 탐지•판단**: 보안 경보와 조사 정황으로 침해 여부와 법적 인지 시각을 확정하는 활동이다.
- **확산 억제•복구**: 공격 경로를 차단하고 취약점을 보완한 뒤 안전성을 확인하여 서비스를 복원하는 활동이다.
- **증거 보존•조사 협력**: 로그•메모리•시스템 이미지를 보전하고 관계기관의 원인 조사에 제공하는 활동이다.
...
- **한국인터넷진흥원(Korea Internet & Security Agency, KISA)**: 침해사고 신고를 접수하고 원인 조사와 복구를 기술적으로 지원하는 기관이다.
...
- **정보통신망법**: 정보통신서비스 제공자의 침해사고 신고와 정보통신망 보호조치를 규율하는 법률이다.
...
- **인지 시각•근거**: 조직이 침해사고를 안 시각과 그 판단에 사용한 경보•티켓•조사 정황으로, 신고 기한을 입증하는 기록이다.
...
- **공동 대응**: 사업자•정부•한국인터넷진흥원(Korea Internet & Security Agency, KISA)이 사고 정보를 공유하여 확산 차단과 공통 원인 분석을 수행하는 체계이다.
