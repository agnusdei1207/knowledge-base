...
date: "2026-08-06T19:47:00+09:00"
tags:
  - "notes-law-policy"
weight: 41
extra:
...
- 정의/개념: **오픈소스 컴플라이언스•SBOM**은 구성•의무•취약점을 관리하는 **공급망 준수 체계**
- 배경/필요성: 직접 의존성만으로는 전이 버전•배포 의무•**신규 취약점** 추적 곤란

#### 한줄 요약
- 직접•전이 구성의 **라이선스•취약점 위험** 추적
...
#### 한줄 요약
- **법률 의무•취약점 영향**을 분리 검증해 배포 증적 보존
...
2. **라이선스•취약점 조치 판정**: 배포 의무와 CVE 도달성•VEX 상태 판정
3. **고지•소스•VEX 배포 준비**: 예외 심사와 의무 이행 후 출시 승인
4. **신규 취약점•구성 변경 대조**: 운영 중 SBOM을 신규 CVE•변경과 대조

#### 한줄 요약
- 배포본 **구성 동일성** 확인 후 신규 취약점과 지속 대조
