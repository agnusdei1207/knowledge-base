...
- 정의/개념: **디지털 트윈(Digital Twin)** 은 물리 대상과 상태·이력을 동기화하는 생애주기 가상 표현
...
- **사물인터넷(IoT)**: 센서와 통신을 이용해 물리 대상의 상태와 사건을 수집하는 기술이다.
...
**사물인터넷(Internet of Things, IoT)** 센서가 물리 대상의 상태를 수집해 트윈 상태 저장소를 갱신한다.
...
| 물리·가상 연계 수준 | 디지털 모델(Digital Model) | 디지털 섀도(Digital Shadow) | 디지털 트윈(Digital Twin) |
|:---|:---|:---|:---|
