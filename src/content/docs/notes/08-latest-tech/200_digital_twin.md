...
date: "2026-08-14T11:26:00+09:00"
tags:
  - "notes-latest-tech"
weight: 200
extra:
...
- 정의: **디지털 트윈** 기반 물리 대상과 상태•이력을 동기화하는 생애주기 가상 표현임이다.
...
- **IoT 센서•사건** 및 이력 기반 **트윈 상태 동기화** 핵심임.
- 모델•시뮬레이션 기반 **고장•변경 영향 예측** 핵심임.
- **ISO 23247** 기반 생애주기 연계와 **승인•안전 피드백** 핵심임.
...
**IoT 센서** 물리 대상의 상태를 수집해 트윈 상태 저장소를 갱신한다.
