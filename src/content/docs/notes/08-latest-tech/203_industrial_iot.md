...
date: "2026-08-14T11:44:00+09:00"
tags:
  - "notes-latest-tech"
weight: 203
extra:
...
- 정의: 산업 설비•센서를 연결해 공정을 감시•분석•제어하는 **IIoT 체계**임이다.
...
- 기존 설비 데이터를 변환•정제하는 **산업 자산•에지 연결** 핵심임.
- 장애 버퍼링•품질 검증을 적용한 **신뢰성 있는 데이터 흐름** 핵심임.
- 중앙 장애에도 로컬 제어를 유지하는 **현장 자율성** 핵심임.
#### 한줄 요약
...
- **저장 후 전달•로컬 인터록** 기반 통신 단절 시 현장 자율성 유지
