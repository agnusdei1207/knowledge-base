...
date: "2026-08-14T08:56:00+09:00"
tags:
  - "notes-latest-tech"
weight: 175
extra:
...
1. 개발 여정•병목 전달: 반복 작업•대기•인지부하 문제 탐색
2. 권장 경로•정책 전달: 골든 패스•탈출 경로 설계
3. 셀프서비스 기능 전달: 포털•템플릿으로 공통 기능 노출
4. 채택•미사용 피드백 전달: 채택률•미사용 원인으로 개선
...
- **대기•인지부하 감소•자발적 채택**을 기준으로 플랫폼 개선
