...
- 정의/개념: **사고 트리(ToT)**는 여러 사고 상태를 탐색 트리로 분기하고 후보를 평가·가지치기하여 해법을 찾는 추론 탐색 기법
...
- **BFS·DFS**: 동일 깊이 우선 또는 단일 경로 우선 탐색
...
- **ToT 적용 기준**: 여러 대안의 비교와 초기 오류 회복 이득이 추가 탐색 비용보다 클 때 사용한다.
