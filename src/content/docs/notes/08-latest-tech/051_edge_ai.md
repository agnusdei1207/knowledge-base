...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "Edge AI (엣지 AI)"
date: "2026-08-26T16:55:33+09:00"
tags:
  - "notes-latest_tech"
weight: 51
extra:
...
- 배경/필요성: 모든 센서 데이터를 중앙 클라우드로 올리면 대역폭과 왕복 지연 비용을 데이터량에 비례해 지불하고 단절 시 제어가 끊기므로, 단말과 클라우드 사이 현장 노드에 추론 계층을 끼워 넣어 원본은 가까이에서 처리하고 요약만 중앙으로 올림
