...
- 정의/개념: 데이터 발생 현장에 인접한 장치•게이트웨이에서 추론과 제한된 제어를 수행하는 **엣지 인공지능(Edge Artificial Intelligence, Edge AI)**
...
| 중앙 제어면 | **장치 신원•모델 버전•무선 업데이트(Over-the-Air Update, OTA Update) 관리** |
...
- **엣지 인공지능(Edge Artificial Intelligence, Edge AI)**: 현장 인접 게이트웨이가 다수 장치의 저지연 추론과 제어를 담당한다.
...
| 이기종 장치별 **무선 업데이트(Over-the-Air Update, OTA Update) 호환성 불일치** | 장치군별 **단계 배포•롤백** | 현장 장비의 **버전 파편화** 억제 |
