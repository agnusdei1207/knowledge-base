...
date: "2026-07-31T12:11:25+09:00"
tags:
  - "notes-latest_tech"
weight: 155
extra:
...
- **균형 축**: 단계 불균형은 유휴 시간, 세분된 텐서 분할은 통신 대기 증가
...
> 요약: **파이프라인 병렬**은 계층, **텐서 병렬**은 단일 연산 분할
...
- 계층 분할 가능은 **파이프라인 병렬**, 단일 계층 초과는 **텐서 병렬** 선택
