...
- 배경/필요성: 정적 필터는 **변형 지시** 활용 놓치고 정상 요청을 과잉 차단
...
> 요약: **탈옥 공격** 정책, **프롬프트 인젝션** 업무 지시 변경이 핵심이다.
