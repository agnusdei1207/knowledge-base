...
date: "2026-08-14T06:12:00+09:00"
tags:
  - "notes-latest_tech"
weight: 121
extra:
...
- 정의/개념: 악성 표본으로 결정 경계를 조작하는 **데이터 오염** 공격
- 배경/필요성: 입력 형식 검사만으로 **논리 오류•백도어** 탐지 곤란
...
1. **악성 표본 주입**: 라벨•특징 조작 표본을 데이터셋에 삽입
2. **오염 배치 유입**: 검증을 우회한 표본이 학습 배치에 포함
3. **경계 왜곡 학습**: 오염 분포가 모델 파라미터에 전이
4. **트리거 입력**: 공격자가 백도어 발동 패턴을 제공
5. **오작동 유발**: 표적 오판•성능 저하로 피해 발생
