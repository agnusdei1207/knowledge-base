...
- 배경/필요성: 문맥창만으로 **장기 연속성•세션 간 경험 재사용** 확보하기 어렵다.

#### 한줄 요약
- **상태•지식•경험**을 목적별 저장•검색•정리가 핵심이다.
...
- **분리 축**: 작업•의미•일화 기억을 목적별 저장한다.
- **기억 검색**: 의미•시간•중요도로 관련 기억을 선택한다.
- **기억 통합**: 경험 요약•정정•만료•삭제로 오염을 통제한다.

#### 한줄 요약
- **관련성•최신성•권한**으로 기억을 검색•통합•삭제가 핵심이다.
...
1. **가치•민감도별 분류 저장**: 기억 유형•권한•보존 기간을 결정한다.
2. **의미•시간•권한 후보 조회**: 접근 권한 후 관련성•최신성을 평가한다.
...
> 요약: 현재 상태에는 **작업 기억**, 장기 경험•지식에는 **일화•의미 기억**을 적용한다.
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 오래된 기억의 **사실 오염** | **출처•시각•유효기간•정정 이력** 저장 | 최신 사실의 **우선 검색** |
| 민감 기억의 **과다 노출** | **주체•목적 접근통제•권한 필터** 적용 | 기억 검색의 **최소 권한** 보장 |
| 유사하지만 무관한 **기억 간섭** | **관련성•최신성•신뢰도 재순위** 후 주입 | 문맥의 **정확도•집중도** 향상 |
| 무제한 축적에 따른 **비용 증가** | **통합•요약•만료•삭제 정책** 운영 | 저장•검색 비용과 **기억 품질** 통제 |

#### 한줄 요약
- **작업 상태•해결 이력**을 분리해 관련 사례 검색이 핵심이다.
...
- 현재 상태는 **작업 기억**, 세션 간 경험•사실은 **장기 기억**을 선택한다.

#### 한줄 요약
- **출처•최신성•권한**으로 기억 검색 후 노후 정보 삭제가 핵심이다.
