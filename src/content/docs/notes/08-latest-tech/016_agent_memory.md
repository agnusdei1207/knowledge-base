...
- 정의/개념: 상태•지식•경험을 저장•검색•갱신하는 **에이전트 메모리**
- 배경/필요성: 문맥창만으로 **장기 연속성•세션 간 경험 재사용** 확보가 곤란

#### 한줄 요약
- **상태•지식•경험**을 목적별 저장•검색•정리
...
> 요약: 현재 상태에는 **작업 기억**, 장기 경험•지식에는 **일화•의미 기억** 적용
