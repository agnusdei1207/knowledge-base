...
- 정의/개념: 첫 토큰 이후 출력 토큰 하나를 생성하는 평균 지연인 **TPOT**
...
- KV Cache 대역폭이 낮거나 배치•동시성이 크면 **디코드 지연 증가**
...
선의 의미: 배치•캐시•로짓•선택•전송 책임의 정적 연결
...
- p95 TPOT의 원인이 대역폭이면 **KV 공유•캐시 양자화**, 배치면 **동시 요청 상한** 적용

#### 한줄 요약
- **p95 TPOT 병목**에 따라 캐시•배치 대책 선택
