...
date: "2026-08-06T20:56:00+09:00"
tags:
  - "notes-latest_tech"
weight: 15
extra:
...
- 정의/개념: 목표를 작업•의존성•완료 조건으로 바꾸는 **에이전트 플래닝**
- 배경/필요성: 단일 행동 선택은 장기 과업의 **누락•순서 오류•목표 이탈** 유발

#### 한줄 요약

- **작업•의존성 계획**을 세우고 환경 변화 시 부분 재계획
...
> 요약: 장기 계획에는 **Plan-and-Execute**, 즉시 적응에는 **ReAct** 적용
...
- 장기 의존 과업은 **전체 계획**, 변화 발생 시 **부분 재계획**
