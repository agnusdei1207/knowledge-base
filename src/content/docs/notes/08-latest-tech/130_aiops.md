...
- **사건 분석 엔진**: 경보를 군집하고 이상 패턴을 탐지해 운영 사건을 구성하는 구성요소이다.
...
- **경보 군집**: 관련된 여러 경보를 하나의 사건으로 묶어 중복을 줄이는 처리하는 개념이다.
...
- 원인 신뢰도•가역성이 낮으면 **사람 승인**, 높으면 **런북 자동 실행** #### 한줄 요약
