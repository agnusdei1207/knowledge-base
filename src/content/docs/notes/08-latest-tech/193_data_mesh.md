...
- 배경/필요성: 중앙 데이터팀 방식은 요청 병목이 발생하고 업무 의미가 전달 과정에서 단절되며 데이터 품질 책임이 불명확해진다.
...
- **1. 데이터 의미·품질·생애주기의 종단 책임**: 도메인 팀이 데이터 의미·품질·생애주기의 종단 책임을 가진다.
- **2. 소비자 중심으로 제공**: 데이터 제품은 계약·문서·SLO를 갖춰 소비자 중심으로 제공된다.
- **3. 분산 자율성과 전사 상호운용성을 연결**: 셀프서비스 플랫폼과 연합 거버넌스가 분산 자율성과 전사 상호운용성을 연결한다.
### 쉽게 이해하기 (학습용)
