...
date: "2026-08-04T16:13:00+09:00"
tags:
  - "notes-latest-tech"
weight: 193
extra:
...
- 정의/개념: 도메인 팀이 데이터 제품의 소유•품질•운영을 책임지는 **데이터 메시 운영 모델**
- 배경/필요성: 중앙 데이터팀은 요청 증가 시 처리 병목•업무 의미 단절과 **품질 책임 공백** 발생

#### 한줄 요약

- 도메인별 데이터 제품 책임과 공통 플랫폼•전사 규칙의 결합
...
- 도메인 제품팀•셀프서비스 플랫폼•연합 거버넌스의 역할 분리
...
- 소비 요구 기반 제품 계약•정책 검증•카탈로그 게시와 피드백
