...
- 정의: 적층 **DRAM** 및 **초광폭 인터페이스** 기반 가속기에 고대역폭을 제공하는 근접 메모리이다.
- 배경/필요성: 보드 메모리의 좁은 **핀 폭**으로는 다량의 가속기 데이터 **공급 불가** #### 한줄 요약

- 적층 DRAM•TSV•초광폭 채널로 **병렬 데이터 공급** ## Ⅱ. 특징
...
**인터포저** 기반 가속기와 **HBM** 연결하고, **TSV** 기반 적층 **DRAM** 다이를 수직으로 잇는다.
...
- TSV•인터포저•독립 채널의 **수직•수평 연결 구조** ## Ⅳ. 흐름도
...
**HBM**, **GDDR**, **DDR** 대역폭•비용•용량 확장성의 우선순위가 다르다.
...
> 요약: **HBM** 대역폭, **GDDR** 비용, **DDR** 용량 중심

#### 한줄 요약

- 대역폭•비용•용량 확장성에 따른 **메모리 선택** ## Ⅵ. 실무 고려사항 및 대책
...
- 대역폭 병목은 **HBM**, 용량 우선은 **DDR** 선택해 **메모리 계층** 구성
