...
- 배경/필요성: 범용 프로세서는 제한된 전력에서 **정수 텐서 처리량•종단 지연** 동시에 충족하기 어렵음.

#### 한줄 요약
- 완전 **INT8 지원 연산** 대상 특화된 저전력 ASIC
...
#### 한줄 요약
- 제어는 **CPU**, 범용 병렬은 **GPU**, INT8은 **Edge TPU** ## Ⅵ. 실무 고려사항 및 대책
...
- **INT8 품질•지원률** 충족 시 Edge TPU, 미지원 연산은 **CPU 폴백** #### 한줄 요약
