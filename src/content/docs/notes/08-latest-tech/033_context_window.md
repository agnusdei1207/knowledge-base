...
date: "2026-08-06T22:08:00+09:00"
tags:
  - "notes-latest_tech"
weight: 33
extra:
...
- 배경/필요성: 지시•대화•근거•출력이 **토큰 예산**을 공유해 입력 증가 시 출력 공간 축소

#### 한줄 요약
- **입력•출력 토큰**이 하나의 길이 한도를 공유
...
4. **어텐션 계산•KV Cache 생성**: 프리필 결과를 저장하여 후속 생성에서 **키•밸류 재사용**
...
- 전체 상호 참조에는 **롱 컨텍스트**, 일부 근거에는 **RAG**, 전역•최신 결합에는 **혼합 방식** 선택

#### 한줄 요약
- **상호 참조 범위•비용**에 따라 롱 컨텍스트•RAG 선택
