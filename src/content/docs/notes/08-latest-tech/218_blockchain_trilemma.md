...
- 배경/필요성: 블록체인의 처리량을 높이면 검증 장비가 고사양화돼 검증자가 집중되거나 합의 구조의 공격면이 커질 수 있다.
...
- **1. 탈중앙화**: 검증자 수·다양성·집중도로 참여와 통제 분산을 평가한다.
- **2. 보안성**: 공격 비용·합의 안전성·장애 복구력으로 장부 신뢰를 평가한다.
- **3. 확장성**: 처리량·확정 지연·수수료를 높이되 새 신뢰 가정을 확인한다.
### 쉽게 이해하기 (학습용)
