...
date: "2026-08-26T16:51:37+09:00"
tags:
  - "notes-latest_tech"
weight: 8
extra:
...
- 배경/필요성: 호스트가 서버마다 직접 붙으면 연결·세션·추적 구현을 서버 수만큼 중복 지불하고 보안 경계도 각 연동이 따로 지켜야 하므로, 호스트와 서버 사이에 연결 하나당 하나씩 대응하는 클라이언트 계층을 두어 중개와 경계 유지를 일원화
