...
date: "2026-08-14T11:56:00+09:00"
tags:
  - "notes-latest-tech"
weight: 205
extra:
...
- 정의: 차량 소프트웨어를 원격 검증•설치•복구하는 **OTA Update 체계**임이다.
- 배경/필요성: 방문•수동 갱신은 **정비 비용 증가•결함 대응 지연** 초래함.
...
- 패키지 서명•암호화•인증서 기반 **종단 간 신뢰성** 핵심임.
- 애플리케이션 **SOTA**부터 ECU 펌웨어 **FOTA**까지 **호환성•안전 설치**
- 소규모 배포와 실패 중단•롤백의 **단계 배포•복구성** 핵심임.
#### 한줄 요약
...
- 서명•호환성 검증 후 **A/B 슬롯** 기반 **단계 배포•자동 롤백** 적용함.

#### 한줄 요약

- **서명•호환성•단계 배포•자동 롤백** 갖춘 OTA만 적용
