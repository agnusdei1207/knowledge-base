...
- 정의: **SASE** 기반 **SD-WAN** 연결과 **SSE** 활용 분산 서비스 거점에서 통합하는 아키텍처임이다.
- 배경/필요성: 중앙 백홀은 분산 사용자•클라우드 접속의 지연•병목과 **정책 편차** 활용 유발함.
#### 한줄 요약
...
- **SD-WAN**•**SSE** 기반 **연결•보안 정책 통합** 핵심임.
- **ZTNA** 기반 사용자•장치•애플리케이션의 **지속적 접근 판정** 핵심임.
- 인접 **PoP** 기반 **백홀 지연 감소** 및 거점 품질 의존이 핵심임.
#### 한줄 요약
...
분산 **PoP** **SSE** 접근 검사, **SD-WAN** 경로 제어, **ZTNA** 집행
