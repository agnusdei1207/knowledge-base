...
- **배경/필요성**: 사용자 인접 거점에서 연결 경로와 보안 정책을 일관되게 집행하기 위함이다
### 쉽게 이해하기 (학습용)
...
1. 다지점 매장은 가까운 엣지에서 SaaS 보안 검사와 경로 선택을 수행한다
2. 원격 사용자는 신원·장치 검증 후 허용된 사설 앱에만 접속한다
...
- 분산 사용자는 거점 품질과 연결·보안 통합 범위로 SASE를 선택한다

### 쉽게 이해하기 (학습용)

- 필요한 연결·보안 범위를 정하고 실제 지역별 지연과 통제 효과를 측정해야 한다.
