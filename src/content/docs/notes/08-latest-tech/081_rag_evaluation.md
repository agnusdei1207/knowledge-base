...
date: "2026-08-14T04:52:00+09:00"
tags:
  - "notes-latest_tech"
weight: 81
extra:
...
- 배경/필요성: 최종 답변 점수만으로는 **검색 누락•생성 오류 구분 곤란** #### 한줄 요약
...
1. 품질 목표•기준 표본 정의: 질의별 기준 근거•답과 **합격 임계값** 설정함.
2. 질의 실행•로그 수집: 검색 후보•문맥•응답•인용을 **동일 실행 식별자** 기반 연결함.
3. 검색 회수•순위 측정: 기준 근거 포함 여부와 첫 관련 문서의 **검색 품질** 계산함.
4. 충실성•관련성 측정: 답변 주장의 문맥 지지와 질의 대응의 **생성 품질** 계산함.
