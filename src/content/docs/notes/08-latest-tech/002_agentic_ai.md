...
date: "2026-08-06T20:08:00+09:00"
tags:
  - "notes-latest_tech"
weight: 2
extra:
...
- 정의/개념: 목표 분해•도구 실행•관찰•재계획을 반복하는 **Agentic AI**
- 배경/필요성: 생성형 AI의 단발 응답으로는 **장기 상태•완료 조건•예외 복구 관리 불가**

#### 한줄 요약
- **Agentic AI**가 목표를 작업으로 나누고 완료까지 수행
...
> 요약: **Agentic AI** 중심 목표 실행, **Generative AI** 중심 콘텐츠 생성

#### 한줄 요약
- 단발 생성은 **Generative AI**, 목표 반복은 **Agentic AI**
...
- 장기•다단계 목표는 **Agentic AI**, 고영향 행동은 **HITL 승인** 적용

#### 한줄 요약
- **승인 지점•중단•복구 절차**로 자율성 범위 통제
