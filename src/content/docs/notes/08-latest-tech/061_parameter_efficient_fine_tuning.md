...
- **PEFT 주입 구성**으로 유형•대상 층•모듈 크기 지정
...
#### 한줄 요약
- **주입 위치•추론 경로**에 따라 Adapter•Prompt•LoRA 선택
