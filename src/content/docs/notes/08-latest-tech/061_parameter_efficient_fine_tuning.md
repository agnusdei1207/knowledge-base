...
- 정의: 기반 가중치를 동결하고 소수 파라미터만 학습하는 **PEFT**이다.
- 배경/필요성: 전체 파인튜닝의 **학습•저장•업무별 배포 비용 증가** #### 한줄 요약
- 기반 모델 고정과 **소수 파라미터 학습** ## Ⅱ. 특징
...
- 중간층 삽입은 **Adapter**, 입력 조정은 **Prompt Tuning**, 변화량 적응은 **LoRA** | 구분 | Adapter | Prompt Tuning | LoRA |
|:---|:---|:---|:---|
...
- 중간 표현은 **Adapter**, 입력 조정은 **Prompt Tuning**, 선형층 변화량은 **LoRA** 선택
