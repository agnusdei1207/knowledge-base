...
date: "2026-07-31T08:47:07+09:00"
tags:
  - "notes-latest_tech"
weight: 104
extra:
...
- **설명 가능한 AI(XAI)**: AI의 판단 근거를 사람이 이해하고 검증할 수 있는 형태로 제공하는 기술이다.
- **판단 근거**: 모델 출력에 영향을 준 특징·규칙·사례 또는 내부 관계를 나타내는 정보이다.

</details>

- 정의/개념: AI의 **판단 근거**를 사람이 이해·검증할 형태로 제공하는 기술
- 배경/필요성: 예측값만으로 **오류 원인·편향**과 이의제기 근거 확인 곤란
...
- **1. 예측·모델 정보 전달**: 기여도·규칙·사례 산출에 필요한 정보 제공
- **2. 설명 산출물 전달**: 사용자 역할에 맞는 판단 근거 표현
