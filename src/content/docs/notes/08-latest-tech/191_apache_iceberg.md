...
- 정의/개념: **Apache Iceberg**는 스냅샷·매니페스트 계층으로 대규모 분석 테이블의 유효 파일과 스키마를 관리하는 오픈 테이블 형식
...
- 다중 엔진·파티션 진화가 중요하면 **Iceberg**, 로그 중심 스트리밍은 **Delta Lake** 선택
