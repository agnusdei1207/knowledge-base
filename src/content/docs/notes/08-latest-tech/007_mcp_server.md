...
- 개념: AI 호스트에 표준 기능을 노출하고 백엔드 실행을 통제하는 시스템. 기능 발견·권한 통제를 일관되게 제공하여 업무 자율성 확보.
- 배경: 맞춤 API마다 상이한 기능 발견·권한 방식으로 재사용성과 일관된 통제 어려움. 표준화된 서버 연동 구조 필요.
...
#### 한줄 요약
- **권한·입력 검증 후 백엔드 실행** 뒤 결과 반환 체계 적용.
...
#### 한줄 요약
- 사용자별 **테넌트·최소 권한**으로 자료 범위 제한 체계 적용.
