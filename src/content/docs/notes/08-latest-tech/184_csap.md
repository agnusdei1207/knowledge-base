...
- 정의/개념: CSAP는 클라우드서비스의 관리적·물리적·기술적 보호조치가 **보안인증기준**에 적합한지 평가하고 인증 상태를 관리하는 제도
- 배경/필요성: 사업자 자체 설명과 기관별 점검만으로는 공공 업무가 사용하는 서비스의 보호 수준과 적용 범위를 일관되게 판단하기 어려우므로 공통 검증 체계 필요
...
- **3. 수명주기 관리**: 최초 인증 이후 사후·변경·갱신 절차로 유효 상태 지속 확인
### 쉽게 이해하기 (학습용)
