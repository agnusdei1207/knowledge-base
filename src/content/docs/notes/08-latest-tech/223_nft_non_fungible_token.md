...
| 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| **토큰·법적 권리 혼동** | 소유자가 저작권·이용권을 잘못 인식 | 이용권 계약, 발행자·권리자 검증, 양도 범위 명시 |
| **원본·메타데이터 소실** | 토큰은 남아도 참조 콘텐츠 접근 불가 | 내용 해시, 분산 복제·핀 고정, 변경·보존 책임 정의 |
| **키 탈취·분실** | 무단 이전 또는 영구 접근 상실 | 하드웨어 지갑, 다중 승인, 사회적·계약 기반 복구 절차 |
