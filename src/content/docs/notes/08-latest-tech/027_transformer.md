...
date: "2026-08-06T21:44:00+09:00"
tags:
  - "notes-latest_tech"
weight: 27
extra:
...
#### 한줄 요약
- **희소 어텐션•KV Cache**로 장문 연산•생성 비용 절감
...
- 긴 문맥 병렬 학습에는 **트랜스포머**, 짧은 순차 상태에는 **RNN** 선택

#### 한줄 요약
- **문맥 성능•O(N²) 비용**을 함께 평가해 구조 선택
