...
#### 한줄 요약
- **게이트웨이•라우터•스케줄러•엔진•제어 평면**을 구성한다.
...
#### 한줄 요약
- **응답 시급성•처리량**에 따라 온라인•비동기•오프라인을 선택한다.
...
#### 한줄 요약
- **배치•캐시•SLO•회로 차단•카나리**로 운영을 통제한다.
...
#### 한줄 요약
- **응답 시급성•작업량**에 따라 서빙 방식을 선택한다. 체계 적용