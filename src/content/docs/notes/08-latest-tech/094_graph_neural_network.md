...
date: "2026-08-14T05:18:00+09:00"
tags:
  - "notes-latest_tech"
weight: 94
extra:
...
- 정의/개념: 이웃 특징을 집계해 노드•링크•그래프를 표현하는 **GNN**
- 배경/필요성: 독립 표본 모델은 **위상•간선 관계 활용 불가**
...
#### 한줄 요약
- **그래프 규모•귀납성•이웃 중요도**에 따라 GNN 방식 결정
