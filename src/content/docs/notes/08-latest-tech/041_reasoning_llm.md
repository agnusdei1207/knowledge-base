...
#### 한줄 요약
- **후학습•가변 추론•도구 검증**으로 복합 문제를 해결한다.
...
#### 한줄 요약
- 지연 민감은 **일반 LLM**, 복합 검증은 **Reasoning LLM**이 적합하다.
...
#### 한줄 요약
- **라우팅•중간 검증•격리 실행**으로 비용•위험을 통제한다.
...
#### 한줄 요약
- **검증 이득•지연 비용**에 따라 일반•추론 모델을 선택한다. 체계 적용