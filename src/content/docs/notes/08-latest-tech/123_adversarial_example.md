...
- **FGSM**: 손실 기울기의 부호를 이용해 한 번에 교란을 생성하는 공격이다.
- **PGD**: 교란을 반복 갱신하고 매 단계 허용 범위에 투영하는 공격이다.
- **C&W**: 작은 교란으로 오분류를 유도하도록 거리와 공격 목적을 함께 최적화하는 공격이다.
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 약한 공격으로 **방어 과대평가** | **FGSM·PGD·C&W** 공격 강도 비교 | 기울기 은폐의 **오판 완화** |
| 교란 예산의 **의미 불일치** | 입력별 **거리 규범·ε** 명시 | 강건성의 **주장 범위** 고정 |
| **공격 설정 비공개** | 반복·초기값·성공 조건·**강건 정확도** 공개 | 방어 **재현성 확보** |
