...
| 구성요소 | 책임 |
|:---|:---|
| 위협 모델 저장소 | **공격 지식•계산 예산** 관리 |
| 목적함수 | **오분류 유도 손실** 최적화 |
| 교란 제약기 | **거리 규범•허용 예산** 준수 확인 |
| 공격 알고리즘 | **교란 후보** 최적 탐색 |
| 강건성 평가기 | 적대적 상황의 **강건 정확도** 측정 |
...
│ 공격 알고리즘 ◀─ 5. 공격 성공•강건 정확도 평가 ─ 강건성 평가기
└──────────────────────────────────────────────┘
```

### 동작 원리

1. 공격 지식•예산: 공격자의 **접근 범위•계산 한계** 고정
2. 오분류 손실 방향: 비표적•표적 공격의 **최적화 목표** 결정
3. 교란 후보 생성: 손실 기울기로 **입력 변화 탐색**
4. 허용 범위 투영: 예산 밖 후보를 **제약 집합**으로 복귀
...
|:---|:---|:---|:---|
| 적용 기준 | 빠른 **강건성 점검** | 반복 **공격 평가** | 작은 교란의 **정밀 탐색** |
