...
- 정의/개념: EU 규정 2024/1689에 따라 AI의 위험•역할별 의무를 정한 **EU AI Act 규제**이다.
- 배경/필요성: 기존 일반 규정은 **AI 위험 등급•공급망 책임별 통제 강도 구분하기 어렵다**.
...
- EU 시장•출력 사용 기준의 **역외 적용**이 핵심이다.
- AI 시스템•범용 모델과 **위험 유형별 의무**가 핵심이다.
- **공급망 역할별 문서•감시•사고 책임**이 핵심이다.
...
1. **적용 범위•공급망 역할 판정**: 역외 적용과 사업자 책임을 결정한다.
2. **위험 분류•의무 매핑**: 금지•고위험•투명성 통제를 연결한다.
3. **적합성 평가•출시 판정**: 증적 기반 출시•보완 여부를 결정한다.
4. **출시 후 감시•사고 보고**: 성능•위험•중대 사고를 추적한다.
5. **시정•회수•운영 중단**: 비준수 위험의 피해 확산을 방지한다.
...
- **위험 유형•공급망 역할**에 따라 EU AI Act의 출시•감시 의무 이행이 핵심이다.
