...
- **유럽연합 인공지능법(European Union Artificial Intelligence Act, EU AI Act)**: AI의 용도·위험 수준과 공급망 역할에 따라 금지·적합성·투명성 의무를 정한 규제
...
- 정의/개념: **위험 유형·공급망 역할**별 AI 의무를 정한 유럽연합 규제
- 배경/필요성: 일반 규정만으로 **AI 위험 등급·참여자 책임** 구분 곤란
