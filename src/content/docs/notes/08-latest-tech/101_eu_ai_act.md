...
date: "2026-07-31T08:45:48+09:00"
tags:
  - "notes-latest_tech"
weight: 101
extra:
...
- 정의/개념: 유럽연합(European Union, EU) 규정 2024/1689에 따라 인공지능(Artificial Intelligence, AI)의 위험·역할별 의무를 정한 **EU AI Act 규제**
...
- 유럽연합(European Union, EU) 시장·출력 사용 기준의 **역외 적용**
- 인공지능(Artificial Intelligence, AI) 시스템·범용 모델과 **위험 유형별 의무**
- **공급망 역할별 문서·감시·사고 책임**
...
- **공급자·배포자(Provider·Deployer)**: AI 시스템을 개발·출시하는 주체와 업무에 실제 사용하는 주체로, 역할별 의무가 다르게 부과된다.
...
인공지능(Artificial Intelligence, AI)의 고위험 통제 항목: **적합성 평가·출시 후 감시**, 연결 기준: 공급망 역할
...
인공지능(Artificial Intelligence, AI)의 연결 항목: **위험 분류·중대 사고**, 통제 시점: 출시 전 평가·출시 후 감시
...
sequenceDiagram
    ...
    O->>C: 1. 용도·시장·역할 정보 전달
    C->>A: 2. 위험 분류·의무 전달
    A-->>O: 3. 출시·보완 판정 전달
    O->>M: 4. 운영 로그·사고 정보 전달
    M-->>O: 5. 시정·중단 조치 전달
```

- **1. 용도·시장·역할 정보 전달**: 역외 적용과 공급자·배포자 책임 판정
- **2. 위험 분류·의무 전달**: 금지·고위험·투명성 대상별 통제 매핑
- **3. 출시·보완 판정 전달**: 적합성 증적 기반 출시 가능 여부 결정
- **4. 운영 로그·사고 정보 전달**: 출시 후 성능·위험·중대 사고 감시
- **5. 시정·중단 조치 전달**: 비준수 위험의 보완·회수·운영 중단
...
인공지능(Artificial Intelligence, AI)의 용도와 영향에 따라 금지 관행, 고위험 시스템, 투명성 의무 대상으로 구분한다.
...
| 고위험 인공지능(Artificial Intelligence, AI)의 **적합성 증적 부족** | 위험관리·데이터·로그·감독 증적 연결 | 출시 전 **준수 입증** |
...
- 결정 기준: **위험 유형·공급망 역할**, 적용 법규: **유럽연합 인공지능법(European Union Artificial Intelligence Act, EU AI Act)의 출시·감시 의무**
