...
- 정의: **VC** 기반 발급자의 자격 주장에 암호학적 증명을 결합해 보유자가 제시하고 검증자가 확인하는 디지털 자격증명임이다.
...
- **발급자•보유자•검증자** 책임을 분리함.
- **VC 원본•VP 제시물** 제출 범위를 구분함.
- 증명•스키마와 **상태 목록•선택적 공개** 활용 검증함.
#### 한줄 요약
...
발급자는 **VC** 대상 암호학적 증명을 결합하고 보유자는 **VP** 활용 구성해 검증자에게 제시한다.
...
1. 주체•스키마•DID 키 검증: 발급 대상•형식•**DID 서명 키** 활용 확인함.
2. 발급자 DID•증명•스키마 검증: **VC**•**VP** 무결성•유효성을 확인함.
...
> 요약: **VC** 기반 직접 제시, **중앙 API** 기반 기관 조회 중심.
...
- 선택적 공개는 **W3C VC**, 기관 직접 조회는 **중앙 API** 활용 선택.
