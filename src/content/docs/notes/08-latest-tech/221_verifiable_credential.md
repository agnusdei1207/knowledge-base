...
date: "2026-07-31T09:02:42+09:00"
tags:
- "notes-latest-tech"
weight: 221
extra:
...
- **역할 축**: 발급자·보유자·검증자의 책임 분리
- **제시 축**: VC 원본과 목적별 VP 제출 범위 구분
- **검증 축**: 증명·스키마·상태·선택적 공개 확인
### 쉽게 이해하기 (학습용)
...
3. **상태 목록·업무 정책 확인**: 취소 상태·발급자 신뢰 평가
...
| VP 재사용으로 **상관관계·재전송** | **챌린지·대상·만료** 결합 | VP 추적 가능성 축소 |
