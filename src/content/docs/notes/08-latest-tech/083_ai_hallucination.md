...
- 배경/필요성: 다음 토큰 확률 기반 생성은 **사실성•충실성 보장 불가** #### 한줄 요약
...
- 주장과 인용 출처가 어긋나는 **근거 귀속 오류** #### 한줄 요약
- **사실성•충실성•근거 귀속** 오류 구분
...
1. 입력•문맥•응답 기록: 환각 원인 추적을 위한 **생성 조건** 보존함.
2. 검증 가능 주장 분해: **복합 답변의 원자 주장을 변환**함.
3. 외부 사실•문맥 대조: 신뢰 사실과 제공 근거의 **주장 지지 여부** 활용 확인함.
4. 오류 유형•위험 판정: 사실성•충실성•귀속 오류와 **업무 영향** 분류함.
5. 수정•보류•거절 적용: 검증 결과와 위험 수준에 맞는 **출력 통제** 활용 실행함.
