...
date: "2026-08-14T04:56:00+09:00"
tags:
  - "notes-latest_tech"
weight: 83
extra:
...
- 정의/개념: 모델이 사실•근거와 불일치한 내용을 생성하는 **AI 환각**
- 배경/필요성: 다음 토큰 확률 기반 생성은 **사실성•충실성 보장 불가**
...
- **사실 검증기(Fact Verifier)**: 주장을 근거와 대조해 지지•반박•불명으로 판정한다.
