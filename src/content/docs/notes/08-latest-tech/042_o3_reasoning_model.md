...
date: "2026-08-06T22:46:00+09:00"
tags:
  - "notes-latest_tech"
weight: 42
extra:
...
- 역사적 모델 성능과 현재 **API 지원•후속 모델**을 구분

#### 한줄 요약
- **출시 성능•현재 지원 경로**를 분리 판단
...
#### 한줄 요약
- **호환성•복합 추론 요구**에 따라 o3•GPT-5.6 Sol 선택
