...
- **재무 운영(FinOps)**: 기술·재무·사업 조직이 변동하는 기술 비용과 사업 가치를 공동 최적화하는 운영 체계이다.
- **단위 경제성(Unit Economics)**: 요청·고객·거래 등 사업 가치 단위당 기술 비용이다.

</details>

- 정의/개념: **재무 운영(Financial Operations, FinOps)** 은 기술·재무·사업 조직이 사용량 기반 기술 지출을 할당·분석·예측해 비용과 사업 가치를 공동 최적화하는 운영 체계
