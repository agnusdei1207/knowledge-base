...
- 정의/개념: **PQC**는 양자 공격에 안전하도록 설계한 고전 컴퓨터용 공개키 암호임.
- 배경/필요성: **RSA**•**ECC**는 쇼어 알고리즘으로 해독될 수 있어 **선취 후 복호화 위험**에 노출됨.
...
- 키 설정용 **ML-KEM**과 서명용 **ML-DSA**•**SLH-DSA**가 핵심임.
- 기존 공개키 암호와 다른 **큰 키•서명•연산 특성**이 핵심임.
- 자산 목록•하이브리드 운용•암호 민첩성 기반 **점진적 전환**이 핵심임.
#### 한줄 요약
...
3. 병행 구성•통합: 기존 암호와 **PQC KEM•서명**을 결합함.
...
- HNDL 위험이 큰 자산부터 **ML-KEM**•**ML-DSA**로 단계적으로 전환함.
