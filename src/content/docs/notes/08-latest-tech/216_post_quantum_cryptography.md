...
- 기존 한계: RSA·ECC는 충분한 규모의 양자컴퓨터에서 쇼어 알고리즘으로 해독될 수 있어 장기 기밀 데이터의 선취·후복호화 위험이 있다.
...
- 양자컴퓨터의 기존 공개키 암호 위협에 대비하기 위해 암호 자산·비밀 유지기간·표준 성숙도·호환성·성능을 검토하여, 장기 비밀 자산부터 PQC로 단계 전환해야 한다.
