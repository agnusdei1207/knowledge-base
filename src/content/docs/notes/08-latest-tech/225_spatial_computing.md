...
- 정의: **공간 컴퓨팅** 기반 물리 환경을 인식해 디지털 정보와 사용자•기기 동작을 실제 공간 좌표에 정합하는 컴퓨팅 방식임이다.
...
- 시각•관성•**LiDAR 센서** **시간•좌표 정렬** 핵심임.
- **SLAM** 기반 **장치 위치•환경 지도** 활용 동시에 갱신함.
- 객체•가림•통행 영역의 **공간 맥락 추론** 핵심임.
#### 한줄 요약
...
카메라•관성•**LiDAR** 센서를 보정•융합하고 **SLAM** 기반 위치와 장면 모델을 갱신한다.
...
- 시각 정보 정렬은 **AR**, 공간 이해•입력•작동 연결은 **공간 컴퓨팅** 선택함.
