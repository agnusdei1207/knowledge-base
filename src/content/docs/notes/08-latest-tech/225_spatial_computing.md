...
| 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| **드리프트·지연** | 정보가 실제 대상과 어긋나 오조작 | 앵커 재관측, 지연 예산, 정합 오차 임계값과 표시 중단 |
| **장면 오인식** | 사람·장애물·작업 영역을 잘못 추론 | 신뢰도 표시, 다중 센서 검증, 위험 동작의 사람 승인 |
| **공간 개인정보** | 실내 구조·사람·행동 정보 노출 | 기기 내 최소 처리, 공간 지도 암호화, 목적별 보존·공유 통제 |
