...
date: "2026-07-31T09:07:23+09:00"
tags:
- "notes-latest-tech"
weight: 225
extra:
...
- 정의/개념: 디지털 정보·동작을 물리 좌표에 연결하는 **공간 컴퓨팅**
...
- **보정 축**: 시각·관성·LiDAR 센서 시간·좌표 정렬
- **추적 축**: SLAM으로 장치 위치·환경 지도 동시 갱신
- **이해 축**: 객체·가림·통행 영역의 공간 맥락 추론
### 쉽게 이해하기 (학습용)
...
| 장면 오인식으로 **위험 동작 전파** | **다중 센서 검증·사람 승인** | 현실 피해 차단 |
| 공간 지도 수집으로 **개인정보 노출** | **기기 내 처리·지도 암호화** | 노출 범위 축소 |
