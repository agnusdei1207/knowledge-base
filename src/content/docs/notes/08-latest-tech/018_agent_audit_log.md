...
- **추적 식별자(Trace Identifier, Trace ID) 기반 결정·행동·결과 연결**
- 최소 수집과 **1회 기록 다회 판독(Write Once Read Many, WORM)·전자서명** 기반 변조 탐지
...
4. **추적 식별자(Trace Identifier, Trace ID)·해시 봉인**: 관련 사건 연결·변조 흔적을 **1회 기록 다회 판독(Write Once Read Many, WORM) 저장소** 에 보존
...
| 로그 관리자에 의한 **사후 변조** | 해시 체인·서명·**1회 기록 다회 판독(Write Once Read Many, WORM) 저장** 과 외부 시각 증명 | 기록의 **변조 탐지성** 확보 |
