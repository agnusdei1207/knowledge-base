...
- 배경/필요성: 일반 진단 로그만으로 **결정 근거•승인 과정•상태 변경 책임** 입증하기 어렵다.

#### 한줄 요약
- 대리 행동의 **권한•승인•결과**를 연결한 책임 증거가 핵심이다.
...
- 책임•규정 입증은 **감사 로그**, 성능•오류 진단은 **관측 로그**를 선택한다.
