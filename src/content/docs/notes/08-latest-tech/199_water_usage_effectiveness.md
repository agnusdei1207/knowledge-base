...
1. **물 사용량•IT 에너지 전달**: 같은 기간의 물 소비량과 **IT 분모 에너지**를 제공함.
2. **WUE 영향 분석 전달**: 냉각 대안별 **WUE•PUE•탄소 변화**를 제공함.
...
- **재생수**: 처리한 폐수를 냉각 등 비음용 용도로 다시 사용하는 수자원을 말한다.

</details>

- 현장 물 절감은 **site WUE**, 전력 생산 물까지 포함하면 **source WUE**을 선택함.
