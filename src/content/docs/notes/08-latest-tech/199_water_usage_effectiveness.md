...
1. **증발 냉각의 PUE 개선·WUE 악화 비교**
2. **상수도에서 재생수 전환 후 수원별 보고**

### 쉽게 이해하기 (학습용)

- 냉각 전력이 줄어도 물 사용이 늘 수 있어 지역 물 스트레스와 온도 안정성을 함께 본다.
- 총물 사용량뿐 아니라 상수도 의존 감소와 재생수 비율을 별도로 확인한다.

## Ⅶ. 결론

- 냉각 방식과 수원을 선택할 때 **동일 경계의 WUE와 지역 물 스트레스·PUE·탄소·신뢰성을 함께 검증**해야 한다.

### 쉽게 이해하기 (학습용)

- WUE가 낮아도 물 부족 지역의 부담이 클 수 있으므로 물의 출처와 지역 상황까지 봐야 한다.
