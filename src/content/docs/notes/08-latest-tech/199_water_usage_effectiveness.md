...
- 정의/개념: **WUE**는 같은 기간 물 사용량을 **IT 에너지**로 나눈 **L/kWh 물 집약도**임.
...
- 수원•취수•방류•재사용을 구분한 **물 수지•지역 부담 해석**이 핵심임.
- 증발 냉각은 **PUE 감소•WUE 증가**를 유발해 **CUE•SLO** 병행 판단이 핵심임.
#### 한줄 요약
...
- **동일 물 경계•지역 스트레스•PUE•탄소•SLO**를 함께 평가
