...
date: "2026-07-31T12:03:26+09:00"
tags:
  - "notes-latest-tech"
weight: 133
extra:
...
- **모델 레지스트리**: 모델 산출물과 불변 버전·계보·평가·승인·배포 상태를 연결해 관리하는 저장소이다.
- **평가 증적**: 특정 모델 버전이 품질·안전·성능 기준을 충족했음을 입증하는 시험 결과이다.

</details>

- 정의/개념: **모델 레지스트리(Model Registry)** 는 모델의 불변 버전과 학습 계보·평가 증적·승인·배포 상태를 연결해 관리하는 수명주기 저장소
