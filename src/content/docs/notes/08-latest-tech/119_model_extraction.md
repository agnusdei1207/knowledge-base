...
- **API(에이피아이)**: Application Programming Interface의 머리글자로, 공격자가 원본 모델에 반복 질의하는 접점
...
- 기존 한계: 공개 API의 상세 출력과 반복 질의 허용은 원본의 판단 경계 모방을 쉽게 만든다
- **배경/필요성**: 모델 기능과 지식재산의 무단 복제를 억제하기 위함이다
