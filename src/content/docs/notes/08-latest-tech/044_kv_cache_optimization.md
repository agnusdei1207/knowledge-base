...
date: "2026-08-06T22:54:00+09:00"
tags:
  - "notes-latest_tech"
weight: 44
extra:
...
- 정의/개념: 키•값 재사용으로 디코드 연산을 줄이고 저장•회수로 메모리를 관리하는 **KV Cache 최적화**
...
- 층•KV Head•토큰•배치•정밀도에 비례하는 **캐시 용량**
...
1. **요청별 캐시 용량 산정**: 문맥 길이•층•**KV Head•정밀도 기반 예상 메모리 계산**
...
- 헤드 중복에는 **GQA•MQA**, 단편화에는 **페이징**, 용량 부족에는 **양자화•오프로딩** 적용

#### 한줄 요약
- **병목 원인**에 따라 헤드 공유•페이징•압축 선택
