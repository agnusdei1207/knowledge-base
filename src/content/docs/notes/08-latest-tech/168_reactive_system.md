...
date: "2026-07-25T01:52:00+09:00"
...
| 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| **무제한 메시지 큐** | 적체가 메모리 고갈과 지연 폭증으로 전환 | 유한 큐, 입장 제어, 역압과 초과 요청 거부 정책 적용 |
| **재시도 폭주** | 장애 중 재시도가 하류 시스템을 추가 압박 | 회로 차단기, 지수 백오프, 무작위 지연과 재시도 예산 적용 |
| **확장 지연** | 자원이 늦게 늘어나 응답 시간 목표 위반 | 큐 지연 기반 임계값, 사전 준비 용량, 확장 상한을 함께 관리 |
