...
- 배경/필요성: GAN 적대적 학습은 **학습 불안정•모드 붕괴 위험** #### 한줄 요약
...
- 반복 **역방향 잡음 제거** 활용 통한 새 표본 추출
- 역전이 단계 증가에 따른 **생성 품질 향상•지연 증가** #### 한줄 요약
...
2. 잡음 예측 학습: 제거 모델이 시점 조건부 **추가 잡음** 예측함.
3. 현재 잡음 상태 입력: 무작위 잡음에서 시작해 **시점 상태** 활용 전달함.
