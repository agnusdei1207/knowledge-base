...
- 정의/개념: 순방향 잡음 추가와 역방향 제거를 학습하는 **확산모델**
- 배경/필요성: GAN 적대적 학습은 **학습 불안정•모드 붕괴 위험**

#### 한줄 요약
- 무작위 잡음에서 **단계별 역방향 잡음 제거**로 표본 생성
...
1. 순방향 잡음 상태 생성: 학습 표본과 잡음을 **스케줄 비율로 혼합**함.
...
- **생성 지연•표본 다양성•품질**로 DDPM•DDIM•단계 수 선택
