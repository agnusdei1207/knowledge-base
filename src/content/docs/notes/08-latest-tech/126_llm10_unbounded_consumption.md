...
- 기존 한계: 요청 건수 제한만으로는 요청별 토큰·실행 시간·반복 횟수·외부 도구 비용의 큰 편차를 통제하기 어렵다.
...
- 무제한 소비의 가용성·비용 위험을 줄이기 위해 **토큰·시간·동시성·도구 호출·할당량**을 검토하고, 예산 초과 요청을 제한·중단한다
