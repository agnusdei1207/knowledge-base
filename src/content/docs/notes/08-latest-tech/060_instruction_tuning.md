...
- 배경/필요성: 다음 토큰 예측만으로는 **새 지시•출력 형식**을 안정적으로 준수하기 어렵다.
...
- **다양한 과제•지시 표현 혼합**으로 미학습 지시 일반화가 핵심이다.
- **대화 템플릿**으로 역할•지시•입력•응답 경계 일관성이 핵심이다.
- 지시 이행 학습과 **사실성•안전성 검증•인간 선호 정렬**을 분리한다.
