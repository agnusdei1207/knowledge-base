...
- 정의/개념: **지시 튜닝**은 다과제 지시문•입력•모범 응답으로 지시 이행을 지도 학습하는 방법
...
- 지시 이행 학습과 **사실성•안전성 검증•인간 선호 정렬**의 분리

#### 한줄 요약
- **지시 준수•사실성•안전성**을 분리 검증
...
선의 의미: 데이터•혼합•직렬화•학습•평가 책임의 정적 연결
