...
date: "2026-08-26T17:03:29+09:00"
tags:
  - "notes-latest_tech"
weight: 60
extra:
...
- 배경/필요성: 다음 토큰 예측으로만 학습한 모델은 지시를 수행 대상이 아니라 이어 쓸 문장으로 다뤄 원하는 응답을 얻기까지 예시 설계 비용을 매번 치르므로, 사전학습과 활용 사이에 지시-응답 쌍으로 학습하는 단계를 넣어 **새 지시·출력 형식 준수**를 모델의 기본 행동으로 만듦
