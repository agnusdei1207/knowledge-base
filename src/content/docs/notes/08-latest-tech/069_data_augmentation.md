...
date: "2026-07-25T23:18:00+09:00"
tags:
  - "notes-latest_tech"
weight: 69
extra:
...
- **데이터 증강 (Data Augmentation)**: 라벨을 유지하며 원본 데이터를 변형하는 기법
...
- 라벨 관계를 보존하는 변환만 유효한 학습 신호가 된다.
- 도메인마다 허용할 라벨 보존 변환이 다르다.
- 학습 중 무작위 변환으로 다양한 표본을 만든다.
- 과도한 변환은 라벨 오염과 분포 이격을 일으킨다.
...
|:---|:---|:---|:---|
| 대표 변환 | 회전·밝기·가림 | 역번역·동의어 | 이동·잡음·속도 |
| 주요 위험 | 라벨의 방향·위치 변형 | 개체·의미 변경 | 신호·사건 훼손 |
