...
- 정의/개념: 질의 해석•복수 검색•재순위로 답변하는 **AI 검색**
...
- **검색 회수율•답변 충실성**을 분리 측정해 재순위•생성 경로 조정

#### 한줄 요약

- **검색 관련성•근거성•지연 예산**에 따라 검색•생성 경로 결정
