...
date: "2026-07-31T11:56:09+09:00"
tags:
  - "notes-latest_tech"
weight: 86
extra:
...
- **AI 검색**: 질의를 해석하고 복수 검색 결과를 재순위해 근거 문서나 답변을 제공하는 검색 방식이다.

</details>

- 정의/개념: **AI 검색**은 질의 해석·복수 검색·재순위로 근거 답변을 제공하는 검색 방식
...
- **검색 증강 생성(RAG)**: 검색한 문서를 모델 문맥에 넣어 근거가 있는 답변을 생성하는 기법이다.
...
| 핵심 특징 | **복수 검색·재순위**와 답변 생성 | **어휘 일치** 기반 문서 순위 | **임베딩 근접성** 기반 순위 |
| 한계 | **생성 충실성·추가 지연** | **표현 불일치** | 정확한 **고유명사 누락** |

> 요약: **AI 검색**은 검색과 생성을 통합한 **지능형 검색 서비스**
