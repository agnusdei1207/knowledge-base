...
- 정의: 개방형 파일 저장소에 **ACID 테이블 관리** 활용 결합한 **데이터 레이크하우스**임이다.
- 배경/필요성: 레이크•웨어하우스 분리는 데이터 복제•버전 불일치와 **파이프라인 중복** 유발함.
#### 한줄 요약
...
- 개방형 저장소•컴퓨트 분리 기반 **다중 엔진 선택권** 핵심임.
- **오픈 테이블 포맷** 기반 스키마 진화와 **ACID•스냅샷 관리** 핵심임.
- **카탈로그** 기반 BI•스트리밍•ML 통합과 **파일 최적화 부담** 핵심임.
#### 한줄 요약
