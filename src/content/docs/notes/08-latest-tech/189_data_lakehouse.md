...
- **1. 다중 엔진 선택권**: 개방형 저장소·컴퓨트 분리 기반 다중 엔진 선택권
- **2. ACID·스키마 진화·스냅샷 관리**: 테이블 메타데이터 기반 ACID·스키마 진화·스냅샷 관리
- **3. BI·스트리밍·ML 통합과 파일 최적화 부담**: 동일 테이블 공유 기반 BI·스트리밍·ML 통합과 파일 최적화 부담
### 쉽게 이해하기 (학습용)
