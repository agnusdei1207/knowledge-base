...
- 정의/개념: 개방형 파일 저장소에 **ACID 테이블 관리**를 결합한 **데이터 레이크하우스**
...
- 신규 파일•후보 스냅샷 생성 후 원자 커밋 기반 일관된 조회
...
- 원시 저장은 레이크, 정형 분석은 웨어하우스, 통합은 레이크하우스
...
- **BI•ML 통합** 워크로드는 레이크하우스, 고정 정형 분석은 웨어하우스를 선택하고 파일 유지관리 병행
