...
- 배경/필요성: 기술 성능만으로는 **차별•권리•안전 피해 사전 식별 곤란** #### 한줄 요약
...
- 완화 후 잔여 영향의 **출시 승인•재평가 연결** #### 한줄 요약
...
1. 사용 맥락•영향 집단 정의: 시스템 결정 경계와 **직접•간접 영향 대상** 확정함.
2. 피해 시나리오 식별: 이해관계자 관점에서 **피해 발생 경로** 활용 도출함.
3. 가능성•심각도•가역성 평가: 피해의 빈도•규모•회복 가능성으로 **영향 수준** 판정함.
4. 예방•탐지•구제 조치 검증: 피해 전후의 통제와 **실행 책임** 시험함.
5. 잔여 영향 승인•재평가: 남은 피해로 출시•중지와 **변경 시 재평가 조건** 결정함.
...
- 잔여 영향이 한도 이내면 **조건부 출시**, 초과하면 **재설계**•**중지** #### 한줄 요약
