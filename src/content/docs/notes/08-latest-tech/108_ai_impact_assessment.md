...
- 정의/개념: 인공지능(Artificial Intelligence, AI)의 권리•안전•기회 영향을 식별하고 잔여 영향으로 출시 조건을 정하는 **AI 영향평가 절차**
- 배경/필요성: 기술 성능만으로는 **차별•권리 침해•안전 피해의 출시 전 식별 곤란**
...
인공지능(Artificial Intelligence, AI) 영향평가는 권리•안전•기회 영향을, 개인정보 영향평가는 정보 처리 위험을, 시스템 위험평가는 보안•연속성 위험을 중심으로 수행한다.
...
- 결정 기준: **영향 범위•피해 수준•잔여 영향 수용성**, 적용 대상: **인공지능(Artificial Intelligence, AI) 출시•중지•재평가 조건**
