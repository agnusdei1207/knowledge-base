...
- **국제표준화기구(International Organization for Standardization, ISO)·국제전기기술위원회(International Electrotechnical Commission, IEC)**: AI 경영시스템 국제표준 ISO/IEC 42001을 공동 발행한 표준화 기구
- **인공지능 경영시스템(Artificial Intelligence Management System, AIMS)**: AI 정책·목표와 이를 달성할 조직 절차를 수립하고 지속 개선하는 관리체계
- **계획-실행-점검-개선(Plan-Do-Check-Act, PDCA)**: 정책과 통제를 계획·운영·평가·시정하는 경영시스템 개선 순환
