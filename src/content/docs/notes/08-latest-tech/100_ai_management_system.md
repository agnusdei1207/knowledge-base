...
- **리더십•자원 책임**: 최고경영진이 정책•역할•역량•자원을 배정하고 인공지능 경영시스템의 책임성을 보장하는 요구이다.
- **위험 평가**: AI의 위험•기회•영향을 식별하고 우선순위를 결정하는 활동이다.
- **운영 통제**: 데이터•개발•획득•공급자•배포•변경 활동에 계획된 기준과 증적을 적용하는 요구이다.
- **성과 평가**: 목표•통제의 효과를 지표•내부심사•경영검토로 확인하는 요구이다.
