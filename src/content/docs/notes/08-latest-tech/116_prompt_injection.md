...
- 배경/필요성: 모델은 자연어의 **신뢰 지시•비신뢰 데이터** 활용 완전히 구분하지 못해 권한 오용 가능성이 있음.
...
- 독립 권한 검증•최소 권한 기반 **도구 피해 제한** #### 한줄 요약
- 모델 행동을 별도 정책으로 확인하는 **독립 권한 검증** ## Ⅲ. 구조 및 구성요소
...
> 요약: **직접 공격** 대화, **간접 공격** 외부 콘텐츠로 지시 주입이 핵심이다.
