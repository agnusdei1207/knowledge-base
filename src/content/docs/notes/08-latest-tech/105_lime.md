...
- 배경/필요성: 블랙박스 출력만으로는 **개별 예측의 특징 영향 식별 불가** #### 한줄 요약
- 교란 표본으로 **블랙박스 국소 경계** 활용 단순 모델로 근사
...
#### 한줄 요약
- **국소 경계 근사•일관된 기여 배분** 대상 따라 기법 구분
...
#### 한줄 요약
- **국소 충실도•설명 안정성** 대상 따라 교란 범위•커널 폭 결정
