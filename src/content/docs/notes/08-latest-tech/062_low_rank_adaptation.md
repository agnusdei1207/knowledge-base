...
- 원본 전체는 **Full FT**, 직렬 모듈은 **Adapter**, 변화량은 LoRA
...
#### 한줄 요약
- **갱신 대상•추론 경로**로 Full FT•Adapter•LoRA 구분
...
- **과업 변화량•학습 메모리•배포 경로**로 LoRA 구성 결정

#### 한줄 요약
- **변화량•메모리•배포 경로**로 랭크•층•병합 방식 선택
