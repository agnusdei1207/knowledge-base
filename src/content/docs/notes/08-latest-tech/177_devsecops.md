...
- **DevSecOps**: 개발·보안·운영이 소프트웨어 수명주기 전반의 보안 결과를 공동 소유하고 자동 검증·운영 피드백을 지속하는 체계이다.
...
- **SBOM(Software Bill of Materials)**: 소프트웨어에 포함된 구성요소와 버전을 추적하는 소프트웨어 자재 명세서이다.
...
- **파이프라인 보안**: CI/CD 과정에서 코드·의존성·비밀·산출물을 규칙 기반으로 자동 검사하는 방식이다.
