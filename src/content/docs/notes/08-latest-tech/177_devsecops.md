...
- **위협 모델•보안 요구**: 보호 대상과 공격 경로를 식별해 개발 전에 필요한 보안 통제를 정의한 기준이다.
- **보안 피드백**: 정적 분석•구성요소 분석 등의 결과를 개발 단계에 즉시 돌려주는 활동이다.
- **정책 게이트**: 빌드•배포물이 보안 기준과 공급망 증거를 충족할 때만 다음 단계로 통과시키는 통제이다.
- **운영 탐지•환류**: 운영 중 발견한 위협과 취약점을 개발 요구와 정책에 다시 반영하는 폐쇄 루프이다.
...
|:---|:---|:---|:---|
| 적용 기준 | **전 수명주기 위험 관리** | **지속적 통합•지속적 전달(Continuous Integration and Continuous Delivery, CI/CD) 자동 검사** 중심 | 고위험 변경의 **전문가 검토** |
