...
- **AI 거버넌스**: 조직의 AI 의사결정권·책임과 위험 통제를 총괄하는 감독 체계이다.
- **책임 체계**: AI의 개발·승인·운영·중지 단계별 결정권자와 책임자를 정한 구조이다.
...
- **AI 경영시스템**: AI 관련 정책·절차·책임을 반복적으로 운영하고 개선하는 관리체계이다.
- **AI 위험관리**: 개별 AI 위험을 식별·분석·평가하고 처리하는 활동이다.
- **포트폴리오 통제**: 조직이 보유한 전체 AI 목록을 공통 기준으로 분류하고 감독하는 방식이다.
