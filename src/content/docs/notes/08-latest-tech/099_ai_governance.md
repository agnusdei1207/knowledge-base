...
- 배경/필요성: 프로젝트별 관리의 **전사 위험·책임 기준** 불일치 해소
...
- **AI 목록·영향도 등급**에 따라 검증·승인·감시 강도를 정한다.
- **다기능 책임 배분**으로 사업·모델·법무·보안의 의사결정권을 구분한다.
- **등록부·계보·검증·사고 증적**으로 통제 효과를 감독한다.
...
| 영향도와 승인 강도 불일치 | 위험 등급별 **검증·승인 기준** 적용 | 고영향 AI 통제 강화 |
...
- **AI 영향도·조직 책임 범위**에 따라 승인권을 배분하고 **등록·중지·시정 체계** 운영
