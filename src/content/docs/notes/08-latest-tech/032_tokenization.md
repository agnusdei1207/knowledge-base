...
date: "2026-08-06T22:04:00+09:00"
tags:
  - "notes-latest_tech"
weight: 32
extra:
...
- 정의/개념: 입력 문자열을 모델 어휘의 부분 단위로 분할하고 각 단위를 Token ID로 변환하는 **토큰화**
...
선의 의미: 표기•경계•조각•ID•문자열 복원 책임의 정적 연결
...
- 범용•다국어에는 **서브워드 BPE**, 미지 문자열에는 **문자•바이트** 선택

#### 한줄 요약
- **언어•미지 문자열 비중**에 따라 분절 단위 선택
