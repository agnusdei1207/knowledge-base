...
date: "2026-08-14T05:48:00+09:00"
tags:
  - "notes-latest_tech"
weight: 109
extra:
...
- 배경/필요성: 기술 가능성•법적 최소 요건만으로는 **허용 사용•가치 충돌 판단 곤란** #### 한줄 요약
...
- 원칙을 제품 통제•책임•구제로 잇는 **실행 지향성** #### 한줄 요약
...
1. 목적•대안•영향 식별: AI 사용 필요성과 비AI 대안 및 **피해 대상** 확인함.
2. 법적 금지 경계 판정: 가치 절충 전에 준수해야 할 **강제 금지선** 적용함.
3. 충돌 가치•피해 숙의: 당사자 관점에서 선택별 **권리•효익•피해** 비교함.
4. 통제 조건•책임 승인: 허용 범위와 사람 감독•고지의 **실행 책임** 확정함.
5. 구제 운영•기준 재검토: 민원•사고•변화로 **윤리 판단 기준** 갱신함.
...
#### 한줄 요약
- **가치 원칙•제품 통제•조직 권한** 대상 따라 책임 체계 구분
...
- 강제 금지선 위반은 **AI 사용 중단**, 허용 영역은 **통제•구제 조건부 승인** #### 한줄 요약
