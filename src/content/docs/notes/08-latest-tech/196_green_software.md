...
- 정의/개념: 서비스 품질을 유지하며 기능 단위의 운영•내재 탄소를 줄이는 **그린 소프트웨어**
- 배경/필요성: 성능•비용 지표만으로는 전력 소비•장비 내재 탄소의 **설계 결정 반영** 곤란

#### 한줄 요약

- 에너지•장비 효율과 저탄소 실행 기반 기능당 탄소 감축
...
- 기능 단위별 운영•내재 탄소 산정과 SLO 기반 감축 검증
...
1. **기준선•탄소 원인 전달**: 에너지•배출계수와 내재 탄소의 **배출 영향** 제공
2. **감축 조치•예상값 전달**: 효율화•적정화의 **예상 감축량** 제공

#### 한줄 요약

- 동일 경계의 SCI•총배출•SLO 기반 감축 효과 검증
