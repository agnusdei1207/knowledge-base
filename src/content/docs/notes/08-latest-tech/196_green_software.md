...
- 배경/필요성: 성능과 비용만 최적화하면 소프트웨어의 전력 소비·장비 내재 탄소·시간대별 전력 탄소 강도를 의사결정에 반영하기 어렵다.
...
- **1. 연산·전송·저장에 필요한 전력량을 감축**: 에너지 효율로 연산·전송·저장에 필요한 전력량을 감축한다.
- **2. 장비 활용률·수명을 높여 기능별 내재 탄소를 감축**: 하드웨어 효율로 장비 활용률·수명을 높여 기능별 내재 탄소를 감축한다.
- **3. 시간·지역별 전력 탄소 강도에 맞춰 유연한 작업을 이동**: 탄소 인지 실행으로 시간·지역별 전력 탄소 강도에 맞춰 유연한 작업을 이동한다.
### 쉽게 이해하기 (학습용)
