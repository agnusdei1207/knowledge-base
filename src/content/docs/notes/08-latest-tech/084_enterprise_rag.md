...
- 배경/필요성: 일반 RAG은 다중 원천의 **최신성•권한•감사 관리 곤란** #### 한줄 요약
- **최신 버전•열람 권한•근거 계보** 활용 전 과정에서 유지
...
- 검색 단계의 사용자 권한 적용과 **허용 문맥 생성** #### 한줄 요약
...
1. 문서•버전•권한 변경 수집: 원천 이벤트를 통해 **현재 지식 상태** 활용 확보함.
2. 조각•메타데이터 색인 게시: 내용과 버전•권한을 결합한 **검색 단위** 활용 생성함.
3. 사용자 권한 내 근거 검색: 허용 공간에서만 관련 문서를 찾아 **검색 후보** 활용 제한함.
4. 답변•인용•계보 기록: 생성 결과와 사용 근거의 **원천 추적 정보** 활용 저장함.
5. 최신성•품질•비용 개선: 운영 지표와 실패 단계로 **동기화•검색•생성 설정** 조정함.
...
#### 한줄 요약
- **기능 검증•통합 운영•망 격리** 대상 따라 운영 범위 구분
