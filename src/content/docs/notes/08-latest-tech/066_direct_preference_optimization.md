...
- 정의/개념: **DPO**는 선호•비선호 응답쌍과 참조 모델로 정책을 직접 최적화하는 정렬 기법
- 배경/필요성: **RLHF 보상 모델•온라인 강화학습**으로 훈련 복잡도 증가
...
- **학습 신호•정책 탐색**으로 DPO•SFT•RLHF 구분
...
- 고정 선호쌍이 충분하면 **DPO** 선택, 범위 밖 생성은 **독립 평가** 검증

#### 한줄 요약

- **선호쌍 대표성•탐색 필요성**에 따라 DPO•RLHF 선택
