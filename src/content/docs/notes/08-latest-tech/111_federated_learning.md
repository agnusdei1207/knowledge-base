...
- **비독립•비동일분포(Not Independent and Identically Distributed, non-IID)•참여 이탈** 에 따른 업데이트 편향•수렴 변동
...
| 한계 | 원본 집중•주권 제약 | 이탈•통신•자원 편차 | 기관별 **비독립•비동일분포(Not Independent and Identically Distributed, non-IID)•합의 비용** |
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| **비독립•비동일분포(Not Independent and Identically Distributed, non-IID) 데이터** 의 업데이트 충돌 | 참여자별 성능 평가•개인화 계층•집계 가중 조정 | 전역•지역 품질 **균형 개선** |
...
- 데이터 주권•**비독립•비동일분포(Not Independent and Identically Distributed, non-IID)•참여 안정성** 을 기준으로 연합 구조와 집계•보호 정책 결정
