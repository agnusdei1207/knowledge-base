...
date: "2026-08-14T05:12:00+09:00"
tags:
  - "notes-latest_tech"
weight: 91
extra:
...
- 정의: 시공간 정보를 통합해 동적 프레임을 만드는 **영상 생성**이다.
- 배경/필요성: 독립 프레임 합성은 **시간 연속성•물리 개연성 보장 불가**

#### 한줄 요약

- **공간 구조•시간 흐름**을 통합한 동적 프레임 생성
...
4. 연속 프레임 생성: 갱신된 잠재 상태 기반 프레임 복원
...
- 장편 영상은 **자기회귀 생성**과 키프레임 검증 적용

#### 한줄 요약
- **영상 길이•움직임 품질•제어 요구**에 따라 생성 방식 결정
