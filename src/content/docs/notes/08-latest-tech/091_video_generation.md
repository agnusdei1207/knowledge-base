...
- 배경/필요성: 프레임별 생성의 **객체·움직임 불연속** 보완 필요
...
| 시공간 표현 저장소 | 프레임 공간과 시간 위치를 담은 잠재 텐서 |
...
| 핵심 특징 | 프레임 독립 생성 | 시공간 노이즈 제거 | 순차 프레임 생성 |
| 한계 | 외형 흔들림 | 높은 시공간 연산량 | 장기 오차 누적 |
...
- **영상 길이·움직임 조건**에 맞는 생성 방식을 선택하고 **시간·물리 일관성** 검증 후 활용
