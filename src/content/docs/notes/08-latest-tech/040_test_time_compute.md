...
date: "2026-08-26T16:57:17+09:00"
...
- 배경/필요성: 모든 질의에 같은 연산을 쓰면 쉬운 문제에는 과잉 지불하고 어려운 문제에는 품질을 잃는 비용이 남으므로, 학습 시점이 아닌 추론 시점에 탐색·샘플·검증 횟수를 문제 난도에 따라 늘리는 가변 예산 계층을 두어 **품질•지연•비용**을 질의 단위로 배분
