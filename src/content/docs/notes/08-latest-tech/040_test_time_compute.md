...
- 배경/필요성: 고정 예산의 문제별 **품질•지연•비용** 조정 한계가 발생한다.

#### 한줄 요약

- **난도•위험**에 따라 추론•탐색•검증 예산 조절이 핵심이다.
...
- **동적 예산 배정**: 난도•위험별 추론 자원 할당한다.
- **조기 종료**: 품질 정체나 예산 한계에서 연산 중단이다.
...
- 능력 내재화는 **학습 시점**, 요청별 조절은 **테스트 시점**이 핵심이다.
...
- **난도•위험**으로 예산을 배분하고 **P95 지연•SLO** 안에서 종료가 핵심이다.

#### 한줄 요약

- **한계효용•P95 SLO**로 추론 예산 확대•종료를 결정한다.
