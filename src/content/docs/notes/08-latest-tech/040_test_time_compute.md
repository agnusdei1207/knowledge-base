...
- 배경/필요성: 고정 예산으로는 문제별 **품질•지연•비용** 동시에 조절하기 어렵음.

#### 한줄 요약
- **난도**•**위험** 대상 따라 추론•탐색•검증 예산 조절
...
1. 난도•위험 추정: 복잡도•불확실성•**영향도** 활용 산정함.
2. 추론 예산 할당: 토큰•시간•후보의 **상한 설정**
3. 후보 생성•탐색: 과업별 **추론 전략** 선택함.
4. 품질•안전 검증: 임계값•제약 기반 **후보 판정**
5. 종료•정책 환류: 통과•정체•초과 기록과 **예산 보정** #### 한줄 요약
...
#### 한줄 요약
- 능력 내재화는 **학습 시점**, 요청별 조절은 **테스트 시점** ## Ⅵ. 실무 고려사항 및 대책
