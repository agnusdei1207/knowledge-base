...
| URI 템플릿 | **URI Template** 기반 리소스 범위를 표현함 |
| 내용 제공기 | **JSON-RPC** 기반 URI 콘텐츠를 반환함 |
| 변경 알림 관리자 | **변경 알림 구독** 관리함 |
...
|:---|:---|:---|:---|
| 적용 기준 | **Resource** 기반 문맥 데이터를 제공함 | **Tool** 외부 기능을 실행함 | **Prompt** 기반 사용자 작업 틀을 제공함 |
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| URI 조작으로 범위 밖 조회 | **리소스 통제 원칙** 대상 따라 템플릿•테넌트 권한을 재검증함 | 경로•테넌트 우회를 방지함 |
| 과다 제공으로 문맥 오염•정보 노출 | 목적별 분할•최소 필드를 적용함 | 문맥 품질•기밀성을 확보함 |
| 빈번한 변경으로 최신성 저하 | **변경 알림 갱신** 기반 필요한 URI만 재조회함 | 최신성 확보 및 트래픽을 감소함 |
