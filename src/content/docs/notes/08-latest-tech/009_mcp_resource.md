...
date: "2026-07-30T15:16:00+09:00"
tags:
  - "notes-latest_tech"
weight: 9
extra:
...
| 절차 | 설명 |
|:---|:---|
| 리소스 목록·템플릿 요청 | 사용 가능한 고정·매개변수형 URI를 탐색 |
| URI·이름·MIME 명세 제공 | 리소스의 식별자와 설명 및 콘텐츠 형식 수신 |
| 권한 범위의 URI 읽기 요청 | 호스트가 선택한 리소스의 최신 내용 요청 |
| URI 해석·저장소 내용 조회 | 서버가 요청 주체·테넌트를 검증하고 원천 데이터 검색 |
| 텍스트·바이너리 내용 또는 변경 알림 | 콘텐츠를 반환하거나 구독된 URI의 재조회 필요성을 통지 |
