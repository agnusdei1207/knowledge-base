...
date: "2026-08-06T20:33:00+09:00"
tags:
  - "notes-latest_tech"
weight: 9
extra:
...
- **최신성 축**: subscriptions/listen 기반 변경 알림 전달

#### 한줄 요약
- **URI•MIME**으로 자료를 읽고 선택한 변경 알림 수신
...
1. **리소스 목록•템플릿 요청**: 권한 범위의 URI•템플릿 조회
2. **URI 읽기 요청**: 선택한 리소스의 텍스트•바이너리 내용 요구
3. **URI 해석•권한 검증 후 내용 반환**: MIME과 검증된 내용 제공
4. **변경 알림 구독 등록**: subscriptions/listen에서 알림 유형 선택
5. **구독 리소스 변경 알림**: 변경된 URI의 재조회 필요성 통지
