...
date: "2026-08-26T16:52:31+09:00"
tags:
  - "notes-latest_tech"
weight: 9
extra:
...
- 배경/필요성: 파일·데이터베이스·API마다 탐색·조회 방식이 달라 문맥 주입 코드를 소스 수만큼 다시 쓰는 비용이 들므로, 읽기 전용 데이터를 URI로 식별하는 자원 계층을 두어 소스 차이를 주소 규약 뒤로 감추고 문맥을 재사용
