...
- 정의: 국가나 권역이 AI 데이터, 모델, 컴퓨팅, 운영 의사결정의 실질적 통제권을 확보하는 모델.
- 필요성: 외부 모델 및 인프라 종속 시 발생하는 공급망 중단, 법률 충돌에 따른 독자적인 교체 및 복구 제약 해결.
...
- 국가안보 및 공공 핵심 AI는 직접 통제, 비핵심 기능은 외부 조달을 통한 단계적 주권 전략 적용.

#### 한줄 요약

- 핵심 판단 기준 수립 기반의 단계적 적용 전략 필수.
