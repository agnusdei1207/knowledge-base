...
- **소버린 AI(Sovereign AI)**: 국가·권역이 AI의 데이터·모델·컴퓨팅·운영 의사결정에 실질적 통제권을 확보하는 체계이다.
...
- **직접 통제**: 핵심 AI의 데이터·모델·컴퓨팅·중단 결정을 국가·권역이 스스로 행사하는 방식이다.
- **외부 조달**: 비핵심 AI 기능을 계약과 통제 조건 아래 외부 사업자의 서비스로 사용하는 방식이다.
