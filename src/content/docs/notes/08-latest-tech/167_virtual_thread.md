...
- 콜백 분할 없이 흐름•예외를 추적하는 **작업별 스레드 모델** 핵심임.
- 블로킹 입출력 대기에 캐리어를 반환하는 **마운트**•**언마운트** 핵심임.
- JDK 24 이후 synchronized 대기 해제와 **native•foreign 피닝 잔존** 핵심임.
...
- **피닝 관측•하류 동시성 제한** 가능한 입출력 작업에 적용
