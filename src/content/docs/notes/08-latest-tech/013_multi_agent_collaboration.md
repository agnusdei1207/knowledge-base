...
date: "2026-08-06T20:48:00+09:00"
tags:
  - "notes-latest_tech"
weight: 13
extra:
...
- 정의/개념: 복수의 자율 에이전트가 역할•작업•상태•결과를 조정하는 **MAS 기반 협업**
- 배경/필요성: 단일 에이전트로는 복합 과업의 **동시 전문 수행•독립 검증 불가**

#### 한줄 요약

- 공동 목표에 맞춘 **역할 특화•상태 공유•결과 통합**
...
> 요약: 통합에는 **중앙형**, 위임에는 **계층형**, 합의에는 **분산형** 적용

#### 한줄 요약

- **역할 전문성**과 조정•합의 비용을 함께 비교
...
- 독립 전문 과업에는 **MAS**, 역할 분리가 어려운 단순 과업에는 **단일 에이전트** 선택

#### 한줄 요약

- 과업 의존성•검증 필요성에 따라 **MAS•단일 에이전트** 선택
