...
- 정의: **클라우드 마이그레이션 6R** 기반 업무 가치와 기술 조건에 따라 애플리케이션별 유지•폐기•이전•개선•재설계•교체 전략을 선택하는 분류 체계임이다.
...
- Retain•Retire 기반 **이전 제외 판단** 핵심임.
- Rehost•Replatform 기반 **속도와 개선 폭 조절** 핵심임.
- Refactor•Repurchase 기반 **구조•제품 전환** 핵심임.
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 누락된 **종속성** 기반 전환 실패 | **트래픽•CMDB•인터뷰 교차 검증** | **웨이브 장애** 감소 |
