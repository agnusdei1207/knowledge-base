...
- Retain·Retire의 **이전 제외 판단**
- Rehost·Replatform의 **속도와 개선 폭 조절**
- Refactor·Repurchase의 **구조·제품 전환**
- 자산별 결정보다 종속성 기반 **웨이브 실행**
...
> 요약: 자산과 종속성을 평가해 6R을 정하고 준비된 환경으로 웨이브 전환한다
...
> 요약: 자산·종속성 평가부터 전략 선택과 전환 검증까지 추적한다
...
> 요약: 가치와 변경 폭 및 목표 기한으로 6R 전략군을 선택한다
