...
- **1. 자산•소유자 정보**: 가치•비용•기술 상태와 책임자를 확인함.
- **2. 종속성•중단 영향**: 호출•데이터 흐름과 허용 중단 시간을 분석함.
- **3. 전략•목표 환경 결정**: 대상별 6R과 성공 기준을 선택함.
- **4. 웨이브 전환 준비**: 랜딩 존•데이터 동기화•순서•롤백을 구성함.
- **5. 검증•롤백•자산 종료**: 수용 기준 확인 후 구환경 폐기 또는 복귀임.
...
- 가치 없음은 **Retire**, 빠른 이전은 **Rehost•Replatform**, 차별화는 Refactor•Repurchase을 선택함.

#### 한줄 요약

- 전략 이름을 붙이는 데서 끝나지 않고 연결된 시스템의 전환 순서와 구환경 종료까지 설계해야  체계 적용
