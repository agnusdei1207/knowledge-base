...
date: "2026-08-06T21:32:00+09:00"
tags:
  - "notes-latest_tech"
weight: 24
extra:
...
2. **KV Cache 조회**: 과거 토큰의 어텐션 상태 재사용
...
- **KV Cache•자기회귀 생성**으로 다음 토큰을 반복 예측
...
- 최신 지식에는 **RAG**, 고위험 업무에는 **검증형**, 비용 제약에는 **SLM** 선택

#### 한줄 요약

- 최신 지식은 **RAG**, 고위험 결과는 **검증형 적용**
