...
- **거대 언어 모델(Large Language Model, LLM)**: 대규모 말뭉치에서 토큰 관계를 학습한 언어 모델
...
- **배경/필요성**: 과업별 모델 구축 비용을 범용 사전학습으로 절감
...
- 자기지도 학습으로 비정형 문장을 활용한다
- 문맥 지시·예시만으로 새 과업에 적응한다
- 확률 생성으로 같은 입력의 출력도 달라진다
- 지식의 시점·근거·편향을 자체 보장하지 않는다
