...
1. 고속도로 **Level 2 차로·속도 보조**

### 쉽게 이해하기 (학습용)

- 차로 유지와 속도 제어를 동시에 지원하되 운전자 상태와 센서 신뢰도를 계속 감시하고 이상 시 경고 후 기능을 안전하게 해제한다.

## Ⅶ. 결론

- 운전자 보조 기능을 자율주행으로 오인하는 위험을 막기 위해 제어 축·운전자 감독·센서 한계·기능 해제 조건을 검토하여, 책임 경계가 명확한 ADAS 수준과 안전 전환을 설계해야 한다.
