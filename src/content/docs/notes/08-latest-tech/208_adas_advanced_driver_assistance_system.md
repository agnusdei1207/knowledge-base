...
- 정의: 환경•운전자 상태를 인지해 경고•조향•가감속을 보조하는 **ADAS**임이다.
...
- 다중 센서 융합 기반 **객체•차선•충돌 위험 인지** 핵심임.
- SAE Level 0~2의 **AEB•ACC 종방향, LKA 횡방향 보조** 핵심임.
- DMS•센서 감시 기반 **운전자 감독•기능 저하 전환** 핵심임.
#### 한줄 요약
...
**DMS**•**HMI** 운전자 상태와 경고•제어 결과를 연결한다.
...
- ODD•센서 한계 초과 시 **기능 저하•해제**, **운전자 감독 책임** 유지함.

#### 한줄 요약

- **ODD•기능 한계•운전자 감독 책임** 명시한 ADAS만 적용
