...
date: "2026-08-26T17:24:33+09:00"
tags:
  - "notes-latest_tech"
weight: 154
extra:
...
- 배경/필요성: 단일 장치는 데이터가 늘어난 만큼 반복 시간을 그대로 치러 **처리량•학습 시간 제약**을 받으므로, 모델을 장치마다 복제해 배치를 나눠 계산 시간을 장치 수로 나누고 그 대가로 기울기 동기화 통신만 새로 지불하는 구조의 필요
