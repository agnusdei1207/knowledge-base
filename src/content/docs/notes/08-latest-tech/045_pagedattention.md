...
date: "2026-08-06T22:58:00+09:00"
tags:
  - "notes-latest_tech"
weight: 45
extra:
...
- 정의/개념: KV Cache를 고정 크기 비연속 블록에 할당하고 블록 테이블로 논리 순서를 복원하는 **PagedAttention**
...
4. **참조 블록 회수**: 공유 참조가 없는 블록을 풀에 반납해 **재사용 가능 상태** 전환
...
- 가변 길이•고동시성에는 **PagedAttention**, 블록 크기에는 **단편화•조회 비용 실측** 적용

#### 한줄 요약
- **길이 분포•동시성•조회 비용**으로 할당 방식 선택
