...
- 정의: 정의된 ODD에서 전체 DDT와 대체 대응을 수행하는 **ADS**임이다.
- 배경/필요성: 운전자 지원과 자동주행의 혼동은 **환경 감시•비상 대응 책임 공백** 초래함.
...
- 조향•가감속•OEDR을 포함한 **전체 DDT 수행** 핵심임.
- 도로•날씨•속도에 따른 **명시적 ODD 기반 작동 제한** 핵심임.
- SAE Level 3 운전자•Level 4 이상 시스템의 **대체 대응 책임 구분** 핵심임.
#### 한줄 요약
...
- SAE Level 3는 **운전자 인계**, Level 4 이상은 **시스템 MRM** 적용함.

#### 한줄 요약

- **ODD•DDT•fallback 주체•MRC** 활용 명시하고 검증
