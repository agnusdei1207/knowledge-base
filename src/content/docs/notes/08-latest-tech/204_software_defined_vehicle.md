...
- 정의: 중앙 컴퓨팅•서비스 기반으로 차량 기능을 지속 갱신하는 **SDV 구조**임이다.
- 배경/필요성: 기능별 분산 ECU 증가는 **통합 복잡도•변경 비용** 초래함.
...
- ECU를 HPC•구역 제어기로 통합하는 **중앙 컴퓨팅•존 구조** 핵심임.
- 공통 API로 장치 의존성을 분리하는 **하드웨어 추상화•서비스화** 핵심임.
- 검증•OTA Update•관측을 통한 **전 생애주기 갱신** 핵심임.
#### 한줄 요약
