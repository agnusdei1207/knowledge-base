...
date: "2026-08-14T11:14:00+09:00"
tags:
  - "notes-latest-tech"
weight: 198
extra:
...
- 정의: **PUE** 기반 같은 기간의 총 시설 에너지를 **IT 장비 에너지** 기반 나눈 비율임이다.
- 배경/필요성: 총전력량만으로는 IT 소비와 냉각•배전의 **시설 오버헤드** 구분하기 어렵음.
...
- **ISO/IEC 30134-2:2026** 기반 동일 경계•기간 계측이 핵심임.
- **PUE** 1에 가까울수록 비IT 오버헤드 감소•**DCiE** 증가함.
- 부하•기후 영향을 고려한 IT 효율과 **탄소•물 지표 병행** 핵심임.
#### 한줄 요약
...
**IT 장비 계측** 및 총 시설 계측은 같은 경계와 기간을 사용한다.
