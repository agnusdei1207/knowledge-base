...
- 배경/필요성: 시스템별 용어·관계 해석 차이로 지식 공유가 어려움
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 부서별 동음이의어와 **분류 기준 충돌** | 역량 질문과 범위를 먼저 정하고 용어집·상하위 관계 공동 검토 | 공유 개념의 **해석 일관성** 확보 |
| 표현력이 높은 규칙의 **공리 복잡도** 증가 | 추론 범위에 맞는 OWL 프로파일을 선택하고 규칙 복잡도 제한 | 추론의 **결정 가능성·응답 시간** 확보 |
| 클래스·속성 변경의 **하위 호환성** 훼손 | URI 안정성을 유지하고 버전·폐기 매핑·일관성 회귀 검사 | 기존 개체·질의의 **호환성** 보존 |
