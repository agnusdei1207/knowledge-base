...
| 핵심 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| 개체 연결 | 동명이인·별칭을 잘못 병합하거나 동일 개체를 중복 생성 | 고유 식별자와 문맥 기반 Entity Linking을 적용하고 불확실 후보 검수 |
| 관계·출처·시점 | 오래되거나 근거 없는 간선이 다단계 추론에 전파 | 간선별 출처·유효 기간·신뢰도를 기록하고 시점 질의 적용 |
| 스키마 정합성 | 관계 방향·타입 불일치로 탐색·추론 결과 왜곡 | 온톨로지 제약과 SHACL 검증을 적재 파이프라인에 적용 |
