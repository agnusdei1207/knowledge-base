...
- 배경/필요성: 단발성 화상회의와 개별 3D 콘텐츠는 세션이 끝나면 사용자 관계·공동 상태·활동 결과가 단절된다.
...
- **1. 지속성·동시성**: 사용자가 떠나도 공유 세계와 활동 결과가 유지된다.
- **2. 체화·현존감**: 아바타·공간 음향·실시간 상호작용으로 공동 경험을 만든다.
- **3. 생태계 운영**: 정체성·콘텐츠·경제·안전 규칙이 활동과 권리를 연결한다.
### 쉽게 이해하기 (학습용)
