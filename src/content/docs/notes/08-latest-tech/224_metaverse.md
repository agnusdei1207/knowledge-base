...
date: "2026-07-31T09:06:02+09:00"
tags:
- "notes-latest-tech"
weight: 224
extra:
...
- 정의/개념: 지속형 공유 가상공간에서 활동·권리를 연결하는 **메타버스 생태계**
...
- **지속 축**: 사용자 이탈 후에도 세계·활동 결과 유지
- **경험 축**: 아바타·공간 음향·실시간 상호작용
- **운영 축**: 정체성·콘텐츠·경제·안전 규칙 연결
### 쉽게 이해하기 (학습용)
...
| 사칭·괴롭힘으로 **사용자 안전 침해** | **연령·역할·신고·제재 정책** | 피해 범위 축소 |
| 플랫폼 종료로 **가상 자산 권리 분쟁** | **권리 계약·내보내기·환불** 절차 | 이동·종료 시 권리 보존 |
