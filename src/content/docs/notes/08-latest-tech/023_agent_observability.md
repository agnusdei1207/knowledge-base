...
date: "2026-08-06T21:28:00+09:00"
tags:
  - "notes-latest_tech"
weight: 23
extra:
...
- 정의/개념: 계획•모델•도구의 추적•지표•로그를 연결하는 **에이전트 관측성**
- 배경/필요성: 다단계 호출의 최종 결과만으로 **품질 저하•오류•비용 발생 구간** 추적이 곤란

#### 한줄 요약

- **Trace•Span**으로 지연•오류•비용 발생 구간 식별
...
- **상관 문맥•버전 속성**으로 SLO 위반 원인 구간 식별
