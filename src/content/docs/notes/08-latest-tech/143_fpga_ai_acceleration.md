...
- 데이터 경로 맞춤에 따른 **지연 감소•구현 복잡성 증가** #### 한줄 요약
...
- LUT•DSP•BRAM•인터페이스의 **맞춤 데이터 경로** ## Ⅳ. 흐름도
...
> 요약: 그래픽 처리장치는 **범용 변경**, 현장 프로그래머블 게이트 배열은 **회로 재구성**, 주문형 집적회로는 **고정** 핵심이다.
