...
- 정의: **SNN** 기반 으로 뉴런•시냅스 상태를 갱신하는 뉴로모픽 컴퓨팅이다.
...
**NC**, **GPU 기반 AI**, **엣지 MCU** 기반 전력•범용성•제어 복잡도의 우선순위가 다르다.
...
| **ANN-SNN 변환** 기반 정확도 저하 | 임계값•시간창별 **변환 오차** 검증 | 과업 정확도 보존 |
