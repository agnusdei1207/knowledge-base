...
date: "2026-08-06T21:40:00+09:00"
tags:
  - "notes-latest_tech"
weight: 26
extra:
...
- 정의/개념: 범용 표현을 사전학습해 여러 과업에 재사용하는 **파운데이션 모델**
- 배경/필요성: 과업별 전용 모델 학습은 데이터•연산 비용이 반복되고 **학습 표현의 범용 재사용** 곤란

#### 한줄 요약
- **RAG•PEFT**로 범용 모델을 여러 하위 과업에 적응
...
#### 한줄 요약
- 범용 능력과 함께 **공통 편향•취약점**도 하위 서비스에 전파
...
3. **RAG•PEFT 기반 하위 과업 적응**: 검색 문맥이나 일부 매개변수 학습으로 **도메인 적합성** 확보
4. **도메인 품질•안전 검증**: 정확성•편향•보안•규제 기준의 **배포 적합성** 판정
5. **하위 서비스 회귀 감시**: 기반 모델 변경의 공통 영향 추적

#### 한줄 요약
- **도메인 적응•안전 검증** 후 모든 하위 서비스 회귀 감시
...
- 다수 과업은 **파운데이션 모델**, 정밀 통제 단일 과업은 **전용 모델** 선택

#### 한줄 요약
- 공유 모델의 **변경 영향•시스템 위험**을 서비스별 추적
