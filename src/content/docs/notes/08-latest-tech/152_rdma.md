...
date: "2026-08-14T07:14:00+09:00"
tags:
  - "notes-latest_tech"
weight: 152
extra:
...
- 배경/필요성: 소켓의 커널 경유•복사•문맥 전환으로 **지연•CPU 부하** 발생

#### 한줄 요약
- 커널 개입 없이 **등록 메모리** 활용 네트워크 어댑터가 직접 전송
...
#### 한줄 요약
- 보호 영역•등록 메모리•QP•CQ의 **RDMA 제어 구조** ## Ⅳ. 흐름도
