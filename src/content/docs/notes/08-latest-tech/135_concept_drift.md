...
date: "2026-07-31T12:04:14+09:00"
tags:
  - "notes-latest-tech"
weight: 135
extra:
...
- 정의/개념: **개념 드리프트**는 시간이나 환경 변화로 입력과 정답 사이의 조건부 관계 $P(Y\mid X)$가 달라지는 현상
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 지연 정답 누락으로 **관계 변화 오판** | **예측·라벨 시각 정합**과 미확정 건 분리 | 개념 드리프트 **판정 정확도** 향상 |
