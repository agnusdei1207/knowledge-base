...
1. 은행은 여러 저장소의 고객 식별자·계보·민감도를 활성 메타데이터로 연결하고 접근 정책을 자동 추천한다.

### 쉽게 이해하기 (학습용)

- 메타데이터가 정확하면 분산된 고객 데이터를 찾고 민감도에 맞는 접근 통제를 자동화할 수 있다.

## Ⅶ. 결론

- 분산 데이터의 발견과 통합을 자동화하기 위해 활성 메타데이터 품질·연결 정확도·자동 조치 승인 경계를 검토하여 데이터 패브릭을 적용해야 한다.
