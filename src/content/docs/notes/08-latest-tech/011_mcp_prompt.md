...
- 사용자가 서버의 작업 양식을 선택•입력•검토한 뒤 모델에 전달함
...
- 서버가 양식과 인자를 정의하고 클라이언트 화면이 선택•검토를 지원함
...
- 템플릿 조회•인자 입력•사용자 승인 뒤 모델 문맥에 전달함
...
- 리소스는 문맥, 도구는 행동, 프롬프트는 사용자 선택 작업 틀임
...
- 템플릿 출처•버전을 확인하고 민감한 인자 입력을 제한함
...
- 출처와 입력을 사용자가 검토한 프롬프트만 모델에 전달함
