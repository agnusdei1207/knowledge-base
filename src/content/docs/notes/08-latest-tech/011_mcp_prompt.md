...
date: "2026-08-06T20:40:00+09:00"
tags:
  - "notes-latest_tech"
weight: 11
extra:
...
- 사용자가 **작업 양식•인자**를 선택•검토한 뒤 모델에 전달
...
- 서버는 인자로 메시지를 만들고 **사용자**가 전달 여부 결정
...
> 요약: 문맥에는 **Resource**, 행동에는 **Tool**, 작업 지시에는 **Prompt** 적용
