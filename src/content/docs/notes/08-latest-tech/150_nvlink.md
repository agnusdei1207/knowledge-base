...
- 배경/필요성: PCIe의 **GPU 집단 통신 대역폭•지연 한계** 발생하는 특징을 가짐.
...
- 스위치 도메인 밖의 **외부 패브릭 병목** #### 한줄 요약

- 인접•도메인•랙 간에 따른 **계층형 연결** ## Ⅲ. 구조 및 구성요소
...
> 요약: 인접 연결은 **직접 NVLink**, 도메인 연결은 **NVSwitch**, 랙 간 연결은 **InfiniBand** 핵심이다.
...
- **연결 범위** 대상 따라 직접 NVLink•NVSwitch•외부 패브릭 선택
