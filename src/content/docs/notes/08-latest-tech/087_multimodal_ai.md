...
- 정의/개념: 여러 모달리티를 정렬•융합해 공동 추론•생성하는 **멀티모달 인공지능(Multimodal Artificial Intelligence, 멀티모달 AI)**
...
> 요약: 여러 모달을 정렬•융합하는 **멀티모달 인공지능(Multimodal Artificial Intelligence, 멀티모달 AI) 기반 공동 추론 모델**
