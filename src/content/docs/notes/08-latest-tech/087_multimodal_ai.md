...
- 배경/필요성: 단일 모달은 신호 누락•잡음 시 **보완 문맥 활용 불가** #### 한줄 요약

- 텍스트•시각•음성을 연결한 **공동 추론•생성** ## Ⅱ. 특징
...
2. 시간•의미 표현 정렬: 동일 시점•대상의 **신호 관계** 활용 대응함.
...
- **저수준•중간 표현•예측 단계** 대상 따라 융합 시점 구분
