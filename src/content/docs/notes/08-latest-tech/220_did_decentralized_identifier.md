...
date: "2026-07-31T09:07:15+09:00"
tags:
  - "notes-latest-tech"
weight: 220
extra:
...
| **DID 문서** | 검증 방법과 서비스 정보 제공 |
| **DID 리졸버** | 메서드에 따라 DID 문서 해석 |
...
| **상관관계 추적** | 관계별 DID와 최소 문서 정보 | 개인정보 노출 감소 |
| **메서드 종속성** | 표준 리졸버와 상호운용 시험 | 해석 결과 일관성 확보 |
| **VC 상태 검증** | 폐기·정지 상태 목록 연계 | 유효 자격만 수용 |
