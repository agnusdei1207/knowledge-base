...
- 배경/필요성: 일반 RAG은 원천 ACL 미보존으로 **민감정보 노출 가능** #### 한줄 요약
...
- 이중 권한 통제인 **사전 필터링•반환 전 재검증** #### 한줄 요약
...
1. 신원•유효 권한 계산: 인증 상태와 그룹•정책으로 **현재 허용 범위** 활용 산출함.
2. 허용 공간 사전 필터 검색: 권한 조건을 먼저 적용한 뒤 **관련 근거** 활용 검색함.
...
#### 한줄 요약
- **색인 격리•검색 전•검색 후** 대상 따라 권한 적용 구분
