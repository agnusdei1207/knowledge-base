...
- 정의/개념: **데이터 드리프트(Data Drift)** 는 학습 기준 시점과 운영 시점 사이에서 모델 입력의 확률분포 $P(X)$가 변하는 현상
...
- **3. 분포 거리•경보 전달**: **모집단 안정성 지수(Population Stability Index, PSI)•콜모고로프-스미르노프 검정(Kolmogorov-Smirnov Test, KS 검정)** 등 문맥 임계값 기반 조기 경보
