...
- 배경/필요성: 수집•학습•추론은 **개인정보 노출•재식별 위험** 유발
...
- 강한 보호 설정에 따른 **정확도 저하•연산 비용 증가** #### 한줄 요약
...
선의 의미: 위협•신뢰 경계•분산•보호 계층•평가의 관계이다.
...
1. 보호 자산•공격자 능력 정의: 원본•업데이트•출력과 **관측 가능 주체** 활용 설정함.
2. 단계별 노출 경로 분석: 학습•집계•추론에서 개인정보가 새는 **공격 표면** 식별함.
3. 분산•노이즈•암호 기술 배치: 노출 경로별로 상호 보완적인 **보호 계층** 적용함.
4. 공격 성공률•효용 측정: 재식별•추론 공격과 정확도•지연의 **실제 결과** 활용 비교함.
5. 잔여 노출•비용 재설계: 보호 목표를 넘는 위험이나 비용의 **기술 조합** 조정함.
...
#### 한줄 요약
- **원본 비이동•개인 기여 은닉•암호 연산** 대상 따라 기법 구분
...
#### 한줄 요약
- **관측 범위•보호 예산•효용 손실** 대상 따라 보호 기술 조합 결정
