...
- 정의/개념: 요청 전송부터 첫 출력 토큰 수신까지의 초기 응답 지연인 **TTFT**
...
- `TTFT = 첫 토큰 수신 시각 - 요청 전송 시각`의 **TTFT 종단 간 측정**
...
선의 의미: 종단 측정•입구•대기•프리필•전송 책임의 정적 연결
