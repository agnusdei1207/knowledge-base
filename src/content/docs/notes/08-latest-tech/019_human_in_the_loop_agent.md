...
date: "2026-08-06T21:12:00+09:00"
tags:
  - "notes-latest_tech"
weight: 19
extra:
...
- 정의/개념: 에이전트 실행 과정에서 사람이 결과와 영향을 검토하고 계속•수정•거부•중단을 결정하는 **HITL**
- 배경/필요성: 고위험•불확실 판단의 자동 실행은 **오류 사전 차단•최종 통제권** 확보가 곤란

#### 한줄 요약
- **고위험•비가역 행동**을 사람이 검토한 뒤 실행
...
> 요약: 사전 승인에는 **HITL**, 실행 중 감시에는 **인간 감시** 적용

#### 한줄 요약
- 행동 위험도에 따라 **사전 승인•실행 중 감시** 구분
...
#### 한줄 요약
- **외부 발송•결제 위험 등급**에 따라 승인 수준•기한 차등
...
- 비가역•고위험 행동에는 **HITL**, 가역•감시 가능 행동에는 **인간 감시** 선택

#### 한줄 요약
- **근거•영향 검토**로 오류를 발견할 때 HITL 적용
