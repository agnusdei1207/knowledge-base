...
date: "2026-07-31T09:06:23+09:00"
tags:
  - "notes-latest-tech"
weight: 195
extra:
...
- 정의/개념: **실시간 스트리밍**은 연속 이벤트를 제한된 지연으로 처리하는 방식
- 배경/필요성: 배치 처리는 데이터 수집 완료 전 이상 거래·장애와 **설비 변화** 즉시 대응 곤란
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| **지연·순서 역전 이벤트** | 워터마크·허용 지연과 **수정 정책** | **정확도·지연 균형** |
