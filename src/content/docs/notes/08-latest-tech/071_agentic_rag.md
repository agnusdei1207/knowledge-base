...
| 핵심 특징 | 검색·생성 1회 수행 | 사전 정의된 분기 실행 | 상태·평가 기반 다음 행동 결정 |
| 한계 | 검색 실패 복구 곤란 | 미정의 상황 분기 누락 | 반복 루프·도구 비용 증가 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 근거 부족의 반복 탐색 | **최대 단계·비용·완료 조건** 설정 | 무한 탐색 루프 차단 |
| 부적합 도구 선택 | 목표·스키마 기반 **도구 라우팅** | 호출 실패·오용 감소 |
| 근거 간 모순 | 출처·시점 기반 **근거 평가** | 상충 근거 식별 |
