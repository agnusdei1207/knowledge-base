...
- 정의/개념: **ZKP**는 증명자가 비밀 증거를 공개하지 않고 공개 명제가 참임을 검증자에게 입증하는 암호 기술임.
- 배경/필요성: 원본 제출 검증은 비밀번호•소득•거래의 **과다 공개**를 유발함.
...
- 참인 명제의 올바른 증명을 수락하는 **완전성**이 핵심임.
- 거짓 명제의 수락 확률을 제한하는 **건전성**이 핵심임.
- 검증 결과 외 비밀을 숨기는 **영지식성**이 핵심임.
#### 한줄 요약
...
> 요약: **zk-SNARK**는 간결성, **zk-STARK**는 투명 설정•확장성 중심이 핵심이다.
...
- 작은 증명•온체인은 **zk-SNARK**, 투명 설정•대형 계산은 **zk-STARK**를 선택함.
