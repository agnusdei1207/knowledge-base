...
- 정의/개념: 비밀 증거를 공개하지 않고 명제의 참을 입증하는 **ZKP 암호 기술**
...
- **수락 축**: 참인 명제·올바른 증명의 완전성
- **거부 축**: 거짓 명제의 수락 확률을 제한하는 건전성
- **노출 축**: 검증 결과 외 비밀을 숨기는 영지식성
### 쉽게 이해하기 (학습용)
...
| 설정값 유출로 **위조 증명 가능** | **다자 설정·폐기 증적** 또는 투명 설정 | 위조 가능성 제거 |
| 허위 입력으로 **현실 사실성 불일치** | **발급자 서명·챌린지 결합** | 입력·증명 신뢰 연계 |
