...
- 배경/필요성: 단일 모달은 객체•공간과 언어 의미의 **공동 해석 곤란** #### 한줄 요약

- 이미지•텍스트를 **공동 의미 공간** 대상 연결해 판별•생성
...
- 대조•매칭•생성 목적별 **출력 능력•오류 차이** #### 한줄 요약
...
3. 판별•응답 생성: 이미지 문맥으로 **유사도•언어 토큰** 산출함.
...
- **검색•대응 판별•자연어 생성** 대상 따라 학습 목표 구분
