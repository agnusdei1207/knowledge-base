...
- **인간 감독(Human Oversight)**: AI 판단을 사람이 검토·개입·중단하고 이의제기를 처리하는 통제
- **잔여 위험(Residual Risk)**: 기술·조직 통제 뒤에도 남아 책임자의 승인과 추적이 필요한 위험
...
- 배경/필요성: 정확도 중심 개발의 **차별·안전·책임 위험** 공동 통제 한계
...
- **가치 충돌·잔여 위험**으로 기술 통제와 인간 감독 수준을 결정
