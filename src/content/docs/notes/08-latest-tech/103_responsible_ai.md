...
1. 사용 맥락•책임 원칙 확정: 영향 집단과 **공정성·안전 목표** 설정
2. 피해•가치 충돌 평가: 정확성·공정성·**프라이버시 상충** 측정
3. 통제 적용•잔여 위험 검증: 기술·조직 통제의 **효과·한계 기록**
4. 승인•인간 개입 기준 설정: **재심·중단·구제 책임** 지정
5. 사고•이의제기 구제•개선: 증적 기반 **통제·원칙 갱신**
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 집단별 오류 차이와 공정성 훼손 | 집단별 성능·피해와 **임계값 공동 검증** | 차별 위험 **측정·완화** |
