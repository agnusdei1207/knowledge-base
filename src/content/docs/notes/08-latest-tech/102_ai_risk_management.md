...
- 기존 한계: 배포 전 정확도 시험만으로는 용도·데이터·공격·규제 변화에 따른 피해를 지속해서 통제하기 어렵다.
...
- AI의 품질·안전·보안·권리 위험을 지속 관리하기 위해 **영향도·발생 가능성·통제 효과·잔여 위험·책임자**를 검토하고, 수명주기 전반에 AI 위험관리 체계를 적용해야 한다.
