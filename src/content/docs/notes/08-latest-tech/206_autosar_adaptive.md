...
1. 중앙 ADAS의 **인지와 제동 역할 분리**

### 쉽게 이해하기 (학습용)

- 고성능 인지·경로 계획은 Adaptive Platform에서 수행하고 결정적 시간 보장이 필요한 최종 제동은 Classic Platform에 분리한다.

## Ⅶ. 결론

- 고성능 차량 앱과 결정적 제어의 상충 요구를 해결하기 위해 연산 복잡도·실시간성·동적 갱신·안전 책임을 검토하여, Adaptive와 Classic의 역할·통신 경계를 명확히 분리해야 한다.
