...
- Trace ID·Span ID와 부모 관계 기반 **분산 연산의 인과관계 연결**
- 동기·비동기 경계의 스팬 컨텍스트 전파 기반 **요청 경로 연속성 유지**
- 샘플링과 배기지 정책 기반 **수집 비용·민감정보 통제**
...
| 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| 문맥 단절 | 비동기·외부 호출의 **부모 관계 유실** | 표준 전파 형식과 경계별 **주입·추출 검사** |
| 수집 비용 | 고트래픽의 **저장·처리량 급증** | 헤드·테일 **샘플링 정책과 보존 등급** |
| 배기지·속성 | 민감정보 유출·**고카디널리티** | 허용 목록·크기 제한·**민감정보 제거** |
