...
- 정의/개념: 소프트웨어 제품의 **구성요소·버전·식별자·의존 관계를 기계 판독 형식으로 기록**한 자재명세서
- 배경/필요성: 완성 제품만으로 식별하기 어려운 **직접·전이 의존성의 취약점·라이선스 영향 범위** 추적 필요
### 쉽게 이해하기 (학습용)
...
- 제품 해시·VEX·서명·출처 증거 기반 **목록 결속·영향 판정**
...
| 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| 완전성 | 전이·동적 구성의 **누락** | 다단계 생성·누락 표시와 **정확도 검증** |
| 제품 결속 | SBOM과 배포본의 **버전 불일치** | 해시·서명·출처 기반 **아티팩트 결속** |
| 최신성 | 취약점·VEX 상태의 **노후화** | 자산 연계·재평가와 **수명주기 갱신** |
...
- **구성요소 투명성·제품 결속·VEX 영향 상태·수명주기 최신성**을 결합한 소프트웨어 자산 추적 체계
