...
- 기존 한계: 에이전트마다 능력 공개·작업 상태·결과 전달 방식이 다르면 이기종 에이전트 간 협업을 개별 연동해야 한다.
...
1. 조달 에이전트가 전문 검색 에이전트의 능력과 인증 요구를 확인한 뒤 공급업체 탐색 작업을 위임하고, 작업 상태와 결과물을 추적한다.
...
- 이기종 에이전트에 장기 작업을 위임하기 위해 공개 능력·인증·작업 상태·결과물의 신뢰 조건을 검토하여 **A2A**를 활용해야 한다.
