...
- **1. 데이터 접근 요청**: 가까운 캐시 조회
- **2. 적중 데이터 반환**: 요청 위치 반환
- **3. 하위 계층 블록 요청**: 미스 블록 요구
- **4. 상주 블록 반환**: 메모리 블록 전달
- **5. 비상주 페이지 적재**: 저장장치 조회
- **6. 채운 블록 데이터 반환**: 캐시 저장 후 반환
