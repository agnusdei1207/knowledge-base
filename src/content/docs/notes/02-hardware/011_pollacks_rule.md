...
date: "2026-07-25T17:15:00+09:00"
tags:
  - "notes-hardware"
weight: 11
extra:
...
- **99백분위 응답시간(p99)**: 전체 요청의 99%가 이 시간 안에 끝난다는 뜻으로 가장 느린 꼬리 쪽 응답을 나타내며, 평균이 좋아도 이 값이 나쁘면 사용자는 느리다고 느낀다
...
- **기존 한계**: 면적을 키워도 단일 스레드 성능은 **선형 증가 불가**
