...
date: "2026-08-05T11:33:05+09:00"
tags:
  - "notes-hardware"
weight: 11
extra:
...
- **1. 병목 유형 판정**: 순차 지연과 병렬 처리량 구분
- **2. 대형 코어 확대**: 순차•p99 임계경로 단축
- **3. 소형 코어 증설**: 독립 작업의 병렬 처리량 확대
- **4. 제곱근 성능•면적 산정**: 폴락 법칙으로 수익 체감 계산
- **5. 전력•열•대역폭 검증**: 지속 가능한 후보만 확정

#### 한줄 요약

- 병목별 **코어 크기•개수** 배분과 운영 상한 검증
