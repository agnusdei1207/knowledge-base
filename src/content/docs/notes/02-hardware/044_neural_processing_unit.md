...
- **1. 추론 계획 제출**: 컴파일된 서브그래프·입력 등록
- **2. 입력 타일 적재**: SRAM 전송
- **3. 지원 서브그래프 실행**: 저정밀 MAC 결과를 SRAM에 저장
- **4. 비지원 연산 폴백**: CPU·GPU로 실행 책임 이전
- **5. 추론 결과 반환**: 가속·폴백 구간을 동기화해 출력 확정
