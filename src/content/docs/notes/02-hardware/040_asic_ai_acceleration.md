...
date: "2026-07-30T19:00:17+09:00"
tags:
  - "notes-hardware"
weight: 40
extra:
...
- **2. 온칩 SRAM 적재**: 입력·가중치를 SRAM에 배치
- **3. 재사용 데이터 분배**: NoC가 PE 배열에 멀티캐스트
- **4. PE 멀티캐스트**: 여러 처리 요소에 동시 전달
- **5. 최종 결과 전달**: 누적 결과를 DMA로 반환
