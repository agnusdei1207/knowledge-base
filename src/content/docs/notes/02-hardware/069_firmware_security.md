...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "펌웨어 보안 취약점"
date: "2026-07-25T10:42:00+09:00"
tags:
  - "notes-hardware"
weight: 69
extra:
...
- **정의/개념**: 부팅·장치 제어 코드의 보안 취약성이다
- **배경/필요성**: OS 재설치 뒤 남는 침해와 복구 실패를 막는다
...
- OS보다 먼저 실행해 침해가 재설치 뒤에도 남는다
- 긴 수명·공급사 분산은 패치를 늦춰 노출 시간을 늘린다
- 서명은 취약 코드·오설정을 못 막아 침해를 허용한다
...
1. 서버 BMC는 기기별 자격으로 관리망에 접속한다
2. 현장 기기는 서명 갱신·A/B 복구를 시험한다

### 쉽게 이해하기 (학습용)

- 서버 관리실은 업무망과 분리하고 기기마다 다른 열쇠로만 들어간다.
- 현장 기기는 서명된 새 이미지를 예비 슬롯에 설치하고 실패 시 정상 슬롯으로 돌아가는지 확인한다.

## Ⅶ. 결론

- 자산별 서명 갱신·측정·검증본 복구를 갖춘다
