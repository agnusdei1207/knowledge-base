...
- **2. 서명·버전 검증**: 신뢰 키·폐기 목록·최소 버전으로 출처와 롤백 공격 판정
- **3. 비활성 슬롯 기록**: 실행 중인 정상 이미지를 보존한 채 후보 이미지 저장
- **4. 시험 부팅·건강 확인**: 제한된 부팅에서 핵심 서비스와 장치 상태 검증
- **5. 확정·롤백 결과 보고**: 건강 검증 성공 시 활성화하고 실패 시 이전 슬롯 복구
