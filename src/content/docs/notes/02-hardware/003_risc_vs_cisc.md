...
- **1. 해독 결과 조회**: 캐시된 내부 연산 확인
- **2. 명령어 인출·해독**: 명령 필드의 내부 연산 변환
- **3. 내부 연산 저장**: 해독 결과 캐시 보관
- **4. 내부 연산 발행·실행**: 준비 연산 실행 유닛 전달
- **5. 실행 결과 기록**: 아키텍처 상태 반영
