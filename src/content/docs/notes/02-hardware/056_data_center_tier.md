...
date: "2026-07-25T10:16:00+09:00"
tags:
  - "notes-hardware"
weight: 56
extra:
...
- **정의/개념**: 설비 중복·정비·장애 허용 수준의 분류다
- **배경/필요성**: 중단 손실에 맞는 복원력 투자를 정한다
...
- Tier·Rated 숫자를 환산하면 복원력 등급을 오판한다
- 최약 필수 경로가 등급을 제한해 보강 비용을 정한다
...
1. 금융 센터: Tier III의 정비 우회를 시험한다
2. 관제 센터: Tier IV의 단일 장애를 시험한다

### 쉽게 이해하기 (학습용)

- 금융 센터는 전력 경로 하나를 정비해도 서비스가 이어지는지 확인한다
- 관제 센터는 설비 하나를 고장 내도 핵심 부하가 유지되는지 확인한다

## Ⅶ. 결론

- 정비 연속은 Tier III, 장애 허용은 Tier IV를 택한다
