...
date: "2026-08-05T17:31:32+09:00"
tags:
  - "notes-hardware"
weight: 56
extra:
...
- 정의/개념: 전력•냉각 설비의 중복성•정비 가능성•장애 허용 수준으로 시설 복원력을 구분하는 **데이터센터 등급 분류 체계**
- 배경/필요성: 공통 기준 없이는 시설별 **복원력•비용 비교 불가**

#### 한줄 요약

- 정비•장애 중 **핵심 부하 지속 수준** 을 등급화
...
- **1. 대체 경로 상태•용량 검증**: 부하 연속 공급 확인
- **2. 핵심 부하 공급 전환**: 검증된 대체 경로로 부하 이동
- **3. 정비 경로 격리**: 작업 구간의 활성 경로 영향 차단
- **4. 정비•복구•단독 기능 확인**: 재투입 조건 검증
- **5. 경로 재투입•중복도 회복**: 예비 설비 여유 복원
...
- Tier III는 정비, Tier IV는 단일 장애 중 부하 유지
...
- 정비 중 연속성 요구에는 **Tier III**, 단일 장애 유지 요구에는 **Tier IV** 선택
