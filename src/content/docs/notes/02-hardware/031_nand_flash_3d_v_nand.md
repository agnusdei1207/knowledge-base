...
date: "2026-07-28T12:51:22+09:00"
tags:
  - "notes-hardware"
weight: 31
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| 워드라인 적층 | 층 선택 전압 | 같은 높이의 셀 선택 |
| 전하 저장 셀 | 임계 전압 상태 | 비휘발성 비트 저장 |
| 수직 채널 스트링 | 선택 셀 전류 | 적층 셀과 비트라인 연결 |
| 페이지·블록 배열 | 읽기·프로그램·삭제 명령 | 페이지 입출력·블록 초기화 |
...
- 저장 밀도 향상을 위해 적층·내구성을 검토하여 **3D NAND** 활용
