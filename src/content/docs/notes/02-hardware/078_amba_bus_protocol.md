...
date: "2026-08-26T16:11:00+09:00"
tags:
  - "notes-hardware"
weight: 78
extra:
...
- 배경/필요성: IP마다 인터페이스가 다르면 SoC에 붙일 때마다 접속 로직을 새로 만들어 **IP 재사용 한계**와 **온칩 통신 병목**을 함께 치르므로, 온칩 통신을 표준 규격으로 고정하고 성능 요구에 따라 AXI·AHB·APB로 계층을 나눠 필요한 만큼만 회로 비용을 지불할 필요
...
- 고대역폭 IP는 **AXI·CHI**, 저속 주변장치는 **APB** 선택
