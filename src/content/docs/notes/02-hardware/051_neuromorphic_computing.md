...
- **정의/개념**: 입력 변화만 스파이크로 처리하는 구조다
- **배경/필요성**: 상시 연산의 전력 낭비를 줄인다
...
- 스파이크 시점·빈도는 값과 시간 정보를 함께 보존한다
- 희소 이벤트만 연산해 유휴 전력과 응답 지연을 줄인다
