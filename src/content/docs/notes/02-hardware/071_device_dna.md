...
date: "2026-07-30T21:29:14+09:00"
tags:
  - "notes-hardware"
weight: 71
extra:
...
- **1. 논스·수집 정책**: 세션별 재전송 방지 기준 전달
- **2. 장치 특성**: 허용한 최소 특징을 현재 벡터로 구성
- **3. 기준 DNA 요청**: 등록 이력과 특징별 안정도 조회
- **4. 유사도·위험 점수**: 자연 변동과 위장 가능성 계산
- **5. 추가 인증 요청**: 위험 구간에서 별도 인증 수행
...
| 이전 지문을 재전송해 현재 장치로 위장 | **논스·세션 바인딩** | **재전송 인증 우회** 방지 |
