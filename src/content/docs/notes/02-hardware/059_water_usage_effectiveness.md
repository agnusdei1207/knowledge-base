...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "물 사용 효율 (WUE)"
date: "2026-07-25T10:22:00+09:00"
tags:
  - "notes-hardware"
weight: 59
extra:
...
- **정의/개념**: 현장 물을 IT 에너지로 나눈 비율이다
- **배경/필요성**: 냉각의 물 소비와 지역 위험을 줄인다
...
- 물 사용 증가는 WUE를 높여 물 비용을 늘린다
- 증발 냉각은 PUE를 낮춰도 WUE와 물 위험을 높인다
- 기후·냉각·IT 부하 차이는 WUE 비교를 왜곡한다
...
| 주요 위험 | 수원별 희소성 미반영 | IT 작업 효율 미반영 | 지역·시간별 계수 의존 |
