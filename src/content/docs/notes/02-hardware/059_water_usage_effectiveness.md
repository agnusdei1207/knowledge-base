...
```mermaid
sequenceDiagram
    participant E as 물·IT 에너지 계량·환경 정보
...
> 요약: 물·IT 에너지 비율과 지역 물 부족도를 분석

**동작 원리**

- **① 수원별 현장 물 사용량 전달**: 냉각·가습·설비 사용량 계량
- **② IT 장비 에너지 전달**: 같은 기간의 WUE 분모 제공
- **③ 외기·가뭄·물 부족도 전달**: 지역·계절 환경 영향 구분
- **④ 수원·배출·계량 시각 정보 전달**: 물 수지 경계와 결측 정보 제공
- **⑤ 계량 보완·비교 제외 요청**: 경계·집계 창 불일치 데이터 차단
- **⑥ 검증된 물·IT 에너지·환경 조건 전달**: 유효한 분석 조건 제공
- **⑦ WUE·수원별 사용·지역 위험 보고**: 비율·절대량·수원 비중 병기
- **⑧ 냉각 방식·수원 조정 후 재계량**: PUE·CUE 역효과까지 재평가
...
- 가뭄 지역은 증발 냉각을 줄이고 건식 냉각·재생수를 늘리되 전력·탄소 증가도 측정한다
