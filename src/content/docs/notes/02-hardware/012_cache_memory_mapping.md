...
date: "2026-08-05T11:33:47+09:00"
tags:
  - "notes-hardware"
weight: 12
extra:
...
- **1. 인덱스•태그 탐색**: 후보 집합과 저장 태그 비교
- **2. 적중 데이터 선택**: 일치 웨이의 오프셋 데이터 반환
- **3. 교체 웨이 선택**: 미스 시 축출 대상 결정
- **4. 하위 블록 조회**: 요청 블록을 하위 계층에서 가져오기
- **5. 태그•상태•데이터 리필**: 선택 웨이에 새 라인 기록
