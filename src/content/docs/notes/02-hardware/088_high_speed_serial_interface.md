...
| 씨씨 핀(CC Pin) | 케이블 뒤집어 꽂았는지 확인하고, "너 몇 볼트 먹냐?" 하고 전력(**USB PD**)을 강력히 협상하는 탐지 센서 |
...
| USB-C로 화면 띄우면서 동시에 100W 땡기다가 포트 단자가 급격히 뜨거워져 녹아내림 | **USB PD** 칩이 온도 센서랑 연동해서 뜨거워지면 전류를 제한(스로틀링) | 포트 과열로 인한 화재나 칩셋 사망을 원천 차단해 안전한 지속 사용 보장 |
