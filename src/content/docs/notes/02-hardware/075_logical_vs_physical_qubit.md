...
- **1. 보호 자원 요청**: 목표 오류율 지정
- **2. 물리 계획 반환**: 큐비트·주기 배치
- **3. 내결함 일정 전달**: 물리 게이트 변환
- **4. 데이터 게이트 실행**: 패치 상태 변경
- **5. 안정자 측정 실행**: 보조 큐비트 판독
- **6. 오류 증후군 전달**: 복호 입력 생성
- **7. 파울리 프레임 반환**: 보정 상태 기록
