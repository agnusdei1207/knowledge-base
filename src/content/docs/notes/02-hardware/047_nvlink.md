...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "NVLink"
date: "2026-08-26T15:37:00+09:00"
tags:
  - "notes-hardware"
weight: 47
extra:
...
- 배경/필요성: 다중 GPU가 PCIe로 통신하면 호스트 대역폭을 나눠 쓰며 CPU 메모리를 경유해 동기화 구간마다 대기를 쌓아 **대규모 텐서 교환**이 병목이 되므로, GPU 간 전용 링크를 직결해 P2P 메모리 접근을 호스트 밖에서 완결할 필요
...
- 노드 내 GPU 확장은 **NVLink**, 노드 간 확장은 **InfiniBand** 선택
