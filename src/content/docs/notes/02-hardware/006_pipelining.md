...
- 정의/개념: 명령 단계 중첩 기반 **처리량 향상 구조**
- 배경/필요성: 후속 명령의 **단계 진입 대기** 제거
...
- **1. 명령어 인출·IF/ID 전달**: 명령·PC값 저장
- **2. 해독·피연산자 전달**: 값·제어 신호 전달
- **3. 연산·주소 결과 전달**: ALU·주소 결과 저장
- **4. 메모리·연산 결과 전달**: 접근값·연산값 전달
- **5. 결과 기록·다음 인출**: 기록과 후속 인출 지속
