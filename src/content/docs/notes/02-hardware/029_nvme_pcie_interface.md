...
- **1. SQ 명령 기록**: 명령·버퍼 주소 저장
- **2. 도어벨 갱신**: 새 꼬리 위치 통지
- **3. SQ 명령 DMA 조회**: 명령 엔트리 읽기
- **4. 플래시 작업 실행**: 채널 병렬 처리
- **5. 데이터·CQ DMA 기록**: 결과·완료 저장
- **6. MSI-X 완료 통지**: 담당 CPU 알림
- **7. CQ 엔트리 회수**: I/O 완료 처리
