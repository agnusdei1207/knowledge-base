...
date: "2026-08-26T15:16:00+09:00"
tags:
  - "notes-hardware"
weight: 29
extra:
...
- 배경/필요성: SATA·AHCI는 큐가 하나뿐이라 NAND의 채널·다이 병렬성을 살리지 못하고 명령을 직렬화하며 **호스트 I/O 지연**을 누적시키므로, 코어별 다중 큐를 PCIe에 직결해 큐 경합 없이 병렬 발행하는 규격의 필요
...
- 로컬 병렬 I/O는 **NVMe**, 원격 풀링은 **NVMe-oF** 선택
