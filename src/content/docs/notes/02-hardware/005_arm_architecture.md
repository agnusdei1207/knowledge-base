...
date: "2026-08-05T10:28:49+09:00"
tags:
  - "notes-hardware"
weight: 5
extra:
...
- **1. 벡터 주소 조회**: 복귀 상태 저장•VBAR_ELx 기준 엔트리 선택
- **2. ELx 처리기 진입**: 선택한 예외 수준으로 제어 전환
- **3. ERET 실행**: SPSR_ELx•ELR_ELx로 PSTATE•PC 복원

#### 한줄 요약
- 예외 진입•처리•ERET 복귀를 잇는 **ARM 코어** 제어 흐름
