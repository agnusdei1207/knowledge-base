...
date: "2026-08-26T12:33:45+09:00"
tags:
  - "notes-hardware"
weight: 5
extra:
...
- 배경/필요성: 단일 프로파일로는 **전력·성능**과 **실시간성**을 동시에 만족할 수 없으므로, 공통 로드·스토어 RISC 코어 위에 응용 영역별 프로파일(A/R/M)을 분화해 각 영역이 쓰지 않는 회로 비용을 치르지 않도록 분리
...
- 범용 OS는 **A-Profile**, 결정론·저전력 제어는 **R/M-Profile** 선택
