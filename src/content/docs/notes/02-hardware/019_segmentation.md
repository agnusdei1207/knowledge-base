...
- **x86 32비트**: ‘엑스팔육 삼십이 비트’로 읽고 8086 계열 이름의 86과 주소 폭을 결합한 표기이며, 세그먼트 변환 후 페이징을 적용하는 대표 구현이다
...
| 절차 | 설명 |
|:---|:---|
| 논리 주소 전달 | 세그먼트 번호·오프셋 형식의 **주소 요청** |
...
| 접근 결과 반환 | 물리 메모리의 읽기·쓰기 **처리 결과** 반환 |
