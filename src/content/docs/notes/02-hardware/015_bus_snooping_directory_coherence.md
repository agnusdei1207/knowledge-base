...
- **① 쓰기 권한 요청**: 홈 디렉터리에 배타적 쓰기 권한 요구
- **② 공유자 목록과 무효화 명령 전달**: 공유자 명단과 명령을 연결망에 전달
- **③ 지정 캐시에 무효화 요청**: 명단의 공유자에게만 무효화 전송
- **④ 무효화 완료 응답**: 공유자가 읽기 권한 제거 후 완료 통보
- **⑤ 전체 공유자 응답 수합 완료**: 모든 대상의 응답 도착 확인
- **⑥ 배타적 쓰기 권한 부여**: 명단 갱신 후 요청 캐시에 독점 권한 부여
