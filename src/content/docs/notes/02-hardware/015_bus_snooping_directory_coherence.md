...
date: "2026-08-02T19:05:00+09:00"
tags:
  - "notes-hardware"
weight: 15
extra:
...
- **버스 스누핑•디렉터리 일관성(Bus Snooping•Directory Coherence)**: 캐시 일관성 프로토콜을 구현할 때 공유 버스의 요청을 모든 캐시가 감시하거나 디렉터리가 라인별 공유자를 추적하는 두 방식
...
- **상태 교착·활성**: 요청들이 서로 기다려 진행하지 못하는 상태와 모든 요청이 결국 완료되어야 한다는 성질
