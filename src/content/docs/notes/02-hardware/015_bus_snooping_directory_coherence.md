...
- 정의/개념: **방송·공유자 추적** 기반 일관성 구현
- 배경/필요성: 캐시 사본의 **무효화 대상 식별**
...
- **1. 쓰기 권한 요청**: 독점 권한 요구
- **2. 공유자 목록 전달**: 대상 캐시 명단 전달
- **3. 지정 캐시 무효화**: 읽기 권한 제거 요청
- **4. 무효화 완료 응답**: 제거 완료 통보
- **5. 전체 응답 수합**: 대상별 완료 확인
- **6. 배타적 쓰기 권한 부여**: 명단 갱신·권한 전달
