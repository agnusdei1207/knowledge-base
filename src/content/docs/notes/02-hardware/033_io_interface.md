...
date: "2026-07-30T18:51:16+09:00"
tags:
  - "notes-hardware"
weight: 33
extra:
...
- **1. DMA 작업 준비**: 디스크립터·버퍼 주소 설정
- **2. 전송 시작**: 엔진이 주소·길이·방향 회수
- **3. 장치 데이터 전송**: CPU 복사 없이 블록 전달
- **4. 수신 버퍼 기록**: 주기억장치에 직접 저장
...
- 짧은 대기는 **폴링**, 비정기 사건은 **인터럽트**, 대용량은 DMA
