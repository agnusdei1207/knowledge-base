...
date: "2026-07-28T12:52:10+09:00"
tags:
  - "notes-hardware"
weight: 33
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| CPU·드라이버 | 운영체제 요청·완료 상태 | 전송 설정·완료 처리 |
| 장치·제어기 | 장치 신호·명령 | 상태·데이터 형식 변환 |
| DMA·채널 엔진 | 주소·길이·방향·명령열 | 블록 전송·I/O 명령 실행 |
| 주기억장치 | 버퍼·디스크립터·채널 명령 | 전송 데이터·제어 정보 보관 |
...
- 입출력 효율을 위해 대기·전송량을 검토하여 **I/O 방식** 활용
