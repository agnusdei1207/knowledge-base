...
date: "2026-07-28T12:52:37+09:00"
tags:
  - "notes-hardware"
weight: 34
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| IRQ 원천 | 장치·타이머 사건 | 비동기 요청 발생 |
| 인터럽트 제어기 | 요청·마스크·우선순위 | 수락 대상 중재 |
| 벡터·체인 식별 경로 | 벡터 번호·승인 순서 | 요청 원인 식별 |
| CPU·ISR 문맥 | PC·레지스터·상태 | 원인 처리·실행 복귀 |
...
- 사건 응답을 위해 원인 수·우선순위를 검토하여 **인터럽트** 활용
