...
date: "2026-07-28T12:50:37+09:00"
tags:
  - "notes-hardware"
weight: 30
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| LPN→PPA 매핑 테이블 | 논리·물리 대응·유효 상태 | 최신 물리 위치 제공 |
| 가비지 컬렉터 | 무효 비율·여유 블록 | 유효 페이지 이주·블록 회수 |
| 마모도 평준화기 | 블록별 프로그램·삭제 횟수 | 쓰기·삭제 부하 분산 |
| 메타데이터 복구기 | 체크포인트·저널 | 정전 후 매핑 복원 |
