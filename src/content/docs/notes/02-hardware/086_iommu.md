...
date: "2026-07-30T21:41:36+09:00"
tags:
  - "notes-hardware"
weight: 86
extra:
...
- **큰 페이지(Huge Page)**: 기본 페이지보다 큰 주소 단위로 IOTLB 항목 하나가 더 넓은 메모리를 덮게 하는 페이지

## Ⅰ. 개요

- 정의/개념: IOVA를 물리 주소로 변환하고 **장치 DMA 권한**을 검사하는 장치
...
4. **물리 주소·권한**: 유효 요청만 물리 메모리 접근으로 변환
