...
1. **토큰 매칭•준비 판정**: 같은 인스턴스의 피연산자 충족 확인
2. **준비 연산 병렬 발행**: 준비 노드를 유휴 실행 유닛에 배정
3. **결과 토큰 생성•전달**: 목적지 태그로 후속 노드 활성화

#### 한줄 요약

- **독립 준비 노드 병렬 실행**과 의존 노드의 토큰 대기
...
- **토큰 수명•연산 입도•지역성 배치**로 저장•통신 부담 통제
