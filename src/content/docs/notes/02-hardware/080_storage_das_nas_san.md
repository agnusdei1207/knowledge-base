...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 사람들이 나스(NAS)에서 동영상 파일 급격히 뽑아 쓰다가 랜선이 꽉 막혀 시스템 전체가 마비되는 재앙 | 일반 랜선 뜯어버리고 텐지(10G) 랜카드로 강화한 뒤 링크 집성(LACP)으로 대역폭을 대폭 확장 | 좀비 떼처럼 몰려드는 트래픽을 씹어먹고 파일 전송 속도 성능 저하 방지 |
