...
- **1. 작업 요구 전달**: 시간 요구 등록
- **2. 실행·데드라인 등록**: 태스크 자원을 배정하고 완료 판정 기준 설정
- **3. 완료 시각 전달**: 실행 결과와 실제 종료 시각을 감시기에 보고
- **4. 데드라인 판정·조치**: 하드는 안전 전환, 펌은 결과 폐기, 소프트는 품질 저하 허용
- **5. 미스 상태 반영**: 누적 위반을 다음 스케줄·용량 계획에 반영
...
- **데드라인 미스 피해·결과 가치** 기반 하드·펌·소프트 유형 결정
