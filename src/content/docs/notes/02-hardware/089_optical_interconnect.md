...
date: "2026-07-31T10:20:07+09:00"
tags:
  - "notes-hardware"
weight: 89
extra:
...
- **광 전력 기호($P_{\mathrm{tx}},P_{\mathrm{rx}},P_{\mathrm{sens}}$)**: 각각 송신 전력·수신 전력·수신기의 최소 감도 전력을 나타내며 링크 버짓 산출에 사용
- **총 경로 손실($L_{\mathrm{total}}$)**: 광섬유·커넥터·결합기에서 줄어든 전력을 모두 더한 값
- **링크 여유($M$)**: 수신 전력이 최소 감도보다 높은 정도로, 노화·오염·온도 변화를 견디는 여유

> **키워드:** 광 인터커넥트 (Optical Interconnect)
