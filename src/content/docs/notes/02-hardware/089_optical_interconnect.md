...
| 구멍만 한 광섬유 코어(10마이크로미터)에 빛을 쑤셔 넣다가 각도 틀어져서 빛이 다 새어버리는 대참사 | 렌즈 깎는 노인처럼 초정밀 능동 정렬(Active Alignment)로 빔 각도를 1도 단위로 강력히 꺾음 | 삽입 손실을 씹어먹고 **링크 버짓** 턱밑까지 빛을 100% 욱여넣는 광 효율 달성 |
