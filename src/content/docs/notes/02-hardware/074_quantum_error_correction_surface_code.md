...
- **1. 보조 큐비트 준비**: X·Z 기저 설정
- **2. 안정자 결합 실행**: 국소 게이트 수행
- **3. 보조 큐비트 판독**: 측정 신호 인가
- **4. 안정자 값 반환**: 패리티 비트 생성
- **5. 검출 사건 전달**: 시공간 이력 구성
- **6. 파울리 프레임 전달**: 오류 사슬 기록
- **7. 후속 해석 지시**: 논리 보정 반영
