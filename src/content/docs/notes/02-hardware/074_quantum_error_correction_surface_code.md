...
- **양자 오류 정정(Quantum Error Correction, QEC)**: 물리 큐비트의 오류를 검출·보정하여 논리 큐비트의 정보를 보호하는 기술
...
- 물리 큐비트 오류를 논리 연산이 허용하는 수준까지 낮추기 위해 **물리 오류율·임계값·목표 논리 오류율·코드 거리·복호 지연과 자원**을 검토하고, 임계값 이하에서 적합한 표면 코드를 구성한다
