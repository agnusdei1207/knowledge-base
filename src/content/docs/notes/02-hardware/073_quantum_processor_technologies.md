...
- **양자 비트(Quantum Bit, Qubit)**: 중첩 상태의 확률 진폭과 상대 위상을 저장·연산하는 양자 정보 단위
...
- 물리 큐비트를 초기화한 뒤 단일·다중 큐비트 게이트로 상태를 변환하고 마지막 측정에서 고전 비트값을 얻는다.
...
- 목표 양자 알고리즘을 안정적으로 실행하기 위해 **게이트 정확도와 시간·결맞음 시간·큐비트 연결성·확장성·냉각 요구**를 검토하고, 응용과 시스템 제약에 맞는 양자 프로세서 기술을 선택한다
