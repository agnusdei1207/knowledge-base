...
date: "2026-07-30T18:35:24+09:00"
tags:
  - "notes-hardware"
weight: 21
extra:
...
- **2. 물리 주소 라우팅**: 로컬·원격 위치 판정
- **3. 원격 메모리 요청 전달**: 인터커넥트 전달
- **4. 홈 노드 라우팅**: 주소 담당 노드 선택
- **5. 원격 메모리 접근**: 홈 노드 DRAM 접근
...
| 단일 초기화 스레드의 **최초 접근 배치 편향** | 실제 처리 스레드가 병렬 초기화하도록 구성 | 페이지 균등 분산 |
