...
- **1. NPU 활성 요청**: 작업 전 기동 요구
- **2. 전력·클록 활성화**: 초기화 해제
- **3. MMIO 작업 설정**: 주소·연산 정보 전달
- **4. 메모리 읽기 요청**: 입력·가중치 조회
- **5. 주소 라우팅·QoS 적용**: 경로·우선순위 결정
- **6. 작업 완료 통지**: 결과 회수 알림
- **7. NPU 게이팅 요청**: 유휴 블록 차단
