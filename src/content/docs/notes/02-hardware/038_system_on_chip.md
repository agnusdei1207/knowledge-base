...
date: "2026-07-28T12:54:50+09:00"
tags:
  - "notes-hardware"
weight: 38
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| 연산·기능 IP | 명령·데이터·전력 상태 | 연산·제어 수행 |
| NoC·인터커넥트 | 주소·트래픽 등급·일관성 요청 | 라우팅·중재·QoS 전달 |
| 메모리 서브시스템 | 캐시·SRAM·DRAM 상태 | 데이터 저장·공급 |
| I/O 서브시스템 | MMIO·외부 데이터 | 장치 제어·데이터 이동 |
| 전력·클록·리셋 관리기 | 부하·도메인 상태 | 전원·주파수·초기화 제어 |
