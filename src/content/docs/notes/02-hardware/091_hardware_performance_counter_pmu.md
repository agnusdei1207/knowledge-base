...
date: "2026-07-30T21:46:37+09:00"
tags:
  - "notes-hardware"
weight: 91
extra:
...
1. **이벤트·주기 조건**: 측정 사건과 표본 주기 지정
2. **코어·입력 조건**: 코어와 워크로드 입력 고정
3. **캐시·분기 사건**: 워크로드 실행 중 사건 생성
4. **선택 사건 신호**: 누적하고 오버플로 때 실행 위치 기록
...
| 높은 샘플링 빈도로 **실행 간섭** 발생 | 오버헤드 측정 후 **표본 주기 조절** | **관측 정확도·부하** 균형 |
