...
- **1. 고우선순위 ID 송신**: 작은 ID 중재 참여
- **2. 저우선순위 ID 송신**: 큰 ID 동시 참여
- **3. 중재 패배 통지**: 열성 송신 노드 대기
- **4. 승자 프레임 전송**: 프레임 연속 송신
- **5. 프레임 검사 요청**: CRC·ID 필터 확인
- **6. 정상 수신 응답**: ACK 우성 비트 전송
- **7. 재중재 기회 통지**: 유휴 후 다시 경쟁
