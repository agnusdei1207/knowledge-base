...
- 정의/개념: 서버의 **연산·메모리·I/O·관리 구조**
- 배경/필요성: 자원별 **병목·장애 범위** 통합 관리
...
- **1. 로컬 데이터 조회**: NUMA 상주 확인
- **2. 데이터 확보**: DRAM 상주 여부에 따라 로컬 반환 또는 NVMe 적재 수행
- **3. CPU·GPU 처리**: 작업 특성에 맞춰 범용 코어 또는 가속기에 실행 배치
