...
date: "2026-07-30T21:28:15+09:00"
tags:
  - "notes-hardware"
weight: 70
extra:
...
- **1. 등록 질의**: 기준 응답을 만들 입력 지정
- **2. 질의**: 제조 편차 기반 잡음 응답 생성
- **3. 보조 데이터**: 응답 대신 오류 정정 정보 보관
- **4. 키 재생 요청**: 현장 응답과 보조 데이터 결합
- **5. 복원 키**: 재현성 검증을 통과한 키 일시 제공
