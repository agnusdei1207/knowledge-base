...
date: "2026-07-31T10:08:14+09:00"
tags:
  - "notes-hardware"
weight: 72
extra:
...
- **프사이 상태 표기(\(|\psi\rangle\))**: 상태를 뜻하는 그리스 문자 프사이를 켓 기호에 넣어 전체 큐비트 상태를 나타내는 관례적 표기
- **알파·베타(\(\alpha,\beta\))**: 그리스 문자 알파와 베타를 각 계산 기저의 복소수 확률 진폭에 대응한 관례적 표기
- **계산 기저 표기(\(|0\rangle,|1\rangle\))**: 측정 결과 0과 1에 대응하는 기준 상태를 켓 기호로 나타낸 표기

> **키워드:** 양자 컴퓨팅 큐비트 (Quantum Computing Qubit)
