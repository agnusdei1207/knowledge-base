...
- **1. 스트림 의존성 등록**: 복사·커널의 비동기 순서 설정
- **2. 입력 비동기 전송**: H2D 복사로 장치 메모리 적재
- **3. 커널 실행**: 블록을 SM에 배치
- **4. 커널 완료·결과 전송**: 타일 처리 후 D2H 복사 허용
- **5. 이벤트 완료 통지**: 호스트의 결과 사용 허용
