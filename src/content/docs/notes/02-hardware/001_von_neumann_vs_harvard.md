...
- **1. 접근 요청 생성**: 명령어·데이터 주소 제시
- **2. 경로 구성 판정**: 통합·분리 버스 확인
- **3. 명령어·데이터 전송**: 순차 또는 동시 전송
- **4. 실행 입력 반영**: 명령어·데이터의 실행부 전달
