...
date: "2026-08-05T11:26:29+09:00"
tags:
  - "notes-hardware"
weight: 1
extra:
...
선의 의미: CPU와 통합 경로 또는 두 전용 경로의 정적 연결
...
#### 한줄 요약
- CPU가 통합 또는 분리된 메모리 경로로 명령어와 데이터에 접근한다.
...
- **1. 공유 경로 순차 접근**: 명령어•데이터 요청의 버스 경쟁
- **2. 분리 경로 동시 접근**: 명령어 인출과 데이터 접근 병렬 수행
