...
date: "2026-08-26T13:21:15+09:00"
tags:
  - "notes-software"
weight: 177
extra:
...
- 배경/필요성: 노드가 각자 판단하면 네트워크 분할 시 서로 다른 로그가 커밋돼 되돌릴 수 없는 정합성 파괴 비용을 치르므로, 상태 머신 앞에 과반수 동의 없이는 커밋을 인정하지 않는 합의 계층을 두어 소수 진영의 쓰기를 무효로 만들 필요
...
- 구현 명확성은 **Raft**, 기존 Paxos 계열 연계는 **Multi-Paxos** 선택
