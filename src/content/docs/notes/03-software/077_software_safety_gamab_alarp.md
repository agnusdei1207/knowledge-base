...
date: "2026-07-30T23:25:10+09:00"
tags:
  - "notes-software"
weight: 77
extra:
...
- **안전 요구(Safety Requirement)**: 위험을 탐지·차단·완화하도록 시스템이 충족해야 할 조건
- **저감 검증(Mitigation Verification)**: 안전 요구의 구현 여부와 실제 위험 감소 효과를 확인하는 활동
- **보수적 가정(Conservative Assumption)**: 불확실할 때 위험을 작게 평가하지 않도록 불리한 값을 채택하는 가정
...
- 배경/필요성: 무한 저감 요구나 비용만의 중단은 **위험 수용 객관화 불가**
...
- 참조 가능 시 **GAMAB**, 추가 저감 중단은 **ALARP**로 잔여 위험 승인
