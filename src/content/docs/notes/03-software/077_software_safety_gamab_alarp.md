...
- **정량·정성 평가(Quantitative·Qualitative Assessment)**: 정량 평가는 확률·피해 수치로, 정성 평가는 전문가 근거와 등급으로 위험을 판단한다.
...
- 정의/개념: 안전 동등성과 저감 합리성으로 위험을 판단하는 **원칙**
...
- **1. 참조 위험·운용 조건 조회**: 비교 조건을 확인
- **2. 비교 안전 근거**: 운용 통계와 성능을 제공
- **3. 위험 평가·저감 요구**: 가능성과 심각도를 판결정
- **4. 구현·검증 증거**: 위험 감소 효과를 반환
- **5. 안전 사례 제출**: 위험과 증거를 연결
- **6. 동등성·합리성 검토**: GAMAB·ALARP 근거를 확인
- **7. 잔여 위험·수용 결정**: 추가 저감 또는 수용을 결정

> 요약: 비교 안전성과 합리적 저감 증거를 안전 사례로 연결해 잔여 위험을 판결정
...
> 적용 사례: 철도 신호 변경은 비교 가능한 기존 시스템의 운용 통계와 위험을 근거로 안전 동등성을 논증할 수 존재
...
- **참조 가능성·저감 편익·독립 증거**로 잔여 위험을 판단
