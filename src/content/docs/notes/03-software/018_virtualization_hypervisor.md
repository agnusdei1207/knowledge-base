...
- 정의/개념: 물리 자원을 **격리 가상머신으로 분할**하는 기술
- 배경/필요성: 전용 배치의 **자원 유휴·환경 종속** 해소
...
- **1. VM Exit 전달**: 민감 명령 중재
- **2. 직접 자원 제어**: Type 1 경로
- **3. 호스트 서비스 요청**: Type 2 경로
- **4. 물리 장치 제어**: 호스트 드라이버 실행
- **5. 결과 반환·게스트 재개**: 하드웨어 응답 수신 후 VM Entry 수행
