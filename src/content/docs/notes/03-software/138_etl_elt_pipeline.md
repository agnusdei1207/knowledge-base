...
date: "2026-08-05T19:39:00+09:00"
tags:
  - "notes-software"
weight: 138
extra:
...
- **1. 증분 처리 구간 고정**: 재처리할 입력 위치•구조 확정
- **2. 변환 위치 선택**: 선처리 통제와 원본 보존 우선순위 판정
- **3. ETL 외부 변환•적재**: 정제•차폐 결과를 멱등 반영
- **4. ELT 원천 적재•내부 변환**: 원천 보존 뒤 내부 모델 생성
- **5. 대사•완료 위치 확정**: 검증 성공 뒤 다음 시작점 갱신
