...
date: "2026-07-31T10:24:44+09:00"
tags: [notes-software]
weight: 12
extra:
  question_no: "012"
...
> **키워드:** 세마포어·뮤텍스·모니터 (Semaphore Mutex Monitor)
...
2. **제거 위치**: 공유 버퍼에서 항목을 제거해 빈 공간 생성
3. **빈 공간 신호**: 상태 변경 뒤 조건 변수의 대기 스레드 깨움
4. **재개 신호**: 생산자가 잠금을 다시 얻고 조건을 재검사
