...
date: "2026-08-26T13:16:10+09:00"
tags:
  - "notes-software"
weight: 148
extra:
...
- 배경/필요성: 온디맨드는 언제든 쓰고 버릴 수 있는 유연성의 대가로 가장 비싼 단가를 물리므로, 항상 켜져 있는 기본 부하는 장기 약정으로 유연성을 반납해 단가를 낮추고 중단을 견디는 작업은 회수 가능한 잉여 자원으로 돌려 워크로드 성격에 맞게 단가를 배분할 필요
