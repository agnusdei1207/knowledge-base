...
- 정의/개념: 일정 사용량을 약정하거나 공급자의 자원 회수를 수용해 온디맨드보다 컴퓨팅 단가를 낮추는 **예약 인스턴스(Reserved Instance)•스팟 인스턴스(Spot Instance)** 구매 방식이다.
- 배경/필요성: 온디맨드만 사용하면 지속 수요 비용과 **할인 기회 손실**이 발생한다.
...
- **지속 수요**는 예약, **복구 가능 작업**은 스팟, 변동분은 온디맨드가 핵심이다.
