...
- **1. 시작 템플릿 선택**: 서비스 유형별 경로를 선택
- **2. 기본값·가드레일 전달**: 검증 도구와 정책을 전달
- **3. 서비스·배포 경로 제공**: 자동화 흐름을 실행
- **4. 확장·우회 요청**: 미충족 요구의 사유를 제출
- **5. 플러그인·탈출구 승인**: 예외 경로를 결정
- **6. 시간·실패·우회 기록**: 단계별 마찰을 측결정
- **7. 마찰 분석·경로 개선**: 반복 우회를 기본값에 반영
...
- **반복 빈도·예외 수요·사용 마찰**에 따라 골든 패스를 개선
