...
- 정의/개념: 기능당 운영•내재 탄소의 **소프트웨어 탄소 집약도**
...
1. **측정 경계•기능 단위 확정**: 서비스•자원•작업량 정의
2. **E•I•M•R 자료 수집**: 전력•탄소 계수•제조분 수집
3. **O•SCI 산출**: O=E×I와 SCI=(O+M)/R 계산
4. **기준선•변경안 SCI•SLO 비교**: 탄소•품질 동시 판정
