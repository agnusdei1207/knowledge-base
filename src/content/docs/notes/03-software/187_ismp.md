...
- 정의/개념: 특정 정보화 사업의 요구사항·목표 구조·구축 규모·비용·발주 방안을 구체화하는 **정보시스템 마스터플랜(Information System Master Plan, ISMP)** 실행 계획
...
- **발주 계획**: 로드맵·제안요청서(Request for Proposal, RFP)·객관적 인수 기준을 마련하는 구성요소이다.
...
- **정보시스템 마스터플랜(Information System Master Plan, ISMP)**: 개별 정보화 사업의 요구·모델·규모·비용과 제안요청서를 구체화해 실행·발주를 준비하는 계획이다.
