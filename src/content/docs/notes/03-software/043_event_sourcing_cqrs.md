...
date: "2026-07-30T23:17:55+09:00"
tags:
  - "notes-software"
weight: 43
extra:
...
> **키워드:** 이벤트 소싱·CQRS (Event Sourcing CQRS)

## Ⅰ. 개요

- 정의/개념: 상태 변경을 **이벤트 원본**으로 저장하고 **명령·조회 모델**을 분리하는 아키텍처 패턴
- 배경/필요성: 현재값 덮어쓰기로 **과거 상태 재구성·변경 원인 추적 불가**
