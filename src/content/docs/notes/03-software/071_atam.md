...
- **1. 사업 동인 수집**: 목표·제약·우선순위를 확인
- **2. 아키텍처 접근법 설명**: 구조와 근거를 제시
- **3. 품질 시나리오 요청**: 검증 상황을 수집
- **4. 중요도·난이도 평가**: 시나리오 순위를 결정
- **5. 우선 시나리오 분석**: 설계 접근법을 대입
- **6. 민감점·절충점 식별**: 품질 영향을 검색
- **7. 위험 주제·조치 보고**: 반복 위험과 책임을 결정
...
- **품질 충돌·변경 비용·위험 영향**에 따라 ATAM을 적용
