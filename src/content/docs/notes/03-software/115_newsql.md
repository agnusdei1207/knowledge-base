...
date: "2026-08-05T16:51:00+09:00"
tags:
  - "notes-software"
weight: 115
extra:
...
- **1. 대상 키 범위 추출**: 질의 조건에서 키 구간 식별
- **2. 범위•리더 위치 확인**: 복제 그룹과 현재 리더 탐색
- **3. 범위별 실행 계획**: SQL 연산을 분산 작업으로 분해
- **4. 합의 로그 항목 복제**: 변경 기록을 복제 그룹에 전달
- **5. 분산 커밋•충돌 판정**: 원자 확정 또는 취소 결정
