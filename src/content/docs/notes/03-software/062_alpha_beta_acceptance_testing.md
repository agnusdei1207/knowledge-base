...
date: "2026-08-05T13:36:02+09:00"
tags:
  - "notes-software"
weight: 62
extra:
...
1. **인수 기준•테스트 근거 확정**: 수용 조건 명시
2. **시험 환경•업무 시나리오 배정**: 역할•범위 구분
3. **실행 결과•결함•의견 수집**: 실제 업무 증거 확보
4. **기준별 테스트 증거 판정**: 수용•보완•거부 결정

> 요약: 목적에 맞는 환경에서 얻은 사용자 증거를 합의한 인수 기준과 대조

#### 한줄 요약

- 기준•환경•사용자 증거 기반 **수용 결정 흐름**
