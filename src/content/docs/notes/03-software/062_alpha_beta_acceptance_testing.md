...
date: "2026-07-30T23:14:54+09:00"
tags:
  - "notes-software"
weight: 62
extra:
...
- **증거 저장소(Evidence Repository)**: 실행 결과·결함·의견과 인수 기준의 연결 기록을 보관하는 저장소
...
- **가명화(Pseudonymization)**: 추가 정보 없이는 개인을 식별할 수 없도록 데이터를 바꾸는 조치
- **잔여 위험(Residual Risk)**: 통제 조치 후에도 남아 승인 여부를 판단해야 하는 위험

> **키워드:** 알파·베타·인수 테스트 (Alpha Beta Acceptance Testing)

## Ⅰ. 개요

- 정의/개념: 업무·계약 기준을 사용자 증거로 판정하는 **수용 시험**
