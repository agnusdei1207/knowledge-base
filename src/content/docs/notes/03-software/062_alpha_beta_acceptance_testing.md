...
- **1. 인수 기준 합의**: 수용 조건을 확정한다.
- **2. 환경·업무 시나리오 배정**: 역할과 범위를 정한다.
- **3. 테스트 수행**: 실제 절차를 검증한다.
- **4. 결과·결함·의견 기록**: 기준별 증거를 남긴다.
- **5. 기준별 증거 제출**: 충족 여부와 위험을 전달한다.
- **6. 수용·보완·거부 판정**: 승인권자가 결정한다.
...
- **시험 목적·환경·승인 책임**에 따라 검증 방식을 정한다.
