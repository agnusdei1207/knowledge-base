...
date: "2026-08-26T17:20:00+09:00"
tags:
  - "notes-software"
weight: 47
extra:
...
- 배경/필요성: 객체가 구체 클래스에 직접 의존하면 생성·구조·행위가 바뀔 때마다 호출 지점 전체를 고쳐야 하므로, 반복되는 결합 문제의 검증된 해법에 이름을 붙여 정리한 GoF 23개 패턴을 설계 어휘 계층으로 공유할 필요
