...
date: "2026-07-31T10:50:13+09:00"
tags: ["notes-software"]
weight: 208
extra:
  question_no: "208"
...
- **카나리 배포(Canary Deployment)**: 소수 기기군에 새 모델을 먼저 배포해 품질·장애를 확인하는 방식
- **롤백(Rollback)**: 배포 이상 시 이전 정상 모델 버전으로 되돌리는 복구 동작

> **키워드:** 온디바이스 AI 모델 배포: LiteRT·ONNX (On-Device Model Deployment)
