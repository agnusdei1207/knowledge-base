...
- **비관계형 데이터베이스(Not Only SQL, NoSQL)**: 키값·문서·열·그래프 등 다양한 데이터 모델과 분산 확장을 지원하는 데이터베이스
...
- 다양한 데이터 구조와 확장 요구를 효율적으로 처리하기 위해 **조회·갱신 단위·스키마 유연성·관계 깊이·일관성 요구**를 검토하고, 문서·키값·컬럼·그래프 모델을 선택한다
