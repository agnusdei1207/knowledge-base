...
date: "2026-07-30T23:56:20+09:00"
tags:
  - "notes-software"
weight: 140
extra:
...
- **서비스 수준 목표(Service Level Objective, SLO)**: 완전성·최신성·가용성의 목표와 측정 기준이다
...
- 배경/필요성: 생산자의 일방적 변경은 소비자의 **하류 처리 파손 유발**
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 의미 해석이 달라지는 경우 | **용어·단위·집계 기준** 명시 | 해석 변경 방지 |
| 호환성을 판단하기 어려운 경우 | **소비 의존성·계약 시험** 적용 | 하류 파손 예방 |
| 품질 측정값이 다른 경우 | **계산식·관찰 구간** 정의 | SLO 측정 결과 일치 |
| 미계약 데이터가 우회하는 경우 | 모든 **게시 경계 검증** 적용 | 검사 우회 차단 |
| 파괴적 변경이 필요한 경우 | **공지·유예·폐기일** 관리 | 즉시 전환 위험 감소 |
