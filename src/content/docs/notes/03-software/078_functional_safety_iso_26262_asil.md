...
- **1. ASIL·안전 목표 도출**: S·E·C로 위험 등급 결정
- **2. 안전 요구 할당**: FSR·TSR을 HW·SW 요구로 분해
- **3. 안전 메커니즘 구현**: 등급별 진단·안전 상태 설계
- **4. 통합·결함 주입 검증**: 요구 추적성과 안전 반응 확인
- **5. 안전 목표 달성 판정**: 검증 증거와 잔여 위험 승인
