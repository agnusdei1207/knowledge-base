...
date: "2026-08-26T17:53:00+09:00"
tags:
  - "notes-software"
weight: 78
extra:
...
- 배경/필요성: 전장 기능 전체를 동일 강도로 검증하면 인명과 무관한 기능까지 최고 수준 비용을 치르는 반면 조향·제동 고장은 사후 회수로 되돌릴 수 없으므로, **HARA**로 위험도를 먼저 등급화해 검증 강도를 위험에 비례 배분하는 통제 계층을 수명주기 앞단에 둘 필요
...
- HARA 결과에 따라 비안전은 **QM**, 위해 기능은 **ASIL A~D** 적용
