...
- **1. ASIL·안전 목표 전달**: S·E·C로 등급을 결정
- **2. FSR·TSR·구현 요구 할당**: HW·SW로 분해
- **3. 안전 메커니즘 구현 증거**: 검증 결과를 제출
- **4. 통합·검증 요청**: 안전 요구의 시험을 시작
- **5. 결함 주입·요구 시험**: 등급별 방법을 적용
- **6. 안전 반응 결과**: 탐지와 안전 상태를 확인
- **7. 추적성·목표 달성 판정**: 잔여 위험까지 검토
...
- **위해 등급·추적성·검증 독립성**에 따라 안전 활동을 결정
