...
- **의사결정권·책임**: 데이터의 사용·보호·품질에 대해 누가 결정하고 결과를 책임지는지 정하는 통제 요소이다.

</details>

- 정의/개념: **데이터 거버넌스**는 데이터의 정의·사용·보호·품질에 관한 의사결정권과 책임·정책·감독 절차를 정하는 조직 통제 체계
...
- **CDE**: 업무·규제 위험이 커서 소유자와 통제를 우선 지정해야 하는 중요 데이터 요소이다.
