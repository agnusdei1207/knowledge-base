...
date: "2026-08-05T18:12:00+09:00"
tags:
  - "notes-software"
weight: 127
extra:
...
- **1. 기준 로그 버전 적재**: 현재 파일 집합과 스키마 복원
- **2. 새 Parquet 파일 기록**: 변경 결과를 불변 객체로 저장
- **3. 읽기•쓰기 범위 충돌 검사**: 동시 변경과 작업 범위 비교
- **4. Add•Remove 로그 커밋**: 파일 변경을 다음 단일 버전으로 확정
