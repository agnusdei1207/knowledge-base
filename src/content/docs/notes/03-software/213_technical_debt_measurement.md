...
1. **부채 등록**: 원인·영향 범위·책임자 명시
2. **원금·이자 추정**: 개선 비용과 반복 손실 산정
3. **위험 순위화**: 사업 영향·발생 가능성 비교
4. **상환 실행**: 예산과 선후 관계에 따라 개선
5. **효과 재측정**: 변경 시간·장애 감소 여부 확인
