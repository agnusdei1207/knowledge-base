...
- 정의/개념: 제품의 **구성요소·의존 관계**를 기록한 명세서
- **배경/필요성**: 숨은 전이 부품의 **취약 영향 추적 한계** 해소
...
| SBOM 생성 방식 | 수동 작성 | 빌드 시 생성 | 사후 분석 |
|:---|:---|:---|:---|
| 적용 기준 | 소규모 예외 부품 보완 | 자체 개발 제품의 정본 SBOM | 외부 산출물·레거시 검증 |
| 핵심 특징 | 담당자가 부품 정보를 직접 입력 | 빌드 의존 그래프에서 자동 생성 | 바이너리·패키지 역분석 |
| 한계 | 누락·버전 오기 | 빌드 밖 부품 누락 | 부품 의미·의존 관계 오탐 |
...
- 소프트웨어 구성요소 취약점의 영향을 신속히 추적하기 위해 **제품 버전·부품 식별자·의존 관계·생성 시점·무결성**을 검토하고, 빌드 산출물과 일치하는 SBOM을 운영한다
