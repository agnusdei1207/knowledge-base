...
date: "2026-07-31T00:06:15+09:00"
tags:
  - "notes-software"
weight: 183
extra:
...
- **소프트웨어 패키지 데이터 교환(Software Package Data Exchange, SPDX)**: 패키지·파일·라이선스·관계를 표현하고 교환하는 SBOM 표준
...
- **매니페스트·잠금 파일(Manifest·Lockfile)**: 선언한 의존성과 실제로 해석된 정확한 버전을 기록하는 파일
- **다이제스트(Digest)**: 산출물 내용으로 계산해 동일성과 변경 여부를 확인하는 해시값

> **키워드:** SBOM 소프트웨어 자재명세서 (SBOM)
