...
date: "2026-08-26T13:07:04+09:00"
tags:
  - "notes-software"
weight: 113
extra:
...
- 배경/필요성: 자체 운영은 하드웨어 조달 리드타임에 더해 백업·패치·복구 절차를 조직마다 새로 갖추는 고정 비용을 치르면서도 트래픽 급증에는 즉시 대응하지 못하므로, 그 운영 작업을 사업자가 표준화해 흡수하고 사용자는 용량과 접근 패턴만 고르게 하는 관리형 계층으로 옮길 필요
