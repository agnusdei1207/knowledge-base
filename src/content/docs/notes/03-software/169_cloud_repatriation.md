...
date: "2026-08-26T13:16:13+09:00"
tags:
  - "notes-software"
weight: 169
extra:
...
- 배경/필요성: 부하가 1년 내내 일정하면 탄력성의 대가로 내던 종량 요금이 자체 구축비를 넘어서고 데이터가 쌓일수록 반출 비용이 커져 이탈 자체가 어려워지므로, 워크로드를 오픈소스 표준으로 떼어내 CAPEX 기반 자체 인프라로 되돌릴 필요
