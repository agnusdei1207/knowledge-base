...
date: "2026-08-05T12:38:08+09:00"
tags: [notes-software]
weight: 13
extra:
  question_no: "013"
...
- **수면 가능성 판정**: 현재 문맥이 대기 큐로 이동해 CPU를 반납할 수 있는지 확인하는 단계
- **보유시간•전환비용 비교**: 예상 락 보유시간이 수면•깨움 문맥 전환 비용보다 짧은지 판정하는 단계
...
- **1. 수면 가능성 판정**: 커널 문맥의 수면 허용 여부 확인
- **2. 보유시간•전환비용 비교**: 더 작은 대기 비용의 방식 선택

#### 한줄 요약

- 수면 불가•짧은 보유는 스핀락, 긴 보유는 **뮤텍스**
