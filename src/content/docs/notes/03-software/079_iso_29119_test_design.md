...
- **1. 요구·위험 근거 조회**: 테스트 베이시스를 확인
- **2. 테스트 조건 후보**: 기능·품질·위험을 식별
- **3. 우선 조건·기법 전달**: 위험별 기법을 결정
- **4. 케이스·절차·기대 결과 등록**: 실행 내용을 생성
- **5. 요구 커버리지·누락 보고**: 추적 상태를 계산
- **6. 추적성 보강 요청**: 고위험 누락을 통지
- **7. 보강 결과·완료 근거**: 종료 기준 증거를 제출
