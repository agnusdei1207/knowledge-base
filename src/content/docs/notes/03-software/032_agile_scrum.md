...
date: "2026-08-05T12:56:42+09:00"
tags:
  - "notes-software"
weight: 32
extra:
...
- **1. 스프린트 계획**: 목표와 반복 범위•실행 계획 확정
- **2. 스프린트 실행**: 일일 점검과 통합•시험 수행
- **3. 완료의 정의 검증**: 증분의 공통 품질 기준 확인
- **4. 스프린트 리뷰**: 제품 결과와 다음 백로그 조정
- **5. 스프린트 회고**: 팀 효과성 개선 행동 확정

#### 한줄 요약

- 계획•실행•리뷰•회고의 **스프린트 순환**
