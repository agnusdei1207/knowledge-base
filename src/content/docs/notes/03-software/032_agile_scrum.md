...
- **린 사고(Lean Thinking)**: 고객 가치가 아닌 낭비를 줄이고 흐름을 개선하는 사고방식으로서 스크럼의 경험주의와 함께 효과적인 증분 전달을 뒷받침한다.
...
- 전자상거래 팀은 스프린트 리뷰에서 사용자 반응과 시장 변화를 확인해 제품 백로그의 다음 작업 순서를 변경
