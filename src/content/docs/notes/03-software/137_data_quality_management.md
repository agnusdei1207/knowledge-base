...
date: "2026-08-05T19:31:00+09:00"
tags:
  - "notes-software"
weight: 137
extra:
...
- **1. 기준선•품질 규칙 후보 생성**: 목적•위험별 임계값과 책임자 연결
- **2. 승인 버전 규칙 실행**: 확정 조건과 적용 범위로 데이터 검사
- **3. 품질 게이트 판정**: 위반 비율에 따라 게시•격리•중단 결정
- **4. 결함 원인 수정**: 원천 데이터 또는 변환 규칙 교정
- **5. 동일 규칙 재검증**: 같은 기준으로 수정 효과와 종료 여부 확인
