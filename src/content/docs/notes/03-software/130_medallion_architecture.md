...
date: "2026-08-05T18:35:00+09:00"
tags:
  - "notes-software"
weight: 130
extra:
...
- **1. Bronze 원천•이력 보존**: 원본•출처•처리 기준점 저장
- **2. 품질 규칙 판정**: 스키마•완전성•참조 무결성 검사
- **3. Silver 표준 상세 생성**: 코드•형식•단위•키 공통화
- **4. 원천•표준 상세 대사**: 건수•합계•키의 누락•중복 검증
- **5. Gold 지표 게시**: 목적별 집계와 최신 시점 공개
