...
date: "2026-08-05T13:11:26+09:00"
tags:
  - "notes-software"
weight: 49
extra:
...
1. **업무 시나리오•예외 탐색**: 사건과 판단 규칙 발견
2. **용어•규칙 질문**: 모호한 의미와 경계 후보 확인
3. **공통 언어 합의**: 업무 용어와 제약을 한 의미로 확정
4. **도메인 모델•경계 정제**: 컨텍스트•불변 조건 갱신
5. **모델 기반 코드 구현**: 업무 규칙과 계약 반영

> 요약: **바운디드 컨텍스트** 안의 언어•모델•코드를 **업무 피드백** 으로 정제

#### 한줄 요약

- 업무 피드백 기반 **언어•모델•코드 정제 순환**
