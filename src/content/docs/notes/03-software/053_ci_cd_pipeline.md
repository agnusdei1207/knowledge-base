...
date: "2026-07-30T23:26:40+09:00"
tags:
  - "notes-software"
weight: 53
extra:
...
- **자격 증명(Credential)**: 시스템 접근 권한을 확인하는 비밀·토큰·인증서
- **산출물 서명·해시(Artifact Signature·Hash)**: 배포 산출물의 출처와 무결성을 검증하는 값

> **키워드:** CI/CD 파이프라인 (CI/CD Pipeline)
