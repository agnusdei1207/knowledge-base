...
- 정의/개념: 전략과 **업무·데이터·응용·기술 구조 연결**
- 배경/필요성: 부서별 구축의 **중복·불일치·기술 난립 통제**
...
- **BA·DA·AA·TA** 영역 간 추적 연결
- **현행·목표·전환 구조** 기반 변화 관리
- **표준·심사·예외·저장소** 순환 거버넌스
...
1. **전략 변화 전달**: 목표·규제·역량 변화 공유
2. **기준선 조회**: 현행 자산·표준·예외 확인
3. **목표·표준 제공**: 원칙·참조모형·전환 제약 제시
4. **설계·예외 제출**: 사유·위험·만료 조건 명시
5. **정합성 검토**: 목표 기여·중복·영향 판정
...
| 영역 모델의 **관계 단절** | 공통 ID·**메타모델 적용** | BA·DA·AA·TA **추적성** |
| 임시 예외의 **기술부채화** | 책임자·만료·**상환 계획 지정** | 예외 누적 **억제** |
| 목표만 있는 **전환 계획** | 공존·Rollback·**폐기 기준 설계** | 업무 중단 **위험 축소** |
...
- **전략 정합성·전환 실행성·저장소 최신성**으로 EA 결정
