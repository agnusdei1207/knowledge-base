...
date: "2026-08-05T13:20:28+09:00"
tags:
  - "notes-software"
weight: 54
extra:
...
2. **버전별 지표 수집**: 오류•지연•업무 실패율 분리
3. **가드레일 판정**: 확대•대기•복귀 임계값 확인
4. **노출 비율 확대**: 통과 시 트래픽 단계 증가

> 요약: 가드레일을 통과하면 확대하고 위반하면 이전 기준선으로 자동 복귀

#### 한줄 요약

- 가드레일 통과 시 확대, 위반 시 **자동 복귀**
