...
date: "2026-07-31T10:25:20+09:00"
tags:
  - "notes-software"
weight: 15
extra:
...
> **키워드:** 가상 메모리·페이징·세그멘테이션 (Virtual Memory)

## Ⅰ. 개요

- 정의/개념: 프로세스의 가상 주소를 물리 메모리·후면 저장소에 매핑하는 **메모리 관리 기법**
- 배경/필요성: 물리 주소 직접 사용으로 프로세스 간 **메모리 격리·탄력적 할당 불가**
...
- **2. 가상 페이지·접근 유형**: TLB 미스 시 페이지 테이블 조회
