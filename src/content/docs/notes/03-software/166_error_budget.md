...
date: "2026-08-05T23:23:00+09:00"
tags:
  - "notes-software"
weight: 166
extra:
...
- 정의/개념: SLO가 허용한 실패량을 사용하는 **오류 예산** 운영 기준
...
- **1. 유효•나쁜 이벤트 측정**: 사용자 경계의 실패 결과 분류
- **2. 단기•장기 오류율 계산**: 여러 구간의 실패 추세 산출
- **3. 잔여량•소진 속도 산출**: 누적 상태•긴급도 계산
- **4. 변경•안정화 상태 결정**: 배포 지속•감속•복구 선택
- **5. 배포•롤백 정책 실행**: 변경•복구 후 SLI 재측정
