...
date: "2026-08-05T13:08:31+09:00"
tags: [notes-software]
weight: 7
extra:
  question_no: "007"
...
1. **스케줄 가능성•수용 판정**: 이용률•응답시간 통과 작업만 등록
2. **우선순위 정책 선택**: 고정 주기는 RM, 가변 마감은 EDF 결정
3. **릴리스 작업 우선순위 정렬**: 주기 또는 절대 마감 기준 적용
4. **선점•디스패치**: 상위 작업 도착 시 문맥 교체
5. **마감 준수•과부하 감시**: 미스 시 중요도별 부하 축소

#### 한줄 요약

- **수용 분석 후 RM•EDF 우선순위**로 마감 통제
...
- 고정 주기 제어는 **짧은 주기에 높은 RM 우선순위** 부여
