...
- **1. 작업 집합 분석 요청**: 이용률 검증
- **2. 수용 작업 등록**: 준비 큐 반영
- **3. 작업 인스턴스 방출**: 실행 후보 생성
- **4. 이른 마감 작업 제공**: EDF 선택
- **5. 작업 디스패치**: CPU 배정
- **6. 우선순위 변경 통지**: 새 마감 반영
- **7. 현재 작업 선점**: 더 이른 작업 실행
