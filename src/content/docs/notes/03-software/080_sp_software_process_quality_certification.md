...
- **1. 프로세스·수행 증적 제출**: 내부 진단을 시작한다.
- **2. 격차·시정 항목**: 기준 차이와 원인을 찾는다.
- **3. 인증심사 신청**: 시정 증거와 범위를 제출한다.
- **4. 심사 범위·팀 배정**: 등급별 계획을 정한다.
- **5. 현장 심사·증거 확인**: 실제 수행 일치를 본다.
- **6. 심사 결과 제출**: 충족·미충족 근거를 제시한다.
- **7. 등급·사후관리 결정**: 심의 결과와 조건을 알린다.
...
- **수행 증적·현장 일치·개선 지속성**으로 인증 역량을 판단한다.
