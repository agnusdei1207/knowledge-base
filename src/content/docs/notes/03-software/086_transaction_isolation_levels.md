...
- **1. 격리 수준·트랜잭션 시작**: 관찰 범위를 결정
- **2. 스냅샷·잠금 요청**: 구현 보호를 적용
- **3. 허용 버전 읽기·쓰기**: 데이터에 접근
- **4. 데이터·충돌 정보**: 변경과 충돌을 반환
- **5. 교착·직렬 가능성 판정**: 실행 순서를 검사
- **6. 대기·커밋·취소 결정**: 안전한 결과를 선택
- **7. 결과·재시도 신호**: 제한 재시도를 안내
