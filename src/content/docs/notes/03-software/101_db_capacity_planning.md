...
- **1. 성장률·피크 수집**: 저장량·TPS·동시성의 추세 확보
- **2. 처리 한계 검증**: 부하 시험으로 병목 지점 확인
- **3. 용량 한계일 예측**: 성장률과 여유율로 소진 시점 계산
- **4. 준비 기간 확인**: 조달·이관·검증 리드타임 반영
- **5. 선행 증설 실행**: 한계일보다 준비 기간만큼 먼저 착수
...
> 산정 원칙: 저장·처리 용량의 증가율을 분리한 **병목 자원별 예측**
