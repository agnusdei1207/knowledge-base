...
date: "2026-08-05T15:43:00+09:00"
tags:
  - "notes-software"
weight: 101
extra:
...
- **1. 성장률•피크 시계열**: 저장량•TPS•동시성 추세 확보
- **2. 예측 부하 시나리오**: 미래 피크•장애 조건 구성
- **3. 병목 실측값**: 먼저 한계에 닿는 자원 식별
- **4. 용량 한계일**: 성장률•헤드룸으로 소진일 산출
- **5. 선행 증설 요청**: 조달 선행 시간을 역산해 착수
