...
date: "2026-08-26T12:55:07+09:00"
tags: [notes-software]
weight: 10
extra:
  question_no: "010"
...
- 배경/필요성: 교착 발생 후 탐지·회복은 이미 진행한 작업을 되돌리는 비용을 치르므로, 자원을 내주기 전에 최대 요구량 선언을 근거로 안전 순서열 존재 여부를 미리 검사하는 회피 계층을 할당 결정 앞단에 두어 불안전 상태 진입 자체를 막을 필요
...
- 최대 요구량이 고정되면 **은행원**, 미지이면 **탐지·복구** 선택
