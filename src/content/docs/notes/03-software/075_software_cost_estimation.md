...
- **1. 요구·범위·시점 전달**: 정보 수준을 확인한다.
- **2. 규모·공수 산정 요청**: 기능점수·WBS를 적용한다.
- **3. 기본 비용·가정**: 생산성과 단가를 반환한다.
- **4. 보정·위험 포함 견적 제출**: 예비비를 반영한다.
- **5. 누락·중복·단가 검토**: 근거를 확인한다.
- **6. 대가·불확실성 범위 제시**: 가정과 오차를 알린다.
- **7. 범위·기준선 확정**: 변경 대가 조건을 승인한다.
...
- **범위·정보 수준·불확실성**에 따라 산정법과 대가를 정한다.
