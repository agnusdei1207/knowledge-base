...
date: "2026-08-05T16:08:00+09:00"
tags:
  - "notes-software"
weight: 106
extra:
...
- 정의/개념: 중첩 BSON 문서를 저장•조회•원자 갱신하는 **문서 데이터베이스**
...
- **1. 청크 메타데이터 요청**: 샤드 키의 배치 위치 조회
- **2. 대상 샤드 위치 확인**: 담당 레플리카셋 주소 확인
- **3. BSON 문서 변경**: 주 구성원이 문서 변경을 원자 적용
- **4. oplog 항목 전파**: 확정된 변경 순서 전달
- **5. 복제 확인**: 쓰기 확인 수 충족 판정
