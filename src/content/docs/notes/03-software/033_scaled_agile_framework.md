...
date: "2026-08-05T12:57:18+09:00"
tags:
  - "notes-software"
weight: 33
extra:
...
- **1. 전략•투자 우선순위**: 가치 흐름 목표 결정
- **2. PI 목표•의존성 정렬**: 용량•위험•책임자 합의
- **3. 팀 증분•시스템 통합**: 반복 결과를 공동 시스템에 반영
- **4. 시스템 데모**: 여러 팀의 통합 결과 검토
- **5. 검사•적응**: 가치•위험 피드백을 다음 PI에 반영

#### 한줄 요약

- 전략 정렬부터 시스템 데모까지 **PI 피드백 순환**
