...
date: "2026-08-26T13:30:54+09:00"
tags:
  - "notes-software"
weight: 216
extra:
...
- 배경/필요성: 자원 발급을 티켓으로 처리하면 인프라팀이 병목이 되어 대기 비용이 요청마다 반복되고 이를 우회하면 통제가 사라지므로, 개발자와 인프라 사이에 검증된 기본값과 정책을 담은 셀프서비스 계층을 두어 사람의 승인 판단을 코드로 대체할 필요
...
- 반복 표준 요구는 **골든 패스**, 특수 요구는 예외 승인 적용
