...
date: "2026-08-05T22:51:00+09:00"
tags:
  - "notes-software"
weight: 162
extra:
...
- **1. 관측 신호 생성•문맥 연결**: 스팬•메트릭•로그 생성
- **2. SDK 샘플링•집계•배치**: 전송 정책에 맞게 신호 처리
- **3. OTLP 표준 전송**: 벤더 중립 형식으로 전송
- **4. Collector 필터•변환•분기**: 정제 후 목적지별 전달
- **5. 백엔드 저장•조회•경보**: 신호 보존과 분석 제공
