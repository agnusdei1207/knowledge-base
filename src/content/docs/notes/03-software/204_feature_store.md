...
date: "2026-07-29T18:15:00+09:00"
tags: ["notes-software"]
weight: 204
extra:
  question_no: "204"
...
- 배경/필요성: 개별 피처 구현의 **중복·학습 서빙 편향 방지**
...
block
    columns 1
    A["피처 레지스트리 | 정의·버전·소유권"]
    B["피처 변환기 | 동일 계산식·스키마"]
    C["오프라인 저장소 | 시점별 학습 이력"]
    D["온라인 저장소 | 최신값 저지연 제공"]
    E["피처 감시기 | 품질·분포·신선도"]
    A --- B
    B --- C
    B --- D
...
- **시점 정합성·계산 일치·온라인 신선도**로 피처 제공 결정
