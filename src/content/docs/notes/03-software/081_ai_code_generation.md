...
- **2. 프롬프트·코드 문맥 전달**: 허용 정보만 전달
- **3. 코드 후보 생성**: 모델이 구현 초안을 생성
- **4. 정책 결과·코드 참조**: 일치 정보와 통제를 제공
- **5. 이해·수정한 후보 제출**: 개발자 변경으로 전달
- **6. 빌드·테스트·보안 결과**: 정확성과 안전성을 확인
- **7. 동료 검토·반영 결정**: 권리 위험까지 검토
...
> 적용 사례: 데이터 변환 코드 초안을 생성하고 수정량·검토 시간·리뷰 통과율로 실제 효과를 측결정
