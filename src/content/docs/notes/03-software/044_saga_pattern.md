...
date: "2026-07-31T10:22:38+09:00"
tags:
  - "notes-software"
weight: 44
extra:
...
- **메시지 채널·재전송(Message Channel·Redelivery)**: 메시지 채널은 서비스 간 명령·이벤트를 전달하고 재전송은 응답 누락 시 같은 메시지를 다시 보내므로 멱등 처리가 필요하다.
...
> **키워드:** Saga 패턴: 분산 트랜잭션 (Saga Pattern)

## Ⅰ. 개요

- 정의/개념: 여러 서비스의 로컬 트랜잭션을 순차 실행하고 실패 흐름을 보상하는 **분산 트랜잭션 패턴**
