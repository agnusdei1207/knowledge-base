...
date: "2026-07-29T19:57:00+09:00"
tags: ["notes-software"]
weight: 224
extra:
  question_no: "224"
...
block
    columns 1
    A["요구사항 기준선 | 사업 목표·범위·필수 조건 확정"]
    B["평가 항목·가중치 | 판단 단위와 중요도별 배점 정의"]
    C["척도·증거 체계 | 수준별 점수와 인정 자료 명시"]
    D["평가위원회 | 이해충돌을 배제하고 독립 채점"]
    E["점수 검증대장 | 점수·사유·편차와 조정 이력 기록"]
    A --- B
    B --- C
    C --- D
    D --- E
...
3. **제안 증거 제출**: 제안서·실적·시험 자료를 접수
4. **독립 채점**: 위원별 점수와 판단 사유 기록
...
- **업무 적합성·생애주기 비용·출구 가능성**으로 기술 선정
