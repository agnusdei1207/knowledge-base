...
- 정의/개념: 제안 기술•품질•사업 관리•수행 역량을 공통 기준으로 채점하는 **소프트웨어 기술성 평가**이다.
...
- **복합 평가** 기반 정량 증거와 정성 판단을 함께 반영한다.
- **가중치 평가** 기반 사업 우선순위를 항목별 점수에 반영한다.
- **사전 척도** 기반 판단 일관성을 확보한다.
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 공급자 중심 PoC 편향 | **개념 증명** 대상 공통 자료•동일 시나리오 적용 | 후보 비교 공정성 |
| 평가 항목의 **가중치 왜곡** | 사업 목표•필수 기준 사전 확정 | 선정 타당성 향상 |
| 도입비만의 비용 비교 | 운영•전환•종료 **총소유비용** 포함 | 장기 비용 현실성 |
...
- **제안 선정 기준** 대상 따라 **필수 기준** 미달 제안은 배제하고 충족 후보는 가중 점수로 선정한다.
