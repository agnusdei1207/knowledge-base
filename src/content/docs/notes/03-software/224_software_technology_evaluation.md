...
- **복합 평가**로 정량 증거와 정성 판단을 함께 반영한다.
- **가중치 평가**로 사업 우선순위를 항목별 점수에 반영한다.
- **사전 척도**로 판단 일관성을 확보한다.
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 공급자 중심 PoC 편향 | **개념 증명**에 공통 자료•동일 시나리오 적용 | 후보 비교 공정성 |
...
- **제안 선정 기준**에 따라 **필수 기준** 미달 제안은 배제하고 충족 후보는 가중 점수로 선정한다.
