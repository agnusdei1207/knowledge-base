...
- 정의/개념: **비기능 요구사항** 품질 시나리오로 구체화해 상충 효과를 평가하는 **아키텍처 품질속성 트레이드오프**이다.
...
- **유틸리티 트리** 기반 품질 요구의 우선순위를 정한다.
- **아키텍처 택틱** 민감점과 부작용을 비교한다.
- **아키텍처 트레이드오프 분석 방법** 기반 위험•민감점•상충점을 평가한다.
...
- **택틱 선택 기준** 대상 따라 필수 품질 한계 위반 대안은 폐기하고 **수용 위험** 합의한 대안을 채택한다.
