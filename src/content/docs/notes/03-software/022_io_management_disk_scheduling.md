...
date: "2026-08-05T12:46:48+09:00"
tags:
  - "notes-software"
weight: 22
extra:
...
- **1. 요청 큐 등록**: 위치•시각•우선순위와 버퍼 보관
- **2. 병합•제출 대상 선택**: 매체별 정책으로 다음 요청 확정
- **3. 장치 명령 변환**: 논리 블록•버퍼를 장치 형식으로 변환
- **4. 장치 실행•완료 게시**: 인터럽트•완료 큐에 결과 기록
- **5. 완료 반영•작업 재개**: 큐 제거 후 대기 작업 깨움

#### 한줄 요약

- 요청 병합•장치 제출•**완료 재개**의 전체 흐름
