...
- 정의/개념: 동일 환경•자료•부하•측정 절차에서 **후보 제품** 비교하는 **벤치마크 테스트**이다.
...
- **조건 통제** 기반 후보 외 공통 환경•부하를 고정한다.
- **반복 측정** 기반 우연 편차를 분리한다.
- **대표 부하** 기반 결과 타당성을 확보한다.
...
- **후보 선정 기준** 대상 따라 **사전 합격선** 충족한 제품만 선정한다.
