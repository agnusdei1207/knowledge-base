...
date: "2026-08-05T21:47:00+09:00"
tags:
  - "notes-software"
weight: 154
extra:
...
- **1. 미배치 파드 선택**: 우선순위•대기 상태로 다음 대상 결정
- **2. 필수 조건 필터링**: 요청량•친밀도•테인트 검사
- **3. 후보 노드 점수화**: 선호 조건으로 노드 순위 산출
- **4. 선택 노드 예약•허가**: 가정 자원 확보와 실행 승인
- **5. 파드•노드 바인딩**: 선택 노드 이름을 API에 기록
