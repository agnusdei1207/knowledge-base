...
| 통합 결과 전달 | 테스트·통합 성공·실패 결과 반환 |
| 다음 반복 반영 | 통합 결과를 다음 구현에 반영 |
...
- 잦은 요구 변경에도 코드 품질을 유지하기 위해 **변화 빈도·테스트 자동화·긴밀한 협업 여건**을 검토하고, 작은 변경을 반복할 수 있는 팀에 XP를 적용한다
