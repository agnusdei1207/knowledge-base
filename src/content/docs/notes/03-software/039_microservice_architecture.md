...
date: "2026-08-05T13:00:52+09:00"
tags:
  - "notes-software"
weight: 39
extra:
...
- **1. 외부 요청 라우팅**: 공통 정책 후 소유 서비스 선택
- **2. 소유 서비스 로컬 처리**: 업무•데이터 변경을 경계 안에서 수행
- **3. 서비스 간 계약 선택**: 응답 결합도에 따라 API•이벤트 결정
- **4. 동기 API 협업**: 버전된 요청•응답 계약 호출
- **5. 비동기 이벤트 협업**: 브로커를 통한 독립 소비

#### 한줄 요약

- 소유 경계와 **동기 API•비동기 이벤트** 협업
