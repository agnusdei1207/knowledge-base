...
date: "2026-07-30T23:29:03+09:00"
tags: [notes-software]
weight: 14
extra:
  question_no: "014"
...
- **참조 지역성(Reference Locality)**: 가까운 시간에 일부 페이지를 반복 참조하는 성질

> **키워드:** 프로세스 스레싱 (Process Thrashing)

## Ⅰ. 개요

- 정의/개념: 워킹 셋이 프레임을 넘어 페이지 교체가 유효 실행보다 많아지는 **가상 메모리 성능 붕괴 상태**
