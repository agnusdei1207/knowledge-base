...
date: "2026-08-05T13:01:36+09:00"
tags:
  - "notes-software"
weight: 40
extra:
...
- 외부 계약과 내부 서비스를 분리하는 **공통 API 진입점**
...
- **1. 외부 계약 수신**: 공개 경로•메서드•요청 형식 확인
- **2. 진입 정책 검증**: 토큰•요청률•출처 정책 검사
- **3. L7 라우팅•요청 변환**: 목적 서비스•내부 계약 선택
- **4. 업무 인가•서비스 처리**: 자원별 권한과 업무 규칙 판정
- **5. 응답 변환•조합•관측**: 외부 계약 변환과 추적 기록

#### 한줄 요약

- 진입 정책과 업무 인가를 분리한 **요청 중계 흐름**
