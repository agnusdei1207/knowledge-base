...
- **계획 계층**으로 종합계획과 기관별 실행계획을 연결한다.
- **성과 환류**로 추진 실적•차년도 계획과 예산을 연결한다.
- **법률 구분**으로 기본법과 디지털포용•인공지능 규정을 나눠 적용한다.
...
| 기본법만 확인한 접근성 의무 누락 | **법률 구분**에 따라 현행 관련 법률 점검 | 이용자 권리 보장 |
...
- **적용 법률 선택 기준**에 따라 국가•기관 계획은 기본법, 세부 의무는 **특별법**을 적용한다.
