...
- 정의/개념: 국가와 기관의 **지능정보사회 정책•계획•공통 기반**을 규정하는 지능정보화 기본법이다.
- 배경/필요성: 기관별 정보화 분산은 **정책 중복•투자 연계가 부족하다**.
...
- **계획 계층**: 3년 종합계획과 매년 실행계획 연계이다.
- **성과 환류**: 추진 실적•차년도 계획과 예산을 연결한다.
- **법률 구분**: 기본법과 디지털포용•인공지능 규정을 분리한다.
...
> 요약: **정책•포용•인공지능 책임**에 따라 적용법을 구분한다.
...
- 국가•기관 계획은 **종합•실행계획**, 세부 의무는 **특별법**을 적용한다.
