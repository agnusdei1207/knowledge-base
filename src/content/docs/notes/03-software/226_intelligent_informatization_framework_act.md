...
- 정의/개념: 국가와 기관의 지능정보사회 정책•계획•공통 기반을 규정하는 **지능정보화 기본법**이다.
...
- **계획 계층** 기반 종합계획과 기관별 실행계획을 연결한다.
- **성과 환류** 기반 추진 실적•차년도 계획과 예산을 연결한다.
- **법률 구분** 기반 기본법과 디지털포용•인공지능 규정을 나눠 적용한다.
...
| 지능정보 관련 법률 | **기본법 적용 범위** | **디지털포용법** | **인공지능기본법** |
|:---|:---|:---|:---|
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 상위 계획과 기관 사업 불일치 | **계획 계층** 연결표 관리 | 정책 정합성 확보 |
| 기관마다 다른 **성과 기준 불일치** | **공통 성과지표**•증거 정의 | 사업 비교 가능성 향상 |
| 기본법만 확인한 접근성 의무 누락 | **법률 구분** 대상 따라 현행 관련 법률 점검 | 이용자 권리 보장 |
...
- **적용 법률 선택 기준** 대상 따라 국가•기관 계획은 기본법, 세부 의무는 **특별법** 적용한다.
