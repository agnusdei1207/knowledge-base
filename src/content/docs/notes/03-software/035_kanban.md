...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "칸반 (Kanban)"
date: "2026-08-05T12:58:29+09:00"
tags:
  - "notes-software"
weight: 35
extra:
...
- **1. 수용량•WIP 확인**: 현재 작업 수와 단계 한도 비교
- **2. 당김 허용 판정**: 한도 아래일 때 새 작업 승인
- **3. 우선순위 카드 선택**: 상위 목록에서 다음 작업 결정
- **4. 카드 이동•작업 수행**: 다음 열에서 완료 조건 처리
- **5. 완료•흐름 지표 갱신**: 완료 반영과 지표 기록

#### 한줄 요약

- WIP 여유에 따른 **당김•완료 우선** 흐름
