...
date: "2026-07-30T23:16:53+09:00"
tags:
  - "notes-software"
weight: 21
extra:
...
- **내구성(Durability)**: 커밋이 완료된 변경이 전원 장애 뒤에도 보존되는 트랜잭션 성질
- **워크로드(Workload)**: 저장장치에 가해지는 읽기·쓰기 요청의 유형과 빈도

> **키워드:** 파일 시스템 저널링 (File System Journaling)
