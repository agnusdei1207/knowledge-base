...
- 배경/필요성: 운영 판단과 고객 책임의 **공통 측정·경계 분리**
...
1. **서비스 요청**: 계약·측정 범위의 사용자 호출
2. **유효·좋은 이벤트 기록**: 성공·지연 기준별 결과 분류
3. **SLO·오류 예산 판정**: 내부 목표 대비 실패 여유 계산
4. **SLA 준수 판정**: 계약 기간·제외 조건 적용
5. **책임·보상 안내**: 미달 근거·서비스 크레딧 제공
