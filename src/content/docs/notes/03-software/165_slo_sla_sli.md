...
date: "2026-08-05T23:15:00+09:00"
tags:
  - "notes-software"
weight: 165
extra:
...
- **1. 유효•좋은 이벤트 기록**: 분모와 성공 기준별 결과 분류
- **2. SLI 실제 수준 계산**: 사용자 품질의 실측값 산출
- **3. SLO•오류 예산 운영 판정**: 내부 변경•복구 방향 결정
- **4. SLA 준수•책임 판정**: 외부 책임•보상 여부 결정
...
- **서비스 수준 구분 축**: 측정값•내부 목표•외부 계약 책임의 차이이다.
