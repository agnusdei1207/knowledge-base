...
- **1. 시나리오·가중치 요청**: 품질 요구를 수집한다.
- **2. 효용 함수·중요도**: 가치 점수를 합의한다.
- **3. 대안 전략 요청**: 개선 방안을 제시하게 한다.
- **4. 응답 개선·비용 추정**: 전략별 값을 계산한다.
- **5. 효익-비용 순위 제출**: 투자 순위를 제시한다.
- **6. 예산·의존성 조건**: 실행 제약을 전달한다.
- **7. 실행 조합·전략 확정**: 순서와 검증 지표를 정한다.
