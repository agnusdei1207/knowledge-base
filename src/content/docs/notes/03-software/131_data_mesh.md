...
- **2. 연합 정책 자동 검사**: 플랫폼이 도메인 공통 보안·호환성·상호운용 규칙 판정
- **3. 제품·계보·접근 등록**: 승인된 계약·SLO·소유자·접근 절차를 카탈로그에 게시
- **4. 목적·품질 조건 탐색**: 소비자가 사용 목적과 품질 목표에 맞는 데이터 제품 선택
- **5. 계약 기반 사용·피드백**: 계약을 기준으로 소비하고 품질 문제를 책임 도메인에 전달
