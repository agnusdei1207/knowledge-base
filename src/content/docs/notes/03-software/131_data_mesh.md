...
date: "2026-08-05T18:43:00+09:00"
tags:
  - "notes-software"
weight: 131
extra:
...
- **1. 제품 계약•SLO 정의**: 의미•품질•지원 책임 명시
- **2. 표준 경로 기반 제품 구현**: 공통 저장•배포•관찰 기능 구성
- **3. 연합 정책 자동 검증**: 보안•호환성•상호운용 규칙 판정
- **4. 제품•계보•접근 정보 게시**: 계약•소유자•접근 절차 공개
- **5. 계약 위반•품질 피드백**: 문제를 책임 도메인에 전달
