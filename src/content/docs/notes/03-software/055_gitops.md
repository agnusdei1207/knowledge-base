...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "GitOps"
date: "2026-08-05T13:22:10+09:00"
tags:
  - "notes-software"
weight: 55
extra:
...
1. **목표 상태 조회**: 승인 선언을 저장소에서 수신
2. **실제 상태 관찰**: 운영 자원의 구성•건강 정보 조회
3. **상태 차이 판정**: 목표•실제 상태의 드리프트 확인
4. **목표 상태 적용**: 승인 선언에 맞게 자원 재조정
5. **조정 상태 보고**: 건강•동기화 상태와 실패 전달

> 요약: 제어기가 Git의 **목표•실제 상태 차이** 를 반복 관찰•조정

#### 한줄 요약

- 목표•실제 상태 비교와 **드리프트 조정 순환**
...
- 선언 가능 상태는 GitOps, 명령형 작업은 **푸시 배포**
