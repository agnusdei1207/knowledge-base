...
- 정의/개념: 작업의 **교대 실행·다중 프로세서 실행** 방식
- 배경/필요성: 대기율·병렬성에 따른 **실행 구조 구분**
...
- **1. 실행 작업 제출**: 준비 큐 등록
- **2. 작업 교대 실행**: 단일 코어에서 I/O 대기 시 문맥 전환
- **3. 첫 작업 병렬 배정**: 코어 1 할당
- **4. 둘째 작업 병렬 배정**: 코어 2 할당
- **5. 공유 상태 동기화**: 가시성 보장
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 동시 작업 증가로 메모리·I/O 스레싱 | 수용 제어와 작업별 사용 상한·압박 지표 감시 | 처리량 붕괴 방지 |
