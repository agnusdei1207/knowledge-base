...
date: "2026-08-26T13:25:44+09:00"
tags:
  - "notes-software"
weight: 198
extra:
...
- 배경/필요성: 단일 노드는 그 하나가 멈추는 순간 서비스 중단과 미복제 데이터 유실 비용을 그대로 떠안으므로, 같은 역할의 노드를 복수로 두고 그 위에 누가 주인인지 판정하는 쿼럼·펜싱 계층을 얹어 장애를 중단이 아닌 전환 비용으로 바꿀 필요
...
- 무상태 계층은 **Active-Active**, 단일 쓰기는 **Hot Standby** 선택
