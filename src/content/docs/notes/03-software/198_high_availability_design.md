...
- **정의/개념**: 장애 중에도 목표 가용성을 유지하는 설계
- **배경/필요성**: 이중화 용량·전환 한계로 가용성 설계 필요
...
| 판단 기준 | Active-Active | Hot Standby | Warm Standby |
|:---|:---|:---|:---|
| 핵심 특징 | 두 환경이 동시에 처리함 | 대기 환경이 즉시 승격함 | 대기 환경을 기동해 승격함 |
| 적용 기준 | 무중단·부하 분산 필요 | 짧은 전환·단일 쓰기 | 비용 절감·긴 전환 허용 |
| 주요 위험 | 쓰기 충돌·복잡성 | 유휴 비용·승격 실패 | 기동·데이터 복구 지연 |
