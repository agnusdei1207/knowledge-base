...
- **1. 청구•사용량 정규화**: 공급자별 가격•기간•사용 단위를 공통 기준으로 통일하는 단계이다.
- **2. 비용 할당•단위 경제성 산출**: 공유 비용을 조직•제품에 귀속하고 업무 단위당 비용을 계산하는 단계이다.
- **3. 단위 비용•가치 편차**: 기준선과 비교해 낭비 자원과 가치 있는 투자 후보를 식별한 결과이다.
- **5. 실행 정책•측정 기준**: 예산•약정•자동화 범위와 개선 후 다시 측정할 지표를 확정한 결과이다.
...
1. **청구•사용량 정규화**: 공급자별 가격•기간•사용 단위 통일
2. **비용 할당•단위 경제성 산출**: 공유 비용을 조직•제품의 업무량에 귀속해 단위 비용 계산
