...
date: "2026-08-26T13:29:15+09:00"
tags:
  - "notes-software"
weight: 214
extra:
...
- 배경/필요성: 자원 임계치 경보는 사용자 영향과 무관하게 울려 대응 인력의 주의력을 소모하고 지휘가 나뉘면 같은 조치를 여러 사람이 중복 시도하므로, 경보를 SLO 기준으로 걸러 내고 인시던트마다 단일 지휘자를 세워 복구까지의 시간 비용을 줄일 필요
...
- 사용자 피해 중에는 **완화 우선**, 복구 후 포스트모텀 수행
