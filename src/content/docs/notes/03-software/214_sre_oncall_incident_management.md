...
date: "2026-07-31T10:52:25+09:00"
tags: ["notes-software"]
weight: 214
extra:
  question_no: "214"
...
- **서비스 소유자(Service Owner)**: 서비스의 정상 운영과 장애 대응 책임을 맡은 팀·담당자
- **에스컬레이션(Escalation)**: 현재 대응 권한·역량을 넘는 장애를 상위 책임자나 전문팀에 이관하는 절차
- **타임라인(Timeline)**: 장애 발생부터 완화·복구까지 사건과 조치를 시간순으로 기록한 이력

> **키워드:** SRE 온콜 관리·인시던트 대응 (SRE Oncall Incident Management)
