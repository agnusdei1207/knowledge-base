...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "LLMOps (LLMOps)"
date: "2026-07-31T00:12:00+09:00"
tags: ["notes-software"]
weight: 203
extra:
  question_no: "203"
...
- **토큰(Token)**: 언어 모델이 입력과 출력을 계산·과금하는 기본 텍스트 단위
- **비용 예산(Cost Budget)**: 요청·사용자·서비스별 토큰 비용의 허용 한도

## Ⅰ. 개요

- 정의/개념: 모델·프롬프트·검색의 **품질·안전**을 통제하는 운영 체계
- 배경/필요성: 단일 정답 평가로 **비결정 응답·환각** 품질 판정 불가
