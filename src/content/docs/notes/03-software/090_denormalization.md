...
date: "2026-08-05T14:48:00+09:00"
tags:
  - "notes-software"
weight: 90
extra:
...
- **1. 원본•이벤트 원자 기록**: 변경과 발행 정보 함께 저장
- **2. 변경 식별자•버전 수신**: 중복과 적용 순서 확인
- **3. 최신 원본•파생값 계산**: 조회용 중복•요약값 생성
- **4. 조회 모델 멱등 갱신**: 중복 효과 없이 버전 반영
- **5. 버전•동기화 지연 검증**: 불일치와 지연 재처리
...
- 정규화로 **p95 목표** 미달 시 **동기화 비용** 허용 범위에서 적용
