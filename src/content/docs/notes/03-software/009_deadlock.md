...
sequenceDiagram
    ...
    P2->>R: 2. 반대 요청·순환 형성
    R->>G: 3. 대기 그래프 갱신
    G->>L: 4. 복구 비용·희생 작업 결정
    R->>P2: 5. 롤백·자원 회수
```

**동작 원리**

- **1. 자원 요청·대기**: 보유 중 추가 자원이 없어 대기
- **2. 반대 요청·순환 형성**: 상호 보유 자원을 요청
- **3. 대기 그래프 갱신**: 대기 간선과 순환 확인
- **4. 복구 비용·희생 작업 결정**: 진행량·이력으로 복구 대상 선택
- **5. 롤백·자원 회수**: 순환 해제
...
- 순서 강제·최대 요구·복구 비용으로 **교착 대응**을 결정
