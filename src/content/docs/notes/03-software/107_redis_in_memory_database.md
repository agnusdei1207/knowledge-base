...
date: "2026-08-26T18:23:00+09:00"
tags:
  - "notes-software"
weight: 107
extra:
...
- 배경/필요성: 디스크 기반 저장은 세션·랭킹처럼 짧은 간격으로 반복 조회되는 값에도 요청마다 블록 I/O 비용을 물리므로, 자주 쓰이는 데이터를 RAM에 상주시켜 원본 데이터베이스 앞의 사본 계층으로 삼고 접근 비용을 메모리 수준으로 끌어내릴 필요
