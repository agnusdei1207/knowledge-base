...
- **1. 부채·이자 기록**: 위치와 반복 비용을 기록
- **2. 상환 대상 선택**: 이자와 상환 비용을 비교
- **3. 현재 동작 고정**: 특성화 테스트를 작성
- **4. 작은 구조 변경**: 복구 가능한 단위로 개선
- **5. 회귀 테스트**: 변경 전후 결과를 확인
- **6. 부채 항목 종료**: 통과한 개선 효과를 기록
- **7. 직전 변경 복구**: 실패한 변경을 기준선으로 복귀
