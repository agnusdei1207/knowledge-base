...
date: "2026-08-26T13:26:48+09:00"
tags:
  - "notes-software"
weight: 199
extra:
...
- 배경/필요성: 서버만 이중화해도 그 아래 공유 DNS·스토리지·관리망이 하나로 남으면 그 한 지점의 장애가 전 계층 중단 비용으로 되돌아오므로, 진입·서비스·데이터·제어 각 계층에서 공유 지점을 찾아 독립 경로로 갈라 둘 필요
...
- FMEA 영향이 큰 의존성은 **다중화·격리**, 제거 여부는 **장애 주입** 검증
