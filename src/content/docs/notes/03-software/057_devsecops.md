...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "DevSecOps"
date: "2026-08-05T13:26:31+09:00"
tags:
  - "notes-software"
weight: 57
extra:
...
1. **보안 요구 도출**: 자산•공격 경로•필수 통제 정의
2. **자동 보안 검사**: SAST•SCA•비밀정보 검사 수행
3. **보안 게이트 판정**: 진행•차단•예외 여부 결정
4. **승인 산출물 배포**: 기준 충족 버전을 운영 반영
5. **운영 위험 관측•환류**: 공격 징후를 개선에 연결

> 요약: 자동 검사가 정책 위반을 배포 전에 차단하고 운영 위험을 개발에 환류

#### 한줄 요약

- 설계 위협부터 운영 위험까지 **보안 통제 환류**
