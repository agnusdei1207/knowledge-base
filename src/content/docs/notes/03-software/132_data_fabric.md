...
- **1. 활성 메타데이터 수집**: 분산 소스의 스키마·품질·계보·사용 신호 지속 확보
- **2. 지식 그래프 갱신**: 자산·업무 의미·소유자·변환 관계를 연결해 최신화
- **3. 목적·품질 조건 탐색**: 소비자가 의미와 신뢰 근거로 후보 자산 선택
- **4. 선택 자산 접근 요청**: 가상화·통합 경로에 목적과 권한을 함께 제출
- **5. 정책 집행 결과 제공**: 허용·마스킹·변환·감사를 요청 경로에서 일관되게 적용
