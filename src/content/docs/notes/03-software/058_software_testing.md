...
date: "2026-08-05T13:28:05+09:00"
tags:
  - "notes-software"
weight: 58
extra:
...
2. **시험 대상 실행**: 재현 가능한 조건에서 결과 수집
3. **오라클 판정**: 실제•기대 결과의 일치 비교
4. **통과 증거 기록**: 검증한 요구와 결과 연결
5. **결함 증거 기록**: 조건•영향•재현 정보 보존

> 요약: 요구에서 도출한 기대 결과와 실제 결과의 차이를 품질 근거로 기록

#### 한줄 요약

- 조건 구성•실행•판정•**품질 근거 기록 흐름**
