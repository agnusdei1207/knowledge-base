...
- **1. ADR 검토 요청**: 문제·대안·결과를 제출한다.
- **2. 대안·영향 피드백**: 근거와 품질 영향을 검토한다.
- **3. 승인 ADR 반영**: 합의 결정을 저장소에 남긴다.
- **4. 결정·제약 공유**: 구현팀에 후속 조치를 알린다.
- **5. 구현 변경 연결**: 코드·설정을 ADR과 연계한다.
- **6. 결정 변경 필요 보고**: 운영 결과를 소유자에게 알린다.
- **7. 후속 ADR·상태 갱신**: 대체 기록을 연결한다.
...
- **결정 영향·변경 비용·추적 필요성**에 따라 ADR을 남긴다.
