...
date: "2026-08-05T23:07:00+09:00"
tags:
  - "notes-software"
weight: 164
extra:
...
- **1. 사용자 SLI 측정**: 성공률•지연의 실제 수준 계산
- **2. 오류 예산 소진율 계산**: 목표 대비 허용 실패 소비 산출
- **3. 변경•안정화 상태 결정**: 배포 지속•제한 전환
- **4. 사용자 증상 경보**: 실행 가능한 조건으로 온콜 호출
- **5. 롤백•대체 경로 전환**: 장애 영향을 줄여 정상 수준 회복
