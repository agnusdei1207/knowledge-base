...
date: "2026-08-05T23:31:00+09:00"
tags:
  - "notes-software"
weight: 167
extra:
...
1. **운영 신호•변경 수집**: 관측 자료와 변경 사건 집계
2. **공통 문맥 정규화**: 시간•자원•토폴로지 정렬
3. **사건•원인 후보 압축**: 이상 상관과 원인 순위화
4. **위험별 런북 선택•승인**: 신뢰도•위험도 기반 통제
5. **가역 조치 실행•효과 검증**: 복구 확인과 지식 환류
