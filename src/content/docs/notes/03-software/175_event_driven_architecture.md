...
date: "2026-07-31T00:20:41+09:00"
tags:
  - "notes-software"
weight: 175
extra:
...
- **소비자 그룹(Consumer Group)**: 같은 구독의 파티션을 소비자들이 나눠 처리하는 논리 집합
- **파티션(Partition)**: 토픽의 이벤트를 업무 키별 순서와 병렬 처리 단위로 나눈 저장 구간

> **키워드:** 이벤트 기반 아키텍처 (Event-Driven Architecture)
