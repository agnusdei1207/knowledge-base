...
date: "2026-08-05T15:53:00+09:00"
tags:
  - "notes-software"
weight: 103
extra:
...
- 정의/개념: 네트워크 분할 중 **일관성•가용성 동시 보장 불가**를 설명하는 정리
...
- 정상 상태의 지연시간•일관성 절충까지 확장하는 **PACELC** 관점
...
- **1. 분할 상태 확인**: 복제본 사이 도달성 상실 판정
- **2. 복제본 확인 요청**: 연산 키의 도달 노드 확인
- **3. 최신 버전 조회**: 원격 복제본의 최신 상태 확인
- **4. 도달 가능 복제본 판정**: 정족수로 CP•AP 처리 선택
