...
date: "2026-08-26T18:11:00+09:00"
tags:
  - "notes-software"
weight: 103
extra:
...
- 배경/필요성: 네트워크 분할이 일어나면 양쪽 노드가 서로의 최신 변경을 볼 수 없어 응답을 돌려주면 낡은 값을 줄 위험을 지고 정합성을 지키려면 요청을 거절해야 하므로, 이 둘을 동시에 만족시킬 수 없다는 한계 자체를 설계 전제로 삼아 무엇을 포기할지 미리 확정하게 하는 판단 기준이 필요
