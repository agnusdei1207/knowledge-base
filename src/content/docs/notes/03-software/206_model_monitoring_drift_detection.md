...
[운영 신호 수집기]-+
                  |
[정답 결합기]---[드리프트 탐지기]---[대응 제어기]
```

선의 의미: 기준선 저장소, 운영 신호 수집기와 정답 결합기는 드리프트 탐지기의 비교•판정 자료 관계이고, 드리프트 탐지기는 대응 제어기와 변화 유형•업무 영향 판단 관계이다.
...
- **실제 성능 저하 확인 시 재학습**, 영향 없는 분포 변화는 **검증 후 기준선 갱신**
