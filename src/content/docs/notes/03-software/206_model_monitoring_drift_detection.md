...
date: "2026-07-29T18:03:00+09:00"
tags: ["notes-software"]
weight: 206
extra:
  question_no: "206"
...
block
    columns 1
    A["기준선 저장소 | 학습 입력·예측·성능 분포 보관"]
    B["운영 신호 수집기 | 신호를 슬라이스별 수집"]
    C["정답 결합기 | 지연 정답과 과거 예측 연결"]
    D["드리프트 탐지기 | 통계 거리·성능 차이 판정"]
    E["대응 제어기 | 재학습·복귀·기준 갱신 결정"]
    A --- B
    B --- C
    C --- D
    D --- E
