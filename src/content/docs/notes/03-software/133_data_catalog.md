...
- **1. 기술·운영 메타데이터 스캔**: 연결 소스에서 구조·실행·품질·최신성 신호 수집
- **2. 자산·계보·색인 갱신**: 시스템별 식별자를 정합화하고 검색·변환 관계 반영
- **3. 업무 의미·소유권 인증**: 소유자가 설명·민감도·책임과 신뢰 자산 여부 확정
- **4. 용어·품질 조건 검색**: 사용자가 업무 용어와 사용 조건으로 후보 자산 탐색
- **5. 신뢰·접근 정보 제공**: 계보·품질·소유자·접근 절차를 사용 판단 근거로 반환
