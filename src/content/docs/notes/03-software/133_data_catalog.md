...
- **자동 수집**: 자산·스키마·계보·품질 정보를 갱신
- **의미 연결**: 기술 이름을 용어·소유자·도메인과 연결
- **신뢰 검색**: 계보·최신성·인증 상태를 함께 제공
...
- **1. 자산·스키마·실행 정보 스캔**: 연결 소스의 구조를 조회
- **2. 기술·운영 메타데이터 반환**: 품질·최신성 신호를 전달
- **3. 자산·계보·검색 정보 갱신**: 식별자와 관계를 정합화
- **4. 설명·소유권 검토 요청**: 자동 추론 결과를 소유자에게 전달
- **5. 업무 정의·인증 승인**: 의미·민감도·책임을 확정
- **6. 용어·품질 조건 검색**: 사용자가 후보 자산을 검색
- **7. 계보·소유자·접근 정보 제공**: 사용 판단 근거를 제시
...
- **수집 범위·메타데이터 최신성·소유자 검증·검색 성공률**로 데이터 카탈로그를 운영
