...
- **5. 독립 처리·수신 확인**: 소비자 트랜잭션 수행
- **6. 동기 결과 반환**: 생산 서비스가 화면에 응답
...
- 주문 화면은 MVC로 표현·입력을 나누고 주문·결제는 업무별 서비스로 분리하며 배송 통지는 이벤트로 전달
