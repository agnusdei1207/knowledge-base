...
- **정의/개념**: 반복 설계의 구성요소·책임·관계를 재사용
- **배경/필요성**: 변경 전파가 품질을 좌우해 경계 패턴 필요
...
- 적용 범위가 화면·서비스·통합 경계로 다르다.
- 패턴 조합 시 경계 간 계약이 결합도를 좌우한다.
- 독립 배포·비동기는 분산 복잡도와 상충한다.
...
| 주요 위험 | 컨트롤러 비대화 | 분산 데이터·관측 비용 | 중복·순서·최종 일관성 |
