...
- 정의/개념: **인공지능(Artificial Intelligence, AI)** 데이터•모델•서비스 전주기의 위험과 통제를 확인하는 **인공지능 소프트웨어 감리(Artificial Intelligence Software Audit)**이다.
...
- 학습 데이터의 결함은 데이터 감리, 추론 품질은 모델 감리, 서비스 중 드리프트와 개입은 운영 감리로 확인한다.
...
- 집단별 오류율·사람 개입(Human Oversight) 절차 실작동 확인을 포함한 AI 감리 취약점 식별 체계 적용.
...
- 데이터 계보(Lineage)·모델 성능·사람 개입·드리프트 감시를 연계하는 AI 소프트웨어 전주기 심층 감리 체계 적용 필수.
