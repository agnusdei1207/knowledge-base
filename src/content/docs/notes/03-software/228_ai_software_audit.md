...
- **위험 기반 감리** 기반 영향도에 따라 점검 범위•깊이를 차등화한다.
- **계보 추적** 기반 데이터•모델 버전과 결정 이력을 연결한다.
- **독립 판정** 기반 개발 조직과 분리해 증거를 판단한다.
...
- **감리 깊이 선택 기준** 대상 따라 **고영향 인공지능** 전주기 심층 감리, 저위험은 증적 표본 점검을 적용한다.
