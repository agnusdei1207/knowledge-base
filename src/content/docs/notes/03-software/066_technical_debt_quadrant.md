...
- **1. 부채·발생 배경 등록**: 선택 당시 정보를 남긴다.
- **2. 의도성 확인 요청**: 사전 인지 여부를 묻는다.
- **3. 신중성 근거 제출**: 대안·위험 검토를 제시한다.
- **4. 유형별 조치 배정**: 상환·학습·통제를 정한다.
- **5. 이자·상환 조건 갱신**: 비용과 시점을 기록한다.
- **6. 리팩터링 완료**: 조건 충족 시 항목을 종료한다.
- **7. 재검토 일정 유지**: 미충족 시 다음 판단을 예약한다.
...
- **의도성·신중성·이자**에 따라 상환과 예방 조치를 정한다.
