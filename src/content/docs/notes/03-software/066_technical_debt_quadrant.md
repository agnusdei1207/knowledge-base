...
- **1. 부채·발생 배경 등록**: 선택 당시 정보를 기록
- **2. 의도성 확인 요청**: 부채 발생 전 위험 인지 여부 확인
- **3. 신중성 근거 제출**: 대안·위험 검토를 제시
- **4. 유형별 조치 배정**: 상환·학습·통제를 결정
- **5. 이자·상환 조건 갱신**: 비용과 시점을 기록
- **6. 리팩터링 완료**: 조건 충족 시 항목을 종료
- **7. 재검토 일정 유지**: 미충족 시 다음 판단을 예약
