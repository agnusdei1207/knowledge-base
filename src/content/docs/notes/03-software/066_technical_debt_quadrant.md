...
- 정의/개념: 기술 부채의 발생 원인과 성격을 **의도성** 과 **신중성** 2개 축으로 4분면 분류하여 원인별 상환/예방 전략을 수립하는 프레임워크인 **Technical Debt Quadrant**
- 배경/필요성: 부채의 원인 구분 없이는 **상환•교육•예방 조치** 혼선
...
|:---|:---|:---|
| Prudent & Deliberate**<br/>(신중 & 의도) | 출시 기한과 상환 계획을 고려한 전략적 타협 | **사업 가치•이자에 따라 상환 일정 관리 |
...
1. **부채 근거 수집**: 발생 당시 정보•일정•대안과 이자 기록.
2. **의도성•신중성 판정**: 사전 인지와 상환 계획 여부 확인.
3. **사분면 유형 분류**: 두 축을 조합해 네 부채 유형 지정.
4. **대응 조치 결정**: 상환•학습•품질 게이트 중 조치 선택.
...
| 문서화 여부 | **부채 대장에 근거•책임자•만료일 명시** | **발생 근거와 책임 추적 곤란** |
| 상환 계획 | **사업 가치와 이자 기반 일정 관리** | **계획 부재로 변경 비용 누적** |
...
| Prudent & Deliberate 부채가 상환되지 않고 누적 | **Technical Debt Backlog와 이자 기반 우선순위** | 전략적 부채의 상환 추적 |
...
- 신중•의도 부채는 **계획 상환**, 무모 부채는 **품질 게이트•교육** 적용
