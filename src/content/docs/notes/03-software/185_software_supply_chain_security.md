...
- 정의/개념: 개발·빌드·배포의 **위변조·악성 코드 통제**
- **배경/필요성**: 의존성 침해의 **제품 전파·추적 한계** 해소
...
- 개발자부터 배포까지 **공급 경로 연계 통제**
- 서명·SBOM·출처 증명의 **무결성 검증**
- 최소 권한·격리의 **침해 범위 제한**
...
- 빌드·의존성 변조가 운영에 유입되는 것을 막기 위해 **소스와 빌더 출처·SBOM·서명·검증 정책**을 검토하고, 출처 또는 서명 검증에 실패한 산출물의 배포를 차단한다
