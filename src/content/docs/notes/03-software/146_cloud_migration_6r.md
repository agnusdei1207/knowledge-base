...
- 배경/필요성: 모든 시스템을 재개발로 옮기면 이관 가치가 낮은 자산에도 최고 난도의 비용과 기간을 똑같이 치르게 되므로, 비즈니스 가치와 기술 복잡도로 자산을 먼저 나누고 여섯 갈래 중 하나를 배정해 전환 비용을 가치에 비례 배분할 필요
...
- 신속 이전은 **Rehost**, 전면 현대화는 **Refactor** 선택
