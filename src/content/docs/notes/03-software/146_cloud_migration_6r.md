...
- 정의/개념: 워크로드별 **이전 전략 6가지** 선택 분류
- 배경/필요성: 일괄 이전으로 인한 **과잉 변경·부채 잔존** 방지
...
| 핵심 특징 | 구조 유지·**인프라 이전** | 일부 **관리형 전환** | SaaS·**새 제품 대체** | 구조·코드 **재설계** |
...
| 교차 호출로 분리하기 힘든 **의존성** | 실행 흐름 기반 **웨이브 그래프** | 전환 뒤 **연결 단절 방지** |
...
- **업무 가치·변경 범위·의존성·기한**으로 6R 전략·웨이브 결정
