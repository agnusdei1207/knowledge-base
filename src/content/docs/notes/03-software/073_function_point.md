...
- **1. 측정 목적·요구 확인**: 사용자 관점을 결정
- **2. 사용자 기능 제공**: 기능과 데이터를 식별
- **3. 시스템 경계 정의**: 측정 대상 안팎을 분리
- **4. 내부 유지·외부 참조 구분**: 데이터 책임을 판결정
- **5. 기능 유형·복잡도 제출**: DET·RET·FTR 개수 산정
- **6. 분류·가중치 검토**: 중복과 판정 근거를 확인
- **7. 기능점수 합산·확정**: 가중치를 곱해 규모를 결정
...
> 적용 사례: 공공 소프트웨어 사업은 기능점수와 단가로 개발·변경 대가를 산결정
...
- **측정 경계·기능 유형·복잡도 근거**로 기능점수를 확결정
