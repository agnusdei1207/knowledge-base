...
- **TTA 제3자 시험**: TTA 제3자 시험은 합의한 환경과 기준으로 소프트웨어 품질을 독립적으로 측정하고 판정하는 절차다.

</details>

- 정의/개념: **TTA 제3자 시험**이 합의한 기준으로 품질을 독립 측정·판정하는 절차
...
- **원시 증적·독립 판정**: 시험 조건에서 얻은 원시 증적을 보존하고 독립된 기준으로 판정해야 결과의 재현성과 객관성을 확보할 수 있다.
...
2. **환경·케이스 구성 요청**: 합의한 장비·데이터·부하 고정
...
- **BMT**: BMT는 같은 환경, 데이터, 부하에서 여러 후보 제품의 기능과 성능을 상대 비교하는 시험이다.
