...
- 정의/개념: 공공 **SW 사업**의 필요성•공공성과 민간시장 대체 영향을 발주 전에 판단하는 **SW 사업 영향평가** 절차
...
- **1. 시장•공공성 판정 결과**: 민간 대안의 공급 가능성과 공공 직접 개발 필요성을 기능별로 비교한 결과이다.
- **2. 평가 결과**: 사업 범위•근거•시장 영향 판정을 공시 체계에 공개하는 단계이다.
- **3. 재평가 자료**: 소프트웨어 사업자의 유사 제품 근거와 변경된 사업계획을 반영한 입력이다.
