...
- 정의/개념: 공공 **소프트웨어(Software, SW)** 사업의 필요성•공공성과 민간시장 대체 영향을 발주 전에 판단하는 **소프트웨어사업 영향평가(Software Business Impact Assessment)** 절차
...
- **소프트웨어 사업자(Software Business Operator, SW Business Operator)**: 유사 제품•서비스의 공급 근거를 제시하고 재평가를 요청하는 이해관계자이다.
