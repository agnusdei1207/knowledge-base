...
- 정의/개념: 공공 SW의 민간시장 대체성을 판단하는 **사업 영향평가**
...
1. **기능•사용자•배포 범위 확정**: 시장 대체 단위 정의
2. **민간 공급•공공 필요성 비교**: 조달 가능성과 고유성 판정
3. **평가 근거•결과 공시**: 사업 범위•시장 영향 공개
4. **재평가•사업 범위 조정**: 민간 근거•계획 변경 반영
