...
block
    columns 1
    A["행동·맥락 수집기 | 동의 범위의 행동·시간·위치 수집"]
    B["피처 스토어 | 이력·실시간 피처를 동일 정의로 제공"]
    C["동의·노출 정책 | 목적·보존·빈도·다양성 제약"]
    D["의사결정 엔진 | 후보 점수·정책으로 제안 선택"]
    E["채널·콘텐츠 제공기 | 제안을 앱·웹·메시지에 노출"]
    A --- B
    B --- C
    C --- D
    D --- E
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 동의 없는 **행동 자료 결합** | 목적 동의·**최소 수집 적용** | 프라이버시 **보호** |
...
- **동의 범위·사용자 가치·편향 위험**으로 개인화 수준 결정
