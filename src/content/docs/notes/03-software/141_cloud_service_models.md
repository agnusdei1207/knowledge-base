...
- **1. 모델·용량·보안 설정 요청**: 필요한 서비스 조건을 제출
- **2. 사용자·역할·정책 검증**: 요청 권한과 제한을 확인
- **3. 허용 범위·조건 반환**: 수행 가능한 작업을 결정
- **4. 공급자 책임 계층 구성**: 모델별 관리 계층을 생성
- **5. 서비스·소비자 책임 제공**: 종단점과 설정 범위를 전달
- **6. 앱·계정·데이터 반영**: 소비자가 맡은 계층을 구성
- **7. 경보·준수 증적 제공**: 상태와 조치 책임을 통지
