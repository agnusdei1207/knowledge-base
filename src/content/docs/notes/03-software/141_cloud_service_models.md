...
date: "2026-08-26T13:10:50+09:00"
tags:
  - "notes-software"
weight: 141
extra:
...
- 배경/필요성: 직접 운영하면 하드웨어부터 런타임·애플리케이션까지 모든 계층의 구축과 유지 비용을 조직이 그대로 떠안으므로, 어느 계층까지 사업자가 대신 맡을지를 IaaS·PaaS·SaaS로 끊어 통제권을 내주는 만큼 운영 비용을 덜어 내는 선택지를 만들 필요
...
- 운영 제어 수준에 따라 **IaaS·PaaS·SaaS** 선택
