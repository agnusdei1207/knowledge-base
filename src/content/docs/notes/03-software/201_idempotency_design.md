...
date: "2026-07-31T10:47:49+09:00"
tags:
  - "notes-software"
weight: 201
extra:
...
- **트랜잭셔널 아웃박스(Transactional Outbox)**: 업무 결과와 발행할 이벤트를 같은 트랜잭션에 저장한 뒤 별도 발행기가 전달하는 패턴
- **TTL(Time to Live)**: 멱등성 키를 중복 판정에 유지할 만료 시간

> **키워드:** 멱등성 설계 (Idempotency Design)

## Ⅰ. 개요

- 정의/개념: 반복 요청에도 동일한 **업무 효과**를 보장하는 설계 원칙
