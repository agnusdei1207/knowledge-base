...
date: "2026-08-05T15:58:00+09:00"
tags:
  - "notes-software"
weight: 104
extra:
...
- 정의/개념: 즉시 확정의 **ACID**와 지연 수렴의 **BASE** 보장 비교
...
- **1. 데이터•아웃박스 기록**: 기준 상태와 발행 대기 함께 저장
- **2. 기준 거래 커밋**: 불변식 통과 거래만 원자 확정
- **3. 미발행 아웃박스 조회**: 미전파 이벤트 식별
- **4. 커밋 이벤트 전달**: 확정된 변경만 전파
- **5. 파생 상태 멱등 적용**: BASE 복제본 수렴
...
- 즉시 불변식에는 **ACID**, 지연 허용 파생 상태에는 **BASE** 적용
