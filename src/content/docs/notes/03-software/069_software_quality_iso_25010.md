...
- **1. 사용 맥락·위험 전달**: 실패 영향을 정의
- **2. 특성·부특성 후보**: 관련 품질 항목을 선택
- **3. 측정법·허용 기준 전달**: 합격선을 합의
- **4. 품질 측정 실행**: 정의한 조건에서 시험
- **5. 측정 결과**: 수치와 시험 증거를 수집
- **6. 기준 충족 결과**: 허용 기준과 대조
- **7. 재조정·수용 판정**: 미달은 개선하고 통과는 수용

> 요약: 사용 맥락의 위험을 측정 가능한 품질 요구로 바꿔 제품 수용을 판결정
...
> 적용 사례: 결제 서비스는 성능 효율성과 신뢰성을 응답시간·복구시간 기준으로 측결정
