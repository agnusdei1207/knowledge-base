...
date: "2026-08-05T13:50:41+09:00"
tags:
  - "notes-software"
weight: 69
extra:
...
1. **사용 맥락•실패 영향 분석**: 핵심 품질 위험 도출
2. **품질 특성•부특성 선택**: 위험 대응 평가 항목 선정
3. **품질 요구•허용 기준 정의**: 측정법•합격선 합의
4. **품질 측정•수용 판정**: 값 수집과 기준 대조

> 요약: 사용 맥락의 위험을 측정 가능한 품질 요구로 바꿔 제품 수용 판정

#### 한줄 요약

- 맥락 위험을 **측정 가능한 품질 요구로 변환**
