...
- **1. 사용 맥락·위험 전달**: 실패 영향을 정의한다.
- **2. 특성·부특성 후보**: 관련 품질 항목을 고른다.
- **3. 측정법·허용 기준 전달**: 합격선을 합의한다.
- **4. 품질 측정 실행**: 정의한 조건에서 시험한다.
- **5. 측정 결과**: 수치와 시험 증거를 수집한다.
- **6. 기준 충족 결과**: 허용 기준과 대조한다.
- **7. 재조정·수용 판정**: 미달은 개선하고 통과는 수용한다.
...
- **사용 맥락·실패 위험·측정 가능성**으로 품질 요구를 정한다.
