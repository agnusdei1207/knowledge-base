...
- **1. Snapshot·로그 위치 요청**: 초기 경계를 구
- **2. 기존 행·위치 반환**: 기준 데이터를 수신
- **3. Snapshot 이벤트 발행**: 초기 상태를 전달
- **4. 이후 커밋 로그 제공**: 변경분을 조회
- **5. 변경 이벤트 발행**: 순서·스키마를 포함
- **6. 파티션 순서 전달**: Sink에 전달
- **7. 원천 위치 저장**: 재시작 책갈피를 기록
