...
date: "2026-08-05T14:44:00+09:00"
tags:
  - "notes-software"
weight: 89
extra:
...
- **1. 함수 종속•후보키 도출**: 속성 폐쇄로 최소키 식별
- **2. 정규형 위반 판정**: 부분•이행•비키 결정자 확인
- **3. 위반 종속 분해**: 위반 결정 관계를 별도 표로 분리
- **4. 무손실•종속성 보존 검증**: 복원과 제약 유지 확인
...
- 이상 제거 우선은 **BCNF**, 종속성 보존 우선은 **3NF** 선택
