...
date: "2026-08-05T16:31:00+09:00"
tags:
  - "notes-software"
weight: 111
extra:
...
- 정의/개념: 하위 변경을 매핑에서 흡수하는 **데이터 독립성** 설계 원칙
...
- **1. 개념 질의•논리 연산 변환**: 외부 뷰를 논리 구조에 대응
- **2. 물리 접근 요청**: 파일•페이지•인덱스 조회
- **3. 내부 레코드 반환**: 물리 데이터 반환
- **4. 외부 뷰 결과 복원**: 사용자별 표현으로 변환
