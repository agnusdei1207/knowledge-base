...
date: "2026-08-05T20:19:00+09:00"
tags:
  - "notes-software"
weight: 143
extra:
...
- 정의/개념: 복수 공급자에 워크로드를 배치하는 **멀티 클라우드 전략**
...
- **1. 주 공급자 처리 위치 결정**: 건강•주권•비용 정책으로 환경 선택
- **2. 변경 상태•복제 기준 부여**: 복제 순서와 재시작 지점 연결
- **3. RPO 내 예비 상태 검증**: 허용 손실 시점까지 동기화 확인
- **4. 공급자 장애 판정**: 지속시간으로 일시 오류와 장애 구분
- **5. 예비 공급자 라우팅 전환**: 최신성 확인 후 실행 위치 변경
