...
date: "2026-08-05T12:52:41+09:00"
tags:
  - "notes-software"
weight: 27
extra:
...
- **1. 구독 설정**: 수요 요청•취소 통로 제공
- **2. 수요량 요청**: 처리 가능한 신호 수 전달
- **3. 수요 범위 발행**: 요청 잔량 이하의 데이터 생성
- **4. 변환•소비**: 연산자 가공 후 구독자 처리
- **5. 수요 잔량 갱신**: 추가 요청•종단 여부 판정

#### 한줄 요약

- 수요량 안에서 **신호 발행•종단 처리** 반복
