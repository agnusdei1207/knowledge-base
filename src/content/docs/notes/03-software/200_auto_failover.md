...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 순간 지연의 **장애 오판** | 다중 신호·**지속 시간 판정** | 불필요한 전환 **방지** |
| 이전 Primary의 **생존** | 승격 전 **펜싱 완료 확인** | 이중 쓰기 **차단** |
| 복제 지연의 **자료 손실** | RPO 기준·**승격 후보 제한** | 손실 범위 **통제** |
| 전환 후 **재시도 폭주** | Backoff·**N-1 용량 검증** | 대체 노드 **과부하 방지** |
