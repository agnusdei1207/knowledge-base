...
date: "2026-08-26T13:27:29+09:00"
tags:
  - "notes-software"
weight: 200
extra:
...
- 배경/필요성: 수동 전환은 사람이 장애를 인지하고 판단해 명령하기까지의 시간이 그대로 RTO가 되고 판단 착오 시 이중 쓰기 위험까지 남으므로, 감지·판정·격리·승격을 하나의 자동 제어 계층으로 묶어 전환 시간을 초 단위로 줄일 필요
