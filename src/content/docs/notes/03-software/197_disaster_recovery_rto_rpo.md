...
1. **BIA•MTD 영향 분석**: 중단 피해•최대 허용 시간 평가
2. **RTO•RPO•복구 등급 승인**: 목표•예비 수준 결정
3. **데이터 보호•예비 환경 준비**: 복구점•대체 자원 확보
4. **장애 전환•복구점 적용**: 대체 환경•일관 자료 전환
5. **업무•데이터 대사•복귀**: 거래•무결성 검증 후 복귀
