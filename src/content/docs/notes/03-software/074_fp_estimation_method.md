...
- **1. 목적·범위·요구 버전 확인**: 산정 대상을 고정한다.
- **2. 기능 요구 제공**: 사용자 기능과 데이터를 전달한다.
- **3. 기능 유형 식별**: 다섯 유형을 센다.
- **4. 요구 상세도·요소 정보**: DET·RET·FTR을 확인한다.
- **5. 산정법·가중 점수 제출**: 상세도별 가중치를 적용한다.
- **6. 누락·중복·근거 검토**: 분류 일관성을 확인한다.
- **7. 기능점수·기준선 확정**: 점수와 가정을 기록한다.
...
- **요구 상세도·산정 목적·기준선**에 따라 간이법과 정통법을 정한다.
