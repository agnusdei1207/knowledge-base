...
date: "2026-08-05T14:02:01+09:00"
tags:
  - "notes-software"
weight: 74
extra:
...
1. **다섯 기능 유형 식별**: EI•EO•EQ•ILF•EIF 분류
2. **요구 상세도 판정**: 간이법•정통법 선택
3. **선택 산정법 가중치 적용**: 평균값•상세값 반영
4. **UFP 합산**: 유형별 기능 수와 가중치 계산
5. **근거 검토•기준선 확정**: 누락•중복 확인

> 요약: 요구 상세도에 맞는 가중치를 선택하고 판정 근거와 함께 기능점수 확정

#### 한줄 요약

- 요구 상세도 판정과 **간이•정통 가중치 적용**
