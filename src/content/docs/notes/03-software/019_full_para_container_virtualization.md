...
- **마이크로서비스(Microservice)**: 하나의 비즈니스 기능을 독립 배포하는 작은 서비스로서 컨테이너의 빠른 시작과 높은 배치 밀도를 활용한다.
...
- **3. 하이퍼콜 전달**: 반가상화 중재
- **4. 시스템 호출 전달**: 컨테이너 중재
- **5. 물리 자원 실행·결과 반환**: 권한·한도 검증 후 응용에 응답
