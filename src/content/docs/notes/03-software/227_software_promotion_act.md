...
- 정의/개념: 산업 진흥과 **공공 소프트웨어사업**의 공정성을 규율하는 **소프트웨어 진흥법**이다.
...
- **요구사항 상세화**와 **적정 기간•대가**를 발주 기준에 반영한다.
- **변경 심의**로 과업 변경과 계약금액•기간을 조정한다.
...
- **공공 소프트웨어사업 절차 기준**과 **절차적 공정성**에 따라 발주•변경•계약 조정 근거를 기록한다.
