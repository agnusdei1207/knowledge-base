...
- 정의/개념: 산업 진흥과 **공공 소프트웨어사업** 공정성을 규율하는 **소프트웨어 진흥법**이다.
...
- **요구사항 상세화** 및 **적정 기간•대가** 활용 발주 기준에 반영한다.
- **변경 심의** 기반 과업 변경과 계약금액•기간을 조정한다.
...
| 공공 소프트웨어사업 제도 | **요구사항 상세화 적용** | **과업심의** | **상용소프트웨어 직접구매** |
|:---|:---|:---|:---|
...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 불명확한 초기 요구로 규모 오산 | **요구사항 상세화** | 과업 규모 명확화 |
| 심의 없는 변경으로 **무상 과업** 발생 | 변경 전 **변경 심의** | 무상 업무 방지 |
| 범위 변경 후 **기간•대가 조정 누락** | **계약 조정** | 계약 균형 확보 |
...
- **공공 소프트웨어사업 절차 기준** 및 **절차적 공정성** 대상 따라 발주•변경•계약 조정 근거를 기록한다.
