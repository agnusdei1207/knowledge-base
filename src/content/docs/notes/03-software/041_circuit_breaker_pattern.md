...
date: "2026-08-05T13:02:17+09:00"
tags:
  - "notes-software"
weight: 41
extra:
...
- Closed•Open•Half-Open **상태 전이** 기반 제어
...
- **1. 호출 허용•타임아웃**: Closed 요청을 제한 시간으로 전달
- **2. 결과 집계•임계 판정**: 표본으로 Open 전환 여부 결정
- **3. Open 즉시 차단**: 원격 호출 없이 대체 결과 반환
- **4. Open 대기 만료**: 대기 후 Half-Open 전환
- **5. Half-Open 시험 판정**: 성공은 Closed, 실패는 Open 전환

#### 한줄 요약

- Closed•Open•Half-Open **복구 상태 순환**
