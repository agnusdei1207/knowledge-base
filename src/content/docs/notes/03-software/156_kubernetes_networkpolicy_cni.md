...
date: "2026-08-05T22:03:00+09:00"
tags:
  - "notes-software"
weight: 156
extra:
...
- **1. 송신 규칙•패킷 속성 대조**: 선택자•목적지•포트 비교
- **2. 송신 허용 판정**: 송신 측 허용 규칙 합집합 적용
- **3. 수신 정책 지점 전달**: 통과 패킷을 수신 데이터면으로 전송
- **4. 수신 규칙•패킷 속성 대조**: 선택자•출발지•포트 비교
- **5. 수신 허용 판정**: 수신 측도 허용할 때만 파드 전달
