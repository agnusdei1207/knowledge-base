...
| 절차 | 설명 |
|:---|:---|
| 구조 노출 | 시맨틱 마크업으로 이름·역할·상태를 접근성 트리에 제공 |
| 보조기술 해석 | 스크린리더가 접근성 트리의 의미와 상태를 사용자에게 전달 |
| 키보드·초점 조작 | 포인터 없이 모든 기능을 순서대로 탐색·실행 |
| 핵심 과업 검증 | 자동 검사 결과와 사람·보조기술의 실제 수행 결과를 대조 |
...
- 장애와 환경에 관계없이 디지털 과업을 완료하게 하기 위해 **WCAG 원칙·키보드 조작·대체 텍스트·오류 회복·보조기술 성공률**을 검토하고, 자동 검사와 사용자 과업 검증을 함께 수행한다
