...
- **정의/개념**: 장애·연령·기기와 무관한 서비스 이용 지원
- **배경/필요성**: 감각·운동·인지 장벽으로 대체 이용 수단이 필요함
...
| 판단 기준 | Level A | Level AA | Level AAA |
|:---|:---|:---|:---|
| 핵심 특징 | 최소 접근 장벽을 제거함 | 주요 접근 장벽을 추가 제거함 | 가장 높은 기준까지 충족함 |
| 적용 기준 | 최소 기능 접근 보장 | 일반 서비스 준수 목표 | 특정 고접근성 목표 |
| 주요 위험 | 주요 장벽 잔존 | 일부 사용자 요구 누락 | 전 콘텐츠 적용 비용 증가 |
...
2. 모바일 금융은 스크린 리더로 이체 과업 검증

### 쉽게 이해하기 (학습용)
- 공공 민원은 키보드 과업 완료율을 확인함
- 금융 앱은 스크린 리더 이체 성공률을 확인함
