...
- 정의/개념: 생성부터 종료까지의 **프로세스 상태 전이**
- 배경/필요성: 대기 작업의 **CPU 불필요 점유** 방지
...
- **1. 자식 생성 요청**: PCB 생성
- **2. 준비·실행 상태 전환**: 준비 큐 등록 후 문맥 복원
- **3. I/O 작업 요청**: 장치 작업 시작
- **4. 대기 상태 전환**: CPU 반납
- **5. 완료·준비 상태 전환**: 완료 이벤트로 실행 후보 복귀
...
| 한계 | 긴 준비 큐의 응답 지연 | 이벤트 누락·무기한 대기 |
