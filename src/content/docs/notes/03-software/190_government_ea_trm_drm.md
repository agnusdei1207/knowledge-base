...
- **업무 참조 모형(Business Reference Model, BRM)**: 기관 조직명이 아니라 정부 기능과 업무를 공통 영역으로 분류하는 모형
- **서비스 참조 모형(Service Reference Model, SRM)**: 응용 기능·공통 서비스 구성요소를 분류해 재사용 대상을 찾는 모형
- **데이터 참조 모형(Data Reference Model, DRM)**: 데이터 주제·의미·구조·교환 요소의 공통 분류와 공유 기준을 제공하는 모형
- **기술 참조 모형(Technical Reference Model, TRM)**: 플랫폼·인프라·보안·통신 등 기술 서비스의 공통 분류와 표준 기준을 제공하는 모형
- **성과 참조 모형(Performance Reference Model, PRM)**: 정보화 투자·서비스와 공통 성과 영역·지표를 연결하는 모형
...
- **동명이의·이명동의**: 같은 이름이 다른 뜻을 갖거나 다른 이름이 같은 뜻을 가리켜 데이터 매핑을 혼동시키는 관계

> **키워드:** 범정부 EA 참조 모형 TRM·DRM (Government EA TRM DRM)

## Ⅰ. 개요

- 정의/개념: 정부기관 자산을 **공통 분류**해 비교·연계하는 참조모형 체계
