...
- 배경/필요성: 초기 모호한 요구사항으로 인한 프로젝트 후반부 대대적 재작업(Rework) 비용 소멸, 발주자-수주자 간 분쟁 예방 요구성
...
- **IEEE 830 / ISO/IEC/IEEE 29148** 요구사항 명세 표준 준수
...
| 요구공학 4대 프로세스 | 주요 활동 내용 | 대표적 도구 및 산출물 |
|:---|:---|:---|
| **1. 요구사항 도출 (Elicitation)** | 이해관계자 인터뷰, 브레인스토밍, 프로토타이핑 | 요구사항 목록, 사용자 스토리 |
| **2. 요구사항 분석 (Analysis)** | 구조적/객체지향 분석, 모호성/충돌 제거, 우선순위 부여 | Use Case Diagram, DFD, ERD |
| **3. 요구사항 명세 (Specification)**| **IEEE 830 / 29148** 준수 명세서 작성 | **Software Requirements Specification (SRS)** |
| **4. 요구사항 검증 (Validation)** | 인스펙션(Inspection), 동료 검토, 프로토타입 시연 | **RTM (추적 매트릭스)**, 검토 조치록 |
...
| 측정 및 검증 | Pass/Fail 여부 명확함 (기능 작동 여부) | **정량적 측정 지표 (TPS, Latency, MTBF, Availability %)** |
