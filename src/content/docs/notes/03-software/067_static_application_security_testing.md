...
date: "2026-08-26T13:01:47+09:00"
tags:
  - "notes-software"
weight: 67
extra:
...
- 배경/필요성: 런타임 이후에 취약점을 발견하면 수정이 설계까지 되돌아가고 유출 피해까지 겹치므로, 실행 없이 소스·바이트코드의 데이터 흐름을 분석하는 정적 분석을 빌드 단계에 두어 결함 위치를 코드 라인 단위로 지목할 필요
...
- 코드 경로는 **SAST**, 실행 환경 취약점은 **DAST** 선택
