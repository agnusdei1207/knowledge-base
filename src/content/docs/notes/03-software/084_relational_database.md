...
- 배경/필요성: 데이터 **중복·불일치**를 관계형 제약으로 통제
...
- **1. SQL 선언 제출**: 원하는 결과·변경 조건 표현
- **2. 비용 기반 계획 선택**: 통계로 접근·조인 순서 결정
- **3. 무결성 제약 검증**: 키·참조·도메인 규칙 확인
- **4. 관계 연산 실행**: 저장소·인덱스에서 계획 수행
- **5. 커밋·결과 행 반환**: 유효 변경과 조회 결과 확정
