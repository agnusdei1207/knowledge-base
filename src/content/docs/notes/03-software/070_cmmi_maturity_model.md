...
date: "2026-08-05T13:52:53+09:00"
tags:
  - "notes-software"
weight: 70
extra:
...
1. **실천 영역•목표 수준 선정**: 평가 범위•수준 결정
2. **실천 기록•성과 증거 수집**: 수행•효과 자료 확보
3. **실천•증거 매핑과 격차 평가**: 충족도•원인 판정
4. **개선 과제 우선순위 결정**: 사업 영향별 조치 정렬
5. **개선 실행•성과 재측정**: 적용 효과 확인

> 요약: 사업 목표에 맞는 실천을 적용하고 객관적 증거로 평가해 반복 개선

#### 한줄 요약

- 증거 기반 격차 평가와 **사업 성과 개선 순환**
