...
- 정의/개념: **CMMI 성숙도 모델**은 조직의 개발•서비스 프로세스 역량을 수준별로 진단하고 제도화된 개선 방향을 제시하는 프로세스 개선 모델이다.
- 배경/필요성: 개인 의존 업무는 담당자별 **성과 편차•반복 재현 한계**가 발생한다.

#### 한줄 요약

- 개인 의존을 줄이는 **조직 프로세스 역량 개선 모델**이 핵심이다.
...
- **실천 영역•수준 체계**로 개선 경로 제시가 핵심이다.
- **객관적 증거**로 실천 수행과 성과 평가한다.
- 등급 획득보다 **사업 성과 개선**이 적용 목적이 핵심이다.

#### 한줄 요약

- 실천•객관적 증거•**사업 성과 중심 개선**이 핵심이다.
...
2. **실천 기록•성과 증거 수집**: 수행•효과 자료를 확보한다.
3. **실천•증거 매핑과 격차 평가**: 충족도•원인을 판정한다.
4. **개선 과제 우선순위 결정**: 사업 영향별 조치를 정렬한다.
5. **개선 실행•성과 재측정**: 적용 효과를 확인한다.

> 요약: 사업 목표에 맞는 실천을 적용하고 객관적 증거로 평가해 반복을 개선한다.

#### 한줄 요약

- 증거 기반 격차 평가와 **사업 성과 개선 순환**이 핵심이다.
...
- 전사 통합 개선은 **성숙도**, 특정 영역 개선은 **능력도**를 적용한다.

#### 한줄 요약

- 전사 통합은 성숙도, 특정 영역은 **능력도**가 핵심이다.
