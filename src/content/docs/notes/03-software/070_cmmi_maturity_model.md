...
- **1. 사업 목표·범위 정의**: 개선 성과를 결정
- **2. 대상 실천 영역 제시**: 관련 영역과 수준을 선택
- **3. 실천 적용·성과 증거 축적**: 격차를 개선
- **4. 객관적 증거 제출**: 측정값과 기록을 전달
- **5. 실천 충족도 대조**: 모델 기준과 비교
- **6. 수준 판정 기준**: 성숙도·능력도 기준을 제공
- **7. 수준·개선 과제 보고**: 강점과 격차를 전달
...
> 적용 사례: 반복되는 배포 실패에 품질보증 실천을 적용하고 실패율 변화를 측결정
...
- **사업 목표·개선 범위·증거 수준**에 따라 CMMI를 적용
