...
- 배경/필요성: 개인 경험 의존 프로세스는 **성과 편차•예측 실패** 유발
...
- **CMMI Appraisal Method**를 통한 증거 기반 평가
...
| Level 5 | **Optimizing (최적화)** | **결함 근본 원인 분석** 과 신기술 도입을 통한 지속적 개선 |
...
1. 목표•평가 범위 정의: 사업 성과와 조직•실천 영역 지정.
2. 실천•증거 매핑: 산출물•도구 기록•인터뷰 증거 연결.
3. 구현 격차 평가: 목표 수준 대비 강점과 약점 판정.
4. 개선 조치 실행: 원인별 표준화•재단•자동화 적용.
5. 성과 재측정: 개선 전후 사업•프로세스 지표 비교.
...
|:---|:---|:---|
| 중심 개념 | **조직 전체의 성숙도 ** | **특정 프로세스 영역의 역량 **|
...
- 조직 전체 비교는 **성숙도 수준**, 특정 영역 개선은 **능력도 수준** 선택
