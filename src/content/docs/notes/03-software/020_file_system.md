...
date: "2026-07-31T10:26:27+09:00"
tags: [notes-software]
weight: 20
extra:
  question_no: "020"
...
> **키워드:** 파일 시스템: FAT·NTFS·ext4·APFS (File System)

## Ⅰ. 개요

- 정의/개념: 파일 이름·메타데이터를 저장 블록과 연결하는 **영구 저장 관리 체계**
...
- **1. 경로 구성요소·접근 유형**: 디렉터리를 따라 대상과 권한 조회
- **2. 파일 매핑·할당 조건**: 기존 위치와 필요한 빈 블록 전달
- **3. 데이터·복구 레코드**: 파일 내용과 저널·COW 정보 기록
- **4. 기록 완료·블록 위치**: 저장장치가 영구 기록 결과 반환
- **5. 확정 매핑·메타데이터**: 크기·위치·시간 정보를 커밋
