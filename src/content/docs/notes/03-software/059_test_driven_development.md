...
date: "2026-08-05T13:30:18+09:00"
tags:
  - "notes-software"
weight: 59
extra:
...
2. **레드 확인**: 구현 전 의도한 이유의 실패 판정
3. **최소 구현**: 현재 테스트를 통과할 코드 작성
4. **그린 확인**: 신규•기존 회귀 테스트 통과 판정
5. **리팩터링**: 외부 동작을 유지하며 구조 개선

> 요약: 실패 확인•최소 구현•구조 개선을 작은 동작마다 반복

#### 한줄 요약

- 레드•그린•리팩터의 **작은 동작 반복 순환**
