...
sequenceDiagram
    ...
    H->>I: 원천 자료•자격 발급 요청
    I->>I: 1. 원천 자료•자격 주장 검증
    I->>I: 2. 암호 증명•서명 VC 생성
    I-->>H: 서명 VC
    V->>H: 목적•속성 제시 요청
    ...
    S-->>V: 신뢰•정지•폐기 정보
    V->>V: 4. 서명•발급자•상태 검증
    V->>V: 5. 목적 제한•업무 적합성 판정
    V-->>H: 자격 수용 결과
```

**동작 원리**

- **1. 원천 자료•자격 주장 검증**: 발급 근거와 주체 자격 확인
- **2. 암호 증명•서명 VC 생성**: 주장•유효기간의 무결성 보호
- **3. 동의•선택 공개 VP 생성**: 요청 목적에 필요한 속성만 구성
- **4. 서명•발급자•상태 검증**: 신뢰 기관과 정지•폐기 여부 확인
- **5. 목적 제한•업무 적합성 판정**: 요청 용도와 자격 조건 대조
#### 한줄 요약
