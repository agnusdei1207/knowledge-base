...
date: "2026-08-05T17:31:27+09:00"
tags:
  - "notes-security"
weight: 65
extra:
...
- 정의/개념: 워크로드별 필요한 **동서 트래픽**만 허용하는 **내부 통제**
...
- **가상 근거리 통신망(Virtual Local Area Network, VLAN)**: 네트워크를 큰 논리 구역으로 분리하는 기술
