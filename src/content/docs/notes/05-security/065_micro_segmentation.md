...
- 정의/개념: 워크로드별 **최소 통신 흐름 분리**
- 배경/필요성: 구역 내부의 **자유 통신·측면 이동**
...
- **1. 출발·대상·신원 연결 요청**: 포트·행위·워크로드 제시
- **2. 라벨·현재 정책 조회**: 최신 속성·정책 버전 확인
- **3. 최소 흐름·예외 판정**: 기본 거부·허용 규칙 평가
- **4. 허용 연결만 대상 전달**: 승인된 동서 통신 집행
- **5. 차단·과차단·우회 검증**: 결과·직접 경로를 분석
### 쉽게 이해하기 (학습용)
