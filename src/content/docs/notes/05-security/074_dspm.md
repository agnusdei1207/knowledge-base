...
| 절차 | 설명 |
|:---|:---|
| 최소 권한 메타데이터 조회 | 비침투 방식으로 저장소 검사 |
| 내용·권한·암호화 정보 반환 | 소유자·공유·보호 상태 제공 |
| 민감도·계보·유효접근 분석 | 노출·복제 경로 위험 계산 |
| 권한·마스킹·삭제 승인 | 소유자가 보호 조치 결정 |
| 재스캔·위험 제거 확인 | 수정 결과·잔여 노출 검증 |
