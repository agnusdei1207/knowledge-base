...
sequenceDiagram
    ...
    D-->>O: 3. 민감도·계보·유효접근 분석
    O->>C: 4. 권한·마스킹·삭제 승인
    C-->>검증기: 5. 재스캔·위험 제거 확인
```
...
- **3. 민감도·계보·유효접근 분석**: 노출·복제 경로 위험 계산
- **4. 권한·마스킹·삭제 승인**: 소유자가 보호 조치 결정
- **5. 재스캔·위험 제거 확인**: 수정 결과·잔여 노출 검증
### 쉽게 이해하기 (학습용)
...
| 핵심 특징 | **저장 데이터·접근 분석** | **클라우드 자원 설정 평가** | 데이터 사용·이동 통제 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 정보 분류 기준 | **ISO/IEC 27002 통제 5.12 적용** | 민감도·보호 등급 일관화 |
| 개인식별정보 보호 | **NIST SP 800-122 연계** | 영향 기반 보호조치 선정 |
| 스캔 공백·과잉 권한 | **자산 대조·최소 읽기·재스캔** | 그림자 데이터·잔여 노출 축소 |
...
- **민감도·유효접근·복제계보**로 DSPM 조치순위를 결정한다.
