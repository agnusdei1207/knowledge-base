...
|:---|:---|
| 정찰 | **표적·자산·노출 경로 조사** |
| 무기화·전달 | **공격 도구 준비·목표 전송** |
| 악용·설치 | **코드 실행·지속 통로 배치** |
| C2 | **원격 명령·추가 도구 교환** |
| 목적 달성 | **이동·수집·유출·파괴** |
...
2. 유효 계정 경로는 **ATT&CK으로 행동 세분화**

### 쉽게 이해하기 (학습용)

- 각 단계에 제품 이름만 적지 않고 어떤 증거를 누가 보고 어디서 차단할지 책임을 연결한다.
- 전달·설치가 생략되는 유효 계정 공격은 ATT&CK 기법으로 세부 행동과 탐지 데이터를 보완한다.

## Ⅶ. 결론

- 공격 흐름·조기 차단은 **킬체인**, 세부 행동은 **ATT&CK**
