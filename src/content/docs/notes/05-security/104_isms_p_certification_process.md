...
- 정의/개념: **ISMS-P 인증 심사**는 관리체계의 운영 적합성을 독립적으로 심사•의결하는 절차이다.
- 배경/필요성: 내부 자체 점검만으로는 통제의 **실제 작동•지속성 독립 입증하기 어렵다**.
...
- 문서•현장 기반 **운영 증적 심사**가 핵심이다.
- 결함 원인 시정과 **이행 증거 확인**이 핵심이다.
- 3년 유효기간 중 **매년 1회 이상 사후심사**가 핵심이다.
...
2. **결함 원인 시정•증적 생성**: 보완조치의 이행 근거를 준비한다.
3. **시정 확인•최종 결과 작성**: 적합성•결함•시정 효과를 판정한다.
4. **인증 심의•의결**: 심사 결과에 따른 인증 여부를 결정한다.
...
- 최초 취득은 **최초심사**, 유효기간 중은 **사후심사**, 만료 전은 **갱신심사**를 수행한다.
