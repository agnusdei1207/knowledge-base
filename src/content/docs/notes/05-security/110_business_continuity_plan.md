...
- **배경/필요성**: IT 시스템 복구만으로는 인력·시설·공급망이 얽힌 핵심 업무의 목표 시간 내 복구를 보장하기 어렵다
...
1. 금융기관이 핵심 결제 업무의 RTO·RPO에 맞춰 격리 백업과 대체 환경을 구성하고 실제 전환·복귀 훈련으로 복구 시간을 검증한다.
...
- 핵심 업무의 중단 피해를 허용 범위로 제한하기 위해 BIA·RTO·RPO·자원 의존성·공급자 복구 능력을 검토하여, BCP와 DRP를 수립하고 실제 전환·복귀 훈련으로 검증해야 한다.
