...
| 절차 | 설명 |
|:---|:---|
| 핵심 서비스·자산 범위화 | 업무 중요도·책임자를 정의 |
| 취약점·구성·권한 발견 | 내외부 공격 노출을 식별 |
| 악용·경로·영향 우선화 | KEV·EPSS·업무 문맥 결합 |
| 공격 경로 검증·조치 | 안전한 재현 후 담당자 동원 |
| 잔여 노출 재검증 | 조치 효과·재발 여부 확인 |
...
- **실제악용성·공격경로·업무영향**으로 CTEM 조치순위를 결정한다.
