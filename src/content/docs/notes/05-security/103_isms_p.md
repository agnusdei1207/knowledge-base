...
- 정의/개념: **ISMS-P**는 정보보호와 개인정보보호 요구사항을 함께 심사하는 통합 관리체계 인증이다.
- 배경/필요성: 분리된 보안•개인정보 점검으로는 서비스 위험과 **처리 책임 연결하기 어렵다**.
...
- **운영 증적**: 정책과 통제가 실제 작동했음을 보여 주는 로그•승인•점검•시정 기록한다.
- **3개 영역**은 관리체계 수립•운영, 보호대책, 개인정보 처리단계의 심사 구분이다.
- **102개 기준**은 16개 관리체계, 64개 보호대책, 22개 개인정보 요구사항이다.

</details>

- 3개 영역•102개 기준의 **통합 심사**가 핵심이다.
- 위험평가 기반 **관리•물리•기술 통제**가 핵심이다.
- 로그•승인•점검 기록 기반 **운영 증적**이 핵심이다.
...
4. **운영 증적•심사 자료 구성**: 서면•현장심사용 통제 근거를 정리한다.
5. **발견사항 원인•시정 결정**: 결함 원인 제거와 통제를 갱신한다.
...
- 정보보호 통제는 **ISMS**, 개인정보 처리단계 포함 시 **ISMS-P**을 선택한다.
