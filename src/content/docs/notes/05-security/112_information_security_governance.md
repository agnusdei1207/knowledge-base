...
- 정의/개념: **정보보호 거버넌스**는 경영진이 사업 목표와 위험수용 기준에 따라 보안을 평가•지시•감시하고 책임•성과를 소통하는 의사결정 체계이다.
- 배경/필요성: 보안 조직의 통제 운영만으로는 사업 위험의 수용•투자 책임을 결정할 수 없다.
...
- 승인•실행•감사의 책임과 권한을 분리한다.
- **위험 허용 수준**을 경영진이 승인하고 **독립 보증**으로 결과를 확인한다.
...
- **사업•보안 위험 평가**: 사업 영향과 법적 요구를 분석해 경영 의사결정 대상을 정하는 단계이다.
- **방향•위험 허용 수준 승인**: 보안 목표•수용 한계•우선순위를 경영진이 승인하는 단계이다.
- **처리•예산•책임 배정**: 통제•자원과 실행 책임자를 운영조직에 지정하는 단계이다.
- **성과•준수 증적 생성**: 지표•통제 효과•준수 근거를 기록하는 단계이다.
- **개선 방향•우선순위 결정**: 감사 결과를 바탕으로 전략과 투자를 조정하는 단계이다.
...
1. **사업•보안 위험 평가**: 사업 영향•법적 요구를 평가한다.
2. **방향•위험 허용 수준 승인**: 목표•수용 한계•우선순위를 승인한다.
3. **처리•예산•책임 배정**: **위험 소유자**와 **CISO**에게 통제•자원•책임을 배정한다.
4. **성과•준수 증적 생성**: 지표•통제 효과•준수 근거를 기록한다.
5. **개선 방향•우선순위 결정**: 감사 결과 기반 전략•투자를 조정한다.
...
- **거버넌스**: 위험•투자•책임의 방향을 승인하고 성과를 감독하는 활동이다.
- **관리**: 거버넌스 방향에 따라 통제를 계획•구축•운영•점검하는 활동이다.
...
- **추적 가능한 위험 수용**을 위해 위험 수용•투자는 **거버넌스**, 통제 계획•운영은 **관리**, 효과 확인은 **독립 보증**으로 구분한다.
