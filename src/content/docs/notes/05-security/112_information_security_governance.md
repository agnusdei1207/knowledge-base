...
- 배경/필요성: 보안 조직의 통제 운영만으로는 사업 위험의 **수용•투자 책임 결정할 수 없다**.
...
- 사업 목표•법적 요구의 **보안 전략 연계**가 핵심이다.
- 승인•실행•감사의 **책임•권한 분리**가 핵심이다.
- 성과지표•독립 보증의 **경영진 감독**이 핵심이다.
...
3. **처리•예산•책임 배정**: 통제•자원•책임자를 운영조직에 지정한다.
...
- 위험 수용•투자는 **거버넌스**, 통제 계획•운영은 **관리**, 효과는 **독립 보증**이 핵심이다.
