...
- 정의: 매체의 **비트 단위 복제·해시 동일성 검증**
- 목적: 비할당 영역 보존과 **원본 무변경 입증**
...
| 5. 분석 사본·취급 이력 발급 | 사본 인계·접근 이력 기록 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 증거 획득·보존 | **ISO/IEC 27037:2012 적용** | 원본·사본 신뢰성 |
...
- **쓰기 방지·해시·오류·취급 이력**으로 이미지 신뢰를 결정한다.
