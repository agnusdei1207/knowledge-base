...
- **인공지능(Artificial Intelligence, AI)**: 데이터에서 패턴을 학습하여 콘텐츠를 생성하거나 판단하는 기술이다.
...
1. 생성형 AI 이미지 플랫폼에서 워터마크를 삽입하고 압축·캡처 후 검출률과 정상 이미지 오탐률을 함께 측정한다.
...
- 생성 콘텐츠의 출처 식별과 오용 추적을 위해 품질 영향·변형 강건성·검출률·오탐률을 검토하여, 워터마크를 출처 서명·메타데이터와 함께 보조 증거로 활용해야 한다.
