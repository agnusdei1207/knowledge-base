...
```text
 [내부•외부 원천] -- [정제•보강] -- [분석•산출물] -- [배포•피드백]
                                          \              /
                                         [정보 요구•소비자]
```

선의 의미: 내•외부 원천의 정제•보강 영역과 분석•배포 영역을 연결하고, 소비자의 정보 요구와 피드백이 분석 및 배포 영역에 결합되는 정적 CTI 운영 구조
...
1. **정규화•중복 제거**: 원천별 형식 통일과 중복 지표 병합
2. **신뢰도•수명 평가**: 출처•관측 시점•근거 검증
3. **맥락 분석•산출물 생성**: 자산•TTP•확신 수준 연결
