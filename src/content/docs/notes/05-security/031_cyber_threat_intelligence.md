...
- 정의/개념: 단순 **침해 지표(Indicator of Compromise, IoC)**에 공격자•TTP•신뢰도 및 자산 맥락을 결합하여 방어 의사결정을 지원하는 위협 정보.
- 배경/필요성: 출처 및 관측 시점이 부재한 단편 지표 수집의 한계 극복 및 차단•조사 우선순위 산정.
...
- 위협 데이터 정구화•맥락화 기반의 전술•운영•전략 계층별 입체적 차별 대응 체계 수립 필수.
