...
- 정의/개념: 단순 **침해 지표(IoC)**에 공격자•TTP•신뢰도 및 자산 맥락을 결합하여 방어 의사결정을 지원하는 위협 정보.
...
- 관측 시점•유효기간•철회 상태에 기반한 지표 라이프사이클 관리.
...
- **피드백(Feedback Loop)**: 배포된 정보가 탐지•차단•헌팅에 미친 실효성을 평가하여 분석 파이프라인에 재반영하는 절차에 해당함.
