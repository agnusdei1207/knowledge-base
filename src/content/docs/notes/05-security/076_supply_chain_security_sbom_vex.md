...
- 정의: 개발·유통 전 과정의 **출처·무결성 보호**
- 기존 한계: 전이 의존성의 **오염 범위 식별 곤란**
...
| 절차 | 설명 |
|:---|:---|
| 승인 소스·의존성 전달 | 출처·버전·해시 고정 |
| 서명 산출물·증적 등록 | 결과·빌드 출처 함께 저장 |
| SBOM·VEX·출처 전달 | 구성·영향·생산 정보 연결 |
| 공급망 증적 검증·배포 | 서명·정책 검증 후 승격 |
| 취약점 영향·조치 갱신 | 영향 제품·수정 상태 추적 |
