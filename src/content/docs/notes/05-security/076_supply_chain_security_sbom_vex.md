...
date: "2026-08-26T14:49:27+09:00"
tags:
  - "notes-security"
weight: 76
extra:
...
- 배경/필요성: 최종 산출물만 받으면 취약점이 공개될 때마다 전이 의존성을 역추적하는 비용이 배포본마다 되풀이되므로, 빌드 시점의 부품 목록과 악용성 판정·출처 증명을 산출물에 동봉해 배포 게이트가 역추적 대신 **SBOM·VEX 대조**만으로 판정하도록 옮긴 것
...
- 부품 위험은 **SBOM·VEX**, 빌드 변조는 **출처·서명**으로 차단
