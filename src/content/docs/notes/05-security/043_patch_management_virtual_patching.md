...
1. **영향 자산·악용 경로 식별**: 버전·노출·악용 여부 확인
2. **노출·변경 위험 평가**: 심각도·중단·호환성 분석
3. **임시 통제·단계 배포**: 가상 패치 후 시범·확대
4. **설치·차단 효과 확인**: 버전과 공격 경로 재검증
5. **예외 추적·임시 통제 회수**: 미적용 사유와 만료 관리
