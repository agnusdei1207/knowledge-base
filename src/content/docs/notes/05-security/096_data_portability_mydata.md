...
1. **목적·항목·수신자 지정**: 전송 범위·주기·종료 설정
2. **본인·수신자 적격성 검증**: 요청자·기관·시설 기준 확인
3. **법정 대상 표준 암호전송**: 예외 제외·기계 판독 전달
4. **수신·이용·처리 결과 제공**: 목적 내 이용·결과 통지
5. **이력·철회·중단 기록**: 전송 요구·거절·종료 감사
