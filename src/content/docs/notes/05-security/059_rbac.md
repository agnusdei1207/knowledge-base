...
date: "2026-08-05T10:08:00+09:00"
tags:
  - "notes-security"
weight: 59
extra:
...
1. **사용자•역할 배정 검증**: 현재 주체가 보유한 역할인지 확인
2. **동적 직무분리 검증**: 한 세션의 상충 역할 동시 활성화 차단
3. **역할 계층•권한 해석**: 직접•상속 권한을 활성 역할에서 계산
4. **자원•행위 인가 판정**: 요청 대상•동작과 역할 권한 대조
