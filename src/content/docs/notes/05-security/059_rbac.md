...
- **NIST SP 800-53 Rev. 5**: 계정·접근권한의 승인·검토·회수 등 보안 통제 요구를 제시한다.
...
- **기본·계층·제약 RBAC 선택**: 단순 직무 매핑, 공통 권한 상속, 상충 업무 제한 중 필요한 역할 구조에 맞춘 판단이다.

</details>

- 단순 직무는 **기본 RBAC**, 공통 권한 상속은 **계층 RBAC**, 상충 업무는 **제약 RBAC** 선택
