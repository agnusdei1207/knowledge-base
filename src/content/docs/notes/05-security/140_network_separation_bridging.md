...
1. **승인된 방향·자료·목적지 확인**: 허용 범위 판정
2. **악성·민감정보·CDR 검사**: 차단·무해화 결정
3. **대상·순서·해시 전송 자료 구성**: 무결성 정보 생성
4. **수신 순서·해시·무결성 검증**: 감사 증적 기록

#### 한줄 요약

- 승인·검사·수신 결과로 **사고 흐름 재구성**
