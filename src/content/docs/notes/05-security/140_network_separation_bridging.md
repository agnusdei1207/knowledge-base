...
- 정의/개념: **망분리·망연계**는 보안영역 간 직접 통신을 차단하고 승인된 정보만 검사·중계·감사해 전달하는 **망 경계 통제 체계**
...
- **CDR·DLP**: 실행 요소를 제거해 파일을 재구성하는 기술과 민감정보 유출을 탐지·차단하는 통제이다.
...
- **NIST SP 800-53 AC-4·SC-7**: 정보 흐름 집행과 통신 경계 보호를 다루는 통제이다.
