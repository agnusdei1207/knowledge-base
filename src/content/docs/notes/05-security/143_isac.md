...
- 한 기관의 공격 흔적을 산업 전체가 더 빨리 탐지•대응할 수 있는 지식으로 만듦이 핵심이다.
...
- 많이 공유하기보다 신뢰할 수 있는 회원에게 필요한 범위와 책임을 붙여 공유하는 것이 핵심이다.
...
- 분석 허브가 회원 정보를 산업 맥락으로 보강해 제한 배포하고 현장 결과를 다시 반영하는 것이 핵심이다.
...
- **1. 출처•공유조건 검증**: **출처•공유조건 검증**으로 제공기관•근거•시점을 확인한다.
- **2. TLP•비식별•법적근거 확인**: **TLP•비식별•법적근거 확인**으로 수신자를 제한한다.
- **3. 신뢰도•산업 영향•시효 분석**: **신뢰도•산업 영향•시효 분석**으로 IoC•TTP를 자산에 연결한다.
- **4. STIX•TAXII 배포객체 생성**: **REST** 기반의 **STIX•TAXII 배포객체 생성**으로 표준화한다.
- **5. 품질•유효상태 갱신**: **품질•유효상태 갱신** 결과를 회원 **CSIRT**와 공유한다.

#### 한줄 요약

- 공유 후 적중•오탐•철회 결과까지 되돌려 정보의 신뢰도와 유효기간을 갱신하는 것이 핵심이다.
