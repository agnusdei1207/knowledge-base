...
date: "2026-08-26T15:21:10+09:00"
tags:
  - "notes-security"
weight: 143
extra:
...
- 배경/필요성: 같은 공격을 회원사가 저마다 홀로 겪으면 최초 피해 비용이 기관 수만큼 반복되므로, 침해 지표를 비식별화해 **STIX/TAXII로 공유**하는 산업별 중계 계층을 두어 한 곳의 사고를 나머지 기관의 선행 지표로 전환한 것
...
- 산업 공통 위협은 **ISAC**으로 공유하고 **TLP** 범위 적용
