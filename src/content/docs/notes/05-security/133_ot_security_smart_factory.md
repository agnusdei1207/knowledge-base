...
- **분산 제어 시스템(Distributed Control System, DCS)**: 공정별 제어기를 분산 배치하고 중앙에서 감시하는 시스템이다.
- **산업 자동화·제어 시스템(Industrial Automation and Control System, IACS)**: 산업 공정을 계측·제어하는 장치·시스템의 집합이다.
- **목표 보안수준(Target Security Level, SL-T)**: 위험평가로 정한 영역·통로의 목표 보호 수준이다.
...
- **NIST SP 800-82 Rev.4**: 2026년 의견 수렴을 시작한 차기 OT 보안 지침이다.

> **키워드:** 스마트팩토리 OT 보안 (OT Security Smart Factory)

## Ⅰ. 개요

- 정의/개념: 공정 안전을 우선해 제어 자산을 보호하는 **OT 보안 체계**
...
- **3. 영역·통로·SL-T 제안**: 위험에 따른 통신 경계와 목표 수준
