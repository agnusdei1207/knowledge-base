...
1. **사건·속성 등록**: 출처·속성을 이벤트로 등록
2. **분류·갤럭시 보강**: 문맥·취급 태그를 부여
3. **상관·관측 품질 검증**: 중복·오탐·신뢰도를 확인
4. **TLP·공유그룹 게시**: 배포 경계·대상을 설정
5. **적중·오탐 결과 환류**: 소비 결과로 지표를 갱신
