...
- 정의/개념: **CTI** 사건•지표•관측 정보를 구조화하여 상관 분석하고 권한별 공유를 통제하는 오픈소스 플랫폼.
- 배경/필요성: 단편 지표 수집의 한계 극복 및 사건 맥락 관리와 통제된 조직 간 공유 체계 구현.
...
- **응용 프로그래밍 인터페이스(Application Programming Interface, API)**: external 보안 장비 및 SIEM/SOAR과의 자동화 연동을 위한 RESTful 규약에 해당함.
