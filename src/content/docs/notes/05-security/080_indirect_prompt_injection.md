...
date: "2026-08-26T14:50:33+09:00"
tags:
  - "notes-security"
weight: 80
extra:
...
- 배경/필요성: RAG가 끌어온 외부 문서는 사용자가 읽지 않은 채 문맥에 올라가 사용자 권한을 그대로 물려받으므로, 검색 데이터를 지시어와 태그로 격리하고 실행·유출 판단을 **Dual-LLM과 Egress 통제**라는 별도 계층으로 옮긴 것
...
- 외부 문서는 **Dual-LLM**으로 격리하고 실행은 **PEP·Egress** 통제
