...
- 정의/개념: 외부 콘텐츠의 **모델 행동 교란 공격**
- 배경/필요성: 외부 데이터·신뢰 지시의 **분리 불완전**
...
1. **자료 기반 요청·신원 수집**: 질의·사용자 권한 확인
2. **ACL·출처 적용 문맥 전달**: 허용 문서만 출처와 제공
3. **응답·도구 제안**: 모델은 실행 없이 제안
4. **고위험 행동 재승인**: 대상·내용·영향 확인
5. **제한 도구 실행·기록**: 최소 권한 집행·우회 감시
