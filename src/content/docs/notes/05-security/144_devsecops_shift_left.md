...
- **개발·보안·운영(Development, Security, and Operations, DevSecOps)**: '데브섹옵스'로 읽고 세 역할을 합친 표기로 보안 책임·자동화·피드백의 공동 운영을 표시
...
- 제품팀이 보안 위험을 소유하고 지원한다.
- 위험에 맞춰 자동 검사를 파이프라인에 배치한다.
- 코드·의존성·IaC·컨테이너 검증한다.
- 운영 사고 결과를 정책·백로그에 반영한다.
### 쉽게 이해하기 (학습용)
