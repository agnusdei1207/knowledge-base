...
- 정의: 위험 **식별·분석·평가**로 처리 순위 결정
- 목적: 일관된 기준으로 **보안 자원 우선 배분**
...
| 2. 자산·위협·취약점 식별 | 업무 의존성과 시나리오 연결 |
| 3. 가능성·결과 위험 분석 | 통제 상태·불확실성 반영 |
| 4. 수용기준 비교·위험 평가 | 처리 필요성과 순위 결정 |
...
| 평가 기법 선택 | **IEC 31010:2019 참조** | 상황별 기법 적합성 |
...
- **업무 영향·가능성·불확실성**으로 위험 처리 순위를 결정한다.
