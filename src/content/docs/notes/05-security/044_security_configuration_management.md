...
1. **자산·환경별 기준선 승인**: 보안·가용성 요구 버전화
2. **정책 코드·배포 전 검사**: 위반 설정을 변경 전에 차단
3. **실행 상태·기준 편차 탐지**: 수동·긴급 변경 지속 확인
4. **영향 검증·복구·예외 처리**: 롤백·보상 통제·만료일 관리
5. **반복 원인·기준선 개선**: 운영 결과를 정책에 반영
