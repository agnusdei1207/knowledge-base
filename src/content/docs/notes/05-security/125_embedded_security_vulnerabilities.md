...
- **JTAG·UART**: 칩 디버깅과 직렬 진단에 쓰이며 노출 시 로컬 공격 경로가 되는 인터페이스이다.
...
- **ETSI EN 303 645**: 소비자 IoT 제품의 기본 사이버보안 요구사항을 규정한 유럽표준이다.
- **IEC 62443-4-1·NIST IR 8259**: 산업 제품의 보안 개발 생명주기와 IoT 장치 보안 기준선을 다루는 지침이다.
