...
date: "2026-08-05T17:48:46+09:00"
tags:
  - "notes-security"
weight: 92
extra:
...
- 정의/개념: **딥페이크 탐지** 는 합성 흔적•생체•출처 증거로 조작 가능성을 판정하는 기술
...
선의 의미: 정규화한 입력을 합성 흔적, 생체•모달, 출처의 독립 검증 영역에 연결하고 각 증거를 위험 정책 엔진에서 결합하는 정적 다중 증거 구조
