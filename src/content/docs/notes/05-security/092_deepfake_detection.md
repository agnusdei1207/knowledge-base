...
- 정의: 합성 흔적·생체·출처의 **조작 위험 판정**
- 기존 한계: 압축·미지 생성기의 **단일 탐지 성능 저하**
...
| 절차 | 설명 |
|:---|:---|
| 채널·코덱 확인 | 저장·실시간 입력 조건 구분 |
| 합성·생체·모달 분석 | 흔적·반응·동기 점수 산출 |
| 탐지 점수·출처 조회 | 조작 가능성·이력 확인 |
| 서명 이력·증거 결합 | 증거 신뢰도·오류 비용 반영 |
| 허용·경고·추가 인증 | 위험 수준별 조치 적용 |

> 요약: 탐지 점수와 생체·출처 증거를 결합한다.
