...
- 정의: 구현 결함을 예방하는 **코드·검토·검증 규칙**
- 기존 한계: 임의 구현의 **취약점 반복·품질 편차**
...
| 절차 | 설명 |
|:---|:---|
| 위협·반복 결함 규칙 정의 | 안전 기본값·대체 API 결정 |
| 안전 구현·업무 논리 검토 | 규칙 적용과 권한·위험 경로를 함께 검토 |
| SAST·DAST 자동 검증 | 취약 패턴·실행 동작 검사 |
| 배포 판정·예외 승인 | 미달 차단·보상 통제 기록 |
| 만료·운영 결함 환류 | 예외·사고를 규칙에 반영 |
