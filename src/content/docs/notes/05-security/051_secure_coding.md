...
date: "2026-07-31T01:58:42+09:00"
tags:
  - "notes-security"
weight: 51
extra:
...
sequenceDiagram
    ...
    배포게이트->>예외관리자: 4. 검사·배포 판정
    예외관리자->>가이드소유자: 5. 예외·운영 결함
```
...
5. **예외·운영 결함**: 보상 통제·만료일·운영 사고를 규칙 개선에 제공
...
| 검사 우회와 만료 없는 예외로 기술 부채 증가 | **배포 게이트·만료일** 적용 | 반복 결함과 **기술 부채** 억제 |
