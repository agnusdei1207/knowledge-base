...
date: "2026-08-05T09:36:00+09:00"
tags:
  - "notes-security"
weight: 51
extra:
...
1. **위협•반복 결함 규칙화**: 안전 기본값과 대체 API 기준 정의
2. **안전 API•기본값 구현**: 입력•권한•암호•오류 통제 적용
3. **업무 권한•복합 논리 검토**: 자동 검사가 놓친 위험 경로 확인
4. **SAST•DAST 배포 판정**: 자동 검사 기준 미달 변경 차단
