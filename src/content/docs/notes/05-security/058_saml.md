...
1. SP는 **서명된 Assertion만 세션에 사용**
2. 응답 ID를 저장해 **SAML 응답 재사용 거부**

### 쉽게 이해하기 (학습용)

- 세션 생성에는 서명 검증을 통과한 정확한 Assertion 요소만 사용한다.
- 사용한 응답 ID를 기록해 같은 SAML 응답으로 다시 로그인하지 못하게 한다.

## Ⅶ. 결론

- 기업 웹 연합은 **SAML**, 요청 결속은 **SP 시작 방식**
