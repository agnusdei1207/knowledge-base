...
1. **서비스 접근·요청 ID 생성**: SP가 미인증 접근을 식별
2. **목적지·반환 주소 인증 요청**: 요청 ID·수신 경로를 결속
3. **사용자 인증·주장 서명**: IdP가 자격·속성을 확인
4. **대상·시간·요청 결속 응답**: 서명 주장·조건을 전달
5. **서명·조건·중복 검증**: 래핑·오수신·재전송 차단
