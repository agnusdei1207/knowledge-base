...
- 정의: 사람·자동화 요청을 구별하는 **보조 통제**
- 기존 한계: 대량 가입·스팸·로그인의 **자동 남용**
...
| 절차 | 설명 |
|:---|:---|
| 가입·로그인·결제 요청 | 공개 기능의 업무 시도 |
| 계정·기기·행위 위험 평가 | 자동화 가능성·규모 산출 |
| 고위험 적응형 도전 제시 | 임계값에 따라 과제 요구 |
| 문제 응답·단기 토큰 발급 | 풀이 결과·맥락을 결속 |
| 목적·만료·재사용 결합검증 | 서버에서 토큰·업무 판정 |
