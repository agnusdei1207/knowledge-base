...
- **정의**: 사람과 자동화 요청을 구별하는 보조 통제
- **배경/필요성**: 자동화된 대량 가입·스팸·로그인 공격 억제
...
1. 대량 계정 가입에 **CAPTCHA와 호출률 제한 적용**
...
- 자동화된 서비스 남용 비용을 높이기 위해 공격 규모·정상 사용자 실패율·접근성·우회 비용을 검토하여, CAPTCHA를 호출률 제한과 강한 인증의 보조 통제로 활용해야 한다.
