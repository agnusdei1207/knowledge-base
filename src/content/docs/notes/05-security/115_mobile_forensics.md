...
- 정의: 모바일·앱·클라우드 증거의 **적법한 획득·분석**
- 목적: 잠금·암호화·원격 변경의 **증거 소실 방지**
...
| 절차 | 설명 |
|:---|:---|
| 1. 권한·전원·BFU·AFU 기록 | 근거·화면·통신·충전 상태 기록 |
| 2. 격리·보존 전략 결정 | 원격 명령·키·배터리 위험 비교 |
| 3. 논리·파일·물리 추출 | 최소 변경 방식부터 획득 |
| 4. 해시·앱·시간 교차 검증 | 도구 결과·DB·타임스탬프 분석 |
| 5. 연계 증거·한계 보고 | 클라우드 자료·누락 범위 기록 |
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 모바일 포렌식 절차 | **NIST SP 800-101 Rev.1 적용** | 획득·분석 일관성 |
| 디지털 증거 취급 | **ISO/IEC 27037:2012 적용** | 보존·인계 신뢰성 |
...
- **BFU·AFU·원격 변경·추출 한계**로 보존 전략을 결정한다.
