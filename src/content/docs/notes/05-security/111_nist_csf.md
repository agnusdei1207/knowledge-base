...
- **Implementation Tier(Implementation Tier)**: 조직의 사이버보안 위험 관리 관행의 정교함과 이행 수준을 4단계로 평가는 평가 도구.
...
2. **현재 프로파일•증적 구성**: 달성한 CSF 결과와 근거 구성.
3. **목표 프로파일•격차 분석**: **현재•목표 프로파일**의 차이 분석.
4. **개선 계획•성과지표 수립**: 위험•비용•효과 기반 실행안 수립.
5. **투자•개선 우선순위 결정**: 성과 평가에 따른 자원 배분 결정.
