...
- 수리센터의 RMA 장치는 작업자와 승인된 진단 명령을 인증한 경우에만 JTAG를 임시 개방하고 작업 종료 후 권한을 폐기해 다시 잠근다.

## Ⅶ. 결론

- 디버그 포트를 통한 펌웨어·비밀 탈취를 막기 위해 장치 수명 상태·작업자 신원·명령 범위·재잠금·감사를 검토하여, 개발성과 수리 필요에 맞게 JTAG 접근을 통제해야 한다.
