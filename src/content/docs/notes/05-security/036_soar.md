...
| 핵심 특징 | 분석가 전 과정 실행 | 자동 보강 후 사람 승인 | 조건 충족 시 자동 조치 |
...
- 반복 대응의 지연과 편차를 극복하기 위해 경보 신뢰도·조치 영향·가역성·승인 필요성을 검토하여, 안전하게 통제할 수 있는 절차부터 SOAR로 자동화해야 한다.
