...
- 정의/개념: **SOC**는 사람•절차•기술을 통합해 보안 이벤트를 **상시 탐지•대응**하는 조직이다.
- 배경/필요성: 분산 경보만으로는 사건별 **조치 책임•복구 연계할 수 없다**.
...
- 24시간 **탐지•분석•대응 운영**이 핵심이다.
- 역할•승인•에스컬레이션의 **책임 체계**가 핵심이다.
- **SIEM•SOAR**와 **EDR•NDR** 기반 통합 관제가 핵심이다.
...
- 문맥•권한 중시는 **내부 SOC**, 역량 결합은 **공동 SOC**, 인력 부족은 **외부 위탁**이 핵심이다.
