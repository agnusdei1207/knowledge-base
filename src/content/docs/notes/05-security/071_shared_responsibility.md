...
- 정의: 클라우드 계층별 **제공자·고객 책임 분담**
- 기존 한계: 제공자 전담 오해의 **통제 책임 공백**
...
| 절차 | 설명 |
|:---|:---|
| 서비스 모델·계약 경계 확인 | 기능·SLA·제외 범위 식별 |
| 제공자 통제·증적 전달 | 하부 계층 보호 근거 제공 |
| 고객 통제·책임 지정 | 계정·데이터·설정 소유자 지정 |
| RACI·검증 방법 매핑 | 통제별 수행·승인·증거 확정 |
| 공백·중복·사고 절차 개선 | 책임표·설정·협업 절차 갱신 |
