...
- **내부자 위협(Insider Threat)**: “인사이더 스렛”으로 읽으며 조직의 신뢰와 접근 권한이 고의·실수·계정 탈취로 피해를 일으킬 위험
...
1. 고권한 세션을 기록하고 긴급·개인정보 권한을 제한
2. 직무 변동 시 계정·기기·자료 접근권한 회수
3. 확정 위험·오탐 결과로 행위 기준선 조정
