...
| 절차 | 설명 |
|:---|:---|
| 인사 변동·권한 조정 | 입사·이동·휴직·퇴사에 맞춰 접근권한 변경 |
| 행위 위험 분석 | 권한·업무 기준선과 현재 행위의 차이로 조사 대상 선별 |
| 적법성·조사 범위 승인 | 목적·비례성·법적 요건을 확인하고 증거·기간·접근자 지정 |
| 증거 보존·비례 대응 | 승인 범위의 증거를 보존하고 위험에 맞춰 권한 제한 |
| 판정 결과 환류 | 오탐·확정 결과로 행위 기준과 대응 조건 조정 |
