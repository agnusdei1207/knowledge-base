...
- 배경/필요성: 외부 공격 시그니처만으로는 정상 권한의 **고의•실수•탈취 구분하기 어렵다**.
...
- 고의•실수•계정 탈취의 **원인별 대응**이 핵심이다.
- 보안•인사•법무의 **협업•적법 조사**가 핵심이다.
...
4. **적법 범위•비례 대응 판정**: 증거•기간•접근 범위를 판정한다.
...
- 고의는 **권한 제한•증거 보존**, 실수는 **교육•절차 개선**, 탈취 계정은 **세션 회수**가 핵심이다.
