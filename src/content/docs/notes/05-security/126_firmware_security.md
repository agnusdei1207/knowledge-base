...
- 정의/개념: 하드웨어와 운영체제 사이의 실행•갱신 신뢰성을 보장하는 **펌웨어 보안** 수립.
- 배경/필요성: 운영체제 보안만으로는 하위 펌웨어의 지속성 공격 차단 불가에 따른 펌웨어 보안 필요성 증대.
...
- **1. 펌웨어 이미지•매니페스트 서명**: **펌웨어 이미지•매니페스트 서명** 수행 시 **SBOM**•대상•버전•정책을 바인딩하여 결합.
- **2. 대상•버전•해시•서명 검증**: **대상•버전•해시•서명 검증**을 통해 장치 정책과 배포물의 일치 여부 확인.
- **3. 설치•부팅•복구 판정**: **설치•부팅•복구 판정**을 통한 원자적 설치 및 부팅 허용 여부 판정.
