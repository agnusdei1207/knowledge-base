...
- 정의/개념: **SIEM**의 데이터 탐지•상관분석 기능과 **SOAR**의 이종 연계•자동 대응 기능을 상호 연동한 관제 구조.
- 배경/필요성: 단일 솔루션 운영의 한계 극복 및 탐지-조치 간 병목 현상 해소를 통한 평균 대응 시간(MTTR) 단축.
...
- 인계 계약 명율화로 경보 데이터와 조치 티켓 간 이력 추적성을 확보함.
...
- SIEM 탐지 상관분석과 SOAR 플레이북 자동 대응 연계 기반 통합 보안관제 체계 구축 필수.
