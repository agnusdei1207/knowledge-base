...
- **글로벌 국경 간 개인정보보호 규칙(Global Cross-Border Privacy Rules, Global CBPR)**: 글로벌 시비피알로 읽고 영문 머리글자를 딴 표기이며, 컨트롤러의 개인정보보호 책임성을 인증
- **글로벌 프로세서 개인정보보호 인정(Global Privacy Recognition for Processors, Global PRP)**: 글로벌 피알피로 읽고 영문 머리글자를 딴 표기이며, 프로세서의 개인정보보호 책임성을 인증
...
1. SaaS 이전의 **인증 범위·법적 근거 대조**
2. 해외 지원센터의 **지역·서비스 재심사**
