...
- 정의/개념: **CA** 는 신청 주체와 공개키의 관계를 검증하고 인증서를 전자서명하여 발급•갱신•폐지하는 PKI 신뢰기관
...
| CA 계층 | 신뢰 역할 | 운영 원칙 |
|:---|:---|:---|
| **루트 CA** | 하위 CA 서명에 쓰는 **최상위 신뢰 기준점** | 오프라인 보관•다중 승인•사용 최소화 |
| **중간 CA** | 조직•용도별 **발급 권한 위임** | 정책 경계•경로 길이•사고 범위 분리 |
| **발급 CA** | 가입자 **인증서 발급•갱신•폐지** | 온라인 가용성•HSM 키 보호•오발급 감시 |
