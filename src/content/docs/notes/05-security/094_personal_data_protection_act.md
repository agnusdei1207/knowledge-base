...
- **정보주체**는 자신의 개인정보에 관한 권리를 행사하는 개인이다.
- **개인정보처리자**는 업무 목적으로 개인정보파일을 운용하는 주체다.

</details>

- 정의/개념: **개인정보 보호법**은 처리 전주기의 근거•책임•정보주체 권리를 규율하는 일반법이다.
- 배경/필요성: 수집 중심 관리의 **이전•복제•파기 공백**이 발생한다.
...
- **처리 정당성**은 적법한 근거와 명확한 목적에 필요한 최소 정보만 처리하는 원칙이다.
- **목적 제한**은 수집한 개인정보를 정한 목적 밖으로 임의 이용하지 않는 원칙이다.
- **안전조치**는 개인정보의 유출•변조•훼손을 방지하는 관리적•기술적•물리적 통제다.
- **보유기간**은 처리 목적이나 법적 의무가 개인정보 보관을 허용하는 기간이다.

</details>

- 목적•근거•최소수집의 **처리 정당성**이 핵심이다.
- 제공•위탁 구분의 **책임 경계**가 핵심이다.
- 안전조치•권리•파기의 **수명주기 증적**이 핵심이다.
...
- **제3자 제공**은 수령자가 개인정보를 독립된 목적에 사용하는 이전 관계다.
- **처리 위탁**은 개인정보처리자의 업무 목적을 수탁자가 대신 수행하는 관계다.
- **원본 파기**는 보유 목적이 끝난 운영 개인정보를 복구할 수 없게 삭제하는 처리다.
- **복제본 파기**는 백업•로그 등 모든 개인정보 사본을 추적해 삭제하는 처리다.
...
3. **안전조치•보유 통제**: 접근 권한과 보유기간을 단계별을 적용한다.
4. **정보주체 권리 처리**: 열람•정정•정지 요구를 기한 내를 이행한다.
5. **보유 종료•파기 검증**: 파기 결과와 예외 보유 근거를 기록한다.
...
- **수집**은 정한 처리 목적에 필요한 개인정보를 적법한 근거로 얻는 처리다.
- **이용**은 수집한 개인정보를 정한 업무 목적 안에서 사용하는 처리다.
...
- **보호법 제15조**는 개인정보 수집•이용의 법적 근거와 범위를 규정한다.
- **보호법 제17조**는 개인정보의 제3자 제공 근거와 고지 사항을 규정한다.
- **보호법 제26조**는 개인정보 처리 위탁의 문서화•공개•감독 의무를 규정한다.
- **보호법 제21조**는 보유기간 종료와 목적 달성 뒤 개인정보 파기를 규정한다.
- **보호법 제29조**는 개인정보의 안전성 확보조치 의무를 규정한다.
...
- 처리 근거•책임•보유기간이 확인된 범위만 **수집•제공•위탁**이 핵심이다.
