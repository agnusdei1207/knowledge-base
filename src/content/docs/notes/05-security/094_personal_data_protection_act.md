...
1. **목적·근거·기간 고지**: 처리 전 법적 근거 확정
2. **최소 개인정보 수집·이용**: 필요 항목만 목적 내 처리
3. **제공·위탁 근거별 이전**: 고지·계약·수탁자 감독
4. **열람·정정·정지 요구**: 본인 확인·예외·결과 통지
5. **보유 종료·파기 증적**: 법정보존 외 원본·복제 삭제
