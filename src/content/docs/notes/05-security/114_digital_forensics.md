...
date: "2026-07-31T02:10:15+09:00"
tags:
  - "notes-security"
weight: 114
extra:
...
> **키워드:** 디지털 포렌식 — 증거 수집·체인 오브 커스터디 (Digital Forensics)

## Ⅰ. 개요

- 정의/개념: 디지털 증거의 **적법한 획득·보존·분석**
...
sequenceDiagram
  ...
  I->>A: 1. 조사 권한·범위 승인 요청
  A-->>I: 승인·제한 결정
  I->>T: 2. 증거 식별·현장 상태 기록
  I->>R: 3. 획득 증거·해시 봉인 전달
  R->>N: 4. 분석 사본·인계 기록 전달
  N->>R: 5. 분석 이력·파생 증거 보관 요청
  N-->>I: 재현 결과·한계 보고
```

**동작 원리**

- **1. 조사 권한·범위 승인 요청**: 근거·대상·기간·도구 검토 요청
- **2. 증거 식별·현장 상태 기록**: 장치·연결·시각·휘발성 판단
- **3. 획득 증거·해시 봉인 전달**: 쓰기 차단·비트 복제 후 원본 보관
- **4. 분석 사본·인계 기록 전달**: 검증된 사본과 연계보관 이력 제공
- **5. 분석 이력·파생 증거 보관 요청**: 도구·명령·산출물 보존 지시
