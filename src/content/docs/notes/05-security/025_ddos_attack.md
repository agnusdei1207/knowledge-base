...
date: "2026-08-05T17:05:09+09:00"
tags:
  - "notes-security"
weight: 25
extra:
...
- 정의/개념: **DDoS 공격** 은 다수의 분산 공격원이 대역폭•연결 상태•응용 자원을 고갈시켜 정상 사용자의 서비스 이용을 방해하는 **가용성 공격**
...
1. **고갈 자원 식별**: 회선•연결•응용 병목 판별
2. **계층별 완화 적용**: 병목 앞단에 대응 수단 배치
3. **정상 요청 SLI 검증**: 유지 또는 단계적 복귀 결정
