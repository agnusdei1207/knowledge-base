...
- 정의: 다계층 신호의 **상관·통합 대응 체계**
- 기존 한계: 분산 경보의 **공격 경로 단절**
...
| 절차 | 설명 |
|:---|:---|
| 다계층 신호 정규화 | 센서 필드·시각을 통일 |
| 엔티티·시간선 사건화 | 자산·계정·세션을 연결 |
| 공격 경로·영향 검증 | 원본 근거·업무 영향 확인 |
| 도메인 간 대응 실행 | 단말·신원·망 조치 수행 |
| 조치 결과·사건 갱신 | 성공·실패를 기록·환류 |
...
- **도메인범위·증거연결·조치영향**으로 XDR 도입을 결정한다.
