...
date: "2026-08-05T12:42:00+09:00"
tags:
  - notes-security
weight: 130
extra:
...
```text
                 ...
                 [시간•전력•EM•캐시 채널]
                    ...
                    [반복 입력•신호 수집]
                               |
                 [정렬•필터•누설 모델] -- [통계 검정•키 복구 검증]
```

선의 의미: 비밀 연산 표적의 구현 흔적을 관측 채널과 신호 수집 장치에 연결하고, 누설 모델 및 통계•키 복구 검증 환경을 결합한 정적 부채널 분석 구조
...
- **1. 부채널 누설 표본 수집**: 시간•전력•EM•캐시 반복 측정
- **2. 누설 흔적 정렬•필터링**: 측정 잡음을 줄여 분석 입력 생성
