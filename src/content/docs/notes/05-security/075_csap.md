...
- 정의: 클라우드 서비스의 **법정 보안인증 제도**
- 기존 한계: 공공 정보의 **위험별 통제 수준 부족**
- 근거: **클라우드컴퓨팅법 제23조의2**
...
| 절차 | 설명 |
|:---|:---|
| 유형·등급·인증 범위 신청 | 서비스·자산·조직 경계 확정 |
| 서면·현장·취약점 평가 | 기준 이행·통제 상태 점검 |
| 부적합 보완·결과 상정 | 원인 시정·보완 증적 제출 |
| 인증 심의·인증서 발급 | 적합성 결정·범위 명시 |
| 사후·갱신·유효성 확인 | 운영 변화·만료 상태 검증 |

> 요약: 범위별 통제를 평가·인증하고 운영 중 유효성을 관리한다.
