...
1. 공공기관이 도입할 SaaS의 **CSAP 인증 범위·유효성 확인**

### 쉽게 이해하기 (학습용)

- 공공기관은 계약하려는 SaaS의 서비스명·등급·데이터센터·유효기간이 실제 CSAP 인증서 범위와 일치하는지 대조한 뒤 도입한다.

## Ⅶ. 결론

- 공공기관의 클라우드 도입 위험을 줄이기 위해 인증 서비스명·등급·적용 범위·유효기간·중요 변경을 검토하여, 실제 이용 조건과 일치하는 CSAP 인증 서비스를 선택해야 한다.
