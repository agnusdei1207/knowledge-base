...
- 정의: 검증된 주체의 **승인 앱 전용 연결**
- 기존 한계: VPN의 **내부망 노출·측면 이동**
...
| 절차 | 설명 |
|:---|:---|
| 사용자·기기·대상 앱 요청 | 주체·상태·자원 맥락 제시 |
| 신원·기기·위험 정책 평가 | 허용 조건·재인증 판정 |
| 앱·행위·시간 제한 연결 | 지정 앱 전용 세션 중계 |
| 승인 세션·직접 경로 감시 | 우회 접속·행위를 추적 |
| 위험 변화·세션 재평가 | 조건 변경 시 제한·종료 |
