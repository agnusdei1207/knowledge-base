...
| 핵심 특징 | 앱·세션별 동적 연결 | 원격 장비의 내부망 연결 | 특정 웹 앱 요청 중계 |
...
- 원격 사용자에게 내부망 전체를 노출하는 한계를 극복하기 위해 사용자·기기·대상 앱·직접 우회 경로를 검토하여, 앱 단위 원격 접근에는 ZTNA를 선택해야 한다.
