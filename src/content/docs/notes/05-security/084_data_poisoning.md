...
1. 사용자 피드백의 **검토 후 재학습 반영**

### 쉽게 이해하기 (학습용)

- 스팸 분류기는 사용자 신고를 즉시 학습하지 않고 출처·중복·이상 분포를 검토한 승인 표본만 재학습 데이터에 넣어 집단 조작을 막는다.

## Ⅶ. 결론

- 오염 데이터가 모델 행동을 왜곡하는 위험을 줄이기 위해 데이터 출처·승인 절차·계보·표적 성능·영향 모델을 검토하여, 격리된 재학습과 복구 체계를 운영해야 한다.
