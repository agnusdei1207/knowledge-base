...
- **NIST SP 800-181 Rev.1**: 사이버보안 업무를 역할·과업·지식·기술로 기술하는 NICE 프레임워크 구조이다.
- **NICE 프레임워크 구성요소 v2.2.0**: 2026년 4월 공개된 최신 역할·과업·지식·기술 구성요소이다.

> **키워드:** 사이버 레인지 (Cyber Range, 가상 실전 훈련장)
