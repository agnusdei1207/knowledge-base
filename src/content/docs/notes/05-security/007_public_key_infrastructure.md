...
- **정의/개념**: 공개키와 주체를 인증서로 연결·운영하는 체계
- **배경/필요성**: 임의 생성 공개키의 소유자·용도 검증
...
| 판단 기준 | 공개 웹 PKI | 사설 조직 PKI |
|:---|:---|:---|
| 핵심 특징 | 공개 신뢰 저장소의 CA 사용 | 조직이 루트 CA와 정책 운영 |
| 적용 기준 | 불특정 사용자의 공개 서비스 | 관리 가능한 내부 장비·사용자 |
| 주요 위험 | 오발급 영향이 공개 사용자에 확산 | 루트 배포 누락 시 내부 연결 실패 |
