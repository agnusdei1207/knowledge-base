...
- 정의/개념: 공공 정보화사업의 계획•설계 단계에서 보안 요구와 보호대책을 확인하는 **국가정보원 보안성 검토**
...
sequenceDiagram
  ...
  A->>S: 보안성 검토 요청
  S->>N: 검토 자료•위임 근거 전달
  N->>N: 1. 사업 경계•위험•위임 근거 검토
  N->>A: 검토 의견 전달
  A->>A: 2. 보안 보완 의견•요구 확정
  A->>R: 확정 요구사항 전달
  R->>R: 3. RFP•계약 보안 조건 반영
  R->>I: 설계•검수 기준 전달
  I->>I: 4. 설계•구축•검수 증적 검증
  I-->>A: 이행 증적•잔여위험
```

**동작 원리**

- **1. 사업 경계•위험•위임 근거 검토**: 사업 유형•경계•정보 흐름 검토
- **2. 보안 보완 의견•요구 확정**: 망•자산•통제 공백의 개선 요구 확정
- **3. RFP•계약 보안 조건 반영**: 위험•법률별 보완사항을 발주 기준에 반영
- **4. 설계•구축•검수 증적 검증**: 요구사항 이행 결과와 잔여위험 검증
