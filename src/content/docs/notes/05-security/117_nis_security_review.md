...
- 정의/개념: 공공 정보화사업의 계획•설계 단계에서 보안 요구와 보호대책을 확인하는 **국가정보원 보안성 검토**이다.
- 배경/필요성: 구축 후 검토로는 계약에 빠진 **보안 요구의 이행•비용 통제하기 어렵다**.
...
- 사업 공고 전 **설계•보안대책 사전 검토**가 핵심이다.
- 데이터•망•인증•암호의 **위험 기반 검토**가 핵심이다.
- 검토 의견의 **RFP•설계•검수 추적**이 핵심이다.
...
2. **보안 보완 의견•요구 확정**: 망•자산•통제 공백의 개선 요구를 확정한다.
...
- 설계•RFP는 **보안성 검토**, 제품•버전•구성은 **보안적합성 검증**을 수행한다.
