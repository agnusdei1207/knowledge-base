...
- 정의: 승인 범위의 **공격 경로·영향 검증**
- 기존 한계: 자동 진단의 **복합 경로 누락**
...
| 절차 | 설명 |
|:---|:---|
| 목표·교전 규칙 승인 | 범위·기법·중단·통신 합의 |
| 정찰·공격 경로 설계 | 자산·신원·흐름을 분석 |
| 최소 영향 악용 검증 | 권한·이동·우회를 입증 |
| 증거 보존·잔존물 정리 | 근거 확보 후 계정·도구 제거 |
| 원인·영향·재시험 보고 | 개선 우선순위·검증 계획 전달 |
