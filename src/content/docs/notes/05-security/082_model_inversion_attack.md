...
- 정의: 출력 신호를 이용한 **학습 특징 복원 공격**
- 기존 한계: 과도한 점수·기울기의 **정보 노출**
...
| 절차 | 설명 |
|:---|:---|
| 목표·사전 정보 설정 | 복원 속성·입력 형태 정의 |
| 후보 입력 반복 질의 | 현재 후보를 모델에 제출 |
| 출력 신호 반환 | 점수·임베딩·기울기 제공 |
| 후보 최적화·수렴 | 목표 반응 방향으로 수정 |
| 유사성·식별성 판정 | 원본 근접도·노출 위험 평가 |

> 요약: 출력 신호를 역최적화해 학습 특징을 추정한다.
