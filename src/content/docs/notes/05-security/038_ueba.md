...
| 절차 | 설명 |
|:---|:---|
| 행위·엔티티 품질 검증 | 신원 연결·결측·시각 확인 |
| 개인·동료군 기준선 구성 | 정상 행동 범위를 모델링 |
| 편차·문맥 위험도 산출 | 자산·직무·시간을 결합 |
| 정탐·오탐 조사 판정 | 고위험 엔티티 근거 검증 |
| 기준선·임계값 보정 | 조사 결과로 모델 개선 |
...
- **기준선신뢰도·동료군·오탐비용**으로 UEBA 임계값을 결정한다.
