...
- 정의: AI 수명주기의 **통합 공격면 관리**
- 기존 한계: 모델·프롬프트·도구의 **고유 위험 미통제**
...
| 절차 | 설명 |
|:---|:---|
| 입력·권한 맥락 수집 | 사용자 입력·권한 확인 |
| 허용 자료 제한 검색 | ACL·검색 범위 적용 |
| 출처 표시 문맥 전달 | 외부 자료를 지침과 분리 |
| 응답·도구 제안 검증 | 내용·권한·민감도 검사 |
| 제한 출력·실행·기록 | 최소 권한 집행·이상 탐지 |
