...
1. **장치 신원·입력 일관성 검증**: 출처·시각·센서값 대조
2. **모델 추론·확신도 산정**: AI 추론 증거 기록
3. **허용 범위·안전 상태 결정**: 제어 한계 설정
4. **제한 제어·안전 전환 실행**: 안전 상태 전환

#### 한줄 요약

- 센서 충돌·저확신 시 **자동 제어 중단**
