...
- 정의: 클라우드의 **접근·데이터·위협 정책 중개**
- 기존 한계: 경계 보안의 **SaaS·데이터 가시성 부족**
...
| 절차 | 설명 |
|:---|:---|
| 로그인·업로드·공유 요청 | 사용자·대상·행위 제출 |
| 신원·기기·민감도 평가 | 요청 맥락·데이터 등급 결합 |
| 허용·차단·암호화·MFA 결정 | 위험별 보호 조치 선택 |
| 승인 작업 실시간 중계 | 허용 동작만 SaaS에 전달 |
| 저장 데이터·권한 사후 점검 | API로 파일·공유·위반 회수 |
