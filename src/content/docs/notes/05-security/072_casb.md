...
date: "2026-07-25T22:12:00+09:00"
tags:
  - "notes-security"
weight: 72
extra:
...
- **정의**: 클라우드 접근과 데이터 정책의 중개 체계
- **배경/필요성**: SaaS 사용·공유·반출·계정 행위
- **목적**: 그림자 IT와 데이터 유출 통제
...
| 주요 위험 | 방식별 사각지대 | 개별 동작 차단 불가 | 우회·지연·TLS 부담 | 호출량·반영 지연 |
