...
- 정의: 생체 표본·등록 템플릿의 **유사도 판정**
- 기존 한계: 비밀번호의 **탈취·공유·대리 사용**
...
| 절차 | 설명 |
|:---|:---|
| 지문·얼굴·홍채 표본 제시 | 센서에 원시 생체정보 입력 |
| 품질·제시 공격 검사 | 환경 품질·위조 여부 확인 |
| 통과 표본·특징 추출 | 비교용 템플릿으로 변환 |
| 등록 템플릿·유사도 비교 | 보호 저장값과 점수 산출 |
| 임계값 판정·대체 인증 | 수락·거부·보조 경로 선택 |
