...
1. 요청 본문은 **깊이·개수·크기를 계약으로 제한**
2. SQL 값은 **바인딩**, 정렬 열은 **허용 목록 매핑**

### 쉽게 이해하기 (학습용)

- 중첩 깊이와 항목 수를 제한해 파서·메모리 고갈을 막는다.
- 값은 SQL 구문과 분리하고 동적 열 이름은 승인된 목록에만 매핑한다.

## Ⅶ. 결론

- 값 적합성은 **검증**, 표현 통일은 **정규화**, 주입 방지는 **바인딩**
