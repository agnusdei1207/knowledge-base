...
- 정의/개념: RP 결속 공개키 인증 표준 **FIDO2/WebAuthn**
- 배경/필요성: 공유 비밀은 **유출•중간자 피싱**에 취약
...
- **도전값** 무결성 대조 및 **사용자 검증**, **사용자 존재**에 의한 물리적 타당성 확보.
...
| 인증자 | **인증자** 내부 개인키 생성, **UV/UP** 검증 및 서명 집행 |
...
- **RP별 개인키 서명**: 해당 RP ID 전용 개인키로 Challenge + ClientDataJSON에 서명하는 단계.
