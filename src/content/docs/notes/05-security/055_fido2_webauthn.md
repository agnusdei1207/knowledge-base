...
- 정의: WebAuthn·CTAP 기반 **RP 결속 공개키 인증**
- 기존 한계: 공유 비밀의 **피싱·재사용·서버 유출**
...
| 절차 | 설명 |
|:---|:---|
| 도전값·RP 정책 발급 | 무작위 값·사용자 검증 요구 |
| 원본·RP ID 결속 요청 | 서비스 도메인과 요청 결합 |
| 사용자 검증·서명 생성 | PIN·생체 확인 후 개인키 서명 |
| 자격 증명·서명 전달 | 식별자·인증자 데이터를 전송 |
