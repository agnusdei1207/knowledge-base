...
- 정의/개념: 서로 다른 보안 수준을 갖는 네트워크 경계 간 트래픽을 미리 정의된 보안 정책에 따라 차단 또는 허용하는 **방화벽(Firewall)** 통제 시스템
- 배경/필요성: 외부 비인가자의 내부망 무단 침입, 악성 트래픽 유입 및 내부 자원의 무분별한 외부 유출 방지 요구
...
- NIST SP 800-41 준수, NGFW 도입, 세션 상태 추적 및 정기적 룰셋 감사를 통한 경계 보안 실효성 확보 체계 구축 필수