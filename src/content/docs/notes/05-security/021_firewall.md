...
- 정책 상단부터 순차 매칭(Top-down) 평가 후 최종 **기본 거부** 적용
- 내부망 수평 침투(Lateral Movement) 차단을 위한 **동서 트래픽** 마이크로 세그멘테이션 통제
...
- 보안 요구수준에 따라 헤더 통제는 **패킷 필터**, 세션 추적은 **상태 기반 방화벽**, L7 위협 방어는 **차세대 방화벽** 적용
