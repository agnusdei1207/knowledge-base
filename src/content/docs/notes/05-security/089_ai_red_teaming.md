...
- 정의: 공격자 관점의 **AI 악용·피해 재현 평가**
- 기존 한계: 고정 평가의 **적응형·연쇄 공격 누락**
...
| 절차 | 설명 |
|:---|:---|
| 자산·범위·중단 조건 합의 | 권한·피해·시험 한도 확정 |
| 공격 시나리오 안전 실행 | 격리 계정·비용으로 재현 |
| 재현 증거·원인 전달 | 입력·응답·도구·영향 기록 |
| 완화 구현·잔여 위험 평가 | 근본 원인 수정·위험 재산정 |
| 변형 회귀·배포 결정 | 동일·우회 공격 재시험 |

> 요약: 공격을 안전하게 재현하고 수정 효과를 검증한다.
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 생성형 AI 위험 범위 | **NIST AI 600-1 기반 시나리오** | 오용·유출·연쇄 피해 포함 |
