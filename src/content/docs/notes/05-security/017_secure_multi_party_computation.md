...
date: "2026-08-02T10:12:00+09:00"
tags:
  - "notes-security"
weight: 17
extra:
...
- **반정직 공격자**는 절차를 따르며 정보를 추론하고, **악의적 공격자**는 잘못된 입력·메시지·중단으로 결과를 왜곡한다.
...
- **출력 정책·재구성기**는 결과 조각의 MAC을 확인하고 허용된 대상과 범위의 결과만 복구한다.
...
- **ISO/IEC 4922-1:2023**은 MPC의 용어·절차·참여자·암호 속성을 규정한 국제 표준이다.
...
- **비밀 분산·가블드 회로 선택**은 산술 계산 중심에는 조각 연산을, 비교와 분기 중심에는 암호화 논리 회로를 적용하는 판단이다.
