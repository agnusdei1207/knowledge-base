...
- 정의/개념: 위험 처리 전략을 선택·실행하고 잔여위험을 승인·감시
- **배경/필요성**: 위험 평가만으로 위험 수준을 허용 범위까지 낮추지 못함
...
| 한계 | 과도한 수용 또는 사업 기회 상실 | 책임까지 이전됐다고 오해 | 통제 비용이 감소 효과를 초과 |
...
1. 클라우드 계약 전가 후에도 **접근 통제·공급자 감독 유지**

### 쉽게 이해하기 (학습용)

- 클라우드 사고 손실을 계약이나 보험으로 전가해도 고객의 접근 통제와 공급자 감독 책임은 유지하고 잔여위험은 소유자가 승인한다.

## Ⅶ. 결론

- 식별된 위험을 허용 수준으로 낮추기 위해 법적 의무·비용·통제 효과·전가 한계·잔여위험을 검토하여, 회피·감소·전가·수용 전략과 책임자를 결정해야 한다.
