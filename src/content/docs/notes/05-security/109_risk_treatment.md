...
- 정의/개념: **위험 처리**는 수용•회피•전가•감소 전략을 실행하고 잔여위험을 승인•감시하는 과정이다.
...
- 평가 결과의 **예산•통제•계약 연계**가 핵심이다.
- 위험 소유자의 **전략•잔여위험 승인**이 핵심이다.
- 수용기준 초과 시 **추가 처리•상향 보고**가 핵심이다.
...
2. **처리 옵션•계획 선정**: 비용•효과•사업 영향 기반 승인안을 선정한다.
3. **통제•계약•업무변경 실행**: 책임•기한•자원에 따른 조치를 실행한다.
4. **통제 효과•분담 증적 생성**: 적용 결과와 손실 분담 조건을 기록한다.
5. **잔여위험•재평가 조건 산정**: 처리 후 수준과 재평가 조건을 산정한다.
...
- 기준 이내는 **수용**, 활동 중단은 **회피**, 손실 분담은 **전가**, 통제 효과 우수는 **감소**가 핵심이다.
