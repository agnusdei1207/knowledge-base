...
- 정의/개념: 보호 대상 계층(L3~L7 네트워크, L7 웹 애플리케이션, L7 SaaS 클라우드)과 검사 문맥에 따라 역할을 명확히 분담하는 **NGFW, WAF, CASB** 3대 영역별 통제 솔루션
- 배경/필요성: 단일 경계 방화벽만으로는 웹 애플리케이션 취약점 공격 및 클라우드(SaaS) 기반 섀도 IT/데이터 유출 통제 불가능
...
- NIST SP 800-41 준수, 계층별 솔루션(NGFW, WAF, CASB) 상호 보완배치 및 IdP/SIEM 통합 통제 체계 구축 필수