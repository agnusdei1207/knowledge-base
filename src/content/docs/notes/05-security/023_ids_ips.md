...
date: "2026-08-05T16:50:32+09:00"
tags:
  - "notes-security"
weight: 23
extra:
...
- 정의/개념: 복제 경보와 인라인 차단을 구분한 **IDS•IPS**
...
1. **정규화 특징 추출**: 패킷 표현을 통일하고 탐지 특징 생성
2. **공격 위험도•근거 판정**: 시그니처•기준선 기반 위험 평가
3. **경보•차단 정책 적용**: 위험도별 허용•경보•차단 조치 실행
