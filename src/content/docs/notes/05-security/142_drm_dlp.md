...
date: "2026-07-31T11:24:33+09:00"
tags:
  - notes-security
weight: 142
extra:
...
- **사용·이동 구간 통제**: 디지털 권리관리(DRM), 데이터 유출방지(DLP), 범용 직렬 버스(Universal Serial Bus, USB) 반출 통제를 구간별로 구분한다.
...
| **한계** | **촬영·라이선스 장애** | **암호화 트래픽 검사 제약·오탐** | **승인 사용자 유출** |
