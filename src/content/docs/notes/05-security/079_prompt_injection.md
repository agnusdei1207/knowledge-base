...
1. **사용자 요청·권한 수집**: 입력·사용자 권한 확인
2. **출처 구분 문맥 전달**: 지침·외부 자료 분리 표시
3. **응답·도구 제안 반환**: 모델은 실행 없이 제안
4. **중요 행위 재승인**: 대상·내용·영향 재확인
5. **최소 권한 제한 실행**: 샌드박스·단명 자격 집행
