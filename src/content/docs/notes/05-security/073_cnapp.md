...
date: "2026-07-31T02:06:12+09:00"
tags:
  - "notes-security"
weight: 73
extra:
...
- **유효 권한(Effective Permission)**: 정책 상속과 조건을 반영해 실제 행사할 수 있는 권한이다.
- **자산 소유자**: 위험 자원의 수정·수용·예외 승인 책임을 가진 주체이다.
- **센서 공백**: 일부 자산·계층의 상태가 수집되지 않아 분석에서 빠지는 영역이다.
- **원본 보존**: 탐지 결과를 실제 코드·IaC·이미지의 출처와 연결해 유지하는 활동이다.
- **이식성(Portability)**: 보안 자료와 정책을 다른 도구로 옮길 수 있는 정도이다.

> **키워드:** 클라우드 네이티브 애플리케이션 보호 플랫폼 (Cloud-Native Application Protection Platform, CNAPP)

## Ⅰ. 개요

- 정의/개념: 코드부터 런타임의 위험·공격 경로를 연결하는 **통합 보호 플랫폼**
