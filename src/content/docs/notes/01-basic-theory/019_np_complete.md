...
date: "2026-08-06T23:19:00+09:00"
tags:
  - "notes-basic-theory"
weight: 19
extra:
...
가지의 의미: NP-완전성을 이루는 두 조건과 증명 근거
...
- **1. NP 소속 입증**: 인증서 크기•검증 시간의 다항성 확인
- **2. 기존 NP-완전 문제 선택**: 난도가 알려진 출발 문제 선정
- **3. 다항 환원 구성**: 대상 문제의 입력을 다항 시간에 생성
- **4. 답 동치 입증**: 변환 전후의 예•아니오 일치 증명
...
- **불리언 만족 가능성 문제(Boolean Satisfiability Problem, SAT)**: 불 논리식을 참으로 만드는 변수 할당의 존재 여부를 판정하는 문제
