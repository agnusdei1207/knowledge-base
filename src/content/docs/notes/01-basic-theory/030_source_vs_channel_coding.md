...
date: "2026-07-29T12:01:30+09:00"
tags:
  - "notes-basic-theory"
weight: 30
extra:
...
- 정의/개념: **정보 중복 제거**와 오류 복구 중복 추가
- 배경/필요성: 압축률•오류율의 **상충 목표** 분리 설계
...
flowchart TB
    R{블록 길이•지연 조건}
    R -->|긴 블록•충분한 지연| S[분리 코딩]
    R -->|짧은 블록•낮은 지연| J[결합 소스-채널 코딩]
    R -->|채널 상태 변화| A[적응형 코드율]
```
