...
date: "2026-07-29T12:02:06+09:00"
tags:
  - "notes-basic-theory"
weight: 31
extra:
...
flowchart TB
    R{추론 조건}
    R -->|사전 정보•순차 증거| B[베이지안 통계]
    R -->|반복 표본•오류율 통제| F[빈도주의 통계]
    R -->|희귀 사건•양성 관측| P[기저율 반영]
```

- 사전 정보•표본 조건에 맞춰 추론하고 **확률 보정** 검증
