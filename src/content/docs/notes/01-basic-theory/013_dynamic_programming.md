...
xychart-beta
    title "중복 상태 저장에 따른 계산량 개념도"
    x-axis "문제 단계" [1, 2, 3, 4, 5]
    y-axis "상대 계산 횟수" 0 --> 32
    line [2, 4, 8, 16, 32]
    line [1, 2, 3, 4, 5]
```

<span style="color:#3080dd">■</span> **중복 재계산** &nbsp;&nbsp; <span style="color:#d95926">■</span> **상태 저장·재사용**

> 상태 저장은 같은 부분 문제의 반복 계산을 제거
