...
- 정의/개념: 중복되는 부분 문제의 상태값을 한 번 계산해 저장하고 점화식에서 재사용함으로써 계산량을 줄이는 알고리즘 설계 기법이다.
...
- **상태(State)**: 부분 문제를 서로 구분하는 최소 변수의 조합한다.
...
- **상태 공간**: 문제에서 정의할 수 있는 모든 상태의 집합이다.
