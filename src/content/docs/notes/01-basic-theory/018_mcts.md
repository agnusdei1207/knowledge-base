...
date: "2026-07-30T18:50:20+09:00"
tags:
  - "notes-basic-theory"
weight: 18
extra:
...
1. **UCT 경로 선택**: 탐색•활용 점수가 높은 경로 결정
2. **자식 노드 확장**: 미시도 행동을 탐색 트리에 추가
3. **확장 상태 전달**: 롤아웃 시작 상태와 정책 설정
4. **롤아웃 보상 전달**: 종료 상태까지 모의한 보상 산출
5. **경로 통계 갱신**: 보상을 선택 경로에 역전파
...
| 병렬 작업자의 같은 경로 집중으로 중복 탐색 | 가상 손실과 노드 통계 원자적 갱신 | 병렬 탐색의 **경로 다양성·효율 향상** |
