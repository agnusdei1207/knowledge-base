...
date: "2026-07-28T11:55:02+09:00"
tags:
  - "notes-basic-theory"
weight: 18
extra:
...
| 고려사항 | 대응 방안 | 기대 효과 |
|:---|:---|:---|
| 롤아웃 정책의 보상 편향 | 기준 정책 검증·가치 모델 보정 | 행동 가치 왜곡 완화 |
| 탐색 상수 부적합 | 도메인·예산별 UCT 상수 튜닝 | 탐색·활용 균형 개선 |
| 저방문 행동의 높은 분산 | 최종 행동을 평균 보상과 방문 수로 검증 | 우연한 고보상 선택 방지 |
| 병렬 롤아웃의 중복 경로 집중 | 가상 손실·통계 동기화 적용 | 병렬 탐색 다양성 확보 |
...
> 요약: **분기 계수**·평가 신뢰도로 MCTS와 **미니맥스** 선택
...
### 쉽게 이해하기 (학습용)
- 정책·가치 신경망이 MCTS의 후보 선택과 상태 평가를 안내한다.


## Ⅶ. 결론

- 대규모 탐색을 위해 분기·평가 신뢰도를 검토하여 **MCTS** 활용
