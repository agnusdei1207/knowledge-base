...
| 탐색 상수 부적합 | 도메인·예산별 UCT 상수 조정 | 탐색·활용 균형 개선 |
| 저방문 행동의 높은 분산 | 평균 보상과 방문 수 동시 검증 | 우연한 고보상 선택 방지 |
| 병렬 롤아웃의 경로 집중 | 가상 손실·통계 동기화 적용 | 병렬 탐색 다양성 확보 |
| 정책·가치 신경망 결합 | 사전확률·가치로 탐색 유도 | 제한 예산의 유망 수 집중 |
