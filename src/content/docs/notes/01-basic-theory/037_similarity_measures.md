...
- **정규화(Normalization)**: 벡터 길이나 변수 범위를 맞춰 특정 크기가 점수를 지배하지 않게 하는 처리
...
- **정규화(Normalization)**: 비교 전에 벡터 길이나 변수 척도를 맞추는 처리
...
- **코사인•자카드•유클리드**: 벡터 방향의 일치도, 집합 교집합 비율, 좌표 간 직선거리를 각각 재는 척도
