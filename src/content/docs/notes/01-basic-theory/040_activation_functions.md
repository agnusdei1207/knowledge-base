...
- **순전파•역전파**: 예측값을 앞 방향으로 계산하고 손실 기울기를 이전 층으로 전달하는 과정
...
- **도함수(Derivative)**: 입력 변화에 대한 활성값 변화율로 역전파 기울기의 통과 배율
...
- **Sigmoid•Tanh•ReLU**: 0~1 확률, -1~1 영중심 상태, 음수 0•양수 항등 출력을 만드는 활성화 함수
