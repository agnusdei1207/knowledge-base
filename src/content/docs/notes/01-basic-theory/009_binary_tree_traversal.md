...
date: "2026-07-30T18:23:38+09:00"
tags:
  - "notes-basic-theory"
weight: 9
extra:
...
2. **다음 문맥 요청**: 다음 노드와 방문 시점 복원
3. **노드 정보 요청**: 값 처리 후 순서에 맞는 후속 문맥 배치
...
| 순회 중 구조 변경으로 노드 누락·중복·참조 단절 | 스냅샷 고정 또는 변경 감지 버전 적용 | 한 시점 기준의 **순회 결과 일관성** 확보 |
