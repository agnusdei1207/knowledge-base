...
date: "2026-07-28T14:59:27+09:00"
tags:
  - "notes-basic-theory"
weight: 12
extra:
...
| 구성요소 | 책임 | 흐름상 역할 |
|:---|:---|:---|
| MST 알고리즘 | 후보 중 **안전 간선**만 누적 | ① 요청 → ② 후보 조회 → ③ 선택 → ④ 판정 → ⑥ 반환 |
| 간선 후보 집합 | **간선 목록·우선순위 큐**로 후보 보관 | ② 조회 수신 → ③ 최소 간선 반환 |
| 연결 상태 집합 | **서로소 집합·방문 집합** 보관 | ④ 판정 수신 → ⑤ 안전 여부 반환 |
...
- 연결성·동률 처리·입력 밀도·비용 변경을 확인해야 최소성과 재현성을 함께 유지할 수 있다.
