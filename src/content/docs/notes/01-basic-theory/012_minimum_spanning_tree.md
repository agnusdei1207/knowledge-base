...
date: "2026-07-25T23:50:00+09:00"
tags:
  - "notes-basic-theory"
weight: 12
extra:
...
- **최소 신장 트리(Minimum Spanning Tree, MST, 엠에스티)**: 영문 각 단어의 첫 글자를 따 MST로 표기하며 모든 정점을 사이클 없이 연결하고 가중치 합을 최소화한 트리
...
2. 기존 클러스터 증설은 **프림**으로 최소 비용 인접 노드 확장

### 쉽게 이해하기 (학습용)

- 데이터센터에 깔 수 있는 링크 후보를 비용이 싼 순서로 훑으면서 이미 이어진 랙끼리 다시 잇는 고리 링크는 버리고 새 랙을 물어 오는 링크만 남긴다
- 이미 돌아가는 클러스터에 노드를 더 붙일 때는 지금 묶여 있는 노드 무리의 경계에 닿는 링크 중 가장 싼 것부터 하나씩 끌어와 무리를 넓힌다
