...
- **다목적 최적화(Multi-objective Optimization)**: 정확도를 올리면 다양성이 떨어지는 것처럼 서로 충돌하는 목표들 사이에서 균형점을 찾는 방법
...
- **기존 한계**: 아이템이 수십만 개면 사용자가 **탐색 비용** 감당 불가
