...
date: "2026-07-28T21:42:01+09:00"
tags:
  - "notes-basic-theory"
weight: 21
extra:
...
- **② 비단말 치환**: 현재 비단말을 단말·비단말열로 치환
- **③ 구문 트리 확장**: 적용 규칙을 부모·자식 관계로 기록
- **④ 다음 입력 토큰 요청**: 유도 상태의 단말과 비교할 입력 토큰 조회
- **⑤ 단말 일치 확인·소비**: 두 단말이 같으면 유도 상태와 입력에서 제거하고 다르면 오류 처리
- **⑥ 구문 트리 확정**: 유도 상태와 입력을 모두 소비한 경우 완성된 구문 트리 반환
