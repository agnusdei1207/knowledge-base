...
date: "2026-07-28T11:57:45+09:00"
tags:
  - "notes-basic-theory"
weight: 21
extra:
...
| 하향식 파서의 좌재귀 무한 호출 | 좌재귀 제거와 좌인수분해 적용 | LL 파싱 가능성 확보 |
| 같은 입력 위치의 규칙 선택 충돌 | FIRST·FOLLOW 집합으로 파싱표 검증 | 결정적 규칙 선택 |
| 오류 입력에서 진단 연쇄 발생 | 동기화 토큰 기반 오류 복구 | 후속 오류 위치 정확성 향상 |
...
### 쉽게 이해하기 (학습용)
- 파서는 괄호와 블록의 중첩을 CFG 규칙에 따라 구문 트리로 만든다.

## Ⅶ. 결론

- 중첩 구문 분석을 위해 모호성·좌재귀를 검토하여 **CFG** 활용
