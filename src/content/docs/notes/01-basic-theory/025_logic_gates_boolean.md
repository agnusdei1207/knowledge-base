...
- 정의/개념: 0•1 논리식을 단순화하고 게이트 조합으로 구현하는 **디지털 논리 설계 체계**
- 배경/필요성: 직접 회로 조합은 **게이트 수•지연** 증가
...
- **논리식 최소화**로 게이트 수를 줄이되 전파 지연은 별도 검증
...
- **1. 진리표 정의**: 모든 입력 조합의 요구 출력 명시
- **2. 논리식 최소화**: 카르노 맵으로 리터럴•항 축소
- **3. 게이트망 합성**: SOP **2단 논리** 또는 범용 게이트 구성
- **4. 등가성•타이밍 검증**: 기능 일치와 전파 지연 확인
