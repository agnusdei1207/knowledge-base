...
date: "2026-07-28T12:00:36+09:00"
tags:
  - "notes-basic-theory"
weight: 25
extra:
...
| 고려사항 | 대응 방안 | 기대 효과 |
|:---|:---|:---|
| 논리 최소화 후 기능 변경 | 원식·최소식의 형식 등가성 검증 | 기능 정확성 보장 |
| 경로 지연 차에 따른 글리치 | 합의항 추가·레지스터 경계 배치 | 순간 오출력 방지 |
| 게이트 수만 줄여 임계 경로 증가 | 면적·전력·지연을 함께 최적화 | 타이밍 제약 충족 |
| NAND·NOR 변환으로 논리 단계 증가 | 표준 셀 지연 기반 재합성 | 기능 완전성의 지연 부담 완화 |
...
> 요약: 일반 논리는 기본 게이트, 홀짝 판정은 **배타 게이트**, 게이트 종류 통일은 **범용 게이트**
...
### 쉽게 이해하기 (학습용)
- 검증된 표준 셀로 논리를 매핑하고 클록 주기 안에 결과가 도착하도록 최적화한다.


## Ⅶ. 결론

- 회로 효율을 위해 논리 등가성·타이밍·글리치를 검토하여 **부울 대수** 활용
