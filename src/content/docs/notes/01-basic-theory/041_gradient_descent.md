...
- 정의/개념: 손실 기울기의 반대 방향으로 파라미터를 갱신하는 **경사하강법**
- 배경/필요성: 고차원 **비볼록 손실**은 해석적 최적해 산출 곤란
...
- **학습률**이 크면 최적점을 지나쳐 발산하고 작으면 학습 시간 증가
...
- **1. 손실•기울기 계산**: 순전파와 역전파로 기울기 산출
- **2. 최적화기 상태 갱신**: 모멘트•누적 제곱 이력 반영
...
> 요약: **상태 메모리•적응 보폭**의 필요성에 따른 최적화기 선택
...
- **상태 메모리** 제약은 SGD, 희소 특징은 AdaGrad, 초기 수렴은 Adam 선택
