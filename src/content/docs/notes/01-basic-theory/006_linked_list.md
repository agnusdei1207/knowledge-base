...
date: "2026-08-02T16:06:00+09:00"
tags:
  - "notes-basic-theory"
weight: 6
extra:
...
- **현재 노드**: 순회 과정에서 데이터와 다음 링크를 읽고 있는 노드
- **후속 노드**: 현재 노드의 링크가 가리키는 다음 방문 대상
...
2. **현재 값 요청**: 데이터 필드에 현재 원소 조회
3. **현재 값 반환**: 현재 노드의 데이터 처리
4. **다음 참조 요청**: 링크 필드에 후속 노드 조회
5. **다음 참조 반환**: 후속 노드를 현재 노드로 전환
