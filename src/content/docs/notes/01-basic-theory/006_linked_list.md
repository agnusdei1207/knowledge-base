...
- 정의/개념: 비연속 노드를 **링크**로 이어 논리적 순서를 관리하는 선형 자료구조
- 배경/필요성: 위치가 알려진 노드를 **링크 변경**만으로 삽입•삭제할 구조 필요
...
선의 의미: 가로선은 헤드부터 널까지 각 노드를 잇는 링크 연결 관계
...
선의 의미: 세로선과 가지는 노드가 데이터 필드와 링크 필드를 포함하는 관계
