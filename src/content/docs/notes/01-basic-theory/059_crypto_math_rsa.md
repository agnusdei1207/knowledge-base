...
| 패딩 처리기 | 평문·해시·난수로 **OAEP·PSS 블록** 생성·검증 |
| 모듈러 거듭제곱 연산 | 인코딩 블록과 지수로 **암호화·복호화** 수행 |

**동작 원리**

- **① OAEP 블록**: 평문에 난수·해시를 결합해 인코딩
- **② 개인키 요청**: 수신자의 격리 키 사용 권한 확인
- **③ 개인 지수**: 저장소 내부의 **비밀 지수**로 복호 연산
- **④ 복호 블록**: **상수 시간** 패딩 검증 후 평문 복원
