...
date: "2026-07-28T12:27:09+09:00"
tags:
  - "notes-basic-theory"
weight: 61
extra:
...
- 병렬 시간뿐 아니라 총 연산량, 스팬, 효율과 메모리 경합을 함께 측정해야 증설 효과를 판단할 수 있다.
...
1. 병렬 집계에서 **리덕션 트리**로 공유 주소의 **쓰기 경합** 완화

### 쉽게 이해하기 (학습용)

- 프로세서별 부분 합을 만든 뒤 트리로 병합하면 같은 주소에 결과를 동시에 쓰는 충돌과 순차 대기 시간을 줄일 수 있다
