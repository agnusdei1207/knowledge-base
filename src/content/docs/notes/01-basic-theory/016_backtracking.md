...
date: "2026-07-27T21:31:00+09:00"
tags:
  - "notes-basic-theory"
weight: 16
extra:
...
### 쉽게 이해하기 (학습용)
- 스도쿠 빈칸에 숫자를 넣다가 같은 줄의 숫자와 겹치면 그 값을 지우고 다른 숫자를 넣듯, 제약 위반 분기를 버리고 이전 선택으로 돌아가는 탐색이 백트래킹이다
...
### 쉽게 이해하기 (학습용)
- 스도쿠 숫자를 한 칸씩 깊이 넣고 돌아올 때 지우면 현재 선택 경로만 저장하면 되며, 규칙 위반을 일찍 발견할수록 그 숫자 아래의 수많은 조합을 검사하지 않아도 된다
...
> 요약: 해 조건을 확인한 뒤 **유망한** 후보만 하위 단계로 진행하고 복구
