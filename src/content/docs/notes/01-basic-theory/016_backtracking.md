...
xychart-beta
    title "탐색 깊이별 후보 노드 수 개념도"
    x-axis "선택 깊이" [1, 2, 3, 4, 5]
    y-axis "상대 후보 노드 수" 0 --> 32
    line [2, 4, 8, 16, 32]
    line [2, 3, 5, 8, 13]
```

<span style="color:#3080dd">■</span> **완전 탐색** &nbsp;&nbsp; <span style="color:#d95926">■</span> **조기 가지치기**

> 제약을 일찍 판정할수록 하위 후보 제거량 증가
...
| 후보 순서에 따른 **탐색 시간** 편차 | 실패 가능성·**제약도** 높은 후보 우선 | 완성 해 **발견 시간** 단축 |
