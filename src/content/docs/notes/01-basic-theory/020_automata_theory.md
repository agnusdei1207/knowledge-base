...
date: "2026-08-05T10:52:21+09:00"
tags:
  - "notes-basic-theory"
weight: 20
extra:
...
선의 의미: 세로선과 가지는 유한 오토마타가 5튜플의 각 형식 요소를 포함하는 관계
...
- **1. 초기 상태 구성**: DFA는 q0, NFA는 엡실론 폐쇄 설정
- **2. 입력 기호 소비**: 입력 스트림에서 기호 하나 선택
- **3. 다음 상태 갱신**: DFA 상태 또는 NFA 상태 집합 갱신
- **4. 수용 상태 판정**: 현재 상태와 수용 상태 집합 비교
