...
- 배경/필요성: 전체 입력의 **처리 용량 초과**•병렬화 제약 해소
...
| 계열 | 수식•의미 |
|:---|:---|
| <span style="color:#3080dd">■</span> 파란색 선언 | **균형 분할 $\log_2 n$**: 절반 분할 깊이 |
| <span style="color:#d95926">■</span> 주황색 선언 | **최악 불균형 $n$**: 한 원소씩 축소 |

> **불균형 분할**: 호출 깊이•스택 사용량 증가
...
- **1. 분할 요청**: 입력을 독립된 작은 문제로 분해
- **2. 복귀 문맥 전달**: 호출 위치•결합 정보 보관
- **3. 부분 문제 전달**: 종료 조건까지 같은 해법 적용
- **4. 부분 해 전달**: 반환된 해를 전체 결과로 결합
