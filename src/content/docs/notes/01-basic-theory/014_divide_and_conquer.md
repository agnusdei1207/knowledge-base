...
date: "2026-08-02T09:32:00+09:00"
tags:
  - "notes-basic-theory"
weight: 14
extra:
...
- 배경/필요성: 단일 문제 실행은 독립 연산의 **병렬 처리 불가**
...
1. **복귀 문맥 저장**: 호출 위치와 결합 정보 보관
2. **부분 문제 재귀 호출**: 같은 형태의 더 작은 입력을 해결
3. **복귀 문맥 조회**: 종료 조건부터 호출 위치와 결합 정보 복원
4. **부분 해 결합**: 재귀 단계별 부분 해로 상위 문제의 해 구성
