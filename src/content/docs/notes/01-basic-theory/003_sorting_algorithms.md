...
date: "2026-08-06T23:03:00+09:00"
tags:
  - "notes-basic-theory"
weight: 3
extra:
...
- **평균 시간복잡도**: 입력 분포에서 기대되는 연산 증가율
- **최악 시간복잡도**: 가장 불리한 입력에서의 연산 증가율
...
- 일반 비교 정렬의 **하한 $\Omega(n\log n)$**
- 알고리즘별 **평균•최악 시간복잡도** 차이
- 보조 공간•**안정성•제자리 정렬** 조합 차이
...
- **입력 규모**: 메모리 적재 가능 여부와 정렬 비용을 가르는 데이터 크기
