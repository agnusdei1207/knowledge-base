...
date: "2026-07-29T09:41:02+09:00"
tags:
  - "notes-basic-theory"
weight: 42
extra:
...
- 정의/개념: 예측 오차의 **단일 비용 변환 함수**
- 배경/필요성: **미분 가능한 갱신 기준** 제공
...
| 계열 | 수식•의미 |
|:---|:---|
| 파랑 `#3080dd` • MSE | 큰 오차를 강조하는 **제곱 손실** |
| 주황 `#d95926` • 허버 손실 | 임계값 $\delta=1$인 허버 손실: $|e|\le1$이면 $\frac12e^2$, 그 밖은 $|e|-\frac12$ |
...
- **평가 지표•이상치 비율•클래스 분포**를 측정해 손실 함수 선택
