...
| 계열 | 수식·의미 |
|:---|:---|
| 파란색·첫째 선 | **$O(1)$**: 입력과 무관한 일정 비용 |
| 주황색·둘째 선 | **$O(\log n)$**: 입력이 배가될 때 한 단계 증가 |
...
| 계열 | 수식·의미 |
|:---|:---|
| 파란색·첫째 선 | **$O(n)$**: 입력 수에 비례하는 비용 |
| 주황색·둘째 선 | **$O(n\log n)$**: 입력 처리와 분할 단계가 결합된 비용 |
...
| 계열 | 수식·의미 |
|:---|:---|
| 파란색·첫째 선 | **$O(n\log n)$**: 입력 처리와 분할 단계가 결합된 비용 |
| 주황색·둘째 선 | **$O(n^2)$**: 모든 입력 쌍에 비례하는 비용 |
