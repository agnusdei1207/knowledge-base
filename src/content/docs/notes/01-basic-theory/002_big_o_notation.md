...
| 핵심 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| **느슨한 상한** 선택 | 실제 증가율보다 큰 빅오로 후보 차이 은폐 | 성립하는 가장 낮은 **점근 차수**와 증인 제시 |
| **상수 비용** 생략 | 같은 차수 후보의 운영 응답 시간 역전 | 목표 입력 구간에서 동일 환경 **실측값** 병행 |
| 입력 사례와 **점근 상한** 혼동 | 최악 사례와 빅오를 같은 개념으로 오해 | 최선•평균•최악 조건과 상•하한 표기를 분리 |
