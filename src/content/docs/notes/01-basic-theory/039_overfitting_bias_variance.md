...
date: "2026-07-29T12:06:52+09:00"
tags:
  - "notes-basic-theory"
weight: 39
extra:
...
| 계열 | 수식•의미 |
|:---|:---|
| <span style="color:#3080dd">■</span> 파란색 선언 | **훈련 오차**: 복잡도 증가 시 감소 |
| <span style="color:#d95926">■</span> 주황색 선언 | **검증 오차**: 적정 지점 뒤 증가 |

> **개념 데이터**: 모델 복잡도별 오차 추세
...
flowchart TB
    R{훈련•검증 오차}
    R -->|훈련 낮음•검증 높음| O[과적합: 규제 강화]
    R -->|두 오차 모두 높음| U[과소적합: 용량 확대]
    R -->|검증 오차 최소| A[적정 적합]
```

- 오차 높이•**일반화 격차**에 따라 규제•용량 조정
