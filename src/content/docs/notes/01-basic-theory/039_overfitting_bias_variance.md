...
date: "2026-07-28T12:12:32+09:00"
tags:
  - "notes-basic-theory"
weight: 39
extra:
...
| 과적합의 큰 일반화 격차 | L2 규제·조기 종료·데이터 증강 적용 | 분산 감소 |
| 과소적합의 높은 두 오차 | 특징·모델 용량 확대와 규제 완화 | 편향 감소 |
| 운영 입력 분포 변화 | 성능·격차 모니터링과 주기적 재학습 | 적정 적합 유지 |

### 쉽게 이해하기 (학습용)

- 두 오차의 절대 크기와 격차를 먼저 구분해야 규제와 용량의 조정 방향이 정해진다.
...
- 희소 특징의 큰 가중치에 L2 벌점을 적용해 특정 단어 의존을 줄인다.
