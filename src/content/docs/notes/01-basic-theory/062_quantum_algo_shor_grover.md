...
date: "2026-07-28T12:28:13+09:00"
tags:
  - "notes-basic-theory"
weight: 62
extra:
...
| 설계 요소 | 입력·상태 | 역할 |
|:---|:---|:---|
| 큐비트 레지스터 | 중첩 입력·중간 상태 | 양자 계산 상태 보관 |
| 문제 함수 회로 | 문제 구조 | 모듈러 거듭제곱·정답 오라클 구현 |
| 간섭 연산 | 위상·확률 진폭 | 역 QFT·진폭 증폭 수행 |
| 측정 | 최종 양자 상태 | 고전 비트 결과 산출 |
...
### 쉽게 이해하기 (학습용)
- 논리 복잡도뿐 아니라 회로·오류 정정·반복 측정과 고전 후처리까지 포함해야 실용적 양자 우위를 평가할 수 있다.
