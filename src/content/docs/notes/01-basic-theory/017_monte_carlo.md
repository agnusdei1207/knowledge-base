...
date: "2026-07-28T22:39:00+09:00"
tags:
  - "notes-basic-theory"
weight: 17
extra:
...
- **③ 추정 통계**: 표본평균·표준오차·신뢰구간 계산
- **④ 추가 표본 요청**: 표준오차가 허용 범위를 넘으면 반복
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 난수 표본의 **상관·편향** | 검증된 생성기·**독립 난수 스트림** 분할 | **추정량 편향** 방지 |
...
- 여러 작업자가 같은 난수표를 겹쳐 읽지 않게 스트림을 나누고, 희귀사건 표본을 보강한 뒤 신뢰구간과 계산 한도로 반복을 멈춘다.
