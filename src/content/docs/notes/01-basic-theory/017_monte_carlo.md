...
| 핵심 고려사항 | 위험 | 대책 |
|:---|:---|:---|
| 난수 표본의 상관 | 독립 가정 위반으로 표준오차 과소평가 | 검증된 생성기와 독립 난수 스트림 분할 |
| **희귀사건** 표본 부족 | 영향이 큰 꼬리 영역의 확률 추정 실패 | 중요도•층화 표본추출과 가중치 보정 |
| 높은 분산 | 허용 오차 도달까지 표본 수 급증 | 제어 변량 등 분산 감소 기법 적용 |
| 종료 기준 부재 | 불필요한 반복 또는 낮은 정밀도 조기 종료 | 신뢰구간•허용 오차•표본 한도 동시 정의 |
