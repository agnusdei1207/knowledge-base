...
- **몬테카를로 방법(Monte Carlo Method)**: 난수 표본의 통계로 직접 계산하기 어려운 값을 근사하는 기법
...
- **기존 한계**: **해석해**가 없거나 **고차원**이면 정확값 계산 불가
...
- **표준오차**가 표본 수 제곱근에 반비례해 정밀도 개선 비용 급증
...
> 요약: 생성·평가·추정 반복으로 **허용 오차** 도달까지 근사
