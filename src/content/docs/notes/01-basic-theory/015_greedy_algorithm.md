...
date: "2026-08-05T10:40:59+09:00"
tags:
  - "notes-basic-theory"
weight: 15
extra:
...
선의 의미: 선택 함수가 후보 집합에서 고른 대상을 부분 해와 연결하고, 두 판정 함수가 부분 해의 제약 충족과 완성 여부를 검사하는 정적 의존 관계
...
1. **국소 최선 선택**: 목적 함수로 현재 최선 후보 결정
2. **타당성 판정**: 후보 추가 후 제약 충족 여부 확인
3. **통과 후보 확정**: 선택을 되돌리지 않고 부분 해에 누적
4. **완성 여부 판정**: 미완성이면 다음 선택 반복
