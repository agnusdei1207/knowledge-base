...
date: "2026-07-29T11:55:51+09:00"
tags:
  - "notes-basic-theory"
weight: 23
extra:
...
flowchart TB
    R{수치 요구사항}
    R -->|정확한 10진 일치| D[정수•10진 형식]
    R -->|넓은 범위•연산 성능| F[부동소수점]
    R -->|오차 민감 누적 계산| H[큰 정밀도•보상 합산]
```

- 정확성•범위•성능 요구로 **수치 표현 형식** 선택
