...
date: "2026-07-28T20:15:00+09:00"
tags:
  - "notes-basic-theory"
weight: 23
extra:
...
```mermaid
sequenceDiagram
    participant W as 저장 워드
    participant S as 부호 비트
    participant E as 지수 필드
    participant F as 가수 필드
...
| 오버플로·특수값 전파 | 범위 검사와 NaN·무한대 정책 정의 | 비정상 결과 조기 탐지 |
| 혼합 정밀도의 작은 변화 소실 | 큰 형식 누산·손실 스케일링 | 학습 안정성 확보 |
