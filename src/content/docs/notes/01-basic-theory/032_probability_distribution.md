...
- 장애 복구에 걸린 시간들을 늘어놓고 하위 10%·중앙값·상위 10% 지점을 후보 분포의 같은 지점과 나란히 점으로 찍어 보면, 점들이 대각선에서 어느 쪽으로 휘는지를 눈으로 보고 실제 복구 시간을 가장 잘 흉내 내는 분포를 고를 수 있다
