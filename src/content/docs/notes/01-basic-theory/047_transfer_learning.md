...
- **기존 한계**: 타깃 **라벨**이 적으면 **처음부터 학습**으로는 성능 미달
...
| 한계 | 표현 고정에 따른 **부정적 전이** | **학습률** 과대 시 기존 표현 훼손 | 데이터 부족 시 **과적합**·큰 학습 비용 |

> 요약: **도메인 유사도**와 라벨량이 정하는 재학습 범위
