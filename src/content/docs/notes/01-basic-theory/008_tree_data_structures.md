...
| 계열 | 수식•의미 |
|:---|:---|
| <span style="color:#3080dd">■</span> 파란색 선언 | **AVL**: $1.44\log_2(n+2)-0.328$ |
| <span style="color:#d95926">■</span> 주황색 선언 | **레드블랙**: $2\log_2(n+1)$ |

> **AVL**: 강한 균형으로 최대 탐색 경로 단축
...
flowchart TB
    R{저장 위치•처리 비율}
    R -->|외부 저장소•페이지 I/O| B[B-Tree]
    R -->|메모리•조회 비율 높음| A[AVL 트리]
    R -->|메모리•갱신 비율 높음| C[레드블랙 트리]
```
