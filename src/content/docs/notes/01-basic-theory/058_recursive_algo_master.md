...
date: "2026-08-05T11:21:18+09:00"
tags:
  - "notes-basic-theory"
weight: 58
extra:
...
- 정의/개념: **재귀 알고리즘과 마스터 정리** 는 축소 입력의 반복 호출을 점화식으로 모델링하고 균등 분할 재귀의 시간 복잡도를 판정하는 **분석 체계**
- 배경/필요성: 호출 수•입력 축소율•결합 비용이 중첩돼 코드만으로는 **시간•스택 증가율 판단이 어려움**
