...
date: "2026-07-30T18:52:52+09:00"
tags:
  - "notes-basic-theory"
weight: 58
extra:
...
- **2. 성장률 비교•Case 판정**: 재귀 비용•결합 비용 차수로 경우 결정
- **3. 재귀 트리•대입법 분석**: 범위 밖 점화식 분석
- **4. 최대 재귀 깊이 분석**: 점근 공간 산정
...
### 쉽게 이해하기 (학습용)
- 깊은 트리 순회는 명시적 스택의 반복 처리로 호출 스택 오버플로를 피한다.
