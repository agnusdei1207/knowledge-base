...
date: "2026-08-05T17:18:03+09:00"
tags:
  - "notes-basic-theory"
weight: 10
extra:
...
가지의 의미: 확장 제어•후보•연결•방문 기록의 정적 책임 분리
...
1. **다음 노드 추출**: 큐•스택 규칙으로 확장 대상 선택
2. **미방문 이웃 선별**: 인접 정보에서 발견한 이웃 제외
3. **발견 표시•프런티어 삽입**: 중복 방지 후 후보 저장
