...
| 계열 | 수식•의미 |
|:---|:---|
| <span style="color:#3080dd">■</span> 파란색 선언 | **BFS $2^d$**: 깊이별 큐 후보 수 |
| <span style="color:#d95926">■</span> 주황색 선언 | **DFS $d$**: 활성 경로의 스택 깊이 |

> **개념 데이터**: 이진 분기에서 BFS 후보 수 급증
