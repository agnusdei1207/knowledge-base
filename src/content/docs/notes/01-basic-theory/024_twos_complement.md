...
date: "2026-07-28T20:23:00+09:00"
tags:
  - "notes-basic-theory"
weight: 24
extra:
...
- **① 비트 반전**: 뺄 수의 모든 비트를 뒤집어 1의 보수 생성
- **② 1 가산**: 반전값에 1을 더해 2의 보수 생성
- **③ n비트 합**: 동일 가산기로 덧셈·뺄셈 결과 산출
- **④ 부호 관계 판정**: 입력·결과 부호로 오버플로 검출
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 비트 폭이 다른 값의 변환 | 확대 시 부호 확장·축소 시 범위 검사 | 정수값 보존 |
| 캐리 아웃과 오버플로 혼동 | 입력·결과 부호 관계로 판정 | 부호 연산 정확성 확보 |
