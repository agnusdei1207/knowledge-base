...
date: "2026-08-06T23:01:00+09:00"
tags:
  - "notes-basic-theory"
weight: 1
extra:
...
- 정의/개념: 입력 증가에 따른 **연산량•메모리 증가**를 나타내는 비용 척도
...
- 하드웨어와 무관한 **점근 증가율•Big-O** 표기
- 정확 차수•하한을 구분하는 **Theta•Omega** 표기
...
가지의 의미: 동일 계산 모델을 공유하는 정적 분석 구성
...
- 기본 연산•보조 공간 비용 함수의 **점근 차수** 독립 산정
