...
- 정의/개념: 데이터를 $K$개로 나누어 순환 훈련·검증하는 **일반화 성능 평가 기법**
- 배경/필요성: 단일 분할의 평가 편향을 줄이고 표본 활용도를 극대화하기 위해 **교차 검증** 필요
...
1. **분할 전략 수립**: 데이터 형태에 따라 일반, 층화, TimeSeriesSplit 결정
...
- 독립 표본은 **일반 K-Fold**, 불균형 데이터는 **층화 K-Fold**, 시계열은 시간 분할 선택
