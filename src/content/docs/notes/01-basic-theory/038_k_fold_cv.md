...
- **1. 데이터•분할 규칙 전달**: 누수 방지 단위로 폴드 구성
- **2. 훈련 폴드 전달**: 나머지 폴드를 학습에 배정
- **3. 회차 모델•검증 폴드 전달**: 훈련 폴드 안에서만 적합
- **4. 검증 점수 전달**: 미사용 폴드로 성능 평가
- **5. 점수 요약 반환**: 평균•편차로 성능 요약
