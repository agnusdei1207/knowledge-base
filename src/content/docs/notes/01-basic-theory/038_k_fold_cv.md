...
date: "2026-07-29T12:06:19+09:00"
tags:
  - "notes-basic-theory"
weight: 38
extra:
...
- **2. 회차 모델 전달**: 훈련 폴드 안에서만 적합
- **3. 검증 점수 전달**: 미사용 폴드로 성능 평가
- **4. 점수 요약 반환**: 평균•편차로 성능 요약
...
flowchart TB
    R{표본 구조}
    R -->|독립•교환 가능| K[일반 K-Fold]
    R -->|클래스 불균형| S[층화 K-Fold]
    R -->|개체 반복 측정| G[그룹 K-Fold]
    R -->|시간 순서 존재| T[시계열 분할]
```
