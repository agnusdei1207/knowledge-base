...
- 클래스별 AP 평균 **mAP** 기반 탐지 정확도 평가

### 쉽게 이해하기 (학습용)
- 특징 피라미드는 크기별 특징을 제공하고 NMS는 겹친 후보 상자를 제거한다.
...
### 쉽게 이해하기 (학습용)
- 특징 추출기가 크기별 표현을 만들고 탐지 헤드가 후보를 예측하며 NMS가 중복 결과를 제거한다.
...
### 쉽게 이해하기 (학습용)
- 고해상도 특징 피라미드와 크기별 재현율로 소형 객체 미탐을 줄인다.
