...
date: "2026-07-28T21:26:00+09:00"
tags:
  - "notes-basic-theory"
weight: 33
extra:
...
| 빨강 · 2계열 | 같은 표본 수에서는 거짓 귀무가설의 미기각 증가 |
...
- **① 검정 통계량 산출**: 표본과 귀무가설 차이를 표준화
- **② 유의확률 계산**: 귀무분포에서 관측 이상 극단 확률 계산
- **③ 유의수준 비교**: 사전 기준과 비교해 기각 여부 결정
- **④ 신뢰구간 산출**: 효과 추정값과 표준오차로 범위 제시
...
| 두 버전 지연 차이의 **배포 판단** | 신뢰구간의 보수적 끝값을 개선 기준과 비교 | 우연한 **성능 회귀** 차단 |
