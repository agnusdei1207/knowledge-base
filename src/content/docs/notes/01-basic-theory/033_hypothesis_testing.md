...
date: "2026-07-26T00:16:00+09:00"
tags:
  - "notes-basic-theory"
weight: 33
extra:
...
> 요약: 먼저 정한 **유의수준**과 **유의확률** 비교로 기각 결정

### 쉽게 이해하기 (학습용)
- 실험 결과를 보고 나서 기준선을 정하면 유리한 쪽으로 옮기고 싶어지므로 자료를 열기 전에 "5%까지는 헛다리를 허용한다"고 먼저 못 박아 두고, 그다음 표본에서 뽑은 값이 차이 없음 분포의 꼬리 얼마나 바깥에 있는지를 확률로 바꿔 그 기준선과 비교하며, 기각이 나오든 아니든 마지막에는 차이의 크기와 그 범위까지 읽어야 결론이 닫힌다
