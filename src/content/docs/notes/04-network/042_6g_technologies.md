...
- 2030년대 글로벌 디지털 사회와 우주 항공, 완전 자율주행, 홀로그래픽 텔레프레즌스 및 인간-기계 상호작용(HMI)을 주도할 차세대 초공간·초고속 지능형 이동통신 종합 표준 기술로 자리매김하고 있으며, 실무 기술 개발 및 표준화 대응 시에는 Sub-THz 대역의 경로 손실을 극복하는 RIS 및 분산 Massive MIMO 배치, 저궤도 위성망과의 단절 없는 연동을 위한 조건부 핸드오버(Conditional Handover) 및 도플러 보상, AI-Native 자율 제어망의 발진을 방지하는 Safety Boundary 규칙 설계를 결합하여 견고한 6G 글로벌 인프라 기반을 완성
