...
- **1. 상위 무선 처리**: CU가 정책과 상위 계층을 처리
- **2. F1 계층 전달**: CU 결과를 DU에 전달
- **3. 프론트홀 신호 전달**: DU가 스케줄링 후 RU로 전달
- **4. 무선 신호 송수신**: RU가 변환한 전파를 단말과 교환
- **5. 무선 품질 환류**: 측정 결과로 자원 정책을 보정
