...
- **변조 차수•심벌당 비트** 증가와 잡음 내성 저하
- **성상도•SNR** 기반 심벌 판정 오류 결정
- 고차 **QAM•PAPR** 증가에 따른 증폭 효율 저하
...
- **무선 주파수부(Radio Frequency, RF)**: 기저대역 심벌을 반송파로 변환•증폭하고 수신 파형을 하향 변환하는 기능
- **파일럿(Pilot)**: 채널 상태와 동기 기준을 추정하도록 미리 알려진 심벌
- **변조•부호화 조합(Modulation and Coding Scheme, MCS)**: 링크가 함께 적용할 변조 차수와 부호율 조합
...
- 아날로그 단순성은 **AM**, 잡음 내성은 **FM** 선택
- 디지털 저 SNR은 **QPSK**, 고속은 **QAM** 선택
