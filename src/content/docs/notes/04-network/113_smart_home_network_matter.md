...
- **1. 기기 발견·보안 연결**: 코드·BLE로 식별 후 안전한 경로 생성
- **2. 기기 증명 제시**: 제품 인증 정보를 전달
- **3. 기기 진위 검증**: 신뢰 체인과 제조 정보를 확인
- **4. 운영 자격 발급**: 패브릭 인증서와 권한 생성
- **5. 암호화 제어 설정**: 상호 인증 후 명령 경로 수립
