...
| 제조사 신뢰 판정 | 저장소가 제조사 인증서의 신뢰 여부를 결정 |
...
1. 스마트홈 IoT 분리망의 **Matter 기기 발견 허용**

### 쉽게 이해하기 (학습용)

- IoT 기기는 업무 단말과 격리하되 Matter 제어기가 기기를 찾는 데 필요한 mDNS 경로만 제한적으로 허용한다.

## Ⅶ. 결론

- 스마트홈 기기의 제조사별 제어 단절을 줄이기 위해 전력·대역폭·IP 연결·Matter 데이터 모델·기존 장비를 검토하여, 저전력은 Thread, 고속은 Wi-Fi, 기존 기기는 브리지를 활용해야 한다.
