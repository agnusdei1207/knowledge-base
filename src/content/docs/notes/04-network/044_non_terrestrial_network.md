...
> 파란 선은 지상–위성–지상 수직 경로를 진공 광속으로 왕복한다는 하한 가정이며 GEO에서는 전파 시간만 약 478ms이고 실제 지연에는 경사 경로·처리·대기 시간이 더해진다.
...
2. **보정 기준 전달**: 단말이 도플러 편이와 전파 지연을 선보정할 기준 제공
