...
- **SOAR·SIEM·API**: SIEM이 생성한 보안 경보를 API로 도구와 연결해 표준 대응 절차를 자동 실행하는 구성요소
...
| 실행 상태 보고 | 도구가 조치의 성공·실패와 대상 상태를 보고 |
...
- 반복 대응의 지연과 편차를 줄이기 위해 경보 신뢰도·업무 영향·가역성·승인·롤백을 검토하여, 안전한 절차부터 SOAR로 자동화해야 한다.
