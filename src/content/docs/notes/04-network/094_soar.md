...
date: "2026-08-02T15:04:00+09:00"
tags: ["notes-network"]
weight: 94
extra:
  question_no: "094"
...
- **응용 프로그래밍 인터페이스(Application Programming Interface, API)**: 플레이북이 제품별 조회·조치 기능을 구조화해 호출하는 규약
...
- **4. 조치 상태·타임아웃 판정**: 의도 상태와 실제 결과를 대조하고 응답 기한 초과를 실패로 처리
- **5. 원복 요청**: 실패·오탐 시 보상 단계로 앞선 조치를 상쇄하고 이전 상태로 복구
