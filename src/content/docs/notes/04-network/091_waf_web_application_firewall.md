...
date: "2026-08-26T14:02:51+09:00"
tags:
  - "notes-network"
weight: 91
extra:
...
- 배경/필요성: L3/L4 방화벽은 포트·주소만 보아 **웹 페이로드 공격 식별 부담을 애플리케이션 코드에 전가**하므로, 애플리케이션 앞단에 HTTP를 해석·정규화하는 검사 계층을 두어 코드 수정 없이 악성 요청을 걸러냄
...
- 웹 공격은 **WAF 가상 패치**, 코드 결함은 **시큐어 코딩** 적용
