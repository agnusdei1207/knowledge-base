...
| 노변 장치 (RSU) | 신호 제어기•센서와 연동해 MAP•SPaT 수신•방송 |
...
3. 타임스탬프 및 시퀀스 넘버 최신성 검증: 지연•중복 메시지 폐기
...
|:---|:---|:---|:---|
| GPS 위치 정보 위조 공격 | Sybil•GPS Spoofing의 허위 위치 | 센서 연동 **개연성 검증** | 서명된 허위 위치 탐지 보완 |
