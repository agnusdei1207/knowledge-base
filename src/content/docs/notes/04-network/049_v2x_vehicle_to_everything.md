...
- 정의/개념: 차량이 **PC5•Uu**로 주변 대상과 정보를 교환하는 **V2X 협력 체계**
...
- **공개키 기반구조(Public Key Infrastructure, PKI)**: 인증서와 공개키로 송신자와 전자서명을 검증하는 신뢰 체계
...
- **노변 장치(Roadside Unit, RSU)**: 도로 주변에서 차량과 서버 사이 정보를 교환하는 장치
