...
title: "5G 코어 SBA"
date: "2026-07-25T19:38:00+09:00"
tags: ["notes-network"]
weight: 38
extra:
  question_no: "038"
...
- **정의/개념**: 망 기능을 등록·발견·호출하는 5G 코어 구조
- **배경/필요성**: 기능별 독립 배치·확장과 결합도 완화
...
- 고정 노드 연결 대신 망 기능 서비스를 호출한다.
- NRF에서 가용 망 기능과 위치를 발견한다.
- 부하가 큰 망 기능만 독립 확장한다.
- SMF가 경로를 정하고 UPF가 패킷을 전달한다.
- 서비스 발견·호출 장애가 제어 기능을 연쇄 중단시킨다.
