...
date: "2026-07-31T11:08:51+09:00"
tags: ["notes-network"]
weight: 98
extra:
  question_no: "098"
...
- **AI 추론 계층**: 이상·수요·원인과 대응 후보를 계산하는 계층이다.
- **망 제어·집행기**: 승인된 설정을 장비에 적용하고 결과를 검증하는 구성요소다.
- **입력 품질**: 수집 자료의 누락·지연·오류·시간 일관성을 나타내는 수준이다.
- **감사 기록**: 누가 어떤 근거로 변경을 승인·실행했는지 남긴 기록이다.

> **키워드:** AI 네이티브 네트워킹 (AI-Native Networking)
...
- 다변량 변화는 **AI**, 반복 조건은 **규칙**, 고위험·희귀 변경은 수동 적용
