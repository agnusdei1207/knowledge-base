...
1. 혼잡 예측 경로를 일부 트래픽에 먼저 적용
2. 무선 장애 원인 권고 후 사람 승인으로 채널 변경

### 쉽게 이해하기 (학습용)

- 혼잡을 피할 새 경로는 전체가 아니라 일부 흐름에 적용해 지연과 다른 서비스 영향을 확인한 뒤 확대한다.
- 인공지능이 간섭을 원인으로 지목해도 채널 변경은 운영자가 근거와 영향 범위를 확인한 뒤 승인한다.

## Ⅶ. 결론

- 변경 위험·모델 신뢰도로 승인·카나리 결정
