...
date: "2026-07-25T19:41:00+09:00"
tags:
  - "notes-network"
weight: 41
extra:
...
- **정의/개념**: 전용 자원·정책으로 운영하는 현장 5G망
- **배경/필요성**: 공중망 장애·외부 전송 의존 제거
...
- 전용 주파수·RAN으로 무선 자원 간섭을 통제한다.
- SNPN은 공중망 장애에도 현장 연결을 유지한다.
- 로컬 UPF는 데이터를 현장망 안에서 전달한다.
- SIM 인증과 QoS로 단말·트래픽을 통제한다.
- 독립성이 커질수록 코어망 운영 부담도 늘어난다.
...
1. 스마트 공장은 로컬 UPF로 제어 데이터를 OT망에 전달
2. 물류센터는 SIM·QoS로 로봇 접속과 트래픽 우선순위 통제

### 쉽게 이해하기 (학습용)

- 공장 제어 데이터가 외부망을 돌지 않고 현장 설비에 바로 도착한다
- 물류 로봇만 접속시키고 제어 신호를 일반 데이터보다 먼저 전달한다

## Ⅶ. 결론

- 장애 독립성·운영 역량으로 SNPN·PNI-NPN 선택
