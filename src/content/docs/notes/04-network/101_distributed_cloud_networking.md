...
1. 공장 영상은 현장 엣지 처리 후 결과만 중앙 전송
2. 개인정보는 지정 지역에 두고 공통 정책 적용

### 쉽게 이해하기 (학습용)

- 공장 영상 원본은 현장 엣지에서 분석하고 작은 결과만 중앙으로 보내 지연과 외부 전송량을 줄인다.
- 지역 밖으로 나가면 안 되는 개인정보는 지정 클라우드에 배치하고 같은 신원·접근 정책을 모든 지역에 배포한다.
