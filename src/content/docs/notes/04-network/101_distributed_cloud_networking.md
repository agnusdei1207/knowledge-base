...
- **중앙 제어 평면·정책 엔진**: 서비스 배치·경로·보안 의도를 계산하고 신원·주권·망 구역 조건을 판정하는 구성요소
...
- **정책 드리프트**: 지역별 실제 경로·보안 설정이 중앙 선언 정책과 달라진 상태
...
- **분산 클라우드**: 지연과 데이터 주권 요구를 위해 여러 지역·엣지 자원을 공통 제어하는 배치 방식
