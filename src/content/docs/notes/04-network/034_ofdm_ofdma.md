...
5. **수신 신호 FFT 및 채널 추정**: 수신측에서 CP를 제거하고 FFT 연산으로 심볼을 분리하며, CSI를 업데이트하여 다음 스케줄링에 반영한다.
...
- 초고속 고밀도 무선 통신망 구축 시 **CSI 기반 동적 RU 스케줄링**과 **PAPR 저감 및 CP 최적화 기법** 필수 적용.

#### 한줄 요약

- CSI 기반 동적 자원 할당 스케줄링 및 순환 전치 최적화 체계 구현 필수.
