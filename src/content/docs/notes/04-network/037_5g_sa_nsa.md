...
- **사업자 구축 목표 및 CAPEX 판정**: 자산•서비스 요구 비교
- **NSA 방식**: LTE 제어와 EPC 세션 관리 활용
- **SA 방식**: 5G NR 제어와 5GC 슬라이스 적용
...
| NSA 신호 과다 소모 | LTE와 5G 신호를 동시에 처리 | 데이터 비활성 시 5G NR 무선 릴리스 | 단말 전력 소모 절감 |
