...
1. **LTE 제어 접속**: NSA의 LTE 기준 연결 수립
2. **EPC 등록·인증**: EPC가 가입 권한 확인
3. **NR 보조 링크 추가**: NSA의 5G 데이터 링크 결합
4. **LTE·NR 사용자 경로**: EPC 기반 이중 연결 전달
5. **NR 단독 접속**: SA의 NR 연결 수립
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| SA 단말·음성 미지원 | 단말·VoNR·로밍 조합 시험 | 전환 중 통화 보장 |
| NSA의 LTE 의존 | EPC 용량·장애 영향 계측 | 5G 서비스 연속성 |
...
- **단말·음성·코어 기능을 검증한 NSA에서 SA로의 전환**
