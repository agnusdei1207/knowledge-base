...
- 급제동 명령에 편의 기능보다 작은 식별자를 배정해 여러 ECU가 동시에 송신해도 중재 과정에서 버스를 먼저 차지하게 한다.

## Ⅶ. 결론

- 다수 ECU의 실시간 메시지 충돌을 결정적으로 해결하기 위해 프레임 긴급도·식별자 우선순위·데이터 크기·버스 부하·호환성을 검토하여, 요구에 맞는 CAN 규격을 선택해야 한다.
