...
date: "2026-08-26T14:15:07+09:00"
tags:
  - "notes-network"
weight: 115
extra:
...
- 배경/필요성: 링크만 연결되면 통신이 시작되는 구조는 **비인가 단말을 사후에 찾아내는 비용**을 치르므로, 스위치 포트를 인증 전까지 닫아 두고 RADIUS 서버의 판정 이후에만 여는 3자 모델을 통제 지점으로 삽입
...
- 관리 단말은 **EAP-TLS**, 미지원 기기는 **격리 MAB** 적용
