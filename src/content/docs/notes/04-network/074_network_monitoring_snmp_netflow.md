...
1. SNMP와 IPFIX를 결합해 대역 폭증 원인을 찾는다
2. sFlow 표본율과 추정 오차를 함께 제시한다

### 쉽게 이해하기 (학습용)

- 포트 사용량이 오른 시각의 흐름 기록을 찾아 어느 통신이 대역을 썼는지 확인한다
- 표본으로 계산한 트래픽 양은 실제값 하나가 아니라 오차 범위와 함께 본다

## Ⅶ. 결론

- 장애 질문·수집 비용으로 SNMP·Flow·sFlow를 조합한다
