...
date: "2026-08-26T14:01:14+09:00"
tags:
  - "notes-network"
weight: 74
extra:
...
- 배경/필요성: 링크 상태만 보는 감시는 이상 징후마다 **사람이 장비를 직접 뒤지는 추적 비용**을 반복하므로, 장비 상태(SNMP)와 세션 단위 플로우 기록(NetFlow/sFlow)을 컬렉터에 모아 원인 규명을 수작업 대신 상관 분석으로 대체
...
- 장비 상태는 **SNMP**, 세션·고속망 분석은 **NetFlow·sFlow** 선택
