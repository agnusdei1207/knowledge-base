...
1. **계량 자료 수집**: 시간대별 사용량·상태 이벤트 전송
2. **수집 완전성 검증**: 미터 신원·누락 구간 확인과 재수집
...
| 대량 미터의 **인증서 만료** | PKI 갱신·폐기 **자동화** | 계량 통신의 **연속성 유지** |
