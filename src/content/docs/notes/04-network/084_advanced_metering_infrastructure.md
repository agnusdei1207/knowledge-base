...
- **배경/필요성**: 단방향 AMR의 **원격 제어·상태 확인 한계** 해소
...
- 원격 계량의 데이터 오류와 제어 오용을 막기 위해 계량값 품질·VEE·시간 동기·명령 권한·감사 이력을 검토하여, 과금 데이터와 원격 제어를 분리 통제하는 AMI를 운영해야 한다.
