...
- 정의/개념: 원신호를 **주파수 도약•코드 결합**으로 넓은 대역에 분산하는 전송 방식이다.
- 배경/필요성: 협대역 전송은 **간섭•재밍 에너지 집중**에 취약해진다.
...
- **FHSS**의 도약 순서 기반 간섭 주파수 회피가 핵심이다.
- **DSSS**의 PN 코드•칩 기반 신호 대역 확산이 핵심이다.
- **도약•코드•시점 동기** 기반 수신 역확산이 핵심이다.
...
- 협대역 간섭 회피는 **FHSS**, 처리 이득 확보는 **DSSS**을 선택한다.
