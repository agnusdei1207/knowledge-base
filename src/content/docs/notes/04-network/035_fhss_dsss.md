...
1. 간섭 환경에 따라 **FHSS의 주파수 도약 또는 DSSS의 확산 코드를 적용**
...
- 간섭과 도청에 강한 확산 통신을 위해 간섭 대역폭·도약 동기·확산 이득·코드 분리 요구를 검토하여, 주파수 회피에는 FHSS, 처리 이득에는 DSSS를 선택해야 한다.
