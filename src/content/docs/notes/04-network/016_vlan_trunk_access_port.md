...
- 배경: 단일 물리망에 다 적용하으면 브로드캐스트 폭풍이 일고 **부서 간 보안 격리도 불가능했기 때문** #### 한줄 요약
...
| 트렁크로 쓸데없는 방송 다 넘어가서 **반대편 스위치까지 다 뻗음** | **허용 VLAN 목록(Allowed List)** 에 진짜 쓰는 VLAN만 한 땀 한 땀 적음 | 쓰레기 트래픽 새는 거 막아서 오버헤드 대역폭 아낌 |
