...
- **SIEM·SOAR**: SIEM은 로그를 분석해 탐지 근거를 만들고, SOAR는 경보를 받아 대응 절차를 조정·자동 실행함
...
- 탐지와 대응이 단절되는 한계를 극복하기 위해 경보 근거·사건 식별자·조치 영향·실행 결과를 검토하여, SIEM 탐지와 SOAR 대응을 폐루프로 연결해야 한다.
