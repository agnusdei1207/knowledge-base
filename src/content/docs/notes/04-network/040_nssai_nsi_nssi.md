...
date: "2026-07-25T19:40:00+09:00"
tags: ["notes-network"]
weight: 40
extra:
  question_no: "040"
...
- **정의/개념**: 슬라이스 식별 정보를 운영 인스턴스에 매핑
- **배경/필요성**: 가입·지역별 논리망 선택과 영역 조립
...
- SST와 선택적 SD로 슬라이스를 구분한다.
- 가입·지역·가용성에 따라 NSI를 선택한다.
- 영역별 NSSI를 종단 NSI로 조립한다.
- 정책에 따라 NSSI를 공유하거나 분리한다.
- 매핑 오류는 단말을 잘못된 논리망에 연결한다.
