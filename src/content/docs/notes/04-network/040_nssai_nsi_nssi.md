...
- 정의/개념: **NSSAI** 요청을 **NSI**와 영역별 **NSSI**에 연결하는 체계이다.
- 배경/필요성: 식별자만으로는 종단망을 선택할 수 없다.

#### 한줄 요약

- 요청 이름표를 논리망과 하위망에 연결한다.
...
- 단말의 이름표가 가입과 지역에 맞는 종단망과 하위망으로 이어지는지 확인해야 한다.
