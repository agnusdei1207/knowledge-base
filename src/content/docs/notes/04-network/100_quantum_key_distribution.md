...
- **2. 측정 기저 제출**: 무작위 측정 결과의 기저를 전달
- **3. 일치 기저 선별**: 같은 기저의 비트만 후보로 유지
- **4. QBER·키 정제**: 임계값 판정·오류 정정·비밀성 증폭
- **5. 최종 키 공급**: 검증된 대칭키를 응용에 제공
