...
date: "2026-07-25T02:15:00+09:00"
tags:
  - "notes-network"
weight: 6
extra:
...
- **매체 접근 제어 주소(Media Access Control Address, MAC 주소)**: 같은 링크에서 프레임의 출발지·목적지 인터페이스를 식별하는 데이터링크 계층 주소
...
- 이더넷 MAC은 48비트를 6개 옥텟으로 표현한다
- I/G·U/L 비트가 수신 범위·관리 주체를 나눈다
- 변경 가능한 MAC만으로는 신원을 증명할 수 없다
...
| 주요 위험 | 장기 식별자 노출로 추적 | 같은 링크의 주소 중복 |
...
1. 사내 스위치는 802.1X 인증 후 포트를 개방
2. 무선 단말은 프라이버시 MAC과 인증 기록을 연결
