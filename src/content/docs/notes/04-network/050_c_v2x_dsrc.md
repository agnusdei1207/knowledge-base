...
date: "2026-08-26T13:57:32+09:00"
tags:
  - "notes-network"
weight: 50
extra:
...
- 배경/필요성: 매 전송마다 채널을 다투는 CSMA/CA는 차량 밀집 시 **경합 지연과 패킷 충돌 증가**를 피할 수 없으므로, 주기적 안전 메시지에 한해 자원을 미리 예약해 반복 사용하는 준지속 스케줄링(SPS)으로 갈아타 충돌 비용을 스케줄링 복잡도로 바꿀 필요
...
- 셀룰러 연계는 **C-V2X**, 기존 WAVE 망은 이중 모드 전환
