...
- 정의/개념: 차량 안전 메시지를 **C-V2X•DSRC**로 전달하는 **V2X 기술군**이다.
- 배경/필요성: 단일 규격으로는 기존 **WAVE 호환**과 이동통신 진화 동시 수용하기 어렵다.
...
- **C-V2X**의 **PC5 직접•Uu 망 경유**이중 경로이다.
- **DSRC**의 **OCB•CSMA/CA** 기반 직접 접속이 핵심이다.
- 차량 밀도 증가 시 **채널 경쟁•충돌**로 DSRC 지연•손실 증가한다.
...
- 기존 **WAVE•RSU** 호환이 우선이면 **DSRC**, 이동통신 진화•광역 연계면 **C-V2X**을 선택한다.
