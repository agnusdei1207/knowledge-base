...
- 한국, 미국, 중국을 포함한 글로벌 주요국들이 C-ITS 국가 단일 표준으로 C-V2X 방식을 확정함에 따라 **자율협력주행 및 커넥티드 카 생태계의 단일 지배 표준 기술**로 자리매김하였으며, 향후 고정밀 센서 셰어링 및 군집 주행을 지원하는 5G-NR V2X(Rel-16/17)로 발전해 나가는 가운데, 실무 구축 시에는 **기존 WAVE 인프라와의 공존을 위한 Dual-Mode RSU/OBU 과도기적 운용, 차량용 텔레매틱스와 C-V2X를 원칩화한 통합 SoC 적용, 고속 주행 시 도플러 편이를 보상하는 DMRS 밀도 제어**를 결합하여 성공적인 차세대 C-ITS 무선망을 완성
