...
- 정의/개념: **오픈랜**은 5G/6G 무선 기지국(RAN)의 하드웨어와 소프트웨어를 분리(Disaggregation)하고, 기지국 구성요소(RU, DU, CU) 간 인터페이스를 개방형 표준(Open Interface)으로 규격화하여 멀티 벤더 장비 간 상호 운용성을 보장하는 무선망 기술이다.
