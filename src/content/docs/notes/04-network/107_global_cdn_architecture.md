...
| 문제 | 대책 | 효과 |
|:---|:---|:---|
| 개인 응답의 **공유 캐시 노출** | **RFC**의 **RFC 9111**과 비저장 정책 검증 | 사용자 정보 격리 |
...
- 글로벌 사용자와 원본 부하가 크면 **글로벌 CDN**, 한 지역 반복 요청은 **지역 캐시**, 캐시 불가는 **원본 직접 제공**을 택하고 **원본 보호**를 적용하는 **콘텐츠 전달 방식 선택**이 필요하다.
