...
1. 정적 파일의 **내용 해시 주소와 장기 캐싱**

### 쉽게 이해하기 (학습용)

- 파일 내용이 바뀔 때 URL의 해시도 바뀌게 해 긴 TTL로 캐시하면서도 새 버전을 별도 객체로 즉시 배포한다.

## Ⅶ. 결론

- 전 세계 사용자의 콘텐츠 지연과 원본 부하를 줄이기 위해 **사용자 분포·콘텐츠 변경성·캐시 키·신선도·원본 장애**를 검토하고, 에지·중간·원본 계층과 무효화 정책을 설계해야 한다.
