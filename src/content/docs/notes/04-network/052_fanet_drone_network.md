...
date: "2026-07-25T19:52:00+09:00"
tags:
  - "notes-network"
weight: 52
extra:
...
- **정의/개념**: 3차원 이동 드론이 자율 구성하는 애드혹망
- **배경/필요성**: 통신 인프라 없는 군집 임무의 경로 확보
...
- 3차원 이동으로 토폴로지가 빠르게 변한다.
- 위치·비행 계획으로 링크 수명과 경로를 예측한다.
- 비행과 통신이 배터리를 공유해 에너지가 제한된다.
- 망 분할은 관제와 임무 데이터 전달을 끊을 수 있다.
...
| 판단 기준 | FANET | MANET | VANET |
|:---|:---|:---|:---|
| 핵심 특징 | 고속 3차원 비행 | 자유로운 지상 이동 | 도로 제약 고속 이동 |
| 적용 기준 | 드론 군집 임무 | 일반 단말 임시망 | 차량 도로망 |
| 주요 위험 | 짧은 링크 수명·에너지 | 예측 어려운 단말 이동 | 밀집·단절 구간 반복 |
...
2. GCS 단절 시 군집 제어기가 임무 경로 유지

### 쉽게 이해하기 (학습용)

- 수색 드론이 멀어지기 전에 배터리가 남은 드론으로 중계 경로를 바꾼다
- 지상 관제가 끊겨도 드론끼리 정한 수색 구역과 귀환 조건을 유지한다

## Ⅶ. 결론

- 링크 수명·잔여 에너지로 중계 경로 전환
