...
- **무인항공기(Unmanned Aerial Vehicle, UAV)**: 조종사가 탑승하지 않고 원격•자율 비행하는 항공기

</details>

- 정의/개념: 3차원 이동 **UAV**가 중계 경로를 자율 구성하는 **FANET**
...
- **위성항법시스템(Global Positioning System, GPS)**: 위성 신호로 위치와 시간을 산출하는 항법 체계
...
- **이동 애드혹 네트워크(Mobile Ad Hoc Network, MANET)**: 일반 이동 단말이 자율 구성하는 임시망
- **차량 애드혹 네트워크(Vehicular Ad Hoc Network, VANET)**: 도로 이동 차량에 특화된 애드혹망
...
- 예상 링크 수명•잔여 에너지가 임무 기준을 충족하는 **FANET 중계 경로** 선택
