...
- Three-way Handshake (SYN $\rightarrow$ SYN/ACK $\rightarrow$ ACK)를 통해 Client/Server 간 Bi-directional Reachability 검증 및 ISN (Initial Sequence Number) 동기화를 수행한다.
...
- SYN Segment Option Field에서 MSS (Maximum Segment Size), Window Scale, SACK Permitted 등 Connection Parameter를 Negotiation한다.
