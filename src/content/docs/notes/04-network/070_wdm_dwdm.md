...
| **광증폭기 ** | 광선로 감쇠를 전기 변환 없이 광 영역에서 보상 |
| **광 채널 모니터 ** | 각 파장의 스펙트럼 밀도, 파장 쏠림(Drift) 및 OSNR 지표를 인라인 모니터링 |
...
|:---|:---|:---|:---|
| **채널 간격 ** | 20 nm (널찍한 간격) | 0.8 nm (100GHz) / 0.4 nm (50GHz) | 12.5 GHz 단위 가변 슬롯 할당 |
