...
[운영 제어기] ----- [클라우드 플랫폼]
                         /       \
              [범용 컴퓨팅] ----- [가상 CU] ----- [가상 DU] ----- [무선 장치]
                    \                                  /
                         [무선 가속기]
```

선의 의미: 운영 제어기와 클라우드 플랫폼은 vRAN의 배치•자원 관리 경계를 이루고, 플랫폼 아래 범용 컴퓨팅과 가상 CU•DU가 결합되며 무선 가속기는 범용 자원과 가상 DU 사이의 시간 민감 연산을 지원하는 정적 실행 구조를 뜻한다.
