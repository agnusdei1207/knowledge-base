...
date: "2026-07-25T12:32:00+09:00"
tags:
  - "notes-network"
weight: 75
extra:
...
- 정의: 0·1·X값을 병렬 비교하는 검색 메모리다
- 배경: LPM·ACL 규칙의 조회 지연을 줄인다
...
- 전체 항목 병렬 비교는 규칙 조회 지연을 줄인다
- X값은 접두어·범위를 표현해 규칙 수를 줄인다
- 우선순위 인코더는 복수 일치의 오동작을 막는다
- 병렬 비교는 SRAM보다 전력·면적 비용을 높인다
...
1. ACL·LPM·QoS별 TCAM 영역을 분할한다
2. IPv6 범위 규칙의 확장 항목을 계산해 집약한다
