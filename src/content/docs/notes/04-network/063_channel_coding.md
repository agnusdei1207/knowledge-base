...
> **키워드:** 채널 코딩 : 해밍·리드-솔로몬·터보 (Channel Coding)
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 오류 환경과 부호율이 불일치 | **BER·지연별 부호율·블록 길이** 시험 | 복호 성공률 확보 |
| 반복 복호 증가로 서비스 지연 초과 | **서비스 기한 내 반복 횟수** 제한 | 종단 지연 보호 |
| 강한 부호의 복호 연산량 과다 | **처리량·전력 기준** 구현 비교 | 수신 자원 절감 |
...
- 단일 비트·저비용은 **해밍**, 버스트는 **RS**, 코딩 이득은 **터보** 선택
