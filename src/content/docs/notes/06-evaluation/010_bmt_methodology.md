...
date: "2026-08-06T17:07:52+09:00"
tags:
  - "notes-evaluation"
weight: 10
extra:
...
- 배경/필요성: 벤더 제안 수치는 환경•부하 차이로 **실제 도입 성능** 공정 비교 곤란
...
선의 의미: 요구사항•평가 항목 아래 공통 시험환경과 사전 판정기준을 분리하고, 후보 제품•시험 순서 및 원시값•반복•통계를 같은 비교 경계에 결합한 구조
