...
- 기존 한계: 공급자마다 제안 수치와 시험 조건이 다르면 후보 제품의 성능과 업무 적합성을 공정하게 비교하기 어렵다.
...
- 후보 제품의 업무 적합성과 성능을 공정하게 비교하기 위해 **대표 시나리오·동일 환경·데이터 규모·평가 가중치·반복성**을 검토하고, 사전에 동결한 기준으로 BMT를 수행해야 한다.
