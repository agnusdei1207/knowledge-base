...
- **전력 사용 효율(PUE)**: 총 시설 에너지를 IT 장비 에너지로 나누어 지원 설비의 전력 부담을 나타내는 지표이다.
- **물 사용 효율(WUE)**: 현장 물 사용량을 IT 장비 에너지로 나누어 물 사용 부담을 나타내는 지표이다.
- **탄소 사용 효율(CUE)**: 탄소 배출량을 IT 장비 에너지로 나누어 탄소 집약도를 나타내는 지표이다.
...
- **재생에너지 계수(REF)**: 데이터센터 총에너지 중 재생에너지가 차지하는 비율이다.
...
- **생애주기 평가(LCA)**: 원료 조달부터 건설·운영·폐기까지 전 과정의 환경 영향을 평가하는 기법이다.
- **생애주기 비용(LCC)**: 도입비뿐 아니라 운영·유지·교체·폐기 비용까지 합산한 비용이다.
...
- **ISO/IEC 30134**: 데이터센터 자원 효율 지표의 정의·측정·보고 방법을 규정하는 국제표준 계열이다.
