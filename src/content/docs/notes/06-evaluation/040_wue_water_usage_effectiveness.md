...
- **IT 장비 에너지**: 서버·스토리지·네트워크 장비가 WUE 측정 기간에 사용한 전력량이다.
...
- **WUE**: IT 에너지 대비 현장 물 사용량으로 데이터센터의 직접 물 부담을 평가하는 지표이다.
- **PUE**: 총 시설 에너지를 IT 장비 에너지로 나누어 지원 설비의 전력 부담을 평가하는 지표이다.
...
- **ISO/IEC 30134-9**: WUE의 정의·측정·계산·보고 기준을 규정한 국제표준이다.
