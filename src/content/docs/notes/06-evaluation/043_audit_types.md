...
- 정의/개념: 사업 위험에 따라 시점•관여 강도를 조합하는 **감리 유형 선택**이다.
- 배경/필요성: 단일 시점 감리로는 변화•상시 위험•긴급 현안의 **적시 발견할 수 없다**.
...
- 사업 단계•현안에 따라 **단계감리•특정감리**를 선택한다.
- 변화 조기 발견과 진입 조건을 잇는 **상주감리**가 핵심이다.
- 통제 이행을 정해진 주기로 확인하는 **정기감리**가 핵심이다.
- 모든 유형에서 지켜야 하는 **사업 수행•감리 판단 독립성**이 핵심이다.
...
1. **사업 위험 분석**: 규모•단계•변화 속도•현안과 점검 준거를 분석한다.
2. **유형•시점 선정**: 위험을 발견해야 할 시점에 맞춰 감리 유형을 조합한다.
3. **범위•전문분야 배정**: 사업관리•응용•데이터•인프라 등 위험별 감리원을 투입한다.
4. **조치•잔여 위험 판정**: 수정 증거를 재검증해 종결 여부와 다음 감리 시점을 결정한다.
...
| 특정 현안만 좁게 보는 **연관 위험 누락** | **영향 시스템•통제 범위 확대** | 같은 원인의 **파급 위험 식별** |
| 유형별 지적 분리로 **중복•조치 누락** | **증거•지적•시정조치 공통 식별자 연결** | 감리 유형 간 **추적성 확보** |
| 상주 역할이 사업관리와 섞이는 **책임 혼재** | **정보시스템 감리기준의 역할•절차 준수** | 상주감리의 **법적 정합성 확보** |
...
- 위험 발견 시점•전문분야에 맞게 **감리 유형 조합**, 지적은 **공통 증거 이력**으로 종결이 핵심이다.
