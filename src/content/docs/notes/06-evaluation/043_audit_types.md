...
date: "2026-07-31T05:03:46+09:00"
...
- 배경/필요성: 동일한 시점의 감리만으로는 **단계 사이 변화·긴급 현안 발견 지연**
...
- 사업 위험·단계·현안에 따른 **시점·범위·전문분야 선택**
- 변화 조기 발견과 진입 조건을 잇는 **상주·단계 점검**
...
| 구성요소 | 책임 |
|:---|:---|
| 사업 위험·준거 | **규모·복잡도·법정 의무·현안**으로 범위 결정 |
| 시점·관여 방식 | **단계·상주·정기·특정** 시점과 강도 선택 |
| 인력·전문분야 | 위험별 **감리원·투입 기간** 배정 |
| 증거·지적 이력 | 유형별 **근거·판정·지적 사항** 연결 |
| 조치 확인 | **수정 증거·잔여 위험·종결 여부** 판정 |
