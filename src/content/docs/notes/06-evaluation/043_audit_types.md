...
- **PMO(Project Management Office)**: 발주자를 지원해 일정·비용·범위·위험을 관리하는 사업관리 조직
...
- 감리 목적·범위·시점에 따라 필요한 증거가 달라진다.
- 관여가 잦을수록 위험 조기 발견 기회 증가한다.
- 상주해도 사업 의사결정과 독립성 유지한다.
- 유형을 병행하면 지적·조치 이력을 통합한다.
...
| 비교축 | 단계감리 | 상주감리 | 특정감리 |
|:---|:---|:---|:---|
| 핵심 특징 | 마일스톤마다 산출물 점검 | 사업 기간에 지속 관여 | 특정 현안·원인 집중 점검 |
| 적용 기준 | 단계 진입·완료 판단이 중요할 때 | 대규모·고위험 사업을 밀착 점검 | 중대 장애·분쟁·긴급 위험 발생 |
| 주요 위험 | 단계 사이 위험을 늦게 발견 | 역할 개입으로 독립성 훼손 | 좁은 범위로 연관 위험 누락 |
