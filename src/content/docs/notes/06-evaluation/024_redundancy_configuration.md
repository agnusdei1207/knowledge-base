...
- 기존 한계: 예비 자원 없이 필요 용량만 구성하면 장비 장애나 유지보수 중 처리 용량과 서비스 수준 목표를 유지하기 어렵다.
...
- 장애 시 필요한 처리 용량과 복구 여유를 확보하기 위해 **허용 동시 장애 수·정상 및 장애 부하·상태 동기화·전환시간**을 검토하고, 요구 수준에 맞는 N+1·2N·N+M 이중화를 선택해야 한다.
