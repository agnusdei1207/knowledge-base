...
- **MTBF(Mean Time Between Failures, 엠티비에프)**: 영문 머리글자를 딴 지표로, 수리 가능 시스템의 고장 사이 평균 운전 시간
...
- 기존 한계: 누적 고장 수만으로 결함 수정 효과 판단 곤란
- **배경/필요성**: 신뢰성 개선 추세와 시험 종료 근거 확보
...
- 시험·분석·수정 반복에 따른 고장 강도 변화를 추정한다.
- 결함 수정 없이 시험 시간만 늘어도 신뢰성은 성장하지 않는다.
- 동일 형상·운용 프로파일과 추정 불확실성을 함께 관리한다.
...
- 시험과 결함 수정에 따른 신뢰도 개선을 정량화하기 위해 **고장 발생 추세·수정 효과·모형 적합도·예측 불확실성**을 검토하고, 목표 신뢰도 달성 여부와 시험 종료 판단에 신뢰도 성장모형을 활용해야 한다.
