...
- **Crow-AMSAA 모델**: 시간에 따라 발생률이 변하는 비동질 포아송 과정(Non-Homogeneous Poisson Process, NHPP)으로 누적 고장과 성장 추세를 통계적으로 추정하는 모델이다.
...
- **시험 지속 결정**: 성장 모수가 1 미만이고 목표 평균 고장 간격의 하한을 충족하면 종료하며, 1 이상이면 시험·분석·수정을 계속하는 판단이다.
