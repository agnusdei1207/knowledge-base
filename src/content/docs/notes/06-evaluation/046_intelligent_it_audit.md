...
date: "2026-07-31T05:05:29+09:00"
...
- **NIST AI RMF 1.0**: Govern·Map·Measure·Manage 기능으로 AI 위험을 관리하는 프레임워크다.
...
| 구성요소 | 책임 |
|:---|:---|
| 업무·인간 책임 | **자동화·오류 비용·승인·중단 책임** 확정 |
| 데이터·AI | **계보·품질·성능·편향·강건성** 증거 |
| 클라우드·API | **IAM·인터페이스 계약·공동 책임** 통제 |
| 기기·통신 | **센서·명령·연결 보안·복원력** 유지 |
| 운영 통제 | **변경·재학습·배포·수동 전환** 관리 |
...
- 물리 영향이 크면 **종단 경로·공동 책임·인간 중단**을 모두 입증한 경우만 승인
