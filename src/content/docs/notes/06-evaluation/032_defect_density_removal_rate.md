...
- 기존 한계: 단순 결함 건수만 비교하면 제품 규모의 차이와 시험 단계의 결함 검출 능력을 구분하기 어렵다.
...
- 개발 품질과 출시 전 결함 제거 수준을 판단하기 위해 **기능 또는 코드 규모·단계별 발견 결함·출시 후 결함·제거 효율**을 검토하고, 결함밀도와 DRE를 함께 활용해야 한다.
