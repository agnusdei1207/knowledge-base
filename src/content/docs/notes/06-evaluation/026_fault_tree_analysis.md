...
- **FTA(Fault Tree Analysis, 에프티에이)**: 영문 머리글자를 딴 명칭으로, 최상위 사건을 원인 조합으로 분해하는 하향식 분석
...
- **FMEA(Failure Mode and Effects Analysis, 에프엠이에이)**: 영문 머리글자를 딴 명칭으로, 개별 고장 모드에서 시스템 영향을 분석하는 상향식 기법

## Ⅰ. 개요

- 정의/개념: 사고 결과에서 원인 조합을 하향 분석
- 기존 한계: 단일 고장 목록은 복합 원인 조합 파악 곤란
- **배경/필요성**: 최소 컷셋과 사고 기여 경로 식별
