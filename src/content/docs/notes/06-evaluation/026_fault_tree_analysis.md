...
- 정의: 최상위 사고를 **논리적 원인 조합으로 하향 분해**
- 목적: 복합 사고의 **최소 컷셋·중요 원인 제거**
...
| 설계 요소 | 설명 |
|:---|:---|
| 최상위 사건·경계 | 사고 상태·범위·가정 |
| AND·OR 논리 게이트 | 동시·선택 원인 관계 |
| 중간 사건 | 하위 조합의 중간 결과 |
| 기본 사건·공통원인 | 최하위 원인·의존성 |
| 최소 컷셋·사고 확률 | 최소조합·중요도·가능성 |
...
> 요약: 사고를 원인 조합으로 분해해 최소 컷셋과 중요도를 계산한다.
...
- **최상위사건·컷셋·확률·공통원인·중요도**로 통제를 결정한다.
