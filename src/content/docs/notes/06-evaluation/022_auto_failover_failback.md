...
- **복구 시간 목표(RTO)**: 서비스 중단 후 업무를 재개해야 하는 최대 허용 시간이다.
...
- **VIP·로드밸런서·DNS**: 활성 노드가 바뀌어도 클라이언트 요청을 새 정상 노드로 유도하는 접속 경로 수단이다.
...
- **ISO 22301**: 업무 중단에 대한 대응·복구 절차와 훈련 요구사항을 규정한 국제표준이다.
