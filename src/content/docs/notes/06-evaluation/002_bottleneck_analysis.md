...
date: "2026-08-06T17:04:00+09:00"
tags:
  - "notes-evaluation"
weight: 2
extra:
...
- 정의/개념: 처리량•응답시간을 제한하는 **병목 원인**을 측정•식별하는 성능 진단
- 배경/필요성: 평균 사용률만으로는 **대기•임계 경로 원인 식별 불가**
...
4. **병목 후보 검증**: 단일 요인 변경 후 같은 부하로 재측정
...
- **포화•대기열**이 처리량을 제한하면 **임계 경로 자원** 우선 개선
