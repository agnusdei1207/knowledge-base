...
- 지연·포화 시점의 **상관 분석** 기반 원인 후보 도출
- 자원과 사용자 품질의 **교차 진단** 기반 맹점 제거
- 개선 전후 부하곡선으로 **병목 이동** 검증

#### 한줄 요약

- 시계열 상관과 재시험을 통한 **병목 원인 입증** ## Ⅲ. 구조 및 구성요소
...
**동작 원리** 1. **기준 부하 실행**: 재현 조건의 비교 기준선 수립
...
- 동일 조건 재시험으로 **성능 향상 효과 검증** ## Ⅴ. 종류 및 비교
...
- 자원·서비스 지표를 융합한 **병목 규명** ## Ⅵ. 실무 고려사항 및 대책
