...
date: "2026-08-02T12:51:00+09:00"
...
- 정의/개념: **디지털 서비스 성숙도 평가**는 전략·고객·프로세스·데이터·기술·조직 등 영역별 실행·성과 증거로 현재 역량 수준을 판정하고 목표와의 격차를 개선 로드맵으로 전환하는 **조직 역량 진단 체계**
...
- **핵심 성과 지표(KPI)**: 조직이나 서비스의 목표 달성 정도를 지속적으로 측정하는 핵심 지표이다.
...
- **ISO/IEC 33020**: 프로세스 역량 수준과 속성을 일관되게 평가하기 위한 측정 틀을 제시하는 국제표준이다.
