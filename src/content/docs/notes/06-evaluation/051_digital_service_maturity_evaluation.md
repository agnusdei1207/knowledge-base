...
- **KPI(Key Performance Indicator)**: 목표 달성 정도를 확인하기 위해 지속 측정하는 핵심 성과지표
- **역량 프로파일**: 평가 영역별 성숙도 점수를 한눈에 비교하도록 나타낸 결과
- **내재화**: 특정 담당자나 외부 업체 없이도 조직의 표준 역할과 절차로 역량을 반복 수행하는 상태

## Ⅰ. 개요

- **정의/개념**: 디지털 서비스 역량을 증거로 단계화하는 평가
- **배경/필요성**: 기술 보유가 아닌 반복 가능한 실행 역량 개선
...
- 모든 영역의 최고 단계보다 필요 목표를 설정한다.
- 갭 원인과 선행관계로 실행 순서를 결정한다.
...
| 증거 수집 | 정책·실행 기록·성과지표 확보 |
| 현재 수준 판정 | 영역별 증거를 기준과 대조 |
