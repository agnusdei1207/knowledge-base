...
date: "2026-08-06T17:33:51+09:00"
...
- 정의/개념: 영역별 증거로 현재 역량과 목표 격차를 판정하는 **디지털 서비스 성숙도 평가**
- 배경/필요성: 기술 보유 여부•자가 설문만으로는 **반복 운영•개선 역량 입증 불가**
...
- **역량 갭**: 영역별 현재 수준과 목표 수준 사이의 차이이다.
...
선의 의미: 영역별 실행 증거를 현재•목표 수준과 개선 성과 검증에 연결한 정적 구조
