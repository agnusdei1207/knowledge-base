...
- 정의: 일부 결함 중에도 **요구된 정상 출력을 지속 제공**
- 목적: 안전 필수 업무의 **무중단·오류 확산 방지**
...
| 표결기·공통원인 고장 | **다양성·표결기 중복 적용** | 동시 실패 가능성 감소 |
...
- **결함범위·독립성·진단범위·안전상태·공통원인**으로 FT를 결정한다.
