...
- 기존 한계: 단일 구성요소의 장애가 전체 서비스 중단으로 이어지는 구조는 고가용성·안전 필수 업무의 연속성을 보장하기 어렵다.
...
- 일부 구성요소 결함 중에도 서비스를 지속하기 위해 **결함 범위·독립 중복성·오류 탐지·상태 복구·공통 원인**을 검토하고, 업무 중단 허용도가 낮은 시스템에 결함허용 구조를 적용해야 한다.
