...
date: "2026-08-06T17:20:00+09:00"
tags:
  - "notes-evaluation"
weight: 6
extra:
...
- 정의/개념: 운영 위험에 맞춰 **부하 패턴**을 달리해 성능•회복성을 검증하는 시험 분류
...
1. **환경•데이터•부하 설정 검증**: 운영 조건과 발생기 용량 검증
2. **부하 증가•유지•급변 실행**: 유형별 프로파일 재현
3. **지연•오류•포화•복구 지표 수집**: 시계열•추적•자원 수집
4. **합격 기준 판정•병목 분석**: 합격선과 개선 조건 결정
