...
- 기존 한계: 현재 사용량만 기준으로 자원을 증설하면 미래 수요 증가에 따른 용량 부족이나 불필요한 과잉 투자를 방지하기 어렵다.
...
- 서비스 수요 증가에도 목표 성능을 유지하기 위해 **성장률·피크 변동·장애 헤드룸·조달 선행시간·확장 단위**를 검토하고, 자원 포화 전에 증설 시점과 규모를 결정해야 한다.
