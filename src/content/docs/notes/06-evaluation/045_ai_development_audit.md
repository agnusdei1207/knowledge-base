...
- **MLOps(Machine Learning Operations, 엠엘옵스)**: 기계학습과 운영을 합친 명칭으로, 데이터·코드·모델의 학습·배포·감시를 자동화
...
- 기존 한계: 일반 감리는 확률적 결과·편향·드리프트 검증 부족
- **배경/필요성**: AI 수명주기의 추적성·공정성·안전성 확보
...
- 데이터·코드·환경·모델 버전을 연결해 재현성을 검증한다.
- 성능 분포·집단별 공정성·교란 강건성을 함께 평가한다.
- 배포 후 드리프트·인간 감독·롤백 가능성을 확인한다.
...
- AI 배포 신뢰를 위해 계보·재현성을 검토하여 **AI 개발 감리** 활용
