...
- **외부 입력·출력·조회(External Input/External Output/External Inquiry, EI·EO·EQ)**: 내부 상태를 변경하는 입력, 가공 결과를 제공하는 출력, 상태를 바꾸지 않는 조회 기능이다.
...
- **기능점수(Function Point, FP) 기반 규모**: 사용자에게 제공하는 논리 기능을 세어 언어·구현 방식과 독립적으로 산정한 규모이다.
