...
- **배경/필요성**: RTO·RPO와 비용에 맞춘 광역 재해 복구
...
- **사례 2**: 인사·분석 업무에 웜 사이트 적용
- **사례 3**: 장기 중단 허용 기록에 콜드 사이트 적용
- **사례 4**: 전환부터 주 센터 복귀까지 통합 훈련

### 쉽게 이해하기 (학습용)

- 사례 1은 거래 중단과 데이터 손실 허용치가 작아 상시 인프라와 최신 복제본으로 빠르게 승계한다.
- 사례 2는 몇 시간의 중단을 허용해 일부 자원만 상시 준비하고 사고 뒤 애플리케이션을 추가로 기동한다.
- 사례 3은 복구 우선순위가 낮은 보관 업무에 공간과 백업 중심의 저비용 대안을 사용한다.
- 사례 4는 DR로 넘기는 것뿐 아니라 변경된 데이터를 정리해 주 센터로 안전하게 돌아오는 절차도 검증한다.
