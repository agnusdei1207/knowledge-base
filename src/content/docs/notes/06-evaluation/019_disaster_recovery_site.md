...
date: "2026-07-31T05:10:26+09:00"
tags:
  - "notes-evaluation"
weight: 19
extra:
...
5. **기능·데이터·RTO 검증 결과**: 업무 재개·정합성 실측값
...
| 고려사항 | 대책 | 효과 |
|:---|:---|:---|
| 지역·기후 재해가 빠지면 두 센터가 함께 중단됨 | **ISO 22301:2019/Amd 1:2024 적용** | BIA·전략·기후 고려 정렬 |
| 구현 절차가 다르면 복구 결과가 흔들림 | **ISO 22313:2020 적용·개정 추적** | 절차 적용 편차 감소 |
| 문서만으로 실제 복구시간을 알 수 없음 | **전환·복귀 통합훈련** | RTO·RPO 실측 검증 |
