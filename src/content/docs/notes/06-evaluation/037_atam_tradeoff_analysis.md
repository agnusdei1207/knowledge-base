...
- **개념 증명(PoC)**: 제한된 구현과 실험으로 민감한 아키텍처 가정과 기술적 실현 가능성을 검증하는 활동이다.
...
- **ATAM**: 여러 품질 시나리오의 위험·민감점·상충점을 평가하는 방법이다.
- **SAAM**: 변경 시나리오가 아키텍처와 구성요소에 미치는 수정 영향을 평가하는 방법이다.
- **CBAM**: 품질 개선 대안의 비용과 기대 편익을 비교하여 투자 우선순위를 정하는 방법이다.
