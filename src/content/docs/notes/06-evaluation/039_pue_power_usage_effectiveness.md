...
- **UPS**: 정전·전원 이상 시 IT 장비에 전력을 계속 공급하는 장치이며 변환 손실이 PUE에 포함된다.
- **전력 분배 장치(PDU)**: 데이터센터 전력을 IT 장비에 분배하고 IT 에너지를 계측하는 장치이다.
...
- **PUE**: IT 장비 에너지 대비 총 시설 에너지로 전력 지원 부담을 평가하는 지표이다.
- **CUE**: IT 장비 에너지 대비 데이터센터 운영의 탄소 배출량을 평가하는 지표이다.
- **WUE**: IT 장비 에너지 대비 데이터센터의 현장 물 사용량을 평가하는 지표이다.
...
- **ISO/IEC 30134-2**: PUE의 정의·측정·계산·보고 기준을 규정한 국제표준이다.
