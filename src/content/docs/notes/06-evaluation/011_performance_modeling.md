...
date: "2026-07-31T05:10:20+09:00"
tags:
  - "notes-evaluation"
weight: 11
extra:
...
1. **목표·경계·워크로드 전달**: 품질 목표와 **부하 범위** 제공
2. **자원·가정·모형 전달**: 분석식·**시뮬레이션 모형** 제공
3. **기준 시나리오·실측 요청**: 예측 보정용 **기준값** 수집 요청
4. **실측 데이터 전달**: 보정과 민감도 분석용 **측정값** 제공
