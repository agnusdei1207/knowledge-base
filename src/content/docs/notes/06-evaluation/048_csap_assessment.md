...
- **CSAP(Cloud Security Assurance Program, 씨에스에이피)**: 영문 머리글자를 딴 클라우드서비스 보안인증 제도로, 공공용 서비스의 보안인증기준 충족 여부를 평가
- **KISA(Korea Internet & Security Agency, 키사)**: 영문 머리글자를 한 단어처럼 읽는 한국인터넷진흥원
- **평가기관**: 신청 서비스의 서면·현장 평가와 보완조치 확인을 수행하도록 지정된 기관
- **인증위원회**: 평가 결과와 기술자문을 바탕으로 인증 여부를 심의하는 조직
- **IaaS(Infrastructure as a Service, 아이애스)**: 제공자가 물리·가상 인프라를 운영하는 서비스형 인프라
- **SaaS(Software as a Service, 사스)**: 제공자가 완성된 응용프로그램을 운영하는 서비스형 소프트웨어
- **DaaS(Desktop as a Service, 다스)**: 제공자가 가상 데스크톱과 실행 기반을 운영하는 서비스형 데스크톱
...
- 기존 한계: 일반 인증만으로 공공용 서비스 범위·통제 확인 곤란
- **배경/필요성**: 공공 이용 클라우드의 서비스별 보안 검증
...
- 서비스 유형·등급·인증 범위별 보안인증기준을 적용한다.
- 서면·현장·취약점·모의침투 증거를 종합 평가한다.
- 최초·사후·갱신평가로 인증 범위의 지속 준수를 확인한다.
...
- 클라우드 보안 확인을 위해 유형·범위를 검토하여 **CSAP** 활용
