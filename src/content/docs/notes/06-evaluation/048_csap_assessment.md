...
date: "2026-07-31T05:07:04+09:00"
...
- 서비스 유형·등급·범위에 따른 **차등 보안인증기준**
- 통제 설계·작동성을 보는 **서면·현장·취약점·모의침투 평가**
- 범위 변경·지속 준수를 잇는 **최초·사후·갱신평가**
...
| 구성요소 | 책임 |
|:---|:---|
| 대상·인증 범위 | **유형·등급·조직·시스템·시설** 경계 확정 |
| 보안인증기준 | **관리·물리·기술 보호 요구사항** 제공 |
| 평가 증거 | **정책·로그·현장·취약점·모의침투** 결과 |
| 부적합·보완조치 | **원인·영향·수정·이행점검** 연결 |
| 인증 유지 | **범위 변경·사고·사후·갱신평가** 관리 |
...
5. **인증 여부·범위 결정**: 인증위원회의 평가 결과·잔여 위험 심의
...
| 인증 만료 뒤 사용하면 공공 조달 근거가 상실됨 | **5년 유효기간·만료 6개월 전 갱신 관리** | 인증 상태의 **법적 연속성 확보** |
