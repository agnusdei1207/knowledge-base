...
- **약어 읽기와 표기**: HA·DB·RTO는 에이치에이·디비·알티오로 읽고 영문 머리글자를 딴 표기이며, 고가용성·데이터베이스·복구 목표시간을 뜻합니다.
...
1. 웹 계층의 **Active-Active 부하 분산**
2. DB 계층의 **Active-Standby·펜싱**
3. 장애 훈련의 **RTO 충족 검증**
