...
date: "2026-07-31T05:03:17+09:00"
...
- **전자정부법 제57조**: 행정기관 등의 감리 대상·독립 수행·감리기준 준수를 정한 근거다.
- **정보시스템 감리기준**: 감리 업무범위·절차·준수사항과 법인·감리원 요건을 정한 고시다.
...
| 구성요소 | 책임 |
|:---|:---|
| 발주자 | **감리 계약·자료 제공·조치 결과** 관리 |
| 감리법인 | **위험 기반 계획·독립 점검·조치 확인** |
| 사업자 | **산출물·실행 증거·수정 결과** 제공 |
| 준거·증거 | **법령·계약·표준·실행 기록** 판정 근거 |
