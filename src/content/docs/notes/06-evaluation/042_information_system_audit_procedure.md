...
- **PMO(Project Management Office)**: 발주자를 지원해 일정·범위·비용·위험을 관리하는 사업관리 조직
- **QA(Quality Assurance)**: 개발 조직이 정한 절차와 산출물로 소프트웨어 품질을 내부에서 보증하는 활동
- **CI/CD**: 코드 변경을 자동으로 통합·시험하고 배포하는 지속적 통합·배포 방식
...
- **배경/필요성**: 공공 정보화 사업의 부실과 위험 조기 개선
...
- 전자정부법상 대상 사업에 독립 감리 적용한다.
- 문서와 실제 시스템 증거를 교차 검증한다.
- 사업 단계·규모·위험에 맞춰 범위 조정한다.
- 지적부터 시정조치 확인까지 추적한다.
...
| 비교축 | 정보시스템 감리 | PMO | 품질보증(QA) |
|:---|:---|:---|:---|
| 핵심 특징 | 제3자의 독립 점검·개선 권고 | 발주자 관점의 사업관리 지원 | 사업자 내부의 품질보증 |
| 적용 기준 | 법정 대상·고위험 사업 검증 | 대규모 사업의 관리역량 보완 | 개발 절차·산출물 품질 관리 |
| 주요 위험 | 독립성 훼손·형식적 증거 확인 | 의사결정 책임과 역할 혼선 | 자기검증으로 결함을 놓칠 수 있음 |
