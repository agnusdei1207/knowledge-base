...
- 정의/개념: 정적 분석 경고의 도달·오염 흐름·업무 영향을 검증해 **실제 결함과 조치 순위**를 정하는 활동
...
- **판정 유형**: 참 양성(True Positive, TP)은 수정하고 거짓 양성(False Positive, FP)은 근거 있는 예외로 처리하며 수용 위험은 기한과 통제를 기록하는 구분이다.
...
| **한계** | 경로의 **검증 비용** | 잘못된 예외의 **위험 은폐** | 장기 방치에 따른 **위험 누적** |

> 요약: **결함은 실행 실패**, **취약점은 공격 가능성** 중심의 판단
