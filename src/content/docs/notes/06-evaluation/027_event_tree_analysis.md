...
date: "2026-08-02T12:27:00+09:00"
tags:
  - "notes-evaluation"
weight: 27
extra:
...
- **사건수 분석(ETA)**: 초기 사건 이후 방어 장벽의 성공·실패 조합을 순방향으로 전개하여 결과 시나리오와 확률을 분석하는 기법이다.
...
- **ETA**: 초기 사건 이후 결과 조합을 순방향으로 전개하는 귀납 분석이다.
- **FTA**: 최상위 사건에서 필요한 원인 조합을 역방향으로 분해하는 연역 분석이다.
...
- **IEC 62502**: 사건수 분석의 절차·표현·정성·정량 평가 지침을 규정한 국제표준이다.
