...
- **p95 지연시간**: 전체 요청의 95%가 이 값 이하에서 완료되는 백분위 응답시간이다.
- **초당 트랜잭션 처리 건수(Transactions Per Second, TPS)**: 1초에 완료한 업무 거래 수이다.
- **요구사항 추적 매트릭스(Requirements Traceability Matrix, RTM)**: 요구사항과 설계·시험·결과를 연결한 추적표이다.
- **ISO/IEC 25010:2023**: ICT·소프트웨어 제품 품질을 9개 특성과 하위 특성으로 정의한 국제표준이다.
- **ISO/IEC 25023:2016**: 제품 품질 특성의 정량 측정 방법을 제시한 국제표준이다.

> **키워드:** 품질 특성 (기능 적합성, 성능 효율성, 호환성, 보안성)

## Ⅰ. 개요

- 정의/개념: 제품 품질을 **독립 특성·하위 특성으로 분해**
- 배경/필요성: 단일 품질 요구로는 **특성별 상충·수용 기준 판정 불가**
