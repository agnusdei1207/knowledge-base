...
- **약어 읽기와 표기**: SPOF·LB·DNS·DB·AZ·ISP는 스포프·엘비·디엔에스·디비·에이지·아이에스피로 읽고 영문 머리글자를 딴 표기이며, 단일 장애점과 주요 의존 자원을 뜻합니다.
...
| 단일 장애점 대응 | SPOF 제거 | 논리적 SPOF 대응 | 공통 원인 고장 대응 |
|:---|:---|:---|:---|
| 적용 기준 | 종단 가용성 설계 | 장비·서비스가 하나뿐일 때 | 다중 자원이 원인을 공유할 때 |
| 핵심 특징 | 단독 기능·경로 의존 제거 | 유일 기능에 대체 자원 추가 | 공유 전원·망·시설 분리 |
| 한계 | 숨은 외부 의존·승계 실패 | 대체 용량·상태 동기화 | 이중화 자원의 동시 장애 |
