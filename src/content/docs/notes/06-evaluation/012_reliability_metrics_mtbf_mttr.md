...
date: "2026-07-31T05:10:59+09:00"
tags:
  - "notes-evaluation"
weight: 12
extra:
...
- **IEC 60050-192:2015+AMD1:2016**: 신뢰성·가용성·유지보수성 등 신인성 용어를 정의한 국제전기기술용어 표준이다.
...
sequenceDiagram
  ...
  O->>M: 1. 대상·고장·복구 경계 전달
  M->>I: 2. 가동·고장 사건 전달
  I->>R: 3. 탐지·수리·복구 시각 전달
  R->>C: 4. 가동·복구 시간 전달
  C-->>O: 분포·가용성·개선축 판정
```

1. **대상·고장·복구 경계 전달**: 수리 여부와 **사건 기준** 제공
2. **가동·고장 사건 전달**: 상태별 **시작·종료 기록** 제공
3. **탐지·수리·복구 시각 전달**: **MTTR 구간** 분해 자료 제공
4. **가동·복구 시간 전달**: 누적 시간과 **사건 수** 제공
