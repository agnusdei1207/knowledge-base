...
date: "2026-08-06T17:08:58+09:00"
tags:
  - "notes-evaluation"
weight: 12
extra:
...
- 배경/필요성: 고장•복구•수명 평균 혼용으로 **개선 책임 구분 곤란**

#### 한줄 요약
- 가동시간•복구시간•비수리 부품 수명을 구분한 신뢰성 측정
...
#### 한줄 요약
- 장비 신뢰성과 신속한 복구 역량을 함께 확보한 가용성 개선
...
#### 한줄 요약
- 수리 가능 대상의 가동•복구 흐름과 비수리 품목 생애주기 구분
...
1. **가동•고장 사건 기록**: 상태별 **시작•종료 기록** 생성
2. **탐지•진단•수리 구간 분해**: **MTTR 구간**별 지연 분석
3. **복구 완료•정상화 시각 검증**: 서비스 복귀 조건과 시각 확인
4. **MTBF•MTTR•가용성 산출**: 누적 시간과 **사건 수**로 계산

#### 한줄 요약
- 대상 구분•장애 로그 정제•산식 적용에 따른 신뢰성 검증
...
#### 한줄 요약
- 신뢰성 지표 기반 예방정비 일정과 유지보수 계약 기준 결정
