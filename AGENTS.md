...
### ⭐ 핵심 — 키워드 1개 = 문서 2개 (암기용 + 답안용)

각 키워드 파일은 **반드시 두 블록을 모두 노출**한다. 과목에서 키워드를 누르면 암기용·답안용이 한 페이지에 함께 떠야 한다.

| 블록 | 용도 | 분량 | 내용 |
|:---|:---|:---|:---|
| **【암기용】** | 1교시 단답·시험 직전 회독 | 1/3쪽 | 정의 1문장 + 핵심 3포인트 + 미니 도식 + 답안 각 1줄 |
| **【답안용】** | 2~4교시 서술·딥 이해 | 2~3쪽 | Ⅰ~Ⅴ 풀 전개 (구조도·흐름도·표·방안) |

- 암기용은 **항상 답안용 위(above the fold)** 에 둔다. 외우는 문서와 서술형 답안을 분리하라는 원칙(writing-method.md)을 한 파일 안에서 두 블록으로 구현한 것이다.
- 답안용은 암기용을 풀어 쓴 것이며, 암기용 도식·키워드가 답안용 Ⅰ~Ⅲ에 그대로 확장돼야 한다.
...
- **정의**: [본질 1문장, 30자 이내]
- **핵심 3포인트**: ① [구성/원리] ② [장점/효과·수치] ③ [한계/비교]
- **미니 도식**: 입력 → [핵심 처리] → 효과
- **답안 각(answer pointer)**: [2~4교시로 끌고 갈 한 줄 골격]
...
| 2 | **【암기용】 카드** (정의·핵심 3포인트·미니 도식·답안 각) 최상단 존재 | 암기용 없이 답안용만 |
| 3 | **【답안용】** 블록이 암기용 아래 별도 노출 | 두 블록 미분리 |
...
# 📝 【암기용】 1교시 단답 카드  → 정의·핵심3포인트·미니도식·답안각 (최상단)
# 📚 【답안용】 2~4교시 서술 전개
